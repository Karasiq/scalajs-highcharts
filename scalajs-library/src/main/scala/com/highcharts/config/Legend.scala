...
class Legend extends js.Object {
   ...
   */
  var itemHiddenStyle: UndefOr[js.Object] = js.undefined
   ...
   */
  var itemHoverStyle: UndefOr[js.Object] = js.undefined
   ...
   */
  var itemStyle: js.Object = js.eval("{ \"color\": \"#333333\", \"cursor\": \"pointer\", \"fontSize\": \"12px\", \"fontWeight\": \"bold\" }").asInstanceOf[js.Object]
   ...
   * @since 2.0
   */
  var itemWidth: UndefOr[Double] = js.undefined
   ...
   */
  var labelFormatter: UndefOr[js.Function] = js.undefined
   ...
   * @since 2.3.0
   */
  var maxHeight: UndefOr[Double] = js.undefined
  
  /**
   * Options for the paging or navigation appearing when the legend is overflown.
   */
  var navigation: UndefOr[LegendNavigation] = js.undefined
   ...
   * @since 3.0.8
   */
  var symbolHeight: UndefOr[Double] = js.undefined
   ...
   * @since 3.0
   */
  var title: UndefOr[LegendTitle] = js.undefined
   ...
   * @since 2.0
   */
  var verticalAlign: String = "bottom"
