...
class SeriesTreemapLevels extends js.Object {
   ...
   * @since 4.1.0
   */
  var borderDashStyle: UndefOr[String] = js.undefined
  
  /**
   * Can set the borderWidth on all points which lies on the same level.
   * @since 4.1.0
   */
  var borderWidth: UndefOr[Double] = js.undefined
   ...
   * @since 4.1.0
   */
  var layoutAlgorithm: UndefOr[String] = js.undefined
  
  /**
   * Can set the layoutStartingDirection option on a specific level.
   * @since 4.1.0
   */
  var layoutStartingDirection: UndefOr[String] = js.undefined
   ...
   * @since 4.1.0
   */
  var level: UndefOr[Double] = js.undefined
}
