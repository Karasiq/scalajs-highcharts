...
class PlotOptionsTreemap extends js.Object {
   ...
   * @since 4.1.0
   */
  var allowDrillToNode: Boolean = false
   ...
   * @since 4.1.0
   */
  var alternateStartingDirection: Boolean = false
   ...
   * @since 4.0
   */
  var color: String = null.asInstanceOf[String]
  ...
  var dataLabels: UndefOr[PlotOptionsTreemapDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsTreemapEvents] = js.undefined
   ...
   * @since 4.1.2
   */
  var interactByLeaf: UndefOr[Boolean] = js.undefined
   ...
   * @since 4.1.0
   */
  var levelIsConstant: Boolean = true
   ...
   * @since 4.1.0
   */
  var levels: UndefOr[js.Array[js.Object]] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsTreemapPoint] = js.undefined
   ...
   * @since 4.1.10
   */
  var sortIndex: UndefOr[Double] = js.undefined
  ...
  var tooltip: UndefOr[PlotOptionsTreemapTooltip] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsTreemapZones]] = js.undefined
}
