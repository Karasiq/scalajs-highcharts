...
/**
  * @note JavaScript name: <code>plotOptions-macd-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMacdStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMacdStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdStatesHoverHalo {
