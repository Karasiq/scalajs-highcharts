...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAdDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesAdDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdDataLabelsFilter {
