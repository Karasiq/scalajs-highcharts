...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesZigzagStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesZigzagStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagStatesSelectMarkerStatesSelect {
