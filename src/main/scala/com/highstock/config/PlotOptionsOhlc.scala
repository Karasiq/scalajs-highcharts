...
class PlotOptionsOhlc extends js.Object {
  ...
  val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataGrouping]] = js.undefined
  ...
  /**
    ...
    */
  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsOhlcEvents]] = js.undefined
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/plotoptions/ohlc-linewidth/" target="_blank">A greater line width</a>
    */
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsOhlcPoint]] = js.undefined
  ...
  /**
    ...
    */
  val tooltip: js.UndefOr[CleanJsObject[PlotOptionsOhlcTooltip]] = js.undefined
  ...
  /**
    ...
    * @since 2.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsOhlcZones]]] = js.undefined
}
...
object PlotOptionsOhlc {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsOhlcEvents]] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, navigatorOptions: js.UndefOr[js.Object] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsOhlcPoint]] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsOhlcTooltip]] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, upColor: js.UndefOr[String | js.Object] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsOhlcZones]]] = js.undefined): PlotOptionsOhlc = {
    ...
    val dataGroupingOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataGrouping]] = dataGrouping
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataLabels]] = dataLabels
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcPoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsOhlcZones]]] = zones
    new PlotOptionsOhlc {
      ...
      override val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataGrouping]] = dataGroupingOuter
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsOhlcDataLabels]] = dataLabelsOuter
      override val description: js.UndefOr[String] = descriptionOuter
      override val enableMouseTracking: js.UndefOr[Boolean] = enableMouseTrackingOuter
      override val events: js.UndefOr[CleanJsObject[PlotOptionsOhlcEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsOhlcPoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[PlotOptionsOhlcTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsOhlcZones]]] = zonesOuter
    }
  }
}
