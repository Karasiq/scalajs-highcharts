...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMappointZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMappointZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointZones {
