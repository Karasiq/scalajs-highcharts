...
class PlotOptionsCandlestick extends js.Object {
  ...
  val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataGrouping]] = js.undefined
  ...
  /**
    ...
    */
  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsCandlestickEvents]] = js.undefined
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/candlestick-linecolor/" target="_blank">Candlestick line colors</a>
    */
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsCandlestickPoint]] = js.undefined
  ...
  /**
    ...
    */
  val tooltip: js.UndefOr[CleanJsObject[PlotOptionsCandlestickTooltip]] = js.undefined
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/candlestick-color/" target="_blank">Custom colors</a>, <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/candlestick/" target="_blank">colors in styled mode</a>.
    */
  ...
  /**
    ...
    * @since 2.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsCandlestickZones]]] = js.undefined
}
...
object PlotOptionsCandlestick {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsCandlestickEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, navigatorOptions: js.UndefOr[js.Object] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCandlestickPoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsCandlestickTooltip]] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, upColor: js.UndefOr[String | js.Object] = js.undefined, upLineColor: js.UndefOr[String | js.Object] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsCandlestickZones]]] = js.undefined): PlotOptionsCandlestick = {
    ...
    val dataGroupingOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataGrouping]] = dataGrouping
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataLabels]] = dataLabels
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickPoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsCandlestickZones]]] = zones
    new PlotOptionsCandlestick {
      ...
      override val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataGrouping]] = dataGroupingOuter
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDataLabels]] = dataLabelsOuter
      override val description: js.UndefOr[String] = descriptionOuter
      override val enableMouseTracking: js.UndefOr[Boolean] = enableMouseTrackingOuter
      override val events: js.UndefOr[CleanJsObject[PlotOptionsCandlestickEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsCandlestickPoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[PlotOptionsCandlestickTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsCandlestickZones]]] = zonesOuter
    }
  }
}
