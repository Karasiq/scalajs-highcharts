...
/**
  * @note JavaScript name: <code>chart-parallelAxes-events</code>
  */
@js.annotation.ScalaJSDefined
class ChartParallelAxesEvents extends com.highcharts.HighchartsGenericObject {
...
object ChartParallelAxesEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Function] = js.undefined, afterSetExtremes: js.UndefOr[js.Function] = js.undefined, pointBreak: js.UndefOr[js.Function] = js.undefined, pointInBreak: js.UndefOr[js.Function] = js.undefined, setExtremes: js.UndefOr[js.Function] = js.undefined): ChartParallelAxesEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new ChartParallelAxesEvents {
