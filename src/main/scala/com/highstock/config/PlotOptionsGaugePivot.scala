...
object PlotOptionsGaugePivot {
  /**
    ...
    */
  def apply(radius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined): PlotOptionsGaugePivot = {
