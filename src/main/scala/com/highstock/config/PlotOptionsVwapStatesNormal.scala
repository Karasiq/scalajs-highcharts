...
/**
  * @note JavaScript name: <code>plotOptions-vwap-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVwapStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsVwapStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapStatesNormal {
