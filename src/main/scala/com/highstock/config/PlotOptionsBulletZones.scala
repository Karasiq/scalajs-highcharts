...
/**
  * @note JavaScript name: <code>plotOptions-bullet-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBulletZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBulletZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletZones {
