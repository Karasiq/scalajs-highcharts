...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMapStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStatesHoverHalo {
