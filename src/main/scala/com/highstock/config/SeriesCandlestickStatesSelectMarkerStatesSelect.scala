...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesCandlestickStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickStatesSelectMarkerStatesSelect {
