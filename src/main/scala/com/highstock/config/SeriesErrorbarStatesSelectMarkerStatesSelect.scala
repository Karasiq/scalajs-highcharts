...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesErrorbarStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesErrorbarStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarStatesSelectMarkerStatesSelect {
