...
class PlotOptionsFlagsStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsStatesHover {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String | js.Object] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsStatesHover {
