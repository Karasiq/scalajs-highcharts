...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-data-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGanttDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesGanttDataMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataMarkerStates {
