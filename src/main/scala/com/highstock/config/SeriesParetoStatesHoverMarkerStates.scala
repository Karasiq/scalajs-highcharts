...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesParetoStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesHoverMarkerStates {
