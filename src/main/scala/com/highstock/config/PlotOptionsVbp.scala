...
/**
  * @note JavaScript name: <code>plotOptions-vbp</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVbp extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  val zoneLines: js.UndefOr[CleanJsObject[PlotOptionsVbpZoneLines]] = js.undefined

  /**
    * <p>The styles for bars when volume is divided into positive/negative.</p>
    * @since 6.0.0
    */
  val volumeDivision: js.UndefOr[CleanJsObject[PlotOptionsVbpVolumeDivision]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/color-zones-simple/">Color zones</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsVbpPathfinder]] = js.undefined
}

object PlotOptionsVbp {
  /**
    ...
    */
  def apply(params: js.UndefOr[js.Any] = js.undefined, zoneLines: js.UndefOr[CleanJsObject[PlotOptionsVbpZoneLines]] = js.undefined, volumeDivision: js.UndefOr[CleanJsObject[PlotOptionsVbpVolumeDivision]] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[js.Any] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[PlotOptionsVbpPathfinder]] = js.undefined): PlotOptionsVbp = {
    val paramsOuter: js.Any = params
    val zoneLinesOuter: js.UndefOr[CleanJsObject[PlotOptionsVbpZoneLines]] = zoneLines
    val volumeDivisionOuter: js.UndefOr[CleanJsObject[PlotOptionsVbpVolumeDivision]] = volumeDivision
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[PlotOptionsVbpPathfinder]] = pathfinder
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbp {
      override val params: js.Any = paramsOuter
      override val zoneLines: js.UndefOr[CleanJsObject[PlotOptionsVbpZoneLines]] = zoneLinesOuter
      override val volumeDivision: js.UndefOr[CleanJsObject[PlotOptionsVbpVolumeDivision]] = volumeDivisionOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsVbpPathfinder]] = pathfinderOuter
    })
  }
}
