...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStochasticStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesStochasticStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticStatesNormal {
