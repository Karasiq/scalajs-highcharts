...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapStatesHoverHalo {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Any] = js.undefined): SeriesTilemapStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapStatesHoverHalo {
