...
/**
  * @note JavaScript name: <code>plotOptions-polygon-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonZones {
