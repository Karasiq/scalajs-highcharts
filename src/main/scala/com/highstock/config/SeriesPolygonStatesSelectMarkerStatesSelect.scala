...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPolygonStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonStatesSelectMarkerStatesSelect {
