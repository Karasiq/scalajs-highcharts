...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatter3dMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsScatter3dMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dMarkerStates {
