...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStochasticStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesStochasticStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticStatesHoverMarkerStates {
