...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBullet extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>bullet</code> series type,
    * points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of arrays with 3 or 2 values. In this case, the values
    * correspond to <code>x,y,target</code>. If the first value is a string,
    ...
    * points exceeds the series&#39; <a href="#series.bullet.turboThreshold">turboThreshold</a>,
    ...
    * @since 6.0.0
    */
  val data: js.UndefOr[js.Array[CleanJsObject[SeriesBulletData] | js.Array[js.Any]]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    * @since 6.0.0
    */
  val `type`: js.UndefOr[String] = "bullet"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>All options related with look and positiong of targets.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bullet-targetoptions/">Target options</a>
    * @since 6.0.0
    */
  val targetOptions: js.UndefOr[CleanJsObject[SeriesBulletTargetOptions]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesBulletPathfinder]] = js.undefined
...
object SeriesBullet {
  /**
    * @param data <p>An array of data points for the series. For the <code>bullet</code> series type,. points can be given in the following ways:</p>. <ol>. <li><p>An array of arrays with 3 or 2 values. In this case, the values. correspond to <code>x,y,target</code>. If the first value is a string,. it is applied as the name of the point, and the <code>x</code> value is inferred.. The <code>x</code> value can also be omitted, in which case the inner arrays. should be of length 2. Then the <code>x</code> value is automatically calculated,. either starting at 0 and incremented by 1, or from <code>pointStart</code>. and <code>pointInterval</code> given in the series options.</p>. <pre><code class="language-js">data: [.     [0, 40, 75],.     [1, 50, 50],.     [2, 60, 40]. ]</code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.bullet.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">data: [{.     x: 0,.     y: 40,.     target: 75,.     name: &quot;Point1&quot;,.     color: &quot;#00FF00&quot;. }, {.     x: 1,.     y: 60,.     target: 40,.     name: &quot;Point2&quot;,.     color: &quot;#FF00FF&quot;. }]</code></pre>. </li>. </ol>
    ...
    * @param targetOptions <p>All options related with look and positiong of targets.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesBulletData] | js.Array[js.Any]]] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[String | js.Any] = js.undefined, `type`: js.UndefOr[String] = "bullet", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, targetOptions: js.UndefOr[CleanJsObject[SeriesBulletTargetOptions]] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String | js.Object] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesBulletPathfinder]] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined): SeriesBullet = {
    val dataOuter: js.UndefOr[js.Array[CleanJsObject[SeriesBulletData] | js.Array[js.Any]]] = data
    ...
    val targetOptionsOuter: js.UndefOr[CleanJsObject[SeriesBulletTargetOptions]] = targetOptions
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesBulletPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBullet {
      override val data: js.UndefOr[js.Array[CleanJsObject[SeriesBulletData] | js.Array[js.Any]]] = dataOuter
      ...
      override val targetOptions: js.UndefOr[CleanJsObject[SeriesBulletTargetOptions]] = targetOptionsOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesBulletPathfinder]] = pathfinderOuter
