...
/**
  * @note JavaScript name: <code>navigator-xAxis-events</code>
  */
@js.annotation.ScalaJSDefined
class NavigatorXAxisEvents extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Function] = js.undefined, afterSetExtremes: js.UndefOr[js.Function] = js.undefined, pointBreak: js.UndefOr[js.Function] = js.undefined, pointInBreak: js.UndefOr[js.Function] = js.undefined, setExtremes: js.UndefOr[js.Function] = js.undefined): NavigatorXAxisEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisEvents {
