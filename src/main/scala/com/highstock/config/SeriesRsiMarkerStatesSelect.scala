...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesRsiMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesRsiMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiMarkerStatesSelect {
