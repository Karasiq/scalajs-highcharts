...
/**
  * @note JavaScript name: <code>plotOptions-ad-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAdStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAdStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdStatesHoverHalo {
