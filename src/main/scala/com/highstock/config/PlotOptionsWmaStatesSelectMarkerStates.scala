...
/**
  * @note JavaScript name: <code>plotOptions-wma-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWmaStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsWmaStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaStatesSelectMarkerStates {
