...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapbubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMapbubbleStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStatesSelectHalo {
