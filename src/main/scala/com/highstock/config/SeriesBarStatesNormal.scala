...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBarStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesBarStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarStatesNormal {
