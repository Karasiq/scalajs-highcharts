...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplinerange extends js.Object {
  ...
  /**
    ...
    */
  val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataGrouping]] = js.undefined
  ...
  /**
    ...
    * @since 1.2.0
    */
  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeEvents]] = js.undefined
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangePoint]] = js.undefined
  ...
  /**
    ...
    */
  val tooltip: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeTooltip]] = js.undefined
  ...
  /**
    ...
    * @since 2.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsAreasplinerangeZones]]] = js.undefined
}

object PlotOptionsAreasplinerange {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, fillOpacity: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Object] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangePoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeTooltip]] = js.undefined, trackByArea: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsAreasplinerangeZones]]] = js.undefined): PlotOptionsAreasplinerange = {
    ...
    val dataGroupingOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataGrouping]] = dataGrouping
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataLabels]] = dataLabels
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangePoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsAreasplinerangeZones]]] = zones
    new PlotOptionsAreasplinerange {
      ...
      override val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataGrouping]] = dataGroupingOuter
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeDataLabels]] = dataLabelsOuter
      override val description: js.UndefOr[String] = descriptionOuter
      override val enableMouseTracking: js.UndefOr[Boolean] = enableMouseTrackingOuter
      override val events: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangePoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsAreasplinerangeZones]]] = zonesOuter
    }
  }
}
