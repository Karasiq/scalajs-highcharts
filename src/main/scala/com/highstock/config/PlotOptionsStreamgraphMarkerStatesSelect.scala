...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStreamgraphMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsStreamgraphMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphMarkerStatesSelect {
