...
class SeriesWaterfallStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesHover {
  /**
    ...
    */
  def apply(lineWidthPlus: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesWaterfallStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesWaterfallStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesHover {
