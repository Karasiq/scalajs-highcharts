...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWmaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWmaMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaMarkerStates {
