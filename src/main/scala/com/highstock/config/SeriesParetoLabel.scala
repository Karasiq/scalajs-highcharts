...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-label</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): SeriesParetoLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoLabel {
