...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesMomentumDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumDataLabelsFilter {
