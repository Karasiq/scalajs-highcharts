...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPivotpointsMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsMarkerStates {
