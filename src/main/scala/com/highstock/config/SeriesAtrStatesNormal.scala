...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAtrStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesAtrStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrStatesNormal {
