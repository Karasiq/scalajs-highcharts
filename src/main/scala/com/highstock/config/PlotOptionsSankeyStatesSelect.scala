...
/**
  * @note JavaScript name: <code>plotOptions-sankey-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSankeyStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyStatesSelect = {
    val colorOuter: js.UndefOr[String | js.Object] = color
    val borderColorOuter: js.UndefOr[String | js.Object] = borderColor
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val borderWidthOuter: js.UndefOr[Double] = borderWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyStatesSelect {
