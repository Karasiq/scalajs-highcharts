...
/**
  * @note JavaScript name: <code>plotOptions-bullet-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBulletStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsBulletStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletStatesNormal {
