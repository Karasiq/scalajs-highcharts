...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMaplineStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesSelectMarkerStates {
