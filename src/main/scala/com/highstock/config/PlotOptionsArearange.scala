...
/**
  * @note JavaScript name: <code>plotOptions-arearange</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsArearange extends js.Object {
  ...
  /**
    ...
    */
  val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataGrouping]] = js.undefined
  ...
  /**
    ...
    * @since 1.2.0
    */
  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsArearangeEvents]] = js.undefined
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsArearangePoint]] = js.undefined
  ...
  /**
    ...
    */
  val tooltip: js.UndefOr[CleanJsObject[PlotOptionsArearangeTooltip]] = js.undefined
  ...
  /**
    ...
    * @since 2.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsArearangeZones]]] = js.undefined
}

object PlotOptionsArearange {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsArearangeEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, fillOpacity: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Object] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsArearangePoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, step: js.UndefOr[String] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsArearangeTooltip]] = js.undefined, trackByArea: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsArearangeZones]]] = js.undefined): PlotOptionsArearange = {
    ...
    val dataGroupingOuter: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataGrouping]] = dataGrouping
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataLabels]] = dataLabels
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsArearangeEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsArearangePoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[PlotOptionsArearangeTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsArearangeZones]]] = zones
    new PlotOptionsArearange {
      ...
      override val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataGrouping]] = dataGroupingOuter
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsArearangeDataLabels]] = dataLabelsOuter
      override val description: js.UndefOr[String] = descriptionOuter
      override val enableMouseTracking: js.UndefOr[Boolean] = enableMouseTrackingOuter
      override val events: js.UndefOr[CleanJsObject[PlotOptionsArearangeEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsArearangePoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[PlotOptionsArearangeTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsArearangeZones]]] = zonesOuter
    }
  }
}
