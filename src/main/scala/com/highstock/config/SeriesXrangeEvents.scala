...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesXrangeEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeEvents {
