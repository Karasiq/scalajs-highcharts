...
/**
  * @note JavaScript name: <code>plotOptions-gantt-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsGanttStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttStatesHover {
