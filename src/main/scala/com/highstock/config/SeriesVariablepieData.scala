...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariablepieData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Whether to display a slice offset from the center.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/point/sliced/">One sliced point</a>
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesVariablepieDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesVariablepieDataEvents]] = js.undefined
}

object SeriesVariablepieData {
  /**
    * @param legendIndex <p>The sequential index of the data point in the legend.</p>
    * @param sliced <p>Whether to display a slice offset from the center.</p>
    ...
    */
  def apply(legendIndex: js.UndefOr[Double] = js.undefined, sliced: js.UndefOr[Boolean] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesVariablepieDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesVariablepieDataEvents]] = js.undefined): SeriesVariablepieData = {
    val legendIndexOuter: js.UndefOr[Double] = legendIndex
    val slicedOuter: js.UndefOr[Boolean] = sliced
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesVariablepieDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesVariablepieDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieData {
      override val legendIndex: js.UndefOr[Double] = legendIndexOuter
      override val sliced: js.UndefOr[Boolean] = slicedOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesVariablepieDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesVariablepieDataEvents]] = eventsOuter
    })
  }
}
