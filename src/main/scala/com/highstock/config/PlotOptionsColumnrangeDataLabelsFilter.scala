...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnrangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnrangeDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeDataLabelsFilter {
