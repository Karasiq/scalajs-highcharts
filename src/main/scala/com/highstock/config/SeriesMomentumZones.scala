...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMomentumZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumZones {
