...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplineData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesAreasplineDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesAreasplineDataEvents]] = js.undefined

  val marker: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarker]] = js.undefined
}

object SeriesAreasplineData {
  /**
    ...
    */
  def apply(dragDrop: js.UndefOr[CleanJsObject[SeriesAreasplineDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesAreasplineDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarker]] = js.undefined): SeriesAreasplineData = {
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesAreasplineDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesAreasplineDataEvents]] = events
    val markerOuter: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarker]] = marker
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineData {
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesAreasplineDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesAreasplineDataEvents]] = eventsOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarker]] = markerOuter
    })
  }
}
