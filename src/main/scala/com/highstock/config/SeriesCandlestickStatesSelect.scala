...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesSelectMarker]] = js.undefined
...
object SeriesCandlestickStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesCandlestickStatesSelect = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesCandlestickStatesSelectMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickStatesSelect {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesSelectMarker]] = markerOuter
