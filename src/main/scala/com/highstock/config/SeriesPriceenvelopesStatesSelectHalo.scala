...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPriceenvelopesStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPriceenvelopesStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesStatesSelectHalo {
