...
/**
  * @note JavaScript name: <code>plotOptions-pie-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPieStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsPieStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieStatesSelectHalo {
