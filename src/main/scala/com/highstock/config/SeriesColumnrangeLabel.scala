...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-label</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): SeriesColumnrangeLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeLabel {
