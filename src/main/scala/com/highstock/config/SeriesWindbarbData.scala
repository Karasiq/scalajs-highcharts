...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarbData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesWindbarbDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesWindbarbDataEvents]] = js.undefined

  val marker: js.UndefOr[CleanJsObject[SeriesWindbarbDataMarker]] = js.undefined
}

object SeriesWindbarbData {
  /**
    * @param value <p>The wind speed in meters per second.</p>
    * @param direction <p>The wind direction in degrees, where 0 is north (pointing towards south).</p>
    ...
    */
  def apply(value: js.UndefOr[Double] = js.undefined, direction: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesWindbarbDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesWindbarbDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesWindbarbDataMarker]] = js.undefined): SeriesWindbarbData = {
    val valueOuter: js.UndefOr[Double] = value
    val directionOuter: js.UndefOr[Double] = direction
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesWindbarbDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesWindbarbDataEvents]] = events
    val markerOuter: js.UndefOr[CleanJsObject[SeriesWindbarbDataMarker]] = marker
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbData {
      override val value: js.UndefOr[Double] = valueOuter
      override val direction: js.UndefOr[Double] = directionOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesWindbarbDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesWindbarbDataEvents]] = eventsOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesWindbarbDataMarker]] = markerOuter
    })
  }
}
