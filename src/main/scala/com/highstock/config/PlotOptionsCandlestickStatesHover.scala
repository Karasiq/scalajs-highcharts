...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCandlestickStatesHover extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val halo: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverHalo]] = js.undefined
  ...
  val marker: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverMarker]] = js.undefined
}

object PlotOptionsCandlestickStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverMarker]] = js.undefined): PlotOptionsCandlestickStatesHover = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val haloOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverHalo]] = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverMarker]] = marker
    new PlotOptionsCandlestickStatesHover {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val halo: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverHalo]] = haloOuter
      override val lineWidth: js.UndefOr[Double] = lineWidthOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesHoverMarker]] = markerOuter
    }
  }
}
