...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesXrangeStatesSelectMarker]] = js.undefined
...
object SeriesXrangeStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesXrangeStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesXrangeStatesSelect = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesXrangeStatesSelectMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeStatesSelect {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesXrangeStatesSelectMarker]] = markerOuter
