...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStreamgraphDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesStreamgraphDataMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataMarkerStates {
