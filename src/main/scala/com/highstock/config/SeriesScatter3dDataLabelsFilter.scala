...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesScatter3dDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataLabelsFilter {
