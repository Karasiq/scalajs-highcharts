...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesMappointDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointDataLabelsFilter {
