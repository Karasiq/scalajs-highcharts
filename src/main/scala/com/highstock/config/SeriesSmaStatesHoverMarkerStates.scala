...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSmaStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSmaStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaStatesHoverMarkerStates {
