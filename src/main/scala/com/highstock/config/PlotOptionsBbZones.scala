...
/**
  * @note JavaScript name: <code>plotOptions-bb-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBbZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBbZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbZones {
