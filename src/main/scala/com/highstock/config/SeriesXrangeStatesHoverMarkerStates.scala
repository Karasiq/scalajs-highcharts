...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesXrangeStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeStatesHoverMarkerStates {
