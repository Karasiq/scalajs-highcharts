...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesVariwideEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideEvents {
