...
/**
  * @note JavaScript name: <code>plotOptions-cmf-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCmfStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsCmfStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfStatesNormal {
