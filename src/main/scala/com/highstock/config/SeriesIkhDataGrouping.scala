...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class SeriesIkhDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhDataGrouping {
  ...
  def apply(approximation: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesIkhDataGrouping = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhDataGrouping {
