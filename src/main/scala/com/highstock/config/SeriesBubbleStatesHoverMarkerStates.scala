...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesBubbleStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleStatesHoverMarkerStates {
