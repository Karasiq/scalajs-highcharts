...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesLineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesLineStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineStatesSelectHalo {
