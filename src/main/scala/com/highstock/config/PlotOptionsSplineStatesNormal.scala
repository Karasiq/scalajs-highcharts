...
/**
  * @note JavaScript name: <code>plotOptions-spline-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSplineStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsSplineStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineStatesNormal {
