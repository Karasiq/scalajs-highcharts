...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatter3dStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsScatter3dStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dStatesSelectMarkerStatesSelect {
