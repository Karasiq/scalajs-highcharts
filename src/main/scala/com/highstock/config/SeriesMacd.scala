...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    * @since 6.0.0
    */
  val `type`: js.UndefOr[String] = "macd"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    ...
    * @since 6.0.0
    */
  val signalLine: js.Any = js.undefined

  /**
    * <p>The styles for macd line</p>
    * @since 6.0.0
    */
  val macdLine: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/color-zones-simple/">Color zones</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesMacdPathfinder]] = js.undefined
...
object SeriesMacd {
  /**
    ...
    */
  def apply(id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[String | js.Any] = js.undefined, `type`: js.UndefOr[String] = "macd", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, params: js.UndefOr[js.Any] = js.undefined, signalLine: js.UndefOr[js.Any] = js.undefined, macdLine: js.UndefOr[js.Any] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, step: js.UndefOr[String] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[js.Any] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesMacdPathfinder]] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined): SeriesMacd = {
    ...
    val signalLineOuter: js.Any = signalLine
    val macdLineOuter: js.Any = macdLine
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesMacdPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacd {
      ...
      override val signalLine: js.Any = signalLineOuter
      override val macdLine: js.Any = macdLineOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesMacdPathfinder]] = pathfinderOuter
