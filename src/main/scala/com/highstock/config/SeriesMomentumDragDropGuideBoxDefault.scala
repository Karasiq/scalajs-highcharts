...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesMomentumDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumDragDropGuideBoxDefault {
