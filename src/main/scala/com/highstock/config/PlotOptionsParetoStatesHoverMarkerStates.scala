...
/**
  * @note JavaScript name: <code>plotOptions-pareto-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsParetoStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsParetoStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoStatesHoverMarkerStates {
