...
class SeriesSolidgaugeData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>The inner radius of an individual point in a solid gauge. Can be
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = js.undefined
...
object SeriesSolidgaugeData {
  /**
    ...
    */
  def apply(innerRadius: js.UndefOr[Double | String] = js.undefined, radius: js.UndefOr[Double | String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataEvents]] = js.undefined): SeriesSolidgaugeData = {
    val innerRadiusOuter: js.UndefOr[Double | String] = innerRadius
    val radiusOuter: js.UndefOr[Double | String] = radius
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = dragDropOuter
