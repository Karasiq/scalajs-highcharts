...
class SeriesGaugeDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataLabels {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, align: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, x: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, format: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): SeriesGaugeDataLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataLabels {
