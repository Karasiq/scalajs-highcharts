...
object ExportingButtonsContextButton {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, menuItems: js.UndefOr[js.Array[js.Object]] = js.undefined, onclick: js.UndefOr[js.Function] = js.undefined, symbol: js.UndefOr[String] = js.undefined, symbolFill: js.UndefOr[String] = js.undefined, symbolSize: js.UndefOr[Double] = js.undefined, symbolStroke: js.UndefOr[String | js.Object] = js.undefined, symbolStrokeWidth: js.UndefOr[Double] = js.undefined, symbolX: js.UndefOr[Double] = js.undefined, symbolY: js.UndefOr[Double] = js.undefined, text: js.UndefOr[String] = js.undefined, theme: js.UndefOr[js.Object] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): ExportingButtonsContextButton = {
    ...
    val symbolFillOuter: js.UndefOr[String] = symbolFill
    ...
    new ExportingButtonsContextButton {
      ...
      override val symbolFill: js.UndefOr[String] = symbolFillOuter
