...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWaterfallZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWaterfallZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallZones {
