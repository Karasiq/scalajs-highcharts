...
/**
  * @note JavaScript name: <code>colorAxis-grid</code>
  */
@js.annotation.ScalaJSDefined
class ColorAxisGrid extends com.highcharts.HighchartsGenericObject {
...
object ColorAxisGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): ColorAxisGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new ColorAxisGrid {
