...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStreamgraphStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesStreamgraphStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphStatesHoverMarkerStates {
