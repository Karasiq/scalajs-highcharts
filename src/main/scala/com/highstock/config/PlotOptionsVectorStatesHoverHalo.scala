...
/**
  * @note JavaScript name: <code>plotOptions-vector-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVectorStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsVectorStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorStatesHoverHalo {
