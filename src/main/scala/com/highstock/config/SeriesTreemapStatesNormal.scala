...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesTreemapStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapStatesNormal {
