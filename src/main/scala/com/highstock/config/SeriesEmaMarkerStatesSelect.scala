...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesEmaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesEmaMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaMarkerStatesSelect {
