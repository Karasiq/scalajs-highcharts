...
object SeriesAreaspline {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, compare: js.UndefOr[String] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, data: js.UndefOr[js.Array[CleanJsObject[SeriesAreasplineData] | js.Array[js.Any] | Double]] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[SeriesAreasplineDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesAreasplineDataLabels]] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesAreasplineEvents]] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, fillOpacity: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesAreasplineMarker]] = js.undefined, name: js.UndefOr[String] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAreasplinePoint]] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stack: js.UndefOr[String] = js.undefined, stacking: js.UndefOr[String] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, tooltip: js.UndefOr[CleanJsObject[SeriesAreasplineTooltip]] = js.undefined, trackByArea: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, `type`: String = "areaspline", visible: js.UndefOr[Boolean] = js.undefined, xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[SeriesAreasplineZones]]] = js.undefined): SeriesAreaspline = {
