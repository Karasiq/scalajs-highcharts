...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesSunburstDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataLabelsFilter {
