...
class SeriesCandlestickDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataGrouping {
  ...
  def apply(approximation: js.UndefOr[String] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesCandlestickDataGrouping = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataGrouping {
