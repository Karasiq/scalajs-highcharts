...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSunburstMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstMarkerStates {
