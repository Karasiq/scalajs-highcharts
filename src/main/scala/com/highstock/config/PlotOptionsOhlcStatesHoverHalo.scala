...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsOhlcStatesHoverHalo extends js.Object {
...
object PlotOptionsOhlcStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsOhlcStatesHoverHalo = {
    ...
    new PlotOptionsOhlcStatesHoverHalo {
