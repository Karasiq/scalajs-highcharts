...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesErrorbarEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesErrorbarEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarEvents {
