...
/**
  * @note JavaScript name: <code>zAxis-events</code>
  */
@js.annotation.ScalaJSDefined
class ZAxisEvents extends com.highcharts.HighchartsGenericObject {
...
object ZAxisEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Function] = js.undefined, afterSetExtremes: js.UndefOr[js.Function] = js.undefined, pointBreak: js.UndefOr[js.Function] = js.undefined, pointInBreak: js.UndefOr[js.Function] = js.undefined, setExtremes: js.UndefOr[js.Function] = js.undefined): ZAxisEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new ZAxisEvents {
