...
object SeriesZigzagParams {
  /**
    ...
    */
  def apply(lowIndex: js.UndefOr[Double] = js.undefined, highIndex: js.UndefOr[Double] = js.undefined, deviation: js.UndefOr[Double] = js.undefined): SeriesZigzagParams = {
