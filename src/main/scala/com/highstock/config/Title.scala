...
class Title extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-align/" target="_blank">Aligned to the plot area (x = 50px 
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-floating/" target="_blank">true - title on top of the plot area</a>.
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-margin/" target="_blank">A chart title margin of 50</a>.
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-style/" target="_blank">Custom color and weight</a>.
...
<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/titles/" target="_blank">Styled mode</a>.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-text/" target="_blank">Custom title</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/chart/title-verticalalign/" target="_blank">Chart title in bottom right corner</a>
    */
