...
class PlotOptionsCandlestickStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  val normal: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesNormal]] = js.undefined
}
...
object PlotOptionsCandlestickStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesNormal]] = js.undefined): PlotOptionsCandlestickStates = {
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    val normalOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesNormal]] = normal
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickStates {
      override val hover: js.Any = hoverOuter
      override val select: js.Any = selectOuter
      override val normal: js.UndefOr[CleanJsObject[PlotOptionsCandlestickStatesNormal]] = normalOuter
    })
  }
}
