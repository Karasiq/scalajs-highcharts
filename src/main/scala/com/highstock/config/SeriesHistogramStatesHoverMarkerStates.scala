...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogramStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesHistogramStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesHoverMarkerStates {
