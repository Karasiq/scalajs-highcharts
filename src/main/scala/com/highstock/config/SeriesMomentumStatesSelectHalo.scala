...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMomentumStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumStatesSelectHalo {
