...
/**
  * @note JavaScript name: <code>plotOptions-momentum-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMomentumStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsMomentumStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumStatesSelectMarkerStatesSelect {
