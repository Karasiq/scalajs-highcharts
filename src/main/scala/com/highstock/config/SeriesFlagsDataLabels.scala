...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFlagsDataLabels extends js.Object {
