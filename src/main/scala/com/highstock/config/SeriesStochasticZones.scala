...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStochasticZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesStochasticZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticZones {
