...
/**
  * @note JavaScript name: <code>plotOptions-gantt-dragDrop-dragHandle</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttDragDropDragHandle {
  /**
    ...
    */
  def apply(pathFormatter: js.UndefOr[js.Function] = js.undefined, cursor: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsGanttDragDropDragHandle = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttDragDropDragHandle {
