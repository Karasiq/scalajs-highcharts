...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeStatesHoverHalo extends js.Object {
...
object SeriesColumnrangeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesColumnrangeStatesHoverHalo = {
    ...
    new SeriesColumnrangeStatesHoverHalo {
