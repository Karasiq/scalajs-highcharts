...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSplineStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSplineStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineStatesSelectMarkerStatesSelect {
