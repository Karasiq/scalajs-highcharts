...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dragDrop-dragHandle</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatter3dDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDragDropDragHandle {
  /**
    ...
    */
  def apply(pathFormatter: js.UndefOr[js.Function] = js.undefined, cursor: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dDragDropDragHandle = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dDragDropDragHandle {
