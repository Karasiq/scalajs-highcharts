...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSunburstStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstStatesHoverMarkerStates {
