...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnrangeZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeZones {
