...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSmaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSmaMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaMarkerStates {
