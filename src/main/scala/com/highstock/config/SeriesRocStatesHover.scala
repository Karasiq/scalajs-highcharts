...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesRocStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 6.0.0
    */
  val marker: js.UndefOr[CleanJsObject[SeriesRocStatesHoverMarker]] = js.undefined
...
object SeriesRocStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesRocStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined): SeriesRocStatesHover = {
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[SeriesRocStatesHoverMarker]] = marker
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocStatesHover {
      override val animation: js.UndefOr[Boolean | js.Object] = animationOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesRocStatesHoverMarker]] = markerOuter
