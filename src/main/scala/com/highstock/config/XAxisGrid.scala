...
/**
  * @note JavaScript name: <code>xAxis-grid</code>
  */
@js.annotation.ScalaJSDefined
class XAxisGrid extends com.highcharts.HighchartsGenericObject {
...
object XAxisGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): XAxisGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisGrid {
