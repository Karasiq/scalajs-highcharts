...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnDataGrouping extends js.Object {
...
object SeriesColumnDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesColumnDataGrouping = {
