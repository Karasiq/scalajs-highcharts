...
/**
  * @note JavaScript name: <code>plotOptions-wma-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWmaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWmaZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaZones {
