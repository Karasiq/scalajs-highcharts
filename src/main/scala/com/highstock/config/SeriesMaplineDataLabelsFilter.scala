...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesMaplineDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineDataLabelsFilter {
