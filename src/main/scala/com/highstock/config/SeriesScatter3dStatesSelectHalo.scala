...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesScatter3dStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesSelectHalo {
