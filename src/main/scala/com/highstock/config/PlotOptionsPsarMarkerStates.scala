...
/**
  * @note JavaScript name: <code>plotOptions-psar-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPsarMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPsarMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarMarkerStates {
