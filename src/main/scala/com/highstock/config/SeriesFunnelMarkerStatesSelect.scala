...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesFunnelMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelMarkerStatesSelect {
