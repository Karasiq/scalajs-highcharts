...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnrangeDataGrouping extends js.Object {
...
object PlotOptionsColumnrangeDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): PlotOptionsColumnrangeDataGrouping = {
    ...
    new PlotOptionsColumnrangeDataGrouping {
