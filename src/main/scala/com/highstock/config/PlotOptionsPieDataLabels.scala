...
class PlotOptionsPieDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieDataLabels {
  ...
  def apply(distance: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, x: js.UndefOr[Double] = js.undefined, connectorColor: js.UndefOr[String | js.Object] = js.undefined, connectorPadding: js.UndefOr[Double] = js.undefined, connectorWidth: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, softConnector: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, y: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): PlotOptionsPieDataLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieDataLabels {
