...
/**
  * @note JavaScript name: <code>plotOptions-polygon-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonDataGrouping extends js.Object {
...
object PlotOptionsPolygonDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): PlotOptionsPolygonDataGrouping = {
    ...
    new PlotOptionsPolygonDataGrouping {
