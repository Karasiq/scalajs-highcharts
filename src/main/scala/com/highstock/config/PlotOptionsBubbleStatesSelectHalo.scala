...
/**
  * @note JavaScript name: <code>plotOptions-bubble-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsBubbleStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleStatesSelectHalo {
