...
class XAxisLabels extends com.highcharts.HighchartsGenericObject {
...
object XAxisLabels {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, indentation: js.UndefOr[Double] = js.undefined, x: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, align: js.UndefOr[String] = js.undefined, autoRotation: js.UndefOr[js.Array[Double]] = js.undefined, autoRotationLimit: js.UndefOr[Double] = js.undefined, distance: js.UndefOr[Double] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Function] = js.undefined, maxStaggerLines: js.UndefOr[Double] = js.undefined, overflow: js.UndefOr[Boolean | String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, staggerLines: js.UndefOr[Double] = js.undefined, step: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String] = js.undefined, skew3d: js.UndefOr[Boolean] = js.undefined): XAxisLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisLabels {
