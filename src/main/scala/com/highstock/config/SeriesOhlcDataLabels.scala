...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcDataLabels extends js.Object {
