...
/**
  * @note JavaScript name: <code>plotOptions-polygon</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygon extends js.Object {
  ...
  /**
    ...
    */
  val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataGrouping]] = js.undefined

  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsPolygonEvents]] = js.undefined
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarker]] = js.undefined
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsPolygonPoint]] = js.undefined
  ...
  /**
    ...
    * @since 2.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsPolygonZones]]] = js.undefined
}

object PlotOptionsPolygon {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataGrouping]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsPolygonEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarker]] = js.undefined, navigatorOptions: js.UndefOr[js.Object] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPolygonPoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[js.Object] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsPolygonZones]]] = js.undefined): PlotOptionsPolygon = {
    ...
    val dataGroupingOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataGrouping]] = dataGrouping
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataLabels]] = dataLabels
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonEvents]] = events
    ...
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarker]] = marker
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonPoint]] = point
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsPolygonZones]]] = zones
    new PlotOptionsPolygon {
      ...
      override val dataGrouping: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataGrouping]] = dataGroupingOuter
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsPolygonDataLabels]] = dataLabelsOuter
      override val description: js.UndefOr[String] = descriptionOuter
      override val enableMouseTracking: js.UndefOr[Boolean] = enableMouseTrackingOuter
      override val events: js.UndefOr[CleanJsObject[PlotOptionsPolygonEvents]] = eventsOuter
      ...
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarker]] = markerOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsPolygonPoint]] = pointOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsPolygonZones]]] = zonesOuter
    }
  }
}
