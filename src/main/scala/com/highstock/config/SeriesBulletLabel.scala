...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-label</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBulletLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): SeriesBulletLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletLabel {
