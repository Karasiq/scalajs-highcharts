...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMappointStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMappointStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesHoverMarkerStates {
