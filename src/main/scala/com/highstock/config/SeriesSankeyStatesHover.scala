...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesSankeyStatesHoverMarker]] = js.undefined
...
object SeriesSankeyStatesHover {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesSankeyStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesSankeyStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesSankeyStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesSankeyStatesHoverMarker]] = markerOuter
