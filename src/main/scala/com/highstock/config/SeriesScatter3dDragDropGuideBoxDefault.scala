...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesScatter3dDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDragDropGuideBoxDefault {
