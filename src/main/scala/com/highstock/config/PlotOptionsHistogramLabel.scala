...
/**
  * @note JavaScript name: <code>plotOptions-histogram-label</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsHistogramLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): PlotOptionsHistogramLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramLabel {
