...
/**
  * @note JavaScript name: <code>plotOptions-flags-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFlagsStatesHoverHalo extends js.Object {
...
object PlotOptionsFlagsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsStatesHoverHalo = {
    ...
    new PlotOptionsFlagsStatesHoverHalo {
