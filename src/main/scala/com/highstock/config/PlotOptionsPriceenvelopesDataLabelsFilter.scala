...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPriceenvelopesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): PlotOptionsPriceenvelopesDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesDataLabelsFilter {
