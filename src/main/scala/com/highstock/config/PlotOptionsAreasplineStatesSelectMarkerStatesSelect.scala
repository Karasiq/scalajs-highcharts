...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplineStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsAreasplineStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineStatesSelectMarkerStatesSelect {
