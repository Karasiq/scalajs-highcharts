...
object SeriesSmaDataLabels {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): SeriesSmaDataLabels = {
