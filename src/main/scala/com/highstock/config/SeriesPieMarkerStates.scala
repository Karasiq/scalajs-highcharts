...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPieMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieMarkerStates {
