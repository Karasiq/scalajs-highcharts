...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsOhlcDataLabels extends js.Object {
...
object PlotOptionsOhlcDataLabels {
  /**
