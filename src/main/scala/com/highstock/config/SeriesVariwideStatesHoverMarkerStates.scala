...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVariwideStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesHoverMarkerStates {
