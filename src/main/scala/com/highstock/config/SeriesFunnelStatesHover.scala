...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesFunnelStatesHoverMarker]] = js.undefined
...
object SeriesFunnelStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesFunnelStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesFunnelStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesFunnelStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesFunnelStatesHoverMarker]] = markerOuter
