...
/**
  * @note JavaScript name: <code>plotOptions-column-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnStatesHoverHalo extends js.Object {
...
object PlotOptionsColumnStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsColumnStatesHoverHalo = {
    ...
    new PlotOptionsColumnStatesHoverHalo {
