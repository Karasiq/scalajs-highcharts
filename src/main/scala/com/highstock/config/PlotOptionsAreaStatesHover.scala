...
class PlotOptionsAreaStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsAreaStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined): PlotOptionsAreaStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaStatesHover {
