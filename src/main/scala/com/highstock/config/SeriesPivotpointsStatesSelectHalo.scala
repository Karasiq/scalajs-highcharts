...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPivotpointsStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesSelectHalo {
