...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesVariwideStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesSelectHalo {
