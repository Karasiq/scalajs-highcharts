...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMappointStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointStatesSelectHalo {
