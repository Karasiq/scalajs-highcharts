...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBellcurveStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesBellcurveStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveStatesHoverMarkerStates {
