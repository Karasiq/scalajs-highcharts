...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMfiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMfiMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiMarkerStates {
