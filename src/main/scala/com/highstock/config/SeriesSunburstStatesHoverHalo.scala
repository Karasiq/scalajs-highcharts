...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesSunburstStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstStatesHoverHalo {
