...
/**
  * @note JavaScript name: <code>plotOptions-scatter-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatterStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsScatterStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterStatesHoverHalo {
