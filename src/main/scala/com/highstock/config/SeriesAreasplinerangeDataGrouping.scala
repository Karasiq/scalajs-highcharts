...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplinerangeDataGrouping extends js.Object {
...
object SeriesAreasplinerangeDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesAreasplinerangeDataGrouping = {
    ...
    new SeriesAreasplinerangeDataGrouping {
