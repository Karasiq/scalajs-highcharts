...
/**
  * @note JavaScript name: <code>plotOptions-gantt-pathfinder-startMarker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttPathfinderStartMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttPathfinderStartMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, symbol: js.UndefOr[String] = js.undefined, radius: js.UndefOr[Double] = js.undefined, fill: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined): PlotOptionsGanttPathfinderStartMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttPathfinderStartMarker {
