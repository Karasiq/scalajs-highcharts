...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGanttDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[SeriesGanttDragDropDragHandle]] = js.undefined
...
object SeriesGanttDragDrop {
  /**
    ...
    */
  def apply(draggableStart: js.UndefOr[Boolean] = js.undefined, draggableEnd: js.UndefOr[Boolean] = js.undefined, draggableX1: js.UndefOr[Boolean] = js.undefined, draggableX2: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[SeriesGanttDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): SeriesGanttDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[SeriesGanttDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[SeriesGanttDragDropDragHandle]] = dragHandleOuter
