...
/**
  * @note JavaScript name: <code>plotOptions-wma-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWmaStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsWmaStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaStatesNormal {
