...
class ChartEvents extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/stock/chart/events-addseries/" target="_blank">Alert on add series</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/stock/chart/events-load/" target="_blank">Alert on chart load</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/stock/chart/events-redraw/" target="_blank">Alert on chart redraw, 
...
object ChartEvents {
  /**
    ...
    */
  def apply(addSeries: js.UndefOr[js.Function] = js.undefined, afterPrint: js.UndefOr[js.Function] = js.undefined, beforePrint: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, load: js.UndefOr[js.Function] = js.undefined, redraw: js.UndefOr[js.Function] = js.undefined, selection: js.UndefOr[js.Function] = js.undefined): ChartEvents = {
