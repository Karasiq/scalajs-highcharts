...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesColumnDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesColumnDataEvents]] = js.undefined
}
...
object SeriesColumnData {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesColumnDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesColumnDataEvents]] = js.undefined): SeriesColumnData = {
    val borderColorOuter: js.UndefOr[String | js.Object] = borderColor
    val borderWidthOuter: js.UndefOr[Double] = borderWidth
    val pointWidthOuter: js.UndefOr[Double] = pointWidth
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesColumnDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesColumnDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnData {
      override val borderColor: js.UndefOr[String | js.Object] = borderColorOuter
      override val borderWidth: js.UndefOr[Double] = borderWidthOuter
      override val pointWidth: js.UndefOr[Double] = pointWidthOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesColumnDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesColumnDataEvents]] = eventsOuter
    })
  }
}
