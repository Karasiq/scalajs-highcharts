...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAtrDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesAtrDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrDataLabelsFilter {
