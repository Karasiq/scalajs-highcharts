...
/**
  * @note JavaScript name: <code>plotOptions-sma-states-hover-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSmaStatesHoverMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaStatesHoverMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsSmaStatesHoverMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaStatesHoverMarkerStatesSelect {
