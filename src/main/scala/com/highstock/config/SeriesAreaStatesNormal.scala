...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesAreaStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaStatesNormal {
