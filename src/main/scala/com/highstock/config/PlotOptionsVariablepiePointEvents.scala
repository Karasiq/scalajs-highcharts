...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVariablepiePointEvents extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Fires when the legend item belonging to the pie point (slice) is
    * clicked. The <code>this</code> keyword refers to the point itself. One parameter,
    * <code>event</code>, is passed to the function, containing common event information. The
    * default action is to toggle the visibility of the point. This can be
    * prevented by calling <code>event.preventDefault()</code>.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/pie-point-events-legenditemclick/">Confirm toggle visibility</a>
    * @since 1.2.0
    */
...
object PlotOptionsVariablepiePointEvents {
  /**
    * @param legendItemClick <p>Fires when the legend item belonging to the pie point (slice) is. clicked. The <code>this</code> keyword refers to the point itself. One parameter,. <code>event</code>, is passed to the function, containing common event information. The. default action is to toggle the visibility of the point. This can be. prevented by calling <code>event.preventDefault()</code>.</p>
    ...
    */
  def apply(legendItemClick: js.UndefOr[js.Function] = js.undefined, dragStart: js.UndefOr[js.Function] = js.undefined, drag: js.UndefOr[js.Function] = js.undefined, drop: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsVariablepiePointEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariablepiePointEvents {
