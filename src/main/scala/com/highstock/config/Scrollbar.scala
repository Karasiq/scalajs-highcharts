...
class Scrollbar extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/scrollbar/enabled/" target="_blank">Disable the scrollbar, only use navigator</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/scrollbar/height/" target="_blank">A 30px scrollbar</a>
    */
