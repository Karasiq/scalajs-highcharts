...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesPyramidEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidEvents {
