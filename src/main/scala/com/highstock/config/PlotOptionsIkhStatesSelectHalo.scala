...
/**
  * @note JavaScript name: <code>plotOptions-ikh-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsIkhStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsIkhStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhStatesSelectHalo {
