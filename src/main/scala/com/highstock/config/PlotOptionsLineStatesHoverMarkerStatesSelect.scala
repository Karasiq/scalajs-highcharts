...
/**
  * @note JavaScript name: <code>plotOptions-line-states-hover-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsLineStatesHoverMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineStatesHoverMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsLineStatesHoverMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineStatesHoverMarkerStatesSelect {
