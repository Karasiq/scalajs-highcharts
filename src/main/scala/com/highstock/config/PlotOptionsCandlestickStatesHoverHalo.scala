...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCandlestickStatesHoverHalo extends js.Object {
...
object PlotOptionsCandlestickStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickStatesHoverHalo = {
    ...
    new PlotOptionsCandlestickStatesHoverHalo {
