...
/**
  * @note JavaScript name: <code>plotOptions-ad-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAdStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAdStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdStatesSelectHalo {
