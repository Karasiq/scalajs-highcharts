...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMaplineZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineZones {
