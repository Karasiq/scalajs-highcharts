...
/**
  * @note JavaScript name: <code>plotOptions-momentum-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMomentumMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMomentumMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumMarkerStates {
