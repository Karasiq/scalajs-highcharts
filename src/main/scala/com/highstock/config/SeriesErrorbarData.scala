...
class SeriesErrorbarData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesErrorbarDataDragDrop]] = js.undefined
...
object SeriesErrorbarData {
  /**
    ...
    */
  def apply(high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesErrorbarDataDragDrop]] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesErrorbarDataEvents]] = js.undefined): SeriesErrorbarData = {
    val highOuter: js.UndefOr[Double] = high
    val lowOuter: js.UndefOr[Double] = low
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesErrorbarDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarData {
      override val high: js.UndefOr[Double] = highOuter
      override val low: js.UndefOr[Double] = lowOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesErrorbarDataDragDrop]] = dragDropOuter
