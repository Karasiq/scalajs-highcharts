...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTilemapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 4.0
    */
  val attributes: js.Any = js.undefined
}

object PlotOptionsTilemapStatesHoverHalo {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Any] = js.undefined): PlotOptionsTilemapStatesHoverHalo = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val sizeOuter: js.UndefOr[Double] = size
    val opacityOuter: js.UndefOr[Double] = opacity
    val attributesOuter: js.Any = attributes
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapStatesHoverHalo {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val size: js.UndefOr[Double] = sizeOuter
      override val opacity: js.UndefOr[Double] = opacityOuter
      override val attributes: js.Any = attributesOuter
    })
  }
}
