...
/**
  * @note JavaScript name: <code>plotOptions-gantt-pathfinder</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttPathfinder extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val `type`: js.UndefOr[String] = "simpleConnect"
  ...
  /**
    ...
    * @since 6.2.0
    */
  val startMarker: js.Any = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  val endMarker: js.Any = js.undefined
...
object PlotOptionsGanttPathfinder {
  /**
    ...
    */
  def apply(`type`: js.UndefOr[String] = "simpleConnect", animation: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[js.Any] = js.undefined, endMarker: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, algorithmMargin: js.UndefOr[Double] = js.undefined): PlotOptionsGanttPathfinder = {
    val typeOuter: js.UndefOr[String] = `type`
    val animationOuter: js.Any = animation
    val startMarkerOuter: js.Any = startMarker
    val endMarkerOuter: js.Any = endMarker
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttPathfinder {
      override val `type`: js.UndefOr[String] = typeOuter
      override val animation: js.Any = animationOuter
      override val startMarker: js.Any = startMarkerOuter
      override val endMarker: js.Any = endMarkerOuter
