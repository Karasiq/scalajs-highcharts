...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBellcurveDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesBellcurveDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveDataLabelsFilter {
