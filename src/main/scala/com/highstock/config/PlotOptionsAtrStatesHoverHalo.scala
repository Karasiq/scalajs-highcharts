...
/**
  * @note JavaScript name: <code>plotOptions-atr-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAtrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAtrStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrStatesHoverHalo {
