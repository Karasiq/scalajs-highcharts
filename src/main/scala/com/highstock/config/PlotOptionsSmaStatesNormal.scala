...
/**
  * @note JavaScript name: <code>plotOptions-sma-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSmaStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsSmaStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaStatesNormal {
