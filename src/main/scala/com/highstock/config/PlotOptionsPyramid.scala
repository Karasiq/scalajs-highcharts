...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsPyramidPathfinder]] = js.undefined
}
...
object PlotOptionsPyramid {
  ...
  def apply(neckWidth: js.UndefOr[String] = js.undefined, neckHeight: js.UndefOr[String] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, center: js.UndefOr[js.Array[String | Double]] = js.undefined, width: js.UndefOr[Double | String] = js.undefined, height: js.UndefOr[Double | String] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, ignoreHiddenPoint: js.UndefOr[Boolean] = js.undefined, legendType: js.UndefOr[String] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, slicedOffset: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, endAngle: js.UndefOr[Double] = js.undefined, innerSize: js.UndefOr[Double | String] = js.undefined, minSize: js.UndefOr[Double] = js.undefined, startAngle: js.UndefOr[Double] = js.undefined, depth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[PlotOptionsPyramidPathfinder]] = js.undefined): PlotOptionsPyramid = {
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[PlotOptionsPyramidPathfinder]] = pathfinder
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid {
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsPyramidPathfinder]] = pathfinderOuter
    })
  }
}
