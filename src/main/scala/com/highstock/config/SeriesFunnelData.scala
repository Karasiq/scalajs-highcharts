...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesFunnelDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesFunnelDataEvents]] = js.undefined
}
...
object SeriesFunnelData {
  /**
    ...
    */
  def apply(legendIndex: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesFunnelDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesFunnelDataEvents]] = js.undefined): SeriesFunnelData = {
    val legendIndexOuter: js.UndefOr[Double] = legendIndex
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesFunnelDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesFunnelDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelData {
      override val legendIndex: js.UndefOr[Double] = legendIndexOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesFunnelDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesFunnelDataEvents]] = eventsOuter
    })
  }
}
