...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplineStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesAreasplineStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineStatesSelectMarkerStatesSelect {
