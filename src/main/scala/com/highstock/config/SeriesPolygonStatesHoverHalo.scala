...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPolygonStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonStatesHoverHalo {
