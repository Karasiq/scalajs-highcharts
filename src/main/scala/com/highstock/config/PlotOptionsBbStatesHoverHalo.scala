...
/**
  * @note JavaScript name: <code>plotOptions-bb-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBbStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsBbStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbStatesHoverHalo {
