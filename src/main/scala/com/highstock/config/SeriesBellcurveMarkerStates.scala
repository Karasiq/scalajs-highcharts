...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBellcurveMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesBellcurveMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveMarkerStates {
