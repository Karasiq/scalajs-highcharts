...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesIkhStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesIkhStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhStatesSelectHalo {
