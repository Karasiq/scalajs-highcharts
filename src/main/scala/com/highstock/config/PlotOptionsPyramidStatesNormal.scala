...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPyramidStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramidStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsPyramidStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramidStatesNormal {
