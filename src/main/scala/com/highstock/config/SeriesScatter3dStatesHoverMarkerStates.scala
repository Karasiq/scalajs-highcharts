...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesScatter3dStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesHoverMarkerStates {
