...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPriceenvelopesStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesPriceenvelopesStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesStatesNormal {
