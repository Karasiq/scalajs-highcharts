...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWordcloudStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudStatesHoverMarkerStates {
