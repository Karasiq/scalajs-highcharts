...
class PlotOptionsCandlestickDataGrouping extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-datagrouping-grouppixelwidth/" target="_blank">
