...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCandlestickDataGrouping extends js.Object {
  ...
  /**
    ...
    *  group. Possible values are "average", "averages", "open", "high", "low", "close" and "sum". For
    *  OHLC and candlestick series the approximation is "ohlc" by default, which finds the 
    *  open, high, low and close values within all the grouped data. For ranges, the approximation is "range", which finds the low and high values. For multi-dimensional data,
    *  like ranges and OHLC, "averages" will compute the average for each dimension.</p>
    *  
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-datagrouping-approximation" target="_blank">Approximation callback with custom data</a>.
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-datagrouping-grouppixelwidth/" target="_blank">
...
object PlotOptionsCandlestickDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): PlotOptionsCandlestickDataGrouping = {
    ...
    new PlotOptionsCandlestickDataGrouping {
