...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesZigzagDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesZigzagDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagDataLabelsFilter {
