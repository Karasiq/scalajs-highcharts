...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesColumnrangeStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeStatesNormal {
