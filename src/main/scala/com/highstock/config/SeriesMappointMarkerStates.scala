...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMappointMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointMarkerStates {
