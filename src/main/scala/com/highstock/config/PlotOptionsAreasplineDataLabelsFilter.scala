...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): PlotOptionsAreasplineDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineDataLabelsFilter {
