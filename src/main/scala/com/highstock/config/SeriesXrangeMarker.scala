...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeMarker {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesXrangeMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeMarker {
