...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesRsiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesRsiDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiDataLabelsFilter {
