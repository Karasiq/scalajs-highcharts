...
/**
  * @note JavaScript name: <code>plotOptions-scatter-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatterZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsScatterZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterZones {
