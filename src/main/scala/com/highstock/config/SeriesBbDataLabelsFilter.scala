...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBbDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesBbDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbDataLabelsFilter {
