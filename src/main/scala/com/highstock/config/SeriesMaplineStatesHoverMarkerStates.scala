...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMaplineStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesHoverMarkerStates {
