...
/**
  * @note JavaScript name: <code>plotOptions-wma-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWmaStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsWmaStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaStatesHoverMarkerStates {
