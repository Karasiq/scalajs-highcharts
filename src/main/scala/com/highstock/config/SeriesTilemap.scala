...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemap extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>tilemap</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of arrays with 3 or 2 values. In this case, the values
    * correspond to <code>x,y,value</code>. If the first value is a string, it is
    ...
    * points exceeds the series&#39; <a href="#series.tilemap.turboThreshold">turboThreshold</a>,
    ...
    * </li>
    * </ol>
    * <p>Note that for some <a href="#plotOptions.tilemap.tileShape">tileShapes</a> the grid
    * coordinates are offset.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/tilemap-gridoffset">Offset grid coordinates</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/chart/reflow-true/">Numerical values</a>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    */
  val data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  val `type`: js.UndefOr[String] = "tilemap"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesTilemapPathfinder]] = js.undefined
...
object SeriesTilemap {
  /**
    * @param data <p>An array of data points for the series. For the <code>tilemap</code> series. type, points can be given in the following ways:</p>. <ol>. <li><p>An array of arrays with 3 or 2 values. In this case, the values. correspond to <code>x,y,value</code>. If the first value is a string, it is. applied as the name of the point, and the <code>x</code> value is inferred.. The <code>x</code> value can also be omitted, in which case the inner arrays. should be of length 2. Then the <code>x</code> value is automatically calculated,. either starting at 0 and incremented by 1, or from <code>pointStart</code>. and <code>pointInterval</code> given in the series options.</p>. <pre><code class="language-js">data: [.     [0, 9, 7],.     [1, 10, 4],.     [2, 6, 3]. ]</code></pre>. </li>. <li><p>An array of objects with named values. The objects are point. configuration objects as seen below. If the total number of data. points exceeds the series&#39; <a href="#series.tilemap.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">data: [{.     x: 1,.     y: 3,.     value: 10,.     name: &quot;Point2&quot;,.     color: &quot;#00FF00&quot;. }, {.     x: 1,.     y: 7,.     value: 10,.     name: &quot;Point1&quot;,.     color: &quot;#FF00FF&quot;. }]</code></pre>. </li>. </ol>. <p>Note that for some <a href="#plotOptions.tilemap.tileShape">tileShapes</a> the grid. coordinates are offset.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "tilemap", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, tileShape: js.UndefOr[String] = js.undefined, colsize: js.UndefOr[Double] = js.undefined, rowsize: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, nullColor: js.UndefOr[String | js.Object] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesTilemapPathfinder]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[String] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined): SeriesTilemap = {
    val dataOuter: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = data
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesTilemapPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemap {
      override val data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = dataOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesTilemapPathfinder]] = pathfinderOuter
