...
/**
  * @note JavaScript name: <code>plotOptions-funnel-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFunnelStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsFunnelStatesSelect = {
    val colorOuter: js.UndefOr[String | js.Object] = color
    val borderColorOuter: js.UndefOr[String | js.Object] = borderColor
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val borderWidthOuter: js.UndefOr[Double] = borderWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelStatesSelect {
