...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesSankeyDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataLabelsFilter {
