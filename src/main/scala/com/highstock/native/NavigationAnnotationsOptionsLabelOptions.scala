...
/**
  * @note JavaScript name: <code>navigation-annotationsOptions-labelOptions</code>
  */
class NavigationAnnotationsOptionsLabelOptions extends com.highcharts.HighchartsGenericObject {
...
object NavigationAnnotationsOptionsLabelOptions {
  /**
