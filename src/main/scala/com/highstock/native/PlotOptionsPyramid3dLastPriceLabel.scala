...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-lastPrice-label</code>
  */
class PlotOptionsPyramid3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dLastPriceLabel {
  /**
