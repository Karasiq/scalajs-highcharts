...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dataSorting</code>
  */
class SeriesAbandsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAbandsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsDataSorting {
