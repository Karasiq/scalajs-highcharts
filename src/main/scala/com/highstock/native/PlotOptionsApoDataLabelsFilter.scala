...
/**
  * @note JavaScript name: <code>plotOptions-apo-dataLabels-filter</code>
  */
class PlotOptionsApoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsApoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoDataLabelsFilter {
