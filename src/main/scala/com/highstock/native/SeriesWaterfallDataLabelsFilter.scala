...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-dataLabels-filter</code>
  */
class SeriesWaterfallDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWaterfallDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataLabelsFilter {
