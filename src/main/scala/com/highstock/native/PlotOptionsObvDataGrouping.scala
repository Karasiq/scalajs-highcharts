...
/**
  * @note JavaScript name: <code>plotOptions-obv-dataGrouping</code>
  */
class PlotOptionsObvDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvDataGrouping {
  /**
