...
/**
  * @note JavaScript name: <code>plotOptions-item-marker</code>
  */
class PlotOptionsItemMarker extends com.highcharts.HighchartsGenericObject {
