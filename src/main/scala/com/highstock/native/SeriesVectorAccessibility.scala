...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-accessibility</code>
  */
class SeriesVectorAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVectorAccessibilityPoint]] = js.undefined
}

object SeriesVectorAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVectorAccessibilityPoint]] = js.undefined): SeriesVectorAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorAccessibility {
