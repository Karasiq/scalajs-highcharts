...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-data-accessibility</code>
  */
class SeriesNetworkgraphDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesNetworkgraphDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphDataAccessibility {
