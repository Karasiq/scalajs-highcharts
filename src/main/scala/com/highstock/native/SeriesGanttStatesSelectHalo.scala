...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-states-select-halo</code>
  */
class SeriesGanttStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesGanttStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttStatesSelectHalo {
