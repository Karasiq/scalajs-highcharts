...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dataLabels</code>
  */
class PlotOptionsHlcDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcDataLabels {
  /**
