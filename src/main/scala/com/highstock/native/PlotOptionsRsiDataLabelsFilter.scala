...
/**
  * @note JavaScript name: <code>plotOptions-rsi-dataLabels-filter</code>
  */
class PlotOptionsRsiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsRsiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiDataLabelsFilter {
