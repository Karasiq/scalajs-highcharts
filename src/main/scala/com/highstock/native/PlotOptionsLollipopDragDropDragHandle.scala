...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dragDrop-dragHandle</code>
  */
class PlotOptionsLollipopDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopDragDropDragHandle {
