...
object SeriesPsarParams {
  /**
    ...
    */
  def apply(decimals: js.UndefOr[Double] = js.undefined, increment: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, initialAccelerationFactor: js.UndefOr[Double] = js.undefined, maxAccelerationFactor: js.UndefOr[Double] = js.undefined): SeriesPsarParams = {
