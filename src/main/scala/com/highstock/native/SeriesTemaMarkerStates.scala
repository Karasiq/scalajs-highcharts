...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-marker-states</code>
  */
class SeriesTemaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTemaMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
