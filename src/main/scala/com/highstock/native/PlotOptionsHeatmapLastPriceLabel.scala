...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-lastPrice-label</code>
  */
class PlotOptionsHeatmapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapLastPriceLabel {
  /**
