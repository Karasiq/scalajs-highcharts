...
/**
  ...
  */
class ColorAxisLabels extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>How to handle overflowing labels on horizontal color axis. If set
    * to <code>&quot;allow&quot;</code>, it will not be aligned at all. By default it
...
object ColorAxisLabels {
  /**
    * @param overflow <p>How to handle overflowing labels on horizontal color axis. If set. to <code>&quot;allow&quot;</code>, it will not be aligned at all. By default it. <code>&quot;justify&quot;</code> labels inside the chart area. If there is room to. move it, it will be aligned to the edge, else it will be removed.</p>
    ...
    */
  def apply(overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, align: js.UndefOr[String] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, autoRotation: js.UndefOr[js.Array[Double]] = js.undefined, autoRotationLimit: js.UndefOr[Double] = js.undefined, distance: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, indentation: js.UndefOr[Double] = js.undefined, maxStaggerLines: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, skew3d: js.UndefOr[Boolean] = js.undefined, staggerLines: js.UndefOr[Double] = js.undefined, step: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): ColorAxisLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ColorAxisLabels {
