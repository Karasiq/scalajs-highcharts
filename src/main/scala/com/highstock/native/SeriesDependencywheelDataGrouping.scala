...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-dataGrouping</code>
  */
class SeriesDependencywheelDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDataGrouping {
  /**
