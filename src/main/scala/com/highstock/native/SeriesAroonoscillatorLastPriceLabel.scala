...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-lastPrice-label</code>
  */
class SeriesAroonoscillatorLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorLastPriceLabel {
  /**
