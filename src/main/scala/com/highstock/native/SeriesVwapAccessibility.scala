...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-accessibility</code>
  */
class SeriesVwapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVwapAccessibilityPoint]] = js.undefined
}

object SeriesVwapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVwapAccessibilityPoint]] = js.undefined): SeriesVwapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapAccessibility {
