...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-states-inactive</code>
  */
class SeriesSupertrendStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesSupertrendStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendStatesInactive {
