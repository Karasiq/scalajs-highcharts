...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-states-inactive</code>
  */
class SeriesPsarStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPsarStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarStatesInactive {
