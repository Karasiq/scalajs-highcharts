...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-states-hover-halo</code>
  */
class PlotOptionsLinearregressionangleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionangleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleStatesHoverHalo {
