...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-accessibility</code>
  */
class SeriesWindbarbDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesWindbarbDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataAccessibility {
