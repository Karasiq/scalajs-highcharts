...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-states-inactive</code>
  */
class SeriesTemaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTemaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaStatesInactive {
