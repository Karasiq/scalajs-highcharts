...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-marker-states</code>
  */
class SeriesWindbarbMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWindbarbMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
