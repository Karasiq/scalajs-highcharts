...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-accessibility</code>
  */
class SeriesDisparityindexAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDisparityindexAccessibilityPoint]] = js.undefined
}

object SeriesDisparityindexAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDisparityindexAccessibilityPoint]] = js.undefined): SeriesDisparityindexAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexAccessibility {
