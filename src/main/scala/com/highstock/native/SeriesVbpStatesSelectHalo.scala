...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-states-select-halo</code>
  */
class SeriesVbpStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesVbpStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpStatesSelectHalo {
