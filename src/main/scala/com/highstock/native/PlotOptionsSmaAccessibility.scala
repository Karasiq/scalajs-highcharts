...
/**
  * @note JavaScript name: <code>plotOptions-sma-accessibility</code>
  */
class PlotOptionsSmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSmaAccessibilityPoint]] = js.undefined
}

object PlotOptionsSmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSmaAccessibilityPoint]] = js.undefined): PlotOptionsSmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaAccessibility {
