...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-label</code>
  */
class SeriesHollowcandlestickLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickLabel {
  /**
