...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-layoutAlgorithm</code>
  */
class PlotOptionsNetworkgraphLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphLayoutAlgorithm {
  /**
