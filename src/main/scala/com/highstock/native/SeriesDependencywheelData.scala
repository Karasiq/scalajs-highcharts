...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-data</code>
  */
class SeriesDependencywheelData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesDependencywheelDataEvents]] = js.undefined
...
object SeriesDependencywheelData {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, from: js.UndefOr[String] = js.undefined, to: js.UndefOr[String] = js.undefined, weight: js.UndefOr[Double | Null] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesDependencywheelDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined): SeriesDependencywheelData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelData {
      this.color = color
      this.from = from
      this.to = to
      this.weight = weight
