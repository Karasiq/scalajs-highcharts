...
/**
  * @note JavaScript name: <code>plotOptions-pc-point-events</code>
  */
class PlotOptionsPcPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsPcPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcPointEvents {
      this.click = click
      this.drag = drag
