...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-marker-states</code>
  */
class SeriesApoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesApoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
