...
/**
  * @note JavaScript name: <code>plotOptions-ao-lastPrice-label</code>
  */
class PlotOptionsAoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoLastPriceLabel {
  /**
