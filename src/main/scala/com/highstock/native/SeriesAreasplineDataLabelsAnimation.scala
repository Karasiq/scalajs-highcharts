...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-dataLabels-animation</code>
  */
class SeriesAreasplineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreasplineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
