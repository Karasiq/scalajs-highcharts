...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-inactive</code>
  */
class SeriesMaplineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMaplineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesInactive {
