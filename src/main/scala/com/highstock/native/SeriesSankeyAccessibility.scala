...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-accessibility</code>
  */
class SeriesSankeyAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSankeyAccessibilityPoint]] = js.undefined
}

object SeriesSankeyAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSankeyAccessibilityPoint]] = js.undefined): SeriesSankeyAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyAccessibility {
