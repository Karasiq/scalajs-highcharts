...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-accessibility-point</code>
  */
class SeriesApoAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesApoAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoAccessibilityPoint {
