...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-states-inactive</code>
  */
class SeriesCylinderStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesCylinderStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderStatesInactive {
