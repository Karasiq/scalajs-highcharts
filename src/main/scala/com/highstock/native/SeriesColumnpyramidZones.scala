...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-zones</code>
  */
class SeriesColumnpyramidZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidZones {
