...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-dragDrop</code>
  */
class SeriesItemDataDragDrop extends com.highcharts.HighchartsGenericObject {
