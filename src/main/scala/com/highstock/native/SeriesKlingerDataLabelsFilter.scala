...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dataLabels-filter</code>
  */
class SeriesKlingerDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesKlingerDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerDataLabelsFilter {
