...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-accessibility</code>
  */
class SeriesDpoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDpoAccessibilityPoint]] = js.undefined
}

object SeriesDpoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDpoAccessibilityPoint]] = js.undefined): SeriesDpoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoAccessibility {
