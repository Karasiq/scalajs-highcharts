...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data-dataLabels-filter</code>
  */
class SeriesPackedbubbleDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleDataDataLabelsFilter {
