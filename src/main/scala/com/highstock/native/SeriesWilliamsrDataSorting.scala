...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dataSorting</code>
  */
class SeriesWilliamsrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesWilliamsrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrDataSorting {
