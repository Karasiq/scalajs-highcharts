...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-dataLabels</code>
  */
class SeriesHeikinashiDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataDataLabels {
  /**
