...
/**
  * @note JavaScript name: <code>plotOptions-abands-marker</code>
  */
class PlotOptionsAbandsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsMarker {
  /**
