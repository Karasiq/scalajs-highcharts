...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-states-hover-halo</code>
  */
class SeriesDisparityindexStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDisparityindexStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexStatesHoverHalo {
