...
/**
  * @note JavaScript name: <code>plotOptions-mfi-dataGrouping</code>
  */
class PlotOptionsMfiDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiDataGrouping {
  /**
