...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-label</code>
  */
class SeriesWilliamsrLabel extends com.highcharts.HighchartsGenericObject {
