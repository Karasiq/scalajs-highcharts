...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-states</code>
  */
class SeriesAoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesAoStatesSelect]] = js.undefined
}

object SeriesAoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAoStatesSelect]] = js.undefined): SeriesAoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoStates {
      this.hover = hover
