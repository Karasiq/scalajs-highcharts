...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-lastPrice-label</code>
  */
class SeriesBubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleLastPriceLabel {
  /**
