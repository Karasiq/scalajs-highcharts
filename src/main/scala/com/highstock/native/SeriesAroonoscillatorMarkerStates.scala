...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-marker-states</code>
  */
class SeriesAroonoscillatorMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAroonoscillatorMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
