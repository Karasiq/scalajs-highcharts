...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-label</code>
  */
class SeriesLinearregressioninterceptLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptLabel {
  /**
