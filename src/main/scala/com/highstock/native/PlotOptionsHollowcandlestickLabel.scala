...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-label</code>
  */
class PlotOptionsHollowcandlestickLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickLabel {
  /**
