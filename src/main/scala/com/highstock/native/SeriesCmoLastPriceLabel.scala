...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-lastPrice-label</code>
  */
class SeriesCmoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoLastPriceLabel {
  /**
