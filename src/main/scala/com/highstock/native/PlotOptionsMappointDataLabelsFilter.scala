...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-dataLabels-filter</code>
  */
class PlotOptionsMappointDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMappointDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointDataLabelsFilter {
