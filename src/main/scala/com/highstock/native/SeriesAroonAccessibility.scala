...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-accessibility</code>
  */
class SeriesAroonAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAroonAccessibilityPoint]] = js.undefined
}

object SeriesAroonAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAroonAccessibilityPoint]] = js.undefined): SeriesAroonAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonAccessibility {
