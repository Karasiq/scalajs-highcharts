...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-accessibility</code>
  */
class SeriesBoxplotAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBoxplotAccessibilityPoint]] = js.undefined
}

object SeriesBoxplotAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBoxplotAccessibilityPoint]] = js.undefined): SeriesBoxplotAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotAccessibility {
