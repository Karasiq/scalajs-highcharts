...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-lastPrice-label</code>
  */
class PlotOptionsPriceenvelopesLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesLastPriceLabel {
  /**
