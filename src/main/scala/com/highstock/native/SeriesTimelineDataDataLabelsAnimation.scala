...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-dataLabels-animation</code>
  */
class SeriesTimelineDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTimelineDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
