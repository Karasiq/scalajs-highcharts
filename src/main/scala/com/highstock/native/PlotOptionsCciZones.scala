...
/**
  * @note JavaScript name: <code>plotOptions-cci-zones</code>
  */
class PlotOptionsCciZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCciZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciZones {
