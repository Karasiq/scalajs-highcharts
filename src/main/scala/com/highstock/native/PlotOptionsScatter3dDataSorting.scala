...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dataSorting</code>
  */
class PlotOptionsScatter3dDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsScatter3dDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dDataSorting {
