...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-lastPrice-label</code>
  */
class PlotOptionsLinearregressionLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionLastPriceLabel {
  /**
