...
/**
  * @note JavaScript name: <code>plotOptions-vector-dataSorting</code>
  */
class PlotOptionsVectorDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsVectorDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorDataSorting {
