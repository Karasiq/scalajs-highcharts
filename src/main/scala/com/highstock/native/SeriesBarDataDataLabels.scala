...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-data-dataLabels</code>
  */
class SeriesBarDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataDataLabels {
  /**
