...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-states-select-halo</code>
  */
class SeriesLinearregressionStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressionStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionStatesSelectHalo {
