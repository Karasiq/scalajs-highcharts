...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-states-hover-halo</code>
  */
class SeriesAdStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAdStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdStatesHoverHalo {
