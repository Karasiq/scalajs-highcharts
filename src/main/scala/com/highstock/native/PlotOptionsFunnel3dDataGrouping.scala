...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-dataGrouping</code>
  */
class PlotOptionsFunnel3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dDataGrouping {
  /**
