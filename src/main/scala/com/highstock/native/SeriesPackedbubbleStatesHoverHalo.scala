...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states-hover-halo</code>
  */
class SeriesPackedbubbleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStatesHoverHalo {
      this.size = size
