...
/**
  * @note JavaScript name: <code>plotOptions-ad-dataLabels</code>
  */
class PlotOptionsAdDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdDataLabels {
  /**
