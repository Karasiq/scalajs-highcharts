...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-marker-states</code>
  */
class PlotOptionsLinearregressionangleMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressionangleMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
