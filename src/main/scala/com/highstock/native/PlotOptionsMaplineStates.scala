...
/**
  ...
  */
class PlotOptionsMaplineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelect]] = js.undefined
}
...
object PlotOptionsMaplineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelect]] = js.undefined): PlotOptionsMaplineStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineStates {
      this.hover = hover
