...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-dataSorting</code>
  */
class SeriesVariwideDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesVariwideDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataSorting {
