...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-lastPrice-label</code>
  */
class PlotOptionsWindbarbLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbLastPriceLabel {
  /**
