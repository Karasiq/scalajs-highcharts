...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-states-inactive</code>
  */
class SeriesOrganizationLevelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesOrganizationLevelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsStatesInactive {
