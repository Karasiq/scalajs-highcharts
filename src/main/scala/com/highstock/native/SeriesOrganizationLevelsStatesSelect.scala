...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-states-select</code>
  */
class SeriesOrganizationLevelsStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesOrganizationLevelsStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsStatesSelect {
