...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-lastPrice-label</code>
  */
class SeriesMaplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineLastPriceLabel {
  /**
