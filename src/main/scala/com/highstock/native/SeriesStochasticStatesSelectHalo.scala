...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-states-select-halo</code>
  */
class SeriesStochasticStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesStochasticStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticStatesSelectHalo {
