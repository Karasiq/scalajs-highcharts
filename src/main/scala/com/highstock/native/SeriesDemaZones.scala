...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-zones</code>
  */
class SeriesDemaZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDemaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaZones {
