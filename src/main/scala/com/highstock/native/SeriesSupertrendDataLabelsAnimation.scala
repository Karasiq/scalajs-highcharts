...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dataLabels-animation</code>
  */
class SeriesSupertrendDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSupertrendDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendDataLabelsAnimation {
      this.defer = defer
    })
  }
}
