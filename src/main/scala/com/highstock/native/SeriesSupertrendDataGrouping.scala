...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dataGrouping</code>
  */
class SeriesSupertrendDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDataGrouping {
  /**
