...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-accessibility</code>
  */
class PlotOptionsDumbbellAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDumbbellAccessibilityPoint]] = js.undefined
}

object PlotOptionsDumbbellAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDumbbellAccessibilityPoint]] = js.undefined): PlotOptionsDumbbellAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellAccessibility {
