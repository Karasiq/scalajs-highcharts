...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dataSorting</code>
  */
class SeriesColumnpyramidDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesColumnpyramidDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataSorting {
