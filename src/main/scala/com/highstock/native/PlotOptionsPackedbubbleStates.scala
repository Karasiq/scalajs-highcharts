...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-states</code>
  */
class PlotOptionsPackedbubbleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleStatesSelect]] = js.undefined
}

object PlotOptionsPackedbubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleStatesSelect]] = js.undefined): PlotOptionsPackedbubbleStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleStates {
      this.hover = hover
