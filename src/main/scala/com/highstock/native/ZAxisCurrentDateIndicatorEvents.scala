...
/**
  * @note JavaScript name: <code>zAxis-currentDateIndicator-events</code>
  */
class ZAxisCurrentDateIndicatorEvents extends com.highcharts.HighchartsGenericObject {
...
object ZAxisCurrentDateIndicatorEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): ZAxisCurrentDateIndicatorEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ZAxisCurrentDateIndicatorEvents {
      this.click = click
