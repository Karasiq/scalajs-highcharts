...
/**
  * @note JavaScript name: <code>plotOptions-klinger-states-inactive</code>
  */
class PlotOptionsKlingerStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerStatesInactive {
