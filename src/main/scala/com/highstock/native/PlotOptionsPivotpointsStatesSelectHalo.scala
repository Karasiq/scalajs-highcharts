...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-states-select-halo</code>
  */
class PlotOptionsPivotpointsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPivotpointsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsStatesSelectHalo {
