...
/**
  * @note JavaScript name: <code>plotOptions-cci-marker-states</code>
  */
class PlotOptionsCciMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsCciMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
