...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-marker-states</code>
  */
class SeriesVwapMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVwapMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
