...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-marker-states-select</code>
  */
class SeriesLinearregressionangleMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleMarkerStatesSelect {
