...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-states-hover-halo</code>
  */
class SeriesHollowcandlestickStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickStatesHoverHalo {
