...
/**
  * @note JavaScript name: <code>plotOptions-ema-states-hover-halo</code>
  */
class PlotOptionsEmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsEmaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaStatesHoverHalo {
