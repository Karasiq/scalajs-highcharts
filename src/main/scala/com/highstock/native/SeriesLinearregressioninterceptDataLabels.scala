...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dataLabels</code>
  */
class SeriesLinearregressioninterceptDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDataLabels {
  /**
