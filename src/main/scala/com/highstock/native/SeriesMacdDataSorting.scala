...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-dataSorting</code>
  */
class SeriesMacdDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMacdDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdDataSorting {
