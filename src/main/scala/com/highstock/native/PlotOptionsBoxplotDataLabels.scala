...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-dataLabels</code>
  */
class PlotOptionsBoxplotDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotDataLabels {
  /**
