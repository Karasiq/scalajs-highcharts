...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-states-inactive</code>
  */
class SeriesStreamgraphStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesStreamgraphStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphStatesInactive {
