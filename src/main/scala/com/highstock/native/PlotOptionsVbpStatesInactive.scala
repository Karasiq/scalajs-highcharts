...
/**
  * @note JavaScript name: <code>plotOptions-vbp-states-inactive</code>
  */
class PlotOptionsVbpStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsVbpStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpStatesInactive {
