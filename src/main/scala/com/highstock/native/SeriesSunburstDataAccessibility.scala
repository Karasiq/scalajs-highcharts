...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-data-accessibility</code>
  */
class SeriesSunburstDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSunburstDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataAccessibility {
