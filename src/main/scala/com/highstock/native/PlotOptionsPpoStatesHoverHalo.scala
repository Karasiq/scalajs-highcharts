...
/**
  * @note JavaScript name: <code>plotOptions-ppo-states-hover-halo</code>
  */
class PlotOptionsPpoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPpoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoStatesHoverHalo {
