...
/**
  * @note JavaScript name: <code>plotOptions-timeline-states-hover-halo</code>
  */
class PlotOptionsTimelineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineStatesHoverHalo {
