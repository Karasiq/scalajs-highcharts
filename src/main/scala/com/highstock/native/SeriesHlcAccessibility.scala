...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-accessibility</code>
  */
class SeriesHlcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesHlcAccessibilityPoint]] = js.undefined
}

object SeriesHlcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesHlcAccessibilityPoint]] = js.undefined): SeriesHlcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcAccessibility {
