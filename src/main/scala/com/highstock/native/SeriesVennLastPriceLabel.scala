...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-lastPrice-label</code>
  */
class SeriesVennLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennLastPriceLabel {
  /**
