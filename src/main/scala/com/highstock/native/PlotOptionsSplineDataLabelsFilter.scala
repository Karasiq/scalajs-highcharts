...
/**
  * @note JavaScript name: <code>plotOptions-spline-dataLabels-filter</code>
  */
class PlotOptionsSplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSplineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineDataLabelsFilter {
