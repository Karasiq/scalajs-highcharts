...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-dataLabels-animation</code>
  */
class SeriesFunnel3dDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
