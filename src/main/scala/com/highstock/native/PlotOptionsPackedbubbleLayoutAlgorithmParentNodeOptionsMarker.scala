...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-layoutAlgorithm-parentNodeOptions-marker</code>
  */
class PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsMarker {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[js.Any] = js.undefined, fillOpacity: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[js.Any] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleLayoutAlgorithmParentNodeOptionsMarker {
