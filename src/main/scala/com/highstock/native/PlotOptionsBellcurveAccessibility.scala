...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-accessibility</code>
  */
class PlotOptionsBellcurveAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBellcurveAccessibilityPoint]] = js.undefined
}

object PlotOptionsBellcurveAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBellcurveAccessibilityPoint]] = js.undefined): PlotOptionsBellcurveAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveAccessibility {
