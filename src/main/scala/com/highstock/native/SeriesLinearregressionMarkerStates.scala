...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-marker-states</code>
  */
class SeriesLinearregressionMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLinearregressionMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
