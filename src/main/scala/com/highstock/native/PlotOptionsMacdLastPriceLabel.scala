...
/**
  * @note JavaScript name: <code>plotOptions-macd-lastPrice-label</code>
  */
class PlotOptionsMacdLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdLastPriceLabel {
  /**
