...
/**
  * @note JavaScript name: <code>plotOptions-bubble-dataGrouping</code>
  */
class PlotOptionsBubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleDataGrouping {
  /**
