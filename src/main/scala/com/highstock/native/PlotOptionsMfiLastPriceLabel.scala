...
/**
  * @note JavaScript name: <code>plotOptions-mfi-lastPrice-label</code>
  */
class PlotOptionsMfiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiLastPriceLabel {
  /**
