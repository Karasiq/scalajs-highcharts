...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-lastPrice-label</code>
  */
class SeriesWilliamsrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrLastPriceLabel {
  /**
