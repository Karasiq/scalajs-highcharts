...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-zones</code>
  */
class SeriesLinearregressionslopeZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeZones {
