...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-states-inactive</code>
  */
class SeriesMapbubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMapbubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStatesInactive {
