...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-dataLabels-filter</code>
  */
class SeriesOhlcDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOhlcDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcDataLabelsFilter {
