...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-data-dataLabels</code>
  */
class SeriesOhlcDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataDataLabels {
  /**
