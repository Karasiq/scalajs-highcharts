...
/**
  * @note JavaScript name: <code>plotOptions-area-connectors-endMarker</code>
  */
class PlotOptionsAreaConnectorsEndMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaConnectorsEndMarker {
  /**
    ...
    */
  def apply(symbol: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsAreaConnectorsEndMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaConnectorsEndMarker {
      this.symbol = symbol
      this.align = align
      this.color = color
