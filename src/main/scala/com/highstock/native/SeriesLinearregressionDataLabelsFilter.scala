...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dataLabels-filter</code>
  */
class SeriesLinearregressionDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionDataLabelsFilter {
