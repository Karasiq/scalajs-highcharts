...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-connectors-marker</code>
  */
class SeriesCandlestickConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesCandlestickConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickConnectorsMarker {
      this.align = align
      this.color = color
