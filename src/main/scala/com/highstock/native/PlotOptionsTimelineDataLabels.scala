...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dataLabels</code>
  */
class PlotOptionsTimelineDataLabels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Whether to position data labels alternately. For example, if
    * <a href="#plotOptions.timeline.dataLabels.distance">distance</a>
    * is set equal to <code>100</code>, then data labels will be positioned
    * alternately (on both sides of the point) at a distance of 100px.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series-timeline/alternate-disabled">Alternate disabled</a>
    * @since 7.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/color-axis/">White data labels</a>
  ...
  /**
    * <p>The color of the line connecting the data label to the point.
    ...
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series-timeline/connector-styles">Custom connector width and color</a>
    * @since 7.0.0
    */
  var connectorColor: js.UndefOr[String | js.Object] = js.undefined

  /**
    * <p>The width of the line connecting the data label to the point.</p>
  ...
  /**
    * <p>A pixel value defining the distance between the data label and
    * the point. Negative numbers puts the label on top of the point.</p>
    * @since 7.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/color-axis/">Data labels enabled</a>
  ...
  /**
    * <p>Shadow options for the data label.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-datalabels-box/">Data labels box options</a>
    * @since 2.2.1
    */
...
object PlotOptionsTimelineDataLabels {
  /**
    ...
    * @param alternate <p>Whether to position data labels alternately. For example, if. <a href="#plotOptions.timeline.dataLabels.distance">distance</a>. is set equal to <code>100</code>, then data labels will be positioned. alternately (on both sides of the point) at a distance of 100px.</p>
    ...
    * @param connectorColor <p>The color of the line connecting the data label to the point.. The default color is the same as the point&#39;s color.</p>. <p>In styled mode, the connector stroke is given in the. <code>.highcharts-data-label-connector</code> class.</p>
    * @param connectorWidth <p>The width of the line connecting the data label to the point.</p>. <p>In styled mode, the connector stroke width is given in the. <code>.highcharts-data-label-connector</code> class.</p>
    * @param distance <p>A pixel value defining the distance between the data label and. the point. Negative numbers puts the label on top of the point.</p>
    ...
    * @param shadow <p>Shadow options for the data label.</p>
    ...
    */
  def apply(allowOverlap: js.UndefOr[Boolean] = js.undefined, alternate: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String] = js.undefined, connectorColor: js.UndefOr[String | js.Object] = js.undefined, connectorWidth: js.UndefOr[Double] = js.undefined, distance: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, width: js.UndefOr[Double] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, className: js.UndefOr[String] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, format: js.UndefOr[String] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shape: js.UndefOr[String] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineDataLabels {
