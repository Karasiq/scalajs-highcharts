...
/**
  * @note JavaScript name: <code>plotOptions-venn-states-select</code>
  */
class PlotOptionsVennStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[PlotOptionsVennStatesSelectMarker]] = js.undefined
}

object PlotOptionsVennStatesSelect {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, color: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsVennStatesSelectMarker]] = js.undefined): PlotOptionsVennStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennStatesSelect {
