...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-dataLabels-filter</code>
  */
class SeriesMapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapDataLabelsFilter {
