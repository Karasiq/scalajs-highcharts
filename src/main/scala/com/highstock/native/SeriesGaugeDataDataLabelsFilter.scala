...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-data-dataLabels-filter</code>
  */
class SeriesGaugeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesGaugeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataDataLabelsFilter {
