...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-data-dataLabels-filter</code>
  */
class SeriesAreasplinerangeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataDataLabelsFilter {
