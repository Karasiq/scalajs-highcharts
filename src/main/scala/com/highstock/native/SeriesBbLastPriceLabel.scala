...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-lastPrice-label</code>
  */
class SeriesBbLastPriceLabel extends com.highcharts.HighchartsGenericObject {
