...
/**
  * @note JavaScript name: <code>plotOptions-dpo-dataLabels-animation</code>
  */
class PlotOptionsDpoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDpoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
