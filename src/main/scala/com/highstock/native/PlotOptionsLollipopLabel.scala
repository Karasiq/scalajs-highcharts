...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-label</code>
  */
class PlotOptionsLollipopLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopLabel {
  /**
