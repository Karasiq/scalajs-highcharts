...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-marker</code>
  */
class SeriesOrganizationMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationMarker {
  /**
