...
/**
  * @note JavaScript name: <code>plotOptions-gauge-accessibility</code>
  */
class PlotOptionsGaugeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsGaugeAccessibilityPoint]] = js.undefined
}

object PlotOptionsGaugeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsGaugeAccessibilityPoint]] = js.undefined): PlotOptionsGaugeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGaugeAccessibility {
