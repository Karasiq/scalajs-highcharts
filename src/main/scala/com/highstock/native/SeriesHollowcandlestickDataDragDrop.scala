...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-data-dragDrop</code>
  */
class SeriesHollowcandlestickDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataDragDrop {
  /**
