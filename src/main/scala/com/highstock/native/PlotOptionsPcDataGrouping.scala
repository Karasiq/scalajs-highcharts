...
/**
  * @note JavaScript name: <code>plotOptions-pc-dataGrouping</code>
  */
class PlotOptionsPcDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcDataGrouping {
  /**
