...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-marker-states-hover</code>
  */
class SeriesHeatmapMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapMarkerStatesHover {
  /**
    ...
    */
  def apply(height: js.UndefOr[js.UndefOr[Double]] = js.undefined, heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, lineWidthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesHeatmapMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapMarkerStatesHover {
      this.height = height
