...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-marker-states-select</code>
  */
class SeriesKeltnerchannelsMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsMarkerStatesSelect {
