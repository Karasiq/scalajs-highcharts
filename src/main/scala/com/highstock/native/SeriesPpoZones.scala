...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-zones</code>
  */
class SeriesPpoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPpoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoZones {
