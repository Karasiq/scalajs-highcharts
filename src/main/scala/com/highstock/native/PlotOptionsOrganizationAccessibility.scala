...
/**
  * @note JavaScript name: <code>plotOptions-organization-accessibility</code>
  */
class PlotOptionsOrganizationAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsOrganizationAccessibilityPoint]] = js.undefined
}

object PlotOptionsOrganizationAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsOrganizationAccessibilityPoint]] = js.undefined): PlotOptionsOrganizationAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationAccessibility {
