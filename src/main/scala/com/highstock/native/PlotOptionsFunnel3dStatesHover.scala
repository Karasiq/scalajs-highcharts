...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-states-hover</code>
  */
class PlotOptionsFunnel3dStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsFunnel3dStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dStatesHover {
