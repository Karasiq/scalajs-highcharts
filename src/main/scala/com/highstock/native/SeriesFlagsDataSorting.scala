...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-dataSorting</code>
  */
class SeriesFlagsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesFlagsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsDataSorting {
