...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-dataLabels-animation</code>
  */
class PlotOptionsPriceenvelopesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPriceenvelopesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
