...
/**
  * @note JavaScript name: <code>plotOptions-klinger-label</code>
  */
class PlotOptionsKlingerLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerLabel {
  /**
