...
/**
  * @note JavaScript name: <code>plotOptions-ppo-dataLabels-animation</code>
  */
class PlotOptionsPpoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPpoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
