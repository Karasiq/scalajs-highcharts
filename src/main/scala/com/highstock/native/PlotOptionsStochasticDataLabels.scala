...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-dataLabels</code>
  */
class PlotOptionsStochasticDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticDataLabels {
  /**
