...
/**
  * @note JavaScript name: <code>plotOptions-trendline-states-hover-halo</code>
  */
class PlotOptionsTrendlineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTrendlineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineStatesHoverHalo {
