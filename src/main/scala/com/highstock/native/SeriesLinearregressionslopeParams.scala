...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-params</code>
  */
class SeriesLinearregressionslopeParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeParams {
