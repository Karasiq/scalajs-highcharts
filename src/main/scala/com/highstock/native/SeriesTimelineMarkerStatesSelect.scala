...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-marker-states-select</code>
  */
class SeriesTimelineMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesTimelineMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineMarkerStatesSelect {
