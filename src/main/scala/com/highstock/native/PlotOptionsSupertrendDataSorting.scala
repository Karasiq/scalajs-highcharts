...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-dataSorting</code>
  */
class PlotOptionsSupertrendDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsSupertrendDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendDataSorting {
