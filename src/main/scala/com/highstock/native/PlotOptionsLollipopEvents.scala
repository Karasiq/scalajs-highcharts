...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-events</code>
  */
class PlotOptionsLollipopEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsLollipopEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopEvents {
