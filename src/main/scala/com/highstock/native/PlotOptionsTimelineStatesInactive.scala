...
/**
  * @note JavaScript name: <code>plotOptions-timeline-states-inactive</code>
  */
class PlotOptionsTimelineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineStatesInactive {
