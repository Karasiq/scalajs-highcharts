...
/**
  * @note JavaScript name: <code>plotOptions-roc-dataLabels</code>
  */
class PlotOptionsRocDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocDataLabels {
  /**
