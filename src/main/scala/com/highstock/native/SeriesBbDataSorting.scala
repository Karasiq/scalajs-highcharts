...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-dataSorting</code>
  */
class SeriesBbDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesBbDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbDataSorting {
