...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-states</code>
  */
class SeriesLinearregressionslopeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesLinearregressionslopeStatesSelect]] = js.undefined
}

object SeriesLinearregressionslopeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesLinearregressionslopeStatesSelect]] = js.undefined): SeriesLinearregressionslopeStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeStates {
      this.hover = hover
