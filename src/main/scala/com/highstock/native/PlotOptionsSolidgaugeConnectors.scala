...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-connectors</code>
  */
class PlotOptionsSolidgaugeConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeConnectorsStartMarker]] = js.undefined
...
object PlotOptionsSolidgaugeConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsSolidgaugeConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugeConnectors {
