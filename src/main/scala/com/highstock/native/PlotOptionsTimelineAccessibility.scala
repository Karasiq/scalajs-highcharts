...
/**
  * @note JavaScript name: <code>plotOptions-timeline-accessibility</code>
  */
class PlotOptionsTimelineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTimelineAccessibilityPoint]] = js.undefined
}

object PlotOptionsTimelineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTimelineAccessibilityPoint]] = js.undefined): PlotOptionsTimelineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineAccessibility {
