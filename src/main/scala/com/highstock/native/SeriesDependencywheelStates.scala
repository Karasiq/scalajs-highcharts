...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-states</code>
  */
class SeriesDependencywheelStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesDependencywheelStatesSelect]] = js.undefined
...
object SeriesDependencywheelStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDependencywheelStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesDependencywheelStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelStates {
      this.hover = hover
