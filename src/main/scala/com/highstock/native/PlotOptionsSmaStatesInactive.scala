...
/**
  * @note JavaScript name: <code>plotOptions-sma-states-inactive</code>
  */
class PlotOptionsSmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaStatesInactive {
