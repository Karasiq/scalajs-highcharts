...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-marker-states-select</code>
  */
class SeriesNatrMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesNatrMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrMarkerStatesSelect {
