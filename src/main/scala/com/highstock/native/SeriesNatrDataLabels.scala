...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dataLabels</code>
  */
class SeriesNatrDataLabels extends com.highcharts.HighchartsGenericObject {
