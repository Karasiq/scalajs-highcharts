...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-lastPrice-label</code>
  */
class SeriesPpoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoLastPriceLabel {
  /**
