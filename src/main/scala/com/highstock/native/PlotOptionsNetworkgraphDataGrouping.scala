...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-dataGrouping</code>
  */
class PlotOptionsNetworkgraphDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphDataGrouping {
  /**
