...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-lastPrice-label</code>
  */
class PlotOptionsErrorbarLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarLastPriceLabel {
  /**
