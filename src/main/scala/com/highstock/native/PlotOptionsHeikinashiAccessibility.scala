...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-accessibility</code>
  */
class PlotOptionsHeikinashiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsHeikinashiAccessibilityPoint]] = js.undefined
}

object PlotOptionsHeikinashiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsHeikinashiAccessibilityPoint]] = js.undefined): PlotOptionsHeikinashiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiAccessibility {
