...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-accessibility-point</code>
  */
class SeriesColumnrangeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesColumnrangeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeAccessibilityPoint {
