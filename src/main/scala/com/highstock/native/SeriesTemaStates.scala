...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-states</code>
  */
class SeriesTemaStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesTemaStatesSelect]] = js.undefined
}

object SeriesTemaStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesTemaStatesSelect]] = js.undefined): SeriesTemaStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaStates {
      this.hover = hover
