...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-states-hover-halo</code>
  */
class SeriesBellcurveStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBellcurveStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveStatesHoverHalo {
