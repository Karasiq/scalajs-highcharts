...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-accessibility</code>
  */
class SeriesCmfAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesCmfAccessibilityPoint]] = js.undefined
}

object SeriesCmfAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesCmfAccessibilityPoint]] = js.undefined): SeriesCmfAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfAccessibility {
