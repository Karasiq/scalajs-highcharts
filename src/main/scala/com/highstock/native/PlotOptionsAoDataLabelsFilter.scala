...
/**
  * @note JavaScript name: <code>plotOptions-ao-dataLabels-filter</code>
  */
class PlotOptionsAoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoDataLabelsFilter {
