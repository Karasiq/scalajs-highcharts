...
/**
  * @note JavaScript name: <code>plotOptions-cmo-zones</code>
  */
class PlotOptionsCmoZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCmoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoZones {
