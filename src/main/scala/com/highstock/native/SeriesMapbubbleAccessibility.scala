...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-accessibility</code>
  */
class SeriesMapbubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMapbubbleAccessibilityPoint]] = js.undefined
}

object SeriesMapbubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMapbubbleAccessibilityPoint]] = js.undefined): SeriesMapbubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleAccessibility {
