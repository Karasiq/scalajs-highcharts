...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-dataLabels-animation</code>
  */
class PlotOptionsCandlestickDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickDataLabelsAnimation {
      this.defer = defer
    })
  }
}
