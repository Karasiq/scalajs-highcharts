...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-accessibility</code>
  */
class SeriesSunburstAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSunburstAccessibilityPoint]] = js.undefined
}

object SeriesSunburstAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSunburstAccessibilityPoint]] = js.undefined): SeriesSunburstAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstAccessibility {
