...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-accessibility-point</code>
  */
class SeriesNatrAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesNatrAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrAccessibilityPoint {
