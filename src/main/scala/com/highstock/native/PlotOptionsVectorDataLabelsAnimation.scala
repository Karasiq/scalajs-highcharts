...
/**
  * @note JavaScript name: <code>plotOptions-vector-dataLabels-animation</code>
  */
class PlotOptionsVectorDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVectorDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorDataLabelsAnimation {
      this.defer = defer
    })
  }
}
