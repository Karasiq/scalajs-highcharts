...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-states-inactive</code>
  */
class SeriesAdStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAdStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdStatesInactive {
