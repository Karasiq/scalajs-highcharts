...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-zones</code>
  */
class SeriesCciZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCciZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciZones {
