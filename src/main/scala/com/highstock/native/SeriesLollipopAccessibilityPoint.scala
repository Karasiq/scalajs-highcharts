...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-accessibility-point</code>
  */
class SeriesLollipopAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesLollipopAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopAccessibilityPoint {
