...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-accessibility-point</code>
  */
class SeriesTimelineAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTimelineAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineAccessibilityPoint {
