...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-dataLabels</code>
  */
class PlotOptionsOrganizationLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLevelsDataLabels {
  /**
