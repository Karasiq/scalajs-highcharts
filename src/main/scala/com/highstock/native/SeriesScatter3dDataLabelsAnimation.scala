...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dataLabels-animation</code>
  */
class SeriesScatter3dDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesScatter3dDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataLabelsAnimation {
      this.defer = defer
    })
  }
}
