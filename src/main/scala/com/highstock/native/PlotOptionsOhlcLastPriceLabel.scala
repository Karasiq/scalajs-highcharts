...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-lastPrice-label</code>
  */
class PlotOptionsOhlcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOhlcLastPriceLabel {
  /**
