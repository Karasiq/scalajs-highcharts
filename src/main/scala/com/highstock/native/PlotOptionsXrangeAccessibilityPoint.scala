...
/**
  * @note JavaScript name: <code>plotOptions-xrange-accessibility-point</code>
  */
class PlotOptionsXrangeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): PlotOptionsXrangeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeAccessibilityPoint {
