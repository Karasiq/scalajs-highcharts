...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-lastPrice-label</code>
  */
class SeriesDisparityindexLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexLastPriceLabel {
  /**
