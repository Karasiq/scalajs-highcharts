...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-params</code>
  */
class SeriesCmoParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesCmoParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoParams {
      this.index = index
      this.period = period
    })
  }
