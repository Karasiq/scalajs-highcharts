...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-zones</code>
  */
class PlotOptionsBoxplotZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBoxplotZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBoxplotZones {
