...
/**
  * @note JavaScript name: <code>plotOptions-map-zones</code>
  */
class PlotOptionsMapZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMapZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapZones {
