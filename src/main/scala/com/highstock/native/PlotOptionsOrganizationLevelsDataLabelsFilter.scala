...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-dataLabels-filter</code>
  */
class PlotOptionsOrganizationLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevelsDataLabelsFilter {
