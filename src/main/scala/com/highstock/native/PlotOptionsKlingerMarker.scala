...
/**
  * @note JavaScript name: <code>plotOptions-klinger-marker</code>
  */
class PlotOptionsKlingerMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerMarker {
  /**
