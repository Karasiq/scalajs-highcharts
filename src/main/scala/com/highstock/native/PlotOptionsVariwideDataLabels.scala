...
/**
  * @note JavaScript name: <code>plotOptions-variwide-dataLabels</code>
  */
class PlotOptionsVariwideDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideDataLabels {
  /**
