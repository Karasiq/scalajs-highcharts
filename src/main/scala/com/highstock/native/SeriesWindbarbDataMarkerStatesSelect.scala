...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-marker-states-select</code>
  */
class SeriesWindbarbDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWindbarbDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataMarkerStatesSelect {
