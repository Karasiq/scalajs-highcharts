...
/**
  * @note JavaScript name: <code>plotOptions-klinger-marker-states</code>
  */
class PlotOptionsKlingerMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsKlingerMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
