...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-states-inactive</code>
  */
class SeriesDisparityindexStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDisparityindexStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexStatesInactive {
