...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-states-hover-halo</code>
  */
class PlotOptionsLinearregressionslopeStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionslopeStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeStatesHoverHalo {
