...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-dataSorting</code>
  */
class PlotOptionsChaikinDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsChaikinDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinDataSorting {
