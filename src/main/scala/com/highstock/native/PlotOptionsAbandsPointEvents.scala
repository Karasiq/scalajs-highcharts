...
/**
  * @note JavaScript name: <code>plotOptions-abands-point-events</code>
  */
class PlotOptionsAbandsPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsAbandsPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsPointEvents {
      this.click = click
      this.drag = drag
