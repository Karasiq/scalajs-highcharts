...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-dataLabels-animation</code>
  */
class SeriesLinearregressionangleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
