...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-label</code>
  */
class SeriesTimelineLabel extends com.highcharts.HighchartsGenericObject {
