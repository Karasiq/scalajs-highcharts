...
/**
  * @note JavaScript name: <code>plotOptions-dema-states-inactive</code>
  */
class PlotOptionsDemaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsDemaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaStatesInactive {
