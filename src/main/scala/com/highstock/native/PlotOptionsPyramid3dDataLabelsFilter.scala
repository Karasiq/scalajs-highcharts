...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-dataLabels-filter</code>
  */
class PlotOptionsPyramid3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPyramid3dDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dDataLabelsFilter {
