...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dataLabels</code>
  */
class SeriesLinearregressionslopeDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDataLabels {
  /**
