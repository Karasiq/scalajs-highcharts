...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-dataLabels-filter</code>
  */
class SeriesEmaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesEmaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaDataLabelsFilter {
