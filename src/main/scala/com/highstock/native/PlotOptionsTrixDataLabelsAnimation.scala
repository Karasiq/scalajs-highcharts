...
/**
  * @note JavaScript name: <code>plotOptions-trix-dataLabels-animation</code>
  */
class PlotOptionsTrixDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTrixDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixDataLabelsAnimation {
      this.defer = defer
    })
  }
}
