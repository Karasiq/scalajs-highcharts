...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-accessibility</code>
  */
class SeriesVennAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVennAccessibilityPoint]] = js.undefined
}

object SeriesVennAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVennAccessibilityPoint]] = js.undefined): SeriesVennAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennAccessibility {
