...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-dataLabels-animation</code>
  */
class SeriesCandlestickDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCandlestickDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataLabelsAnimation {
      this.defer = defer
    })
  }
}
