...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dataLabels-filter</code>
  */
class SeriesCylinderDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCylinderDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataLabelsFilter {
