...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-accessibility</code>
  */
class SeriesBbAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBbAccessibilityPoint]] = js.undefined
}

object SeriesBbAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBbAccessibilityPoint]] = js.undefined): SeriesBbAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbAccessibility {
