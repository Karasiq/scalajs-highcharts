...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-marker-states</code>
  */
class SeriesMacdMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMacdMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
