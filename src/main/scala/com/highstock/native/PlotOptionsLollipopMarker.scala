...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-marker</code>
  */
class PlotOptionsLollipopMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopMarker {
  /**
