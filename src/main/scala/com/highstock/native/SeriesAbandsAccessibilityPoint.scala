...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-accessibility-point</code>
  */
class SeriesAbandsAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAbandsAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsAccessibilityPoint {
