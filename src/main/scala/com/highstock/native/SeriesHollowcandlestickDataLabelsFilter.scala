...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-dataLabels-filter</code>
  */
class SeriesHollowcandlestickDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataLabelsFilter {
