...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dataLabels-filter</code>
  */
class SeriesTrixDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTrixDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixDataLabelsFilter {
