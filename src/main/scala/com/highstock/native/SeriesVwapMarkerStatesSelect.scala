...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-marker-states-select</code>
  */
class SeriesVwapMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesVwapMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapMarkerStatesSelect {
