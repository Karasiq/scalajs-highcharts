...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-dragDrop</code>
  */
class SeriesLollipopDragDrop extends com.highcharts.HighchartsGenericObject {
