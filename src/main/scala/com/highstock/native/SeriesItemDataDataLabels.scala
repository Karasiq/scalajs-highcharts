...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-dataLabels</code>
  */
class SeriesItemDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataDataLabels {
  /**
