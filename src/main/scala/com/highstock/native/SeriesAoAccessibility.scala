...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-accessibility</code>
  */
class SeriesAoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAoAccessibilityPoint]] = js.undefined
}

object SeriesAoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAoAccessibilityPoint]] = js.undefined): SeriesAoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoAccessibility {
