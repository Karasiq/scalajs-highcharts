...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-marker-states</code>
  */
class PlotOptionsDisparityindexMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsDisparityindexMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
