...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dragDrop</code>
  */
class SeriesItemDragDrop extends com.highcharts.HighchartsGenericObject {
