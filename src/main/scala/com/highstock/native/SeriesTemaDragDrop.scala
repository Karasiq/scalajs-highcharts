...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dragDrop</code>
  */
class SeriesTemaDragDrop extends com.highcharts.HighchartsGenericObject {
