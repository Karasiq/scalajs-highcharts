...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-dataLabels-animation</code>
  */
class SeriesOhlcDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesOhlcDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcDataLabelsAnimation {
      this.defer = defer
    })
  }
}
