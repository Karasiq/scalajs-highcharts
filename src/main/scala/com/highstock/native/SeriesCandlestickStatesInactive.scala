...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-states-inactive</code>
  */
class SeriesCandlestickStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesCandlestickStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickStatesInactive {
