...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-point-events</code>
  */
class PlotOptionsPackedbubblePointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubblePointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsPackedbubblePointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubblePointEvents {
      this.click = click
      this.drag = drag
