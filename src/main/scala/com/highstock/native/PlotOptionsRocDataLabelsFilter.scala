...
/**
  * @note JavaScript name: <code>plotOptions-roc-dataLabels-filter</code>
  */
class PlotOptionsRocDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsRocDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocDataLabelsFilter {
