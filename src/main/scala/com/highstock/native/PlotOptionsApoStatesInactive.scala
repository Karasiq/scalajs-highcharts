...
/**
  * @note JavaScript name: <code>plotOptions-apo-states-inactive</code>
  */
class PlotOptionsApoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsApoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoStatesInactive {
