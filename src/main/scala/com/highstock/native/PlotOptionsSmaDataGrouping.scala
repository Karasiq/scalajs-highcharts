...
/**
  * @note JavaScript name: <code>plotOptions-sma-dataGrouping</code>
  */
class PlotOptionsSmaDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaDataGrouping {
  /**
