...
class SeriesScatter3dStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesScatter3dStatesSelect]] = js.undefined
}
...
object SeriesScatter3dStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesScatter3dStatesSelect]] = js.undefined): SeriesScatter3dStates = {
