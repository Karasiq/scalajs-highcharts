...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-states-select-halo</code>
  */
class SeriesLinearregressionslopeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeStatesSelectHalo {
