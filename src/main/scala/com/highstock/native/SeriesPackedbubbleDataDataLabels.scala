...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data-dataLabels</code>
  */
class SeriesPackedbubbleDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataDataLabels {
  /**
