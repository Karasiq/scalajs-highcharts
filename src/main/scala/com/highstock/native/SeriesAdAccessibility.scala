...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-accessibility</code>
  */
class SeriesAdAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAdAccessibilityPoint]] = js.undefined
}

object SeriesAdAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAdAccessibilityPoint]] = js.undefined): SeriesAdAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdAccessibility {
