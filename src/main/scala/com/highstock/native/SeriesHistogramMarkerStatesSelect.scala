...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-marker-states-select</code>
  */
class SeriesHistogramMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesHistogramMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramMarkerStatesSelect {
