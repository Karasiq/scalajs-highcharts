...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data</code>
  */
class SeriesDumbbellData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Pixel width of the line that connects the dumbbell point&#39;s values.</p>
    * @since 8.0.0
    */
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesDumbbellDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesDumbbellDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesDumbbellDataEvents]] = js.undefined
...
object SeriesDumbbellData {
  /**
    ...
    */
  def apply(connectorColor: js.UndefOr[String] = js.undefined, connectorWidth: js.UndefOr[Double] = js.undefined, lowColor: js.UndefOr[String | js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesDumbbellDataDataLabels]] = js.undefined, high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesDumbbellDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesDumbbellDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined): SeriesDumbbellData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellData {
