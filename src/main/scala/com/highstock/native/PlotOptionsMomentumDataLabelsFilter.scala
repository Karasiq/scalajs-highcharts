...
/**
  * @note JavaScript name: <code>plotOptions-momentum-dataLabels-filter</code>
  */
class PlotOptionsMomentumDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMomentumDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumDataLabelsFilter {
