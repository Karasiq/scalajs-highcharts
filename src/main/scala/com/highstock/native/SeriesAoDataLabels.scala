...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-dataLabels</code>
  */
class SeriesAoDataLabels extends com.highcharts.HighchartsGenericObject {
