...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-tooltip</code>
  */
class PlotOptionsPriceenvelopesTooltip extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesTooltip {
  /**
    ...
    */
  def apply(pointFormat: js.UndefOr[String] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined, clusterFormat: js.UndefOr[js.Any] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, distance: js.UndefOr[Double] = js.undefined, followPointer: js.UndefOr[Boolean] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, nullFormat: js.UndefOr[String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, pointFormatter: js.UndefOr[js.Any] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined): PlotOptionsPriceenvelopesTooltip = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesTooltip {
