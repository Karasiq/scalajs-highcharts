...
/**
  * @note JavaScript name: <code>plotOptions-cmo-states-select-halo</code>
  */
class PlotOptionsCmoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsCmoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoStatesSelectHalo {
