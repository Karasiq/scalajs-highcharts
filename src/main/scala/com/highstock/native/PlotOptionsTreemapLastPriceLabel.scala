...
/**
  * @note JavaScript name: <code>plotOptions-treemap-lastPrice-label</code>
  */
class PlotOptionsTreemapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapLastPriceLabel {
  /**
