...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-label</code>
  */
class SeriesLollipopLabel extends com.highcharts.HighchartsGenericObject {
