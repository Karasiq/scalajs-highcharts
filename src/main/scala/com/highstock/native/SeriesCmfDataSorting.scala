...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-dataSorting</code>
  */
class SeriesCmfDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesCmfDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfDataSorting {
