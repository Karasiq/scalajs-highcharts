...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-marker</code>
  */
class PlotOptionsLinearregressionslopeMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeMarker {
  /**
