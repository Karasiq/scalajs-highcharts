...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-accessibility-point</code>
  */
class SeriesAreasplinerangeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAreasplinerangeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeAccessibilityPoint {
