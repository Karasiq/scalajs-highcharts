...
/**
  * @note JavaScript name: <code>plotOptions-wordcloud-states-inactive</code>
  */
class PlotOptionsWordcloudStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWordcloudStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsWordcloudStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWordcloudStatesInactive {
