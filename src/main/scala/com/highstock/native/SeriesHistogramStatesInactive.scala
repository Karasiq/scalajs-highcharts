...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-inactive</code>
  */
class SeriesHistogramStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesHistogramStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesInactive {
