...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-accessibility</code>
  */
class SeriesZigzagAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesZigzagAccessibilityPoint]] = js.undefined
}

object SeriesZigzagAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesZigzagAccessibilityPoint]] = js.undefined): SeriesZigzagAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagAccessibility {
