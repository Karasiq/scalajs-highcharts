...
/**
  * @note JavaScript name: <code>plotOptions-pareto-dataSorting</code>
  */
class PlotOptionsParetoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsParetoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoDataSorting {
