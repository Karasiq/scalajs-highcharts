...
/**
  * @note JavaScript name: <code>plotOptions-obv-dataSorting</code>
  */
class PlotOptionsObvDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsObvDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvDataSorting {
