...
/**
  ...
  */
class SeriesLineDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLineDataMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
