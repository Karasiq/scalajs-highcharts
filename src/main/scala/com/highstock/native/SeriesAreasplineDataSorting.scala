...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-dataSorting</code>
  */
class SeriesAreasplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAreasplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataSorting {
