...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-states-inactive</code>
  */
class PlotOptionsMapbubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMapbubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleStatesInactive {
