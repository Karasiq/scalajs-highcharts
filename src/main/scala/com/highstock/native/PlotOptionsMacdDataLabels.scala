...
/**
  * @note JavaScript name: <code>plotOptions-macd-dataLabels</code>
  */
class PlotOptionsMacdDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdDataLabels {
  /**
