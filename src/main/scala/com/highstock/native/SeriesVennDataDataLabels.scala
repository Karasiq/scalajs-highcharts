...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-data-dataLabels</code>
  */
class SeriesVennDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennDataDataLabels {
  /**
