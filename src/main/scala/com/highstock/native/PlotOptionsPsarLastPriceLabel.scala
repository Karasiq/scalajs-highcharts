...
/**
  * @note JavaScript name: <code>plotOptions-psar-lastPrice-label</code>
  */
class PlotOptionsPsarLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarLastPriceLabel {
  /**
