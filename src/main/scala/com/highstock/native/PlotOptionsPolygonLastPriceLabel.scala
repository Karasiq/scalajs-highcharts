...
/**
  * @note JavaScript name: <code>plotOptions-polygon-lastPrice-label</code>
  */
class PlotOptionsPolygonLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonLastPriceLabel {
  /**
