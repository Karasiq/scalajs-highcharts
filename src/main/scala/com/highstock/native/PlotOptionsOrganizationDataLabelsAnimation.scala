...
/**
  * @note JavaScript name: <code>plotOptions-organization-dataLabels-animation</code>
  */
class PlotOptionsOrganizationDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationDataLabelsAnimation {
      this.defer = defer
    })
  }
}
