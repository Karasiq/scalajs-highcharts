...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-accessibility-point</code>
  */
class SeriesSlowstochasticAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesSlowstochasticAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticAccessibilityPoint {
