...
/**
  * @note JavaScript name: <code>plotOptions-tema-lastPrice-label</code>
  */
class PlotOptionsTemaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaLastPriceLabel {
  /**
