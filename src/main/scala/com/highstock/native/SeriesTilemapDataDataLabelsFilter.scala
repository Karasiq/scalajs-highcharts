...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-data-dataLabels-filter</code>
  */
class SeriesTilemapDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTilemapDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapDataDataLabelsFilter {
