...
class SeriesAdStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesAdStatesSelect]] = js.undefined
}
...
object SeriesAdStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAdStatesSelect]] = js.undefined): SeriesAdStates = {
