...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-dataGrouping</code>
  */
class SeriesPyramid3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataGrouping {
  /**
