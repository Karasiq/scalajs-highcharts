...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-dataSorting</code>
  */
class SeriesParetoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesParetoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoDataSorting {
