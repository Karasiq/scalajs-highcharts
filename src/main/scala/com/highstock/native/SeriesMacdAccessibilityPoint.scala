...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-accessibility-point</code>
  */
class SeriesMacdAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesMacdAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdAccessibilityPoint {
