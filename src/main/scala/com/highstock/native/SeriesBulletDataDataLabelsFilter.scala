...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-data-dataLabels-filter</code>
  */
class SeriesBulletDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBulletDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletDataDataLabelsFilter {
