...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dataLabels-filter</code>
  */
class SeriesAbandsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAbandsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsDataLabelsFilter {
