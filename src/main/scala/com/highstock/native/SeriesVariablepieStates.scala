...
class SeriesVariablepieStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesVariablepieStatesSelect]] = js.undefined
}
...
object SeriesVariablepieStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesVariablepieStatesSelect]] = js.undefined): SeriesVariablepieStates = {
