...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-dataSorting</code>
  */
class SeriesBubbleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesBubbleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataSorting {
