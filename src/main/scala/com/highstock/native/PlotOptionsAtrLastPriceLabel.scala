...
/**
  * @note JavaScript name: <code>plotOptions-atr-lastPrice-label</code>
  */
class PlotOptionsAtrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrLastPriceLabel {
  /**
