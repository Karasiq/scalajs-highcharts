...
/**
  * @note JavaScript name: <code>plotOptions-pie-lastPrice-label</code>
  */
class PlotOptionsPieLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieLastPriceLabel {
  /**
