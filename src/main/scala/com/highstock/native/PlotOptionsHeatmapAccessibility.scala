...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-accessibility</code>
  */
class PlotOptionsHeatmapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsHeatmapAccessibilityPoint]] = js.undefined
}

object PlotOptionsHeatmapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsHeatmapAccessibilityPoint]] = js.undefined): PlotOptionsHeatmapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapAccessibility {
