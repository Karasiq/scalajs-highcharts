...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-label</code>
  */
class PlotOptionsAroonoscillatorLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorLabel {
  /**
