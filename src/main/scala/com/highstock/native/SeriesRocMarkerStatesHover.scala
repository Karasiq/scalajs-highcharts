...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-marker-states-hover</code>
  */
class SeriesRocMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesRocMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocMarkerStatesHover {
