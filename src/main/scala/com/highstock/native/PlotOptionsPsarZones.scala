...
/**
  * @note JavaScript name: <code>plotOptions-psar-zones</code>
  */
class PlotOptionsPsarZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPsarZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarZones {
