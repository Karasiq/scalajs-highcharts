...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-states-inactive</code>
  */
class SeriesStochasticStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesStochasticStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticStatesInactive {
