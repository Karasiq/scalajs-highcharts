...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-dataLabels-animation</code>
  */
class SeriesAoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
