...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-accessibility-point</code>
  */
class SeriesTilemapAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTilemapAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapAccessibilityPoint {
