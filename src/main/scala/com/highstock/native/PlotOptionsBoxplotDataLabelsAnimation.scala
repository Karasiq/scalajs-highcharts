...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-dataLabels-animation</code>
  */
class PlotOptionsBoxplotDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsBoxplotDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBoxplotDataLabelsAnimation {
      this.defer = defer
    })
  }
}
