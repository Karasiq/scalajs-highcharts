...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-dataGrouping</code>
  */
class SeriesHistogramDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramDataGrouping {
  /**
