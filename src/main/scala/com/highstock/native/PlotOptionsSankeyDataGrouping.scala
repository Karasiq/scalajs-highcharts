...
/**
  * @note JavaScript name: <code>plotOptions-sankey-dataGrouping</code>
  */
class PlotOptionsSankeyDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyDataGrouping {
  /**
