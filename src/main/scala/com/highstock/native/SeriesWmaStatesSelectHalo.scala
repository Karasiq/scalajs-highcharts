...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-states-select-halo</code>
  */
class SeriesWmaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWmaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaStatesSelectHalo {
