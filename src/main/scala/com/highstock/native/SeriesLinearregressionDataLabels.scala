...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dataLabels</code>
  */
class SeriesLinearregressionDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDataLabels {
  /**
