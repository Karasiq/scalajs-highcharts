...
/**
  * @note JavaScript name: <code>plotOptions-bubble-states-inactive</code>
  */
class PlotOptionsBubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleStatesInactive {
