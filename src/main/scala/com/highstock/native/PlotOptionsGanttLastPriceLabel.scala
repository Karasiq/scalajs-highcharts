...
/**
  * @note JavaScript name: <code>plotOptions-gantt-lastPrice-label</code>
  */
class PlotOptionsGanttLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttLastPriceLabel {
  /**
