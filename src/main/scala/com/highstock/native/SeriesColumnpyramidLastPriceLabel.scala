...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-lastPrice-label</code>
  */
class SeriesColumnpyramidLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidLastPriceLabel {
  /**
