...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-zones</code>
  */
class PlotOptionsZigzagZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsZigzagZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsZigzagZones {
