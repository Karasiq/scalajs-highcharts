...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dragDrop</code>
  */
class SeriesKlingerDragDrop extends com.highcharts.HighchartsGenericObject {
