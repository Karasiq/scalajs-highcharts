...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-lastPrice-label</code>
  */
class PlotOptionsAreasplinerangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplinerangeLastPriceLabel {
  /**
