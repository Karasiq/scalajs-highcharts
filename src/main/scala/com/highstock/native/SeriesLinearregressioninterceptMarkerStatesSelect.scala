...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-marker-states-select</code>
  */
class SeriesLinearregressioninterceptMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptMarkerStatesSelect {
