...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-lastPrice-label</code>
  */
class PlotOptionsPyramidLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramidLastPriceLabel {
  /**
