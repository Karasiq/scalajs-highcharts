...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-states</code>
  */
class SeriesKlingerStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesKlingerStatesSelect]] = js.undefined
}

object SeriesKlingerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesKlingerStatesSelect]] = js.undefined): SeriesKlingerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerStates {
      this.hover = hover
