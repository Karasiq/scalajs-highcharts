...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-lastPrice-label</code>
  */
class SeriesSolidgaugeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeLastPriceLabel {
  /**
