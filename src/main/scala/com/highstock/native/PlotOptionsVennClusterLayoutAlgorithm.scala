...
/**
  * @note JavaScript name: <code>plotOptions-venn-cluster-layoutAlgorithm</code>
  */
class PlotOptionsVennClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): PlotOptionsVennClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennClusterLayoutAlgorithm {
