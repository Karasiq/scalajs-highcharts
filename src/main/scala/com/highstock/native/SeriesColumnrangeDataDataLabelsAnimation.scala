...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-data-dataLabels-animation</code>
  */
class SeriesColumnrangeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnrangeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
