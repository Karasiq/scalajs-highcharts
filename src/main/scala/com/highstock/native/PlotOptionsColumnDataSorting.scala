...
/**
  * @note JavaScript name: <code>plotOptions-column-dataSorting</code>
  */
class PlotOptionsColumnDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsColumnDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnDataSorting {
