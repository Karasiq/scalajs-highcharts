...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-data-dataLabels-animation</code>
  */
class SeriesVariablepieDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVariablepieDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
