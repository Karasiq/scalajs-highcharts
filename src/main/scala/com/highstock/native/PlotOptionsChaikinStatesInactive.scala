...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-states-inactive</code>
  */
class PlotOptionsChaikinStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinStatesInactive {
