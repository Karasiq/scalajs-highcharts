...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-data-accessibility</code>
  */
class SeriesFunnelDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesFunnelDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDataAccessibility {
