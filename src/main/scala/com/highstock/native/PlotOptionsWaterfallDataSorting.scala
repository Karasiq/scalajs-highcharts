...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-dataSorting</code>
  */
class PlotOptionsWaterfallDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsWaterfallDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallDataSorting {
