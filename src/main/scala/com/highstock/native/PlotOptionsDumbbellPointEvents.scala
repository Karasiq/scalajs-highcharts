...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-point-events</code>
  */
class PlotOptionsDumbbellPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsDumbbellPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellPointEvents {
      this.click = click
      this.drag = drag
