...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-states</code>
  */
class PlotOptionsDumbbellStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDumbbellStatesSelect]] = js.undefined
}

object PlotOptionsDumbbellStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDumbbellStatesSelect]] = js.undefined): PlotOptionsDumbbellStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellStates {
      this.hover = hover
