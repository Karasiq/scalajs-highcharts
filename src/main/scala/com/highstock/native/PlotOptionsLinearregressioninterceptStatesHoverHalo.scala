...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-states-hover-halo</code>
  */
class PlotOptionsLinearregressioninterceptStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressioninterceptStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptStatesHoverHalo {
