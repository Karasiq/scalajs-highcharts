...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-accessibility-point</code>
  */
class SeriesDependencywheelAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesDependencywheelAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelAccessibilityPoint {
