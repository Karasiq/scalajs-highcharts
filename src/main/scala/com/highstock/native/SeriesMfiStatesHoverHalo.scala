...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-states-hover-halo</code>
  */
class SeriesMfiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesMfiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiStatesHoverHalo {
