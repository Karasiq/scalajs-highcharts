...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-states-hover-halo</code>
  */
class SeriesSplineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSplineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineStatesHoverHalo {
