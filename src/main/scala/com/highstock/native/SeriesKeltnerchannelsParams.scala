...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-params</code>
  */
class SeriesKeltnerchannelsParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsParams {
      this.index = index
      this.period = period
    })
  }
