...
/**
  * @note JavaScript name: <code>plotOptions-cmo-dataLabels</code>
  */
class PlotOptionsCmoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoDataLabels {
  /**
