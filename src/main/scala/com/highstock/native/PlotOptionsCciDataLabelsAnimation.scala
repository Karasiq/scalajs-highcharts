...
/**
  * @note JavaScript name: <code>plotOptions-cci-dataLabels-animation</code>
  */
class PlotOptionsCciDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsCciDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciDataLabelsAnimation {
      this.defer = defer
    })
  }
}
