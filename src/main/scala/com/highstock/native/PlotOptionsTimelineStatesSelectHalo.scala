...
/**
  * @note JavaScript name: <code>plotOptions-timeline-states-select-halo</code>
  */
class PlotOptionsTimelineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineStatesSelectHalo {
