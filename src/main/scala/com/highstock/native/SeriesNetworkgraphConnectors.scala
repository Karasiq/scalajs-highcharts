...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-connectors</code>
  */
class SeriesNetworkgraphConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesNetworkgraphConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesNetworkgraphConnectorsStartMarker]] = js.undefined
...
object SeriesNetworkgraphConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesNetworkgraphConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesNetworkgraphConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesNetworkgraphConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphConnectors {
