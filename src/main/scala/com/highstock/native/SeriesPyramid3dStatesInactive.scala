...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states-inactive</code>
  */
class SeriesPyramid3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPyramid3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStatesInactive {
