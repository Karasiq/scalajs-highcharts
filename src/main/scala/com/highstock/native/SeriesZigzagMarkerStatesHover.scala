...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-marker-states-hover</code>
  */
class SeriesZigzagMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesZigzagMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagMarkerStatesHover {
