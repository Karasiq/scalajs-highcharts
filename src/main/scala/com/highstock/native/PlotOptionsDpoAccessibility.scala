...
/**
  * @note JavaScript name: <code>plotOptions-dpo-accessibility</code>
  */
class PlotOptionsDpoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDpoAccessibilityPoint]] = js.undefined
}

object PlotOptionsDpoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDpoAccessibilityPoint]] = js.undefined): PlotOptionsDpoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoAccessibility {
