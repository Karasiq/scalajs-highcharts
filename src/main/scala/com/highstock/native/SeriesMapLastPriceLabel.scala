...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-lastPrice-label</code>
  */
class SeriesMapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapLastPriceLabel {
  /**
