...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-marker-states-hover</code>
  */
class SeriesCmoMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesCmoMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoMarkerStatesHover {
