...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-data-dataLabels-filter</code>
  */
class SeriesScatterDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesScatterDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataDataLabelsFilter {
