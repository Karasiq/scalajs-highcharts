...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-states-hover-halo</code>
  */
class SeriesTrixStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTrixStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixStatesHoverHalo {
