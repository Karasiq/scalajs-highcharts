...
/**
  * @note JavaScript name: <code>plotOptions-trix-dataLabels-filter</code>
  */
class PlotOptionsTrixDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTrixDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixDataLabelsFilter {
