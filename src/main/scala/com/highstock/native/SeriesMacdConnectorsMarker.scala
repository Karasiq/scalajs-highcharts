...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-connectors-marker</code>
  */
class SeriesMacdConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesMacdConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdConnectorsMarker {
      this.align = align
      this.color = color
