...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states-hover</code>
  */
class SeriesPackedbubbleStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesHoverMarker]] = js.undefined
}

object SeriesPackedbubbleStatesHover {
  /**
    ...
    */
  def apply(halo: js.UndefOr[js.Any] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesHoverMarker]] = js.undefined): SeriesPackedbubbleStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStatesHover {
      this.halo = halo
