...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-dataLabels-animation</code>
  */
class SeriesColumnDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnDataLabelsAnimation {
      this.defer = defer
    })
  }
}
