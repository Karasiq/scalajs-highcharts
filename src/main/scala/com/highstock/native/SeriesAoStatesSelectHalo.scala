...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-states-select-halo</code>
  */
class SeriesAoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoStatesSelectHalo {
