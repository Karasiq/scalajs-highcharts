...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dataSorting</code>
  */
class SeriesKlingerDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesKlingerDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerDataSorting {
