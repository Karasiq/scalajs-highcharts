...
/**
  * @note JavaScript name: <code>plotOptions-wordcloud-accessibility</code>
  */
class PlotOptionsWordcloudAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsWordcloudAccessibilityPoint]] = js.undefined
}

object PlotOptionsWordcloudAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsWordcloudAccessibilityPoint]] = js.undefined): PlotOptionsWordcloudAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWordcloudAccessibility {
