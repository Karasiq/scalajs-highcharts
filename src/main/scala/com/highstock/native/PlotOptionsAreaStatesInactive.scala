...
/**
  * @note JavaScript name: <code>plotOptions-area-states-inactive</code>
  */
class PlotOptionsAreaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAreaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaStatesInactive {
