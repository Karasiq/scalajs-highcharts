...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-marker-states-select</code>
  */
class SeriesCmfMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesCmfMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfMarkerStatesSelect {
