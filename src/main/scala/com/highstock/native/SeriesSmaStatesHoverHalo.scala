...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-states-hover-halo</code>
  */
class SeriesSmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSmaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaStatesHoverHalo {
