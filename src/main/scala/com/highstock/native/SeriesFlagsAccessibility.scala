...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-accessibility</code>
  */
class SeriesFlagsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesFlagsAccessibilityPoint]] = js.undefined
}

object SeriesFlagsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesFlagsAccessibilityPoint]] = js.undefined): SeriesFlagsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsAccessibility {
