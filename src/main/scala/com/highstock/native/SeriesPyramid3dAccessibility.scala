...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-accessibility</code>
  */
class SeriesPyramid3dAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPyramid3dAccessibilityPoint]] = js.undefined
}

object SeriesPyramid3dAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPyramid3dAccessibilityPoint]] = js.undefined): SeriesPyramid3dAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dAccessibility {
