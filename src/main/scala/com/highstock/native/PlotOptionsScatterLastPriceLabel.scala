...
/**
  * @note JavaScript name: <code>plotOptions-scatter-lastPrice-label</code>
  */
class PlotOptionsScatterLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterLastPriceLabel {
  /**
