...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-dragDrop</code>
  */
class SeriesTimelineDragDrop extends com.highcharts.HighchartsGenericObject {
