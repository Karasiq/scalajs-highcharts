...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dataLabels</code>
  */
class SeriesAbandsDataLabels extends com.highcharts.HighchartsGenericObject {
