...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-states-select-halo</code>
  */
class SeriesNatrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesNatrStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrStatesSelectHalo {
