...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-lastPrice-label</code>
  */
class SeriesDependencywheelLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLastPriceLabel {
  /**
