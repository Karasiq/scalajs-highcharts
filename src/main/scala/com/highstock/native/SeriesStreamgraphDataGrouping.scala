...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-dataGrouping</code>
  */
class SeriesStreamgraphDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataGrouping {
  /**
