...
/**
  * @note JavaScript name: <code>plotOptions-gantt-connectors</code>
  */
class PlotOptionsGanttConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.Any = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.Any = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var `type`: js.UndefOr[String] = "simpleConnect"
...
object PlotOptionsGanttConnectors {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Any] = js.undefined, endMarker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[js.Any] = js.undefined, `type`: js.UndefOr[String] = "simpleConnect", dashStyle: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined): PlotOptionsGanttConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttConnectors {
