...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-levels-dataLabels</code>
  */
class SeriesTreemapLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapLevelsDataLabels {
  /**
