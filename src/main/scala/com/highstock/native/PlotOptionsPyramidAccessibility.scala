...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-accessibility</code>
  */
class PlotOptionsPyramidAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPyramidAccessibilityPoint]] = js.undefined
}

object PlotOptionsPyramidAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPyramidAccessibilityPoint]] = js.undefined): PlotOptionsPyramidAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramidAccessibility {
