...
/**
  * @note JavaScript name: <code>plotOptions-cmf-dataSorting</code>
  */
class PlotOptionsCmfDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsCmfDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfDataSorting {
