...
/**
  * @note JavaScript name: <code>plotOptions-pc-states-hover-halo</code>
  */
class PlotOptionsPcStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPcStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcStatesHoverHalo {
