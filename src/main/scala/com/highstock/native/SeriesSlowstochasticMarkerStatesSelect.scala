...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-marker-states-select</code>
  */
class SeriesSlowstochasticMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticMarkerStatesSelect {
