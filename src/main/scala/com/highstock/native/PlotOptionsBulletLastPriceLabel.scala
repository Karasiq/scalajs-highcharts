...
/**
  * @note JavaScript name: <code>plotOptions-bullet-lastPrice-label</code>
  */
class PlotOptionsBulletLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletLastPriceLabel {
  /**
