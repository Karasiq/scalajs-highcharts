...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-marker-states</code>
  */
class SeriesFunnelMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesFunnelMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
