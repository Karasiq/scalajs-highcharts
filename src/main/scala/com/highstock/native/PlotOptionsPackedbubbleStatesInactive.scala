...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-states-inactive</code>
  */
class PlotOptionsPackedbubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleStatesInactive {
