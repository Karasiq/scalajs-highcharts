...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-lastPrice-label</code>
  */
class SeriesOhlcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcLastPriceLabel {
  /**
