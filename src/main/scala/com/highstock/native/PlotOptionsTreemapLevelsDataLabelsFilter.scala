...
/**
  * @note JavaScript name: <code>plotOptions-treemap-levels-dataLabels-filter</code>
  */
class PlotOptionsTreemapLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapLevelsDataLabelsFilter {
