...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-dataLabels-animation</code>
  */
class SeriesZigzagDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesZigzagDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagDataLabelsAnimation {
      this.defer = defer
    })
  }
}
