...
/**
  * @note JavaScript name: <code>plotOptions-dmi-states-inactive</code>
  */
class PlotOptionsDmiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsDmiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiStatesInactive {
