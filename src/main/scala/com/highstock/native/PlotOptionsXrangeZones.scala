...
/**
  * @note JavaScript name: <code>plotOptions-xrange-zones</code>
  */
class PlotOptionsXrangeZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsXrangeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeZones {
