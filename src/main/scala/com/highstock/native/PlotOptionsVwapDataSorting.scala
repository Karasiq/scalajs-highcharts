...
/**
  * @note JavaScript name: <code>plotOptions-vwap-dataSorting</code>
  */
class PlotOptionsVwapDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsVwapDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapDataSorting {
