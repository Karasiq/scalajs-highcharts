...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-lastPrice-label</code>
  */
class SeriesPieLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieLastPriceLabel {
  /**
