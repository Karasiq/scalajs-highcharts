...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-marker-states-select</code>
  */
class SeriesBbMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesBbMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbMarkerStatesSelect {
