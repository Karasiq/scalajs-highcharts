...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-states-hover-halo</code>
  */
class SeriesAroonStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAroonStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonStatesHoverHalo {
