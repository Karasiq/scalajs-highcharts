...
/**
  * @note JavaScript name: <code>plotOptions-ikh-dataSorting</code>
  */
class PlotOptionsIkhDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsIkhDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhDataSorting {
