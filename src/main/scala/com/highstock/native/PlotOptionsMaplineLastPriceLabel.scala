...
/**
  * @note JavaScript name: <code>plotOptions-mapline-lastPrice-label</code>
  */
class PlotOptionsMaplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineLastPriceLabel {
  /**
