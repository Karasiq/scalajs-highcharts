...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-lastPrice-label</code>
  */
class PlotOptionsSunburstLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstLastPriceLabel {
  /**
