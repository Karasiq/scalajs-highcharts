...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-states</code>
  */
class SeriesSupertrendStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesSupertrendStatesSelect]] = js.undefined
}

object SeriesSupertrendStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesSupertrendStatesSelect]] = js.undefined): SeriesSupertrendStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendStates {
      this.hover = hover
