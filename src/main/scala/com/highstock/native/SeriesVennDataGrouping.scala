...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-dataGrouping</code>
  */
class SeriesVennDataGrouping extends com.highcharts.HighchartsGenericObject {
