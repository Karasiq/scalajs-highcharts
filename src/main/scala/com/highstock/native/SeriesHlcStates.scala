...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-states</code>
  */
class SeriesHlcStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesHlcStatesSelect]] = js.undefined
...
object SeriesHlcStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesHlcStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesHlcStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcStates {
      this.hover = hover
      this.select = select
