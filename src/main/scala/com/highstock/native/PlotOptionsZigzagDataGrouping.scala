...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-dataGrouping</code>
  */
class PlotOptionsZigzagDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagDataGrouping {
  /**
