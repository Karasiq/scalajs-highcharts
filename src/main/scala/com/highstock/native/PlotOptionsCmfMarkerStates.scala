...
/**
  * @note JavaScript name: <code>plotOptions-cmf-marker-states</code>
  */
class PlotOptionsCmfMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsCmfMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
