...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-accessibility-point</code>
  */
class SeriesPivotpointsAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPivotpointsAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsAccessibilityPoint {
