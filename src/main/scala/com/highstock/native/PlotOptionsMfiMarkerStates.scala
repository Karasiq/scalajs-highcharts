...
/**
  * @note JavaScript name: <code>plotOptions-mfi-marker-states</code>
  */
class PlotOptionsMfiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMfiMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
