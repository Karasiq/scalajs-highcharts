...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dataLabels-animation</code>
  */
class SeriesLinearregressionslopeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
