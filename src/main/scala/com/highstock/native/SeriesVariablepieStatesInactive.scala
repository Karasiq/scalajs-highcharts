...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-states-inactive</code>
  */
class SeriesVariablepieStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesVariablepieStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieStatesInactive {
