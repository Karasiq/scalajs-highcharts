...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dataLabels-animation</code>
  */
class SeriesHlcDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHlcDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataLabelsAnimation {
      this.defer = defer
    })
  }
}
