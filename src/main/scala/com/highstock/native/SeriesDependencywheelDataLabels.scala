...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-dataLabels</code>
  */
class SeriesDependencywheelDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDataLabels {
  /**
