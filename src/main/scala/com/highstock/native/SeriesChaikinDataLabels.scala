...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dataLabels</code>
  */
class SeriesChaikinDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinDataLabels {
  /**
