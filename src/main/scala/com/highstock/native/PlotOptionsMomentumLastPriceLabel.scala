...
/**
  * @note JavaScript name: <code>plotOptions-momentum-lastPrice-label</code>
  */
class PlotOptionsMomentumLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumLastPriceLabel {
  /**
