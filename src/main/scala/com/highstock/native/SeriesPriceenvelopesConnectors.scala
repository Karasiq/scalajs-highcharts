...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-connectors</code>
  */
class SeriesPriceenvelopesConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesPriceenvelopesConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesPriceenvelopesConnectorsStartMarker]] = js.undefined
...
object SeriesPriceenvelopesConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesPriceenvelopesConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesPriceenvelopesConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesPriceenvelopesConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesConnectors {
