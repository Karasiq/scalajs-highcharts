...
/**
  * @note JavaScript name: <code>plotOptions-ppo-dataLabels</code>
  */
class PlotOptionsPpoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoDataLabels {
  /**
