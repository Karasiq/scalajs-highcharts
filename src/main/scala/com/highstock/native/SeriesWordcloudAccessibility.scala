...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-accessibility</code>
  */
class SeriesWordcloudAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesWordcloudAccessibilityPoint]] = js.undefined
}

object SeriesWordcloudAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesWordcloudAccessibilityPoint]] = js.undefined): SeriesWordcloudAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudAccessibility {
