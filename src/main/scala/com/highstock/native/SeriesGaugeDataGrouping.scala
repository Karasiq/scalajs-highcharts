...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-dataGrouping</code>
  */
class SeriesGaugeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataGrouping {
  /**
