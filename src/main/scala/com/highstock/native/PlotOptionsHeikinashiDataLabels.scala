...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dataLabels</code>
  */
class PlotOptionsHeikinashiDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDataLabels {
  /**
