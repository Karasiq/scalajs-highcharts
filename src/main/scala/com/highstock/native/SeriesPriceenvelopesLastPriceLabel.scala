...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-lastPrice-label</code>
  */
class SeriesPriceenvelopesLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesLastPriceLabel {
  /**
