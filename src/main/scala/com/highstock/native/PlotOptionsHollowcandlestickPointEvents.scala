...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-point-events</code>
  */
class PlotOptionsHollowcandlestickPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsHollowcandlestickPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickPointEvents {
      this.click = click
      this.drag = drag
