...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-data-dataLabels</code>
  */
class SeriesPyramidDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataDataLabels {
  /**
