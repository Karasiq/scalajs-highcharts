...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-dataLabels-animation</code>
  */
class PlotOptionsTilemapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTilemapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
