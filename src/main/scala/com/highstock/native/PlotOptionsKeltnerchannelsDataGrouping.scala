...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-dataGrouping</code>
  */
class PlotOptionsKeltnerchannelsDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsDataGrouping {
  /**
