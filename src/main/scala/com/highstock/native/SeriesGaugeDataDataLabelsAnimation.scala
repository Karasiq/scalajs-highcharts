...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-data-dataLabels-animation</code>
  */
class SeriesGaugeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesGaugeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
