...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-accessibility</code>
  */
class SeriesPsarAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPsarAccessibilityPoint]] = js.undefined
}

object SeriesPsarAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPsarAccessibilityPoint]] = js.undefined): SeriesPsarAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarAccessibility {
