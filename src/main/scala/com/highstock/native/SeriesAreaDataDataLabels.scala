...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-data-dataLabels</code>
  */
class SeriesAreaDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataDataLabels {
  /**
