...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-marker-states</code>
  */
class SeriesCylinderMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesCylinderMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
