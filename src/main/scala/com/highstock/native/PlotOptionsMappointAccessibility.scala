...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-accessibility</code>
  */
class PlotOptionsMappointAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMappointAccessibilityPoint]] = js.undefined
}

object PlotOptionsMappointAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMappointAccessibilityPoint]] = js.undefined): PlotOptionsMappointAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointAccessibility {
