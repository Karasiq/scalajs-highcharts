...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dataLabels</code>
  */
class SeriesWilliamsrDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDataLabels {
  /**
