...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-data-marker-states-select</code>
  */
class SeriesGanttDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesGanttDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataMarkerStatesSelect {
