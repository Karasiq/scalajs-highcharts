...
/**
  * @note JavaScript name: <code>plotOptions-rsi-states-select-halo</code>
  */
class PlotOptionsRsiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsRsiStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiStatesSelectHalo {
