...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-connectors-startMarker</code>
  */
class SeriesVwapConnectorsStartMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapConnectorsStartMarker {
  /**
    ...
    */
  def apply(symbol: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesVwapConnectorsStartMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapConnectorsStartMarker {
      this.symbol = symbol
      this.align = align
      this.color = color
