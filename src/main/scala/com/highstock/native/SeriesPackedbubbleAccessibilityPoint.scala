...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-accessibility-point</code>
  */
class SeriesPackedbubbleAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPackedbubbleAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleAccessibilityPoint {
