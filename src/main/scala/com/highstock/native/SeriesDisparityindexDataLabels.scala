...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dataLabels</code>
  */
class SeriesDisparityindexDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDataLabels {
  /**
