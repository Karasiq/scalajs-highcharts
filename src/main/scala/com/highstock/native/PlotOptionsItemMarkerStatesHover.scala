...
/**
  * @note JavaScript name: <code>plotOptions-item-marker-states-hover</code>
  */
class PlotOptionsItemMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): PlotOptionsItemMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemMarkerStatesHover {
