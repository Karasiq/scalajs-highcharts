...
/**
  * @note JavaScript name: <code>plotOptions-flags-dataLabels-animation</code>
  */
class PlotOptionsFlagsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
