...
/**
  * @note JavaScript name: <code>plotOptions-item-marker-states</code>
  */
class PlotOptionsItemMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsItemMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
