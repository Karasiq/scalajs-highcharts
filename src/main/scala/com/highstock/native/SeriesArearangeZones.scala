...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-zones</code>
  */
class SeriesArearangeZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesArearangeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeZones {
