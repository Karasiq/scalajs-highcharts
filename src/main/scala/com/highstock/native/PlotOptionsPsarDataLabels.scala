...
/**
  * @note JavaScript name: <code>plotOptions-psar-dataLabels</code>
  */
class PlotOptionsPsarDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarDataLabels {
  /**
