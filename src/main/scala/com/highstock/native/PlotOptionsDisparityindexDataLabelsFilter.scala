...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-dataLabels-filter</code>
  */
class PlotOptionsDisparityindexDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDisparityindexDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexDataLabelsFilter {
