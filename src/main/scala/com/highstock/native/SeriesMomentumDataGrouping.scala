...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-dataGrouping</code>
  */
class SeriesMomentumDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumDataGrouping {
  /**
