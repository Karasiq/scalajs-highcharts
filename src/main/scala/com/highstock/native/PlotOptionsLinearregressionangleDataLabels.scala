...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-dataLabels</code>
  */
class PlotOptionsLinearregressionangleDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleDataLabels {
  /**
