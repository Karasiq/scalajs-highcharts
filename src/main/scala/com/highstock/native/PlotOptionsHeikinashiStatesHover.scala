...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-states-hover</code>
  */
class PlotOptionsHeikinashiStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiStatesHover {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsHeikinashiStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiStatesHover {
