...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-dataLabels-animation</code>
  */
class SeriesSankeyLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSankeyLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
