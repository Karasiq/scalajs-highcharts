...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-zones</code>
  */
class SeriesMapZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMapZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapZones {
