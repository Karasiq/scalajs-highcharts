...
/**
  * @note JavaScript name: <code>plotOptions-cci-states-hover-halo</code>
  */
class PlotOptionsCciStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsCciStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciStatesHoverHalo {
