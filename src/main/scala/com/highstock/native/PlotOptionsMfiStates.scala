...
class PlotOptionsMfiStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsMfiStatesSelect]] = js.undefined
}
...
object PlotOptionsMfiStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsMfiStatesSelect]] = js.undefined): PlotOptionsMfiStates = {
