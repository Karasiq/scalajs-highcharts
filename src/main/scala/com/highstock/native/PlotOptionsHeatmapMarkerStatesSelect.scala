...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-marker-states-select</code>
  */
class PlotOptionsHeatmapMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapMarkerStatesSelect {
  /**
    ...
    */
  def apply(height: js.UndefOr[js.UndefOr[Double]] = js.undefined, heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapMarkerStatesSelect {
      this.height = height
