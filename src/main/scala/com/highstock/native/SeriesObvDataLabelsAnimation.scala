...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-dataLabels-animation</code>
  */
class SeriesObvDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesObvDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvDataLabelsAnimation {
      this.defer = defer
    })
  }
}
