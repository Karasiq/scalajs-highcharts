...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-dataLabels</code>
  */
class SeriesWordcloudDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataLabels {
  /**
