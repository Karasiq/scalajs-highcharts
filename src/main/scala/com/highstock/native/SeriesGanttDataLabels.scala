...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dataLabels</code>
  */
class SeriesGanttDataLabels extends com.highcharts.HighchartsGenericObject {
