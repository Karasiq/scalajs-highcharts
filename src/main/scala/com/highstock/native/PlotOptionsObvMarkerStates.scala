...
/**
  * @note JavaScript name: <code>plotOptions-obv-marker-states</code>
  */
class PlotOptionsObvMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsObvMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
