...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-label</code>
  */
class SeriesSupertrendLabel extends com.highcharts.HighchartsGenericObject {
