...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dataLabels-animation</code>
  */
class PlotOptionsHollowcandlestickDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsHollowcandlestickDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickDataLabelsAnimation {
      this.defer = defer
    })
  }
}
