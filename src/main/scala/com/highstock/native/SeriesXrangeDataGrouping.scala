...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-dataGrouping</code>
  */
class SeriesXrangeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataGrouping {
  /**
