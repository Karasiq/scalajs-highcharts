...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-dataLabels</code>
  */
class SeriesVariwideDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataLabels {
  /**
