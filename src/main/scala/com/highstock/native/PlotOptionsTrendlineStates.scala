...
/**
  * @note JavaScript name: <code>plotOptions-trendline-states</code>
  */
class PlotOptionsTrendlineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.3
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsTrendlineStatesSelect]] = js.undefined
}

object PlotOptionsTrendlineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsTrendlineStatesSelect]] = js.undefined): PlotOptionsTrendlineStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineStates {
      this.hover = hover
