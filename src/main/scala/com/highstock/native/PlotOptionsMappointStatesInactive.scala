...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-inactive</code>
  */
class PlotOptionsMappointStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMappointStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesInactive {
