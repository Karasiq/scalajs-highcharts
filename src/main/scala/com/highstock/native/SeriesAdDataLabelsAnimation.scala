...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-dataLabels-animation</code>
  */
class SeriesAdDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAdDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdDataLabelsAnimation {
      this.defer = defer
    })
  }
}
