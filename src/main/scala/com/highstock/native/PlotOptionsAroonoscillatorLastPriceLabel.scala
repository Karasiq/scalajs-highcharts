...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-lastPrice-label</code>
  */
class PlotOptionsAroonoscillatorLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorLastPriceLabel {
  /**
