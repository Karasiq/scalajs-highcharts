...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-states-select-halo</code>
  */
class SeriesVwapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesVwapStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapStatesSelectHalo {
