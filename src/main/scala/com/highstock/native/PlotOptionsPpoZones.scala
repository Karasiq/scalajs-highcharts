...
/**
  * @note JavaScript name: <code>plotOptions-ppo-zones</code>
  */
class PlotOptionsPpoZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPpoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoZones {
