...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-states-hover-halo</code>
  */
class PlotOptionsMapbubbleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMapbubbleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleStatesHoverHalo {
      this.size = size
