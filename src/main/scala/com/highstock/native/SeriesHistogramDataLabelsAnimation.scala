...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-dataLabels-animation</code>
  */
class SeriesHistogramDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHistogramDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramDataLabelsAnimation {
      this.defer = defer
    })
  }
}
