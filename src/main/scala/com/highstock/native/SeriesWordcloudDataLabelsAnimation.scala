...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-dataLabels-animation</code>
  */
class SeriesWordcloudDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWordcloudDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudDataLabelsAnimation {
      this.defer = defer
    })
  }
}
