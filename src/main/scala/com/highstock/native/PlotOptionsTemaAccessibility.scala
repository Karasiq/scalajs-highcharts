...
/**
  * @note JavaScript name: <code>plotOptions-tema-accessibility</code>
  */
class PlotOptionsTemaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTemaAccessibilityPoint]] = js.undefined
}

object PlotOptionsTemaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTemaAccessibilityPoint]] = js.undefined): PlotOptionsTemaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaAccessibility {
