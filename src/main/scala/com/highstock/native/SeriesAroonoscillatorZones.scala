...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-zones</code>
  */
class SeriesAroonoscillatorZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorZones {
