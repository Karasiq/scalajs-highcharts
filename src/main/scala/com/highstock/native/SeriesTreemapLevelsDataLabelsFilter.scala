...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-levels-dataLabels-filter</code>
  */
class SeriesTreemapLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTreemapLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapLevelsDataLabelsFilter {
