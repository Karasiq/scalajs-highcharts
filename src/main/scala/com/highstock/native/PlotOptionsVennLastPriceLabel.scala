...
/**
  * @note JavaScript name: <code>plotOptions-venn-lastPrice-label</code>
  */
class PlotOptionsVennLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennLastPriceLabel {
  /**
