...
/**
  * @note JavaScript name: <code>plotOptions-arearange-dataSorting</code>
  */
class PlotOptionsArearangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsArearangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeDataSorting {
