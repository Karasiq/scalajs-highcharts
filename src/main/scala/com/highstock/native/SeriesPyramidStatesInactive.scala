...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-inactive</code>
  */
class SeriesPyramidStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPyramidStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesInactive {
