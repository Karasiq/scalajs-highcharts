...
/**
  * @note JavaScript name: <code>plotOptions-trendline-dataGrouping</code>
  */
class PlotOptionsTrendlineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineDataGrouping {
  /**
