...
/**
  * @note JavaScript name: <code>plotOptions-bb-states-select-halo</code>
  */
class PlotOptionsBbStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsBbStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbStatesSelectHalo {
