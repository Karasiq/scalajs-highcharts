...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dataLabels</code>
  */
class SeriesScatter3dDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataLabels {
  /**
