...
/**
  * @note JavaScript name: <code>plotOptions-arearange-dataLabels-animation</code>
  */
class PlotOptionsArearangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsArearangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
