...
/**
  * @note JavaScript name: <code>plotOptions-klinger-accessibility</code>
  */
class PlotOptionsKlingerAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsKlingerAccessibilityPoint]] = js.undefined
}

object PlotOptionsKlingerAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsKlingerAccessibilityPoint]] = js.undefined): PlotOptionsKlingerAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerAccessibility {
