...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-label</code>
  */
class SeriesLinearregressionslopeLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeLabel {
  /**
