...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-dataLabels-animation</code>
  */
class SeriesWaterfallDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWaterfallDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataLabelsAnimation {
      this.defer = defer
    })
  }
}
