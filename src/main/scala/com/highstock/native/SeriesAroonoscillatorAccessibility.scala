...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-accessibility</code>
  */
class SeriesAroonoscillatorAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAroonoscillatorAccessibilityPoint]] = js.undefined
}

object SeriesAroonoscillatorAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAroonoscillatorAccessibilityPoint]] = js.undefined): SeriesAroonoscillatorAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorAccessibility {
