...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-accessibility-point</code>
  */
class SeriesFlagsAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesFlagsAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsAccessibilityPoint {
