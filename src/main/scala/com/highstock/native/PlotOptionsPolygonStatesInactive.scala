...
/**
  * @note JavaScript name: <code>plotOptions-polygon-states-inactive</code>
  */
class PlotOptionsPolygonStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonStatesInactive {
