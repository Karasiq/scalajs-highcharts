...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-accessibility</code>
  */
class SeriesLollipopAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLollipopAccessibilityPoint]] = js.undefined
}

object SeriesLollipopAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLollipopAccessibilityPoint]] = js.undefined): SeriesLollipopAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopAccessibility {
