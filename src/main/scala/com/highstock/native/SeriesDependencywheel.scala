...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;</code>
  */
class SeriesDependencywheel extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>dependencywheel</code> series
  ...
  /**
    * <p>A collection of options for the individual nodes. The nodes in a dependency
    * diagram are auto-generated instances of <code>Highcharts.Point</code>, but options can
    * be applied here and linked by the <code>id</code>.</p>
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "dependencywheel"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectors]] = js.undefined
...
object SeriesDependencywheel {
  /**
    * @param data <p>An array of data points for the series. For the <code>dependencywheel</code> series. type, points can be given in the following way:</p>. <p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">   data: [{.        from: &#39;Category1&#39;,.        to: &#39;Category2&#39;,.        weight: 2.    }, {.        from: &#39;Category1&#39;,.        to: &#39;Category3&#39;,.        weight: 5.    }]. </code></pre>
    * @param nodes <p>A collection of options for the individual nodes. The nodes in a dependency. diagram are auto-generated instances of <code>Highcharts.Point</code>, but options can. be applied here and linked by the <code>id</code>.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Any]] = js.undefined, nodes: js.UndefOr[js.Array[js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[Double | String] = js.undefined, `type`: js.UndefOr[String] = "dependencywheel", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, center: js.UndefOr[js.Array[Double | String | Null]] = js.undefined, curveFactor: js.UndefOr[Double] = js.undefined, startAngle: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, levels: js.UndefOr[js.Array[js.Any]] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, minLinkWidth: js.UndefOr[Double] = js.undefined, nodePadding: js.UndefOr[Double] = js.undefined, nodeWidth: js.UndefOr[Double] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, centerInCategory: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectors]] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, boostBlending: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesDependencywheel = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheel {
      this.data = data
      this.nodes = nodes
      this.id = id
      this.index = index
