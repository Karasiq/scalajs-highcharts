...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-accessibility</code>
  */
class SeriesTilemapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTilemapAccessibilityPoint]] = js.undefined
}

object SeriesTilemapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTilemapAccessibilityPoint]] = js.undefined): SeriesTilemapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapAccessibility {
