...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-lastPrice-label</code>
  */
class SeriesRocLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocLastPriceLabel {
  /**
