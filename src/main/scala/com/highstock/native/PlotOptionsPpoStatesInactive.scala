...
/**
  * @note JavaScript name: <code>plotOptions-ppo-states-inactive</code>
  */
class PlotOptionsPpoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPpoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoStatesInactive {
