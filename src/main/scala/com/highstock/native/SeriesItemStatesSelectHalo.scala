...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-states-select-halo</code>
  */
class SeriesItemStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesItemStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemStatesSelectHalo {
