...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-data-dataLabels-animation</code>
  */
class SeriesWaterfallDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWaterfallDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
