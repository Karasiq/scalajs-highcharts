...
/**
  * @note JavaScript name: <code>navigator-xAxis-title</code>
  */
class NavigatorXAxisTitle extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/axis/">Styled mode</a>
  ...
  /**
    * <p>The actual text of the axis title. It can contain basic HTML tags
    * like <code>b</code>, <code>i</code> and <code>span</code> with style.</p>
...
object NavigatorXAxisTitle {
  /**
    ...
    * @param text <p>The actual text of the axis title. It can contain basic HTML tags. like <code>b</code>, <code>i</code> and <code>span</code> with style.</p>
    ...
    */
  def apply(align: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, margin: js.UndefOr[Double] = js.undefined, offset: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String | Null] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, skew3d: js.UndefOr[Boolean | Null] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, text: js.UndefOr[String | Null] = js.undefined, textAlign: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): NavigatorXAxisTitle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisTitle {
      this.align = align
