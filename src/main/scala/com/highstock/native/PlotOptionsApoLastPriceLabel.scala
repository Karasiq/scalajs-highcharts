...
/**
  * @note JavaScript name: <code>plotOptions-apo-lastPrice-label</code>
  */
class PlotOptionsApoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoLastPriceLabel {
  /**
