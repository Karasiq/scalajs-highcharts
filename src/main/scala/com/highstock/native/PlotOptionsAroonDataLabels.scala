...
/**
  * @note JavaScript name: <code>plotOptions-aroon-dataLabels</code>
  */
class PlotOptionsAroonDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonDataLabels {
  /**
