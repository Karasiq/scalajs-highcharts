...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-cluster-layoutAlgorithm</code>
  */
class PlotOptionsMappointClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): PlotOptionsMappointClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointClusterLayoutAlgorithm {
