...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-accessibility</code>
  */
class PlotOptionsTilemapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTilemapAccessibilityPoint]] = js.undefined
}

object PlotOptionsTilemapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTilemapAccessibilityPoint]] = js.undefined): PlotOptionsTilemapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapAccessibility {
