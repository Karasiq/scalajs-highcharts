...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dataGrouping</code>
  */
class SeriesCylinderDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataGrouping {
  /**
