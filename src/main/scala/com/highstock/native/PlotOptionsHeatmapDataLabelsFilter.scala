...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-dataLabels-filter</code>
  */
class PlotOptionsHeatmapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapDataLabelsFilter {
