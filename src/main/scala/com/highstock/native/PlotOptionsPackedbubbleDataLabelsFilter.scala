...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-dataLabels-filter</code>
  */
class PlotOptionsPackedbubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleDataLabelsFilter {
