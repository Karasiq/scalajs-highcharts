...
/**
  * @note JavaScript name: <code>plotOptions-line-states-inactive</code>
  */
class PlotOptionsLineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsLineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineStatesInactive {
