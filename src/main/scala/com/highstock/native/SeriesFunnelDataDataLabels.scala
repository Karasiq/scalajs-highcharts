...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-data-dataLabels</code>
  */
class SeriesFunnelDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataDataLabels {
  /**
