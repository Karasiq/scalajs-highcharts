...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-data</code>
  */
class SeriesVennData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The name of the point. Used in data labels and tooltip. If name is not
    * defined then it will default to the joined values in
    * <a href="#series.venn.sets">sets</a>.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/euler-diagram/">Euler diagram</a>
  ...
  /**
    * <p>The set or sets the options will be applied to. If a single entry is defined,
    * then it will create a new set. If more than one entry is defined, then it
    * will define the overlap between the sets in the array.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/venn-diagram/">Venn diagram</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/euler-diagram/">Euler diagram</a>
    * @since 7.0.0
    */
  ...
  /**
    * <p>The value of the point, resulting in a relative area of the circle, or area
    * of overlap between two sets in the venn or euler diagram.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/venn-diagram/">Venn diagram</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/euler-diagram/">Euler diagram</a>
    * @since 7.0.0
    */
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesVennDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesVennDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesVennDataEvents]] = js.undefined
...
object SeriesVennData {
  /**
    * @param name <p>The name of the point. Used in data labels and tooltip. If name is not. defined then it will default to the joined values in. <a href="#series.venn.sets">sets</a>.</p>
    * @param sets <p>The set or sets the options will be applied to. If a single entry is defined,. then it will create a new set. If more than one entry is defined, then it. will define the overlap between the sets in the array.</p>
    * @param value <p>The value of the point, resulting in a relative area of the circle, or area. of overlap between two sets in the venn or euler diagram.</p>
    ...
    */
  def apply(name: js.UndefOr[Double] = js.undefined, sets: js.UndefOr[js.Array[String]] = js.undefined, value: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesVennDataDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesVennDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesVennDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined): SeriesVennData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennData {
      this.name = name
      this.sets = sets
      this.value = value
