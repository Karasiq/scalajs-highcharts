...
/**
  * @note JavaScript name: <code>plotOptions-ao-dataLabels</code>
  */
class PlotOptionsAoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoDataLabels {
  /**
