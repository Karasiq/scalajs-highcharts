...
/**
  * @note JavaScript name: <code>navigator-yAxis-labels</code>
  */
class NavigatorYAxisLabels extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisLabels {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, align: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double | String] = js.undefined, levels: js.UndefOr[js.Array[js.Any]] = js.undefined, symbol: js.UndefOr[js.Any] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, autoRotation: js.UndefOr[js.Array[Double]] = js.undefined, autoRotationLimit: js.UndefOr[Double] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, indentation: js.UndefOr[Double] = js.undefined, maxStaggerLines: js.UndefOr[Double] = js.undefined, overflow: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, skew3d: js.UndefOr[Boolean] = js.undefined, staggerLines: js.UndefOr[Double] = js.undefined, step: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): NavigatorYAxisLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisLabels {
