...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-states-inactive</code>
  */
class SeriesPieStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPieStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieStatesInactive {
