...
/**
  * @note JavaScript name: <code>plotOptions-obv-states-hover-halo</code>
  */
class PlotOptionsObvStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsObvStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvStatesHoverHalo {
