...
/**
  * @note JavaScript name: <code>plotOptions-ikh-dataLabels</code>
  */
class PlotOptionsIkhDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhDataLabels {
  /**
