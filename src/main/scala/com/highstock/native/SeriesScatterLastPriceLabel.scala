...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-lastPrice-label</code>
  */
class SeriesScatterLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterLastPriceLabel {
  /**
