...
/**
  * @note JavaScript name: <code>plotOptions-dema-dataLabels-animation</code>
  */
class PlotOptionsDemaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDemaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
