...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-states-select-halo</code>
  */
class PlotOptionsLinearregressionslopeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionslopeStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeStatesSelectHalo {
