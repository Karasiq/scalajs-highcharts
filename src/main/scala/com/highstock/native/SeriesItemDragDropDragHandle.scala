...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dragDrop-dragHandle</code>
  */
class SeriesItemDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesItemDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDragDropDragHandle {
