...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-nodes-dataLabels-animation</code>
  */
class SeriesSankeyNodesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyNodesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSankeyNodesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyNodesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
