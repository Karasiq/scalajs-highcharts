...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-data-dataLabels-animation</code>
  */
class SeriesPieDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPieDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
