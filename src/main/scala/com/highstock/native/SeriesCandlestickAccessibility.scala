...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-accessibility</code>
  */
class SeriesCandlestickAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesCandlestickAccessibilityPoint]] = js.undefined
}

object SeriesCandlestickAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesCandlestickAccessibilityPoint]] = js.undefined): SeriesCandlestickAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickAccessibility {
