...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-marker-states-select</code>
  */
class SeriesOhlcMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesOhlcMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcMarkerStatesSelect {
