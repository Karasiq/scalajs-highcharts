...
/**
  * @note JavaScript name: <code>chart-parallelAxes-crosshair-label</code>
  */
class ChartParallelAxesCrosshairLabel extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Flag to enable crosshair&#39;s label.</p>
...
object ChartParallelAxesCrosshairLabel {
  /**
    ...
    * @param enabled <p>Flag to enable crosshair&#39;s label.</p>
