...
class PlotOptionsGanttDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Allow end value to be dragged individually.</p>
    * @since 6.2.0
    */
  var draggableEnd: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow start value to be dragged individually.</p>
    * @since 6.2.0
    */
  var draggableStart: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow x value to be dragged individually.</p>
    * @since 6.2.0
    */
  var draggableX1: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow x2 value to be dragged individually.</p>
    * @since 6.2.0
    */
...
object PlotOptionsGanttDragDrop {
  /**
    * @param draggableEnd <p>Allow end value to be dragged individually.</p>
    * @param draggableStart <p>Allow start value to be dragged individually.</p>
    * @param draggableX1 <p>Allow x value to be dragged individually.</p>
    * @param draggableX2 <p>Allow x2 value to be dragged individually.</p>
    ...
    */
  def apply(draggableEnd: js.UndefOr[Boolean] = js.undefined, draggableStart: js.UndefOr[Boolean] = js.undefined, draggableX1: js.UndefOr[Boolean] = js.undefined, draggableX2: js.UndefOr[Boolean] = js.undefined, dragHandle: js.UndefOr[js.Any] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsGanttDragDrop = {
