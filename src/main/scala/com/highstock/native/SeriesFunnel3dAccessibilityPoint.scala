...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-accessibility-point</code>
  */
class SeriesFunnel3dAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesFunnel3dAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dAccessibilityPoint {
