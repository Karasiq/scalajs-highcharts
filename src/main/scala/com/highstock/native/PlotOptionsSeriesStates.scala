...
/**
  ...
  */
class PlotOptionsSeriesStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsSeriesStatesSelect]] = js.undefined
}
...
object PlotOptionsSeriesStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsSeriesStatesSelect]] = js.undefined): PlotOptionsSeriesStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesStates {
      this.hover = hover
