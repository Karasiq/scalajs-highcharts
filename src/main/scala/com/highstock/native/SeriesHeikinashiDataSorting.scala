...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dataSorting</code>
  */
class SeriesHeikinashiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesHeikinashiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataSorting {
