...
/**
  * @note JavaScript name: <code>plotOptions-arearange-states-inactive</code>
  */
class PlotOptionsArearangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsArearangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeStatesInactive {
