...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-states</code>
  */
class SeriesCylinderStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesCylinderStatesSelect]] = js.undefined
...
object SeriesCylinderStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesCylinderStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesCylinderStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderStates {
      this.hover = hover
      this.select = select
