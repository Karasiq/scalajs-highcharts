...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-dataGrouping</code>
  */
class SeriesZigzagDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagDataGrouping {
  /**
