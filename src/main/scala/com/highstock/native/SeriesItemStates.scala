...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-states</code>
  */
class SeriesItemStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesItemStatesSelect]] = js.undefined
}

object SeriesItemStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesItemStatesSelect]] = js.undefined): SeriesItemStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemStates {
      this.hover = hover
