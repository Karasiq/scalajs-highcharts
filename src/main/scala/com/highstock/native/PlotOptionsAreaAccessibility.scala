...
/**
  * @note JavaScript name: <code>plotOptions-area-accessibility</code>
  */
class PlotOptionsAreaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAreaAccessibilityPoint]] = js.undefined
}

object PlotOptionsAreaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAreaAccessibilityPoint]] = js.undefined): PlotOptionsAreaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaAccessibility {
