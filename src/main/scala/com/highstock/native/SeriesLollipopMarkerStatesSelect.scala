...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-marker-states-select</code>
  */
class SeriesLollipopMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLollipopMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopMarkerStatesSelect {
