...
/**
  * @note JavaScript name: <code>plotOptions-aroon-dataGrouping</code>
  */
class PlotOptionsAroonDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonDataGrouping {
  /**
