...
/**
  * @note JavaScript name: <code>plotOptions-sma-dataLabels-animation</code>
  */
class PlotOptionsSmaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSmaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
