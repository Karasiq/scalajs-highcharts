...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-states</code>
  */
class SeriesTrixStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesTrixStatesSelect]] = js.undefined
}

object SeriesTrixStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesTrixStatesSelect]] = js.undefined): SeriesTrixStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixStates {
      this.hover = hover
