...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data-dataLabels-filter</code>
  */
class SeriesAreasplineDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreasplineDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataDataLabelsFilter {
