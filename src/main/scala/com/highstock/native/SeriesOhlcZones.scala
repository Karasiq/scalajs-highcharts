...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-zones</code>
  */
class SeriesOhlcZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOhlcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcZones {
