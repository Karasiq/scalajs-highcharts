...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-accessibility-point</code>
  */
class SeriesWordcloudAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesWordcloudAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudAccessibilityPoint {
