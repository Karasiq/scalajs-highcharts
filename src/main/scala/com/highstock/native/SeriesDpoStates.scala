...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-states</code>
  */
class SeriesDpoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesDpoStatesSelect]] = js.undefined
}

object SeriesDpoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDpoStatesSelect]] = js.undefined): SeriesDpoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoStates {
      this.hover = hover
