...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-data-dataLabels</code>
  */
class SeriesArearangeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataDataLabels {
  /**
