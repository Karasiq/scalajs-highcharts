...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-lastPrice-label</code>
  */
class SeriesColumnLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnLastPriceLabel {
  /**
