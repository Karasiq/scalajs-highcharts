...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-marker-states</code>
  */
class PlotOptionsSlowstochasticMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsSlowstochasticMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
