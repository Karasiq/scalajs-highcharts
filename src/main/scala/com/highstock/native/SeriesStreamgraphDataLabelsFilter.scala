...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-dataLabels-filter</code>
  */
class SeriesStreamgraphDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesStreamgraphDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataLabelsFilter {
