...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-states-select-halo</code>
  */
class SeriesObvStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesObvStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvStatesSelectHalo {
