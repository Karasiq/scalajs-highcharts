...
/**
  * @note JavaScript name: <code>plotOptions-natr-states-inactive</code>
  */
class PlotOptionsNatrStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsNatrStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrStatesInactive {
