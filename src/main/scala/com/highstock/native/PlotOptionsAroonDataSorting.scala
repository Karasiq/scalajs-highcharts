...
/**
  * @note JavaScript name: <code>plotOptions-aroon-dataSorting</code>
  */
class PlotOptionsAroonDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAroonDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonDataSorting {
