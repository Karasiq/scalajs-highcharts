...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-dataSorting</code>
  */
class SeriesScatterDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesScatterDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataSorting {
