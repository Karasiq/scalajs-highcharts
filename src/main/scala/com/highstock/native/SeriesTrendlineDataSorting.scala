...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dataSorting</code>
  */
class SeriesTrendlineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesTrendlineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineDataSorting {
