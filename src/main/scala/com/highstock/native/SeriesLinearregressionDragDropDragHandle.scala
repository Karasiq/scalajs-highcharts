...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dragDrop-dragHandle</code>
  */
class SeriesLinearregressionDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesLinearregressionDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionDragDropDragHandle {
