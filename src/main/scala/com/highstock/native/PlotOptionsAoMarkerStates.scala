...
/**
  * @note JavaScript name: <code>plotOptions-ao-marker-states</code>
  */
class PlotOptionsAoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
