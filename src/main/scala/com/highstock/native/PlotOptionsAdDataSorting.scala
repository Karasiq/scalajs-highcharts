...
/**
  * @note JavaScript name: <code>plotOptions-ad-dataSorting</code>
  */
class PlotOptionsAdDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAdDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdDataSorting {
