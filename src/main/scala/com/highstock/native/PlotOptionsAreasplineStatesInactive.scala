...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-states-inactive</code>
  */
class PlotOptionsAreasplineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAreasplineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineStatesInactive {
