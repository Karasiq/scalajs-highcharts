...
/**
  * @note JavaScript name: <code>plotOptions-klinger-dataLabels-animation</code>
  */
class PlotOptionsKlingerDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerDataLabelsAnimation {
      this.defer = defer
    })
  }
}
