...
/**
  * @note JavaScript name: <code>plotOptions-trendline-marker-states</code>
  */
class PlotOptionsTrendlineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsTrendlineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
