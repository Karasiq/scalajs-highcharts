...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-states-hover-halo</code>
  */
class SeriesStochasticStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesStochasticStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticStatesHoverHalo {
