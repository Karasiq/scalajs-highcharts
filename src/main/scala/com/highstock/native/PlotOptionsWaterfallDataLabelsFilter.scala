...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-dataLabels-filter</code>
  */
class PlotOptionsWaterfallDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWaterfallDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallDataLabelsFilter {
