...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-dataSorting</code>
  */
class SeriesArearangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesArearangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataSorting {
