...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-hover-halo</code>
  */
class SeriesFunnelStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesFunnelStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesHoverHalo {
