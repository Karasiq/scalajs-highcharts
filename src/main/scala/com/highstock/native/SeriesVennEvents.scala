...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-events</code>
  */
class SeriesVennEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): SeriesVennEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennEvents {
