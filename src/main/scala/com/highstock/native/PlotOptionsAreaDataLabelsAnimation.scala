...
/**
  * @note JavaScript name: <code>plotOptions-area-dataLabels-animation</code>
  */
class PlotOptionsAreaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAreaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
