...
/**
  ...
  */
class SeriesCandlestickData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesCandlestickDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesCandlestickDataEvents]] = js.undefined
...
object SeriesCandlestickData {
  /**
    ...
    */
  def apply(open: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesCandlestickDataDataLabels]] = js.undefined, high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesCandlestickDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined): SeriesCandlestickData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickData {
      this.open = open
