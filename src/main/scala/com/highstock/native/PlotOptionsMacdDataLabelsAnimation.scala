...
/**
  * @note JavaScript name: <code>plotOptions-macd-dataLabels-animation</code>
  */
class PlotOptionsMacdDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMacdDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdDataLabelsAnimation {
      this.defer = defer
    })
  }
}
