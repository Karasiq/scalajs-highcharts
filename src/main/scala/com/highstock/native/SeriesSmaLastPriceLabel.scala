...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-lastPrice-label</code>
  */
class SeriesSmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaLastPriceLabel {
  /**
