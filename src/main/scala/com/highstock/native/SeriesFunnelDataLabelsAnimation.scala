...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-dataLabels-animation</code>
  */
class SeriesFunnelDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesFunnelDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDataLabelsAnimation {
      this.defer = defer
    })
  }
}
