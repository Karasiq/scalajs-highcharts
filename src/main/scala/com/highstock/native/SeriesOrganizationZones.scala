...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-zones</code>
  */
class SeriesOrganizationZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOrganizationZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationZones {
