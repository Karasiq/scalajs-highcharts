...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-marker-states</code>
  */
class SeriesDmiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDmiMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
