...
/**
  * @note JavaScript name: <code>plotOptions-gantt-zones</code>
  */
class PlotOptionsGanttZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsGanttZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttZones {
