...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-states</code>
  */
class PlotOptionsDisparityindexStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexStatesSelect]] = js.undefined
}

object PlotOptionsDisparityindexStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexStatesSelect]] = js.undefined): PlotOptionsDisparityindexStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexStates {
      this.hover = hover
