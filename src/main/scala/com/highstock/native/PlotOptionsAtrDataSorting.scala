...
/**
  * @note JavaScript name: <code>plotOptions-atr-dataSorting</code>
  */
class PlotOptionsAtrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAtrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrDataSorting {
