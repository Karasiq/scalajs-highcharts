...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-states-hover-halo</code>
  */
class SeriesDemaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDemaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaStatesHoverHalo {
