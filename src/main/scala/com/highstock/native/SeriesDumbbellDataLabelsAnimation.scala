...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dataLabels-animation</code>
  */
class SeriesDumbbellDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDumbbellDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataLabelsAnimation {
      this.defer = defer
    })
  }
}
