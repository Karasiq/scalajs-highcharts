...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-levels-dataLabels-animation</code>
  */
class PlotOptionsSunburstLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSunburstLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
