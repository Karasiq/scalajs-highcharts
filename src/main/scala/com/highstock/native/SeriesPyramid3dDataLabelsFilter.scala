...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-dataLabels-filter</code>
  */
class SeriesPyramid3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPyramid3dDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataLabelsFilter {
