...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-dataLabels</code>
  */
class PlotOptionsSlowstochasticDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticDataLabels {
  /**
