...
/**
  ...
  */
class PlotOptionsHeatmapTooltip extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapTooltip {
  /**
    ...
    */
  def apply(pointFormat: js.UndefOr[String] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined, clusterFormat: js.UndefOr[js.Any] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, distance: js.UndefOr[Double] = js.undefined, followPointer: js.UndefOr[Boolean] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, nullFormat: js.UndefOr[String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, pointFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[js.UndefOr[Double]] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined): PlotOptionsHeatmapTooltip = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapTooltip {
