...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-accessibility-point</code>
  */
class PlotOptionsAreasplineAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): PlotOptionsAreasplineAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineAccessibilityPoint {
