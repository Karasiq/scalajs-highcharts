...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-dataLabels</code>
  */
class SeriesAdDataLabels extends com.highcharts.HighchartsGenericObject {
