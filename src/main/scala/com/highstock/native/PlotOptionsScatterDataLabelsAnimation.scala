...
/**
  * @note JavaScript name: <code>plotOptions-scatter-dataLabels-animation</code>
  */
class PlotOptionsScatterDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsScatterDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterDataLabelsAnimation {
      this.defer = defer
    })
  }
}
