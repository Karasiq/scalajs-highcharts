...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-lastPrice-label</code>
  */
class SeriesItemLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemLastPriceLabel {
  /**
