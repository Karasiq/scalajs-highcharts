...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-dataLabels</code>
  */
class PlotOptionsNetworkgraphDataLabels extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The
    * <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>
    * specifying what to show for <em>node</em> in the networkgraph. In v7.0
    * defaults to <code>{key}</code>, since v7.1 defaults to <code>undefined</code> and
    * <code>formatter</code> is used instead.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-format/">Formatted value in the data label</a>
  ...
  /**
    * <p>Callback JavaScript function to format the data label for a node.
    * Note that if a <code>format</code> is defined, the format takes precedence
    * and the formatter is ignored.</p>
  ...
  /**
    * <p>The
    * <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>
    * specifying what to show for <em>links</em> in the networkgraph.
  ...
  /**
    ...
    * The <code>linkFormat</code> option takes precedence over the
    * <code>linkFormatter</code>.</p>
    * @since 7.1.0
    */
  var linkFormatter: js.Any = js.undefined

  /**
    * <p>Options for a <em>link</em> label text which should follow link
    ...
    * @since 7.1.0
    */
  var linkTextPath: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphDataLabelsLinkTextPath]] = js.undefined
...
object PlotOptionsNetworkgraphDataLabels {
  /**
    * @param format <p>The. <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>. specifying what to show for <em>node</em> in the networkgraph. In v7.0. defaults to <code>{key}</code>, since v7.1 defaults to <code>undefined</code> and. <code>formatter</code> is used instead.</p>
    * @param formatter <p>Callback JavaScript function to format the data label for a node.. Note that if a <code>format</code> is defined, the format takes precedence. and the formatter is ignored.</p>
    * @param linkFormat <p>The. <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>. specifying what to show for <em>links</em> in the networkgraph.. (Default: <code>undefined</code>)</p>
    * @param linkFormatter <p>Callback to format data labels for <em>links</em> in the sankey diagram.. The <code>linkFormat</code> option takes precedence over the. <code>linkFormatter</code>.</p>
    * @param linkTextPath <p>Options for a <em>link</em> label text which should follow link. connection. Border and background are disabled for a label that. follows a path.</p>. <p><strong>Note:</strong> Only SVG-based renderer supports this option. Setting. <code>useHTML</code> to true will disable this option.</p>
    ...
    */
  def apply(format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, linkFormat: js.UndefOr[String] = js.undefined, linkFormatter: js.UndefOr[js.Any] = js.undefined, linkTextPath: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphDataLabelsLinkTextPath]] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphDataLabels {
      this.format = format
