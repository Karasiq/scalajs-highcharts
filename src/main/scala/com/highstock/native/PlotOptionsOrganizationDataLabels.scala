...
/**
  * @note JavaScript name: <code>plotOptions-organization-dataLabels</code>
  */
class PlotOptionsOrganizationDataLabels extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>A callback for defining the format for <em>nodes</em> in the
    * organization chart. The <code>nodeFormat</code> option takes precedence
    * over <code>nodeFormatter</code>.</p>
    * <p>In an organization chart, the <code>nodeFormatter</code> is a quite complex
    ...
    * the data labels come with <code>useHTML</code> set to true, meaning they
    * will be rendered as true HTML above the SVG.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series-organization/datalabels-nodeformatter">Modify the default label format output</a>
    * @since 6.0.2
    */
  var nodeFormatter: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-format/">Formatted value in the data label</a>
  ...
  /**
    * <p>The
    * <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>
    * specifying what to show for <em>nodes</em> in the sankey diagram. By
    * default the <code>nodeFormatter</code> returns <code>{point.name}</code>.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/sankey-link-datalabels/">Node and link data labels</a>
    * @since 6.0.0
    */
...
object PlotOptionsOrganizationDataLabels {
  /**
    * @param nodeFormatter <p>A callback for defining the format for <em>nodes</em> in the. organization chart. The <code>nodeFormat</code> option takes precedence. over <code>nodeFormatter</code>.</p>. <p>In an organization chart, the <code>nodeFormatter</code> is a quite complex. function of the available options, striving for a good default. layout of cards with or without images. In organization chart,. the data labels come with <code>useHTML</code> set to true, meaning they. will be rendered as true HTML above the SVG.</p>
    ...
    * @param nodeFormat <p>The. <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>. specifying what to show for <em>nodes</em> in the sankey diagram. By. default the <code>nodeFormatter</code> returns <code>{point.name}</code>.</p>
    ...
    */
  def apply(nodeFormatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, y: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, x: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationDataLabels {
