...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-dataLabels</code>
  */
class PlotOptionsLinearregressionslopeDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeDataLabels {
  /**
