...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-data-dataLabels-animation</code>
  */
class SeriesLineDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLineDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
