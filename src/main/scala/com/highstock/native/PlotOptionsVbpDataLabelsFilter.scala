...
/**
  * @note JavaScript name: <code>plotOptions-vbp-dataLabels-filter</code>
  */
class PlotOptionsVbpDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVbpDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpDataLabelsFilter {
