...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-select-halo</code>
  */
class SeriesFunnelStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesFunnelStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesSelectHalo {
