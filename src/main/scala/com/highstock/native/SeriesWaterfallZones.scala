...
/**
  ...
  */
class SeriesWaterfallZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWaterfallZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallZones {
