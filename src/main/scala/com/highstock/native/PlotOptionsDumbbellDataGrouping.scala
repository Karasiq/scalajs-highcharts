...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dataGrouping</code>
  */
class PlotOptionsDumbbellDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDataGrouping {
  /**
