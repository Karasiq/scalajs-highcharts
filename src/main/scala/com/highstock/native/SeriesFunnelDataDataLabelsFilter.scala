...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-data-dataLabels-filter</code>
  */
class SeriesFunnelDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFunnelDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDataDataLabelsFilter {
