...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dataLabels-filter</code>
  */
class SeriesSlowstochasticDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticDataLabelsFilter {
