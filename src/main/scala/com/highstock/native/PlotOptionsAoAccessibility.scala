...
/**
  * @note JavaScript name: <code>plotOptions-ao-accessibility</code>
  */
class PlotOptionsAoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAoAccessibilityPoint]] = js.undefined
}

object PlotOptionsAoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAoAccessibilityPoint]] = js.undefined): PlotOptionsAoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoAccessibility {
