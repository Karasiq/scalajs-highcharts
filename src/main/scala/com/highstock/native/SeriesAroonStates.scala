...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-states</code>
  */
class SeriesAroonStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesAroonStatesSelect]] = js.undefined
}

object SeriesAroonStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAroonStatesSelect]] = js.undefined): SeriesAroonStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonStates {
      this.hover = hover
