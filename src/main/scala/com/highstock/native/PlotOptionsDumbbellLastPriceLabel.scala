...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-lastPrice-label</code>
  */
class PlotOptionsDumbbellLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellLastPriceLabel {
  /**
