...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-dataGrouping</code>
  */
class PlotOptionsVariablepieDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariablepieDataGrouping {
  /**
