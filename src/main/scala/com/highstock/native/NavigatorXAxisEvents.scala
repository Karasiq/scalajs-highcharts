...
object NavigatorXAxisEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Any] = js.undefined, afterSetExtremes: js.UndefOr[js.Any] = js.undefined, pointBreak: js.UndefOr[js.Any] = js.undefined, pointInBreak: js.UndefOr[js.Any] = js.undefined, setExtremes: js.UndefOr[js.Any] = js.undefined): NavigatorXAxisEvents = {
