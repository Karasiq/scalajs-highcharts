...
/**
  * @note JavaScript name: <code>plotOptions-trix-params</code>
  */
class PlotOptionsTrixParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsTrixParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixParams {
      this.index = index
      this.period = period
    })
  }
