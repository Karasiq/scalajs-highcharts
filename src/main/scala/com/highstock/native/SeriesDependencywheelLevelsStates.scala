...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-states</code>
  */
class SeriesDependencywheelLevelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsStatesSelect]] = js.undefined
...
object SeriesDependencywheelLevelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesDependencywheelLevelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevelsStates {
      this.hover = hover
