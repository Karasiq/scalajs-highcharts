...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dataGrouping</code>
  */
class PlotOptionsErrorbarDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarDataGrouping {
  /**
