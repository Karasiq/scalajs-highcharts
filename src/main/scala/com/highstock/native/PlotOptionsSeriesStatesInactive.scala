...
/**
  * @note JavaScript name: <code>plotOptions-series-states-inactive</code>
  */
class PlotOptionsSeriesStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesStatesInactive {
