...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-dataLabels-filter</code>
  */
class SeriesPcDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPcDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcDataLabelsFilter {
