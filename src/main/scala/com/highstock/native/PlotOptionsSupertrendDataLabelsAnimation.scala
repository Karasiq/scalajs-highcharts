...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-dataLabels-animation</code>
  */
class PlotOptionsSupertrendDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendDataLabelsAnimation {
      this.defer = defer
    })
  }
}
