...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dataGrouping</code>
  */
class SeriesTrixDataGrouping extends com.highcharts.HighchartsGenericObject {
