...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-accessibility</code>
  */
class SeriesMapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMapAccessibilityPoint]] = js.undefined
}

object SeriesMapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMapAccessibilityPoint]] = js.undefined): SeriesMapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapAccessibility {
