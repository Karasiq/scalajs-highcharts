...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-accessibility</code>
  */
class SeriesHeatmapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesHeatmapAccessibilityPoint]] = js.undefined
}

object SeriesHeatmapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesHeatmapAccessibilityPoint]] = js.undefined): SeriesHeatmapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapAccessibility {
