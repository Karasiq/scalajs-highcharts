...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-accessibility-point</code>
  */
class SeriesMapAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesMapAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapAccessibilityPoint {
