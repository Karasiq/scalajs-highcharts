...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-accessibility</code>
  */
class PlotOptionsWaterfallAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsWaterfallAccessibilityPoint]] = js.undefined
}

object PlotOptionsWaterfallAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsWaterfallAccessibilityPoint]] = js.undefined): PlotOptionsWaterfallAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallAccessibility {
