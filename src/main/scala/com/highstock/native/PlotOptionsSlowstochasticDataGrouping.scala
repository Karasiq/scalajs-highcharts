...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-dataGrouping</code>
  */
class PlotOptionsSlowstochasticDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticDataGrouping {
  /**
