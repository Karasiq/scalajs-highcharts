...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-dataGrouping</code>
  */
class PlotOptionsBoxplotDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotDataGrouping {
  /**
