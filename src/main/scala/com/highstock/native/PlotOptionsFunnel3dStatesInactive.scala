...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-states-inactive</code>
  */
class PlotOptionsFunnel3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsFunnel3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dStatesInactive {
