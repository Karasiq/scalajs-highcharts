...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-accessibility</code>
  */
class SeriesXrangeDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesXrangeDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataAccessibility {
