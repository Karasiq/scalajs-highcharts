...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-zones</code>
  */
class SeriesChaikinZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesChaikinZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinZones {
