...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-connectors-startMarker</code>
  */
class SeriesPsarConnectorsStartMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarConnectorsStartMarker {
  /**
    ...
    */
  def apply(symbol: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPsarConnectorsStartMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarConnectorsStartMarker {
      this.symbol = symbol
      this.align = align
      this.color = color
