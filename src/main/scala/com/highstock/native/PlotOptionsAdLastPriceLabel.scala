...
/**
  * @note JavaScript name: <code>plotOptions-ad-lastPrice-label</code>
  */
class PlotOptionsAdLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdLastPriceLabel {
  /**
