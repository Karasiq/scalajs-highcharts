...
/**
  * @note JavaScript name: <code>plotOptions-xrange-dataGrouping</code>
  */
class PlotOptionsXrangeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeDataGrouping {
  /**
