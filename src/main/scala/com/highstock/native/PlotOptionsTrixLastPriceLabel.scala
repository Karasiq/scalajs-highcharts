...
/**
  * @note JavaScript name: <code>plotOptions-trix-lastPrice-label</code>
  */
class PlotOptionsTrixLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixLastPriceLabel {
  /**
