...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-states</code>
  */
class SeriesChaikinStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesChaikinStatesSelect]] = js.undefined
}

object SeriesChaikinStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesChaikinStatesSelect]] = js.undefined): SeriesChaikinStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinStates {
      this.hover = hover
