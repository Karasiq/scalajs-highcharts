...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-lastPrice-label</code>
  */
class PlotOptionsCandlestickLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickLastPriceLabel {
  /**
