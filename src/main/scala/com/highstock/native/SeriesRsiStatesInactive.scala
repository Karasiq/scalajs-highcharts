...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-states-inactive</code>
  */
class SeriesRsiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesRsiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiStatesInactive {
