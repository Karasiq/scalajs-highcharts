...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-lastPrice-label</code>
  */
class SeriesGaugeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeLastPriceLabel {
  /**
