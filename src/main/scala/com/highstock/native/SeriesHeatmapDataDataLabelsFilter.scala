...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-dataLabels-filter</code>
  */
class SeriesHeatmapDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHeatmapDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataDataLabelsFilter {
