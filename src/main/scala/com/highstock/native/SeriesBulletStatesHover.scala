...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-states-hover</code>
  */
class SeriesBulletStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBulletStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletStatesHover {
