...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-zones</code>
  */
class SeriesBbZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBbZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbZones {
