...
/**
  * @note JavaScript name: <code>plotOptions-bb-marker-states</code>
  */
class PlotOptionsBbMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsBbMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
