...
/**
  * @note JavaScript name: <code>plotOptions-treemap-cluster-layoutAlgorithm</code>
  */
class PlotOptionsTreemapClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): PlotOptionsTreemapClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapClusterLayoutAlgorithm {
