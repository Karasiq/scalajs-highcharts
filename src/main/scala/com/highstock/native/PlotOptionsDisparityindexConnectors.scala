...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-connectors</code>
  */
class PlotOptionsDisparityindexConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexConnectorsStartMarker]] = js.undefined
...
object PlotOptionsDisparityindexConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsDisparityindexConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexConnectors {
