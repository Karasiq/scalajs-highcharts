...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-states-inactive</code>
  */
class SeriesVwapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesVwapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapStatesInactive {
