...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data-accessibility</code>
  */
class SeriesPolygonDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPolygonDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataAccessibility {
