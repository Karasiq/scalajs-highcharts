...
/**
  * @note JavaScript name: <code>plotOptions-mapline-dataLabels-animation</code>
  */
class PlotOptionsMaplineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMaplineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
