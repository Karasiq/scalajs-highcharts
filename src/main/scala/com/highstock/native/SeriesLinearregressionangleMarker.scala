...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-marker</code>
  */
class SeriesLinearregressionangleMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleMarker {
  /**
