...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-lastPrice-label</code>
  */
class PlotOptionsAreasplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineLastPriceLabel {
  /**
