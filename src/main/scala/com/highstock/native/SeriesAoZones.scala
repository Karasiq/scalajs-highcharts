...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-zones</code>
  */
class SeriesAoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoZones {
