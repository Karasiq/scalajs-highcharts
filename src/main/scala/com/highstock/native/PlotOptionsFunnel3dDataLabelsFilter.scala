...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-dataLabels-filter</code>
  */
class PlotOptionsFunnel3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsFunnel3dDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dDataLabelsFilter {
