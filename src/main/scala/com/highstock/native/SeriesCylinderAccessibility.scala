...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-accessibility</code>
  */
class SeriesCylinderAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesCylinderAccessibilityPoint]] = js.undefined
}

object SeriesCylinderAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesCylinderAccessibilityPoint]] = js.undefined): SeriesCylinderAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderAccessibility {
