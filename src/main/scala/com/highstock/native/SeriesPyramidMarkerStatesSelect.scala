...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-marker-states-select</code>
  */
class SeriesPyramidMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesPyramidMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidMarkerStatesSelect {
