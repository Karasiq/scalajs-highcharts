...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-dataGrouping</code>
  */
class SeriesPpoDataGrouping extends com.highcharts.HighchartsGenericObject {
