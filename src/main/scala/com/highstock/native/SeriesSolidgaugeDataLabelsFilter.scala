...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-dataLabels-filter</code>
  */
class SeriesSolidgaugeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSolidgaugeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeDataLabelsFilter {
