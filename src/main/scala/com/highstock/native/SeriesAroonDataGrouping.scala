...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dataGrouping</code>
  */
class SeriesAroonDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonDataGrouping {
  /**
