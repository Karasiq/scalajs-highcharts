...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-marker-states-select</code>
  */
class SeriesHeatmapDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(height: js.UndefOr[js.UndefOr[Double]] = js.undefined, heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesHeatmapDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataMarkerStatesSelect {
      this.height = height
