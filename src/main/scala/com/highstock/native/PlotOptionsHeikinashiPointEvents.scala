...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-point-events</code>
  */
class PlotOptionsHeikinashiPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsHeikinashiPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiPointEvents {
      this.click = click
      this.drag = drag
