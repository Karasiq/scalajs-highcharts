...
/**
  * @note JavaScript name: <code>plotOptions-cmo-states-inactive</code>
  */
class PlotOptionsCmoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsCmoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoStatesInactive {
