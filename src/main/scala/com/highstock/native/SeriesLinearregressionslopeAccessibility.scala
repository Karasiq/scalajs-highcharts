...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-accessibility</code>
  */
class SeriesLinearregressionslopeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLinearregressionslopeAccessibilityPoint]] = js.undefined
}

object SeriesLinearregressionslopeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLinearregressionslopeAccessibilityPoint]] = js.undefined): SeriesLinearregressionslopeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeAccessibility {
