...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dataLabels-animation</code>
  */
class SeriesWilliamsrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWilliamsrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
