...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-accessibility</code>
  */
class PlotOptionsLinearregressionangleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionangleAccessibilityPoint]] = js.undefined
}

object PlotOptionsLinearregressionangleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionangleAccessibilityPoint]] = js.undefined): PlotOptionsLinearregressionangleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleAccessibility {
