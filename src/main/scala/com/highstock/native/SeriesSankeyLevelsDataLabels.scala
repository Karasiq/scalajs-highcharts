...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-dataLabels</code>
  */
class SeriesSankeyLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsDataLabels {
  /**
