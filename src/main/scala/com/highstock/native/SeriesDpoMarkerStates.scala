...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-marker-states</code>
  */
class SeriesDpoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDpoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
