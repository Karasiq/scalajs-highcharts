...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-accessibility</code>
  */
class SeriesAreasplinerangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAreasplinerangeAccessibilityPoint]] = js.undefined
}

object SeriesAreasplinerangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAreasplinerangeAccessibilityPoint]] = js.undefined): SeriesAreasplinerangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeAccessibility {
