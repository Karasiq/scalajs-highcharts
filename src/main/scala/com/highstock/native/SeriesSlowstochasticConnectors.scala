...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-connectors</code>
  */
class SeriesSlowstochasticConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesSlowstochasticConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesSlowstochasticConnectorsStartMarker]] = js.undefined
...
object SeriesSlowstochasticConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesSlowstochasticConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesSlowstochasticConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesSlowstochasticConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticConnectors {
