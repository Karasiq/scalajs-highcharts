...
/**
  * @note JavaScript name: <code>navigator-xAxis-crosshair-label</code>
  */
class NavigatorXAxisCrosshairLabel extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisCrosshairLabel {
  /**
