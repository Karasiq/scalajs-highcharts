...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dataLabels-filter</code>
  */
class PlotOptionsScatter3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dDataLabelsFilter {
