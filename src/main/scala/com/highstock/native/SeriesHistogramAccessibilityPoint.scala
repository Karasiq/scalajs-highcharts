...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-accessibility-point</code>
  */
class SeriesHistogramAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesHistogramAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramAccessibilityPoint {
