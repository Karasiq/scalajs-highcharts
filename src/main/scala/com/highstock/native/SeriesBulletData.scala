...
class SeriesBulletData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var targetOptions: js.UndefOr[CleanJsObject[SeriesBulletDataTargetOptions]] = js.undefined
  ...
  /**
    ...
    * @since 6.0.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesBulletDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesBulletDataDragDrop]] = js.undefined
  ...
  /**
    ...
    * @since 6.0.0
    */
  var events: js.UndefOr[CleanJsObject[SeriesBulletDataEvents]] = js.undefined
...
object SeriesBulletData {
  /**
    ...
    */
  def apply(target: js.UndefOr[Double] = js.undefined, targetOptions: js.UndefOr[CleanJsObject[SeriesBulletDataTargetOptions]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesBulletDataDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesBulletDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesBulletDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined): SeriesBulletData = {
