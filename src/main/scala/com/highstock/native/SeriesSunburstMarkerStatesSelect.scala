...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-marker-states-select</code>
  */
class SeriesSunburstMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesSunburstMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstMarkerStatesSelect {
