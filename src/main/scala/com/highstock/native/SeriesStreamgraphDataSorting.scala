...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-dataSorting</code>
  */
class SeriesStreamgraphDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesStreamgraphDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataSorting {
