...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-zones</code>
  */
class SeriesLinearregressioninterceptZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptZones {
