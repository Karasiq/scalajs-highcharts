...
/**
  * @note JavaScript name: <code>plotOptions-bubble-lastPrice-label</code>
  */
class PlotOptionsBubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleLastPriceLabel {
  /**
