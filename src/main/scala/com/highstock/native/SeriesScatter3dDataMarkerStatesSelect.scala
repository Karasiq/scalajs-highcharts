...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data-marker-states-select</code>
  */
class SeriesScatter3dDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesScatter3dDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataMarkerStatesSelect {
