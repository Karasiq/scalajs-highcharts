...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-connectors-marker</code>
  */
class PlotOptionsPyramid3dConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsPyramid3dConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dConnectorsMarker {
      this.align = align
      this.color = color
