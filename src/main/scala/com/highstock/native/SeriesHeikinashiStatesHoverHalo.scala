...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-states-hover-halo</code>
  */
class SeriesHeikinashiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHeikinashiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiStatesHoverHalo {
