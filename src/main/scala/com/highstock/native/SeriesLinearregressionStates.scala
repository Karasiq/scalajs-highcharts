...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-states</code>
  */
class SeriesLinearregressionStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesLinearregressionStatesSelect]] = js.undefined
}

object SeriesLinearregressionStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesLinearregressionStatesSelect]] = js.undefined): SeriesLinearregressionStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionStates {
      this.hover = hover
