...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-accessibility</code>
  */
class PlotOptionsDependencywheelAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelAccessibilityPoint]] = js.undefined
}

object PlotOptionsDependencywheelAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelAccessibilityPoint]] = js.undefined): PlotOptionsDependencywheelAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelAccessibility {
