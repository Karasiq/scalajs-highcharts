...
/**
  * @note JavaScript name: <code>plotOptions-dmi-states-select-halo</code>
  */
class PlotOptionsDmiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDmiStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiStatesSelectHalo {
