...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-accessibility-point</code>
  */
class SeriesPolygonAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPolygonAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonAccessibilityPoint {
