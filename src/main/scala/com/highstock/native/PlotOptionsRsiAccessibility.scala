...
/**
  * @note JavaScript name: <code>plotOptions-rsi-accessibility</code>
  */
class PlotOptionsRsiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsRsiAccessibilityPoint]] = js.undefined
}

object PlotOptionsRsiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsRsiAccessibilityPoint]] = js.undefined): PlotOptionsRsiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiAccessibility {
