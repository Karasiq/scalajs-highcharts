...
/**
  * @note JavaScript name: <code>plotOptions-funnel-dataGrouping</code>
  */
class PlotOptionsFunnelDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelDataGrouping {
  /**
