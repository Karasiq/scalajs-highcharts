...
/**
  * @note JavaScript name: <code>plotOptions-dmi-dataGrouping</code>
  */
class PlotOptionsDmiDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiDataGrouping {
  /**
