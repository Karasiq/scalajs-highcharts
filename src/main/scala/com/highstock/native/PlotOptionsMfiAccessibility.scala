...
/**
  * @note JavaScript name: <code>plotOptions-mfi-accessibility</code>
  */
class PlotOptionsMfiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMfiAccessibilityPoint]] = js.undefined
}

object PlotOptionsMfiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMfiAccessibilityPoint]] = js.undefined): PlotOptionsMfiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiAccessibility {
