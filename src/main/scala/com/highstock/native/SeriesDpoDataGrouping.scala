...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-dataGrouping</code>
  */
class SeriesDpoDataGrouping extends com.highcharts.HighchartsGenericObject {
