...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dragDrop-dragHandle</code>
  */
class SeriesColumnpyramidDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDragDropDragHandle {
