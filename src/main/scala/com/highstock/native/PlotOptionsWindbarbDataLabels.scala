...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-dataLabels</code>
  */
class PlotOptionsWindbarbDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbDataLabels {
  /**
