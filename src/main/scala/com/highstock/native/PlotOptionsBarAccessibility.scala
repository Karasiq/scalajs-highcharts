...
/**
  * @note JavaScript name: <code>plotOptions-bar-accessibility</code>
  */
class PlotOptionsBarAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBarAccessibilityPoint]] = js.undefined
}

object PlotOptionsBarAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBarAccessibilityPoint]] = js.undefined): PlotOptionsBarAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarAccessibility {
