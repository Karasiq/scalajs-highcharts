...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-dataLabels-animation</code>
  */
class PlotOptionsAroonoscillatorDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAroonoscillatorDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorDataLabelsAnimation {
      this.defer = defer
    })
  }
}
