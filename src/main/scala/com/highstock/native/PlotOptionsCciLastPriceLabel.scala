...
/**
  * @note JavaScript name: <code>plotOptions-cci-lastPrice-label</code>
  */
class PlotOptionsCciLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciLastPriceLabel {
  /**
