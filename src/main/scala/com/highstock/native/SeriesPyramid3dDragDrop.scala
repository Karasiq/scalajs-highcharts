...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-dragDrop</code>
  */
class SeriesPyramid3dDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDragDrop {
  /**
