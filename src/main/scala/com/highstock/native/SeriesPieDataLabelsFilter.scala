...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-dataLabels-filter</code>
  */
class SeriesPieDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPieDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieDataLabelsFilter {
