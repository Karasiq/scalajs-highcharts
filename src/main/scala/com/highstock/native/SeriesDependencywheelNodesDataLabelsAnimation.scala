...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-nodes-dataLabels-animation</code>
  */
class SeriesDependencywheelNodesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelNodesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDependencywheelNodesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelNodesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
