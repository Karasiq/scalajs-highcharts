...
/**
  * @note JavaScript name: <code>plotOptions-tema-states-hover-halo</code>
  */
class PlotOptionsTemaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTemaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaStatesHoverHalo {
