...
/**
  * @note JavaScript name: <code>plotOptions-abands-marker-states</code>
  */
class PlotOptionsAbandsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAbandsMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
