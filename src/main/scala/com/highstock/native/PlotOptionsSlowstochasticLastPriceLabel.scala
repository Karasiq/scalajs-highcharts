...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-lastPrice-label</code>
  */
class PlotOptionsSlowstochasticLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticLastPriceLabel {
  /**
