...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-dataLabels</code>
  */
class PlotOptionsWilliamsrDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrDataLabels {
  /**
