...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-accessibility</code>
  */
class PlotOptionsDisparityindexAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexAccessibilityPoint]] = js.undefined
}

object PlotOptionsDisparityindexAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexAccessibilityPoint]] = js.undefined): PlotOptionsDisparityindexAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexAccessibility {
