...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-marker-states-select</code>
  */
class SeriesWilliamsrMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWilliamsrMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrMarkerStatesSelect {
