...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-events</code>
  */
class SeriesHeikinashiDataEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesHeikinashiDataEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataEvents {
      this.click = click
      this.drag = drag
