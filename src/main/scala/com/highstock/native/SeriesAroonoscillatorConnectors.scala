...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-connectors</code>
  */
class SeriesAroonoscillatorConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesAroonoscillatorConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesAroonoscillatorConnectorsStartMarker]] = js.undefined
...
object SeriesAroonoscillatorConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesAroonoscillatorConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesAroonoscillatorConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesAroonoscillatorConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorConnectors {
