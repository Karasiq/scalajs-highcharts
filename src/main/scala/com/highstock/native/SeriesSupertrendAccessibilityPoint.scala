...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-accessibility-point</code>
  */
class SeriesSupertrendAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesSupertrendAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendAccessibilityPoint {
