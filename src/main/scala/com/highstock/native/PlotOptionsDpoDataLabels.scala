...
/**
  * @note JavaScript name: <code>plotOptions-dpo-dataLabels</code>
  */
class PlotOptionsDpoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoDataLabels {
  /**
