...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-dataSorting</code>
  */
class SeriesColumnrangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesColumnrangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataSorting {
