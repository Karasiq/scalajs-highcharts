...
/**
  * @note JavaScript name: <code>plotOptions-natr-marker</code>
  */
class PlotOptionsNatrMarker extends com.highcharts.HighchartsGenericObject {
