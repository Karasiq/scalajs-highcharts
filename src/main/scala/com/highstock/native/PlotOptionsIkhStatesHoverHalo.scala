...
/**
  * @note JavaScript name: <code>plotOptions-ikh-states-hover-halo</code>
  */
class PlotOptionsIkhStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsIkhStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhStatesHoverHalo {
