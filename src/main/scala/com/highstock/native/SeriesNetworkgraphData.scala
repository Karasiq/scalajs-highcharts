...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-data</code>
  */
class SeriesNetworkgraphData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesNetworkgraphDataDragDrop]] = js.undefined

  /**
    * <p>The individual point events.</p>
    */
  var events: js.UndefOr[CleanJsObject[SeriesNetworkgraphDataEvents]] = js.undefined
...
object SeriesNetworkgraphData {
  /**
    ...
    */
  def apply(dataLabels: js.UndefOr[js.Object | js.Array[js.Object]] = js.undefined, from: js.UndefOr[String] = js.undefined, to: js.UndefOr[String] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesNetworkgraphDataDragDrop]] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesNetworkgraphDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined): SeriesNetworkgraphData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphData {
