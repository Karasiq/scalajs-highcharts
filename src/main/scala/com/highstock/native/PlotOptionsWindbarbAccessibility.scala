...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-accessibility</code>
  */
class PlotOptionsWindbarbAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsWindbarbAccessibilityPoint]] = js.undefined
}

object PlotOptionsWindbarbAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsWindbarbAccessibilityPoint]] = js.undefined): PlotOptionsWindbarbAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbAccessibility {
