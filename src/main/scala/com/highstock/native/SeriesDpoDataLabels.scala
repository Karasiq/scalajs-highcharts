...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-dataLabels</code>
  */
class SeriesDpoDataLabels extends com.highcharts.HighchartsGenericObject {
