...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-lastPrice-label</code>
  */
class SeriesCciLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciLastPriceLabel {
  /**
