...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-accessibility-point</code>
  */
class SeriesGanttAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesGanttAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttAccessibilityPoint {
