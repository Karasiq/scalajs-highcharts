...
/**
  * @note JavaScript name: <code>plotOptions-apo-marker-states</code>
  */
class PlotOptionsApoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsApoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
