...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-dataSorting</code>
  */
class SeriesMaplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMaplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineDataSorting {
