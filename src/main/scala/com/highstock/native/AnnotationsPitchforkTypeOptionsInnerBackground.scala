...
/**
  * @note JavaScript name: <code>annotations-pitchfork-typeOptions-innerBackground</code>
  */
class AnnotationsPitchforkTypeOptionsInnerBackground extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsPitchforkTypeOptionsInnerBackground {
  /**
    ...
    */
  def apply(fill: js.UndefOr[String] = js.undefined, strokeWidth: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, ry: js.UndefOr[Double] = js.undefined, snap: js.UndefOr[Double] = js.undefined, src: js.UndefOr[String] = js.undefined, stroke: js.UndefOr[String] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): AnnotationsPitchforkTypeOptionsInnerBackground = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsPitchforkTypeOptionsInnerBackground {
      this.fill = fill
