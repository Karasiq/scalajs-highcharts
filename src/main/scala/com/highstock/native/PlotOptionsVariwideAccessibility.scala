...
/**
  * @note JavaScript name: <code>plotOptions-variwide-accessibility</code>
  */
class PlotOptionsVariwideAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsVariwideAccessibilityPoint]] = js.undefined
}

object PlotOptionsVariwideAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsVariwideAccessibilityPoint]] = js.undefined): PlotOptionsVariwideAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideAccessibility {
