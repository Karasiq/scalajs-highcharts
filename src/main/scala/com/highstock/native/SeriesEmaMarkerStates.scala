...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-marker-states</code>
  */
class SeriesEmaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesEmaMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
