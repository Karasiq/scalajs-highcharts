...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-dataLabels</code>
  */
class PlotOptionsKeltnerchannelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsDataLabels {
  /**
