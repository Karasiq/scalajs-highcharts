...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-states-inactive</code>
  */
class SeriesPriceenvelopesStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPriceenvelopesStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesStatesInactive {
