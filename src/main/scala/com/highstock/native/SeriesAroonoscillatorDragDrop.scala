...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dragDrop</code>
  */
class SeriesAroonoscillatorDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDragDrop {
  /**
