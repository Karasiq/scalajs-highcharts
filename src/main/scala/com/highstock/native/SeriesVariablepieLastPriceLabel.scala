...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-lastPrice-label</code>
  */
class SeriesVariablepieLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieLastPriceLabel {
  /**
