...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-marker-states-select</code>
  */
class SeriesTrendlineMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesTrendlineMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineMarkerStatesSelect {
