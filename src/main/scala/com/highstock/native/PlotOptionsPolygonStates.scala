...
class PlotOptionsPolygonStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 4.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsPolygonStatesSelect]] = js.undefined
}
...
object PlotOptionsPolygonStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsPolygonStatesSelect]] = js.undefined): PlotOptionsPolygonStates = {
