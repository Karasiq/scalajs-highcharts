...
/**
  * @note JavaScript name: <code>plotOptions-trix-dataSorting</code>
  */
class PlotOptionsTrixDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsTrixDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixDataSorting {
