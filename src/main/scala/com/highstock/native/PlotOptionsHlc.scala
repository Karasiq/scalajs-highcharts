...
/**
  * @note JavaScript name: <code>plotOptions-hlc</code>
  */
class PlotOptionsHlc extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[PlotOptionsHlcConnectors]] = js.undefined
