...
/**
  * @note JavaScript name: <code>plotOptions-dema-states</code>
  */
class PlotOptionsDemaStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDemaStatesSelect]] = js.undefined
}

object PlotOptionsDemaStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDemaStatesSelect]] = js.undefined): PlotOptionsDemaStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaStates {
      this.hover = hover
