...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-states-select-halo</code>
  */
class PlotOptionsPriceenvelopesStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPriceenvelopesStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesStatesSelectHalo {
