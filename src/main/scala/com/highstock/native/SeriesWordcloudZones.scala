...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-zones</code>
  */
class SeriesWordcloudZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWordcloudZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudZones {
