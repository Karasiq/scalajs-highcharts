...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-accessibility</code>
  */
class SeriesObvAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesObvAccessibilityPoint]] = js.undefined
}

object SeriesObvAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesObvAccessibilityPoint]] = js.undefined): SeriesObvAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvAccessibility {
