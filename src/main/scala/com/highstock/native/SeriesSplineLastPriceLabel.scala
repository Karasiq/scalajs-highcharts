...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-lastPrice-label</code>
  */
class SeriesSplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineLastPriceLabel {
  /**
