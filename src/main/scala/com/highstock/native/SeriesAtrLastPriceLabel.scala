...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-lastPrice-label</code>
  */
class SeriesAtrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrLastPriceLabel {
  /**
