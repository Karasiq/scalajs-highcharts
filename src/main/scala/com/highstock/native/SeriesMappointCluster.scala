...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-cluster</code>
  */
class SeriesMappointCluster extends com.highcharts.HighchartsGenericObject {
