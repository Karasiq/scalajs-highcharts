...
/**
  * @note JavaScript name: <code>plotOptions-line-accessibility</code>
  */
class PlotOptionsLineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLineAccessibilityPoint]] = js.undefined
}

object PlotOptionsLineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLineAccessibilityPoint]] = js.undefined): PlotOptionsLineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineAccessibility {
