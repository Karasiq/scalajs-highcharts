...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-states-inactive</code>
  */
class PlotOptionsWindbarbStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsWindbarbStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbStatesInactive {
