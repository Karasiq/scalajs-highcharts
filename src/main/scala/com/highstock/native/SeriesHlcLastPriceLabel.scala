...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-lastPrice-label</code>
  */
class SeriesHlcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcLastPriceLabel {
  /**
