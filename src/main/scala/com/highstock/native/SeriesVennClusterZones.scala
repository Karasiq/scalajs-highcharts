...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-cluster-zones</code>
  */
class SeriesVennClusterZones extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesVennClusterZonesMarker]] = js.undefined
...
object SeriesVennClusterZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, from: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesVennClusterZonesMarker]] = js.undefined, to: js.UndefOr[Double] = js.undefined): SeriesVennClusterZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennClusterZones {
