...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-accessibility-point</code>
  */
class SeriesPpoAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPpoAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoAccessibilityPoint {
