...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dataSorting</code>
  */
class SeriesHlcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesHlcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataSorting {
