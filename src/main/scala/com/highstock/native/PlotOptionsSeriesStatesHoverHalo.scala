...
/**
  * @note JavaScript name: <code>plotOptions-series-states-hover-halo</code>
  */
class PlotOptionsSeriesStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesStatesHoverHalo {
