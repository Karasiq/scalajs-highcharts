...
/**
  * @note JavaScript name: <code>plotOptions-area-lastPrice-label</code>
  */
class PlotOptionsAreaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaLastPriceLabel {
  /**
