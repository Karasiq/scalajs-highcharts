...
/**
  * @note JavaScript name: <code>plotOptions-dema-marker</code>
  */
class PlotOptionsDemaMarker extends com.highcharts.HighchartsGenericObject {
