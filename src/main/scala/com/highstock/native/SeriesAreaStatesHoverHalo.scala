...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-states-hover-halo</code>
  */
class SeriesAreaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAreaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaStatesHoverHalo {
