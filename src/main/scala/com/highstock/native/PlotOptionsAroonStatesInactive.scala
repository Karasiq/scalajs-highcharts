...
/**
  * @note JavaScript name: <code>plotOptions-aroon-states-inactive</code>
  */
class PlotOptionsAroonStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAroonStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonStatesInactive {
