...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-lastPrice-label</code>
  */
class SeriesSlowstochasticLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticLastPriceLabel {
  /**
