...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-states-select</code>
  */
class SeriesDependencywheelLevelsStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLevelsStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesDependencywheelLevelsStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevelsStatesSelect {
