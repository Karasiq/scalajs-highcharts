...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-states-inactive</code>
  */
class PlotOptionsDumbbellStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellStatesInactive {
