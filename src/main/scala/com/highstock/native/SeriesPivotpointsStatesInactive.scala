...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-inactive</code>
  */
class SeriesPivotpointsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPivotpointsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesInactive {
