...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-states-select-halo</code>
  */
class PlotOptionsKeltnerchannelsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsKeltnerchannelsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsStatesSelectHalo {
