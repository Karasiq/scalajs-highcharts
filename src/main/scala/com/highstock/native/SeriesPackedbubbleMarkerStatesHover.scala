...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-marker-states-hover</code>
  */
class SeriesPackedbubbleMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleMarkerStatesHover {
  /**
    ...
    */
  def apply(radiusPlus: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleMarkerStatesHover {
