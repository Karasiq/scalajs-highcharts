...
/**
  * @note JavaScript name: <code>annotations-infinityLine-labelOptions</code>
  */
class AnnotationsInfinityLineLabelOptions extends com.highcharts.HighchartsGenericObject {
