...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-lastPrice-label</code>
  */
class SeriesHeatmapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapLastPriceLabel {
  /**
