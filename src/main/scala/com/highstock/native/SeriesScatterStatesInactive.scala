...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-states-inactive</code>
  */
class SeriesScatterStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesScatterStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterStatesInactive {
