...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-dataLabels-filter</code>
  */
class SeriesDpoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDpoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoDataLabelsFilter {
