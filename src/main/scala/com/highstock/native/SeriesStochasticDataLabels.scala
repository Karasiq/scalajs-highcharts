...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-dataLabels</code>
  */
class SeriesStochasticDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticDataLabels {
  /**
