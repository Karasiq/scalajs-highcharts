...
/**
  * @note JavaScript name: <code>plotOptions-pareto-dataGrouping</code>
  */
class PlotOptionsParetoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoDataGrouping {
  /**
