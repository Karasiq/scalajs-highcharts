...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-states-select-halo</code>
  */
class SeriesLollipopStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLollipopStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopStatesSelectHalo {
