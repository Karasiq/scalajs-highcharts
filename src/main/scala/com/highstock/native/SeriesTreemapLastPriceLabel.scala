...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-lastPrice-label</code>
  */
class SeriesTreemapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapLastPriceLabel {
  /**
