...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-dataSorting</code>
  */
class PlotOptionsOhlcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOhlcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsOhlcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcDataSorting {
