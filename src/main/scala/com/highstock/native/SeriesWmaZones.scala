...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-zones</code>
  */
class SeriesWmaZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWmaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaZones {
