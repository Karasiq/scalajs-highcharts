...
/**
  * @note JavaScript name: <code>plotOptions-dmi-zones</code>
  */
class PlotOptionsDmiZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDmiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiZones {
