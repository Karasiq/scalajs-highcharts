...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-dataGrouping</code>
  */
class SeriesRocDataGrouping extends com.highcharts.HighchartsGenericObject {
