...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-states</code>
  */
class SeriesOrganizationLevelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesOrganizationLevelsStatesSelect]] = js.undefined
...
object SeriesOrganizationLevelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesOrganizationLevelsStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesOrganizationLevelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsStates {
      this.hover = hover
