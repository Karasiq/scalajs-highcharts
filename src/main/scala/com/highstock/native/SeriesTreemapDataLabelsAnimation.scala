...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-dataLabels-animation</code>
  */
class SeriesTreemapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTreemapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
