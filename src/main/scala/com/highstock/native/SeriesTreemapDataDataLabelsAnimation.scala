...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-data-dataLabels-animation</code>
  */
class SeriesTreemapDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTreemapDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
