...
object SeriesTilemapStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTilemapStatesHoverHalo = {
