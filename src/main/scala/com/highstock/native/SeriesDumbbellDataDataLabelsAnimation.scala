...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-dataLabels-animation</code>
  */
class SeriesDumbbellDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDumbbellDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
