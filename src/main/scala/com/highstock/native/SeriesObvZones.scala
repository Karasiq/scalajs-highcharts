...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-zones</code>
  */
class SeriesObvZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesObvZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvZones {
