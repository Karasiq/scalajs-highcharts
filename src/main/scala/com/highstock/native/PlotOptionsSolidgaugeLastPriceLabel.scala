...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-lastPrice-label</code>
  */
class PlotOptionsSolidgaugeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSolidgaugeLastPriceLabel {
  /**
