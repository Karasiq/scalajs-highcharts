...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-lastPrice-label</code>
  */
class PlotOptionsPackedbubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleLastPriceLabel {
  /**
