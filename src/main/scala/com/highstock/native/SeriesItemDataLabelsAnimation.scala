...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dataLabels-animation</code>
  */
class SeriesItemDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesItemDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataLabelsAnimation {
      this.defer = defer
    })
  }
}
