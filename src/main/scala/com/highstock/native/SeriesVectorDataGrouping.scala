...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-dataGrouping</code>
  */
class SeriesVectorDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataGrouping {
  /**
