...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-states-inactive</code>
  */
class SeriesLineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesLineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineStatesInactive {
