...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-states-inactive</code>
  */
class PlotOptionsCandlestickStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickStatesInactive {
