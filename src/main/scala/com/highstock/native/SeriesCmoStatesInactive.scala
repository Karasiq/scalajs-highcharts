...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-states-inactive</code>
  */
class SeriesCmoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesCmoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoStatesInactive {
