...
/**
  * @note JavaScript name: <code>plotOptions-ema-zones</code>
  */
class PlotOptionsEmaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsEmaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaZones {
