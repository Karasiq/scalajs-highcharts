...
/**
  ...
  */
class SeriesPolygonDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPolygonDataMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
