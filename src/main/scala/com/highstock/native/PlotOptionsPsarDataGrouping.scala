...
/**
  * @note JavaScript name: <code>plotOptions-psar-dataGrouping</code>
  */
class PlotOptionsPsarDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarDataGrouping {
  /**
