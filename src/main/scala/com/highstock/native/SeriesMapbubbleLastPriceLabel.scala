...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-lastPrice-label</code>
  */
class SeriesMapbubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleLastPriceLabel {
  /**
