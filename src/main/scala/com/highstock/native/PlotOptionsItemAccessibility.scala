...
/**
  * @note JavaScript name: <code>plotOptions-item-accessibility</code>
  */
class PlotOptionsItemAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsItemAccessibilityPoint]] = js.undefined
}

object PlotOptionsItemAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsItemAccessibilityPoint]] = js.undefined): PlotOptionsItemAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemAccessibility {
