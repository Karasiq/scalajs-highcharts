...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-dataLabels</code>
  */
class SeriesWmaDataLabels extends com.highcharts.HighchartsGenericObject {
