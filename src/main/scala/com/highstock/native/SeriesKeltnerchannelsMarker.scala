...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-marker</code>
  */
class SeriesKeltnerchannelsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsMarker {
  /**
