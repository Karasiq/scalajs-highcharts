...
/**
  * @note JavaScript name: <code>plotOptions-organization-states</code>
  */
class PlotOptionsOrganizationStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsOrganizationStatesSelect]] = js.undefined
...
object PlotOptionsOrganizationStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsOrganizationStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsOrganizationStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationStates {
      this.hover = hover
