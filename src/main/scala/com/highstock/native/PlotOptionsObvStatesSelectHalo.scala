...
/**
  * @note JavaScript name: <code>plotOptions-obv-states-select-halo</code>
  */
class PlotOptionsObvStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsObvStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvStatesSelectHalo {
