...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-marker-states</code>
  */
class SeriesStreamgraphMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesStreamgraphMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
