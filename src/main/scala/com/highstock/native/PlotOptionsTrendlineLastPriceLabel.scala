...
/**
  * @note JavaScript name: <code>plotOptions-trendline-lastPrice-label</code>
  */
class PlotOptionsTrendlineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineLastPriceLabel {
  /**
