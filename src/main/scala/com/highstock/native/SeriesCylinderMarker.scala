...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-marker</code>
  */
class SeriesCylinderMarker extends com.highcharts.HighchartsGenericObject {
