...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-dataLabels</code>
  */
class PlotOptionsStreamgraphDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphDataLabels {
  /**
