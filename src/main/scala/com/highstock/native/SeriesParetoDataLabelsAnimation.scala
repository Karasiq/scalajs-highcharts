...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-dataLabels-animation</code>
  */
class SeriesParetoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesParetoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
