...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dataLabels-filter</code>
  */
class SeriesLinearregressionslopeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeDataLabelsFilter {
