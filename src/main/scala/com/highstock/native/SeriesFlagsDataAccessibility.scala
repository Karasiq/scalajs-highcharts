...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-data-accessibility</code>
  */
class SeriesFlagsDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesFlagsDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsDataAccessibility {
