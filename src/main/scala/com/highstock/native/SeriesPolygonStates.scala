...
class SeriesPolygonStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesPolygonStatesSelect]] = js.undefined
}
...
object SeriesPolygonStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesPolygonStatesSelect]] = js.undefined): SeriesPolygonStates = {
