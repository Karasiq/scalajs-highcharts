...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-connectors</code>
  */
class SeriesDependencywheelConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectorsStartMarker]] = js.undefined
...
object SeriesDependencywheelConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesDependencywheelConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesDependencywheelConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelConnectors {
