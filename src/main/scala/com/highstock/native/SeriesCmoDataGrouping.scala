...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dataGrouping</code>
  */
class SeriesCmoDataGrouping extends com.highcharts.HighchartsGenericObject {
