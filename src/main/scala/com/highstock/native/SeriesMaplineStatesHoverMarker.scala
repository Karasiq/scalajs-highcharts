...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-hover-marker</code>
  */
class SeriesMaplineStatesHoverMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesHoverMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesMaplineStatesHoverMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesHoverMarker {
