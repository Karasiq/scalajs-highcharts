...
/**
  * @note JavaScript name: <code>plotOptions-histogram-dataGrouping</code>
  */
class PlotOptionsHistogramDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramDataGrouping {
  /**
