...
/**
  * @note JavaScript name: <code>plotOptions-dema-dataGrouping</code>
  */
class PlotOptionsDemaDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaDataGrouping {
  /**
