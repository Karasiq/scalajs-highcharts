...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-data-dataLabels</code>
  */
class SeriesLineDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataDataLabels {
  /**
