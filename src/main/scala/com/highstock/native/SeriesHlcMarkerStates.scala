...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-marker-states</code>
  */
class SeriesHlcMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesHlcMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
