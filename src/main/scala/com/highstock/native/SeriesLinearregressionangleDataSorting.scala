...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-dataSorting</code>
  */
class SeriesLinearregressionangleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLinearregressionangleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleDataSorting {
