...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-connectors</code>
  */
class SeriesHollowcandlestickConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesHollowcandlestickConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesHollowcandlestickConnectorsStartMarker]] = js.undefined
...
object SeriesHollowcandlestickConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesHollowcandlestickConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesHollowcandlestickConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesHollowcandlestickConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickConnectors {
