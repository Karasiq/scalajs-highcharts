...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-dataLabels-animation</code>
  */
class SeriesHollowcandlestickDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataLabelsAnimation {
      this.defer = defer
    })
  }
}
