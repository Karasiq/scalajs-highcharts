...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dataSorting</code>
  */
class SeriesDumbbellDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesDumbbellDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataSorting {
