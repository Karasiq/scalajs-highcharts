...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-accessibility-point</code>
  */
class SeriesColumnpyramidAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesColumnpyramidAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidAccessibilityPoint {
