...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-states-hover-halo</code>
  */
class SeriesMapbubbleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMapbubbleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStatesHoverHalo {
      this.size = size
