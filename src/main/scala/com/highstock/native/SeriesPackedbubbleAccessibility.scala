...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-accessibility</code>
  */
class SeriesPackedbubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPackedbubbleAccessibilityPoint]] = js.undefined
}

object SeriesPackedbubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPackedbubbleAccessibilityPoint]] = js.undefined): SeriesPackedbubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleAccessibility {
