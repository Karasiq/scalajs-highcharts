...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-data-dataLabels</code>
  */
class SeriesWordcloudDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataDataLabels {
  /**
