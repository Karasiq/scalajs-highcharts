...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-cluster-layoutAlgorithm</code>
  */
class SeriesVectorClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): SeriesVectorClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorClusterLayoutAlgorithm {
