...
class PlotOptionsVariablepiePointEvents extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * clicked. The <code>this</code> keyword refers to the point itself. One
    ...
    * the point. This can be prevented by calling <code>event.preventDefault()</code>.</p>
...
object PlotOptionsVariablepiePointEvents {
  /**
    ...
    */
  def apply(legendItemClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsVariablepiePointEvents = {
