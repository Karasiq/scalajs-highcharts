...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dataSorting</code>
  */
class PlotOptionsLollipopDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLollipopDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopDataSorting {
