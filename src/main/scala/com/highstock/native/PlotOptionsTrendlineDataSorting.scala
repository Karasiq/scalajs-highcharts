...
/**
  * @note JavaScript name: <code>plotOptions-trendline-dataSorting</code>
  */
class PlotOptionsTrendlineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsTrendlineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineDataSorting {
