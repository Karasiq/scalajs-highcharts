...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-accessibility</code>
  */
class SeriesAtrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAtrAccessibilityPoint]] = js.undefined
}

object SeriesAtrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAtrAccessibilityPoint]] = js.undefined): SeriesAtrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrAccessibility {
