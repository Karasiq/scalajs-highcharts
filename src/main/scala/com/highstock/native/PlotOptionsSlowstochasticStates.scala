...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-states</code>
  */
class PlotOptionsSlowstochasticStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsSlowstochasticStatesSelect]] = js.undefined
}

object PlotOptionsSlowstochasticStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsSlowstochasticStatesSelect]] = js.undefined): PlotOptionsSlowstochasticStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticStates {
      this.hover = hover
