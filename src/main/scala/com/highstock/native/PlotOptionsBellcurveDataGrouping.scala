...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dataGrouping</code>
  */
class PlotOptionsBellcurveDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveDataGrouping {
  /**
