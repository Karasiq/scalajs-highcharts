...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-states-inactive</code>
  */
class PlotOptionsTilemapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsTilemapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapStatesInactive {
