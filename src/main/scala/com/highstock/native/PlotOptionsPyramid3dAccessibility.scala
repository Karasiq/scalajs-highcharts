...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-accessibility</code>
  */
class PlotOptionsPyramid3dAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dAccessibilityPoint]] = js.undefined
}

object PlotOptionsPyramid3dAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dAccessibilityPoint]] = js.undefined): PlotOptionsPyramid3dAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dAccessibility {
