...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-accessibility</code>
  */
class SeriesPyramid3dDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPyramid3dDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataAccessibility {
