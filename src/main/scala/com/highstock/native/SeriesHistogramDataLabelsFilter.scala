...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-dataLabels-filter</code>
  */
class SeriesHistogramDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHistogramDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramDataLabelsFilter {
