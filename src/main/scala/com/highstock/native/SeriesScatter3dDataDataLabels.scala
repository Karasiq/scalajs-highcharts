...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data-dataLabels</code>
  */
class SeriesScatter3dDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataDataLabels {
  /**
