...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-accessibility</code>
  */
class PlotOptionsWilliamsrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsWilliamsrAccessibilityPoint]] = js.undefined
}

object PlotOptionsWilliamsrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsWilliamsrAccessibilityPoint]] = js.undefined): PlotOptionsWilliamsrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrAccessibility {
