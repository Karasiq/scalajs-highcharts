...
/**
  * @note JavaScript name: <code>plotOptions-trendline-dataLabels-animation</code>
  */
class PlotOptionsTrendlineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTrendlineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
