...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-states-hover-halo</code>
  */
class PlotOptionsSlowstochasticStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSlowstochasticStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticStatesHoverHalo {
