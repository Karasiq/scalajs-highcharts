...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dataSorting</code>
  */
class SeriesTemaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesTemaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaDataSorting {
