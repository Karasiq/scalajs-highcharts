...
/**
  * @note JavaScript name: <code>plotOptions-venn-dataGrouping</code>
  */
class PlotOptionsVennDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennDataGrouping {
  /**
