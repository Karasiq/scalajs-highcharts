...
/**
  * @note JavaScript name: <code>plotOptions-cmo-accessibility</code>
  */
class PlotOptionsCmoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsCmoAccessibilityPoint]] = js.undefined
}

object PlotOptionsCmoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCmoAccessibilityPoint]] = js.undefined): PlotOptionsCmoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoAccessibility {
