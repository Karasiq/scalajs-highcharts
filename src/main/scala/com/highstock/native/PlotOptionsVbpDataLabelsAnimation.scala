...
/**
  * @note JavaScript name: <code>plotOptions-vbp-dataLabels-animation</code>
  */
class PlotOptionsVbpDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVbpDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpDataLabelsAnimation {
      this.defer = defer
    })
  }
}
