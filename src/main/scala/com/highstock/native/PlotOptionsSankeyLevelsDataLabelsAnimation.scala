...
/**
  * @note JavaScript name: <code>plotOptions-sankey-levels-dataLabels-animation</code>
  */
class PlotOptionsSankeyLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
