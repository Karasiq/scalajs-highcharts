...
/**
  * @note JavaScript name: <code>plotOptions-histogram-dataLabels-animation</code>
  */
class PlotOptionsHistogramDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsHistogramDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramDataLabelsAnimation {
      this.defer = defer
    })
  }
}
