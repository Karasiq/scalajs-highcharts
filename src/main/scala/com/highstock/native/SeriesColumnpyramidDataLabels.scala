...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dataLabels</code>
  */
class SeriesColumnpyramidDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataLabels {
  /**
