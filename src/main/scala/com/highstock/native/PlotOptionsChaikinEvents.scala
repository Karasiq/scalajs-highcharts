...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-events</code>
  */
class PlotOptionsChaikinEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsChaikinEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinEvents {
