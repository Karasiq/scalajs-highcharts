...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-states-inactive</code>
  */
class SeriesSplineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesSplineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineStatesInactive {
