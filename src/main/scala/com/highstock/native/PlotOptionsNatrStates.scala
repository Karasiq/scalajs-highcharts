...
/**
  * @note JavaScript name: <code>plotOptions-natr-states</code>
  */
class PlotOptionsNatrStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsNatrStatesSelect]] = js.undefined
}

object PlotOptionsNatrStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsNatrStatesSelect]] = js.undefined): PlotOptionsNatrStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrStates {
      this.hover = hover
