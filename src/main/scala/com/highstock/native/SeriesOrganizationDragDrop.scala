...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-dragDrop</code>
  */
class SeriesOrganizationDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDragDrop {
  /**
