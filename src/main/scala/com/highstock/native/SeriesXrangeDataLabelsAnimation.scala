...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-dataLabels-animation</code>
  */
class SeriesXrangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesXrangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
