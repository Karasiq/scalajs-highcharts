...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dataSorting</code>
  */
class SeriesLinearregressionslopeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLinearregressionslopeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeDataSorting {
