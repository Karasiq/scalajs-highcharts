...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dataLabels</code>
  */
class SeriesSlowstochasticDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDataLabels {
  /**
