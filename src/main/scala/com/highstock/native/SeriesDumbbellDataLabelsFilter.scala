...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dataLabels-filter</code>
  */
class SeriesDumbbellDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDumbbellDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataLabelsFilter {
