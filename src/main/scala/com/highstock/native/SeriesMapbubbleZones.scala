...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-zones</code>
  */
class SeriesMapbubbleZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMapbubbleZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleZones {
