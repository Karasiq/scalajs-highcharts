...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-dataLabels-animation</code>
  */
class SeriesPackedbubbleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
