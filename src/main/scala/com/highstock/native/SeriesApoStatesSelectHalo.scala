...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-states-select-halo</code>
  */
class SeriesApoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesApoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoStatesSelectHalo {
