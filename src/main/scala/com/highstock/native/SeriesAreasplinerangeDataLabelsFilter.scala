...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-dataLabels-filter</code>
  */
class SeriesAreasplinerangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataLabelsFilter {
