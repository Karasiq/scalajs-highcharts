...
trait Series extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/members/series-addpoint/" target="_blank">Append 100 points</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/members/series-addpoint-shift/" target="_blank">append and shift</a>
    */
...
Can be one of <code>null</code>, <code>"percent"</code> or <code>"value"</code>.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/members/series-show-hide/" target="_blank">Toggle visibility from a button</a>
    */
...
New options that will be merged into the series' existing options.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/members/series-remove/" target="_blank">Remove first series from a button</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/stock/members/series-setdata/" target="_blank">Set new data from a button</a>
    */
