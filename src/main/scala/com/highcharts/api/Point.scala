...
trait Point extends js.Object {
   ...
   * @since 1.2.0
   */
  def remove(redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def slice(sliced: UndefOr[Boolean] = js.undefined, redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def update(options: UndefOr[js.Any] = js.undefined, redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def select(select: UndefOr[Boolean] = js.undefined, accumulate: UndefOr[Boolean] = js.undefined): Unit = js.native
