...
trait Renderer extends js.Object {
  ...
  /**
    * Draw text. The text can contain a subset of HTML, like spans and anchors and some basic text styling of these. For more advanced features like border and background, use <a href="#Renderer.label">label</a> instead. To update the text after render, run <code>Element.attr({ text: 'New text' })</code>.
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-text-on-chart/" target="_blank">Annotate the chart freely</a>; <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-on-chart/" target="_blank">annotate with a border and in response to the data</a>; <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-text/" target="_blank">formatted text</a>.
    * @since 2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-arc/" target="_blank">Drawing an arc</a>
    * @since 2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-circle/" target="_blank">Drawing a circle</a>
    * @since 2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-g/" target="_blank">Show and hide grouped objects</a>
    * @since 2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-path-on-chart/" target="_blank">Draw a path in a chart</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-path/" target="_blank">draw a path independent from a chart</a>
    * @since 2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-rect-on-chart/" target="_blank">Draw a rectangle in a chart</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-rect/" target="_blank">draw a rectangle independent from a chart</a>
    * @since 2.0
    */
  def rect(x: Double = ???, y: Double = ???, width: Double = ???, height: Double = ???, cornerRadius: Double = ???): CleanJsObject[Element] = js.native

  /**
    * Draw a label, which is an extended <code>text</code> element with support for border and background. Highcharts creates a <code>g</code> element with a <code>text</code> and a <code>path</code> or <code>rect</code> inside, to make it behave somewhat like a HTML <code>div</code>. Border and background are set through <code>stroke</code>, <code>stroke-width</code> and <code>fill</code> attributes using the <a href="#Element.attr">attr</a> method. To update the text after render, run <code>Element.attr({ text: 'New text' })</code>.
    * @param str 
The text or HTML to draw
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/renderer-label-on-chart/" target="_blank">A label on the chart</a>
    */
...
The text or HTML to draw
    */
  def button(str: String = ???, x: Double = ???, y: Double = ???, callback: js.Function = ???, normalState: js.Object = ???, hoverState: js.Object = ???, pressedState: js.Object = ???, disabledState: js.Object = ???, shape: String = ???): CleanJsObject[Element] = js.native

  /**
    * <p><a href="http://www.highcharts.com/docs/chart-design-and-style/style-by-css">Styled mode</a> only. A hook for adding general definitions to the SVG's <code>defs</code> tag. Definitions can be referenced from the CSS by its <code>id</code>. Read more in <a href="http://www.highcharts.com/docs/chart-design-and-style/gradients-shadows-and-patterns">Gradients, shadows and patterns</a>.</p>
    * 
...
A serialized form of an SVG definition, including children. 
    * @since 5.0.0
    */
  def definition(`def`: js.Object = ???): CleanJsObject[Element] = js.native
}
