...
trait Renderer extends js.Object {
  ...
  /**
    ...
    * @since 2.0
    */
  def arc(centerX: js.UndefOr[Double] = js.undefined, centerY: js.UndefOr[Double] = js.undefined, outerRadius: js.UndefOr[Double] = js.undefined, innerRadius: js.UndefOr[Double] = js.undefined, start: js.UndefOr[Double] = js.undefined, end: js.UndefOr[Double] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def circle(centerX: js.UndefOr[Double] = js.undefined, centerY: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def g(name: js.UndefOr[String] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def image(source: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def path(path: js.UndefOr[js.Array[js.Any]] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def rect(x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, cornerRadius: js.UndefOr[Double] = js.undefined): CleanJsObject[Element] = js.native
  ...
  /**
    ...
    * @since 2.0
    */
  def text(str: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): CleanJsObject[Element] = js.native
...
The text or HTML to draw
    ...
    */
  def label(str: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, shape: js.UndefOr[String] = js.undefined, anchorX: js.UndefOr[Double] = js.undefined, anchorY: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, baseline: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined): CleanJsObject[Element] = js.native
}
