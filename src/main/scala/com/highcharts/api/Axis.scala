...
Defaults to <code>true</code>. Whether to redraw the chart following the remove. 
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-removeplotband/" target="_blank">Remove plot band by id</a>, <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-addplotband/" target="_blank">Toggle the plot band from a button</a>
    * @since 1.2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/xaxis/plotlines-id/" target="_blank">Remove plot line by id</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-addplotline/" target="_blank">toggle the plot line from a button</a>
    * @since 1.2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-setcategories/" target="_blank">Set categories by click on a button</a>
    * @since 1.2.0
    */
  def setCategories(cateories: js.Array[js.Any] = ???, redraw: Boolean = ???): Unit = js.native
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-setextremes/" target="_blank">Set extremes from button</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-setextremes-datetime/" target="_blank">Set extremes on datetime axis</a>,<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-setextremes-off-ticks/" target="_blank">setting extremes off ticks</a>
    * @since 1.2.0
    */
...
The new options that will be merged in with existing options on the axis.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-settitle/" target="_blank">Set a new Y axis title</a>
    * @since 2.2
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-addplotline/" target="_blank">Toggle the plot line from a button</a>
    * @since 1.2.0
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-addplotband/" target="_blank">Toggle the plot band from a button</a>
    * @since 1.2.0
    */
  ...
  /**
    ...
    * </dl>
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/members/axis-getextremes/" target="_blank">Report extremes by click on a button</a>
    * @since 1.2.0
    */
