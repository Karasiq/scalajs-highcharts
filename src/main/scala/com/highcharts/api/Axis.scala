...
Defaults to <code>true</code>. Whether to redraw the chart following the remove. 
   ...
   * @since 1.2.0
   */
  def removePlotBand(id: UndefOr[String] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def removePlotLine(id: UndefOr[String] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def setCategories(cateories: UndefOr[js.Array[js.Any]] = js.undefined, redraw: UndefOr[Boolean] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def setExtremes(min: UndefOr[Double] = js.undefined, max: UndefOr[Double] = js.undefined, redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
...
A value in terms of axis units.
   * @since 3.0
   */
  def toPixels(value: UndefOr[Double] = js.undefined, paneCoordinates: UndefOr[Boolean] = js.undefined): Double = js.native
...
A pixel position along the axis.
   * @since 3.0
   */
  def toValue(pixel: UndefOr[Double] = js.undefined, paneCoordinates: UndefOr[Boolean] = js.undefined): Double = js.native
...
The new options that will be merged in with existing options on the axis.
   ...
   * @since 2.2
   */
  def setTitle(title: UndefOr[js.Object] = js.undefined, redraw: UndefOr[Boolean] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def addPlotLine(options: UndefOr[js.Object] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def addPlotBand(options: UndefOr[js.Object] = js.undefined): Unit = js.native
}
