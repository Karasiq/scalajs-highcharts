...
trait RootObject extends js.Object {
   ...
   */
  var Axis: UndefOr[Axis] = js.native
   ...
   */
  var Element: UndefOr[Element] = js.native
   ...
   */
  var Highcharts: UndefOr[Highcharts] = js.native
   ...
   */
  var Point: UndefOr[Point] = js.native
   ...
   */
  var Renderer: UndefOr[Renderer] = js.native
