...
The Axis options, as documented under <a href="#xAxis">xAxis</a> and <a href="#yAxis">yAxis</a>.
   ...
   * @since 3.0
   */
  def addAxis(options: UndefOr[js.Object] = js.undefined, isX: UndefOr[Boolean] = js.undefined, redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
...
The series options, as documented under <a href="#plotOptions.series">plotOptions.series</a> and under the plotOptions for each series type.
   ...
   * @since 1.2.0
   */
  def addSeries(options: UndefOr[js.Object] = js.undefined, redraw: UndefOr[Boolean] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Series = js.native
...
<code>sourceHeight</code>: the height of the source chart.
   ...
   * @since 2.0
   */
  def exportChart(options: UndefOr[js.Object] = js.undefined, chartOptions: UndefOr[js.Object] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def get(id: UndefOr[String] = js.undefined): js.Any = js.native
   ...
   * @since 2.0
   */
  def getSVG(additionalOptions: UndefOr[js.Object] = js.undefined): String = js.native
   ...
   */
  def setSize(width: UndefOr[Double] = js.undefined, height: UndefOr[Double] = js.undefined, animation: UndefOr[js.Any] = js.undefined): Unit = js.native
   ...
   * @since 2.0.5
   */
  def showLoading(str: UndefOr[String] = js.undefined): Unit = js.native
...
The existing Point object from which the drilldown will start.
   ...
   * @since 3.0.8
   */
  def addSeriesAsDrilldown(point: UndefOr[js.Object] = js.undefined, seriesOptions: UndefOr[js.Object] = js.undefined): Unit = js.native
   ...
   * @since 2.1.0
   */
  def setTitle(title: UndefOr[js.Object] = js.undefined, subtitle: UndefOr[js.Any] = js.undefined, redraw: UndefOr[Boolean] = js.undefined): Unit = js.native
   ...
   * @since 1.2.0
   */
  def redraw(animation: UndefOr[js.Any] = js.undefined): Unit = js.native
}
