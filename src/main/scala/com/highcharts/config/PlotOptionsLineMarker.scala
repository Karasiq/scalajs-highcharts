...
class PlotOptionsLineMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[PlotOptionsLineMarkerStates]] = js.undefined
...
object PlotOptionsLineMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsLineMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsLineMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[PlotOptionsLineMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new PlotOptionsLineMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[PlotOptionsLineMarkerStates]] = statesOuter
