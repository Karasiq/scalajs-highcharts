...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val dataLabels: SeriesHeatmapDataLabels = new SeriesHeatmapDataLabels
  ...
  val events: SeriesHeatmapEvents = new SeriesHeatmapEvents
   ...
   */
  val point: SeriesHeatmapPoint = new SeriesHeatmapPoint
   ...
   * @since 4.1.0
   */
  val zones: js.Array[SeriesHeatmapZones] = new js.Array[SeriesHeatmapZones]
}
