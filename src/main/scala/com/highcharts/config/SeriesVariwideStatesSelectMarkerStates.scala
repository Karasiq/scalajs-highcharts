...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVariwideStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesSelectMarkerStates {
