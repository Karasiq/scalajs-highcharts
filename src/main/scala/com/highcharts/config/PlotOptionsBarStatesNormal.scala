...
/**
  * @note JavaScript name: <code>plotOptions-bar-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBarStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsBarStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarStatesNormal {
