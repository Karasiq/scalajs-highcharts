...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPriceenvelopesDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesDataGrouping {
  /**
  ...
  def apply(approximation: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesPriceenvelopesDataGrouping = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesDataGrouping {
