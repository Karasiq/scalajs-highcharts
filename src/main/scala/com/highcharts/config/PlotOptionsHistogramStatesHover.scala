...
/**
  * @note JavaScript name: <code>plotOptions-histogram-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsHistogramStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsHistogramStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramStatesHover {
