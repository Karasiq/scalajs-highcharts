...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsErrorbarStatesHoverHalo extends js.Object {
...
object PlotOptionsErrorbarStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsErrorbarStatesHoverHalo = {
    ...
    new PlotOptionsErrorbarStatesHoverHalo {
