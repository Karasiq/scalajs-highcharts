...
/**
  * @note JavaScript name: <code>plotOptions-psar-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPsarStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsPsarStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarStatesHoverHalo {
