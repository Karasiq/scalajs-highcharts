...
/**
  * @note JavaScript name: <code>plotOptions-bar-dataLabels</code>
  */
...
class PlotOptionsBarDataLabels extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bar-datalabels-align-inside-bar/" target="_blank">Data labels inside the bar</a>
    */
...
object PlotOptionsBarDataLabels {
  /**
