...
class SeriesBoxplotData extends js.Object {
   ...
   */
  var events: UndefOr[SeriesBoxplotDataEvents] = js.undefined
   ...
   */
  var high: UndefOr[Double] = js.undefined
   ...
   */
  var q1: UndefOr[Double] = js.undefined
  
  /**
   * The higher quartile for each data point. This is the top of the box.
   */
  var q3: UndefOr[Double] = js.undefined
