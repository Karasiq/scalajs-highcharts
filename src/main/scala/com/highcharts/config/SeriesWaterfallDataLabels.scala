...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallDataLabels extends js.Object {
...
object SeriesWaterfallDataLabels {
  /**
