...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesMappointStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointStatesNormal {
