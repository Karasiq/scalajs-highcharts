...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStochasticDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticDataGrouping {
  /**
  ...
  def apply(approximation: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): SeriesStochasticDataGrouping = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticDataGrouping {
