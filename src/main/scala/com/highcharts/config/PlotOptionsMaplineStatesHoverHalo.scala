...
/**
  * @note JavaScript name: <code>plotOptions-mapline-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMaplineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMaplineStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineStatesHoverHalo {
