...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTreemapStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapStatesHoverMarkerStates {
