...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesRocMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesRocMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocMarkerStates {
