...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaDataLabels extends js.Object {
