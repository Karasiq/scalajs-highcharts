...
class PlotOptionsBar extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsBarDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsBarEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsBarPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsBarZones]] = js.undefined
}
