...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapDataLabels extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-datalabels-align-left/" target="_blank">Left aligned</a>.
...
<a href="http://jsfiddle.net/highcharts/72sbw0Lz/">Understand alignment to boxes, lines and points</a>.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-datalabels-enabled/" target="_blank">Data labels enabled</a>
    * @since 4.1.0
    */
...
object SeriesTreemapDataLabels {
  /**
    ...
    * @param inside Whether to align the data label inside the box or to the actual value point. 
    ...
    * @param verticalAlign The vertical alignment of a data label. Can be one of top, middle or bottom. The default value depends on the data, for instance in a column chart, the label is above positive values and below negative values.
