...
object NavigatorYAxisLabelsSymbol {
  /**
    ...
    */
  def apply(`type`: js.UndefOr[String] = "triangle", x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined): NavigatorYAxisLabelsSymbol = {
