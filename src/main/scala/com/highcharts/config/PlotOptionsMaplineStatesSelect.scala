...
/**
  * @note JavaScript name: <code>plotOptions-mapline-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMaplineStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelectMarker]] = js.undefined
...
object PlotOptionsMaplineStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsMaplineStatesSelect = {
    val colorOuter: js.UndefOr[String] = color
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelectMarker]] = marker
    val haloOuter: js.Any = halo
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val borderColorOuter: js.UndefOr[String | js.Object] = borderColor
    val borderWidthOuter: js.UndefOr[Double] = borderWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineStatesSelect {
      ...
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsMaplineStatesSelectMarker]] = markerOuter
