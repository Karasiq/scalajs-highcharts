...
/**
  * @note JavaScript name: <code>plotOptions-funnel-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFunnelEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsFunnelEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelEvents {
