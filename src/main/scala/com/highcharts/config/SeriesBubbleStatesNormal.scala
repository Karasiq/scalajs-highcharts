...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesBubbleStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleStatesNormal {
