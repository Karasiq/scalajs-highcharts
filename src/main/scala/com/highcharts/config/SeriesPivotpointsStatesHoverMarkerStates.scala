...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPivotpointsStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesHoverMarkerStates {
