...
/**
  * @note JavaScript name: <code>plotOptions-macd-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMacdMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMacdMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdMarkerStates {
