...
/**
  * @note JavaScript name: <code>plotOptions-spline-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsSplineStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineStatesSelectHalo {
