...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-data-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudDataDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesWordcloudDataDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudDataDragDropGuideBoxDefault {
