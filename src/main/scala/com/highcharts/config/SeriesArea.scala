...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val dataLabels: UndefOr[SeriesAreaDataLabels] = js.undefined
  ...
  val events: UndefOr[SeriesAreaEvents] = js.undefined
  ...
  val marker: UndefOr[SeriesAreaMarker] = js.undefined
   ...
   */
  val point: UndefOr[SeriesAreaPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[SeriesAreaZones]] = js.undefined
}
