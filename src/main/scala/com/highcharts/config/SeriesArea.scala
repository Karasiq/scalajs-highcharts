...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val dataLabels: SeriesAreaDataLabels = new SeriesAreaDataLabels
  ...
  val events: SeriesAreaEvents = new SeriesAreaEvents
  ...
  val marker: SeriesAreaMarker = new SeriesAreaMarker
  ...
  /**
    ...
    */
  val point: SeriesAreaPoint = new SeriesAreaPoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[SeriesAreaZones] = new js.Array[SeriesAreaZones]
}
