...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesOhlcDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesOhlcDataEvents]] = js.undefined
}

object SeriesOhlcData {
  /**
    * @param close <p>The closing value of each data point.</p>
    ...
    */
  def apply(close: js.UndefOr[Double] = js.undefined, open: js.UndefOr[Double] = js.undefined, high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesOhlcDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesOhlcDataEvents]] = js.undefined): SeriesOhlcData = {
    ...
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesOhlcDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesOhlcDataDragDrop]] = dragDropOuter
