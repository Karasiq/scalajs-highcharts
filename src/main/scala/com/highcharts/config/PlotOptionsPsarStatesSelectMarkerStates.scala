...
/**
  * @note JavaScript name: <code>plotOptions-psar-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPsarStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPsarStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarStatesSelectMarkerStates {
