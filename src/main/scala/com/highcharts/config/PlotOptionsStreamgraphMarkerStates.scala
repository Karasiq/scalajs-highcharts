...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStreamgraphMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsStreamgraphMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphMarkerStates {
