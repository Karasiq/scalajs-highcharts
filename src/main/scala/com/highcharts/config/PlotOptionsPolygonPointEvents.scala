...
/**
  * @note JavaScript name: <code>plotOptions-polygon-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonPointEvents extends js.Object {
...
object PlotOptionsPolygonPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsPolygonPointEvents = {
    ...
    new PlotOptionsPolygonPointEvents {
