...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesLineDataLabels extends js.Object {
