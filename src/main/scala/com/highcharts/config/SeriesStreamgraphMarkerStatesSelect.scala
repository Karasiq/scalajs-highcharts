...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStreamgraphMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesStreamgraphMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphMarkerStatesSelect {
