...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieDataLabels extends js.Object {
