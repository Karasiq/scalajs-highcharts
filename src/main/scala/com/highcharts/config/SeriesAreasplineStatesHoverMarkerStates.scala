...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplineStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAreasplineStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineStatesHoverMarkerStates {
