...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val events: SeriesArearangeEvents = new SeriesArearangeEvents
   ...
   */
  val point: SeriesArearangePoint = new SeriesArearangePoint
   ...
   * @since 4.1.0
   */
  val zones: js.Array[SeriesArearangeZones] = new js.Array[SeriesArearangeZones]
}
