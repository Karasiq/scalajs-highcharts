...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-pathfinder</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVbpPathfinder extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpPathfinder {
  /**
    ...
    */
  def apply(`type`: js.UndefOr[String] = "straight|simpleConnect", lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Object] = js.undefined, startMarker: js.UndefOr[js.Object] = js.undefined, endMarker: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, algorithmMargin: js.UndefOr[Double] = js.undefined): SeriesVbpPathfinder = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpPathfinder {
