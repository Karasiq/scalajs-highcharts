...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesColumnrangeMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeMarkerStates {
