...
/**
  * @note JavaScript name: <code>plotOptions-treemap-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsTreemapStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapStatesHoverMarkerStates {
