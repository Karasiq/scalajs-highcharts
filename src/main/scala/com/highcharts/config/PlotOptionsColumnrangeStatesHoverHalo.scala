...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnrangeStatesHoverHalo extends js.Object {
...
object PlotOptionsColumnrangeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsColumnrangeStatesHoverHalo = {
