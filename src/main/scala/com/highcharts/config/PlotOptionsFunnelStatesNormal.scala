...
/**
  * @note JavaScript name: <code>plotOptions-funnel-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFunnelStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsFunnelStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelStatesNormal {
