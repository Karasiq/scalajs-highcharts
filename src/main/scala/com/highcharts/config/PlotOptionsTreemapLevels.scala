...
class PlotOptionsTreemapLevels extends js.Object {
   ...
   * @since 4.1.0
   */
  val borderDashStyle: UndefOr[String] = js.undefined
  
  /**
   * Can set the borderWidth on all points which lies on the same level.
   * @since 4.1.0
   */
  val borderWidth: UndefOr[Double] = js.undefined
   ...
   * @since 4.1.0
   */
  val layoutAlgorithm: UndefOr[String] = js.undefined
  
  /**
   * Can set the layoutStartingDirection option on a specific level.
   * @since 4.1.0
   */
  val layoutStartingDirection: UndefOr[String] = js.undefined
   ...
   * @since 4.1.0
   */
  val level: UndefOr[Double] = js.undefined
}
