...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPieStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieStatesSelectHalo {
