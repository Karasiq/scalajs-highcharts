...
class Lang extends js.Object {
   ...
   * @since 3.0
   */
  var contextButtonTitle: String = "Chart context menu"
   ...
   * @since 2.0
   */
  var downloadJPEG: String = "Download JPEG image"
  
  /**
   * Exporting module only. The text for the PDF download menu item.
   * @since 2.0
   */
  var downloadPDF: String = "Download PDF document"
  
  /**
   * Exporting module only. The text for the PNG download menu item.
   * @since 2.0
   */
  var downloadPNG: String = "Download PNG image"
  
  /**
   * Exporting module only. The text for the SVG download menu item.
   * @since 2.0
   */
  var downloadSVG: String = "Download SVG vector image"
   ...
   * @since 3.0.8
   */
  var drillUpText: String = "Back to {series.name}"
   ...
   */
  var months: js.Array[String] = js.Array( "January" , "February" , "March" , "April" , "May" , "June" , "July" , "August" , "September" , "October" , "November" , "December")
  
  /**
   * The text to display when the chart contains no data. Requires the no-data module, see <a href="#noData">noData</a>.
   * @since 3.0.8
   */
  var noData: String = "No data to display"
   ...
   * @since 2.3.0
   */
  var numericSymbols: js.Array[String] = js.Array( "k" , "M" , "G" , "T" , "P" , "E")
  
  /**
   * Exporting module only. The text for the menu item to print the chart.
   * @since 3.0.1
   */
  var printChart: String = "Print chart"
  
  /**
   * The text for the label appearing when a chart is zoomed.
   * @since 1.2.4
   */
  var resetZoom: String = "Reset zoom"
  
  /**
   * The tooltip title for the label appearing when a chart is zoomed.
   * @since 1.2.4
   */
  var resetZoomTitle: String = "Reset zoom level 1:1"
  
  /**
   * An array containing the months names in abbreviated form. Corresponds to the 
   *  <code>%b</code> format in <code>Highcharts.dateFormat()</code>. 
   */
  var shortMonths: js.Array[String] = js.Array( "Jan" , "Feb" , "Mar" , "Apr" , "May" , "Jun" , "Jul" , "Aug" , "Sep" , "Oct" , "Nov" , "Dec")
   ...
   */
  var weekdays: js.Array[String] = js.Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday")
}
