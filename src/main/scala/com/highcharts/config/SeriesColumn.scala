...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val dataLabels: UndefOr[SeriesColumnDataLabels] = js.undefined
  ...
  val events: UndefOr[SeriesColumnEvents] = js.undefined
   ...
   */
  val point: UndefOr[SeriesColumnPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[SeriesColumnZones]] = js.undefined
}
