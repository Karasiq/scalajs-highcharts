...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val dataLabels: SeriesColumnDataLabels = new SeriesColumnDataLabels
  ...
  val events: SeriesColumnEvents = new SeriesColumnEvents
  ...
  /**
    ...
    */
  val point: SeriesColumnPoint = new SeriesColumnPoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[SeriesColumnZones] = new js.Array[SeriesColumnZones]
}
