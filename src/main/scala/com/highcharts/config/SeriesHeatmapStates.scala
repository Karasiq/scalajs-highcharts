...
object SeriesHeatmapStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[SeriesHeatmapStatesNormal]] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesHeatmapStatesSelect]] = js.undefined): SeriesHeatmapStates = {
