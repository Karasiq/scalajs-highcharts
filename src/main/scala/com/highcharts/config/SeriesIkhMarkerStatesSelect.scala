...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesIkhMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesIkhMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhMarkerStatesSelect {
