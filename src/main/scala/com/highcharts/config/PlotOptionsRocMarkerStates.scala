...
/**
  * @note JavaScript name: <code>plotOptions-roc-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsRocMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsRocMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocMarkerStates {
