...
/**
  * @note JavaScript name: <code>plotOptions-spline-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSplineDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsSplineDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineDragDropGuideBoxDefault {
