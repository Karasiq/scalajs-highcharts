...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsErrorbarDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsErrorbarDragDropDragHandle]] = js.undefined
...
object PlotOptionsErrorbarDragDrop {
  /**
    ...
    */
  def apply(draggableLow: js.UndefOr[Boolean] = js.undefined, draggableQ1: js.UndefOr[Boolean] = js.undefined, draggableQ3: js.UndefOr[Boolean] = js.undefined, draggableHigh: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsErrorbarDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsErrorbarDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsErrorbarDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsErrorbarDragDropDragHandle]] = dragHandleOuter
