...
/**
  * @note JavaScript name: <code>plotOptions-polygon-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsPolygonStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonStatesNormal {
