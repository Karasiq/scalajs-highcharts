...
/**
  * @note JavaScript name: <code>plotOptions-sankey-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSankeyDataLabels extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-box/">Data labels box options</a>
  ...
  /**
    * <p>The [format string](<a href="https://www.highcharts.com/docs/chart-">https://www.highcharts.com/docs/chart-</a>
    * concepts/labels-and-string-formatting) specifying what to show
    * for <em>nodes</em> in the sankey diagram. By default the
    * <code>nodeFormatter</code> returns <code>{point.name}</code>.</p>
    * @since 6.0.0
    */
  val nodeFormat: js.UndefOr[String] = js.undefined

  /**
    * <p>Callback to format data labels for <em>nodes</em> in the sankey diagram.
    * The <code>nodeFormat</code> option takes precedence over the <code>nodeFormatter</code>.</p>
    * @since 6.0.2
    */
  val nodeFormatter: js.UndefOr[js.Function] = js.undefined

  /**
    * <p>The [format string](<a href="https://www.highcharts.com/docs/chart-">https://www.highcharts.com/docs/chart-</a>
    * concepts/labels-and-string-formatting) specifying what to show for
    * <em>links</em> in the sankey diagram. Defaults to an empty string returned
    * from the <code>formatter</code>, in effect disabling the labels.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-format/">Formatted value in the data label</a>
  ...
  /**
    * <p>Callback to format data labels for <em>links</em> in the sankey diagram.
    * The <code>format</code> option takes precedence over the <code>formatter</code>.</p>
  ...
  /**
    ...
    * @since 6.0.0
    */
  val align: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    * @since 2.3.3
    */
  val verticalAlign: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    ...
    * @since 6.0.0
    */
  val y: js.UndefOr[Double | Null] = js.undefined
...
object PlotOptionsSankeyDataLabels {
  /**
    ...
    * @param nodeFormat <p>The [format string](<a href="https://www.highcharts.com/docs/chart-">https://www.highcharts.com/docs/chart-</a>. concepts/labels-and-string-formatting) specifying what to show. for <em>nodes</em> in the sankey diagram. By default the. <code>nodeFormatter</code> returns <code>{point.name}</code>.</p>
    * @param nodeFormatter <p>Callback to format data labels for <em>nodes</em> in the sankey diagram.. The <code>nodeFormat</code> option takes precedence over the <code>nodeFormatter</code>.</p>
    * @param format <p>The [format string](<a href="https://www.highcharts.com/docs/chart-">https://www.highcharts.com/docs/chart-</a>. concepts/labels-and-string-formatting) specifying what to show for. <em>links</em> in the sankey diagram. Defaults to an empty string returned. from the <code>formatter</code>, in effect disabling the labels.</p>
    * @param formatter <p>Callback to format data labels for <em>links</em> in the sankey diagram.. The <code>format</code> option takes precedence over the <code>formatter</code>.</p>
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, nodeFormatter: js.UndefOr[js.Function] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, x: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, shape: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): PlotOptionsSankeyDataLabels = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val backgroundColorOuter: js.UndefOr[String] = backgroundColor
    val cropOuter: js.UndefOr[Boolean] = crop
    val nodeFormatOuter: js.UndefOr[String] = nodeFormat
    val nodeFormatterOuter: js.UndefOr[js.Function] = nodeFormatter
    val formatOuter: js.UndefOr[String] = format
    val formatterOuter: js.Any = formatter
    val insideOuter: js.UndefOr[Boolean] = inside
    val alignOuter: js.UndefOr[String | Null] = align
    val verticalAlignOuter: js.UndefOr[String | Null] = verticalAlign
    val yOuter: js.UndefOr[Double | Null] = y
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyDataLabels {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val backgroundColor: js.UndefOr[String] = backgroundColorOuter
      override val crop: js.UndefOr[Boolean] = cropOuter
      override val nodeFormat: js.UndefOr[String] = nodeFormatOuter
      override val nodeFormatter: js.UndefOr[js.Function] = nodeFormatterOuter
      ...
      override val align: js.UndefOr[String | Null] = alignOuter
      override val verticalAlign: js.UndefOr[String | Null] = verticalAlignOuter
      override val y: js.UndefOr[Double | Null] = yOuter
