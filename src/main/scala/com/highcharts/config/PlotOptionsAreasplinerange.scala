...
class PlotOptionsAreasplinerange extends js.Object {
  ...
  var events: UndefOr[PlotOptionsAreasplinerangeEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsAreasplinerangePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsAreasplinerangeZones]] = js.undefined
}
