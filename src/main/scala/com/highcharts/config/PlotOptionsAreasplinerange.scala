...
class PlotOptionsAreasplinerange extends js.Object {
  ...
  val events: PlotOptionsAreasplinerangeEvents = new PlotOptionsAreasplinerangeEvents
  ...
  /**
    ...
    */
  val point: PlotOptionsAreasplinerangePoint = new PlotOptionsAreasplinerangePoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[PlotOptionsAreasplinerangeZones] = new js.Array[PlotOptionsAreasplinerangeZones]
}
