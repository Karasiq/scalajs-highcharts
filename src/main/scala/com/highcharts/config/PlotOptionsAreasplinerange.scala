...
class PlotOptionsAreasplinerange extends js.Object {
  ...
  val events: UndefOr[PlotOptionsAreasplinerangeEvents] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsAreasplinerangePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsAreasplinerangeZones]] = js.undefined
}
