...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogram extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An integer identifying the index to use for the base series, or a string
    * representing the id of the series.</p>
    * @since 6.0.0
    */
  val baseSeries: js.UndefOr[Double | String] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    * @since 6.0.0
    */
  val `type`: js.UndefOr[String] = "histogram"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>A preferable number of bins. It is a suggestion, so a histogram may have
    * a different number of bins. By default it is set to the square root
    * of the base series&#39; data length. Available options are: <code>square-root</code>,
    * <code>sturges</code>, <code>rice</code>. You can also define a function which takes a
    * <code>baseSeries</code> as a parameter and should return a positive integer.</p>
    * @since 6.0.0
    */
  val binsNumber: js.UndefOr[String | Double | js.Function] = js.undefined

  /**
    * <p>Width of each bin. By default the bin&#39;s width is calculated as
    * <code>(max - min) / number of bins</code>. This option takes precedence over
    * <a href="#plotOptions.histogram.binsNumber">binsNumber</a>.</p>
    * @since 6.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-pointplacement-numeric/">Numeric placement for custom layout</a>
    * @since 2.3.0
    */
  val pointPlacement: js.UndefOr[String] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesHistogramPathfinder]] = js.undefined
...
object SeriesHistogram {
  /**
    * @param baseSeries <p>An integer identifying the index to use for the base series, or a string. representing the id of the series.</p>
    ...
    * @param binsNumber <p>A preferable number of bins. It is a suggestion, so a histogram may have. a different number of bins. By default it is set to the square root. of the base series&#39; data length. Available options are: <code>square-root</code>,. <code>sturges</code>, <code>rice</code>. You can also define a function which takes a. <code>baseSeries</code> as a parameter and should return a positive integer.</p>
    * @param binWidth <p>Width of each bin. By default the bin&#39;s width is calculated as. <code>(max - min) / number of bins</code>. This option takes precedence over. <a href="#plotOptions.histogram.binsNumber">binsNumber</a>.</p>
    ...
    */
  def apply(baseSeries: js.UndefOr[Double | String] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[String | js.Any] = js.undefined, `type`: js.UndefOr[String] = "histogram", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, binsNumber: js.UndefOr[String | Double | js.Function] = js.undefined, binWidth: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, pointPlacement: js.UndefOr[String] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String | js.Object] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesHistogramPathfinder]] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[String] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined): SeriesHistogram = {
    val baseSeriesOuter: js.UndefOr[Double | String] = baseSeries
    ...
    val binsNumberOuter: js.UndefOr[String | Double | js.Function] = binsNumber
    val binWidthOuter: js.UndefOr[Double] = binWidth
    ...
    val pointPlacementOuter: js.UndefOr[String] = pointPlacement
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesHistogramPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogram {
      override val baseSeries: js.UndefOr[Double | String] = baseSeriesOuter
      ...
      override val binsNumber: js.UndefOr[String | Double | js.Function] = binsNumberOuter
      override val binWidth: js.UndefOr[Double] = binWidthOuter
      ...
      override val pointPlacement: js.UndefOr[String] = pointPlacementOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesHistogramPathfinder]] = pathfinderOuter
