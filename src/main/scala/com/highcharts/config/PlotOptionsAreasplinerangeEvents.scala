...
class PlotOptionsAreasplinerangeEvents extends js.Object {
   ...
   * @since 4.0
   */
  val afterAnimate: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  val checkboxClick: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  val hide: UndefOr[js.Function] = js.undefined
   ...
   */
  val legendItemClick: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  val show: UndefOr[js.Function] = js.undefined
}
