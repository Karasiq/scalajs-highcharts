...
class PlotOptionsAreasplinerangeEvents extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val afterAnimate: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val checkboxClick: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val hide: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    */
  val legendItemClick: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val show: js.Function = js.undefined.asInstanceOf[js.Function]
}
