...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesEmaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesEmaStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaStatesSelectHalo {
