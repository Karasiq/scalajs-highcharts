...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesColumnDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnDataLabelsFilter {
