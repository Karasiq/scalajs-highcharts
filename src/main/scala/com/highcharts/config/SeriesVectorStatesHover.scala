...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVectorStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesVectorStatesHoverMarker]] = js.undefined
...
object SeriesVectorStatesHover {
  /**
    ...
    */
  def apply(lineWidthPlus: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesVectorStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined): SeriesVectorStatesHover = {
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val markerOuter: js.UndefOr[CleanJsObject[SeriesVectorStatesHoverMarker]] = marker
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesHover {
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val animation: js.UndefOr[Boolean | js.Object] = animationOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesVectorStatesHoverMarker]] = markerOuter
