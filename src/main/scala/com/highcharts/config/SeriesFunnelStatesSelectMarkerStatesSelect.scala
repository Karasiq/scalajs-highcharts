...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesFunnelStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesSelectMarkerStatesSelect {
