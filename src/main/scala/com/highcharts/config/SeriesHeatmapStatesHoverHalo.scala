...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHeatmapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesHeatmapStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapStatesHoverHalo {
