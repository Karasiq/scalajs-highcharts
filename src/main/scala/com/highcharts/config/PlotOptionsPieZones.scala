...
/**
  * @note JavaScript name: <code>plotOptions-pie-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPieZones extends js.Object {
...
object PlotOptionsPieZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPieZones = {
