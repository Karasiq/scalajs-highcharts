...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[SeriesCandlestickDragDropDragHandle]] = js.undefined
...
object SeriesCandlestickDragDrop {
  /**
    ...
    */
  def apply(draggableLow: js.UndefOr[Boolean] = js.undefined, draggableHigh: js.UndefOr[Boolean] = js.undefined, draggableOpen: js.UndefOr[Boolean] = js.undefined, draggableClose: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[SeriesCandlestickDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): SeriesCandlestickDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[SeriesCandlestickDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[SeriesCandlestickDragDropDragHandle]] = dragHandleOuter
