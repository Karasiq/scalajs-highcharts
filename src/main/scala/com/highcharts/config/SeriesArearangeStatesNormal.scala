...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesArearangeStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeStatesNormal {
