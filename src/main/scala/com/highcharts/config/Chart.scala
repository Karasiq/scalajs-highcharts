...
object Chart {
  /**
    * @param alignTicks When using multiple axis, the ticks of two or more opposite axes will  automatically be aligned by adding ticks to the axis or axes with the least ticks. This can be prevented by setting <code>alignTicks</code> to false. If the grid lines look messy, it's a good idea to hide them for the secondary axis by setting <code>gridLineWidth</code> to 0.
    ...
    * @param inverted Whether to invert the axes so that the x axis is vertical and y axis is horizontal..  When true, the x axis is reversed by default. If a bar series is present in the chart,.  it will be inverted automatically.
    ...
    */
  def apply(alignTicks: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, defaultSeriesType: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[ChartEvents]] = js.undefined, height: js.UndefOr[Double] = js.undefined, ignoreHiddenSeries: js.UndefOr[Boolean] = js.undefined, inverted: js.UndefOr[Boolean] = js.undefined, margin: js.UndefOr[js.Array[js.Any]] = js.undefined, marginBottom: js.UndefOr[Double] = js.undefined, marginLeft: js.UndefOr[Double] = js.undefined, marginRight: js.UndefOr[Double] = js.undefined, marginTop: js.UndefOr[Double] = js.undefined, options3d: js.UndefOr[CleanJsObject[ChartOptions3d]] = js.undefined, panKey: js.UndefOr[String] = js.undefined, panning: js.UndefOr[Boolean] = js.undefined, pinchType: js.UndefOr[String] = js.undefined, plotBackgroundColor: js.UndefOr[String | js.Object] = js.undefined, plotBackgroundImage: js.UndefOr[String] = js.undefined, plotBorderColor: js.UndefOr[String | js.Object] = js.undefined, plotBorderWidth: js.UndefOr[Double] = js.undefined, plotShadow: js.UndefOr[Boolean | js.Object] = js.undefined, polar: js.UndefOr[Boolean] = js.undefined, reflow: js.UndefOr[Boolean] = js.undefined, renderTo: js.UndefOr[String | js.Object] = js.undefined, resetZoomButton: js.UndefOr[CleanJsObject[ChartResetZoomButton]] = js.undefined, selectionMarkerFill: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showAxes: js.UndefOr[Boolean] = js.undefined, spacing: js.UndefOr[js.Array[Double]] = js.undefined, spacingBottom: js.UndefOr[Double] = js.undefined, spacingLeft: js.UndefOr[Double] = js.undefined, spacingRight: js.UndefOr[Double] = js.undefined, spacingTop: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, `type`: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, zoomType: js.UndefOr[String] = js.undefined): Chart = {
