...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesWaterfallStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesSelectHalo {
