...
class PlotOptionsHeatmap extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsHeatmapDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsHeatmapEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsHeatmapPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsHeatmapZones]] = js.undefined
}
