...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesPolygonMarkerStates]] = js.undefined
...
object SeriesPolygonMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesPolygonMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPolygonMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesPolygonMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesPolygonMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesPolygonMarkerStates]] = statesOuter
