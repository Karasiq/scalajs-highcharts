...
/**
  * @note JavaScript name: <code>plotOptions-polygon-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarkerStates]] = js.undefined
...
object PlotOptionsPolygonMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new PlotOptionsPolygonMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[PlotOptionsPolygonMarkerStates]] = statesOuter
