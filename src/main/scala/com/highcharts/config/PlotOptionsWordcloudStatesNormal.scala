...
/**
  * @note JavaScript name: <code>plotOptions-wordcloud-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWordcloudStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWordcloudStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsWordcloudStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWordcloudStatesNormal {
