...
class YAxisStackLabels extends js.Object {
   ...
   * @since 2.1.5
   */
  var style: js.Object = js.eval("{ \"color\": \"#000000\", \"fontSize\": \"11px\", \"fontWeight\": \"bold\", \"textShadow\": \"0 0 6px contrast, 00 3px contrast\" }").asInstanceOf[js.Object]
   ...
   * @since 2.1.5
   */
  var textAlign: UndefOr[String] = js.undefined
