...
/**
  * @note JavaScript name: <code>plotOptions-pareto-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsParetoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsParetoMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoMarkerStates {
