...
/**
  * @note JavaScript name: <code>plotOptions-bar-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBarStatesHoverHalo extends js.Object {
...
object PlotOptionsBarStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsBarStatesHoverHalo = {
    ...
    new PlotOptionsBarStatesHoverHalo {
