...
class SeriesCandlestickData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = js.undefined
...
object SeriesCandlestickData {
  /**
    ...
    */
  def apply(close: js.UndefOr[Double] = js.undefined, open: js.UndefOr[Double] = js.undefined, high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesCandlestickDataEvents]] = js.undefined): SeriesCandlestickData = {
    ...
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesCandlestickDataDragDrop]] = dragDropOuter
