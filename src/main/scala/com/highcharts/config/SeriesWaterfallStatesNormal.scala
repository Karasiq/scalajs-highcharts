...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesWaterfallStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesNormal {
