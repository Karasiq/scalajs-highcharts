...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStreamgraphStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesStreamgraphStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphStatesSelectMarkerStatesSelect {
