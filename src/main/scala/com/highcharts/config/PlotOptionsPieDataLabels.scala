...
/**
  * @note JavaScript name: <code>plotOptions-pie-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPieDataLabels extends js.Object {
...
object PlotOptionsPieDataLabels {
  /**
