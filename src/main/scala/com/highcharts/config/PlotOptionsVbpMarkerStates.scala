...
/**
  * @note JavaScript name: <code>plotOptions-vbp-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVbpMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsVbpMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpMarkerStates {
