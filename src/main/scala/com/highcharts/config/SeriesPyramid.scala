...
class SeriesPyramid extends js.Object {
...
<li><a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  /**
    ...
    * @since 2.3
    */
  val tooltip: js.UndefOr[CleanJsObject[SeriesPyramidTooltip]] = js.undefined
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.UndefOr[js.Array[CleanJsObject[SeriesPyramidZones]]] = js.undefined
}
...
object SeriesPyramid {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, center: js.UndefOr[js.Array[String | Double]] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, cursor: js.UndefOr[String] = js.undefined, data: js.UndefOr[js.Array[CleanJsObject[SeriesPyramidData] | Double]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesPyramidDataLabels]] = js.undefined, depth: js.UndefOr[Double] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesPyramidEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double | String] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, minSize: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPyramidPoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, slicedOffset: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[CleanJsObject[SeriesPyramidTooltip]] = js.undefined, `type`: String = "pyramid", visible: js.UndefOr[Boolean] = js.undefined, width: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[SeriesPyramidZones]]] = js.undefined): SeriesPyramid = {
    ...
    val dataLabelsOuter: js.UndefOr[CleanJsObject[SeriesPyramidDataLabels]] = dataLabels
    val depthOuter: js.UndefOr[Double] = depth
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesPyramidEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[SeriesPyramidPoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[SeriesPyramidTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[SeriesPyramidZones]]] = zones
    new SeriesPyramid {
      ...
      override val dataLabels: js.UndefOr[CleanJsObject[SeriesPyramidDataLabels]] = dataLabelsOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesPyramidEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[SeriesPyramidPoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[SeriesPyramidTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[SeriesPyramidZones]]] = zonesOuter
    }
  }
}
