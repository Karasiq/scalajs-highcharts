...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesTreemapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapStatesSelectHalo {
