...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGanttDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesGanttDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataLabelsFilter {
