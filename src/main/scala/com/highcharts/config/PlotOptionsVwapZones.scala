...
/**
  * @note JavaScript name: <code>plotOptions-vwap-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVwapZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVwapZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapZones {
