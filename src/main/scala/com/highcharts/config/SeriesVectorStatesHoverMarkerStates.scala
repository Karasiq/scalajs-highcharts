...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVectorStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVectorStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesHoverMarkerStates {
