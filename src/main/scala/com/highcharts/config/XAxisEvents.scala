...
class XAxisEvents extends js.Object {
   ...
   * @since 4.1.0
   */
  val afterBreaks: UndefOr[js.Function] = js.undefined
   ...
   * @since 2.3
   */
  val afterSetExtremes: UndefOr[js.Function] = js.undefined
   ...
   * @since 4.1.0
   */
  val pointBreak: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  val setExtremes: UndefOr[js.Function] = js.undefined
}
