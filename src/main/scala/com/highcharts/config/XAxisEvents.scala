...
class XAxisEvents extends js.Object {
  ...
  /**
    ...
    * @since 4.1.0
    */
  val afterBreaks: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 2.3
    */
  val afterSetExtremes: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.1.0
    */
  val pointBreak: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val setExtremes: js.Function = js.undefined.asInstanceOf[js.Function]
}
