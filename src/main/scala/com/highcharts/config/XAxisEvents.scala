...
class XAxisEvents extends js.Object {
   ...
   * @since 4.1.0
   */
  var afterBreaks: UndefOr[js.Function] = js.undefined
   ...
   * @since 2.3
   */
  var afterSetExtremes: UndefOr[js.Function] = js.undefined
   ...
   * @since 4.1.0
   */
  var pointBreak: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  var setExtremes: UndefOr[js.Function] = js.undefined
}
