...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsErrorbarPointEvents extends js.Object {
...
object PlotOptionsErrorbarPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsErrorbarPointEvents = {
    ...
    new PlotOptionsErrorbarPointEvents {
