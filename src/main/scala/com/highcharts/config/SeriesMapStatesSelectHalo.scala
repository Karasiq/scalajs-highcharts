...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStatesSelectHalo {
