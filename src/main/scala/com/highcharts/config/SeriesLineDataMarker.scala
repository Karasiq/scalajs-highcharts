...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesLineDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesLineDataMarkerStates]] = js.undefined
...
object SeriesLineDataMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesLineDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesLineDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesLineDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesLineDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesLineDataMarkerStates]] = statesOuter
