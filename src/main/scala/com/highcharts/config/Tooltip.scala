...
class Tooltip extends js.Object {
  ...
  /**
    ...
    */
  val backgroundColor: String = "rgba(255, 255, 255, 0.85)"
  ...
  /**
    ...
    */
  val crosshairs: js.Any = js.undefined.asInstanceOf[js.Any]
  ...
  /**
    ...
    * @since 3.0
    */
  val followPointer: Boolean = false
  ...
  /**
    ...
    * @since 3.0.1
    */
  val followTouchMove: Boolean = true
  ...
  /**
    ...
    * @since 2.2
    */
  val pointFormat: String = "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>"
  ...
  /**
    ...
    * @since 4.1.0
    */
  val pointFormatter: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 2.2.4
    */
  val positioner: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val snap: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val style: js.Object = js.eval("{ \"color\": \"#333333\", \"cursor\": \"default\", \"fontSize\": \"12px\", \"padding\": \"8px\", \"pointerEvents\": \"none\", \"whiteSpace\": \"nowrap\" }").asInstanceOf[js.Object]
  ...
  /**
    ...
    * @since 2.2
    */
  val valueDecimals: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 2.2
    */
  val valuePrefix: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    * @since 2.2
    */
  val valueSuffix: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    */
  val xDateFormat: String = js.undefined.asInstanceOf[String]
}
