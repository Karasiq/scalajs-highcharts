...
class Tooltip extends js.Object {
   ...
   */
  var backgroundColor: String = "rgba(255, 255, 255, 0.85)"
   ...
   */
  var crosshairs: UndefOr[js.Any] = js.undefined
   ...
   * @since 3.0.1
   */
  var followTouchMove: Boolean = true
   ...
   * @since 2.2
   */
  var pointFormat: String = "<span style=\"color:{point.color}\">\\u25CF</span> {series.name}: <b>{point.y}</b><br/>"
   ...
   * @since 4.1.0
   */
  var pointFormatter: UndefOr[js.Function] = js.undefined
   ...
   * @since 2.2.4
   */
  var positioner: UndefOr[js.Function] = js.undefined
   ...
   * @since 1.2.0
   */
  var snap: UndefOr[Double] = js.undefined
   ...
   */
  var style: js.Object = js.eval("{ \"color\": \"#333333\", \"cursor\": \"default\", \"fontSize\": \"12px\", \"padding\": \"8px\", \"pointerEvents\": \"none\", \"whiteSpace\": \"nowrap\" }").asInstanceOf[js.Object]
   ...
   * @since 2.2
   */
  var valueDecimals: UndefOr[Double] = js.undefined
   ...
   * @since 2.2
   */
  var valuePrefix: UndefOr[String] = js.undefined
   ...
   * @since 2.2
   */
  var valueSuffix: UndefOr[String] = js.undefined
   ...
   */
  var xDateFormat: UndefOr[String] = js.undefined
}
