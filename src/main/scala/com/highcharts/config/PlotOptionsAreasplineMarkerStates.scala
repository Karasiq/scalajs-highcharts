...
class PlotOptionsAreasplineMarkerStates extends js.Object {
  ...
  val hover: PlotOptionsAreasplineMarkerStatesHover = new PlotOptionsAreasplineMarkerStatesHover
  
  /**
   * The appearance of the point marker when selected. In order to allow a point to be 
   * 		selected, set the <code>series.allowPointSelect</code> option to true.
   */
  val select: PlotOptionsAreasplineMarkerStatesSelect = new PlotOptionsAreasplineMarkerStatesSelect
}
