...
/**
  * @note JavaScript name: <code>plotOptions-gauge-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGaugeStatesHover extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val halo: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverHalo]] = js.undefined
  ...
  val marker: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverMarker]] = js.undefined
}

object PlotOptionsGaugeStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverMarker]] = js.undefined): PlotOptionsGaugeStatesHover = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val haloOuter: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverHalo]] = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverMarker]] = marker
    new PlotOptionsGaugeStatesHover {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val halo: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverHalo]] = haloOuter
      override val lineWidth: js.UndefOr[Double] = lineWidthOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsGaugeStatesHoverMarker]] = markerOuter
    }
  }
}
