...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSankeyMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyMarkerStates {
