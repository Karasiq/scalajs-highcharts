...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapbubbleStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMapbubbleStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStatesHoverMarkerStates {
