...
/**
  * @note JavaScript name: <code>plotOptions-sankey-tooltip</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSankeyTooltip extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Whether the tooltip should follow the pointer or stay fixed on the
    * item.</p>
    * @since 3.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/tooltip/format/">Format demo</a>
  ...
  /**
    ...
    * show for <em>nodes</em> in tooltip
    * of a sankey diagram series, as opposed to links.</p>
    * @since 2.3
    */
  val nodeFormat: js.UndefOr[String] = js.undefined

  /**
    * <p>A callback for defining the format for <em>nodes</em> in the sankey chart&#39;s
    * tooltip, as opposed to links.</p>
    * @since 6.0.2
    */
...
object PlotOptionsSankeyTooltip {
  /**
    * @param followPointer <p>Whether the tooltip should follow the pointer or stay fixed on the. item.</p>
    ...
    * @param nodeFormat <p>The [format string](<a href="https://www.highcharts.com/docs/chart-">https://www.highcharts.com/docs/chart-</a>. concepts/labels-and-string-formatting) specifying what to. show for <em>nodes</em> in tooltip. of a sankey diagram series, as opposed to links.</p>
    * @param nodeFormatter <p>A callback for defining the format for <em>nodes</em> in the sankey chart&#39;s. tooltip, as opposed to links.</p>
    ...
    */
  def apply(followPointer: js.UndefOr[Boolean] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, pointFormat: js.UndefOr[String] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, nodeFormatter: js.UndefOr[js.Function] = js.undefined, distance: js.UndefOr[Double] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, hideDelay: js.UndefOr[Double] = js.undefined, outside: js.UndefOr[Boolean] = js.undefined, pointFormatter: js.UndefOr[js.Function] = js.undefined, split: js.UndefOr[Boolean] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyTooltip = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyTooltip {
