...
/**
  * @note JavaScript name: <code>plotOptions-roc-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsRocStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsRocStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocStatesSelectHalo {
