...
class PlotOptionsArearange extends js.Object {
  ...
  val events: PlotOptionsArearangeEvents = new PlotOptionsArearangeEvents
  ...
  /**
    ...
    */
  val point: PlotOptionsArearangePoint = new PlotOptionsArearangePoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[PlotOptionsArearangeZones] = new js.Array[PlotOptionsArearangeZones]
}
