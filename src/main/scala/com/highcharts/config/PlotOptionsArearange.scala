...
class PlotOptionsArearange extends js.Object {
  ...
  val events: UndefOr[PlotOptionsArearangeEvents] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsArearangePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsArearangeZones]] = js.undefined
}
