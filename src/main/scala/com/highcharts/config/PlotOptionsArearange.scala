...
class PlotOptionsArearange extends js.Object {
  ...
  var events: UndefOr[PlotOptionsArearangeEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsArearangePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsArearangeZones]] = js.undefined
}
