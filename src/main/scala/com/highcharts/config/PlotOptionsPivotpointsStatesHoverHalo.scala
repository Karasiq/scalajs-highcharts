...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPivotpointsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsPivotpointsStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsStatesHoverHalo {
