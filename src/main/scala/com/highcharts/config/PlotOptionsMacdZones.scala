...
/**
  * @note JavaScript name: <code>plotOptions-macd-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMacdZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMacdZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdZones {
