...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVbpStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVbpStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpStatesHoverMarkerStates {
