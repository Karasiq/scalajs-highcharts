...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesZigzagMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesZigzagMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagMarkerStatesSelect {
