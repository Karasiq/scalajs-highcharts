...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSankeyMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyMarkerStatesSelect {
