...
/**
  * @note JavaScript name: <code>plotOptions-gauge-zones</code>
  */
...
object PlotOptionsGaugeZones {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsGaugeZones = {
