...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeDataDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesXrangeDataDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataDragDropGuideBoxDefault {
