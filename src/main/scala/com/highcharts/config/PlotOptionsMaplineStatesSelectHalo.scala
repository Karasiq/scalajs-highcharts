...
/**
  * @note JavaScript name: <code>plotOptions-mapline-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMaplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMaplineStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineStatesSelectHalo {
