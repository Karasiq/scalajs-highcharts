...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesVariwideDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataLabelsFilter {
