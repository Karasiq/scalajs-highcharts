...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[SeriesXrangeDragDropDragHandle]] = js.undefined
...
object SeriesXrangeDragDrop {
  /**
    ...
    */
  def apply(draggableX1: js.UndefOr[Boolean] = js.undefined, draggableX2: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[SeriesXrangeDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): SeriesXrangeDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[SeriesXrangeDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[SeriesXrangeDragDropDragHandle]] = dragHandleOuter
