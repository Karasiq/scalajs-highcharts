...
/**
  * @note JavaScript name: <code>plotOptions-mfi-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMfiEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsMfiEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiEvents {
