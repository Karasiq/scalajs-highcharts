...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnDataLabels extends js.Object {
