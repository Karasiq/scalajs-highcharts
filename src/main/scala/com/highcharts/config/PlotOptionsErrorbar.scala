...
class PlotOptionsErrorbar extends js.Object {
  ...
  var events: UndefOr[PlotOptionsErrorbarEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsErrorbarPoint] = js.undefined
   ...
   * @since 3.0
   */
  var whiskerWidth: Double = null.asInstanceOf[Double]
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsErrorbarZones]] = js.undefined
}
