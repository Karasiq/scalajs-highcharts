...
/**
  * @note JavaScript name: <code>yAxis-grid</code>
  */
@js.annotation.ScalaJSDefined
class YAxisGrid extends com.highcharts.HighchartsGenericObject {
...
object YAxisGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): YAxisGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new YAxisGrid {
