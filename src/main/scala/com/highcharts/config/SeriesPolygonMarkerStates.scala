...
class SeriesPolygonMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPolygonMarkerStates = {
    val hoverOuter: js.Any = hover
    val normalOuter: js.Any = normal
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonMarkerStates {
