...
/**
  * @note JavaScript name: <code>plotOptions-treemap-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsTreemapStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapStatesNormal {
