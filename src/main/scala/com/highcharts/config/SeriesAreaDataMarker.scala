...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesAreaDataMarkerStates]] = js.undefined
...
object SeriesAreaDataMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesAreaDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreaDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesAreaDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesAreaDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesAreaDataMarkerStates]] = statesOuter
