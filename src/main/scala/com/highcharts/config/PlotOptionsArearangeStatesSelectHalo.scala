...
/**
  * @note JavaScript name: <code>plotOptions-arearange-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsArearangeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsArearangeStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeStatesSelectHalo {
