...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPyramidZones extends js.Object {
...
object PlotOptionsPyramidZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPyramidZones = {
