...
/**
  * @note JavaScript name: <code>plotOptions-bubble-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBubblePointEvents extends js.Object {
...
object PlotOptionsBubblePointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsBubblePointEvents = {
    ...
    new PlotOptionsBubblePointEvents {
