...
class PlotOptionsColumnrange extends js.Object {
  ...
  var events: UndefOr[PlotOptionsColumnrangeEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsColumnrangePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsColumnrangeZones]] = js.undefined
}
