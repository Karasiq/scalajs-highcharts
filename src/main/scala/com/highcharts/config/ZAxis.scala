...
class ZAxis extends js.Object {
  ...
  /**
    ...
    * @since 4.1
    */
  val crosshair: js.UndefOr[Boolean | CleanJsObject[ZAxisCrosshair]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[ZAxisEvents]] = js.undefined
...
<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/axis-grid/" target="_blank">Styled mode</a>.
  ...
  /**
    ...
    */
  val labels: js.UndefOr[CleanJsObject[ZAxisLabels]] = js.undefined
...
<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/axis/" target="_blank">Axes in styled mode</a>.
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/yaxis/maxpadding/" target="_blank">Max padding of 0.25 on y axis</a>
    * @since 1.2.0
    */
...
<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/axis-grid/" target="_blank">Styled mode</a>.
  ...
  /**
    ...
    */
  val plotBands: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotBands]]] = js.undefined
  ...
  /**
    ...
    */
  val plotLines: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotLines]]] = js.undefined
...
<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/highcharts/css/axis-grid/" target="_blank">Styled mode</a>.
  ...
  /**
    ...
    */
  val title: js.UndefOr[CleanJsObject[ZAxisTitle]] = js.undefined
...
object ZAxis {
  /**
    ...
    * @param nameToX Applies only when the axis <code>type</code> is <code>category</code>. When <code>nameToX</code> is true, points are placed on the X axis according to their names. If the same point name is repeated in the same or another series, the point is placed on the same X position as other points of the same name. When <code>nameToX</code> is false, the points are laid out in increasing X positions regardless of their names, and the X axis category will take the name of the last point in each position.
    ...
    */
  def apply(allowDecimals: js.UndefOr[Boolean] = js.undefined, alternateGridColor: js.UndefOr[String | js.Object] = js.undefined, categories: js.UndefOr[js.Array[String]] = js.undefined, ceiling: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, crosshair: js.UndefOr[Boolean | CleanJsObject[ZAxisCrosshair]] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, endOnTick: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[ZAxisEvents]] = js.undefined, floor: js.UndefOr[Double] = js.undefined, gridLineColor: js.UndefOr[String | js.Object] = js.undefined, gridLineDashStyle: js.UndefOr[String] = js.undefined, gridLineWidth: js.UndefOr[Double] = js.undefined, gridZIndex: js.UndefOr[Double] = js.undefined, id: js.UndefOr[String] = js.undefined, labels: js.UndefOr[CleanJsObject[ZAxisLabels]] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[Double] = js.undefined, max: js.UndefOr[Double] = js.undefined, maxPadding: js.UndefOr[Double] = js.undefined, maxZoom: js.UndefOr[Double] = js.undefined, min: js.UndefOr[Double] = js.undefined, minPadding: js.UndefOr[Double] = js.undefined, minRange: js.UndefOr[Double] = js.undefined, minTickInterval: js.UndefOr[Double] = js.undefined, minorGridLineColor: js.UndefOr[String | js.Object] = js.undefined, minorGridLineDashStyle: js.UndefOr[String] = js.undefined, minorGridLineWidth: js.UndefOr[Double] = js.undefined, minorTickColor: js.UndefOr[String | js.Object] = js.undefined, minorTickInterval: js.UndefOr[String | Double] = js.undefined, minorTickLength: js.UndefOr[Double] = js.undefined, minorTickPosition: js.UndefOr[String] = js.undefined, minorTickWidth: js.UndefOr[Double] = js.undefined, nameToX: js.UndefOr[Boolean] = js.undefined, offset: js.UndefOr[Double] = js.undefined, opposite: js.UndefOr[Boolean] = js.undefined, plotBands: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotBands]]] = js.undefined, plotLines: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotLines]]] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, showEmpty: js.UndefOr[Boolean] = js.undefined, showFirstLabel: js.UndefOr[Boolean] = js.undefined, showLastLabel: js.UndefOr[Boolean] = js.undefined, softMax: js.UndefOr[Double] = js.undefined, softMin: js.UndefOr[Double] = js.undefined, startOfWeek: js.UndefOr[Double] = js.undefined, startOnTick: js.UndefOr[Boolean] = js.undefined, tickAmount: js.UndefOr[Double] = js.undefined, tickColor: js.UndefOr[String | js.Object] = js.undefined, tickInterval: js.UndefOr[Double] = js.undefined, tickLength: js.UndefOr[Double] = js.undefined, tickPixelInterval: js.UndefOr[Double] = js.undefined, tickPosition: js.UndefOr[String] = js.undefined, tickPositioner: js.UndefOr[js.Function] = js.undefined, tickPositions: js.UndefOr[js.Array[Double]] = js.undefined, tickWidth: js.UndefOr[Double] = js.undefined, tickmarkPlacement: js.UndefOr[String] = js.undefined, title: js.UndefOr[CleanJsObject[ZAxisTitle]] = js.undefined, `type`: js.UndefOr[String] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined): ZAxis = {
    ...
    val crosshairOuter: js.UndefOr[Boolean | CleanJsObject[ZAxisCrosshair]] = crosshair
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[ZAxisEvents]] = events
    ...
    val labelsOuter: js.UndefOr[CleanJsObject[ZAxisLabels]] = labels
    ...
    val nameToXOuter: js.UndefOr[Boolean] = nameToX
    val offsetOuter: js.UndefOr[Double] = offset
    val oppositeOuter: js.UndefOr[Boolean] = opposite
    val plotBandsOuter: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotBands]]] = plotBands
    val plotLinesOuter: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotLines]]] = plotLines
    ...
    val titleOuter: js.UndefOr[CleanJsObject[ZAxisTitle]] = title
    ...
    new ZAxis {
      ...
      override val crosshair: js.UndefOr[Boolean | CleanJsObject[ZAxisCrosshair]] = crosshairOuter
      ...
      override val events: js.UndefOr[CleanJsObject[ZAxisEvents]] = eventsOuter
      ...
      override val labels: js.UndefOr[CleanJsObject[ZAxisLabels]] = labelsOuter
      ...
      override val nameToX: js.UndefOr[Boolean] = nameToXOuter
      override val offset: js.UndefOr[Double] = offsetOuter
      override val opposite: js.UndefOr[Boolean] = oppositeOuter
      override val plotBands: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotBands]]] = plotBandsOuter
      override val plotLines: js.UndefOr[js.Array[CleanJsObject[ZAxisPlotLines]]] = plotLinesOuter
      ...
      override val title: js.UndefOr[CleanJsObject[ZAxisTitle]] = titleOuter
