...
/**
  * @note JavaScript name: <code>plotOptions-macd-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMacdEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsMacdEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdEvents {
