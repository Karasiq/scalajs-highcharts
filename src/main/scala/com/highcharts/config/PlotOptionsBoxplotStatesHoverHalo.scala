...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBoxplotStatesHoverHalo extends js.Object {
...
object PlotOptionsBoxplotStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsBoxplotStatesHoverHalo = {
    ...
    new PlotOptionsBoxplotStatesHoverHalo {
