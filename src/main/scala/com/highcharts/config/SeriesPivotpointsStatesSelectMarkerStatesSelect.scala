...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPivotpointsStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesSelectMarkerStatesSelect {
