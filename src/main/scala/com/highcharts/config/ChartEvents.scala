...
class ChartEvents extends js.Object {
  ...
  /**
    ...
    * @since 1.2.0
    */
  val addSeries: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.1.0
    */
  val afterPrint: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.1.0
    */
  val beforePrint: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 3.0.8
    */
  val drilldown: js.Function = js.undefined.asInstanceOf[js.Function]

  /**
    * Fires when drilling up from a drilldown series.
    * @since 3.0.8
    */
  val drillup: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    */
  val load: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val redraw: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    */
  val selection: js.Function = js.undefined.asInstanceOf[js.Function]
}
