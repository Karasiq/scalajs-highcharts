...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPivotpointsMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsMarker {
