...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnrangeDataLabels extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-box/">Data labels box options</a>
  ...
  /**
    * <p>X offset of the lower data labels relative to the point value.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/">Data labels on range series</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/">Data labels on range series</a>
    * @since 2.3.0
    */
  val xLow: js.UndefOr[Double] = js.undefined

  /**
    * <p>X offset of the higher data labels relative to the point value.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/">Data labels on range series</a>
    * @since 2.3.0
    */
  ...
  /**
    * <p>Y offset of the lower data labels relative to the point value.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/">Data labels on range series</a>
    * @since 2.3.0
    */
  val yLow: js.UndefOr[Double | String] = js.undefined

  /**
    * <p>Y offset of the higher data labels relative to the point value.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/arearange-datalabels/">Data labels on range series</a>
    * @since 2.3.0
    */
  val yHigh: js.UndefOr[Double | String] = js.undefined
}

object PlotOptionsColumnrangeDataLabels {
  /**
    ...
    * @param xLow <p>X offset of the lower data labels relative to the point value.</p>
    * @param xHigh <p>X offset of the higher data labels relative to the point value.</p>
    * @param yLow <p>Y offset of the lower data labels relative to the point value.</p>
    * @param yHigh <p>Y offset of the higher data labels relative to the point value.</p>
    */
  def apply(align: js.UndefOr[String | Null] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, xLow: js.UndefOr[Double] = js.undefined, xHigh: js.UndefOr[Double] = js.undefined, yLow: js.UndefOr[Double | String] = js.undefined, yHigh: js.UndefOr[Double | String] = js.undefined): PlotOptionsColumnrangeDataLabels = {
    ...
    val xLowOuter: js.UndefOr[Double] = xLow
    val xHighOuter: js.UndefOr[Double] = xHigh
    val yLowOuter: js.UndefOr[Double | String] = yLow
    val yHighOuter: js.UndefOr[Double | String] = yHigh
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeDataLabels {
      ...
      override val xLow: js.UndefOr[Double] = xLowOuter
      override val xHigh: js.UndefOr[Double] = xHighOuter
      override val yLow: js.UndefOr[Double | String] = yLowOuter
      override val yHigh: js.UndefOr[Double | String] = yHighOuter
    })
  }
}
