...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplinerangeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAreasplinerangeMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeMarkerStates {
