...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAtrStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAtrStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrStatesHoverMarkerStates {
