...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleDataLabels extends js.Object {
