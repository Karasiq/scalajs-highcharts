...
/**
  * @note JavaScript name: <code>plotOptions-gauge-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGaugeStatesHoverHalo extends js.Object {
...
object PlotOptionsGaugeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsGaugeStatesHoverHalo = {
    ...
    new PlotOptionsGaugeStatesHoverHalo {
