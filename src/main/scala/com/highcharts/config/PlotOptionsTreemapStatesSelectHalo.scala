...
/**
  * @note JavaScript name: <code>plotOptions-treemap-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsTreemapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapStatesSelectHalo {
