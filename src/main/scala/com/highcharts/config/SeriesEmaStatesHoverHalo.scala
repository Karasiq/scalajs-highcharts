...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesEmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesEmaStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaStatesHoverHalo {
