...
class PlotOptionsBarStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  val normal: js.UndefOr[CleanJsObject[PlotOptionsBarStatesNormal]] = js.undefined
}
...
object PlotOptionsBarStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[PlotOptionsBarStatesNormal]] = js.undefined): PlotOptionsBarStates = {
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    val normalOuter: js.UndefOr[CleanJsObject[PlotOptionsBarStatesNormal]] = normal
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarStates {
      override val hover: js.Any = hoverOuter
      override val select: js.Any = selectOuter
      override val normal: js.UndefOr[CleanJsObject[PlotOptionsBarStatesNormal]] = normalOuter
    })
  }
}
