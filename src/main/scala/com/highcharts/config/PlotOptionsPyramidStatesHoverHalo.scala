...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPyramidStatesHoverHalo extends js.Object {
...
object PlotOptionsPyramidStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPyramidStatesHoverHalo = {
    ...
    new PlotOptionsPyramidStatesHoverHalo {
