...
/**
  * @note JavaScript name: <code>plotOptions-scatter-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatterMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[PlotOptionsScatterMarkerStates]] = js.undefined
...
object PlotOptionsScatterMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsScatterMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsScatterMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[PlotOptionsScatterMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new PlotOptionsScatterMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[PlotOptionsScatterMarkerStates]] = statesOuter
