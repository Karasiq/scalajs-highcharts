...
/**
  * @note JavaScript name: <code>plotOptions-map-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMapStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapStatesHoverHalo {
