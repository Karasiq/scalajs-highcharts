...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAreasplineStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineStatesSelectHalo {
