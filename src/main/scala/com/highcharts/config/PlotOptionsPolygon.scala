...
class PlotOptionsPolygon extends js.Object {
  ...
  val dataLabels: UndefOr[PlotOptionsPolygonDataLabels] = js.undefined
  ...
  val events: UndefOr[PlotOptionsPolygonEvents] = js.undefined
  ...
  val marker: UndefOr[PlotOptionsPolygonMarker] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsPolygonPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsPolygonZones]] = js.undefined
}
