...
class PlotOptionsPolygon extends js.Object {
  ...
  val dataLabels: PlotOptionsPolygonDataLabels = new PlotOptionsPolygonDataLabels
  ...
  val events: PlotOptionsPolygonEvents = new PlotOptionsPolygonEvents
  ...
  val marker: PlotOptionsPolygonMarker = new PlotOptionsPolygonMarker
  ...
  /**
    ...
    */
  val point: PlotOptionsPolygonPoint = new PlotOptionsPolygonPoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[PlotOptionsPolygonZones] = new js.Array[PlotOptionsPolygonZones]
}
