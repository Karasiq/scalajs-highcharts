...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGaugeDataLabels extends js.Object {
