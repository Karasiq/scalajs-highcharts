...
/**
  * @note JavaScript name: <code>plotOptions-series-dragDrop-dragHandle</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSeriesDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesDragDropDragHandle {
  /**
    ...
    */
  def apply(pathFormatter: js.UndefOr[js.Function] = js.undefined, cursor: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesDragDropDragHandle = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesDragDropDragHandle {
