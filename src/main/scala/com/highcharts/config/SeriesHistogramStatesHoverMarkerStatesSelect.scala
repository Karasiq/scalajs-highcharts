...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-hover-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogramStatesHoverMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesHoverMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHistogramStatesHoverMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesHoverMarkerStatesSelect {
