...
object SeriesBoxplotStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[SeriesBoxplotStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesBoxplotStatesHoverMarker]] = js.undefined): SeriesBoxplotStatesHover = {
