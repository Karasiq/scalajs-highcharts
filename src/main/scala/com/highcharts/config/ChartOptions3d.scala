...
object ChartOptions3d {
  /**
    ...
    */
  def apply(alpha: js.UndefOr[Double] = js.undefined, beta: js.UndefOr[Double] = js.undefined, depth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, frame: js.UndefOr[CleanJsObject[ChartOptions3dFrame]] = js.undefined, viewDistance: js.UndefOr[Double] = js.undefined): ChartOptions3d = {
