...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWaterfallStatesHoverHalo extends js.Object {
...
object PlotOptionsWaterfallStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsWaterfallStatesHoverHalo = {
    ...
    new PlotOptionsWaterfallStatesHoverHalo {
