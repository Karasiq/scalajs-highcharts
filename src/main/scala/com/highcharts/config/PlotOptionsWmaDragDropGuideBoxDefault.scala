...
/**
  * @note JavaScript name: <code>plotOptions-wma-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsWmaDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsWmaDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaDragDropGuideBoxDefault {
