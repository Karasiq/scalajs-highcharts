...
/**
  * @note JavaScript name: <code>plotOptions-ikh-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsIkhMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsIkhMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhMarker {
