...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The relative width for each column. On a category axis, the widths are
    * distributed so they sum up to the X axis length. On linear and datetime axes,
    * the columns will be laid out from the X value and Z units along the axis.</p>
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesVariwideDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesVariwideDataEvents]] = js.undefined
}

object SeriesVariwideData {
  /**
    * @param z <p>The relative width for each column. On a category axis, the widths are. distributed so they sum up to the X axis length. On linear and datetime axes,. the columns will be laid out from the X value and Z units along the axis.</p>
    ...
    */
  def apply(z: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesVariwideDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesVariwideDataEvents]] = js.undefined): SeriesVariwideData = {
    val zOuter: js.UndefOr[Double] = z
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesVariwideDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesVariwideDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideData {
      override val z: js.UndefOr[Double] = zOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesVariwideDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesVariwideDataEvents]] = eventsOuter
    })
  }
}
