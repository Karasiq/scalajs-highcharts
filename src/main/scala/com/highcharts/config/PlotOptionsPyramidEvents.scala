...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPyramidEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramidEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsPyramidEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramidEvents {
