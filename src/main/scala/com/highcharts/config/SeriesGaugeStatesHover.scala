...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGaugeStatesHover extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val halo: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverHalo]] = js.undefined
  ...
  val marker: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverMarker]] = js.undefined
}

object SeriesGaugeStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverMarker]] = js.undefined): SeriesGaugeStatesHover = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val haloOuter: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverHalo]] = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverMarker]] = marker
    new SeriesGaugeStatesHover {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val halo: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverHalo]] = haloOuter
      override val lineWidth: js.UndefOr[Double] = lineWidthOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesGaugeStatesHoverMarker]] = markerOuter
    }
  }
}
