...
class PlotOptionsBubbleStatesHoverHalo extends js.Object {
...
object PlotOptionsBubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleStatesHoverHalo = {
    ...
    new PlotOptionsBubbleStatesHoverHalo {
