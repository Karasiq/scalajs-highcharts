...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesTreemapStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapStatesHoverHalo {
