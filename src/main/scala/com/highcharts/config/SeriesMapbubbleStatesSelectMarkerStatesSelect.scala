...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapbubbleStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMapbubbleStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStatesSelectMarkerStatesSelect {
