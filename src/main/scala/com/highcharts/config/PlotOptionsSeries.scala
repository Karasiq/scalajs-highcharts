...
class PlotOptionsSeries extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsSeriesDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsSeriesEvents] = js.undefined
  ...
  var marker: UndefOr[PlotOptionsSeriesMarker] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsSeriesPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsSeriesZones]] = js.undefined
}
