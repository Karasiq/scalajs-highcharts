...
class PlotOptionsSeries extends js.Object {
  ...
  val dataLabels: PlotOptionsSeriesDataLabels = new PlotOptionsSeriesDataLabels
  ...
  val events: PlotOptionsSeriesEvents = new PlotOptionsSeriesEvents
  ...
  val marker: PlotOptionsSeriesMarker = new PlotOptionsSeriesMarker
  ...
  /**
    ...
    */
  val point: PlotOptionsSeriesPoint = new PlotOptionsSeriesPoint
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[PlotOptionsSeriesZones] = new js.Array[PlotOptionsSeriesZones]
}
