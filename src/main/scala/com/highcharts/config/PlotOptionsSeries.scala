...
class PlotOptionsSeries extends js.Object {
  ...
  val dataLabels: UndefOr[PlotOptionsSeriesDataLabels] = js.undefined
  ...
  val events: UndefOr[PlotOptionsSeriesEvents] = js.undefined
  ...
  val marker: UndefOr[PlotOptionsSeriesMarker] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsSeriesPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsSeriesZones]] = js.undefined
}
