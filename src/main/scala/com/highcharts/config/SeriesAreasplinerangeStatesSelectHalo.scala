...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplinerangeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesAreasplinerangeStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeStatesSelectHalo {
