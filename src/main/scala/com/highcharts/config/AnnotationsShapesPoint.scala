...
/**
  * @note JavaScript name: <code>annotations-shapes-point</code>
  */
@js.annotation.ScalaJSDefined
class AnnotationsShapesPoint extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsShapesPoint {
  /**
    ...
    */
  def apply(x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined): AnnotationsShapesPoint = {
    val xOuter: js.UndefOr[Double] = x
    val yOuter: js.UndefOr[Double] = y
    val xAxisOuter: js.UndefOr[Double | String] = xAxis
    val yAxisOuter: js.UndefOr[Double | String] = yAxis
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsShapesPoint {
