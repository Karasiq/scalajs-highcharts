...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHeatmapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesHeatmapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapStatesSelectHalo {
