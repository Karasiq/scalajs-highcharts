...
class SeriesPolygonDataMarkerStatesHover extends js.Object {
...
object SeriesPolygonDataMarkerStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesPolygonDataMarkerStatesHover = {
    ...
    new SeriesPolygonDataMarkerStatesHover {
