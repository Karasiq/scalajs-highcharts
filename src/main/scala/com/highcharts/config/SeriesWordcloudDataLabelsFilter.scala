...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesWordcloudDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudDataLabelsFilter {
