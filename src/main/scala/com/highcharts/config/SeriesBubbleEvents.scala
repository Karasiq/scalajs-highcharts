...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesBubbleEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleEvents {
