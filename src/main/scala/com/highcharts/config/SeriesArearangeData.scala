...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesArearangeDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesArearangeDataEvents]] = js.undefined
}
...
object SeriesArearangeData {
  /**
    ...
    */
  def apply(high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesArearangeDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesArearangeDataEvents]] = js.undefined): SeriesArearangeData = {
    val highOuter: js.UndefOr[Double] = high
    val lowOuter: js.UndefOr[Double] = low
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesArearangeDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesArearangeDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeData {
      override val high: js.UndefOr[Double] = highOuter
      override val low: js.UndefOr[Double] = lowOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesArearangeDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesArearangeDataEvents]] = eventsOuter
    })
  }
}
