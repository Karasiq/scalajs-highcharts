...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplineMarker extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-marker-radius/" target="_blank">Bigger markers</a>
    */
  val radius: js.UndefOr[Double] = js.undefined

  val states: js.UndefOr[CleanJsObject[PlotOptionsAreasplineMarkerStates]] = js.undefined
...
object PlotOptionsAreasplineMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsAreasplineMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsAreasplineMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[PlotOptionsAreasplineMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new PlotOptionsAreasplineMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[PlotOptionsAreasplineMarkerStates]] = statesOuter
