...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesParetoStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesNormal {
