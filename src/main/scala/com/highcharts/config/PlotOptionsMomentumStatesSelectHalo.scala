...
/**
  * @note JavaScript name: <code>plotOptions-momentum-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMomentumStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMomentumStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumStatesSelectHalo {
