...
/**
  * @note JavaScript name: <code>plotOptions-cmf-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCmfStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsCmfStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfStatesSelectMarkerStates {
