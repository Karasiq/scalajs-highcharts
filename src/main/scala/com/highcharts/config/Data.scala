...
class Data extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val columns: js.Array[js.Array[js.Any]] = js.undefined.asInstanceOf[js.Array[js.Array[js.Any]]]
  ...
  /**
    ...
    * @since 4.0
    */
  val complete: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.0
    */
  val dateFormat: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    * @since 4.0
    */
  val endColumn: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 4.0.4
    */
  val endRow: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 4.0
    */
  val googleSpreadsheetWorksheet: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    * @since 4.0
    */
  val parseDate: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.0
    */
  val parsed: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @since 4.0
    */
  val rows: js.Array[js.Array[js.Any]] = js.undefined.asInstanceOf[js.Array[js.Array[js.Any]]]
  ...
  /**
    ...
    * @since 4.0.4
    */
  val seriesMapping: js.Array[js.Object] = js.undefined.asInstanceOf[js.Array[js.Object]]
  ...
  /**
    ...
    * @since 4.0
    */
  val table: js.Any = js.undefined.asInstanceOf[js.Any]
}
