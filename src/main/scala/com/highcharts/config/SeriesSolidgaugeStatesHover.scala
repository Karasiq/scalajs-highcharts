...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSolidgaugeStatesHover extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val halo: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverHalo]] = js.undefined
  ...
  val marker: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverMarker]] = js.undefined
}

object SeriesSolidgaugeStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverMarker]] = js.undefined): SeriesSolidgaugeStatesHover = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val haloOuter: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverHalo]] = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverMarker]] = marker
    new SeriesSolidgaugeStatesHover {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val halo: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverHalo]] = haloOuter
      override val lineWidth: js.UndefOr[Double] = lineWidthOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesSolidgaugeStatesHoverMarker]] = markerOuter
    }
  }
}
