...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesPyramidDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidDataLabelsFilter {
