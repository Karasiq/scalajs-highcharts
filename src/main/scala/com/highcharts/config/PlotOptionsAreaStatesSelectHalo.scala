...
/**
  * @note JavaScript name: <code>plotOptions-area-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAreaStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaStatesSelectHalo {
