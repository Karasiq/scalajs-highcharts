...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-pathfinder-startMarker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoPathfinderStartMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoPathfinderStartMarker {
  /**
    ...
    */
  def apply(symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, align: js.UndefOr[String] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined): SeriesParetoPathfinderStartMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoPathfinderStartMarker {
