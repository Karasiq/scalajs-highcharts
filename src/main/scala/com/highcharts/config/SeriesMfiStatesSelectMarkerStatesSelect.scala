...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMfiStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMfiStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiStatesSelectMarkerStatesSelect {
