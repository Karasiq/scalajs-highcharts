...
class SeriesPie extends js.Object {
   ...
   */
  var center: js.Any = js.Array(null, null)
...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  var dataLabels: UndefOr[SeriesPieDataLabels] = js.undefined
   ...
   * @since 1.3.6
   */
  var endAngle: Double = null.asInstanceOf[Double]
  
  var events: UndefOr[SeriesPieEvents] = js.undefined
   ...
   * @since 2.3.0
   */
  var ignoreHiddenPoint: Boolean = true
   ...
   */
  var point: UndefOr[SeriesPiePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[SeriesPieZones]] = js.undefined
}
