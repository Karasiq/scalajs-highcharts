...
class PlotOptionsCandlestickStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickStatesHover {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickStatesHover {
