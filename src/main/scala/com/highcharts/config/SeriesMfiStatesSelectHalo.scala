...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMfiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMfiStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiStatesSelectHalo {
