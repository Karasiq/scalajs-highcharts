...
class Loading extends js.Object {
   ...
   * @since 1.2.0
   */
  var labelStyle: js.Object = js.eval("{ \"fontWeight\": \"bold\", \"position\": \"relative\", \"top\": \"45%\" }").asInstanceOf[js.Object]
