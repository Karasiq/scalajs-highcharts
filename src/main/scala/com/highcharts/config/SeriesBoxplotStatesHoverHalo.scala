...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBoxplotStatesHoverHalo extends js.Object {
...
object SeriesBoxplotStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBoxplotStatesHoverHalo = {
    ...
    new SeriesBoxplotStatesHoverHalo {
