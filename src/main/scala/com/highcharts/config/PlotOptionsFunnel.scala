...
class PlotOptionsFunnel extends js.Object {
...
<a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/pie-point/">Styled mode</a>.
  ...
  val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsFunnelDataLabels]] = js.undefined
  ...
  val events: js.UndefOr[CleanJsObject[PlotOptionsFunnelEvents]] = js.undefined
  ...
  /**
    ...
    */
  val point: js.UndefOr[CleanJsObject[PlotOptionsFunnelPoint]] = js.undefined
...
object PlotOptionsFunnel {
  /**
    ...
    */
  def apply(allowPointSelect: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, center: js.UndefOr[js.Array[String | Double]] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsFunnelDataLabels]] = js.undefined, depth: js.UndefOr[Double] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsFunnelEvents]] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double | String] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, minSize: js.UndefOr[Double] = js.undefined, neckHeight: js.UndefOr[Double | String] = js.undefined, neckWidth: js.UndefOr[Double | String] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsFunnelPoint]] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, slicedOffset: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsFunnelTooltip]] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, width: js.UndefOr[Double | String] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsFunnelZones]]] = js.undefined): PlotOptionsFunnel = {
    ...
    val dataLabelsOuter: js.UndefOr[CleanJsObject[PlotOptionsFunnelDataLabels]] = dataLabels
    val depthOuter: js.UndefOr[Double] = depth
    val descriptionOuter: js.UndefOr[String] = description
    val enableMouseTrackingOuter: js.UndefOr[Boolean] = enableMouseTracking
    val eventsOuter: js.UndefOr[CleanJsObject[PlotOptionsFunnelEvents]] = events
    ...
    val pointOuter: js.UndefOr[CleanJsObject[PlotOptionsFunnelPoint]] = point
    ...
    val tooltipOuter: js.UndefOr[CleanJsObject[PlotOptionsFunnelTooltip]] = tooltip
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsFunnelZones]]] = zones
    new PlotOptionsFunnel {
      ...
      override val dataLabels: js.UndefOr[CleanJsObject[PlotOptionsFunnelDataLabels]] = dataLabelsOuter
      ...
      override val events: js.UndefOr[CleanJsObject[PlotOptionsFunnelEvents]] = eventsOuter
      ...
      override val point: js.UndefOr[CleanJsObject[PlotOptionsFunnelPoint]] = pointOuter
      ...
      override val tooltip: js.UndefOr[CleanJsObject[PlotOptionsFunnelTooltip]] = tooltipOuter
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsFunnelZones]]] = zonesOuter
    }
  }
}
