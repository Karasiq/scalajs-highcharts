...
class PlotOptionsFunnel extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsFunnelDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsFunnelEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsFunnelPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsFunnelZones]] = js.undefined
}
