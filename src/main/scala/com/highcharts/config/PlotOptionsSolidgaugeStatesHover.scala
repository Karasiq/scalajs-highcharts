...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSolidgaugeStatesHover extends js.Object {
  ...
  /**
    ...
    * @since 4.0
    */
  val halo: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverHalo]] = js.undefined
  ...
  val marker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverMarker]] = js.undefined
}

object PlotOptionsSolidgaugeStatesHover {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverHalo]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverMarker]] = js.undefined): PlotOptionsSolidgaugeStatesHover = {
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val haloOuter: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverHalo]] = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverMarker]] = marker
    new PlotOptionsSolidgaugeStatesHover {
      override val enabled: js.UndefOr[Boolean] = enabledOuter
      override val halo: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverHalo]] = haloOuter
      override val lineWidth: js.UndefOr[Double] = lineWidthOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeStatesHoverMarker]] = markerOuter
    }
  }
}
