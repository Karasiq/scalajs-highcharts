...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFlagsStatesHover extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>The fill or background color of the flag.</p>
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesFlagsStatesHoverMarker]] = js.undefined
...
object SeriesFlagsStatesHover {
  /**
    * @param lineColor <p>The color of the line/border of the flag.</p>
    * @param fillColor <p>The fill or background color of the flag.</p>
    ...
    */
  def apply(lineColor: js.UndefOr[String | js.Object] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesFlagsStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesFlagsStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesFlagsStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesFlagsStatesHoverMarker]] = markerOuter
