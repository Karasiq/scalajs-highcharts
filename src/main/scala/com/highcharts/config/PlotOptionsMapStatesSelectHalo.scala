...
/**
  * @note JavaScript name: <code>plotOptions-map-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapStatesSelectHalo {
