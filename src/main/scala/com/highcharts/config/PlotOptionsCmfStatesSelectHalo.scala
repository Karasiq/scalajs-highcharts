...
/**
  * @note JavaScript name: <code>plotOptions-cmf-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCmfStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsCmfStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfStatesSelectHalo {
