...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCmfStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesCmfStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfStatesSelectHalo {
