...
/**
  * @note JavaScript name: <code>plotOptions-area-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreaStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsAreaStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaStatesNormal {
