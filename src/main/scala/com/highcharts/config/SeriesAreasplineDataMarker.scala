...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplineDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarkerStates]] = js.undefined
...
object SeriesAreasplineDataMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreasplineDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesAreasplineDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesAreasplineDataMarkerStates]] = statesOuter
