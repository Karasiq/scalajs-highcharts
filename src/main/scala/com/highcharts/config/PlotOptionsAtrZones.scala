...
/**
  * @note JavaScript name: <code>plotOptions-atr-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAtrZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAtrZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrZones {
