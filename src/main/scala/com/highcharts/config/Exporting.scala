...
class Exporting extends js.Object {
  ...
  /**
    ...
    */
  val chartOptions: js.Object = null.asInstanceOf[js.Object]
  ...
  /**
    ...
    * @since 4.1.8
    */
  val fallbackToExportServer: Boolean = true
  ...
  /**
    ...
    * @since 3.0.8
    */
  val formAttributes: js.Object = js.undefined.asInstanceOf[js.Object]
  ...
  /**
    ...
    * @since 3.0
    */
  val sourceHeight: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 3.0
    */
  val sourceWidth: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 2.0
    */
  val url: String = "http://export.highcharts.com"
