...
/**
  * @note JavaScript name: <code>plotOptions-area-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): PlotOptionsAreaDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaDataLabelsFilter {
