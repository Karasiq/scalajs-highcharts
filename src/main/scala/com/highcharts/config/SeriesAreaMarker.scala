...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesAreaMarkerStates]] = js.undefined
...
object SeriesAreaMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesAreaMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreaMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesAreaMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesAreaMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesAreaMarkerStates]] = statesOuter
