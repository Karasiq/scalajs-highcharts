...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSolidgaugeStatesHoverHalo extends js.Object {
...
object SeriesSolidgaugeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSolidgaugeStatesHoverHalo = {
    ...
    new SeriesSolidgaugeStatesHoverHalo {
