...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPyramidStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesHoverHalo {
