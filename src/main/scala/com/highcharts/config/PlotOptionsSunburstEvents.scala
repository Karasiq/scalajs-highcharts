...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSunburstEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsSunburstEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstEvents {
