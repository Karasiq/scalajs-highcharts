...
class Drilldown extends js.Object {
   ...
   * @since 3.0.8
   */
  val activeAxisLabelStyle: UndefOr[js.Object] = js.undefined
   ...
   * @since 3.0.8
   */
  val activeDataLabelStyle: UndefOr[js.Object] = js.undefined
   ...
   * @since 3.0.8
   */
  val animation: UndefOr[js.Any] = js.undefined
