...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  var dataLabels: UndefOr[SeriesPolygonDataLabels] = js.undefined
  ...
  var events: UndefOr[SeriesPolygonEvents] = js.undefined
  ...
  var marker: UndefOr[SeriesPolygonMarker] = js.undefined
   ...
   */
  var point: UndefOr[SeriesPolygonPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[SeriesPolygonZones]] = js.undefined
}
