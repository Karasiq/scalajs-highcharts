...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesLineMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesLineMarkerStates]] = js.undefined
...
object SeriesLineMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesLineMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesLineMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesLineMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesLineMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesLineMarkerStates]] = statesOuter
