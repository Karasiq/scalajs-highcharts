...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterDataLabels extends js.Object {
...
object SeriesScatterDataLabels {
  /**
