...
/**
  * @note JavaScript name: <code>plotOptions-area-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreaDataLabels extends js.Object {
...
object PlotOptionsAreaDataLabels {
  /**
