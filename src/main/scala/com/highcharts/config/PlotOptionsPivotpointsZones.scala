...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPivotpointsZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPivotpointsZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsZones {
