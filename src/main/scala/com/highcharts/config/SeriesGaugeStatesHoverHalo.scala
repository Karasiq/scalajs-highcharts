...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGaugeStatesHoverHalo extends js.Object {
...
object SeriesGaugeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesGaugeStatesHoverHalo = {
    ...
    new SeriesGaugeStatesHoverHalo {
