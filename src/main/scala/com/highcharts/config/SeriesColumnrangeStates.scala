...
class SeriesColumnrangeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  val normal: js.UndefOr[CleanJsObject[SeriesColumnrangeStatesNormal]] = js.undefined
}
...
object SeriesColumnrangeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[SeriesColumnrangeStatesNormal]] = js.undefined): SeriesColumnrangeStates = {
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    val normalOuter: js.UndefOr[CleanJsObject[SeriesColumnrangeStatesNormal]] = normal
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeStates {
      override val hover: js.Any = hoverOuter
      override val select: js.Any = selectOuter
      override val normal: js.UndefOr[CleanJsObject[SeriesColumnrangeStatesNormal]] = normalOuter
    })
  }
}
