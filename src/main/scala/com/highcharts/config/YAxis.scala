...
class YAxis extends js.Object {
  ...
  /**
    ...
    */
  val alternateGridColor: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    */
  val categories: js.Array[String] = js.undefined.asInstanceOf[js.Array[String]]
  ...
  /**
    ...
    * @since 4.0
    */
  val ceiling: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val dateTimeLabelFormats: js.Object = js.undefined.asInstanceOf[js.Object]
  ...
  /**
    ...
    * @since 4.0
    */
  val floor: Double = null.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val gridLineColor: String = "#D8D8D8"
  ...
  /**
    ...
    * @since 1.2
    */
  val gridLineDashStyle: String = "Solid"
  ...
  /**
    ...
    */
  val gridLineInterpolation: String = null.asInstanceOf[String]
  ...
  /**
    ...
    * @since 2.0.2
    */
  val linkedTo: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val max: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 1.2.0
    */
  val maxPadding: Double = 0.05

  /**
    * Deprecated. Renamed to <code>minRange</code> as of Highcharts 2.2.
    */
  val maxZoom: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val min: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val minRange: Double = js.undefined.asInstanceOf[Double]

  /**
    * The minimum tick interval allowed in axis values. For example on zooming in on an axis with daily data, this can be used to prevent the axis from showing hours. Defaults to the closest distance between two points on the axis.
    * @since 2.3.0
    */
  val minTickInterval: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val minorGridLineColor: String = "#E0E0E0"
  ...
  /**
    ...
    * @since 1.2
    */
  val minorGridLineDashStyle: String = "Solid"
  ...
  /**
    ...
    */
  val minorGridLineWidth: Double = 1
  ...
  /**
    ...
    */
  val minorTickColor: String = "#A0A0A0"
  ...
  /**
    ...
    */
  val minorTickInterval: js.Any = js.undefined.asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  val minorTickPosition: String = "outside"
  ...
  /**
    ...
    * @since 3.0.10
    */
  val reversedStacks: Boolean = true
  ...
  /**
    ...
    */
  val showFirstLabel: Boolean = true
  ...
  /**
    ...
    */
  val showLastLabel: Boolean = true
  ...
  /**
    ...
    * @since 4.0
    */
  val stops: js.Array[js.Array[js.Any]] = js.undefined.asInstanceOf[js.Array[js.Array[js.Any]]]
  ...
  /**
    ...
    * @since 4.1.0
    */
  val tickAmount: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val tickInterval: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val tickPixelInterval: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    */
  val tickPosition: String = "outside"
  ...
  /**
    ...
    */
  val tickPositioner: js.Function = js.undefined.asInstanceOf[js.Function]
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/xaxis/tickpositions-tickpositioner/" target="_blank">Demo of tickPositions and tickPositioner</a>
    */
  val tickPositions: js.Array[Double] = js.undefined.asInstanceOf[js.Array[Double]]
  ...
  /**
    ...
    * ]]</pre>
    */
  val units: js.Array[js.Any] = js.undefined.asInstanceOf[js.Array[js.Any]]
