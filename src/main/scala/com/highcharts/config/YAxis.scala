...
class YAxis extends js.Object {
   ...
   */
  var alternateGridColor: UndefOr[String] = js.undefined
   ...
   * @since 4.1.0
   */
  var breaks: UndefOr[js.Array[YAxisBreaks]] = js.undefined
   ...
   */
  var categories: UndefOr[js.Array[String]] = js.undefined
   ...
   * @since 4.0
   */
  var ceiling: UndefOr[Double] = js.undefined
   ...
   */
  var dateTimeLabelFormats: UndefOr[js.Object] = js.undefined
   ...
   * @since 1.2.0
   */
  var endOnTick: Boolean = true
  
  var events: UndefOr[YAxisEvents] = js.undefined
   ...
   * @since 4.0
   */
  var floor: Double = null.asInstanceOf[Double]
   ...
   */
  var gridLineColor: String = "#D8D8D8"
   ...
   * @since 1.2
   */
  var gridLineDashStyle: String = "Solid"
   ...
   */
  var gridLineInterpolation: String = null.asInstanceOf[String]
  ...
  var labels: UndefOr[YAxisLabels] = js.undefined
   ...
   * @since 2.0.2
   */
  var linkedTo: UndefOr[Double] = js.undefined
   ...
   * @since 1.2.0
   */
  var maxPadding: Double = 0.05
  
  /**
   * Deprecated. Renamed to <code>minRange</code> as of Highcharts 2.2.
   */
  @deprecated
  var maxZoom: UndefOr[Double] = js.undefined
   ...
   */
  var min: UndefOr[Double] = js.undefined
   ...
   */
  var minRange: UndefOr[Double] = js.undefined
  
  /**
   * The minimum tick interval allowed in axis values. For example on zooming in on an axis with daily data, this can be used to prevent the axis from showing hours. Defaults to the closest distance between two points on the axis.
   * @since 2.3.0
   */
  var minTickInterval: UndefOr[Double] = js.undefined
   ...
   */
  var minorGridLineColor: String = "#E0E0E0"
   ...
   * @since 1.2
   */
  var minorGridLineDashStyle: String = "Solid"
   ...
   */
  var minorGridLineWidth: Double = 1
   ...
   */
  var minorTickColor: String = "#A0A0A0"
   ...
   */
  var minorTickInterval: UndefOr[js.Any] = js.undefined
   ...
   */
  var minorTickPosition: String = "outside"
   ...
   */
  var plotBands: UndefOr[js.Array[js.Object]] = js.undefined
  
  /**
   * An array of objects representing plot lines on the X axis
   */
  var plotLines: UndefOr[js.Array[js.Object]] = js.undefined
   ...
   * @since 3.0.10
   */
  var reversedStacks: Boolean = true
   ...
   */
  var showFirstLabel: Boolean = true
   ...
   */
  var showLastLabel: Boolean = true
   ...
   */
  var stackLabels: UndefOr[YAxisStackLabels] = js.undefined
   ...
   * @since 4.0
   */
  var stops: UndefOr[js.Array[js.Array[js.Any]]] = js.undefined
   ...
   * @since 4.1.0
   */
  var tickAmount: UndefOr[Double] = js.undefined
   ...
   */
  var tickInterval: UndefOr[Double] = js.undefined
   ...
   */
  var tickPixelInterval: UndefOr[Double] = js.undefined
   ...
   */
  var tickPosition: String = "outside"
   ...
   */
  var tickPositioner: UndefOr[js.Function] = js.undefined
   ...
   * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/xaxis/tickpositions-tickpositioner/" target="_blank">Demo of tickPositions and tickPositioner</a>
   */
  var tickPositions: UndefOr[js.Array[Double]] = js.undefined
   ...
   */
  var tickmarkPlacement: String = null.asInstanceOf[String]
  
  var title: UndefOr[YAxisTitle] = js.undefined
   ...
   * ]]</pre>
   */
  var units: UndefOr[js.Array[js.Any]] = js.undefined
