...
class YAxis extends js.Object {
   ...
   */
  val alternateGridColor: UndefOr[String] = js.undefined
   ...
   */
  val categories: UndefOr[js.Array[String]] = js.undefined
   ...
   * @since 4.0
   */
  val ceiling: UndefOr[Double] = js.undefined
   ...
   */
  val dateTimeLabelFormats: UndefOr[js.Object] = js.undefined
   ...
   * @since 2.0.2
   */
  val linkedTo: UndefOr[Double] = js.undefined
   ...
   */
  val max: UndefOr[Double] = js.undefined
   ...
   */
  val min: UndefOr[Double] = js.undefined
   ...
   */
  val minRange: UndefOr[Double] = js.undefined
  
  /**
   * The minimum tick interval allowed in axis values. For example on zooming in on an axis with daily data, this can be used to prevent the axis from showing hours. Defaults to the closest distance between two points on the axis.
   * @since 2.3.0
   */
  val minTickInterval: UndefOr[Double] = js.undefined
   ...
   */
  val minorTickInterval: UndefOr[js.Any] = js.undefined
   ...
   * @since 4.0
   */
  val stops: UndefOr[js.Array[js.Array[js.Any]]] = js.undefined
   ...
   * @since 4.1.0
   */
  val tickAmount: UndefOr[Double] = js.undefined
   ...
   */
  val tickInterval: UndefOr[Double] = js.undefined
   ...
   */
  val tickPixelInterval: UndefOr[Double] = js.undefined
   ...
   */
  val tickPositioner: UndefOr[js.Function] = js.undefined
   ...
   * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/xaxis/tickpositions-tickpositioner/" target="_blank">Demo of tickPositions and tickPositioner</a>
   */
  val tickPositions: UndefOr[js.Array[Double]] = js.undefined
   ...
   * ]]</pre>
   */
  val units: UndefOr[js.Array[js.Any]] = js.undefined
