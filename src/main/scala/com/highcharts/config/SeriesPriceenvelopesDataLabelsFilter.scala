...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPriceenvelopesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesPriceenvelopesDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesDataLabelsFilter {
