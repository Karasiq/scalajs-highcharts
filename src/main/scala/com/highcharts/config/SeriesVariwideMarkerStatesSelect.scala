...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVariwideMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideMarkerStatesSelect {
