...
/**
  * @note JavaScript name: <code>plotOptions-xrange-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsXrangeStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsXrangeStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeStatesNormal {
