...
class Pane extends js.Object {
  ...
  /**
    ...
    * @since 2.3.0
    */
  val background: js.Array[js.Object] = js.undefined.asInstanceOf[js.Array[js.Object]]
  ...
  /**
    ...
    * @since 2.3.0
    */
  val endAngle: Double = js.undefined.asInstanceOf[Double]
  ...
  /**
    ...
    * @since 2.3.0
    */
  val startAngle: Double = js.undefined.asInstanceOf[Double]
}
