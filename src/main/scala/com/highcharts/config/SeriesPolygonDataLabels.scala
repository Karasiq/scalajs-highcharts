...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonDataLabels extends js.Object {
...
object SeriesPolygonDataLabels {
  /**
