...
/**
  * @note JavaScript name: <code>plotOptions-line-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsLineDataLabels extends js.Object {
...
object PlotOptionsLineDataLabels {
  /**
