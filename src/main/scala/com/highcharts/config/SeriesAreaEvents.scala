...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-events</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): SeriesAreaEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaEvents {
