...
object ZAxisTitle {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[String] = js.undefined, margin: js.UndefOr[Double] = js.undefined, offset: js.UndefOr[Double] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, text: js.UndefOr[String] = js.undefined, textAlign: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String] = js.undefined, skew3d: js.UndefOr[Boolean] = js.undefined): ZAxisTitle = {
