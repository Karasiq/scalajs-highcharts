...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSolidgaugeZones extends js.Object {
...
object PlotOptionsSolidgaugeZones {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSolidgaugeZones = {
    ...
    new PlotOptionsSolidgaugeZones {
