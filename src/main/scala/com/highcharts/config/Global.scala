...
class Global extends js.Object {
   ...
   * @since 4.0.4
   */
  var Date: UndefOr[js.Object] = js.undefined
  
  /**
   * Path to the pattern image required by VML browsers in order to draw radial gradients.
   * @since 2.3.0
   */
  var VMLRadialGradientURL: String = "http://code.highcharts.com/{version}/gfx/vml-radial-gradient.png"
   ...
   */
  var canvasToolsURL: String = "http://code.highcharts.com/{version}/modules/canvas-tools.js"
   ...
   * @since 4.1.0
   */
  var getTimezoneOffset: UndefOr[js.Function] = js.undefined
