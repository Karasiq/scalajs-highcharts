...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesPolygonDataMarkerStates]] = js.undefined
...
object SeriesPolygonDataMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesPolygonDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPolygonDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesPolygonDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesPolygonDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesPolygonDataMarkerStates]] = statesOuter
