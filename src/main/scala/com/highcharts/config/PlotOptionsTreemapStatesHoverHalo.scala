...
/**
  * @note JavaScript name: <code>plotOptions-treemap-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapStatesHoverHalo extends js.Object {
...
object PlotOptionsTreemapStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapStatesHoverHalo = {
    ...
    new PlotOptionsTreemapStatesHoverHalo {
