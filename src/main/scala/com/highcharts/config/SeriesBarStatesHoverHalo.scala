...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBarStatesHoverHalo extends js.Object {
...
object SeriesBarStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBarStatesHoverHalo = {
