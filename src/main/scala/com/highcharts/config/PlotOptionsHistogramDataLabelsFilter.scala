...
/**
  * @note JavaScript name: <code>plotOptions-histogram-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsHistogramDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): PlotOptionsHistogramDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramDataLabelsFilter {
