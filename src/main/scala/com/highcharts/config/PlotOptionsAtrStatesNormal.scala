...
/**
  * @note JavaScript name: <code>plotOptions-atr-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAtrStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsAtrStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrStatesNormal {
