...
/**
  * @note JavaScript name: <code>plotOptions-roc-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsRocStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsRocStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocStatesNormal {
