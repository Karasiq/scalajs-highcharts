...
/**
  * @note JavaScript name: <code>plotOptions-pareto-label</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsParetoLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): PlotOptionsParetoLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoLabel {
