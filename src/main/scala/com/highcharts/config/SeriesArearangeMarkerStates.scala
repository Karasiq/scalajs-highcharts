...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesArearangeMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeMarkerStates {
