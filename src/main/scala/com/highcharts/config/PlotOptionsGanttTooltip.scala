...
/**
  * @note JavaScript name: <code>plotOptions-gantt-tooltip</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttTooltip extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/tooltip/format/">Format demo</a>
    * @since 2.2
    */
  val pointFormat: js.Any = js.undefined
...
object PlotOptionsGanttTooltip {
  /**
    ...
    */
  def apply(headerFormat: js.UndefOr[String] = js.undefined, pointFormat: js.UndefOr[js.Any] = js.undefined, pointFormatter: js.UndefOr[js.Function] = js.undefined, distance: js.UndefOr[Double] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, followPointer: js.UndefOr[Boolean] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, hideDelay: js.UndefOr[Double] = js.undefined, outside: js.UndefOr[Boolean] = js.undefined, split: js.UndefOr[Boolean] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined): PlotOptionsGanttTooltip = {
    val headerFormatOuter: js.UndefOr[String] = headerFormat
    val pointFormatOuter: js.Any = pointFormat
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttTooltip {
      override val headerFormat: js.UndefOr[String] = headerFormatOuter
      override val pointFormat: js.Any = pointFormatOuter
