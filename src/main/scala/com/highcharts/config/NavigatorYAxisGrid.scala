...
/**
  * @note JavaScript name: <code>navigator-yAxis-grid</code>
  */
@js.annotation.ScalaJSDefined
class NavigatorYAxisGrid extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): NavigatorYAxisGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisGrid {
