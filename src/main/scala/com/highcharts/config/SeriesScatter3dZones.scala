...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesScatter3dZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dZones {
