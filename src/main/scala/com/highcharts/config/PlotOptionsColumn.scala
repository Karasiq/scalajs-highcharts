...
class PlotOptionsColumn extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsColumnDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsColumnEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsColumnPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsColumnZones]] = js.undefined
}
