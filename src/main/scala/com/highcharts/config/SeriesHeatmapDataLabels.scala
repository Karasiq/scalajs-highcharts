...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHeatmapDataLabels extends js.Object {
...
object SeriesHeatmapDataLabels {
  /**
