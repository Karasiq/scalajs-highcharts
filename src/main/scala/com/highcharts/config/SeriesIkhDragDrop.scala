...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class SeriesIkhDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[SeriesIkhDragDropDragHandle]] = js.undefined
...
object SeriesIkhDragDrop {
  ...
  def apply(dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[SeriesIkhDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): SeriesIkhDragDrop = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[SeriesIkhDragDropDragHandle]] = dragHandleOuter
