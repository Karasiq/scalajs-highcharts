...
class PlotOptionsScatter extends js.Object {
  ...
  val dataLabels: UndefOr[PlotOptionsScatterDataLabels] = js.undefined
  ...
  val events: UndefOr[PlotOptionsScatterEvents] = js.undefined
  ...
  val marker: UndefOr[PlotOptionsScatterMarker] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsScatterPoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsScatterZones]] = js.undefined
}
