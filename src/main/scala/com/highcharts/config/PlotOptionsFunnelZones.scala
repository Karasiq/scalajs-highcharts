...
/**
  * @note JavaScript name: <code>plotOptions-funnel-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFunnelZones extends js.Object {
...
object PlotOptionsFunnelZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsFunnelZones = {
