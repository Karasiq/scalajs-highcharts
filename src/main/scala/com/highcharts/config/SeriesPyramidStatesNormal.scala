...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesPyramidStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesNormal {
