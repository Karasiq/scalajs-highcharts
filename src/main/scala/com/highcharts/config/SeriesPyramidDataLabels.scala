...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidDataLabels extends js.Object {
...
object SeriesPyramidDataLabels {
  /**
