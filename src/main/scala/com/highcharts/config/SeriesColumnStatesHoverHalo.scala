...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnStatesHoverHalo extends js.Object {
...
object SeriesColumnStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesColumnStatesHoverHalo = {
    ...
    new SeriesColumnStatesHoverHalo {
