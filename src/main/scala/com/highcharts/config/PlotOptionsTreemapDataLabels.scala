...
/**
  * @note JavaScript name: <code>plotOptions-treemap-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapDataLabels extends js.Object {
...
object PlotOptionsTreemapDataLabels {
  /**
