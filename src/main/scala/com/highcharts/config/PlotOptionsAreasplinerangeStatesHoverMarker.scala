...
class PlotOptionsAreasplinerangeStatesHoverMarker extends js.Object {
  ...
  /**
    ...
    */
  val enabled: Boolean = null.asInstanceOf[Boolean]
  ...
  /**
    ...
    * @since 4.0.4
    */
  val height: Double = null.asInstanceOf[Double]
  ...
  val states: js.Any = js.undefined.asInstanceOf[js.Any]
  ...
  /**
    ...
    */
  val symbol: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    * @since 4.0.4
    */
  val width: Double = null.asInstanceOf[Double]
}
