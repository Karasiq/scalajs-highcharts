...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-states-hover-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplinerangeStatesHoverMarker extends js.Object {
...
object PlotOptionsAreasplinerangeStatesHoverMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsAreasplinerangeStatesHoverMarker = {
    ...
    new PlotOptionsAreasplinerangeStatesHoverMarker {
