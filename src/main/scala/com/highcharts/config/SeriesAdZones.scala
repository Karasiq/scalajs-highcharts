...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAdZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAdZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdZones {
