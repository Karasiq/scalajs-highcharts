...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreasplineMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesAreasplineMarkerStates]] = js.undefined
...
object SeriesAreasplineMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesAreasplineMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreasplineMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesAreasplineMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesAreasplineMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesAreasplineMarkerStates]] = statesOuter
