...
/**
  * @note JavaScript name: <code>plotOptions-series-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSeriesMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[PlotOptionsSeriesMarkerStates]] = js.undefined
...
object PlotOptionsSeriesMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[PlotOptionsSeriesMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new PlotOptionsSeriesMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[PlotOptionsSeriesMarkerStates]] = statesOuter
