...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesArearangeStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeStatesSelectHalo {
