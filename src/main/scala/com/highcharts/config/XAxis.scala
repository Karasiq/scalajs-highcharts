...
class XAxis extends js.Object {
   ...
   * @since 4.1.0
   */
  var breaks: UndefOr[js.Array[XAxisBreaks]] = js.undefined
   ...
   * @since 1.2.0
   */
  var endOnTick: Boolean = false
  
  /**
   * Event handlers for the axis.
   */
  var events: UndefOr[XAxisEvents] = js.undefined
   ...
   */
  var labels: UndefOr[XAxisLabels] = js.undefined
   ...
   */
  var title: UndefOr[XAxisTitle] = js.undefined
