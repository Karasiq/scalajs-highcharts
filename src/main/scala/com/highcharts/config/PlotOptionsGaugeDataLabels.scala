...
/**
  * @note JavaScript name: <code>plotOptions-gauge-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGaugeDataLabels extends js.Object {
...
object PlotOptionsGaugeDataLabels {
  /**
