...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMappointStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointStatesHoverMarkerStates {
