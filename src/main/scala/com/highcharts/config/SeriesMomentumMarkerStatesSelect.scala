...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMomentumMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumMarkerStatesSelect {
