...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  val events: SeriesBoxplotEvents = new SeriesBoxplotEvents
   ...
   * @since 3.0
   */
  val medianColor: String = null.asInstanceOf[String]
   ...
   */
  val point: SeriesBoxplotPoint = new SeriesBoxplotPoint
   ...
   * @since 4.1.0
   */
  val zones: js.Array[SeriesBoxplotZones] = new js.Array[SeriesBoxplotZones]
}
