...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPsarStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPsarStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarStatesSelectHalo {
