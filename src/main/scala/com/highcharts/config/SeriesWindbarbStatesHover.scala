...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarbStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-enabled-pie/">Pie</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesHoverMarker]] = js.undefined
...
object SeriesWindbarbStatesHover {
  /**
    ...
    */
  def apply(lineWidthPlus: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesWindbarbStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesWindbarbStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesHoverMarker]] = markerOuter
