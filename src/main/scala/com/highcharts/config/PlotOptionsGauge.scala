...
class PlotOptionsGauge extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsGaugePathfinder]] = js.undefined
}
...
object PlotOptionsGauge {
  /**
    ...
    */
  def apply(dataLabels: js.UndefOr[CleanJsObject[PlotOptionsGaugeDataLabels]] = js.undefined, dial: js.UndefOr[CleanJsObject[PlotOptionsGaugeDial]] = js.undefined, pivot: js.UndefOr[CleanJsObject[PlotOptionsGaugePivot]] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, wrap: js.UndefOr[Boolean] = js.undefined, overshoot: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[js.Any] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[PlotOptionsGaugePathfinder]] = js.undefined): PlotOptionsGauge = {
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[PlotOptionsGaugePathfinder]] = pathfinder
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGauge {
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[PlotOptionsGaugePathfinder]] = pathfinderOuter
    })
  }
}
