...
object PlotOptionsGauge {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsGaugeDataLabels]] = js.undefined, dial: js.UndefOr[CleanJsObject[PlotOptionsGaugeDial]] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[PlotOptionsGaugeEvents]] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, overshoot: js.UndefOr[Double] = js.undefined, pivot: js.UndefOr[CleanJsObject[PlotOptionsGaugePivot]] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsGaugePoint]] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSeriesStates]] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, tooltip: js.UndefOr[CleanJsObject[PlotOptionsGaugeTooltip]] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, wrap: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsGaugeZones]]] = js.undefined): PlotOptionsGauge = {
    ...
    val zonesOuter: js.UndefOr[js.Array[CleanJsObject[PlotOptionsGaugeZones]]] = zones
    new PlotOptionsGauge {
      ...
      override val zones: js.UndefOr[js.Array[CleanJsObject[PlotOptionsGaugeZones]]] = zonesOuter
    }
  }
}
