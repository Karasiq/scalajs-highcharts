...
class PlotOptionsGauge extends js.Object {
  ...
  var events: UndefOr[PlotOptionsGaugeEvents] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsGaugePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsGaugeZones]] = js.undefined
}
