...
/**
  * @note JavaScript name: <code>plotOptions-polygon-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPolygonStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsPolygonStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonStatesHoverHalo {
