...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesScatterMarkerStates]] = js.undefined
...
object SeriesScatterMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesScatterMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesScatterMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesScatterMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesScatterMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesScatterMarkerStates]] = statesOuter
