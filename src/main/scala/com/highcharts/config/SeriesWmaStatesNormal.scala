...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWmaStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesWmaStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaStatesNormal {
