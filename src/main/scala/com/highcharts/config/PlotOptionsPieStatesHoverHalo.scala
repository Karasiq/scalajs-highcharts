...
/**
  * @note JavaScript name: <code>plotOptions-pie-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPieStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsPieStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieStatesHoverHalo {
