...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSplineMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesSplineMarkerStates]] = js.undefined
...
object SeriesSplineMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesSplineMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesSplineMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesSplineMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesSplineMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesSplineMarkerStates]] = statesOuter
