...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWordcloudMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudMarkerStates {
