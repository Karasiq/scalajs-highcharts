...
/**
  * @note JavaScript name: <code>plotOptions-pareto-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsParetoMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoMarker {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsParetoMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoMarker {
