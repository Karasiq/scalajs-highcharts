...
/**
  * @note JavaScript name: <code>plotOptions-spline-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSplineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsSplineStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineStatesHoverHalo {
