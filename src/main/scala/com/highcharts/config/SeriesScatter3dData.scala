...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The z value for each data point.</p>
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesScatter3dDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesScatter3dDataEvents]] = js.undefined

  val marker: js.UndefOr[CleanJsObject[SeriesScatter3dDataMarker]] = js.undefined
}

object SeriesScatter3dData {
  /**
    * @param z <p>The z value for each data point.</p>
    ...
    */
  def apply(z: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesScatter3dDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesScatter3dDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesScatter3dDataMarker]] = js.undefined): SeriesScatter3dData = {
    val zOuter: js.UndefOr[Double] = z
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesScatter3dDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesScatter3dDataEvents]] = events
    val markerOuter: js.UndefOr[CleanJsObject[SeriesScatter3dDataMarker]] = marker
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dData {
      override val z: js.UndefOr[Double] = zOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesScatter3dDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesScatter3dDataEvents]] = eventsOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesScatter3dDataMarker]] = markerOuter
    })
  }
}
