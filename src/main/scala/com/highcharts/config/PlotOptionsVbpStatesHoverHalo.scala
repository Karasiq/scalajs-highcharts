...
/**
  * @note JavaScript name: <code>plotOptions-vbp-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVbpStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsVbpStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpStatesHoverHalo {
