...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCandlestickDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Allow open value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableOpen: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow close value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableClose: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDragDropDragHandle]] = js.undefined
...
object PlotOptionsCandlestickDragDrop {
  /**
    ...
    * @param draggableOpen <p>Allow open value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    * @param draggableClose <p>Allow close value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    ...
    */
  def apply(draggableLow: js.UndefOr[Boolean] = js.undefined, draggableHigh: js.UndefOr[Boolean] = js.undefined, draggableOpen: js.UndefOr[Boolean] = js.undefined, draggableClose: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsCandlestickDragDrop = {
    val draggableLowOuter: js.UndefOr[Boolean] = draggableLow
    val draggableHighOuter: js.UndefOr[Boolean] = draggableHigh
    val draggableOpenOuter: js.UndefOr[Boolean] = draggableOpen
    val draggableCloseOuter: js.UndefOr[Boolean] = draggableClose
    val dragSensitivityOuter: js.UndefOr[Double] = dragSensitivity
    val guideBoxOuter: js.UndefOr[js.Object] = guideBox
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickDragDrop {
      ...
      override val draggableOpen: js.UndefOr[Boolean] = draggableOpenOuter
      override val draggableClose: js.UndefOr[Boolean] = draggableCloseOuter
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsCandlestickDragDropDragHandle]] = dragHandleOuter
