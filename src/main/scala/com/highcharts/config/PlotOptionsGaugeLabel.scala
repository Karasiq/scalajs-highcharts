...
/**
  * @note JavaScript name: <code>plotOptions-gauge-label</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGaugeLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGaugeLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): PlotOptionsGaugeLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGaugeLabel {
