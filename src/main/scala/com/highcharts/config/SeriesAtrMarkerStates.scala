...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAtrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAtrMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrMarkerStates {
