...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemapStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesTilemapStatesHoverMarker]] = js.undefined
...
object SeriesTilemapStatesHover {
  /**
    ...
    */
  def apply(halo: js.UndefOr[js.Any] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesTilemapStatesHoverMarker]] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): SeriesTilemapStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesTilemapStatesHoverMarker]] = marker
    val enabledOuter: js.UndefOr[Boolean] = enabled
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val colorOuter: js.UndefOr[String | js.Object] = color
    val borderColorOuter: js.UndefOr[String | js.Object] = borderColor
    val borderWidthOuter: js.UndefOr[Double] = borderWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesTilemapStatesHoverMarker]] = markerOuter
