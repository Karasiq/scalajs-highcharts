...
class PlotOptionsPyramidDataLabels extends js.Object {
  ...
  /**
    ...
    * @since 2.1
    */
  val connectorColor: String = "{point.color}"
  ...
  /**
    ...
    * @since 3.0
    */
  val inside: Boolean = js.undefined.asInstanceOf[Boolean]
  ...
  /**
    ...
    * @since 2.1.7
    */
  val softConnector: Boolean = true
