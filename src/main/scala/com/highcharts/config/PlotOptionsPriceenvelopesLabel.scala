...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-label</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsPriceenvelopesLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): PlotOptionsPriceenvelopesLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesLabel {
