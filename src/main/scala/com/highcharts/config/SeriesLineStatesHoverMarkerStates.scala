...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesLineStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLineStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineStatesHoverMarkerStates {
