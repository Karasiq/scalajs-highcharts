...
/**
  * @note JavaScript name: <code>plotOptions-funnel-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsFunnelStatesHoverHalo extends js.Object {
...
object PlotOptionsFunnelStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsFunnelStatesHoverHalo = {
    ...
    new PlotOptionsFunnelStatesHoverHalo {
