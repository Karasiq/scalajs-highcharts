...
/**
  * @note JavaScript name: <code>plotOptions-series-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSeriesStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsSeriesStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesStatesSelectHalo {
