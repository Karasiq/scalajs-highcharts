...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariwideStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVariwideStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesSelectMarkerStatesSelect {
