...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSplineDataLabels extends js.Object {
