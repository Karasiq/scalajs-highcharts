...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMapStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStatesHoverMarkerStates {
