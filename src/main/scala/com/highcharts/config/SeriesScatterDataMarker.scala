...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesScatterDataMarkerStates]] = js.undefined
...
object SeriesScatterDataMarker {
  /**
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesScatterDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesScatterDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesScatterDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesScatterDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesScatterDataMarkerStates]] = statesOuter
