...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-data-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSplineDataMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesSplineDataMarkerStates]] = js.undefined
...
object SeriesSplineDataMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesSplineDataMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesSplineDataMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesSplineDataMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesSplineDataMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesSplineDataMarkerStates]] = statesOuter
