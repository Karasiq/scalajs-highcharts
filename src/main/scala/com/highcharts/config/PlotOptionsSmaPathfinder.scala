...
/**
  * @note JavaScript name: <code>plotOptions-sma-pathfinder</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSmaPathfinder extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaPathfinder {
  /**
    ...
    */
  def apply(`type`: js.UndefOr[String] = "straight|simpleConnect", lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Object] = js.undefined, startMarker: js.UndefOr[js.Object] = js.undefined, endMarker: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, algorithmMargin: js.UndefOr[Double] = js.undefined): PlotOptionsSmaPathfinder = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaPathfinder {
