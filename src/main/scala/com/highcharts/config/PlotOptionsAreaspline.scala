...
class PlotOptionsAreaspline extends js.Object {
  ...
  val dataLabels: UndefOr[PlotOptionsAreasplineDataLabels] = js.undefined
  ...
  val events: UndefOr[PlotOptionsAreasplineEvents] = js.undefined
  ...
  val marker: UndefOr[PlotOptionsAreasplineMarker] = js.undefined
   ...
   */
  val point: UndefOr[PlotOptionsAreasplinePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  val zones: UndefOr[js.Array[PlotOptionsAreasplineZones]] = js.undefined
}
