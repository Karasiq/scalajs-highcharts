...
class PlotOptionsAreaspline extends js.Object {
  ...
  val dataLabels: PlotOptionsAreasplineDataLabels = new PlotOptionsAreasplineDataLabels
  ...
  val events: PlotOptionsAreasplineEvents = new PlotOptionsAreasplineEvents
  ...
  /**
    ...
    */
  val lineColor: String = js.undefined.asInstanceOf[String]
  ...
  val marker: PlotOptionsAreasplineMarker = new PlotOptionsAreasplineMarker
  ...
  /**
    ...
    * @since 3.0
    */
  val negativeFillColor: String = ""

  /**
    * Properties for each single point
    */
  val point: PlotOptionsAreasplinePoint = new PlotOptionsAreasplinePoint
  ...
  /**
    ...
    */
  val stacking: String = js.undefined.asInstanceOf[String]
  ...
  /**
    ...
    * @since 4.1.0
    */
  val zones: js.Array[PlotOptionsAreasplineZones] = new js.Array[PlotOptionsAreasplineZones]
}
