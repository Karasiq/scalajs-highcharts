...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSunburstZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstZones {
