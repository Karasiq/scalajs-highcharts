...
/**
  * @note JavaScript name: <code>plotOptions-xrange-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsXrangeDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsXrangeDragDropDragHandle]] = js.undefined
...
object PlotOptionsXrangeDragDrop {
  /**
    ...
    */
  def apply(draggableX1: js.UndefOr[Boolean] = js.undefined, draggableX2: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsXrangeDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsXrangeDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsXrangeDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsXrangeDragDropDragHandle]] = dragHandleOuter
