...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesOhlcStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesSelectMarkerStatesSelect {
