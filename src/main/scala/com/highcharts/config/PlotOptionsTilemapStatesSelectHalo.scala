...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTilemapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsTilemapStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapStatesSelectHalo {
