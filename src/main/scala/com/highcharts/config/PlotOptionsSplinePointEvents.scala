...
/**
  * @note JavaScript name: <code>plotOptions-spline-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSplinePointEvents extends js.Object {
...
object PlotOptionsSplinePointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsSplinePointEvents = {
    ...
    new PlotOptionsSplinePointEvents {
