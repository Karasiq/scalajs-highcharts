...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBbMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesBbMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbMarkerStates {
