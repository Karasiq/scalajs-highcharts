...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleMarker extends js.Object {
  ...
  val states: js.UndefOr[CleanJsObject[SeriesBubbleMarkerStates]] = js.undefined
...
object SeriesBubbleMarker {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesBubbleMarkerStates]] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesBubbleMarker = {
    ...
    val statesOuter: js.UndefOr[CleanJsObject[SeriesBubbleMarkerStates]] = states
    val symbolOuter: js.UndefOr[String] = symbol
    val widthOuter: js.UndefOr[Double] = width
    new SeriesBubbleMarker {
      ...
      override val states: js.UndefOr[CleanJsObject[SeriesBubbleMarkerStates]] = statesOuter
