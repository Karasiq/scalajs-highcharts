...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-label</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatter3dLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): PlotOptionsScatter3dLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dLabel {
