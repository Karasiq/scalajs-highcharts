...
class PlotOptionsLine extends js.Object {
  ...
  var dataLabels: UndefOr[PlotOptionsLineDataLabels] = js.undefined
  ...
  var events: UndefOr[PlotOptionsLineEvents] = js.undefined
  ...
  var marker: UndefOr[PlotOptionsLineMarker] = js.undefined
   ...
   */
  var point: UndefOr[PlotOptionsLinePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[PlotOptionsLineZones]] = js.undefined
}
