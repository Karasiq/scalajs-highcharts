...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMappointStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMappointStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesSelectHalo {
