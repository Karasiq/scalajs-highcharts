...
/**
  * @note JavaScript name: <code>plotOptions-series-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSeriesDataLabels extends js.Object {
...
object PlotOptionsSeriesDataLabels {
  /**
