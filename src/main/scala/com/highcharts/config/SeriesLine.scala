...
<li><a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/highcharts/series/data-array-of-objects/" target="_blank"> Config objects</a></li>
  ...
  var dataLabels: UndefOr[SeriesLineDataLabels] = js.undefined
  ...
  var events: UndefOr[SeriesLineEvents] = js.undefined
  ...
  var marker: UndefOr[SeriesLineMarker] = js.undefined
   ...
   */
  var point: UndefOr[SeriesLinePoint] = js.undefined
   ...
   * @since 4.1.0
   */
  var zones: UndefOr[js.Array[SeriesLineZones]] = js.undefined
}
