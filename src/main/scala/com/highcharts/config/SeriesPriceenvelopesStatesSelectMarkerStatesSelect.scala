...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPriceenvelopesStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPriceenvelopesStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesStatesSelectMarkerStatesSelect {
