...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMfiMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMfiMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiMarkerStatesSelect {
