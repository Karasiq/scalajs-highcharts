...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-lastPrice-label</code>
  */
class SeriesPolygonLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonLastPriceLabel {
  /**
