...
/**
  * @note JavaScript name: <code>plotOptions-momentum-dataGrouping</code>
  */
class PlotOptionsMomentumDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumDataGrouping {
  /**
