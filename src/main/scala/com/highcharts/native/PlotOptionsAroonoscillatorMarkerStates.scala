...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-marker-states</code>
  */
class PlotOptionsAroonoscillatorMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAroonoscillatorMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
