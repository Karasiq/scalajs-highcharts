...
/**
  * @note JavaScript name: <code>plotOptions-scatter-dataSorting</code>
  */
class PlotOptionsScatterDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsScatterDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterDataSorting {
