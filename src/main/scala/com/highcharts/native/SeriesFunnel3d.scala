...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;</code>
  */
class SeriesFunnel3d extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>funnel3d</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li> An array of numerical values. In this case, the numerical values
    ...
    * categories, these will be used. Example:</li>
    * </ol>
    ...
    * points exceeds the series&#39; <a href="#series.funnel3d.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    * @since 7.1.0
    */
  var data: js.UndefOr[js.Array[Double | js.Array[Double] | js.Any]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    * @since 7.1.0
    */
  var `type`: js.UndefOr[String] = "funnel3d"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/mapbubble-animation-false/">Disabled on mapbubble series</a>
  ...
  /**
    * <p>The center of the series. By default, it is centered in the middle
    * of the plot area, so it fills the plot area height.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">Style mode example</a>
  ...
  /**
    * <p>The height of the funnel or pyramid. If it is a number it defines
    * the pixel height, if it is a percentage string it is the percentage
    * of the plot area height.</p>
  ...
  /**
    * <p>The height of the neck, the lower part of the funnel. A number
    * defines pixel width, a percentage string defines a percentage of the
    * plot area height.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/funnel3d/">Funnel3d demo</a>
    * @since 7.1.0
    */
  var neckHeight: js.UndefOr[Double | String] = js.undefined

  /**
    * <p>The width of the neck, the lower part of the funnel. A number defines
  ...
  /**
    * <p>A reversed funnel has the widest area down. A reversed funnel with
    * no neck width and neck height is a pyramid.</p>
    * @since 3.0.10
    */
  ...
  /**
    * <p>The width of the funnel compared to the width of the plot area,
    * or the pixel width if it is a number.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/funnel3d/">Funnel3d demo</a>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/coloraxis/changed-default-color-key/">Changed default color key</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesFunnel3dConnectors]] = js.undefined
...
object SeriesFunnel3d {
  /**
    * @param data <p>An array of data points for the series. For the <code>funnel3d</code> series. type, points can be given in the following ways:</p>. <ol>. <li> An array of numerical values. In this case, the numerical values. will be interpreted as <code>y</code> options. The <code>x</code> values will be automatically. calculated, either starting at 0 and incremented by 1, or from <code>pointStart</code>. and <code>pointInterval</code> given in the series options. If the axis has. categories, these will be used. Example:</li>. </ol>. <pre><code class="language-js">data: [0, 5, 3, 5]. </code></pre>. <ol start="2">. <li> An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.funnel3d.turboThreshold">turboThreshold</a>,. this option is not available.</li>. </ol>. <pre><code class="language-js">   data: [{.        y: 2,.        name: &quot;Point2&quot;,.        color: &quot;#00FF00&quot;.    }, {.        y: 4,.        name: &quot;Point1&quot;,.        color: &quot;#FF00FF&quot;.    }]. </code></pre>
    ...
    * @param animation <p>Initial animation is by default disabled for the funnel chart.</p>
    * @param center <p>The center of the series. By default, it is centered in the middle. of the plot area, so it fills the plot area height.</p>
    ...
    * @param height <p>The height of the funnel or pyramid. If it is a number it defines. the pixel height, if it is a percentage string it is the percentage. of the plot area height.</p>
    * @param neckHeight <p>The height of the neck, the lower part of the funnel. A number. defines pixel width, a percentage string defines a percentage of the. plot area height.</p>
    * @param neckWidth <p>The width of the neck, the lower part of the funnel. A number defines. pixel width, a percentage string defines a percentage of the plot. area width.</p>
    * @param reversed <p>A reversed funnel has the widest area down. A reversed funnel with. no neck width and neck height is a pyramid.</p>
    * @param states <p>Options for the series states.</p>
    * @param width <p>The width of the funnel compared to the width of the plot area,. or the pixel width if it is a number.</p>
    ...
    * @param depth <p>The thickness of a 3D pie.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[Double | js.Array[Double] | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[Double | String] = js.undefined, `type`: js.UndefOr[String] = "funnel3d", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, center: js.UndefOr[js.Array[Double | String]] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, height: js.UndefOr[Double | String] = js.undefined, neckHeight: js.UndefOr[Double | String] = js.undefined, neckWidth: js.UndefOr[Double | String] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, width: js.UndefOr[Double | String] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, depth: js.UndefOr[Double] = js.undefined, endAngle: js.UndefOr[Double] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, ignoreHiddenPoint: js.UndefOr[Boolean] = js.undefined, minSize: js.UndefOr[Double | String] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, slicedOffset: js.UndefOr[Double] = js.undefined, startAngle: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, useOhlcData: js.UndefOr[Boolean] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesFunnel3dConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, gradientForSides: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, centerInCategory: js.UndefOr[Boolean] = js.undefined, edgeColor: js.UndefOr[String] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined): SeriesFunnel3d = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3d {
      this.data = data
      this.id = id
      this.index = index
