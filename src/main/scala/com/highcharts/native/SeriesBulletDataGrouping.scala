...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-dataGrouping</code>
  */
class SeriesBulletDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataGrouping {
  /**
