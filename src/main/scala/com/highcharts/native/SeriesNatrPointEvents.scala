...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-point-events</code>
  */
class SeriesNatrPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesNatrPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrPointEvents {
      this.click = click
      this.drag = drag
