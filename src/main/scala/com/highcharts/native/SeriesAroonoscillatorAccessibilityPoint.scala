...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-accessibility-point</code>
  */
class SeriesAroonoscillatorAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAroonoscillatorAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorAccessibilityPoint {
