...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-marker-states-select</code>
  */
class SeriesMapbubbleMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesMapbubbleMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleMarkerStatesSelect {
