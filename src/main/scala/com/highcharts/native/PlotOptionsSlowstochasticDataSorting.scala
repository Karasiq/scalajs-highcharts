...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-dataSorting</code>
  */
class PlotOptionsSlowstochasticDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsSlowstochasticDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticDataSorting {
