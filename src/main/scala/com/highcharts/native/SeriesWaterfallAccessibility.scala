...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-accessibility</code>
  */
class SeriesWaterfallAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesWaterfallAccessibilityPoint]] = js.undefined
}

object SeriesWaterfallAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesWaterfallAccessibilityPoint]] = js.undefined): SeriesWaterfallAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallAccessibility {
