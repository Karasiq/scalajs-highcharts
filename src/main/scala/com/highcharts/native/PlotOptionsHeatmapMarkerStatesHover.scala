...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-marker-states-hover</code>
  */
class PlotOptionsHeatmapMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * selected point.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/heatmap-marker-states-hover-widthplus">20px greater width and height on hover</a>
    * @since 8.1
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/heatmap-marker-states-hover-linewidthplus">5 pixels wider lineWidth on hover</a>
    * @since 4.0.3
    */
...
object PlotOptionsHeatmapMarkerStatesHover {
  /**
    * @param height <p>Set the marker&#39;s fixed height on hover state.</p>
    * @param heightPlus <p>The number of pixels to increase the height of the. selected point.</p>
    ...
    * @param widthPlus <p>The number of pixels to increase the width of the. selected point.</p>
    ...
    */
  def apply(height: js.UndefOr[js.UndefOr[Double]] = js.undefined, heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapMarkerStatesHover {
      this.height = height
