...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-dataLabels-animation</code>
  */
class SeriesSunburstDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSunburstDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataLabelsAnimation {
      this.defer = defer
    })
  }
}
