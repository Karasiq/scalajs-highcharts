...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dataLabels-filter</code>
  */
class SeriesSupertrendDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSupertrendDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendDataLabelsFilter {
