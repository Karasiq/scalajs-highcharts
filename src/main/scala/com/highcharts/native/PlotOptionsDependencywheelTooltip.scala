...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-tooltip</code>
  */
class PlotOptionsDependencywheelTooltip extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Whether the tooltip should follow the pointer or stay fixed on
    * the item.</p>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/tooltip/format/">Format demo</a>
  ...
  /**
    ...
    * specifying what to show for <em>nodes</em> in tooltip of a diagram
    * series, as opposed to links.</p>
    * @since 2.3.0
    */
  var nodeFormat: js.UndefOr[String] = js.undefined

  /**
    * <p>A callback for defining the format for <em>nodes</em> in the chart&#39;s
...
object PlotOptionsDependencywheelTooltip {
  /**
    ...
    * @param nodeFormat <p>The. <a href="https://www.highcharts.com/docs/chart-concepts/labels-and-string-formatting">format string</a>. specifying what to show for <em>nodes</em> in tooltip of a diagram. series, as opposed to links.</p>
    * @param nodeFormatter <p>A callback for defining the format for <em>nodes</em> in the chart&#39;s. tooltip, as opposed to links.</p>
    ...
    */
  def apply(followPointer: js.UndefOr[Boolean] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, nodeFormatter: js.UndefOr[js.Any] = js.undefined, pointFormat: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined, clusterFormat: js.UndefOr[js.Any] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, nullFormat: js.UndefOr[String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, pointFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[js.UndefOr[Double]] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined): PlotOptionsDependencywheelTooltip = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelTooltip {
