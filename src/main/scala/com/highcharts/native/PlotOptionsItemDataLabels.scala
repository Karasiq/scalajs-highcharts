...
/**
  * @note JavaScript name: <code>plotOptions-item-dataLabels</code>
  */
class PlotOptionsItemDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemDataLabels {
  /**
