...
/**
  * @note JavaScript name: <code>plotOptions-linearregression</code>
  */
class PlotOptionsLinearregression extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-connectnulls-true/">True</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionConnectors]] = js.undefined
...
object PlotOptionsLinearregression {
  /**
