...
/**
  * @note JavaScript name: <code>plotOptions-bullet-dataLabels</code>
  */
class PlotOptionsBulletDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletDataLabels {
  /**
