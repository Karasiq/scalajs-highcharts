...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-data-accessibility</code>
  */
class SeriesLineDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesLineDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataAccessibility {
