...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dataGrouping</code>
  */
class PlotOptionsTimelineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineDataGrouping {
  /**
