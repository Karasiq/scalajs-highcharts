...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-dataLabels-animation</code>
  */
class SeriesCciDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCciDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciDataLabelsAnimation {
      this.defer = defer
    })
  }
}
