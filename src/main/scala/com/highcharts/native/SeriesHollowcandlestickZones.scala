...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-zones</code>
  */
class SeriesHollowcandlestickZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickZones {
