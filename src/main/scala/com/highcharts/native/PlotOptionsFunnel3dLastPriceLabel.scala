...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-lastPrice-label</code>
  */
class PlotOptionsFunnel3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dLastPriceLabel {
  /**
