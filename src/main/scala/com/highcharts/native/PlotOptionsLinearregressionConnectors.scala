...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-connectors</code>
  */
class PlotOptionsLinearregressionConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionConnectorsStartMarker]] = js.undefined
...
object PlotOptionsLinearregressionConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressionConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionConnectors {
