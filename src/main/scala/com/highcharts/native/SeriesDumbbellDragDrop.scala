...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dragDrop</code>
  */
class SeriesDumbbellDragDrop extends com.highcharts.HighchartsGenericObject {
