...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-dragDrop</code>
  */
class SeriesDumbbellDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataDragDrop {
  /**
