...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-lastPrice-label</code>
  */
class SeriesPsarLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarLastPriceLabel {
  /**
