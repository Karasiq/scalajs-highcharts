...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-lastPrice-label</code>
  */
class PlotOptionsKeltnerchannelsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsLastPriceLabel {
  /**
