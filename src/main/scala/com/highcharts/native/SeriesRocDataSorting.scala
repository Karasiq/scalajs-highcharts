...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-dataSorting</code>
  */
class SeriesRocDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesRocDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocDataSorting {
