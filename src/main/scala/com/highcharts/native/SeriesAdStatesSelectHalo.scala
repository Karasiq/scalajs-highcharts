...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-states-select-halo</code>
  */
class SeriesAdStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAdStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdStatesSelectHalo {
