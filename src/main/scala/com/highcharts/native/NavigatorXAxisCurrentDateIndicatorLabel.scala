...
/**
  * @note JavaScript name: <code>navigator-xAxis-currentDateIndicator-label</code>
  */
class NavigatorXAxisCurrentDateIndicatorLabel extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Format of the label. This options is passed as the fist argument to
    * <a href="/class-reference/Highcharts.Time#dateFormat">dateFormat</a> function.</p>
    */
...
object NavigatorXAxisCurrentDateIndicatorLabel {
  /**
    * @param format <p>Format of the label. This options is passed as the fist argument to. <a href="/class-reference/Highcharts.Time#dateFormat">dateFormat</a> function.</p>
    ...
    */
  def apply(format: js.UndefOr[String] = js.undefined, align: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, text: js.UndefOr[String] = js.undefined, textAlign: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): NavigatorXAxisCurrentDateIndicatorLabel = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisCurrentDateIndicatorLabel {
      this.format = format
      this.align = align
