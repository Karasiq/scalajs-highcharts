...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-dataLabels</code>
  */
class SeriesMappointDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointDataLabels {
  /**
