...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-marker</code>
  */
class SeriesWilliamsrMarker extends com.highcharts.HighchartsGenericObject {
