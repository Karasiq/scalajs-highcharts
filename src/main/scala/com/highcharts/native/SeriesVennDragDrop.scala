...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-dragDrop</code>
  */
class SeriesVennDragDrop extends com.highcharts.HighchartsGenericObject {
