...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dataLabels</code>
  */
class SeriesIkhDataLabels extends com.highcharts.HighchartsGenericObject {
