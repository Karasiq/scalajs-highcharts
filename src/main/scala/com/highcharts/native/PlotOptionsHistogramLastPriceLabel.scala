...
/**
  * @note JavaScript name: <code>plotOptions-histogram-lastPrice-label</code>
  */
class PlotOptionsHistogramLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramLastPriceLabel {
  /**
