...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-dataLabels</code>
  */
class SeriesVennDataLabels extends com.highcharts.HighchartsGenericObject {
