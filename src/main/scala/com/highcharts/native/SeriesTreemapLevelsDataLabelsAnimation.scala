...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-levels-dataLabels-animation</code>
  */
class SeriesTreemapLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTreemapLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
