...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-accessibility</code>
  */
class SeriesStochasticAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesStochasticAccessibilityPoint]] = js.undefined
}

object SeriesStochasticAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesStochasticAccessibilityPoint]] = js.undefined): SeriesStochasticAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticAccessibility {
