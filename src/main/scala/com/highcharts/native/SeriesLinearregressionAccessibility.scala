...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-accessibility</code>
  */
class SeriesLinearregressionAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLinearregressionAccessibilityPoint]] = js.undefined
}

object SeriesLinearregressionAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLinearregressionAccessibilityPoint]] = js.undefined): SeriesLinearregressionAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionAccessibility {
