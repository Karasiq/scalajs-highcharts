...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-states</code>
  */
class SeriesFunnel3dStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesFunnel3dStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dStates {
      this.hover = hover
      this.select = select
