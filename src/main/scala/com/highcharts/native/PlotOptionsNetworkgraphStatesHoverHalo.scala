...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-states-hover-halo</code>
  */
class PlotOptionsNetworkgraphStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphStatesHoverHalo {
