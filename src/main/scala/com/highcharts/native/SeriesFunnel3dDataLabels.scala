...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dataLabels</code>
  */
class SeriesFunnel3dDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataLabels {
  /**
