...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-states-select-halo</code>
  */
class SeriesTrendlineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTrendlineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineStatesSelectHalo {
