...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-zones</code>
  */
class SeriesLinearregressionZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionZones {
