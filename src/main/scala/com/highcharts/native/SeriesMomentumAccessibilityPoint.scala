...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-accessibility-point</code>
  */
class SeriesMomentumAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesMomentumAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumAccessibilityPoint {
