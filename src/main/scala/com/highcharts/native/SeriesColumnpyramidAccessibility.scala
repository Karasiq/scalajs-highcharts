...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-accessibility</code>
  */
class SeriesColumnpyramidAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesColumnpyramidAccessibilityPoint]] = js.undefined
}

object SeriesColumnpyramidAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesColumnpyramidAccessibilityPoint]] = js.undefined): SeriesColumnpyramidAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidAccessibility {
