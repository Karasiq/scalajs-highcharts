...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-dataLabels-animation</code>
  */
class PlotOptionsOhlcDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOhlcDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsOhlcDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcDataLabelsAnimation {
      this.defer = defer
    })
  }
}
