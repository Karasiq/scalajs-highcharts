...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-marker-states-select</code>
  */
class SeriesFunnel3dMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesFunnel3dMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dMarkerStatesSelect {
