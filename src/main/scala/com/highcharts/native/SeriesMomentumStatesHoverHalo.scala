...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-states-hover-halo</code>
  */
class SeriesMomentumStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesMomentumStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumStatesHoverHalo {
