...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-marker-states-select</code>
  */
class SeriesRocMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesRocMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocMarkerStatesSelect {
