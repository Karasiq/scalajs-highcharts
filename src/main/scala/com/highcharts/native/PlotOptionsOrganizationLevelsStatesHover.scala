...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-states-hover</code>
  */
class PlotOptionsOrganizationLevelsStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLevelsStatesHover {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsOrganizationLevelsStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevelsStatesHover {
