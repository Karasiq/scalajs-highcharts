...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data-dataLabels-filter</code>
  */
class SeriesStreamgraphDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesStreamgraphDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataDataLabelsFilter {
