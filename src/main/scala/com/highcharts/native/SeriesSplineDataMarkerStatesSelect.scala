...
/**
  ...
  */
class SeriesSplineDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataMarkerStatesSelect {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesSplineDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataMarkerStatesSelect {
