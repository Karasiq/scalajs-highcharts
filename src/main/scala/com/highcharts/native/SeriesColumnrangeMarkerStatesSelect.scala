...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-marker-states-select</code>
  */
class SeriesColumnrangeMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesColumnrangeMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeMarkerStatesSelect {
