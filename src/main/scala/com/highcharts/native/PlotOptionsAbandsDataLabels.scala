...
/**
  * @note JavaScript name: <code>plotOptions-abands-dataLabels</code>
  */
class PlotOptionsAbandsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsDataLabels {
  /**
