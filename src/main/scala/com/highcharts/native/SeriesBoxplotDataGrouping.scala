...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-dataGrouping</code>
  */
class SeriesBoxplotDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataGrouping {
  /**
