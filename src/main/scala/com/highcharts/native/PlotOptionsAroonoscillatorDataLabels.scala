...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-dataLabels</code>
  */
class PlotOptionsAroonoscillatorDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorDataLabels {
  /**
