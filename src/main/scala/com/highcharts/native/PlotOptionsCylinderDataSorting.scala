...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-dataSorting</code>
  */
class PlotOptionsCylinderDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsCylinderDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderDataSorting {
