...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-states-inactive</code>
  */
class SeriesBulletStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBulletStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletStatesInactive {
