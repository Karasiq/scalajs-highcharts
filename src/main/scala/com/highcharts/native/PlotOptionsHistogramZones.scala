...
/**
  * @note JavaScript name: <code>plotOptions-histogram-zones</code>
  */
class PlotOptionsHistogramZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHistogramZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramZones {
