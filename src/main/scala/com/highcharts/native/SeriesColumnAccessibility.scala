...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-accessibility</code>
  */
class SeriesColumnAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesColumnAccessibilityPoint]] = js.undefined
}

object SeriesColumnAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesColumnAccessibilityPoint]] = js.undefined): SeriesColumnAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnAccessibility {
