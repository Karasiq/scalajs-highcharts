...
/**
  * @note JavaScript name: <code>yAxis-plotLines-events</code>
  */
class YAxisPlotLinesEvents extends com.highcharts.HighchartsGenericObject {
...
object YAxisPlotLinesEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): YAxisPlotLinesEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new YAxisPlotLinesEvents {
      this.click = click
