...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-zones</code>
  */
class SeriesDisparityindexZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDisparityindexZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexZones {
