...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-dragDrop</code>
  */
class SeriesCylinderDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataDragDrop {
  /**
