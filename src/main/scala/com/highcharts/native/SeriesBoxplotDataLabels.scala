...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-dataLabels</code>
  */
class SeriesBoxplotDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataLabels {
  /**
