...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-data-accessibility</code>
  */
class SeriesWaterfallDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesWaterfallDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataAccessibility {
