...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-accessibility</code>
  */
class SeriesDependencywheelAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDependencywheelAccessibilityPoint]] = js.undefined
}

object SeriesDependencywheelAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDependencywheelAccessibilityPoint]] = js.undefined): SeriesDependencywheelAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelAccessibility {
