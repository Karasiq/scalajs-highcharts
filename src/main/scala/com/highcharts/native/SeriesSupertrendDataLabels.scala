...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dataLabels</code>
  */
class SeriesSupertrendDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDataLabels {
  /**
