...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-label</code>
  */
class PlotOptionsDisparityindexLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexLabel {
  /**
