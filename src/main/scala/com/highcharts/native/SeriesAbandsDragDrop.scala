...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dragDrop</code>
  */
class SeriesAbandsDragDrop extends com.highcharts.HighchartsGenericObject {
