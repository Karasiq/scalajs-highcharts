...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dragDrop-dragHandle</code>
  */
class PlotOptionsHeikinashiDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsHeikinashiDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiDragDropDragHandle {
