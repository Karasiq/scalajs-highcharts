...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-data-dataLabels</code>
  */
class SeriesOrganizationDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataDataLabels {
  /**
