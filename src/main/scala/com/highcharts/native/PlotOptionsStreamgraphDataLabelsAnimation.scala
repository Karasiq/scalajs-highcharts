...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-dataLabels-animation</code>
  */
class PlotOptionsStreamgraphDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsStreamgraphDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphDataLabelsAnimation {
      this.defer = defer
    })
  }
}
