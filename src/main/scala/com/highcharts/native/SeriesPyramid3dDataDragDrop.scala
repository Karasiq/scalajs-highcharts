...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-dragDrop</code>
  */
class SeriesPyramid3dDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataDragDrop {
  /**
