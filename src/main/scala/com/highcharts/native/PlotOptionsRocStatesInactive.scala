...
/**
  * @note JavaScript name: <code>plotOptions-roc-states-inactive</code>
  */
class PlotOptionsRocStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsRocStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocStatesInactive {
