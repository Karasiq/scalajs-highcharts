...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-zones</code>
  */
class PlotOptionsPriceenvelopesZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPriceenvelopesZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesZones {
