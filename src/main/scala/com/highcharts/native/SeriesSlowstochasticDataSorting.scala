...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dataSorting</code>
  */
class SeriesSlowstochasticDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesSlowstochasticDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticDataSorting {
