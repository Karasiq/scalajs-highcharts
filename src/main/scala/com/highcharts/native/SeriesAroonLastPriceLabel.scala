...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-lastPrice-label</code>
  */
class SeriesAroonLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonLastPriceLabel {
  /**
