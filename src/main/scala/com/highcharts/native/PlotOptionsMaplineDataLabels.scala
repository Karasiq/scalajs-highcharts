...
/**
  * @note JavaScript name: <code>plotOptions-mapline-dataLabels</code>
  */
class PlotOptionsMaplineDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineDataLabels {
  /**
    ...
    */
  def apply(crop: js.UndefOr[Boolean] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[Boolean] = js.undefined, padding: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined): PlotOptionsMaplineDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineDataLabels {
      this.crop = crop
      this.inside = inside
