...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-levels</code>
  */
class PlotOptionsDependencywheelLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var states: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsStates]] = js.undefined
}

object PlotOptionsDependencywheelLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsDataLabels]] = js.undefined, level: js.UndefOr[Double] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsStates]] = js.undefined): PlotOptionsDependencywheelLevels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelLevels {
