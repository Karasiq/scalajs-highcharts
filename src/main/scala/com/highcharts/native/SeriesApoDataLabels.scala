...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-dataLabels</code>
  */
class SeriesApoDataLabels extends com.highcharts.HighchartsGenericObject {
