...
/**
  * @note JavaScript name: <code>plotOptions-variwide-dataLabels-animation</code>
  */
class PlotOptionsVariwideDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVariwideDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideDataLabelsAnimation {
      this.defer = defer
    })
  }
}
