...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-data-dataLabels</code>
  */
class SeriesSolidgaugeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeDataDataLabels {
  /**
