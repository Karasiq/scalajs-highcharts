...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-accessibility-point</code>
  */
class PlotOptionsCylinderAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): PlotOptionsCylinderAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderAccessibilityPoint {
