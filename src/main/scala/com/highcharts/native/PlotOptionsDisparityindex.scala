...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex</code>
  */
class PlotOptionsDisparityindex extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-connectnulls-true/">True</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexConnectors]] = js.undefined
...
object PlotOptionsDisparityindex {
  /**
