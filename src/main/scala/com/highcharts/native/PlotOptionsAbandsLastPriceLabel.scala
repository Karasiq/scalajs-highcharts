...
/**
  * @note JavaScript name: <code>plotOptions-abands-lastPrice-label</code>
  */
class PlotOptionsAbandsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsLastPriceLabel {
  /**
