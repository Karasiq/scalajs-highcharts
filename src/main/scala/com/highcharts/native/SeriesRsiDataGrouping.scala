...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-dataGrouping</code>
  */
class SeriesRsiDataGrouping extends com.highcharts.HighchartsGenericObject {
