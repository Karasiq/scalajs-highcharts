...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-data-dataLabels-animation</code>
  */
class SeriesBoxplotDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBoxplotDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
