...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-dataLabels</code>
  */
class SeriesHollowcandlestickDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataLabels {
  /**
