...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-nodes-dataLabels-filter</code>
  */
class SeriesOrganizationNodesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationNodesDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOrganizationNodesDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationNodesDataLabelsFilter {
