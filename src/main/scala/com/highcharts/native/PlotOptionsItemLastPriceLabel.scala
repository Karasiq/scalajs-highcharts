...
/**
  * @note JavaScript name: <code>plotOptions-item-lastPrice-label</code>
  */
class PlotOptionsItemLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemLastPriceLabel {
  /**
