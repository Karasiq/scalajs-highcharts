...
/**
  ...
  */
class SeriesSolidgaugeData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The inner radius of an individual point in a solid gauge. Can be given as a
    * number (pixels) or percentage string.</p>
  ...
  /**
    * <p>The outer radius of an individual point in a solid gauge. Can be
    * given as a number (pixels) or percentage string.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/solidgauge-radius/">Individual radius and innerRadius</a>
    * @since 4.1.6
    */
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = js.undefined

  /**
    * <p>The individual point events.</p>
    */
  var events: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataEvents]] = js.undefined
...
object SeriesSolidgaugeData {
  /**
    * @param innerRadius <p>The inner radius of an individual point in a solid gauge. Can be given as a. number (pixels) or percentage string.</p>
    * @param radius <p>The outer radius of an individual point in a solid gauge. Can be. given as a number (pixels) or percentage string.</p>
    ...
    */
  def apply(innerRadius: js.UndefOr[Double | String] = js.undefined, radius: js.UndefOr[Double | String] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataDragDrop]] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesSolidgaugeDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined): SeriesSolidgaugeData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeData {
