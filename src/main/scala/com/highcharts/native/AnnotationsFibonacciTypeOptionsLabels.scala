...
/**
  * @note JavaScript name: <code>annotations-fibonacci-typeOptions-labels</code>
  */
class AnnotationsFibonacciTypeOptionsLabels extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsFibonacciTypeOptionsLabels {
  /**
