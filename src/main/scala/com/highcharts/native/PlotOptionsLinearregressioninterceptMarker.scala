...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-marker</code>
  */
class PlotOptionsLinearregressioninterceptMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptMarker {
  /**
