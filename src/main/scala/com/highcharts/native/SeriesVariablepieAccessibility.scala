...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-accessibility</code>
  */
class SeriesVariablepieAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVariablepieAccessibilityPoint]] = js.undefined
}

object SeriesVariablepieAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVariablepieAccessibilityPoint]] = js.undefined): SeriesVariablepieAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieAccessibility {
