...
/**
  * @note JavaScript name: <code>plotOptions-dmi-dataSorting</code>
  */
class PlotOptionsDmiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsDmiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiDataSorting {
