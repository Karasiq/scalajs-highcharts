...
class SeriesErrorbarStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesErrorbarStatesSelect]] = js.undefined
}
...
object SeriesErrorbarStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesErrorbarStatesSelect]] = js.undefined): SeriesErrorbarStates = {
