...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-dataLabels</code>
  */
class SeriesPivotpointsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsDataLabels {
  /**
