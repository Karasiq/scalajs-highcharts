...
/**
  * @note JavaScript name: <code>plotOptions-vbp-dataSorting</code>
  */
class PlotOptionsVbpDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsVbpDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpDataSorting {
