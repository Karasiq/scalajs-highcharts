...
/**
  * @note JavaScript name: <code>plotOptions-apo-accessibility</code>
  */
class PlotOptionsApoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsApoAccessibilityPoint]] = js.undefined
}

object PlotOptionsApoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsApoAccessibilityPoint]] = js.undefined): PlotOptionsApoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoAccessibility {
