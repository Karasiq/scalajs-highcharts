...
/**
  * @note JavaScript name: <code>plotOptions-dmi-lastPrice-label</code>
  */
class PlotOptionsDmiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiLastPriceLabel {
  /**
