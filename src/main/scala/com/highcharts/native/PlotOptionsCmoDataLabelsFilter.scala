...
/**
  * @note JavaScript name: <code>plotOptions-cmo-dataLabels-filter</code>
  */
class PlotOptionsCmoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCmoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoDataLabelsFilter {
