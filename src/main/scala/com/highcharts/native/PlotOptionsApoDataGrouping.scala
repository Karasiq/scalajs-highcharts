...
/**
  * @note JavaScript name: <code>plotOptions-apo-dataGrouping</code>
  */
class PlotOptionsApoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoDataGrouping {
  /**
