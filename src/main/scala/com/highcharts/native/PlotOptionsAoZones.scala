...
/**
  * @note JavaScript name: <code>plotOptions-ao-zones</code>
  */
class PlotOptionsAoZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoZones {
