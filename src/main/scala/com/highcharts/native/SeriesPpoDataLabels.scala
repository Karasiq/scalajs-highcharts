...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-dataLabels</code>
  */
class SeriesPpoDataLabels extends com.highcharts.HighchartsGenericObject {
