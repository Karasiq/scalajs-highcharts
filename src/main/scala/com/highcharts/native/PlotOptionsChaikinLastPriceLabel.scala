...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-lastPrice-label</code>
  */
class PlotOptionsChaikinLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinLastPriceLabel {
  /**
