...
/**
  * @note JavaScript name: <code>plotOptions-macd-accessibility</code>
  */
class PlotOptionsMacdAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMacdAccessibilityPoint]] = js.undefined
}

object PlotOptionsMacdAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMacdAccessibilityPoint]] = js.undefined): PlotOptionsMacdAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdAccessibility {
