...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-data-accessibility</code>
  */
class SeriesGanttDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesGanttDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataAccessibility {
