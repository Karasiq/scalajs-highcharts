...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-dataLabels-filter</code>
  */
class PlotOptionsAroonoscillatorDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAroonoscillatorDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorDataLabelsFilter {
