...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-marker</code>
  */
class PlotOptionsWilliamsrMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrMarker {
  /**
