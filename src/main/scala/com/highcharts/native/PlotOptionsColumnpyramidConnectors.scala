...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-connectors</code>
  */
class PlotOptionsColumnpyramidConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidConnectorsStartMarker]] = js.undefined
...
object PlotOptionsColumnpyramidConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnpyramidConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidConnectors {
