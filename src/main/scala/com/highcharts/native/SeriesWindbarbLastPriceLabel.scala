...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-lastPrice-label</code>
  */
class SeriesWindbarbLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbLastPriceLabel {
  /**
