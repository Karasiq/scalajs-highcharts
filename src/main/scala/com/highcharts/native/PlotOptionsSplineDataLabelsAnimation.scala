...
/**
  * @note JavaScript name: <code>plotOptions-spline-dataLabels-animation</code>
  */
class PlotOptionsSplineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSplineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
