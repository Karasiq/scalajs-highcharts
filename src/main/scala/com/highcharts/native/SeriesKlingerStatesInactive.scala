...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-states-inactive</code>
  */
class SeriesKlingerStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesKlingerStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerStatesInactive {
