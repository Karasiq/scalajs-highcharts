...
/**
  * @note JavaScript name: <code>plotOptions-aroon-accessibility</code>
  */
class PlotOptionsAroonAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAroonAccessibilityPoint]] = js.undefined
}

object PlotOptionsAroonAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAroonAccessibilityPoint]] = js.undefined): PlotOptionsAroonAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonAccessibility {
