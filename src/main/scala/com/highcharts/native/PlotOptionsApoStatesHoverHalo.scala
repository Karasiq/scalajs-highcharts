...
/**
  * @note JavaScript name: <code>plotOptions-apo-states-hover-halo</code>
  */
class PlotOptionsApoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsApoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoStatesHoverHalo {
