...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-label</code>
  */
class PlotOptionsPyramid3dLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dLabel {
  /**
