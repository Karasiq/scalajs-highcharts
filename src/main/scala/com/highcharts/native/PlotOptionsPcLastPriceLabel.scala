...
/**
  * @note JavaScript name: <code>plotOptions-pc-lastPrice-label</code>
  */
class PlotOptionsPcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcLastPriceLabel {
  /**
