...
/**
  * @note JavaScript name: <code>plotOptions-aroon-states-select-halo</code>
  */
class PlotOptionsAroonStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAroonStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonStatesSelectHalo {
