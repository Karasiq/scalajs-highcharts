...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesCylinderDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesCylinderDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataDragDropDragHandle {
