...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-states-select-halo</code>
  */
class SeriesDisparityindexStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDisparityindexStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexStatesSelectHalo {
