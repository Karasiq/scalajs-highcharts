...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-marker-states</code>
  */
class PlotOptionsMappointMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMappointMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
