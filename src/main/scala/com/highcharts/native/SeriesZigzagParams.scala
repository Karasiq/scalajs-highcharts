...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-params</code>
  */
class SeriesZigzagParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagParams {
  /**
    ...
    */
  def apply(deviation: js.UndefOr[Double] = js.undefined, highIndex: js.UndefOr[Double] = js.undefined, lowIndex: js.UndefOr[Double] = js.undefined): SeriesZigzagParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagParams {
