...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-dataGrouping</code>
  */
class PlotOptionsPyramidDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramidDataGrouping {
  /**
