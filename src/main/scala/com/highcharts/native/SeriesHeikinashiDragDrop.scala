...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dragDrop</code>
  */
class SeriesHeikinashiDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDragDrop {
  /**
