...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-dataLabels</code>
  */
class SeriesRocDataLabels extends com.highcharts.HighchartsGenericObject {
