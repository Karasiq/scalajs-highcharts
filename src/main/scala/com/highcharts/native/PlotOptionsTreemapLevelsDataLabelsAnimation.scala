...
/**
  * @note JavaScript name: <code>plotOptions-treemap-levels-dataLabels-animation</code>
  */
class PlotOptionsTreemapLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
