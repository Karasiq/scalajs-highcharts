...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-marker-states-select</code>
  */
class SeriesAdMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAdMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdMarkerStatesSelect {
