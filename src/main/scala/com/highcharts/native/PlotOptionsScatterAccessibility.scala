...
/**
  * @note JavaScript name: <code>plotOptions-scatter-accessibility</code>
  */
class PlotOptionsScatterAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsScatterAccessibilityPoint]] = js.undefined
}

object PlotOptionsScatterAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsScatterAccessibilityPoint]] = js.undefined): PlotOptionsScatterAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterAccessibility {
