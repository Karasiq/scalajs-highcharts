...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-dataLabels-filter</code>
  */
class SeriesBulletDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBulletDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletDataLabelsFilter {
