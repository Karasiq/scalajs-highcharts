...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-zones</code>
  */
class SeriesDumbbellZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDumbbellZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellZones {
