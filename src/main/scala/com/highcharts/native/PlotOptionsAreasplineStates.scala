...
class PlotOptionsAreasplineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAreasplineStatesSelect]] = js.undefined
}
...
object PlotOptionsAreasplineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAreasplineStatesSelect]] = js.undefined): PlotOptionsAreasplineStates = {
