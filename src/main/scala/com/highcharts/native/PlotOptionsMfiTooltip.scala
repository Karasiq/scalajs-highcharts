...
/**
  * @note JavaScript name: <code>plotOptions-mfi-tooltip</code>
  */
class PlotOptionsMfiTooltip extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiTooltip {
  /**
    ...
    */
  def apply(valueDecimals: js.UndefOr[Double] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined, clusterFormat: js.UndefOr[js.Any] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, distance: js.UndefOr[Double] = js.undefined, followPointer: js.UndefOr[Boolean] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, nullFormat: js.UndefOr[String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, pointFormat: js.UndefOr[String] = js.undefined, pointFormatter: js.UndefOr[js.Any] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined): PlotOptionsMfiTooltip = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiTooltip {
