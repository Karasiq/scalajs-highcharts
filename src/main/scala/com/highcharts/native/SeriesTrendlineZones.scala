...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-zones</code>
  */
class SeriesTrendlineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTrendlineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineZones {
