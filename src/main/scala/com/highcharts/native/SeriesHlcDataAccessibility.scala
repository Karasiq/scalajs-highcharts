...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-data-accessibility</code>
  */
class SeriesHlcDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHlcDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataAccessibility {
