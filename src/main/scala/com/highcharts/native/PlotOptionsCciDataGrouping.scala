...
/**
  * @note JavaScript name: <code>plotOptions-cci-dataGrouping</code>
  */
class PlotOptionsCciDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciDataGrouping {
  /**
