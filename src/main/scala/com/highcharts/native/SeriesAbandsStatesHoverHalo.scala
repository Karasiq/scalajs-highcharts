...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-states-hover-halo</code>
  */
class SeriesAbandsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAbandsStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsStatesHoverHalo {
