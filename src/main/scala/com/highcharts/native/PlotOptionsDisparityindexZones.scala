...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-zones</code>
  */
class PlotOptionsDisparityindexZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDisparityindexZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexZones {
