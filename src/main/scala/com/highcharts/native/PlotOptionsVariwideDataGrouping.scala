...
/**
  * @note JavaScript name: <code>plotOptions-variwide-dataGrouping</code>
  */
class PlotOptionsVariwideDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideDataGrouping {
  /**
