...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-data-dragDrop</code>
  */
class SeriesVennDataDragDrop extends com.highcharts.HighchartsGenericObject {
