...
/**
  * @note JavaScript name: <code>plotOptions-vwap-states-inactive</code>
  */
class PlotOptionsVwapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsVwapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapStatesInactive {
