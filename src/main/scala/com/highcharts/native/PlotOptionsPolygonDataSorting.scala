...
/**
  * @note JavaScript name: <code>plotOptions-polygon-dataSorting</code>
  */
class PlotOptionsPolygonDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPolygonDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonDataSorting {
