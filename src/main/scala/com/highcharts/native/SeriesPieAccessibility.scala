...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-accessibility</code>
  */
class SeriesPieAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPieAccessibilityPoint]] = js.undefined
}

object SeriesPieAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPieAccessibilityPoint]] = js.undefined): SeriesPieAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieAccessibility {
