...
/**
  * @note JavaScript name: <code>plotOptions-ad-accessibility</code>
  */
class PlotOptionsAdAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAdAccessibilityPoint]] = js.undefined
}

object PlotOptionsAdAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAdAccessibilityPoint]] = js.undefined): PlotOptionsAdAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdAccessibility {
