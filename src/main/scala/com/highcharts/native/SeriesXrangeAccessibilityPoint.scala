...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-accessibility-point</code>
  */
class SeriesXrangeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesXrangeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeAccessibilityPoint {
