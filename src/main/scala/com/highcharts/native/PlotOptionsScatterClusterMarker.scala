...
/**
  * @note JavaScript name: <code>plotOptions-scatter-cluster-marker</code>
  */
class PlotOptionsScatterClusterMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterClusterMarker {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsScatterClusterMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterClusterMarker {
