...
/**
  * @note JavaScript name: <code>plotOptions-dema-dataLabels</code>
  */
class PlotOptionsDemaDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaDataLabels {
  /**
