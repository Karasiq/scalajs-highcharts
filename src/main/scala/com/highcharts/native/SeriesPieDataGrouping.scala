...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-dataGrouping</code>
  */
class SeriesPieDataGrouping extends com.highcharts.HighchartsGenericObject {
