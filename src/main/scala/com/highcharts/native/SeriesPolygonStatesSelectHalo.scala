...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-states-select-halo</code>
  */
class SeriesPolygonStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPolygonStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonStatesSelectHalo {
