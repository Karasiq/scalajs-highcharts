...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dataLabels-filter</code>
  */
class SeriesDisparityindexDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDisparityindexDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexDataLabelsFilter {
