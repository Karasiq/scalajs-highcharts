...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-accessibility</code>
  */
class SeriesOhlcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesOhlcAccessibilityPoint]] = js.undefined
}

object SeriesOhlcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesOhlcAccessibilityPoint]] = js.undefined): SeriesOhlcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcAccessibility {
