...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-label</code>
  */
class PlotOptionsHeikinashiLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiLabel {
  /**
