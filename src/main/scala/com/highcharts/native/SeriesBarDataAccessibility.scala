...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-data-accessibility</code>
  */
class SeriesBarDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBarDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataAccessibility {
