...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesHeikinashiDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesHeikinashiDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataDragDropDragHandle {
