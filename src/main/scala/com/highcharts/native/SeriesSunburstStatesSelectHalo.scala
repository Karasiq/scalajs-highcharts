...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-states-select-halo</code>
  */
class SeriesSunburstStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSunburstStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstStatesSelectHalo {
