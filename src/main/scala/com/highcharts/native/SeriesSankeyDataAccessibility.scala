...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-data-accessibility</code>
  */
class SeriesSankeyDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSankeyDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataAccessibility {
