...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-states-hover-halo</code>
  */
class SeriesWaterfallStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWaterfallStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesHoverHalo {
