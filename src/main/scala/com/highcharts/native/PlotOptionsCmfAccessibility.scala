...
/**
  * @note JavaScript name: <code>plotOptions-cmf-accessibility</code>
  */
class PlotOptionsCmfAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsCmfAccessibilityPoint]] = js.undefined
}

object PlotOptionsCmfAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCmfAccessibilityPoint]] = js.undefined): PlotOptionsCmfAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfAccessibility {
