...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-lastPrice-label</code>
  */
class SeriesStreamgraphLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphLastPriceLabel {
  /**
