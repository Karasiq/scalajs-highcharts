...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-marker-states-select</code>
  */
class SeriesLinearregressionslopeMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeMarkerStatesSelect {
