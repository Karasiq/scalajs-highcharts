...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dataLabels-animation</code>
  */
class PlotOptionsLollipopDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopDataLabelsAnimation {
      this.defer = defer
    })
  }
}
