...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-connectors</code>
  */
class SeriesDisparityindexConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesDisparityindexConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesDisparityindexConnectorsStartMarker]] = js.undefined
...
object SeriesDisparityindexConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesDisparityindexConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesDisparityindexConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesDisparityindexConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexConnectors {
