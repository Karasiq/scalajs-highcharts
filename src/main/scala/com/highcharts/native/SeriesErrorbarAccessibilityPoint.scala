...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-accessibility-point</code>
  */
class SeriesErrorbarAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesErrorbarAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarAccessibilityPoint {
