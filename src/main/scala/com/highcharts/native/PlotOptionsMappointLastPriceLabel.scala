...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-lastPrice-label</code>
  */
class PlotOptionsMappointLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointLastPriceLabel {
  /**
