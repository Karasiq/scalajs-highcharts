...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-cluster-zones</code>
  */
class SeriesVectorClusterZones extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesVectorClusterZonesMarker]] = js.undefined
...
object SeriesVectorClusterZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, from: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesVectorClusterZonesMarker]] = js.undefined, to: js.UndefOr[Double] = js.undefined): SeriesVectorClusterZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorClusterZones {
