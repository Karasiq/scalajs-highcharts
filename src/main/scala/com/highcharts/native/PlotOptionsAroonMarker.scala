...
/**
  * @note JavaScript name: <code>plotOptions-aroon-marker</code>
  */
class PlotOptionsAroonMarker extends com.highcharts.HighchartsGenericObject {
