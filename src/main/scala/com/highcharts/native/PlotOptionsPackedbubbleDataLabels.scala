...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-dataLabels</code>
  */
class PlotOptionsPackedbubbleDataLabels extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-format/">Formatted value in the data label</a>
  ...
  var parentNodeFormatter: js.Any = js.undefined

  var parentNodeTextPath: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/color-axis/">Bold labels</a>
  ...
  /**
    * <p>Options for a <em>node</em> label text which should follow marker&#39;s
    * shape.</p>
    * <p><strong>Note:</strong> Only SVG-based renderer supports this option.</p>
    * @since 7.1.0
    */
...
object PlotOptionsPackedbubbleDataLabels {
  /**
    ...
    * @param textPath <p>Options for a <em>node</em> label text which should follow marker&#39;s. shape.</p>. <p><strong>Note:</strong> Only SVG-based renderer supports this option.</p>
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, parentNodeFormat: js.UndefOr[String] = js.undefined, parentNodeFormatter: js.UndefOr[js.Any] = js.undefined, parentNodeTextPath: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleDataLabels {
