...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-lastPrice-label</code>
  */
class SeriesLinearregressionangleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleLastPriceLabel {
  /**
