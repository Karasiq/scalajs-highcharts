...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-zones</code>
  */
class SeriesVbpZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVbpZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpZones {
