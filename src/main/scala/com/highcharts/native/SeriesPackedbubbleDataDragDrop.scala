...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data-dragDrop</code>
  */
class SeriesPackedbubbleDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataDragDrop {
  /**
