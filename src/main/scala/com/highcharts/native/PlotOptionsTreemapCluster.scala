...
/**
  * @note JavaScript name: <code>plotOptions-treemap-cluster</code>
  */
class PlotOptionsTreemapCluster extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapCluster {
  /**
