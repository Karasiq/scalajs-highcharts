...
/**
  * @note JavaScript name: <code>plotOptions-venn-states-hover</code>
  */
class PlotOptionsVennStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[PlotOptionsVennStatesHoverMarker]] = js.undefined
}

object PlotOptionsVennStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsVennStatesHoverMarker]] = js.undefined): PlotOptionsVennStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennStatesHover {
