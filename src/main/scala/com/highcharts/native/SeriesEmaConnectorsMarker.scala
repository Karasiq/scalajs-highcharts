...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-connectors-marker</code>
  */
class SeriesEmaConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesEmaConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaConnectorsMarker {
      this.align = align
      this.color = color
