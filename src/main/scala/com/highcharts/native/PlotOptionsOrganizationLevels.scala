...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels</code>
  */
class PlotOptionsOrganizationLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var states: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsStates]] = js.undefined
}

object PlotOptionsOrganizationLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsDataLabels]] = js.undefined, level: js.UndefOr[Double] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsStates]] = js.undefined): PlotOptionsOrganizationLevels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevels {
