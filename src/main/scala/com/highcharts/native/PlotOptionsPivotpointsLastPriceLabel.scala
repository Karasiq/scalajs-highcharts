...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-lastPrice-label</code>
  */
class PlotOptionsPivotpointsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsLastPriceLabel {
  /**
