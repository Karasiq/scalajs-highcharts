...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-connectors</code>
  */
class SeriesSolidgaugeConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesSolidgaugeConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesSolidgaugeConnectorsStartMarker]] = js.undefined
...
object SeriesSolidgaugeConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesSolidgaugeConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesSolidgaugeConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesSolidgaugeConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeConnectors {
