...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-states-hover-halo</code>
  */
class SeriesVwapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesVwapStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapStatesHoverHalo {
