...
/**
  * @note JavaScript name: <code>plotOptions-ad-dataLabels-animation</code>
  */
class PlotOptionsAdDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAdDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdDataLabelsAnimation {
      this.defer = defer
    })
  }
}
