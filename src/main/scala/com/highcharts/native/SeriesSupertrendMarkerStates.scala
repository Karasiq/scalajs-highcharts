...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-marker-states</code>
  */
class SeriesSupertrendMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSupertrendMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
