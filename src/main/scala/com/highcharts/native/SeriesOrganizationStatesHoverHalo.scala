...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-states-hover-halo</code>
  */
class SeriesOrganizationStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesOrganizationStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationStatesHoverHalo {
