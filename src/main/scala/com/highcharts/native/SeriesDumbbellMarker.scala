...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-marker</code>
  */
class SeriesDumbbellMarker extends com.highcharts.HighchartsGenericObject {
