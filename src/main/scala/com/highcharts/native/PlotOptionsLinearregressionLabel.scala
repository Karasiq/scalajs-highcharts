...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-label</code>
  */
class PlotOptionsLinearregressionLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionLabel {
  /**
