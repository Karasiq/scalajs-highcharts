...
/**
  * @note JavaScript name: <code>plotOptions-dema-states-hover-halo</code>
  */
class PlotOptionsDemaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDemaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaStatesHoverHalo {
