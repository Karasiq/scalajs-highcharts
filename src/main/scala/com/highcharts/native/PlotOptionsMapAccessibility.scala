...
/**
  * @note JavaScript name: <code>plotOptions-map-accessibility</code>
  */
class PlotOptionsMapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMapAccessibilityPoint]] = js.undefined
}

object PlotOptionsMapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMapAccessibilityPoint]] = js.undefined): PlotOptionsMapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapAccessibility {
