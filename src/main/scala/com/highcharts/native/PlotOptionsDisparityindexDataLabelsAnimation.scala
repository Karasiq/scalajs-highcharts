...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-dataLabels-animation</code>
  */
class PlotOptionsDisparityindexDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDisparityindexDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexDataLabelsAnimation {
      this.defer = defer
    })
  }
}
