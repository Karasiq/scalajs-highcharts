...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-lastPrice-label</code>
  */
class SeriesColumnrangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeLastPriceLabel {
  /**
