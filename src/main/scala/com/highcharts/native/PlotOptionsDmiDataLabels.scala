...
/**
  * @note JavaScript name: <code>plotOptions-dmi-dataLabels</code>
  */
class PlotOptionsDmiDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiDataLabels {
  /**
