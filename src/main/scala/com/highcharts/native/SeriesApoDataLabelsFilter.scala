...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-dataLabels-filter</code>
  */
class SeriesApoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesApoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoDataLabelsFilter {
