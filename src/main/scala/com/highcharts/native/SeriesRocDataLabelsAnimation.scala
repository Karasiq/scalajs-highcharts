...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-dataLabels-animation</code>
  */
class SeriesRocDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesRocDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocDataLabelsAnimation {
      this.defer = defer
    })
  }
}
