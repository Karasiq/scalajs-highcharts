...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-dataLabels-animation</code>
  */
class PlotOptionsStochasticDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsStochasticDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticDataLabelsAnimation {
      this.defer = defer
    })
  }
}
