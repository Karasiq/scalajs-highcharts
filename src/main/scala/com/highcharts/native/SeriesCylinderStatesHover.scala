...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-states-hover</code>
  */
class SeriesCylinderStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 7.0.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesCylinderStatesHoverMarker]] = js.undefined
}

object SeriesCylinderStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesCylinderStatesHoverMarker]] = js.undefined): SeriesCylinderStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderStatesHover {
