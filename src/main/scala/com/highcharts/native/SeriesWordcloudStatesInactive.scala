...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-states-inactive</code>
  */
class SeriesWordcloudStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesWordcloudStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudStatesInactive {
