...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-states</code>
  */
class SeriesLinearregressioninterceptStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptStatesSelect]] = js.undefined
}

object SeriesLinearregressioninterceptStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptStatesSelect]] = js.undefined): SeriesLinearregressioninterceptStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptStates {
      this.hover = hover
