...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-lastPrice-label</code>
  */
class SeriesOrganizationLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLastPriceLabel {
  /**
