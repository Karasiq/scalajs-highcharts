...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesItemDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesItemDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataDragDropDragHandle {
