...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-states-hover-halo</code>
  */
class SeriesNatrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesNatrStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrStatesHoverHalo {
