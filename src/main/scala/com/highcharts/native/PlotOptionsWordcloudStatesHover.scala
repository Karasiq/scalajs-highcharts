...
/**
  * @note JavaScript name: <code>plotOptions-wordcloud-states-hover</code>
  */
class PlotOptionsWordcloudStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWordcloudStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsWordcloudStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWordcloudStatesHover {
