...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-label</code>
  */
class SeriesDisparityindexLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexLabel {
  /**
