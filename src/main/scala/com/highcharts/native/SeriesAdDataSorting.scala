...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-dataSorting</code>
  */
class SeriesAdDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAdDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdDataSorting {
