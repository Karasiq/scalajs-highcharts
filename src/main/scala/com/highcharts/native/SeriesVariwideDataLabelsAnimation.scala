...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-dataLabels-animation</code>
  */
class SeriesVariwideDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVariwideDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataLabelsAnimation {
      this.defer = defer
    })
  }
}
