...
/**
  * @note JavaScript name: <code>plotOptions-macd-signalLine-zones</code>
  */
class PlotOptionsMacdSignalLineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdSignalLineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMacdSignalLineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdSignalLineZones {
