...
/**
  ...
  */
class SeriesAreaData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesAreaDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesAreaDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesAreaDataEvents]] = js.undefined
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[SeriesAreaDataMarker]] = js.undefined
...
object SeriesAreaData {
  /**
    ...
    */
  def apply(accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesAreaDataDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesAreaDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesAreaDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesAreaDataMarker]] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined): SeriesAreaData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaData {
