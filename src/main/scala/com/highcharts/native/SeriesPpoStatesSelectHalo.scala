...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-states-select-halo</code>
  */
class SeriesPpoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPpoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoStatesSelectHalo {
