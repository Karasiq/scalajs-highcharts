...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-accessibility</code>
  */
class PlotOptionsPriceenvelopesAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPriceenvelopesAccessibilityPoint]] = js.undefined
}

object PlotOptionsPriceenvelopesAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPriceenvelopesAccessibilityPoint]] = js.undefined): PlotOptionsPriceenvelopesAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesAccessibility {
