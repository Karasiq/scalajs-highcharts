...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-dataLabels-animation</code>
  */
class SeriesVennDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVennDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennDataLabelsAnimation {
      this.defer = defer
    })
  }
}
