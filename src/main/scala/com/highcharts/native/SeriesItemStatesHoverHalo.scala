...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-states-hover-halo</code>
  */
class SeriesItemStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesItemStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemStatesHoverHalo {
