...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-marker-states</code>
  */
class SeriesParetoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesParetoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
