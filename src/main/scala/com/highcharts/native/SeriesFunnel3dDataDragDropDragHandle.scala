...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesFunnel3dDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataDragDropDragHandle {
