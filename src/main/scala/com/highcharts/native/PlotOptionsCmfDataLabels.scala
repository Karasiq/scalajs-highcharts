...
/**
  * @note JavaScript name: <code>plotOptions-cmf-dataLabels</code>
  */
class PlotOptionsCmfDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfDataLabels {
  /**
