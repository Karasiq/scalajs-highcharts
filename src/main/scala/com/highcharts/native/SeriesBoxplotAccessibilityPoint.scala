...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-accessibility-point</code>
  */
class SeriesBoxplotAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesBoxplotAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotAccessibilityPoint {
