...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dataLabels</code>
  */
class SeriesHlcDataLabels extends com.highcharts.HighchartsGenericObject {
