...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dragDrop</code>
  */
class PlotOptionsColumnpyramidDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDragDrop {
  /**
