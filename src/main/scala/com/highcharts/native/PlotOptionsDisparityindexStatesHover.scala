...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-states-hover</code>
  */
class PlotOptionsDisparityindexStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 9.1.0
    */
  var marker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexStatesHoverMarker]] = js.undefined
}

object PlotOptionsDisparityindexStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsDisparityindexStatesHoverMarker]] = js.undefined): PlotOptionsDisparityindexStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexStatesHover {
