...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-marker-states</code>
  */
class SeriesOhlcMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesOhlcMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
