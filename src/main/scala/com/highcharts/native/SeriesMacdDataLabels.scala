...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-dataLabels</code>
  */
class SeriesMacdDataLabels extends com.highcharts.HighchartsGenericObject {
