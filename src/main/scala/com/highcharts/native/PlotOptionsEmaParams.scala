...
/**
  * @note JavaScript name: <code>plotOptions-ema-params</code>
  */
class PlotOptionsEmaParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsEmaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaParams {
      this.index = index
      this.period = period
    })
  }
