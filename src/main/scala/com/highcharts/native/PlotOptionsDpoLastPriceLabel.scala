...
/**
  * @note JavaScript name: <code>plotOptions-dpo-lastPrice-label</code>
  */
class PlotOptionsDpoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoLastPriceLabel {
  /**
