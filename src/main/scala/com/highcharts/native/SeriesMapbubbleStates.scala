...
/**
  ...
  */
class SeriesMapbubbleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesMapbubbleStatesSelect]] = js.undefined
}
...
object SeriesMapbubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesMapbubbleStatesSelect]] = js.undefined): SeriesMapbubbleStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleStates {
      this.hover = hover
