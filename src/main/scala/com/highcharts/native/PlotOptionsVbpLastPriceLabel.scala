...
/**
  * @note JavaScript name: <code>plotOptions-vbp-lastPrice-label</code>
  */
class PlotOptionsVbpLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpLastPriceLabel {
  /**
