...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-marker-states</code>
  */
class SeriesItemMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesItemMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
