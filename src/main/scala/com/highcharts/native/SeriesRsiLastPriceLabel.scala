...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-lastPrice-label</code>
  */
class SeriesRsiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiLastPriceLabel {
  /**
