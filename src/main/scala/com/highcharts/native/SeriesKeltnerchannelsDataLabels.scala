...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dataLabels</code>
  */
class SeriesKeltnerchannelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDataLabels {
  /**
