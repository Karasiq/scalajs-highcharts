...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-accessibility-point</code>
  */
class SeriesAtrAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAtrAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrAccessibilityPoint {
