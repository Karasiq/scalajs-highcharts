...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-marker-states</code>
  */
class SeriesPyramid3dMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPyramid3dMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
