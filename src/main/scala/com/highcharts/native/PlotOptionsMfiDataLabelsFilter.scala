...
/**
  * @note JavaScript name: <code>plotOptions-mfi-dataLabels-filter</code>
  */
class PlotOptionsMfiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMfiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiDataLabelsFilter {
