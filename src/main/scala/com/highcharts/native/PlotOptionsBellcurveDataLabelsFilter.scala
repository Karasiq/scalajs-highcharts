...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dataLabels-filter</code>
  */
class PlotOptionsBellcurveDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBellcurveDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveDataLabelsFilter {
