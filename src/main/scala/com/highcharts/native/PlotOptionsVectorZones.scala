...
/**
  * @note JavaScript name: <code>plotOptions-vector-zones</code>
  */
class PlotOptionsVectorZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVectorZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorZones {
