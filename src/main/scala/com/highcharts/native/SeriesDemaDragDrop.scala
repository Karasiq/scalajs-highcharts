...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dragDrop</code>
  */
class SeriesDemaDragDrop extends com.highcharts.HighchartsGenericObject {
