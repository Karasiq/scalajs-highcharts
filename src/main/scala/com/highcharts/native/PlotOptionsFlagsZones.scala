...
/**
  * @note JavaScript name: <code>plotOptions-flags-zones</code>
  */
class PlotOptionsFlagsZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsZones {
