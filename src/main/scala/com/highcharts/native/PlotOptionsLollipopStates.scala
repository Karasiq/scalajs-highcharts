...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-states</code>
  */
class PlotOptionsLollipopStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsLollipopStatesSelect]] = js.undefined
}

object PlotOptionsLollipopStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsLollipopStatesSelect]] = js.undefined): PlotOptionsLollipopStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopStates {
      this.hover = hover
