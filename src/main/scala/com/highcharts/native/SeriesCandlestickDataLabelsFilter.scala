...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-dataLabels-filter</code>
  */
class SeriesCandlestickDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCandlestickDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataLabelsFilter {
