...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-events</code>
  */
class SeriesItemEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined): SeriesItemEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemEvents {
