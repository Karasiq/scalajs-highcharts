...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-dataSorting</code>
  */
class SeriesBarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesBarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataSorting {
