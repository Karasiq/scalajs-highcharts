...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-data-dataLabels-filter</code>
  */
class SeriesOrganizationDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOrganizationDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationDataDataLabelsFilter {
