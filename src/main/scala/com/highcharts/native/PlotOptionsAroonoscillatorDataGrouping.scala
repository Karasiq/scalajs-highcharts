...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-dataGrouping</code>
  */
class PlotOptionsAroonoscillatorDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String] = js.undefined, anchor: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): PlotOptionsAroonoscillatorDataGrouping = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorDataGrouping {
