...
/**
  * @note JavaScript name: <code>navigator-xAxis-plotLines-label</code>
  */
class NavigatorXAxisPlotLinesLabel extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisPlotLinesLabel {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, text: js.UndefOr[String] = js.undefined, textAlign: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): NavigatorXAxisPlotLinesLabel = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisPlotLinesLabel {
      this.align = align
