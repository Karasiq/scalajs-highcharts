...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-point-events</code>
  */
class PlotOptionsNetworkgraphPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsNetworkgraphPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphPointEvents {
      this.click = click
      this.drag = drag
