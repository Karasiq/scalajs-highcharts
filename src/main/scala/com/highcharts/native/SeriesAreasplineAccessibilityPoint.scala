...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-accessibility-point</code>
  */
class SeriesAreasplineAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAreasplineAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineAccessibilityPoint {
