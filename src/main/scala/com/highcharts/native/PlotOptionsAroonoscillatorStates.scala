...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-states</code>
  */
class PlotOptionsAroonoscillatorStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAroonoscillatorStatesSelect]] = js.undefined
}

object PlotOptionsAroonoscillatorStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAroonoscillatorStatesSelect]] = js.undefined): PlotOptionsAroonoscillatorStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorStates {
      this.hover = hover
