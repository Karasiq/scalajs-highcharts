...
/**
  * @note JavaScript name: <code>plotOptions-ikh-dataLabels-animation</code>
  */
class PlotOptionsIkhDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsIkhDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhDataLabelsAnimation {
      this.defer = defer
    })
  }
}
