...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dataGrouping</code>
  */
class SeriesItemDataGrouping extends com.highcharts.HighchartsGenericObject {
