...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-marker-states-select</code>
  */
class SeriesStochasticMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesStochasticMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticMarkerStatesSelect {
