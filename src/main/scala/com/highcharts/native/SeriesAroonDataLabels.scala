...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dataLabels</code>
  */
class SeriesAroonDataLabels extends com.highcharts.HighchartsGenericObject {
