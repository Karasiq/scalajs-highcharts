...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-dataLabels-filter</code>
  */
class PlotOptionsCylinderDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCylinderDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderDataLabelsFilter {
