...
/**
  * @note JavaScript name: <code>plotOptions-aroon-point-events</code>
  */
class PlotOptionsAroonPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsAroonPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonPointEvents {
      this.click = click
      this.drag = drag
