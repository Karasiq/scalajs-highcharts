...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-marker</code>
  */
class SeriesKlingerMarker extends com.highcharts.HighchartsGenericObject {
