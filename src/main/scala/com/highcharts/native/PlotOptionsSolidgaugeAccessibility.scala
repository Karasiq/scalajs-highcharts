...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-accessibility</code>
  */
class PlotOptionsSolidgaugeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeAccessibilityPoint]] = js.undefined
}

object PlotOptionsSolidgaugeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSolidgaugeAccessibilityPoint]] = js.undefined): PlotOptionsSolidgaugeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugeAccessibility {
