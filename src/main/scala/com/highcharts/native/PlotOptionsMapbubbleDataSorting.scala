...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-dataSorting</code>
  */
class PlotOptionsMapbubbleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMapbubbleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleDataSorting {
