...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-data-accessibility</code>
  */
class SeriesColumnrangeDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesColumnrangeDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataAccessibility {
