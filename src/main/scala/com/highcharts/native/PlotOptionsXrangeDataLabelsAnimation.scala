...
/**
  * @note JavaScript name: <code>plotOptions-xrange-dataLabels-animation</code>
  */
class PlotOptionsXrangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsXrangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
