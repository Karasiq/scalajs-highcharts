...
/**
  * @note JavaScript name: <code>plotOptions-trix-dataLabels</code>
  */
class PlotOptionsTrixDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixDataLabels {
  /**
