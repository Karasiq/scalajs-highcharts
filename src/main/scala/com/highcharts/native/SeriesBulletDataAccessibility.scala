...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-data-accessibility</code>
  */
class SeriesBulletDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBulletDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletDataAccessibility {
