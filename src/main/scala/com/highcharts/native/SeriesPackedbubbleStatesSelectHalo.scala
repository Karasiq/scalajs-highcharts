...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states-select-halo</code>
  */
class SeriesPackedbubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStatesSelectHalo {
