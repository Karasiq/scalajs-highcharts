...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-dataLabels-filter</code>
  */
class SeriesXrangeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesXrangeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataDataLabelsFilter {
