...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dataGrouping</code>
  */
class PlotOptionsColumnpyramidDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDataGrouping {
  /**
