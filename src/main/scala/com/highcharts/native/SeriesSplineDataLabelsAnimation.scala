...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-dataLabels-animation</code>
  */
class SeriesSplineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSplineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
