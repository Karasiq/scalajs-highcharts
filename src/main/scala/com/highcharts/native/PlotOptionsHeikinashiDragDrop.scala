...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dragDrop</code>
  */
class PlotOptionsHeikinashiDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDragDrop {
  /**
