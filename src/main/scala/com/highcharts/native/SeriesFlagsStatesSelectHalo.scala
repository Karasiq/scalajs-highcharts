...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-states-select-halo</code>
  */
class SeriesFlagsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesFlagsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsStatesSelectHalo {
