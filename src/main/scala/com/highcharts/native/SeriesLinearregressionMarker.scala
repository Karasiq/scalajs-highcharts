...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-marker</code>
  */
class SeriesLinearregressionMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionMarker {
  /**
