...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-connect</code>
  */
class SeriesXrangeDataConnect extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesXrangeDataConnectEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesXrangeDataConnectStartMarker]] = js.undefined
...
object SeriesXrangeDataConnect {
  /**
    ...
    */
  def apply(to: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesXrangeDataConnectEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesXrangeDataConnectStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesXrangeDataConnect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataConnect {
      this.to = to
