...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-states-select-halo</code>
  */
class PlotOptionsLinearregressionangleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionangleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleStatesSelectHalo {
