...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-marker-states-select</code>
  */
class SeriesDisparityindexMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDisparityindexMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexMarkerStatesSelect {
