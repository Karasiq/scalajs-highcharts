...
/**
  * @note JavaScript name: <code>plotOptions-apo-zones</code>
  */
class PlotOptionsApoZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsApoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoZones {
