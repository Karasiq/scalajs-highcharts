...
/**
  * @note JavaScript name: <code>plotOptions-map-lastPrice-label</code>
  */
class PlotOptionsMapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapLastPriceLabel {
  /**
