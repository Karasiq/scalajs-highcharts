...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-label</code>
  */
class PlotOptionsLinearregressionslopeLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeLabel {
  /**
