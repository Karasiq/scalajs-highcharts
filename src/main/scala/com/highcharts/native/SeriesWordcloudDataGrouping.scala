...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-dataGrouping</code>
  */
class SeriesWordcloudDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataGrouping {
  /**
