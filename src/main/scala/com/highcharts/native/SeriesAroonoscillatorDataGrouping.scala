...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dataGrouping</code>
  */
class SeriesAroonoscillatorDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDataGrouping {
  /**
