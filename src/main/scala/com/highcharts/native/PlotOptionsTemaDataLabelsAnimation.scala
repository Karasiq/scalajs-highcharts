...
/**
  * @note JavaScript name: <code>plotOptions-tema-dataLabels-animation</code>
  */
class PlotOptionsTemaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTemaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
