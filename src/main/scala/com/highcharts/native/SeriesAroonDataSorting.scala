...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dataSorting</code>
  */
class SeriesAroonDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAroonDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonDataSorting {
