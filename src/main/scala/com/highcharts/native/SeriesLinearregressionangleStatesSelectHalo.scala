...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-states-select-halo</code>
  */
class SeriesLinearregressionangleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleStatesSelectHalo {
