...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dataGrouping</code>
  */
class SeriesDumbbellDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataGrouping {
  /**
