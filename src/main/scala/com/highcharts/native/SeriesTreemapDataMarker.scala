...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-data-marker</code>
  */
class SeriesTreemapDataMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataMarker {
  /**
    ...
    */
  def apply(states: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesTreemapDataMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataMarker {
      this.states = states
