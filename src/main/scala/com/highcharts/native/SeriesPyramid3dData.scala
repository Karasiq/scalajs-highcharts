...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data</code>
  */
class SeriesPyramid3dData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesPyramid3dDataDragDrop]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var events: js.UndefOr[CleanJsObject[SeriesPyramid3dDataEvents]] = js.undefined
...
object SeriesPyramid3dData {
  /**
    ...
    */
  def apply(dataLabels: js.UndefOr[js.Any] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesPyramid3dDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesPyramid3dDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined, gradientForSides: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, x: js.UndefOr[Double] = js.undefined): SeriesPyramid3dData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dData {
