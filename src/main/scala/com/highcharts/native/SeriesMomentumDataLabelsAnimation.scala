...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-dataLabels-animation</code>
  */
class SeriesMomentumDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMomentumDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumDataLabelsAnimation {
      this.defer = defer
    })
  }
}
