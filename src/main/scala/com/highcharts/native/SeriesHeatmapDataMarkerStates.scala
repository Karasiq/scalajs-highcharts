...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-marker-states</code>
  */
class SeriesHeatmapDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesHeatmapDataMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataMarkerStates {
      this.hover = hover
      this.select = select
      this.normal = normal
    })
