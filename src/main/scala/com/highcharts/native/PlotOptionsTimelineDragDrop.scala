...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dragDrop</code>
  */
class PlotOptionsTimelineDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineDragDrop {
  /**
