...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-dataLabels</code>
  */
class SeriesPcDataLabels extends com.highcharts.HighchartsGenericObject {
