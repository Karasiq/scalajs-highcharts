...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-lastPrice-label</code>
  */
class SeriesWordcloudLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudLastPriceLabel {
  /**
