...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-marker-states</code>
  */
class PlotOptionsLinearregressionslopeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressionslopeMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
