...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-point-events</code>
  */
class SeriesDisparityindexPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesDisparityindexPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexPointEvents {
      this.click = click
      this.drag = drag
