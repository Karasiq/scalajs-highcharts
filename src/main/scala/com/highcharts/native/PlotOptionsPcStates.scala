...
/**
  * @note JavaScript name: <code>plotOptions-pc-states</code>
  */
class PlotOptionsPcStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsPcStatesSelect]] = js.undefined
}

object PlotOptionsPcStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsPcStatesSelect]] = js.undefined): PlotOptionsPcStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcStates {
      this.hover = hover
