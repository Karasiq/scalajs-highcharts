...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-accessibility</code>
  */
class SeriesPcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPcAccessibilityPoint]] = js.undefined
}

object SeriesPcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPcAccessibilityPoint]] = js.undefined): SeriesPcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcAccessibility {
