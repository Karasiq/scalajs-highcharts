...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-events</code>
  */
class SeriesFunnel3dDataEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesFunnel3dDataEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataEvents {
      this.click = click
      this.drag = drag
