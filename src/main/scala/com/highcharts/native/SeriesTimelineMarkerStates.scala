...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-marker-states</code>
  */
class SeriesTimelineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTimelineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
