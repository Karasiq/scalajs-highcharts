...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-dataLabels</code>
  */
class SeriesDependencywheelLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLevelsDataLabels {
  /**
