...
/**
  * @note JavaScript name: <code>plotOptions-gauge-dataGrouping</code>
  */
class PlotOptionsGaugeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGaugeDataGrouping {
  /**
