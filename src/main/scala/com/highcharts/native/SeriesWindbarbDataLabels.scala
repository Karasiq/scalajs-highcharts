...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-dataLabels</code>
  */
class SeriesWindbarbDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataLabels {
  /**
