...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-marker-states</code>
  */
class SeriesXrangeDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesXrangeDataMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
