...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-states</code>
  */
class SeriesAbandsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesAbandsStatesSelect]] = js.undefined
}

object SeriesAbandsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAbandsStatesSelect]] = js.undefined): SeriesAbandsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsStates {
      this.hover = hover
