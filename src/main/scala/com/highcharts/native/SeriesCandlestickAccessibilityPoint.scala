...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-accessibility-point</code>
  */
class SeriesCandlestickAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesCandlestickAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickAccessibilityPoint {
