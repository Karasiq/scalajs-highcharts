...
/**
  * @note JavaScript name: <code>plotOptions-ppo-accessibility</code>
  */
class PlotOptionsPpoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPpoAccessibilityPoint]] = js.undefined
}

object PlotOptionsPpoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPpoAccessibilityPoint]] = js.undefined): PlotOptionsPpoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoAccessibility {
