...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-states-select-halo</code>
  */
class SeriesAbandsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAbandsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsStatesSelectHalo {
