...
/**
  * @note JavaScript name: <code>plotOptions-pie-states-inactive</code>
  */
class PlotOptionsPieStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPieStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieStatesInactive {
