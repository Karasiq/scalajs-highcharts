...
/**
  * @note JavaScript name: <code>plotOptions-trix-marker-states</code>
  */
class PlotOptionsTrixMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsTrixMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
