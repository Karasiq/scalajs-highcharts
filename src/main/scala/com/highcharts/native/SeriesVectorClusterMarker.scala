...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-cluster-marker</code>
  */
class SeriesVectorClusterMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorClusterMarker {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesVectorClusterMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorClusterMarker {
