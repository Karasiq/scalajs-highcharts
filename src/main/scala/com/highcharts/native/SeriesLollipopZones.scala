...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-zones</code>
  */
class SeriesLollipopZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLollipopZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopZones {
