...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-data-dataLabels-animation</code>
  */
class SeriesColumnDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
