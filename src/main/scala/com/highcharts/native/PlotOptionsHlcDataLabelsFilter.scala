...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dataLabels-filter</code>
  */
class PlotOptionsHlcDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHlcDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcDataLabelsFilter {
