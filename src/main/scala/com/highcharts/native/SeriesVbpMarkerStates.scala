...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-marker-states</code>
  */
class SeriesVbpMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVbpMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
