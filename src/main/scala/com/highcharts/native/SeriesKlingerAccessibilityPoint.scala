...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-accessibility-point</code>
  */
class SeriesKlingerAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesKlingerAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerAccessibilityPoint {
