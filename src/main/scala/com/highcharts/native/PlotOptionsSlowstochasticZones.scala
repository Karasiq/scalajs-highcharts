...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-zones</code>
  */
class PlotOptionsSlowstochasticZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSlowstochasticZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticZones {
