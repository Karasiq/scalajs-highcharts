...
/**
  * @note JavaScript name: <code>plotOptions-vector-lastPrice-label</code>
  */
class PlotOptionsVectorLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorLastPriceLabel {
  /**
