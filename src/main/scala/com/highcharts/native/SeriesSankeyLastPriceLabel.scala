...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-lastPrice-label</code>
  */
class SeriesSankeyLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLastPriceLabel {
  /**
