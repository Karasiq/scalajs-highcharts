...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-lastPrice-label</code>
  */
class SeriesDemaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaLastPriceLabel {
  /**
