...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-states-hover</code>
  */
class PlotOptionsVariablepieStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariablepieStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined): PlotOptionsVariablepieStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariablepieStatesHover {
