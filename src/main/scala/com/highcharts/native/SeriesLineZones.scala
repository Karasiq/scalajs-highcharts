...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-zones</code>
  */
class SeriesLineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineZones {
