...
/**
  * @note JavaScript name: <code>plotOptions-bb-dataLabels-filter</code>
  */
class PlotOptionsBbDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBbDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbDataLabelsFilter {
