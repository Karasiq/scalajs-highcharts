...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-data-dataLabels-animation</code>
  */
class SeriesVectorDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVectorDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
