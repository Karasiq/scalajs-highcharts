...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data-dataLabels</code>
  */
class SeriesStreamgraphDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataDataLabels {
  /**
