...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dataLabels</code>
  */
class PlotOptionsErrorbarDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarDataLabels {
  /**
