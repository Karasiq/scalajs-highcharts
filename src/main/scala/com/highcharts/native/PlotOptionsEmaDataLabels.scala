...
/**
  * @note JavaScript name: <code>plotOptions-ema-dataLabels</code>
  */
class PlotOptionsEmaDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaDataLabels {
  /**
