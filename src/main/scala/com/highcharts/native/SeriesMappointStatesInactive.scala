...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-states-inactive</code>
  */
class SeriesMappointStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMappointStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointStatesInactive {
