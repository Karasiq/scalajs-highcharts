...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dataLabels-animation</code>
  */
class SeriesTrendlineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTrendlineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
