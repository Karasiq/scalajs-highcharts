...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-zones</code>
  */
class SeriesAtrZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAtrZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrZones {
