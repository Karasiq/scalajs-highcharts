...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-connectors</code>
  */
class PlotOptionsPyramid3dConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dConnectorsStartMarker]] = js.undefined
...
object PlotOptionsPyramid3dConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsPyramid3dConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsPyramid3dConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dConnectors {
