...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-states-hover-halo</code>
  */
class PlotOptionsZigzagStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsZigzagStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsZigzagStatesHoverHalo {
