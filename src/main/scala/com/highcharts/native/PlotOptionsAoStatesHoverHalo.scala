...
/**
  * @note JavaScript name: <code>plotOptions-ao-states-hover-halo</code>
  */
class PlotOptionsAoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoStatesHoverHalo {
      this.size = size
