...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-accessibility</code>
  */
class SeriesFunnel3dAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesFunnel3dAccessibilityPoint]] = js.undefined
}

object SeriesFunnel3dAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesFunnel3dAccessibilityPoint]] = js.undefined): SeriesFunnel3dAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dAccessibility {
