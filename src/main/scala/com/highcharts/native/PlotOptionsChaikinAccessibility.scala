...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-accessibility</code>
  */
class PlotOptionsChaikinAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsChaikinAccessibilityPoint]] = js.undefined
}

object PlotOptionsChaikinAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsChaikinAccessibilityPoint]] = js.undefined): PlotOptionsChaikinAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinAccessibility {
