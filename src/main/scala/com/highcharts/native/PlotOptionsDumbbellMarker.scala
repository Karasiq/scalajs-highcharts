...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-marker</code>
  */
class PlotOptionsDumbbellMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellMarker {
  /**
