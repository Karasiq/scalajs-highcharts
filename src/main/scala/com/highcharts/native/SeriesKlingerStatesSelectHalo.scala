...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-states-select-halo</code>
  */
class SeriesKlingerStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesKlingerStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerStatesSelectHalo {
