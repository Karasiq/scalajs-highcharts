...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-states</code>
  */
class PlotOptionsFunnel3dStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsFunnel3dStatesSelect]] = js.undefined
...
object PlotOptionsFunnel3dStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsFunnel3dStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsFunnel3dStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dStates {
      this.hover = hover
      this.select = select
