...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-lastPrice-label</code>
  */
class PlotOptionsScatter3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dLastPriceLabel {
  /**
