...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-accessibility</code>
  */
class SeriesCmoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesCmoAccessibilityPoint]] = js.undefined
}

object SeriesCmoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesCmoAccessibilityPoint]] = js.undefined): SeriesCmoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoAccessibility {
