...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-lastPrice-label</code>
  */
class PlotOptionsWaterfallLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallLastPriceLabel {
  /**
