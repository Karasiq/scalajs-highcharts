...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-accessibility-point</code>
  */
class SeriesLineAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesLineAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineAccessibilityPoint {
