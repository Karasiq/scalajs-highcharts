...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-select-halo</code>
  */
class SeriesHistogramStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHistogramStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesSelectHalo {
