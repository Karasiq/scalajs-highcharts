...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-data-dataLabels</code>
  */
class SeriesVectorDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataDataLabels {
  /**
