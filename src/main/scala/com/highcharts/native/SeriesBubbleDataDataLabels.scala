...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-dataLabels</code>
  */
class SeriesBubbleDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataDataLabels {
  /**
