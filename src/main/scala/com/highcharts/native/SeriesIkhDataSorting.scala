...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dataSorting</code>
  */
class SeriesIkhDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesIkhDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhDataSorting {
