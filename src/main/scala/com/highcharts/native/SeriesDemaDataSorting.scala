...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dataSorting</code>
  */
class SeriesDemaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesDemaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaDataSorting {
