...
/**
  * @note JavaScript name: <code>plotOptions-bullet-states-hover</code>
  */
class PlotOptionsBulletStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsBulletStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletStatesHover {
