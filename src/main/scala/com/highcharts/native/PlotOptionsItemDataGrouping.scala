...
/**
  * @note JavaScript name: <code>plotOptions-item-dataGrouping</code>
  */
class PlotOptionsItemDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemDataGrouping {
  /**
