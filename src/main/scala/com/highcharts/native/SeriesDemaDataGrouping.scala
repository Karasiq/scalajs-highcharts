...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dataGrouping</code>
  */
class SeriesDemaDataGrouping extends com.highcharts.HighchartsGenericObject {
