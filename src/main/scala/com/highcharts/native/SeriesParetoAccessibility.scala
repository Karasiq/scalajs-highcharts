...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-accessibility</code>
  */
class SeriesParetoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesParetoAccessibilityPoint]] = js.undefined
}

object SeriesParetoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesParetoAccessibilityPoint]] = js.undefined): SeriesParetoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoAccessibility {
