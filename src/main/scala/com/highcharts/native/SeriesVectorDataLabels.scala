...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-dataLabels</code>
  */
class SeriesVectorDataLabels extends com.highcharts.HighchartsGenericObject {
