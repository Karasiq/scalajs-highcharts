...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-zones</code>
  */
class SeriesZigzagZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesZigzagZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagZones {
