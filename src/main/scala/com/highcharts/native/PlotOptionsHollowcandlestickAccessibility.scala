...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-accessibility</code>
  */
class PlotOptionsHollowcandlestickAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsHollowcandlestickAccessibilityPoint]] = js.undefined
}

object PlotOptionsHollowcandlestickAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsHollowcandlestickAccessibilityPoint]] = js.undefined): PlotOptionsHollowcandlestickAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickAccessibility {
