...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-lastPrice-label</code>
  */
class SeriesVwapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapLastPriceLabel {
  /**
