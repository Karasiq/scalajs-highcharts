...
/**
  * @note JavaScript name: <code>plotOptions-ao-states</code>
  */
class PlotOptionsAoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAoStatesSelect]] = js.undefined
}

object PlotOptionsAoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAoStatesSelect]] = js.undefined): PlotOptionsAoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoStates {
      this.hover = hover
