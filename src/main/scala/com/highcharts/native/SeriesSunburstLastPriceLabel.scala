...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-lastPrice-label</code>
  */
class SeriesSunburstLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstLastPriceLabel {
  /**
