...
/**
  * @note JavaScript name: <code>plotOptions-candlestick</code>
  */
class PlotOptionsCandlestick extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[PlotOptionsCandlestickConnectors]] = js.undefined
