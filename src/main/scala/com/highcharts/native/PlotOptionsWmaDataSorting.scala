...
/**
  * @note JavaScript name: <code>plotOptions-wma-dataSorting</code>
  */
class PlotOptionsWmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsWmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaDataSorting {
