...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-dataLabels-animation</code>
  */
class SeriesTimelineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTimelineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
