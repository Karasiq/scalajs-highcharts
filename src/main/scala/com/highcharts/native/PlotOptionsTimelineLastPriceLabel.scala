...
/**
  * @note JavaScript name: <code>plotOptions-timeline-lastPrice-label</code>
  */
class PlotOptionsTimelineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineLastPriceLabel {
  /**
