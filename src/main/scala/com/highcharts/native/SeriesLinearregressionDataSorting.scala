...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dataSorting</code>
  */
class SeriesLinearregressionDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLinearregressionDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionDataSorting {
