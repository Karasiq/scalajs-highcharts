...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-accessibility</code>
  */
class SeriesNatrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesNatrAccessibilityPoint]] = js.undefined
}

object SeriesNatrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesNatrAccessibilityPoint]] = js.undefined): SeriesNatrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrAccessibility {
