...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-zones</code>
  */
class PlotOptionsColumnrangeZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsColumnrangeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeZones {
