...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-accessibility</code>
  */
class SeriesDmiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDmiAccessibilityPoint]] = js.undefined
}

object SeriesDmiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDmiAccessibilityPoint]] = js.undefined): SeriesDmiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiAccessibility {
