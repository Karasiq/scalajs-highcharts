...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-zones</code>
  */
class SeriesSplineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSplineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineZones {
