...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-dataSorting</code>
  */
class PlotOptionsStochasticDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsStochasticDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticDataSorting {
