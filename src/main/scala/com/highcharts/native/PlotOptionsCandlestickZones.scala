...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-zones</code>
  */
class PlotOptionsCandlestickZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickZones {
