...
/**
  * @note JavaScript name: <code>plotOptions-funnel-lastPrice-label</code>
  */
class PlotOptionsFunnelLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelLastPriceLabel {
  /**
