...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-states</code>
  */
class PlotOptionsLinearregressionslopeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionslopeStatesSelect]] = js.undefined
}

object PlotOptionsLinearregressionslopeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionslopeStatesSelect]] = js.undefined): PlotOptionsLinearregressionslopeStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeStates {
      this.hover = hover
