...
/**
  * @note JavaScript name: <code>plotOptions-atr-states-inactive</code>
  */
class PlotOptionsAtrStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAtrStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrStatesInactive {
