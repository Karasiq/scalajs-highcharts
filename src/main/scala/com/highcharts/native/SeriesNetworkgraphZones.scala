...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-zones</code>
  */
class SeriesNetworkgraphZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphZones {
