...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dataSorting</code>
  */
class PlotOptionsHlcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsHlcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcDataSorting {
