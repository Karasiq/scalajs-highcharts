...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-states-select-halo</code>
  */
class SeriesFunnel3dStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesFunnel3dStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dStatesSelectHalo {
