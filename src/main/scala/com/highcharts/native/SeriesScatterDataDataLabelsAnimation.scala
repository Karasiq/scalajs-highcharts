...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-data-dataLabels-animation</code>
  */
class SeriesScatterDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesScatterDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
