...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-marker-states</code>
  */
class PlotOptionsLollipopMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsLollipopMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
