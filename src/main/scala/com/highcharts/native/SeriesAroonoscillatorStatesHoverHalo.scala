...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-states-hover-halo</code>
  */
class SeriesAroonoscillatorStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorStatesHoverHalo {
