...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data-dataLabels-animation</code>
  */
class SeriesPolygonDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPolygonDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
