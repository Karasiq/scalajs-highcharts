...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-accessibility</code>
  */
class PlotOptionsCandlestickAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsCandlestickAccessibilityPoint]] = js.undefined
}

object PlotOptionsCandlestickAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCandlestickAccessibilityPoint]] = js.undefined): PlotOptionsCandlestickAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickAccessibility {
