...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-states-hover</code>
  */
class PlotOptionsSunburstStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined): PlotOptionsSunburstStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstStatesHover {
