...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-lastPrice-label</code>
  */
class SeriesTemaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaLastPriceLabel {
  /**
