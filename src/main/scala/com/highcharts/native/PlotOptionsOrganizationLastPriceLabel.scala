...
/**
  * @note JavaScript name: <code>plotOptions-organization-lastPrice-label</code>
  */
class PlotOptionsOrganizationLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLastPriceLabel {
  /**
