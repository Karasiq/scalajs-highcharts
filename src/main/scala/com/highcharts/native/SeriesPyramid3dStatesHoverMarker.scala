...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states-hover-marker</code>
  */
class SeriesPyramid3dStatesHoverMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dStatesHoverMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPyramid3dStatesHoverMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStatesHoverMarker {
