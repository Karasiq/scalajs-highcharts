...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-marker-states</code>
  */
class PlotOptionsLinearregressioninterceptMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressioninterceptMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
