...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-accessibility</code>
  */
class SeriesSmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSmaAccessibilityPoint]] = js.undefined
}

object SeriesSmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSmaAccessibilityPoint]] = js.undefined): SeriesSmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaAccessibility {
