...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-states-select-halo</code>
  */
class SeriesSmaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSmaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaStatesSelectHalo {
