...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-cluster</code>
  */
class PlotOptionsMappointCluster extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointCluster {
  /**
