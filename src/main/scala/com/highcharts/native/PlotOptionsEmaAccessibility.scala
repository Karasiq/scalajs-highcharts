...
/**
  * @note JavaScript name: <code>plotOptions-ema-accessibility</code>
  */
class PlotOptionsEmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsEmaAccessibilityPoint]] = js.undefined
}

object PlotOptionsEmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsEmaAccessibilityPoint]] = js.undefined): PlotOptionsEmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaAccessibility {
