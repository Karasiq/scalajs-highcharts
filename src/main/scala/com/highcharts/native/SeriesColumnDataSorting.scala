...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-dataSorting</code>
  */
class SeriesColumnDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesColumnDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnDataSorting {
