...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-dataLabels-animation</code>
  */
class SeriesDpoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDpoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
