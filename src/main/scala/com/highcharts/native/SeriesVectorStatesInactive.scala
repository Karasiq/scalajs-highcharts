...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-inactive</code>
  */
class SeriesVectorStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesVectorStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesInactive {
