...
/**
  * @note JavaScript name: <code>plotOptions-trix-dataGrouping</code>
  */
class PlotOptionsTrixDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixDataGrouping {
  /**
