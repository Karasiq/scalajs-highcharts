...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-states</code>
  */
class SeriesColumnpyramidStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesColumnpyramidStatesSelect]] = js.undefined
...
object SeriesColumnpyramidStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesColumnpyramidStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesColumnpyramidStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidStates {
      this.hover = hover
      this.select = select
