...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-dataSorting</code>
  */
class SeriesDpoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesDpoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoDataSorting {
