...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-data-dataLabels-animation</code>
  */
class SeriesAreasplinerangeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
