...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-states-inactive</code>
  */
class PlotOptionsStreamgraphStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsStreamgraphStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphStatesInactive {
