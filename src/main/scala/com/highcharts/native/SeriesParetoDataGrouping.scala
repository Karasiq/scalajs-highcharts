...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-dataGrouping</code>
  */
class SeriesParetoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoDataGrouping {
  /**
