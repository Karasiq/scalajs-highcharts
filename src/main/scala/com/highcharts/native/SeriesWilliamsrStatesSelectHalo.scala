...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-states-select-halo</code>
  */
class SeriesWilliamsrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWilliamsrStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrStatesSelectHalo {
