...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-dataSorting</code>
  */
class PlotOptionsPivotpointsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPivotpointsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsDataSorting {
