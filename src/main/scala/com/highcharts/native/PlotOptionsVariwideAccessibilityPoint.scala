...
/**
  * @note JavaScript name: <code>plotOptions-variwide-accessibility-point</code>
  */
class PlotOptionsVariwideAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): PlotOptionsVariwideAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideAccessibilityPoint {
