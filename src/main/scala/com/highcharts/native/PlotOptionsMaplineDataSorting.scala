...
/**
  * @note JavaScript name: <code>plotOptions-mapline-dataSorting</code>
  */
class PlotOptionsMaplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMaplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineDataSorting {
