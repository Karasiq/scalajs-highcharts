...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-dataLabels</code>
  */
class SeriesTimelineDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataLabels {
  /**
