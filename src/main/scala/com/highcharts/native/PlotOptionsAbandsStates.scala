...
/**
  * @note JavaScript name: <code>plotOptions-abands-states</code>
  */
class PlotOptionsAbandsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAbandsStatesSelect]] = js.undefined
}

object PlotOptionsAbandsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAbandsStatesSelect]] = js.undefined): PlotOptionsAbandsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsStates {
      this.hover = hover
