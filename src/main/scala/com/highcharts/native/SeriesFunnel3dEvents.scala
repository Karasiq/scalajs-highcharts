...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-events</code>
  */
class SeriesFunnel3dEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined): SeriesFunnel3dEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dEvents {
