...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-states-inactive</code>
  */
class SeriesFunnel3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesFunnel3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dStatesInactive {
