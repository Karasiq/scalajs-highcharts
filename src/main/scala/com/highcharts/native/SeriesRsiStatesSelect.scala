...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 6.0.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesRsiStatesSelectMarker]] = js.undefined
}
...
object SeriesRsiStatesSelect {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Any] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesRsiStatesSelectMarker]] = js.undefined): SeriesRsiStatesSelect = {
