...
/**
  * @note JavaScript name: <code>plotOptions-hlc-states-select</code>
  */
class PlotOptionsHlcStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsHlcStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcStatesSelect {
