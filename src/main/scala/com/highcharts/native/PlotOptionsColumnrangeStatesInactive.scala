...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-states-inactive</code>
  */
class PlotOptionsColumnrangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsColumnrangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeStatesInactive {
