...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-accessibility</code>
  */
class SeriesAreasplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAreasplineAccessibilityPoint]] = js.undefined
}

object SeriesAreasplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAreasplineAccessibilityPoint]] = js.undefined): SeriesAreasplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineAccessibility {
