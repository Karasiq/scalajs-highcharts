...
/**
  * @note JavaScript name: <code>plotOptions-flags-states-inactive</code>
  */
class PlotOptionsFlagsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsStatesInactive {
