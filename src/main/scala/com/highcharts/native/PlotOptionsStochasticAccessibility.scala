...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-accessibility</code>
  */
class PlotOptionsStochasticAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsStochasticAccessibilityPoint]] = js.undefined
}

object PlotOptionsStochasticAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsStochasticAccessibilityPoint]] = js.undefined): PlotOptionsStochasticAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticAccessibility {
