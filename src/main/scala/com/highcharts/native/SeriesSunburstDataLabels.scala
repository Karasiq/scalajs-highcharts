...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-dataLabels</code>
  */
class SeriesSunburstDataLabels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Decides how the data label will be rotated relative to the
    * perimeter of the sunburst. Valid values are <code>auto</code>, <code>circular</code>,
    * <code>parallel</code> and <code>perpendicular</code>. When <code>auto</code>, the best fit will be
    * computed for the point. The <code>circular</code> option works similiar
    * to <code>auto</code>, but uses the <code>textPath</code> feature - labels are curved,
    * resulting in a better layout, however multiple lines and
    * <code>textOutline</code> are not supported.</p>
    * <p>The <code>rotation</code> option takes precedence over <code>rotationMode</code>.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/sunburst-datalabels-rotationmode-circular/">Circular rotation mode</a>
    * @since 6.0.0
    */
...
object SeriesSunburstDataLabels {
  /**
    ...
    * @param rotationMode <p>Decides how the data label will be rotated relative to the. perimeter of the sunburst. Valid values are <code>auto</code>, <code>circular</code>,. <code>parallel</code> and <code>perpendicular</code>. When <code>auto</code>, the best fit will be. computed for the point. The <code>circular</code> option works similiar. to <code>auto</code>, but uses the <code>textPath</code> feature - labels are curved,. resulting in a better layout, however multiple lines and. <code>textOutline</code> are not supported.</p>. <p>The <code>rotation</code> option takes precedence over <code>rotationMode</code>.</p>
    ...
    */
  def apply(allowOverlap: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, rotationMode: js.UndefOr[String] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, alignTo: js.UndefOr[String] = js.undefined, connectorColor: js.UndefOr[String | js.Object] = js.undefined, connectorPadding: js.UndefOr[Double] = js.undefined, connectorShape: js.UndefOr[String | js.Function] = js.undefined, connectorWidth: js.UndefOr[Double] = js.undefined, crookDistance: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double | String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, softConnector: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined): SeriesSunburstDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataLabels {
