...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-accessibility</code>
  */
class SeriesBubbleDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBubbleDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataAccessibility {
