...
/**
  * @note JavaScript name: <code>plotOptions-klinger-dataSorting</code>
  */
class PlotOptionsKlingerDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsKlingerDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerDataSorting {
