...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-accessibility</code>
  */
class SeriesPpoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPpoAccessibilityPoint]] = js.undefined
}

object SeriesPpoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPpoAccessibilityPoint]] = js.undefined): SeriesPpoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoAccessibility {
