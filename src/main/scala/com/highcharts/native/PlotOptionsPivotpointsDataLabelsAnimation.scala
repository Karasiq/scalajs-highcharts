...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-dataLabels-animation</code>
  */
class PlotOptionsPivotpointsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPivotpointsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
