...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-dataLabels</code>
  */
class PlotOptionsZigzagDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagDataLabels {
  /**
