...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-data-dataLabels</code>
  */
class SeriesVariwideDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataDataLabels {
  /**
