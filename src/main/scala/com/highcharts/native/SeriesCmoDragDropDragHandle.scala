...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dragDrop-dragHandle</code>
  */
class SeriesCmoDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesCmoDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoDragDropDragHandle {
