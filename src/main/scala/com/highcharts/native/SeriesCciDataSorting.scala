...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-dataSorting</code>
  */
class SeriesCciDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesCciDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciDataSorting {
