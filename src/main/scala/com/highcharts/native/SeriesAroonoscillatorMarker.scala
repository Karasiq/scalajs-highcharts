...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-marker</code>
  */
class SeriesAroonoscillatorMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorMarker {
  /**
