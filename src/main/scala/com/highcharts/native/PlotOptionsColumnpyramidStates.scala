...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-states</code>
  */
class PlotOptionsColumnpyramidStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidStatesSelect]] = js.undefined
...
object PlotOptionsColumnpyramidStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnpyramidStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidStates {
      this.hover = hover
      this.select = select
