...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dataLabels</code>
  */
class PlotOptionsBellcurveDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveDataLabels {
  /**
