...
/**
  * @note JavaScript name: <code>plotOptions-abands-states-inactive</code>
  */
class PlotOptionsAbandsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsStatesInactive {
