...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dataLabels-animation</code>
  */
class PlotOptionsBellcurveDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsBellcurveDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveDataLabelsAnimation {
      this.defer = defer
    })
  }
}
