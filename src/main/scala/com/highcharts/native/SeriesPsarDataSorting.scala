...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-dataSorting</code>
  */
class SeriesPsarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPsarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarDataSorting {
