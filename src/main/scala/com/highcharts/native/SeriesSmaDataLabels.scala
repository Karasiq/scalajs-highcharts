...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-dataLabels</code>
  */
class SeriesSmaDataLabels extends com.highcharts.HighchartsGenericObject {
