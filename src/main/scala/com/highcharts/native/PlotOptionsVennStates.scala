...
/**
  * @note JavaScript name: <code>plotOptions-venn-states</code>
  */
class PlotOptionsVennStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsVennStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennStates {
      this.hover = hover
