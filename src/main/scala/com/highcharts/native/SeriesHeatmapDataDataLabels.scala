...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-dataLabels</code>
  */
class SeriesHeatmapDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataDataLabels {
  /**
