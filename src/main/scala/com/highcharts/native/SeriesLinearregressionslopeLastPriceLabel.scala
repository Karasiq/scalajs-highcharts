...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-lastPrice-label</code>
  */
class SeriesLinearregressionslopeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeLastPriceLabel {
  /**
