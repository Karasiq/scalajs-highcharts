...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-select-halo</code>
  */
class SeriesParetoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesParetoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesSelectHalo {
