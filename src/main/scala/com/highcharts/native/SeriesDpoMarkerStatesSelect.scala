...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-marker-states-select</code>
  */
class SeriesDpoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDpoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoMarkerStatesSelect {
