...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-accessibility</code>
  */
class SeriesSupertrendAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSupertrendAccessibilityPoint]] = js.undefined
}

object SeriesSupertrendAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSupertrendAccessibilityPoint]] = js.undefined): SeriesSupertrendAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendAccessibility {
