...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-states-select-halo</code>
  */
class SeriesAreasplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAreasplineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineStatesSelectHalo {
