...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-marker-states-hover</code>
  */
class PlotOptionsScatter3dMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dMarkerStatesHover {
