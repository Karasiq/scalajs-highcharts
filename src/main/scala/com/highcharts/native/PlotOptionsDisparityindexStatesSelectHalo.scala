...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-states-select-halo</code>
  */
class PlotOptionsDisparityindexStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDisparityindexStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexStatesSelectHalo {
