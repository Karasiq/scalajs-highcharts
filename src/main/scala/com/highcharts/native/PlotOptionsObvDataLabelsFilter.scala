...
/**
  * @note JavaScript name: <code>plotOptions-obv-dataLabels-filter</code>
  */
class PlotOptionsObvDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsObvDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvDataLabelsFilter {
