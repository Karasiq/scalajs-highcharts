...
/**
  * @note JavaScript name: <code>plotOptions-tema-marker-states</code>
  */
class PlotOptionsTemaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsTemaMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
