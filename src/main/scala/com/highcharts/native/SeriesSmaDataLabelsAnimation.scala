...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-dataLabels-animation</code>
  */
class SeriesSmaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSmaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
