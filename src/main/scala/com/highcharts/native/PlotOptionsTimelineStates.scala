...
/**
  * @note JavaScript name: <code>plotOptions-timeline-states</code>
  */
class PlotOptionsTimelineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsTimelineStatesSelect]] = js.undefined
}

object PlotOptionsTimelineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsTimelineStatesSelect]] = js.undefined): PlotOptionsTimelineStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineStates {
      this.hover = hover
