...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-data-dataLabels-filter</code>
  */
class SeriesSolidgaugeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSolidgaugeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeDataDataLabelsFilter {
