...
/**
  * @note JavaScript name: <code>plotOptions-bb-lastPrice-label</code>
  */
class PlotOptionsBbLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbLastPriceLabel {
  /**
