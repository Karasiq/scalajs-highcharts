...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-marker</code>
  */
class SeriesSupertrendMarker extends com.highcharts.HighchartsGenericObject {
