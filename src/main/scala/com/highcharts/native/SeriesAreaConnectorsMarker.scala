...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-connectors-marker</code>
  */
class SeriesAreaConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreaConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaConnectorsMarker {
      this.align = align
      this.color = color
