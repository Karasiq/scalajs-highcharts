...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-dataGrouping</code>
  */
class SeriesWmaDataGrouping extends com.highcharts.HighchartsGenericObject {
