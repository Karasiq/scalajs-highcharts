...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-states-hover-halo</code>
  */
class SeriesObvStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesObvStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvStatesHoverHalo {
