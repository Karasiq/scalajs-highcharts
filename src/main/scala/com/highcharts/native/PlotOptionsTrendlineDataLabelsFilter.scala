...
/**
  * @note JavaScript name: <code>plotOptions-trendline-dataLabels-filter</code>
  */
class PlotOptionsTrendlineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTrendlineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineDataLabelsFilter {
