...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-accessibility</code>
  */
class PlotOptionsColumnpyramidAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidAccessibilityPoint]] = js.undefined
}

object PlotOptionsColumnpyramidAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsColumnpyramidAccessibilityPoint]] = js.undefined): PlotOptionsColumnpyramidAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidAccessibility {
