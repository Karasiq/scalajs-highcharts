...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-dataSorting</code>
  */
class PlotOptionsHeatmapDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsHeatmapDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapDataSorting {
