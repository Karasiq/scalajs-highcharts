...
/**
  * @note JavaScript name: <code>plotOptions-momentum-states-inactive</code>
  */
class PlotOptionsMomentumStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMomentumStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumStatesInactive {
