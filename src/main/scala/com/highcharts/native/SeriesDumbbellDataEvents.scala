...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-events</code>
  */
class SeriesDumbbellDataEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesDumbbellDataEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataEvents {
      this.click = click
      this.drag = drag
