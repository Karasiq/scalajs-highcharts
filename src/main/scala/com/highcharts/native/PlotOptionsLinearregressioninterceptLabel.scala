...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-label</code>
  */
class PlotOptionsLinearregressioninterceptLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptLabel {
  /**
