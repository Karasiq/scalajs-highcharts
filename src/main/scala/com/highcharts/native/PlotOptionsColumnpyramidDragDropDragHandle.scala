...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dragDrop-dragHandle</code>
  */
class PlotOptionsColumnpyramidDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsColumnpyramidDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidDragDropDragHandle {
