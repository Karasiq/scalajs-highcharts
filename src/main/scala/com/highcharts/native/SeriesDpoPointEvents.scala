...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-point-events</code>
  */
class SeriesDpoPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesDpoPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoPointEvents {
      this.click = click
      this.drag = drag
