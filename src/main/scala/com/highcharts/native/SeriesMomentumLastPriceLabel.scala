...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-lastPrice-label</code>
  */
class SeriesMomentumLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumLastPriceLabel {
  /**
