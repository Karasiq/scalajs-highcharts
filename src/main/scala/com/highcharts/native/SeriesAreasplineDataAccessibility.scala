...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data-accessibility</code>
  */
class SeriesAreasplineDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesAreasplineDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataAccessibility {
