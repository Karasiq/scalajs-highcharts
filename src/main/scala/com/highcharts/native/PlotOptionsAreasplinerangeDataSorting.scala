...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-dataSorting</code>
  */
class PlotOptionsAreasplinerangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplinerangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAreasplinerangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplinerangeDataSorting {
