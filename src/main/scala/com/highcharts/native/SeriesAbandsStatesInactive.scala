...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-states-inactive</code>
  */
class SeriesAbandsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAbandsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsStatesInactive {
