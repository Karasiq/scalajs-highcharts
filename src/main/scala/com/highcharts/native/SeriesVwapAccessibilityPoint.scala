...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-accessibility-point</code>
  */
class SeriesVwapAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVwapAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapAccessibilityPoint {
