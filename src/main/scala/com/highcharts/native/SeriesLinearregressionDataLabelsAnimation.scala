...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dataLabels-animation</code>
  */
class SeriesLinearregressionDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLinearregressionDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionDataLabelsAnimation {
      this.defer = defer
    })
  }
}
