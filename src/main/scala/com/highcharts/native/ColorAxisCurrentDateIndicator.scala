...
/**
  * @note JavaScript name: <code>colorAxis-currentDateIndicator</code>
  */
class ColorAxisCurrentDateIndicator extends com.highcharts.HighchartsGenericObject {
...
object ColorAxisCurrentDateIndicator {
  /**
    ...
    */
  def apply(label: js.UndefOr[js.Any] = js.undefined, acrossPanes: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): ColorAxisCurrentDateIndicator = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ColorAxisCurrentDateIndicator {
      this.label = label
