...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-data-accessibility</code>
  */
class SeriesPyramidDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPyramidDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidDataAccessibility {
