...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-zones</code>
  */
class SeriesStreamgraphZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesStreamgraphZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphZones {
