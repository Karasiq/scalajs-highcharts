...
/**
  * @note JavaScript name: <code>plotOptions-klinger-states</code>
  */
class PlotOptionsKlingerStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsKlingerStatesSelect]] = js.undefined
}

object PlotOptionsKlingerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsKlingerStatesSelect]] = js.undefined): PlotOptionsKlingerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerStates {
      this.hover = hover
