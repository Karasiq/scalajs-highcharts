...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-states</code>
  */
class PlotOptionsHeikinashiStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsHeikinashiStatesSelect]] = js.undefined
...
object PlotOptionsHeikinashiStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsHeikinashiStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsHeikinashiStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiStates {
      this.hover = hover
      this.select = select
