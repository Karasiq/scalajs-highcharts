...
/**
  * @note JavaScript name: <code>plotOptions-vwap-dataLabels</code>
  */
class PlotOptionsVwapDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapDataLabels {
  /**
