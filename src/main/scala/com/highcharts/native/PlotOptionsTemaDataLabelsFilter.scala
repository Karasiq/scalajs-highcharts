...
/**
  * @note JavaScript name: <code>plotOptions-tema-dataLabels-filter</code>
  */
class PlotOptionsTemaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTemaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaDataLabelsFilter {
