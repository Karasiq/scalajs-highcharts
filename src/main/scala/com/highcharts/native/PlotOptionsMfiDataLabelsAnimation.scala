...
/**
  * @note JavaScript name: <code>plotOptions-mfi-dataLabels-animation</code>
  */
class PlotOptionsMfiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMfiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
