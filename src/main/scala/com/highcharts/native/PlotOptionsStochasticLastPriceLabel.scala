...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-lastPrice-label</code>
  */
class PlotOptionsStochasticLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticLastPriceLabel {
  /**
