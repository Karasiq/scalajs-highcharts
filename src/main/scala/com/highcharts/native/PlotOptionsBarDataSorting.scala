...
/**
  * @note JavaScript name: <code>plotOptions-bar-dataSorting</code>
  */
class PlotOptionsBarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsBarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarDataSorting {
