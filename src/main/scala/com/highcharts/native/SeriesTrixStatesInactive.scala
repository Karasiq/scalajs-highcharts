...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-states-inactive</code>
  */
class SeriesTrixStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTrixStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixStatesInactive {
