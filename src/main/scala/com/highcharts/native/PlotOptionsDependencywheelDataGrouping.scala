...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-dataGrouping</code>
  */
class PlotOptionsDependencywheelDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelDataGrouping {
  /**
