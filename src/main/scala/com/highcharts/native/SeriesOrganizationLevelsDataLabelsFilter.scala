...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-dataLabels-filter</code>
  */
class SeriesOrganizationLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOrganizationLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsDataLabelsFilter {
