...
/**
  * @note JavaScript name: <code>navigation-annotationsOptions-shapeOptions</code>
  */
class NavigationAnnotationsOptionsShapeOptions extends com.highcharts.HighchartsGenericObject {
...
object NavigationAnnotationsOptionsShapeOptions {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, fill: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, r: js.UndefOr[Double] = js.undefined, ry: js.UndefOr[Double] = js.undefined, snap: js.UndefOr[Double] = js.undefined, src: js.UndefOr[String] = js.undefined, stroke: js.UndefOr[String] = js.undefined, strokeWidth: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String] = "rect", width: js.UndefOr[Double] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): NavigationAnnotationsOptionsShapeOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigationAnnotationsOptionsShapeOptions {
