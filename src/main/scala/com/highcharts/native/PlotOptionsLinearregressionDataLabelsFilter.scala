...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-dataLabels-filter</code>
  */
class PlotOptionsLinearregressionDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionDataLabelsFilter {
