...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dragDrop</code>
  */
class SeriesLinearregressionslopeDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDragDrop {
  /**
