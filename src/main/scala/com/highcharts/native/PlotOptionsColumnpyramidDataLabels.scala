...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dataLabels</code>
  */
class PlotOptionsColumnpyramidDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDataLabels {
  /**
