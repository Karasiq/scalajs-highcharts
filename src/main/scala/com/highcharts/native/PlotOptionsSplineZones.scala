...
/**
  * @note JavaScript name: <code>plotOptions-spline-zones</code>
  */
class PlotOptionsSplineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSplineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineZones {
