...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-dataLabels-animation</code>
  */
class PlotOptionsLinearregressionDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionDataLabelsAnimation {
      this.defer = defer
    })
  }
}
