...
/**
  * @note JavaScript name: <code>plotOptions-obv-states</code>
  */
class PlotOptionsObvStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsObvStatesSelect]] = js.undefined
}

object PlotOptionsObvStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsObvStatesSelect]] = js.undefined): PlotOptionsObvStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvStates {
      this.hover = hover
