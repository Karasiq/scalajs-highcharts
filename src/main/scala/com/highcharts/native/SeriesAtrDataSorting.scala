...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-dataSorting</code>
  */
class SeriesAtrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAtrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrDataSorting {
