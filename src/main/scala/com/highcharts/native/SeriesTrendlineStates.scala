...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-states</code>
  */
class SeriesTrendlineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.3
    */
  var select: js.UndefOr[CleanJsObject[SeriesTrendlineStatesSelect]] = js.undefined
}

object SeriesTrendlineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesTrendlineStatesSelect]] = js.undefined): SeriesTrendlineStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineStates {
      this.hover = hover
