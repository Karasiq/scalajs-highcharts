...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-select-halo</code>
  */
class SeriesMaplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesMaplineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesSelectHalo {
