...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-label</code>
  */
class SeriesSlowstochasticLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticLabel {
  /**
