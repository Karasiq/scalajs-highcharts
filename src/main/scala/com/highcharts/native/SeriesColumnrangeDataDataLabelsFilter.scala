...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-data-dataLabels-filter</code>
  */
class SeriesColumnrangeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnrangeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataDataLabelsFilter {
