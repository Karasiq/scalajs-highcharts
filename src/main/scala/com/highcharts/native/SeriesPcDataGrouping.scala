...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-dataGrouping</code>
  */
class SeriesPcDataGrouping extends com.highcharts.HighchartsGenericObject {
