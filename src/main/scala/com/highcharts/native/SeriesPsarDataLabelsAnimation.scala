...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-dataLabels-animation</code>
  */
class SeriesPsarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPsarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
