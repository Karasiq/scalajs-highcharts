...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-states</code>
  */
class PlotOptionsLinearregressionangleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionangleStatesSelect]] = js.undefined
}

object PlotOptionsLinearregressionangleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionangleStatesSelect]] = js.undefined): PlotOptionsLinearregressionangleStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleStates {
      this.hover = hover
