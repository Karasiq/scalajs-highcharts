...
/**
  * @note JavaScript name: <code>yAxis-accessibility</code>
  */
class YAxisAccessibility extends com.highcharts.HighchartsGenericObject {
...
object YAxisAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, rangeDescription: js.UndefOr[String] = js.undefined): YAxisAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new YAxisAccessibility {
