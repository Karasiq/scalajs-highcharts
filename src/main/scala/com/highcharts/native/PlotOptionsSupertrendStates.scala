...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-states</code>
  */
class PlotOptionsSupertrendStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsSupertrendStatesSelect]] = js.undefined
}

object PlotOptionsSupertrendStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsSupertrendStatesSelect]] = js.undefined): PlotOptionsSupertrendStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendStates {
      this.hover = hover
