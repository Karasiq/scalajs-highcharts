...
/**
  * @note JavaScript name: <code>plotOptions-pareto-dataLabels</code>
  */
class PlotOptionsParetoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoDataLabels {
  /**
