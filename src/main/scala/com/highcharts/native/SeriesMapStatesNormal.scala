...
/**
  ...
  */
class SeriesMapStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined): SeriesMapStatesNormal = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStatesNormal {
