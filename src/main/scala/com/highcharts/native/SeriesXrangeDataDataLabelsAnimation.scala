...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-dataLabels-animation</code>
  */
class SeriesXrangeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesXrangeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
