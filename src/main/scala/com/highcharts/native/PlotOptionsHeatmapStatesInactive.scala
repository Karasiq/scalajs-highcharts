...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-states-inactive</code>
  */
class PlotOptionsHeatmapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapStatesInactive {
