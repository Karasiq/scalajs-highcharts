...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-dataGrouping</code>
  */
class SeriesLinearregressionslopeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeDataGrouping {
  /**
