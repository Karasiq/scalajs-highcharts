...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-lastPrice-label</code>
  */
class SeriesWmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaLastPriceLabel {
  /**
