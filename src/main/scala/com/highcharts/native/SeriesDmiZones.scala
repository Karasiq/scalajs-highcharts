...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-zones</code>
  */
class SeriesDmiZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDmiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiZones {
