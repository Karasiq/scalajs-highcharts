...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-states-inactive</code>
  */
class SeriesObvStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesObvStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvStatesInactive {
