...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-lastPrice-label</code>
  */
class PlotOptionsHeikinashiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiLastPriceLabel {
  /**
