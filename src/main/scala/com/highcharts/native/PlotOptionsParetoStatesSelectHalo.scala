...
/**
  * @note JavaScript name: <code>plotOptions-pareto-states-select-halo</code>
  */
class PlotOptionsParetoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsParetoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoStatesSelectHalo {
