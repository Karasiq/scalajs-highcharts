...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-marker-states</code>
  */
class SeriesAroonMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAroonMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
