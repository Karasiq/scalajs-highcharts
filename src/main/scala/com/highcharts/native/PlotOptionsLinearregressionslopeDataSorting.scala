...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-dataSorting</code>
  */
class PlotOptionsLinearregressionslopeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLinearregressionslopeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeDataSorting {
