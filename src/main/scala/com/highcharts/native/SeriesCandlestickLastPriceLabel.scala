...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-lastPrice-label</code>
  */
class SeriesCandlestickLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickLastPriceLabel {
  /**
