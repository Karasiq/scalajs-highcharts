...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-dataGrouping</code>
  */
class SeriesAdDataGrouping extends com.highcharts.HighchartsGenericObject {
