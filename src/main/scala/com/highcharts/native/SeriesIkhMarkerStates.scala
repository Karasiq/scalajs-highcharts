...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-marker-states</code>
  */
class SeriesIkhMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesIkhMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
