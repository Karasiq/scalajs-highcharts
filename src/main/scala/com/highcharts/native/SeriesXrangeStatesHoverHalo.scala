...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-states-hover-halo</code>
  */
class SeriesXrangeStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesXrangeStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeStatesHoverHalo {
