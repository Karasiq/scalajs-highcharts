...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-states-select</code>
  */
class PlotOptionsHeikinashiStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsHeikinashiStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiStatesSelect {
