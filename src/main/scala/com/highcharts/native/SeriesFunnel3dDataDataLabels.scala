...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-dataLabels</code>
  */
class SeriesFunnel3dDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataDataLabels {
  /**
