...
/**
  * @note JavaScript name: <code>plotOptions-dmi-states</code>
  */
class PlotOptionsDmiStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDmiStatesSelect]] = js.undefined
}

object PlotOptionsDmiStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDmiStatesSelect]] = js.undefined): PlotOptionsDmiStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiStates {
      this.hover = hover
