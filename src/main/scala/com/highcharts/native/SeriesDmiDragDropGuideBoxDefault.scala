...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dragDrop-guideBox-default</code>
  */
class SeriesDmiDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesDmiDragDropGuideBoxDefault = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiDragDropGuideBoxDefault {
