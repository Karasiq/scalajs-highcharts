...
class SeriesMapData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesMapDataEvents]] = js.undefined
  ...
  /**
    ...
    * @since 9.3.0
    */
  var geometry: js.UndefOr[CleanJsObject[SeriesMapDataGeometry]] = js.undefined
...
object SeriesMapData {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesMapDataEvents]] = js.undefined, geometry: js.UndefOr[CleanJsObject[SeriesMapDataGeometry]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, middleX: js.UndefOr[Double] = js.undefined, middleY: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, path: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double | Null] = js.undefined): SeriesMapData = {
