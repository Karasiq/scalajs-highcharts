...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-dataLabels</code>
  */
class SeriesStreamgraphDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataLabels {
  /**
