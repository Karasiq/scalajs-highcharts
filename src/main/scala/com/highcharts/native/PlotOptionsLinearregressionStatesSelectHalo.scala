...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-states-select-halo</code>
  */
class PlotOptionsLinearregressionStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionStatesSelectHalo {
