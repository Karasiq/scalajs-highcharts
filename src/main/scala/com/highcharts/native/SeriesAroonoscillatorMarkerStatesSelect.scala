...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-marker-states-select</code>
  */
class SeriesAroonoscillatorMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorMarkerStatesSelect {
