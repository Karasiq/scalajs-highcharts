...
/**
  ...
  */
class PlotOptionsHeatmapStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined): PlotOptionsHeatmapStatesNormal = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapStatesNormal {
