...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-states-select-halo</code>
  */
class SeriesSankeyStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSankeyStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyStatesSelectHalo {
