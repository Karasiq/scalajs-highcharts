...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-states</code>
  */
class PlotOptionsWilliamsrStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsWilliamsrStatesSelect]] = js.undefined
}

object PlotOptionsWilliamsrStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsWilliamsrStatesSelect]] = js.undefined): PlotOptionsWilliamsrStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrStates {
      this.hover = hover
