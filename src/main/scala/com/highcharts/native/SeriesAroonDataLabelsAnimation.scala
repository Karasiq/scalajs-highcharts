...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dataLabels-animation</code>
  */
class SeriesAroonDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAroonDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonDataLabelsAnimation {
      this.defer = defer
    })
  }
}
