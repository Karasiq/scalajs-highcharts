...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-dataLabels-filter</code>
  */
class SeriesGaugeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesGaugeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataLabelsFilter {
