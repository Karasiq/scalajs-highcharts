...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-data-dataLabels-filter</code>
  */
class SeriesSankeyDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSankeyDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataDataLabelsFilter {
