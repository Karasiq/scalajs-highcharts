...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-dataSorting</code>
  */
class SeriesMomentumDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMomentumDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumDataSorting {
