...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-accessibility-point</code>
  */
class SeriesOrganizationAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesOrganizationAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationAccessibilityPoint {
