...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-dataLabels-filter</code>
  */
class SeriesVennDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVennDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennDataLabelsFilter {
