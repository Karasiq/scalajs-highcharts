...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-inactive</code>
  */
class SeriesOhlcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesOhlcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesInactive {
