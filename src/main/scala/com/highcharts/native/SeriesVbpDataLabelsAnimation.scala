...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-dataLabels-animation</code>
  */
class SeriesVbpDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVbpDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpDataLabelsAnimation {
      this.defer = defer
    })
  }
}
