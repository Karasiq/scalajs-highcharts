...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-dataLabels-animation</code>
  */
class PlotOptionsWaterfallDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsWaterfallDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallDataLabelsAnimation {
      this.defer = defer
    })
  }
}
