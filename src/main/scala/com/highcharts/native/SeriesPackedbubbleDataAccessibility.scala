...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data-accessibility</code>
  */
class SeriesPackedbubbleDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPackedbubbleDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleDataAccessibility {
