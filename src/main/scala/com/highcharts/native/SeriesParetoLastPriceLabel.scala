...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-lastPrice-label</code>
  */
class SeriesParetoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoLastPriceLabel {
  /**
