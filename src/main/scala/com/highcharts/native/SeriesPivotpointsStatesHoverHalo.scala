...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-hover-halo</code>
  */
class SeriesPivotpointsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPivotpointsStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesHoverHalo {
