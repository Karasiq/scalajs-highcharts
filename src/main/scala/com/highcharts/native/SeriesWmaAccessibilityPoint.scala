...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-accessibility-point</code>
  */
class SeriesWmaAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesWmaAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaAccessibilityPoint {
