...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-dataLabels-animation</code>
  */
class PlotOptionsNetworkgraphDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphDataLabelsAnimation {
      this.defer = defer
    })
  }
}
