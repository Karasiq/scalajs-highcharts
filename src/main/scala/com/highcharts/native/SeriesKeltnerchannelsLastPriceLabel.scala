...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-lastPrice-label</code>
  */
class SeriesKeltnerchannelsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsLastPriceLabel {
  /**
