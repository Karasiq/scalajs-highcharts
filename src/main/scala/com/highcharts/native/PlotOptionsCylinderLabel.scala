...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-label</code>
  */
class PlotOptionsCylinderLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderLabel {
  /**
