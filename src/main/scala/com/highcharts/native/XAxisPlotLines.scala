...
/**
  ...
  */
class XAxisPlotLines extends com.highcharts.HighchartsGenericObject {
...
object XAxisPlotLines {
  /**
    ...
    */
  def apply(acrossPanes: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, value: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): XAxisPlotLines = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisPlotLines {
