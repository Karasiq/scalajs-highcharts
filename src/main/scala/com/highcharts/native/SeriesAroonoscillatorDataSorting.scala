...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dataSorting</code>
  */
class SeriesAroonoscillatorDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAroonoscillatorDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorDataSorting {
