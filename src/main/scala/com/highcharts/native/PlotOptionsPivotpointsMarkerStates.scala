...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-marker-states</code>
  */
class PlotOptionsPivotpointsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPivotpointsMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
