...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-connectors</code>
  */
class SeriesColumnpyramidConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesColumnpyramidConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesColumnpyramidConnectorsStartMarker]] = js.undefined
...
object SeriesColumnpyramidConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesColumnpyramidConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesColumnpyramidConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesColumnpyramidConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidConnectors {
