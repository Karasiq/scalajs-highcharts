...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-dataSorting</code>
  */
class SeriesAreasplinerangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAreasplinerangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataSorting {
