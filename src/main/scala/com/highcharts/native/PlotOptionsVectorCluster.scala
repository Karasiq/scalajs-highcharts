...
/**
  * @note JavaScript name: <code>plotOptions-vector-cluster</code>
  */
class PlotOptionsVectorCluster extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorCluster {
  /**
