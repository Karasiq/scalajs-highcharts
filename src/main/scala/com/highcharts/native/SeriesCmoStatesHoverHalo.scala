...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-states-hover-halo</code>
  */
class SeriesCmoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesCmoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoStatesHoverHalo {
