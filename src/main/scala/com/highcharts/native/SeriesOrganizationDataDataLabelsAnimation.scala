...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-data-dataLabels-animation</code>
  */
class SeriesOrganizationDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesOrganizationDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
