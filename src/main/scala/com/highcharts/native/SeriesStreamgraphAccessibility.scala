...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-accessibility</code>
  */
class SeriesStreamgraphAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesStreamgraphAccessibilityPoint]] = js.undefined
}

object SeriesStreamgraphAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesStreamgraphAccessibilityPoint]] = js.undefined): SeriesStreamgraphAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphAccessibility {
