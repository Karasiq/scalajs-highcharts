...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dataLabels-filter</code>
  */
class PlotOptionsHeikinashiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHeikinashiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiDataLabelsFilter {
