...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-nodes-dataLabels</code>
  */
class SeriesOrganizationNodesDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationNodesDataLabels {
  /**
