...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-lastPrice-label</code>
  */
class PlotOptionsMapbubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleLastPriceLabel {
  /**
