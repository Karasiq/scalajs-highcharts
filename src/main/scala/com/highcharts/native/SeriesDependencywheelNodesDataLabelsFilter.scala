...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-nodes-dataLabels-filter</code>
  */
class SeriesDependencywheelNodesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelNodesDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDependencywheelNodesDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelNodesDataLabelsFilter {
