...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dataLabels</code>
  */
class PlotOptionsScatter3dDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDataLabels {
  /**
