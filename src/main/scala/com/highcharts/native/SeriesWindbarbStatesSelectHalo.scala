...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-states-select-halo</code>
  */
class SeriesWindbarbStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWindbarbStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbStatesSelectHalo {
