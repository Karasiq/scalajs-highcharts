...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-states-hover-halo</code>
  */
class SeriesPpoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPpoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoStatesHoverHalo {
