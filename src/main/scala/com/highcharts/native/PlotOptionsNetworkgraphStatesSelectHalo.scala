...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-states-select-halo</code>
  */
class PlotOptionsNetworkgraphStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphStatesSelectHalo {
