...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-dataSorting</code>
  */
class PlotOptionsAreasplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAreasplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineDataSorting {
