...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-lastPrice-label</code>
  */
class PlotOptionsNetworkgraphLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphLastPriceLabel {
  /**
