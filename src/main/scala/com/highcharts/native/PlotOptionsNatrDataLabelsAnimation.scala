...
/**
  * @note JavaScript name: <code>plotOptions-natr-dataLabels-animation</code>
  */
class PlotOptionsNatrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsNatrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
