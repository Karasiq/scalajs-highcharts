...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-dataLabels</code>
  */
class SeriesPsarDataLabels extends com.highcharts.HighchartsGenericObject {
