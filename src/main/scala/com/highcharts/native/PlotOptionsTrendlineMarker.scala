...
/**
  * @note JavaScript name: <code>plotOptions-trendline-marker</code>
  */
class PlotOptionsTrendlineMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineMarker {
  /**
