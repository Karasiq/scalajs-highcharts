...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dataLabels-filter</code>
  */
class SeriesNatrDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesNatrDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrDataLabelsFilter {
