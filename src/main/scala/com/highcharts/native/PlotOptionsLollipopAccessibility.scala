...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-accessibility</code>
  */
class PlotOptionsLollipopAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLollipopAccessibilityPoint]] = js.undefined
}

object PlotOptionsLollipopAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLollipopAccessibilityPoint]] = js.undefined): PlotOptionsLollipopAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopAccessibility {
