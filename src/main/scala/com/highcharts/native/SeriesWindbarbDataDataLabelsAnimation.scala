...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-dataLabels-animation</code>
  */
class SeriesWindbarbDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWindbarbDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
