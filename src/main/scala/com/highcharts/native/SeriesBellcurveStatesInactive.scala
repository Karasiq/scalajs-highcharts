...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-states-inactive</code>
  */
class SeriesBellcurveStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBellcurveStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveStatesInactive {
