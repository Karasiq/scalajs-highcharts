...
class SeriesSankeyStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesSankeyStatesSelect]] = js.undefined
...
object SeriesSankeyStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesSankeyStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesSankeyStates = {
