...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-label</code>
  */
class PlotOptionsPackedbubbleLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleLabel {
  /**
