...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-data-dataLabels</code>
  */
class SeriesSplineDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataDataLabels {
  /**
