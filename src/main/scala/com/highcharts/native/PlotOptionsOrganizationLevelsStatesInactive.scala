...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-states-inactive</code>
  */
class PlotOptionsOrganizationLevelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLevelsStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationLevelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevelsStatesInactive {
