...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-accessibility</code>
  */
class SeriesMfiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMfiAccessibilityPoint]] = js.undefined
}

object SeriesMfiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMfiAccessibilityPoint]] = js.undefined): SeriesMfiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiAccessibility {
