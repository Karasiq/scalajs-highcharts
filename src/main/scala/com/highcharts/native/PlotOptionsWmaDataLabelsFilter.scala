...
/**
  * @note JavaScript name: <code>plotOptions-wma-dataLabels-filter</code>
  */
class PlotOptionsWmaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWmaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaDataLabelsFilter {
