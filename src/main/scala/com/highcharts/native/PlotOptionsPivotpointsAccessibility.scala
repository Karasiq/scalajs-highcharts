...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-accessibility</code>
  */
class PlotOptionsPivotpointsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPivotpointsAccessibilityPoint]] = js.undefined
}

object PlotOptionsPivotpointsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPivotpointsAccessibilityPoint]] = js.undefined): PlotOptionsPivotpointsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsAccessibility {
