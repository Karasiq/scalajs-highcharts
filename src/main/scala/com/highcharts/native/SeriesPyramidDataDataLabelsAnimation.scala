...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-data-dataLabels-animation</code>
  */
class SeriesPyramidDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPyramidDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
