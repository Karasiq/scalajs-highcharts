...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states-hover-halo</code>
  */
class SeriesPyramid3dStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPyramid3dStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStatesHoverHalo {
