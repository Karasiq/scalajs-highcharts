...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-states-inactive</code>
  */
class SeriesMapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStatesInactive {
