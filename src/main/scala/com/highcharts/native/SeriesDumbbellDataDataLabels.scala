...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-dataLabels</code>
  */
class SeriesDumbbellDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataDataLabels {
  /**
