...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-dragDrop-dragHandle</code>
  */
class PlotOptionsPyramid3dDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsPyramid3dDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dDragDropDragHandle {
