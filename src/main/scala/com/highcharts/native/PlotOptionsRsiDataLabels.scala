...
/**
  * @note JavaScript name: <code>plotOptions-rsi-dataLabels</code>
  */
class PlotOptionsRsiDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiDataLabels {
  /**
