...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-point-events</code>
  */
class SeriesColumnpyramidPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesColumnpyramidPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidPointEvents {
      this.click = click
      this.drag = drag
