...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-states-hover-halo</code>
  */
class PlotOptionsSupertrendStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendStatesHoverHalo {
