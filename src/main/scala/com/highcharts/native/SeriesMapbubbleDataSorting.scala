...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-dataSorting</code>
  */
class SeriesMapbubbleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMapbubbleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleDataSorting {
