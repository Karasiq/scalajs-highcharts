...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-params</code>
  */
class PlotOptionsLinearregressionslopeParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionslopeParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeParams {
