...
/**
  * @note JavaScript name: <code>plotOptions-spline-accessibility</code>
  */
class PlotOptionsSplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSplineAccessibilityPoint]] = js.undefined
}

object PlotOptionsSplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSplineAccessibilityPoint]] = js.undefined): PlotOptionsSplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineAccessibility {
