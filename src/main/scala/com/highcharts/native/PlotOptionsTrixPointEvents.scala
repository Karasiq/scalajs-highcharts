...
/**
  * @note JavaScript name: <code>plotOptions-trix-point-events</code>
  */
class PlotOptionsTrixPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsTrixPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixPointEvents {
      this.click = click
      this.drag = drag
