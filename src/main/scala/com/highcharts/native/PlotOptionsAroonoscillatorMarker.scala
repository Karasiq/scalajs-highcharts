...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-marker</code>
  */
class PlotOptionsAroonoscillatorMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorMarker {
  /**
