...
/**
  * @note JavaScript name: <code>plotOptions-trix-states-select-halo</code>
  */
class PlotOptionsTrixStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTrixStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixStatesSelectHalo {
