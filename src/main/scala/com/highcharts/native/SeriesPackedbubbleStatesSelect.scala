...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states-select</code>
  */
class SeriesPackedbubbleStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesSelectMarker]] = js.undefined
}

object SeriesPackedbubbleStatesSelect {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Any] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesSelectMarker]] = js.undefined): SeriesPackedbubbleStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStatesSelect {
