...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-accessibility</code>
  */
class PlotOptionsLinearregressioninterceptAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressioninterceptAccessibilityPoint]] = js.undefined
}

object PlotOptionsLinearregressioninterceptAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressioninterceptAccessibilityPoint]] = js.undefined): PlotOptionsLinearregressioninterceptAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptAccessibility {
