...
/**
  * @note JavaScript name: <code>plotOptions-sankey-levels-states-inactive</code>
  */
class PlotOptionsSankeyLevelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyLevelsStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyLevelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyLevelsStatesInactive {
