...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-zones</code>
  */
class SeriesBarZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBarZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarZones {
