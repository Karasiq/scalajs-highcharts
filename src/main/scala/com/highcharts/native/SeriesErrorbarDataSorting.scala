...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-dataSorting</code>
  */
class SeriesErrorbarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesErrorbarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarDataSorting {
