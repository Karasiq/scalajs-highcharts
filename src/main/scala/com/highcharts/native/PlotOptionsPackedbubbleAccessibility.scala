...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-accessibility</code>
  */
class PlotOptionsPackedbubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleAccessibilityPoint]] = js.undefined
}

object PlotOptionsPackedbubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleAccessibilityPoint]] = js.undefined): PlotOptionsPackedbubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleAccessibility {
