...
/**
  * @note JavaScript name: <code>plotOptions-bar-dataLabels-filter</code>
  */
class PlotOptionsBarDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBarDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarDataLabelsFilter {
