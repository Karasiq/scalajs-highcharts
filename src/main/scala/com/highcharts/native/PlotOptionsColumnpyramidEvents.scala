...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-events</code>
  */
class PlotOptionsColumnpyramidEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnpyramidEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidEvents {
