...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-states-select-halo</code>
  */
class PlotOptionsChaikinStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinStatesSelectHalo {
