...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-accessibility</code>
  */
class SeriesGanttAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesGanttAccessibilityPoint]] = js.undefined
}

object SeriesGanttAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesGanttAccessibilityPoint]] = js.undefined): SeriesGanttAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttAccessibility {
