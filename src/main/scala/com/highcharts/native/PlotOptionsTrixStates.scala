...
/**
  * @note JavaScript name: <code>plotOptions-trix-states</code>
  */
class PlotOptionsTrixStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsTrixStatesSelect]] = js.undefined
}

object PlotOptionsTrixStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsTrixStatesSelect]] = js.undefined): PlotOptionsTrixStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixStates {
      this.hover = hover
