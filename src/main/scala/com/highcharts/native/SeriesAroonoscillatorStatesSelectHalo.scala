...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-states-select-halo</code>
  */
class SeriesAroonoscillatorStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorStatesSelectHalo {
