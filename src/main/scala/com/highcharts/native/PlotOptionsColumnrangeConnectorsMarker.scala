...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-connectors-marker</code>
  */
class PlotOptionsColumnrangeConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsColumnrangeConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeConnectorsMarker {
      this.align = align
      this.color = color
