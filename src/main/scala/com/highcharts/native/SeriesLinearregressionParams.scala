...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-params</code>
  */
class SeriesLinearregressionParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesLinearregressionParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionParams {
