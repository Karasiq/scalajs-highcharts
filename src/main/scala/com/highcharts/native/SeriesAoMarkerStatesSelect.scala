...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-marker-states-select</code>
  */
class SeriesAoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoMarkerStatesSelect {
