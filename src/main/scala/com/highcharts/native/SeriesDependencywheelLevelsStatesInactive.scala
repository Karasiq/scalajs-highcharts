...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-states-inactive</code>
  */
class SeriesDependencywheelLevelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLevelsStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDependencywheelLevelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevelsStatesInactive {
