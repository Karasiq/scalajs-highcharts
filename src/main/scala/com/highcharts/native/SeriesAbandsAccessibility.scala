...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-accessibility</code>
  */
class SeriesAbandsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAbandsAccessibilityPoint]] = js.undefined
}

object SeriesAbandsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAbandsAccessibilityPoint]] = js.undefined): SeriesAbandsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsAccessibility {
