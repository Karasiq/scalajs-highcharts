...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dataLabels-filter</code>
  */
class SeriesHlcDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHlcDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataLabelsFilter {
