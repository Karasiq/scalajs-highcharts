...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-dataSorting</code>
  */
class SeriesVectorDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesVectorDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataSorting {
