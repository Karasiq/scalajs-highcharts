...
/**
  * @note JavaScript name: <code>plotOptions-pareto-states-inactive</code>
  */
class PlotOptionsParetoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsParetoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoStatesInactive {
