...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-connectors</code>
  */
class SeriesLinearregressionConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesLinearregressionConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesLinearregressionConnectorsStartMarker]] = js.undefined
...
object SeriesLinearregressionConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesLinearregressionConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesLinearregressionConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesLinearregressionConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionConnectors {
