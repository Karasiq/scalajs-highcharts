...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-dataSorting</code>
  */
class PlotOptionsWilliamsrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsWilliamsrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrDataSorting {
