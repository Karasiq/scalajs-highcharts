...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-accessibility-point</code>
  */
class SeriesMapbubbleAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesMapbubbleAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleAccessibilityPoint {
