...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-zones</code>
  */
class PlotOptionsOhlcZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOhlcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsOhlcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcZones {
