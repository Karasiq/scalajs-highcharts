...
/**
  * @note JavaScript name: <code>plotOptions-dema-states-select-halo</code>
  */
class PlotOptionsDemaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDemaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaStatesSelectHalo {
