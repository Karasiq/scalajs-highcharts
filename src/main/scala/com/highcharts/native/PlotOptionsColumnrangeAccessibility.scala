...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-accessibility</code>
  */
class PlotOptionsColumnrangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsColumnrangeAccessibilityPoint]] = js.undefined
}

object PlotOptionsColumnrangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsColumnrangeAccessibilityPoint]] = js.undefined): PlotOptionsColumnrangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeAccessibility {
