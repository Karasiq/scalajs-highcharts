...
/**
  * @note JavaScript name: <code>plotOptions-wma-accessibility</code>
  */
class PlotOptionsWmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsWmaAccessibilityPoint]] = js.undefined
}

object PlotOptionsWmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsWmaAccessibilityPoint]] = js.undefined): PlotOptionsWmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaAccessibility {
