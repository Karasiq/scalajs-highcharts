...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-states-hover</code>
  */
class PlotOptionsPyramid3dStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsPyramid3dStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dStatesHover {
