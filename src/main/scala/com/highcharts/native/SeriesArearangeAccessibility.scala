...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-accessibility</code>
  */
class SeriesArearangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesArearangeAccessibilityPoint]] = js.undefined
}

object SeriesArearangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesArearangeAccessibilityPoint]] = js.undefined): SeriesArearangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeAccessibility {
