...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-accessibility-point</code>
  */
class SeriesRsiAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesRsiAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiAccessibilityPoint {
