...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-data-dataLabels</code>
  */
class SeriesSankeyDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataDataLabels {
  /**
