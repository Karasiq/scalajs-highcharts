...
/**
  * @note JavaScript name: <code>plotOptions-treemap-cluster-events</code>
  */
class PlotOptionsTreemapClusterEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapClusterEvents {
  /**
    ...
    */
  def apply(drillToCluster: js.UndefOr[js.Any] = js.undefined): PlotOptionsTreemapClusterEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapClusterEvents {
