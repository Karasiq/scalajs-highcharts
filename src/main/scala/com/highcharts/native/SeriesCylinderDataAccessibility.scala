...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-accessibility</code>
  */
class SeriesCylinderDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesCylinderDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataAccessibility {
