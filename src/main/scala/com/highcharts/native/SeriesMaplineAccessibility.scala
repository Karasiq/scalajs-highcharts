...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-accessibility</code>
  */
class SeriesMaplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMaplineAccessibilityPoint]] = js.undefined
}

object SeriesMaplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMaplineAccessibilityPoint]] = js.undefined): SeriesMaplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineAccessibility {
