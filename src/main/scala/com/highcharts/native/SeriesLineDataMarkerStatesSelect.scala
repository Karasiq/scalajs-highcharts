...
/**
  ...
  */
class SeriesLineDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataMarkerStatesSelect {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLineDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataMarkerStatesSelect {
