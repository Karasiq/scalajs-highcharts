...
/**
  * @note JavaScript name: <code>plotOptions-ppo-marker-states</code>
  */
class PlotOptionsPpoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPpoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
