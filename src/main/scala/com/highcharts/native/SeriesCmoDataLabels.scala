...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dataLabels</code>
  */
class SeriesCmoDataLabels extends com.highcharts.HighchartsGenericObject {
