...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dataLabels-filter</code>
  */
class SeriesAroonDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAroonDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonDataLabelsFilter {
