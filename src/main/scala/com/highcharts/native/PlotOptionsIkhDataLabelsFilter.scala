...
/**
  * @note JavaScript name: <code>plotOptions-ikh-dataLabels-filter</code>
  */
class PlotOptionsIkhDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsIkhDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhDataLabelsFilter {
