...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-dataLabels-animation</code>
  */
class SeriesBbDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBbDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbDataLabelsAnimation {
      this.defer = defer
    })
  }
}
