...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-cluster</code>
  */
class SeriesTreemapCluster extends com.highcharts.HighchartsGenericObject {
