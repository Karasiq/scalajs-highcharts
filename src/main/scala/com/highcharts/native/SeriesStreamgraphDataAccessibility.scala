...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data-accessibility</code>
  */
class SeriesStreamgraphDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesStreamgraphDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataAccessibility {
