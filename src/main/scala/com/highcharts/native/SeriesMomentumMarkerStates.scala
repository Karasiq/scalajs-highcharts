...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-marker-states</code>
  */
class SeriesMomentumMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMomentumMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
