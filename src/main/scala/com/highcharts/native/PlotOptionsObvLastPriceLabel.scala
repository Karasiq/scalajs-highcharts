...
/**
  * @note JavaScript name: <code>plotOptions-obv-lastPrice-label</code>
  */
class PlotOptionsObvLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvLastPriceLabel {
  /**
