...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-marker-states-select</code>
  */
class SeriesWmaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWmaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaMarkerStatesSelect {
