...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-data-dataLabels-filter</code>
  */
class SeriesColumnDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnDataDataLabelsFilter {
