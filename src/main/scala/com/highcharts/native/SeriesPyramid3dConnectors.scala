...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-connectors</code>
  */
class SeriesPyramid3dConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesPyramid3dConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesPyramid3dConnectorsStartMarker]] = js.undefined
...
object SeriesPyramid3dConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesPyramid3dConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesPyramid3dConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesPyramid3dConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dConnectors {
