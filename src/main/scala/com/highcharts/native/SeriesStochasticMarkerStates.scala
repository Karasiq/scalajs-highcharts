...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-marker-states</code>
  */
class SeriesStochasticMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesStochasticMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
