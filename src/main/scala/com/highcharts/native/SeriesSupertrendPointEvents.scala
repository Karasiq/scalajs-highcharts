...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-point-events</code>
  */
class SeriesSupertrendPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesSupertrendPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendPointEvents {
      this.click = click
      this.drag = drag
