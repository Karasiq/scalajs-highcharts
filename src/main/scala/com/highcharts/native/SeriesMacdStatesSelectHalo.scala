...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-states-select-halo</code>
  */
class SeriesMacdStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesMacdStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdStatesSelectHalo {
