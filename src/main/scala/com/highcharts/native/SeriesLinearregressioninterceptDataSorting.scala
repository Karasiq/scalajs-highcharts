...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dataSorting</code>
  */
class SeriesLinearregressioninterceptDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLinearregressioninterceptDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptDataSorting {
