...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-marker</code>
  */
class SeriesLinearregressioninterceptMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptMarker {
  /**
