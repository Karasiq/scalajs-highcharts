...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-accessibility-point</code>
  */
class SeriesPriceenvelopesAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPriceenvelopesAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesAccessibilityPoint {
