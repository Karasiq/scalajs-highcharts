...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dataSorting</code>
  */
class SeriesScatter3dDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesScatter3dDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataSorting {
