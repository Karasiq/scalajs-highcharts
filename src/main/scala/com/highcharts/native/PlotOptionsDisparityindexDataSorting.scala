...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-dataSorting</code>
  */
class PlotOptionsDisparityindexDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsDisparityindexDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexDataSorting {
