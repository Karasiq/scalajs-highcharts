...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-marker</code>
  */
class SeriesPyramid3dMarker extends com.highcharts.HighchartsGenericObject {
