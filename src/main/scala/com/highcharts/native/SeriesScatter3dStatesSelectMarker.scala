...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-select-marker</code>
  */
class SeriesScatter3dStatesSelectMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesSelectMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesScatter3dStatesSelectMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesSelectMarker {
