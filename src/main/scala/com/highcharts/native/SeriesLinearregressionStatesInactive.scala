...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-states-inactive</code>
  */
class SeriesLinearregressionStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesLinearregressionStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionStatesInactive {
