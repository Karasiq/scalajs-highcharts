...
/**
  * @note JavaScript name: <code>navigator-yAxis-stackLabels-animation</code>
  */
class NavigatorYAxisStackLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisStackLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): NavigatorYAxisStackLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisStackLabelsAnimation {
      this.defer = defer
    })
  }
}
