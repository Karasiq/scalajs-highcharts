...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dragDrop</code>
  */
class SeriesCylinderDragDrop extends com.highcharts.HighchartsGenericObject {
