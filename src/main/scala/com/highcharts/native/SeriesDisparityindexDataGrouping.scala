...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dataGrouping</code>
  */
class SeriesDisparityindexDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDataGrouping {
  /**
