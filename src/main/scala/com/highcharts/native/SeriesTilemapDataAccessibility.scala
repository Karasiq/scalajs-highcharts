...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-data-accessibility</code>
  */
class SeriesTilemapDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesTilemapDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapDataAccessibility {
