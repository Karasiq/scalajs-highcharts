...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-dataSorting</code>
  */
class SeriesHeatmapDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesHeatmapDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataSorting {
