...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-states-select-halo</code>
  */
class SeriesRocStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesRocStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocStatesSelectHalo {
