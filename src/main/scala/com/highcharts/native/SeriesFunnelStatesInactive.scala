...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-inactive</code>
  */
class SeriesFunnelStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesFunnelStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesInactive {
