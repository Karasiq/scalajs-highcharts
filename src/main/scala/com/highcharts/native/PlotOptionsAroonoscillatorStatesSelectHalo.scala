...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-states-select-halo</code>
  */
class PlotOptionsAroonoscillatorStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAroonoscillatorStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorStatesSelectHalo {
