...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-marker</code>
  */
class PlotOptionsLinearregressionangleMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleMarker {
  /**
