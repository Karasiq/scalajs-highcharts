...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data</code>
  */
class SeriesLollipopData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesLollipopDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesLollipopDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesLollipopDataEvents]] = js.undefined
...
object SeriesLollipopData {
  /**
    ...
    */
  def apply(connectorColor: js.UndefOr[String] = js.undefined, connectorWidth: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesLollipopDataDataLabels]] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesLollipopDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesLollipopDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined): SeriesLollipopData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopData {
