...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-hover-halo</code>
  */
class PlotOptionsMappointStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsMappointStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesHoverHalo {
