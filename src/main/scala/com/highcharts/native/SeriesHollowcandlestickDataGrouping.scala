...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-dataGrouping</code>
  */
class SeriesHollowcandlestickDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataGrouping {
  /**
