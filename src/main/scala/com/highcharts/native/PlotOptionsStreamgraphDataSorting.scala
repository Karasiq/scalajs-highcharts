...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-dataSorting</code>
  */
class PlotOptionsStreamgraphDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsStreamgraphDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphDataSorting {
