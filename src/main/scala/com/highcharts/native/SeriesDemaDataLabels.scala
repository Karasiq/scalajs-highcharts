...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dataLabels</code>
  */
class SeriesDemaDataLabels extends com.highcharts.HighchartsGenericObject {
