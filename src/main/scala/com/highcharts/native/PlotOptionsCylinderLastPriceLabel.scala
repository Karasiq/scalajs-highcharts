...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-lastPrice-label</code>
  */
class PlotOptionsCylinderLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderLastPriceLabel {
  /**
