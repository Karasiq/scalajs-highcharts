...
/**
  * @note JavaScript name: <code>plotOptions-apo-params</code>
  */
class PlotOptionsApoParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoParams {
  /**
    ...
    */
  def apply(periods: js.UndefOr[js.Array[Double]] = js.undefined, index: js.UndefOr[Double] = js.undefined): PlotOptionsApoParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoParams {
