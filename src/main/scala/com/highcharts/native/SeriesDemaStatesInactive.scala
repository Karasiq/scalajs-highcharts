...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-states-inactive</code>
  */
class SeriesDemaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDemaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaStatesInactive {
