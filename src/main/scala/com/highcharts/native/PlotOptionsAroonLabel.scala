...
/**
  * @note JavaScript name: <code>plotOptions-aroon-label</code>
  */
class PlotOptionsAroonLabel extends com.highcharts.HighchartsGenericObject {
