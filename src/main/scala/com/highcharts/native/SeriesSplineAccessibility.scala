...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-accessibility</code>
  */
class SeriesSplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSplineAccessibilityPoint]] = js.undefined
}

object SeriesSplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSplineAccessibilityPoint]] = js.undefined): SeriesSplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineAccessibility {
