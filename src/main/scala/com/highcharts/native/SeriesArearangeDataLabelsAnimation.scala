...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-dataLabels-animation</code>
  */
class SeriesArearangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesArearangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
