...
/**
  * @note JavaScript name: <code>plotOptions-gantt-states-inactive</code>
  */
class PlotOptionsGanttStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsGanttStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttStatesInactive {
