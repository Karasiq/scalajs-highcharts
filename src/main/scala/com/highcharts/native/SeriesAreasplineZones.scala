...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-zones</code>
  */
class SeriesAreasplineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreasplineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineZones {
