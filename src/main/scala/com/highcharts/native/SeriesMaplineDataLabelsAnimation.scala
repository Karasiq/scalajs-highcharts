...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-dataLabels-animation</code>
  */
class SeriesMaplineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMaplineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
