...
/**
  * @note JavaScript name: <code>plotOptions-pc-dataLabels-animation</code>
  */
class PlotOptionsPcDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPcDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcDataLabelsAnimation {
      this.defer = defer
    })
  }
}
