...
/**
  * @note JavaScript name: <code>plotOptions-roc-dataLabels-animation</code>
  */
class PlotOptionsRocDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsRocDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocDataLabelsAnimation {
      this.defer = defer
    })
  }
}
