...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-connectors</code>
  */
class SeriesStreamgraphConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesStreamgraphConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesStreamgraphConnectorsStartMarker]] = js.undefined
...
object SeriesStreamgraphConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesStreamgraphConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesStreamgraphConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesStreamgraphConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphConnectors {
