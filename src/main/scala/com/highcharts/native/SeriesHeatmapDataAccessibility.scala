...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-accessibility</code>
  */
class SeriesHeatmapDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHeatmapDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataAccessibility {
