...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-states-hover-halo</code>
  */
class SeriesErrorbarStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesErrorbarStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarStatesHoverHalo {
