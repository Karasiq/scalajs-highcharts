...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-lastPrice-label</code>
  */
class SeriesPyramid3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dLastPriceLabel {
  /**
