...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-zones</code>
  */
class SeriesKeltnerchannelsZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsZones {
