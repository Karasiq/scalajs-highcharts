...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-accessibility-point</code>
  */
class SeriesObvAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesObvAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvAccessibilityPoint {
