...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-dataLabels-animation</code>
  */
class SeriesLineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
