...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-states-inactive</code>
  */
class SeriesIkhStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesIkhStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhStatesInactive {
