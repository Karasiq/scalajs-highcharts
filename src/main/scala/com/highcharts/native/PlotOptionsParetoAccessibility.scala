...
/**
  * @note JavaScript name: <code>plotOptions-pareto-accessibility</code>
  */
class PlotOptionsParetoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsParetoAccessibilityPoint]] = js.undefined
}

object PlotOptionsParetoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsParetoAccessibilityPoint]] = js.undefined): PlotOptionsParetoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoAccessibility {
