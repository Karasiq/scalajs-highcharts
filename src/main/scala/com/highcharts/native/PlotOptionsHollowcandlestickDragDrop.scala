...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dragDrop</code>
  */
class PlotOptionsHollowcandlestickDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickDragDrop {
  /**
