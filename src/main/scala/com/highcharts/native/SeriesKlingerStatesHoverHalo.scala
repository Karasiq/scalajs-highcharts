...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-states-hover-halo</code>
  */
class SeriesKlingerStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesKlingerStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerStatesHoverHalo {
