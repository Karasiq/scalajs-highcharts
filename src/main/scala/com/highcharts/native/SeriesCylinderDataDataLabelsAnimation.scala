...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-dataLabels-animation</code>
  */
class SeriesCylinderDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCylinderDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
