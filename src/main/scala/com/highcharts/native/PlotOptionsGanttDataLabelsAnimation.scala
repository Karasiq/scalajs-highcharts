...
/**
  * @note JavaScript name: <code>plotOptions-gantt-dataLabels-animation</code>
  */
class PlotOptionsGanttDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsGanttDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttDataLabelsAnimation {
      this.defer = defer
    })
  }
}
