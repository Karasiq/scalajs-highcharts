...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data-dataLabels-animation</code>
  */
class SeriesPackedbubbleDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
