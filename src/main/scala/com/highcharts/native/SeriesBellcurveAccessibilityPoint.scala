...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-accessibility-point</code>
  */
class SeriesBellcurveAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesBellcurveAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveAccessibilityPoint {
