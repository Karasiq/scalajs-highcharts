...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-states-inactive</code>
  */
class PlotOptionsWaterfallStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsWaterfallStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWaterfallStatesInactive {
