...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-dataLabels-filter</code>
  */
class SeriesVectorDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVectorDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataLabelsFilter {
