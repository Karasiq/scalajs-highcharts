...
/**
  * @note JavaScript name: <code>annotations-fibonacci-labelOptions</code>
  */
class AnnotationsFibonacciLabelOptions extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsFibonacciLabelOptions {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, y: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, padding: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, text: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined): AnnotationsFibonacciLabelOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsFibonacciLabelOptions {
      this.align = align
