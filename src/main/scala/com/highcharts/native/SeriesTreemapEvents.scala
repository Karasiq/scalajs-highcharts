...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-events</code>
  */
class SeriesTreemapEvents extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Fires on a request for change of root node for the tree, before the
    * update is made. An event object is passed to the function, containing
    * additional properties <code>newRootId</code>, <code>previousRootId</code>, <code>redraw</code> and
    * <code>trigger</code>.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/treemap-events-setrootnode/">Alert update information on setRootNode event.</a>
    * @since 7.0.3
    */
...
object SeriesTreemapEvents {
  /**
    * @param setRootNode <p>Fires on a request for change of root node for the tree, before the. update is made. An event object is passed to the function, containing. additional properties <code>newRootId</code>, <code>previousRootId</code>, <code>redraw</code> and. <code>trigger</code>.</p>
    ...
    */
  def apply(setRootNode: js.UndefOr[js.Function] = js.undefined, afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): SeriesTreemapEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapEvents {
