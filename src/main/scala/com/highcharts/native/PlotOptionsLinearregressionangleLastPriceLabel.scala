...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-lastPrice-label</code>
  */
class PlotOptionsLinearregressionangleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleLastPriceLabel {
  /**
