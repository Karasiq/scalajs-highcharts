...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-zones</code>
  */
class SeriesTemaZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTemaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaZones {
