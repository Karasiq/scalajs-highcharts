...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-cluster-zones-marker</code>
  */
class SeriesTreemapClusterZonesMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapClusterZonesMarker {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesTreemapClusterZonesMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapClusterZonesMarker {
