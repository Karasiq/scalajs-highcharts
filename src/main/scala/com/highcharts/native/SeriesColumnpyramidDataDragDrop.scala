...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-data-dragDrop</code>
  */
class SeriesColumnpyramidDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataDragDrop {
  /**
