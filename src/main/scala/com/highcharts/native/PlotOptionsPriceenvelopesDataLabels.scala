...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-dataLabels</code>
  */
class PlotOptionsPriceenvelopesDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesDataLabels {
  /**
