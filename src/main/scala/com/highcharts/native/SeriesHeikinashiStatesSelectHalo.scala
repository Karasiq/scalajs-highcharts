...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-states-select-halo</code>
  */
class SeriesHeikinashiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHeikinashiStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiStatesSelectHalo {
