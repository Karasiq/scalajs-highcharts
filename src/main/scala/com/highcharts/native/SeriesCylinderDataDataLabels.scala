...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-dataLabels</code>
  */
class SeriesCylinderDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataDataLabels {
  /**
