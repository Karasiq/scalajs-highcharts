...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-marker-states-select</code>
  */
class SeriesWaterfallMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWaterfallMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallMarkerStatesSelect {
