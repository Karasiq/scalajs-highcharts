...
/**
  * @note JavaScript name: <code>plotOptions-flags-lastPrice-label</code>
  */
class PlotOptionsFlagsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsLastPriceLabel {
  /**
