...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-accessibility</code>
  */
class PlotOptionsBoxplotAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBoxplotAccessibilityPoint]] = js.undefined
}

object PlotOptionsBoxplotAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBoxplotAccessibilityPoint]] = js.undefined): PlotOptionsBoxplotAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBoxplotAccessibility {
