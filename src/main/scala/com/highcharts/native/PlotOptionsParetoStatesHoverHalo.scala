...
/**
  * @note JavaScript name: <code>plotOptions-pareto-states-hover-halo</code>
  */
class PlotOptionsParetoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsParetoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoStatesHoverHalo {
