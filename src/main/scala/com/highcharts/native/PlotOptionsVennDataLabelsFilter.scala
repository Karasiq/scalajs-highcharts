...
/**
  * @note JavaScript name: <code>plotOptions-venn-dataLabels-filter</code>
  */
class PlotOptionsVennDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVennDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennDataLabelsFilter {
