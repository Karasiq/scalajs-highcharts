...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-dataLabels-filter</code>
  */
class PlotOptionsLinearregressionangleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionangleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleDataLabelsFilter {
