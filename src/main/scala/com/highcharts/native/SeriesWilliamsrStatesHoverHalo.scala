...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-states-hover-halo</code>
  */
class SeriesWilliamsrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWilliamsrStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrStatesHoverHalo {
