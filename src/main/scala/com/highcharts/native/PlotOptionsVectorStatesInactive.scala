...
/**
  * @note JavaScript name: <code>plotOptions-vector-states-inactive</code>
  */
class PlotOptionsVectorStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsVectorStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorStatesInactive {
