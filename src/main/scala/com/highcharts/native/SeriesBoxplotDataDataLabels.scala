...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-data-dataLabels</code>
  */
class SeriesBoxplotDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataDataLabels {
  /**
