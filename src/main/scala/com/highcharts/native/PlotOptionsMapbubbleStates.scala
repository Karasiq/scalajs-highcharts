...
class PlotOptionsMapbubbleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleStatesSelect]] = js.undefined
}
...
object PlotOptionsMapbubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleStatesSelect]] = js.undefined): PlotOptionsMapbubbleStates = {
