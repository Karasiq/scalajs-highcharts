...
/**
  * @note JavaScript name: <code>plotOptions-ikh-zones</code>
  */
class PlotOptionsIkhZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsIkhZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhZones {
