...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-dataGrouping</code>
  */
class SeriesTreemapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataGrouping {
  /**
