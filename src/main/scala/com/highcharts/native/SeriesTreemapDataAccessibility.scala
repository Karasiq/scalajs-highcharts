...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-data-accessibility</code>
  */
class SeriesTreemapDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesTreemapDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataAccessibility {
