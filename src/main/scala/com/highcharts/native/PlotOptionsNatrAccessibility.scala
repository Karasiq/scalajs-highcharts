...
/**
  * @note JavaScript name: <code>plotOptions-natr-accessibility</code>
  */
class PlotOptionsNatrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsNatrAccessibilityPoint]] = js.undefined
}

object PlotOptionsNatrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsNatrAccessibilityPoint]] = js.undefined): PlotOptionsNatrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrAccessibility {
