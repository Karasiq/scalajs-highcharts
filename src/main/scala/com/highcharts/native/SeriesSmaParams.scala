...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-params</code>
  */
class SeriesSmaParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesSmaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaParams {
      this.index = index
      this.period = period
    })
  }
