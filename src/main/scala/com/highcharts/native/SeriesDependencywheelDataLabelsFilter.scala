...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-dataLabels-filter</code>
  */
class SeriesDependencywheelDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDependencywheelDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelDataLabelsFilter {
