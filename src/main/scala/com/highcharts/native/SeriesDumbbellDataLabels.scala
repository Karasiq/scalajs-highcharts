...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-dataLabels</code>
  */
class SeriesDumbbellDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataLabels {
  /**
