...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-label</code>
  */
class PlotOptionsSupertrendLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendLabel {
  /**
