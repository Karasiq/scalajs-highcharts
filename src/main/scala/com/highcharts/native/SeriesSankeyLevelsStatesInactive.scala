...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-states-inactive</code>
  */
class SeriesSankeyLevelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesSankeyLevelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsStatesInactive {
