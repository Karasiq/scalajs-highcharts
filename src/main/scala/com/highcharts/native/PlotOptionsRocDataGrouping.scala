...
/**
  * @note JavaScript name: <code>plotOptions-roc-dataGrouping</code>
  */
class PlotOptionsRocDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocDataGrouping {
  /**
