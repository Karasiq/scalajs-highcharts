...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-states-hover-halo</code>
  */
class PlotOptionsDumbbellStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellStatesHoverHalo {
