...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-data-dataLabels-filter</code>
  */
class SeriesHollowcandlestickDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataDataLabelsFilter {
