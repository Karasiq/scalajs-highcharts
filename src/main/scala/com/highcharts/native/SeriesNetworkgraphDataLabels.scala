...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-dataLabels</code>
  */
class SeriesNetworkgraphDataLabels extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-format/">Formatted value in the data label</a>
  ...
  /**
    ...
    * @since 7.1.0
    */
  var linkTextPath: js.UndefOr[CleanJsObject[SeriesNetworkgraphDataLabelsLinkTextPath]] = js.undefined
...
object SeriesNetworkgraphDataLabels {
  /**
