...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-dataSorting</code>
  */
class SeriesBellcurveDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesBellcurveDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveDataSorting {
