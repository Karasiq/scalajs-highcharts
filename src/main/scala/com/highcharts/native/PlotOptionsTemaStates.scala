...
/**
  * @note JavaScript name: <code>plotOptions-tema-states</code>
  */
class PlotOptionsTemaStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsTemaStatesSelect]] = js.undefined
}

object PlotOptionsTemaStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsTemaStatesSelect]] = js.undefined): PlotOptionsTemaStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaStates {
      this.hover = hover
