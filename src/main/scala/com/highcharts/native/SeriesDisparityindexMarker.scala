...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-marker</code>
  */
class SeriesDisparityindexMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexMarker {
  /**
