...
/**
  * @note JavaScript name: <code>plotOptions-bullet-dataGrouping</code>
  */
class PlotOptionsBulletDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletDataGrouping {
  /**
