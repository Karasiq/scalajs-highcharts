...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-params</code>
  */
class SeriesAbandsParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesAbandsParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsParams {
      this.index = index
      this.period = period
    })
  }
