...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-states</code>
  */
class SeriesTimelineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesTimelineStatesSelect]] = js.undefined
}

object SeriesTimelineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesTimelineStatesSelect]] = js.undefined): SeriesTimelineStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineStates {
      this.hover = hover
