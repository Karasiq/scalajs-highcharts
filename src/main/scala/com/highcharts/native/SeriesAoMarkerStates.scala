...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-marker-states</code>
  */
class SeriesAoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
