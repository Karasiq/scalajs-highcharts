...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-data-dataLabels-animation</code>
  */
class SeriesVariwideDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVariwideDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
