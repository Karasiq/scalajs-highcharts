...
/**
  * @note JavaScript name: <code>plotOptions-timeline-point-events</code>
  */
class PlotOptionsTimelinePointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelinePointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsTimelinePointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelinePointEvents {
      this.click = click
      this.drag = drag
