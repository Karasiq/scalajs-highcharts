...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dragDrop</code>
  */
class SeriesWilliamsrDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDragDrop {
  /**
