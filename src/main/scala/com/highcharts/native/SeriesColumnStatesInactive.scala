...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-states-inactive</code>
  */
class SeriesColumnStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesColumnStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnStatesInactive {
