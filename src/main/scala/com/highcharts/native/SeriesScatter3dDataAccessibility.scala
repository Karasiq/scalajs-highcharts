...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data-accessibility</code>
  */
class SeriesScatter3dDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesScatter3dDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataAccessibility {
