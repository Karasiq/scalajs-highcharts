...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-dataGrouping</code>
  */
class PlotOptionsTilemapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapDataGrouping {
  /**
