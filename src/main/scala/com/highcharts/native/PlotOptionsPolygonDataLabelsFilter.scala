...
/**
  * @note JavaScript name: <code>plotOptions-polygon-dataLabels-filter</code>
  */
class PlotOptionsPolygonDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonDataLabelsFilter {
