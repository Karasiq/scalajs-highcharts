...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels</code>
  */
class SeriesDependencywheelLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var states: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsStates]] = js.undefined
}

object SeriesDependencywheelLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsDataLabels]] = js.undefined, level: js.UndefOr[Double] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesDependencywheelLevelsStates]] = js.undefined): SeriesDependencywheelLevels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevels {
