...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-marker-states</code>
  */
class SeriesWilliamsrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWilliamsrMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
