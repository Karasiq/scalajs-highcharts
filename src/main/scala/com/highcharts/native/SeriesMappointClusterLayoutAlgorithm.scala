...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-cluster-layoutAlgorithm</code>
  */
class SeriesMappointClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): SeriesMappointClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointClusterLayoutAlgorithm {
