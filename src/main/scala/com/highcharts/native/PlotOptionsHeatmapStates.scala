...
/**
  ...
  */
class PlotOptionsHeatmapStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsHeatmapStatesSelect]] = js.undefined
}
...
object PlotOptionsHeatmapStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsHeatmapStatesSelect]] = js.undefined): PlotOptionsHeatmapStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapStates {
      this.hover = hover
