...
/**
  * @note JavaScript name: <code>plotOptions-flags-accessibility</code>
  */
class PlotOptionsFlagsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsFlagsAccessibilityPoint]] = js.undefined
}

object PlotOptionsFlagsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsFlagsAccessibilityPoint]] = js.undefined): PlotOptionsFlagsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsAccessibility {
