...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-marker-states-select</code>
  */
class SeriesWindbarbMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWindbarbMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbMarkerStatesSelect {
