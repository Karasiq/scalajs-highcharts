...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dataLabels</code>
  */
class PlotOptionsHollowcandlestickDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickDataLabels {
  /**
