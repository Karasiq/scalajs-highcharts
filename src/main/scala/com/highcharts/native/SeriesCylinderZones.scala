...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-zones</code>
  */
class SeriesCylinderZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCylinderZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderZones {
