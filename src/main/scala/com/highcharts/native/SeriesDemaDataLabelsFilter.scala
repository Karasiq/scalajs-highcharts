...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dataLabels-filter</code>
  */
class SeriesDemaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDemaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaDataLabelsFilter {
