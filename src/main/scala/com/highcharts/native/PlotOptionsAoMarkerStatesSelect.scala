...
/**
  * @note JavaScript name: <code>plotOptions-ao-marker-states-select</code>
  */
class PlotOptionsAoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): PlotOptionsAoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoMarkerStatesSelect {
