...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-states-inactive</code>
  */
class SeriesGanttStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesGanttStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttStatesInactive {
