...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-accessibility</code>
  */
class SeriesHistogramAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesHistogramAccessibilityPoint]] = js.undefined
}

object SeriesHistogramAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesHistogramAccessibilityPoint]] = js.undefined): SeriesHistogramAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramAccessibility {
