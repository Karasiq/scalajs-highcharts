...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-zones</code>
  */
class SeriesWilliamsrZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWilliamsrZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrZones {
