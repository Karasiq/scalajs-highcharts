...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-zones</code>
  */
class SeriesXrangeZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesXrangeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeZones {
