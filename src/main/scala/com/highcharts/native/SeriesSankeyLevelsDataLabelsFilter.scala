...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-dataLabels-filter</code>
  */
class SeriesSankeyLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSankeyLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsDataLabelsFilter {
