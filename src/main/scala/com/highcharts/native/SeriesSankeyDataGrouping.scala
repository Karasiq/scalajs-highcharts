...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-dataGrouping</code>
  */
class SeriesSankeyDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataGrouping {
  /**
