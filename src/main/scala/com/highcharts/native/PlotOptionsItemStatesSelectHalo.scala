...
/**
  * @note JavaScript name: <code>plotOptions-item-states-select-halo</code>
  */
class PlotOptionsItemStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsItemStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemStatesSelectHalo {
