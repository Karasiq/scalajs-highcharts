...
/**
  * @note JavaScript name: <code>plotOptions-natr-dataLabels</code>
  */
class PlotOptionsNatrDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrDataLabels {
  /**
