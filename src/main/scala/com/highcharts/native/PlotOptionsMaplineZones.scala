...
/**
  * @note JavaScript name: <code>plotOptions-mapline-zones</code>
  */
class PlotOptionsMaplineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMaplineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineZones {
