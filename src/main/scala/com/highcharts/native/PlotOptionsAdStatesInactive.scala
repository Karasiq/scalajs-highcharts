...
/**
  * @note JavaScript name: <code>plotOptions-ad-states-inactive</code>
  */
class PlotOptionsAdStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAdStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdStatesInactive {
