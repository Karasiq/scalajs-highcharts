...
/**
  * @note JavaScript name: <code>plotOptions-pc-zones</code>
  */
class PlotOptionsPcZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcZones {
