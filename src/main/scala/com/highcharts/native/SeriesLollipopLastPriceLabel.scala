...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-lastPrice-label</code>
  */
class SeriesLollipopLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopLastPriceLabel {
  /**
