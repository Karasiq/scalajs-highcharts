...
/**
  * @note JavaScript name: <code>plotOptions-timeline-states-hover</code>
  */
class PlotOptionsTimelineStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/halo/">Halo options</a>
  ...
  /**
    ...
    * @since 7.0.0
    */
  var marker: js.UndefOr[CleanJsObject[PlotOptionsTimelineStatesHoverMarker]] = js.undefined
}

object PlotOptionsTimelineStatesHover {
  /**
    ...
    */
  def apply(lineWidthPlus: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsTimelineStatesHoverMarker]] = js.undefined): PlotOptionsTimelineStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineStatesHover {
