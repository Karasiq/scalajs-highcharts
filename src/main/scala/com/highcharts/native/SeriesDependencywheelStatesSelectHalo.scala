...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-states-select-halo</code>
  */
class SeriesDependencywheelStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDependencywheelStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelStatesSelectHalo {
