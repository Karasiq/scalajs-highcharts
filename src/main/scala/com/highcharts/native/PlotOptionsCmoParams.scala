...
/**
  * @note JavaScript name: <code>plotOptions-cmo-params</code>
  */
class PlotOptionsCmoParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsCmoParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoParams {
      this.index = index
      this.period = period
    })
  }
