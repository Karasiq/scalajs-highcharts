...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dragDrop</code>
  */
class SeriesKeltnerchannelsDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDragDrop {
  /**
