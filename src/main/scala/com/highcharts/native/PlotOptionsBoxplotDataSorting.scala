...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-dataSorting</code>
  */
class PlotOptionsBoxplotDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsBoxplotDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBoxplotDataSorting {
