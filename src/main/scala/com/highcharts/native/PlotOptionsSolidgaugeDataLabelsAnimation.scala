...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-dataLabels-animation</code>
  */
class PlotOptionsSolidgaugeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSolidgaugeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSolidgaugeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
