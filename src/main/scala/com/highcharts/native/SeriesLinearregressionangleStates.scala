...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-states</code>
  */
class SeriesLinearregressionangleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesLinearregressionangleStatesSelect]] = js.undefined
}

object SeriesLinearregressionangleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesLinearregressionangleStatesSelect]] = js.undefined): SeriesLinearregressionangleStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleStates {
      this.hover = hover
