...
/**
  * @note JavaScript name: <code>plotOptions-scatter-cluster-zones-marker</code>
  */
class PlotOptionsScatterClusterZonesMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterClusterZonesMarker {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsScatterClusterZonesMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterClusterZonesMarker {
