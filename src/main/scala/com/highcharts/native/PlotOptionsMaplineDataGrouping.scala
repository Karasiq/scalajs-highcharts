...
/**
  * @note JavaScript name: <code>plotOptions-mapline-dataGrouping</code>
  */
class PlotOptionsMaplineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineDataGrouping {
  /**
