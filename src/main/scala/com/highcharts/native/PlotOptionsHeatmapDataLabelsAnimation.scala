...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-dataLabels-animation</code>
  */
class PlotOptionsHeatmapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
