...
/**
  * @note JavaScript name: <code>plotOptions-dmi-states-hover-halo</code>
  */
class PlotOptionsDmiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDmiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiStatesHoverHalo {
