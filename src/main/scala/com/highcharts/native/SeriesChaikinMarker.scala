...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-marker</code>
  */
class SeriesChaikinMarker extends com.highcharts.HighchartsGenericObject {
