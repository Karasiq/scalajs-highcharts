...
/**
  * @note JavaScript name: <code>plotOptions-natr-states-select-halo</code>
  */
class PlotOptionsNatrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsNatrStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrStatesSelectHalo {
