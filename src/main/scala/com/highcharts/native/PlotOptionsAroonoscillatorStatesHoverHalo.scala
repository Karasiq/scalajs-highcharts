...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-states-hover-halo</code>
  */
class PlotOptionsAroonoscillatorStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAroonoscillatorStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorStatesHoverHalo {
