...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-accessibility</code>
  */
class PlotOptionsScatter3dAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsScatter3dAccessibilityPoint]] = js.undefined
}

object PlotOptionsScatter3dAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsScatter3dAccessibilityPoint]] = js.undefined): PlotOptionsScatter3dAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dAccessibility {
