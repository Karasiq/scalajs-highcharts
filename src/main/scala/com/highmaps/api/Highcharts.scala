...
trait Highcharts extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/members/setoptions/" target="_blank">Apply a general theme</a>
    */
...
The GeoJSON structure to parse, represented as a JavaScript object rather than a JSON string.
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/demo/geojson/" target="_blank">Simple areas</a>, <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/demo/geojson-multiple-types/" target="_blank">multiple types</a>
    */
