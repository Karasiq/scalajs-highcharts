...
trait Point extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/series/data-id/" target="_blank">Select a point from a button</a>
    */
  def select(select: Boolean = ???, accumulate: Boolean = ???): Unit = js.native

  /**
    * Zoom in on the point using the global animation.
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/members/point-zoomto/" target="_blank">Zoom to points from buttons</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/members/point-remove/" target="_blank">Remove selected points</a>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/members/point-update/" target="_blank">Update area value</a>
    */
