...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dataLabels-filter</code>
  */
class SeriesIkhDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesIkhDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhDataLabelsFilter {
