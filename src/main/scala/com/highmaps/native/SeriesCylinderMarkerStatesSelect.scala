...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-marker-states-select</code>
  */
class SeriesCylinderMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesCylinderMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderMarkerStatesSelect {
