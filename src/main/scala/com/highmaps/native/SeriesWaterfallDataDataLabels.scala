...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-data-dataLabels</code>
  */
class SeriesWaterfallDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataDataLabels {
  /**
