...
/**
  * @note JavaScript name: <code>plotOptions-dpo-states-hover-halo</code>
  */
class PlotOptionsDpoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDpoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoStatesHoverHalo {
