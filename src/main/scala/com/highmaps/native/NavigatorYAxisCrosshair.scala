...
/**
  * @note JavaScript name: <code>navigator-yAxis-crosshair</code>
  */
class NavigatorYAxisCrosshair extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisCrosshair {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[js.Any] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, snap: js.UndefOr[Boolean] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): NavigatorYAxisCrosshair = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisCrosshair {
