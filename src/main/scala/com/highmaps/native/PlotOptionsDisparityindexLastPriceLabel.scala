...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-lastPrice-label</code>
  */
class PlotOptionsDisparityindexLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexLastPriceLabel {
  /**
