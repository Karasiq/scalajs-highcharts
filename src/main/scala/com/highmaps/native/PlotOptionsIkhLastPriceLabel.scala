...
/**
  * @note JavaScript name: <code>plotOptions-ikh-lastPrice-label</code>
  */
class PlotOptionsIkhLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhLastPriceLabel {
  /**
