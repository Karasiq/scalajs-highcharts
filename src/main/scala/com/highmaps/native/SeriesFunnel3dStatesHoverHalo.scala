...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-states-hover-halo</code>
  */
class SeriesFunnel3dStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesFunnel3dStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dStatesHoverHalo {
