...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-label</code>
  */
class SeriesChaikinLabel extends com.highcharts.HighchartsGenericObject {
