...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-states</code>
  */
class PlotOptionsOrganizationLevelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsStatesSelect]] = js.undefined
...
object PlotOptionsOrganizationLevelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsOrganizationLevelsStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsOrganizationLevelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevelsStates {
      this.hover = hover
