...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-lastPrice-label</code>
  */
class SeriesAreaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaLastPriceLabel {
  /**
