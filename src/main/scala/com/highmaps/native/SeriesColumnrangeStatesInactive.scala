...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-states-inactive</code>
  */
class SeriesColumnrangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesColumnrangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeStatesInactive {
