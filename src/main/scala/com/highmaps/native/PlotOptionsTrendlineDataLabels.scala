...
/**
  * @note JavaScript name: <code>plotOptions-trendline-dataLabels</code>
  */
class PlotOptionsTrendlineDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineDataLabels {
  /**
