...
/**
  * @note JavaScript name: <code>plotOptions-natr-dataLabels-filter</code>
  */
class PlotOptionsNatrDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsNatrDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrDataLabelsFilter {
