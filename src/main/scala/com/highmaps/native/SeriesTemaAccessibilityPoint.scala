...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-accessibility-point</code>
  */
class SeriesTemaAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTemaAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaAccessibilityPoint {
