...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-data-dataLabels-filter</code>
  */
class SeriesSplineDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSplineDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataDataLabelsFilter {
