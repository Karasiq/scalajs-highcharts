...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-dataLabels-filter</code>
  */
class PlotOptionsPivotpointsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPivotpointsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsDataLabelsFilter {
