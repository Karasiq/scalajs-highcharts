...
/**
  * @note JavaScript name: <code>plotOptions-treemap-states-inactive</code>
  */
class PlotOptionsTreemapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapStatesInactive {
