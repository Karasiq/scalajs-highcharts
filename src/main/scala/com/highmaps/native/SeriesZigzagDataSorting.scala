...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-dataSorting</code>
  */
class SeriesZigzagDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesZigzagDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagDataSorting {
