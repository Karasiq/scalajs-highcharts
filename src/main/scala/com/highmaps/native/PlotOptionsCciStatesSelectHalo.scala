...
/**
  * @note JavaScript name: <code>plotOptions-cci-states-select-halo</code>
  */
class PlotOptionsCciStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsCciStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciStatesSelectHalo {
