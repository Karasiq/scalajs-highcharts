...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-marker-states</code>
  */
class PlotOptionsDumbbellMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsDumbbellMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
