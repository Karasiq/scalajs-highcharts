...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-accessibility</code>
  */
class SeriesTrixAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTrixAccessibilityPoint]] = js.undefined
}

object SeriesTrixAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTrixAccessibilityPoint]] = js.undefined): SeriesTrixAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixAccessibility {
