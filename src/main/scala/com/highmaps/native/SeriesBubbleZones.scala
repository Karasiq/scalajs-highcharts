...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-zones</code>
  */
class SeriesBubbleZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBubbleZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleZones {
