...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data-dataLabels-animation</code>
  */
class SeriesScatter3dDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesScatter3dDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
