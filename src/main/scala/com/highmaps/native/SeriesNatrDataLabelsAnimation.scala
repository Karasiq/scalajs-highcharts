...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dataLabels-animation</code>
  */
class SeriesNatrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesNatrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
