...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-lastPrice-label</code>
  */
class SeriesNetworkgraphLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphLastPriceLabel {
  /**
