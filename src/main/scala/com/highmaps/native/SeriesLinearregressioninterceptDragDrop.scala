...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dragDrop</code>
  */
class SeriesLinearregressioninterceptDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDragDrop {
  /**
