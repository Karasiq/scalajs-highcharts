...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-dataGrouping</code>
  */
class SeriesSolidgaugeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeDataGrouping {
  /**
