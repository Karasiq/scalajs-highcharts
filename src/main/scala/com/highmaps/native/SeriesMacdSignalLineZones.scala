...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-signalLine-zones</code>
  */
class SeriesMacdSignalLineZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdSignalLineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMacdSignalLineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdSignalLineZones {
