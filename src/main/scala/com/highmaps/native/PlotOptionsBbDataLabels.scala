...
/**
  * @note JavaScript name: <code>plotOptions-bb-dataLabels</code>
  */
class PlotOptionsBbDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbDataLabels {
  /**
