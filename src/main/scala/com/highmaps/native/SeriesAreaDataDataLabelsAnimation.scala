...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-data-dataLabels-animation</code>
  */
class SeriesAreaDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreaDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
