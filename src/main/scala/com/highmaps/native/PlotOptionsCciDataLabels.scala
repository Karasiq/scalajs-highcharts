...
/**
  * @note JavaScript name: <code>plotOptions-cci-dataLabels</code>
  */
class PlotOptionsCciDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciDataLabels {
  /**
