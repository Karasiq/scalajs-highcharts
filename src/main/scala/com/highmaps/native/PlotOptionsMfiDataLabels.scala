...
/**
  * @note JavaScript name: <code>plotOptions-mfi-dataLabels</code>
  */
class PlotOptionsMfiDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiDataLabels {
  /**
