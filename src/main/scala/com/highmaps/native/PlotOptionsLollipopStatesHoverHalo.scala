...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-states-hover-halo</code>
  */
class PlotOptionsLollipopStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopStatesHoverHalo {
