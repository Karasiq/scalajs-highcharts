...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-data-dataLabels</code>
  */
class SeriesPieDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDataDataLabels {
  /**
