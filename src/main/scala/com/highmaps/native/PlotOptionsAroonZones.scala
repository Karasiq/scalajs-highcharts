...
/**
  * @note JavaScript name: <code>plotOptions-aroon-zones</code>
  */
class PlotOptionsAroonZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAroonZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonZones {
