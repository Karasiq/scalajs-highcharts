...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-dataLabels-animation</code>
  */
class PlotOptionsKeltnerchannelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsKeltnerchannelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
