...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states-select-halo</code>
  */
class SeriesPyramid3dStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPyramid3dStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStatesSelectHalo {
