...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-label</code>
  */
class SeriesAroonoscillatorLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorLabel {
  /**
