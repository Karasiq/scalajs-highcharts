...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-dataLabels-animation</code>
  */
class SeriesMfiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMfiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
