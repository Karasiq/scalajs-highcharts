...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-dataLabels-filter</code>
  */
class SeriesTilemapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTilemapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapDataLabelsFilter {
