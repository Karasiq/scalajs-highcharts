...
/**
  * @note JavaScript name: <code>plotOptions-dema-accessibility</code>
  */
class PlotOptionsDemaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDemaAccessibilityPoint]] = js.undefined
}

object PlotOptionsDemaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDemaAccessibilityPoint]] = js.undefined): PlotOptionsDemaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaAccessibility {
