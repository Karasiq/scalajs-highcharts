...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-states-inactive</code>
  */
class SeriesLollipopStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesLollipopStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopStatesInactive {
