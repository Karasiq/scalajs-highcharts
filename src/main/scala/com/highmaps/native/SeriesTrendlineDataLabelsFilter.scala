...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dataLabels-filter</code>
  */
class SeriesTrendlineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTrendlineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineDataLabelsFilter {
