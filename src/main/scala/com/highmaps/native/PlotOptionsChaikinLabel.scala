...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-label</code>
  */
class PlotOptionsChaikinLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinLabel {
  /**
