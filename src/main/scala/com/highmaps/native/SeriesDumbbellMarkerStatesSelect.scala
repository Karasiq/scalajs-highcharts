...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-marker-states-select</code>
  */
class SeriesDumbbellMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDumbbellMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellMarkerStatesSelect {
