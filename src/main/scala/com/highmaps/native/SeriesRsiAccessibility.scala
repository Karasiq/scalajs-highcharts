...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-accessibility</code>
  */
class SeriesRsiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesRsiAccessibilityPoint]] = js.undefined
}

object SeriesRsiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesRsiAccessibilityPoint]] = js.undefined): SeriesRsiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiAccessibility {
