...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-states-inactive</code>
  */
class SeriesBubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleStatesInactive {
