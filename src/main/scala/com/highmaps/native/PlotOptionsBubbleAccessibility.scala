...
/**
  * @note JavaScript name: <code>plotOptions-bubble-accessibility</code>
  */
class PlotOptionsBubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBubbleAccessibilityPoint]] = js.undefined
}

object PlotOptionsBubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBubbleAccessibilityPoint]] = js.undefined): PlotOptionsBubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleAccessibility {
