...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-dataLabels-animation</code>
  */
class SeriesPyramidDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPyramidDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidDataLabelsAnimation {
      this.defer = defer
    })
  }
}
