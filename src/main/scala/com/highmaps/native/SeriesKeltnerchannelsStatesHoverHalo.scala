...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-states-hover-halo</code>
  */
class SeriesKeltnerchannelsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsStatesHoverHalo {
