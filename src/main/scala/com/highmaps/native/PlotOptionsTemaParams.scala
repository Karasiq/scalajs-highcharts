...
/**
  * @note JavaScript name: <code>plotOptions-tema-params</code>
  */
class PlotOptionsTemaParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsTemaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaParams {
      this.index = index
      this.period = period
    })
  }
