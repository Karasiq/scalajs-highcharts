...
/**
  * @note JavaScript name: <code>plotOptions-roc-states-hover-halo</code>
  */
class PlotOptionsRocStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsRocStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocStatesHoverHalo {
