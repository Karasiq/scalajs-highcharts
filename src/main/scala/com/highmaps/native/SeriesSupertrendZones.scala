...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-zones</code>
  */
class SeriesSupertrendZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSupertrendZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendZones {
