...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-marker-states</code>
  */
class SeriesDumbbellMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDumbbellMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
