...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-levels-dataLabels-filter</code>
  */
class SeriesSunburstLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSunburstLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstLevelsDataLabelsFilter {
