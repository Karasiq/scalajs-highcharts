...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-dataSorting</code>
  */
class SeriesWmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesWmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaDataSorting {
