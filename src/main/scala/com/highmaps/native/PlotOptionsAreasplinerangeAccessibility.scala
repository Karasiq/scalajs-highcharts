...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-accessibility</code>
  */
class PlotOptionsAreasplinerangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeAccessibilityPoint]] = js.undefined
}

object PlotOptionsAreasplinerangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeAccessibilityPoint]] = js.undefined): PlotOptionsAreasplinerangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplinerangeAccessibility {
