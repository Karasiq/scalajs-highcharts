...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-dataLabels-animation</code>
  */
class PlotOptionsCylinderDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsCylinderDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderDataLabelsAnimation {
      this.defer = defer
    })
  }
}
