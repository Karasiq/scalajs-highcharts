...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-accessibility</code>
  */
class SeriesWilliamsrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesWilliamsrAccessibilityPoint]] = js.undefined
}

object SeriesWilliamsrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesWilliamsrAccessibilityPoint]] = js.undefined): SeriesWilliamsrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrAccessibility {
