...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-dataSorting</code>
  */
class SeriesCandlestickDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesCandlestickDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataSorting {
