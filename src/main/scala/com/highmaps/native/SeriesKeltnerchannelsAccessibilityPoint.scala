...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-accessibility-point</code>
  */
class SeriesKeltnerchannelsAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesKeltnerchannelsAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsAccessibilityPoint {
