...
/**
  * @note JavaScript name: <code>connectors</code>
  */
class Connectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Enable connectors for this chart. Requires Highcharts Gantt.</p>
    * @since 6.2.0
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[ConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[ConnectorsStartMarker]] = js.undefined
...
object Connectors {
  /**
    ...
    * @param enabled <p>Enable connectors for this chart. Requires Highcharts Gantt.</p>
    ...
    */
  def apply(algorithmMargin: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, endMarker: js.UndefOr[CleanJsObject[ConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[ConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): Connectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new Connectors {
