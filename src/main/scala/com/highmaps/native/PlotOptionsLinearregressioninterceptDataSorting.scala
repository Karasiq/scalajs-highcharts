...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-dataSorting</code>
  */
class PlotOptionsLinearregressioninterceptDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLinearregressioninterceptDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptDataSorting {
