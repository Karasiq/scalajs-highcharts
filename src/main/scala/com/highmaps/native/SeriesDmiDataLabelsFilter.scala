...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dataLabels-filter</code>
  */
class SeriesDmiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDmiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiDataLabelsFilter {
