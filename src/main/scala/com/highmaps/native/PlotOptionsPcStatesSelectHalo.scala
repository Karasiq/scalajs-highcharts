...
/**
  * @note JavaScript name: <code>plotOptions-pc-states-select-halo</code>
  */
class PlotOptionsPcStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPcStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcStatesSelectHalo {
