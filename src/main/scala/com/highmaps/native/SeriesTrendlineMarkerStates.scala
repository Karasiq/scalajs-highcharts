...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-marker-states</code>
  */
class SeriesTrendlineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTrendlineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
