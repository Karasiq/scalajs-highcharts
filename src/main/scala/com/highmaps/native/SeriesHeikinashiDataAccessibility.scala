...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-accessibility</code>
  */
class SeriesHeikinashiDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHeikinashiDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataAccessibility {
