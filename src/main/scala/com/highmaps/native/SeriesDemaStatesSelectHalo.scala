...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-states-select-halo</code>
  */
class SeriesDemaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDemaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaStatesSelectHalo {
