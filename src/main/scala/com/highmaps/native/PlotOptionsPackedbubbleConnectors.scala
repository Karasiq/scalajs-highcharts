...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-connectors</code>
  */
class PlotOptionsPackedbubbleConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleConnectorsStartMarker]] = js.undefined
...
object PlotOptionsPackedbubbleConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsPackedbubbleConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsPackedbubbleConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleConnectors {
