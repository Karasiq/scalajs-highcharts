...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-data-dataLabels-filter</code>
  */
class SeriesWaterfallDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWaterfallDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataDataLabelsFilter {
