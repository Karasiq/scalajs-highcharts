...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data-dragDrop</code>
  */
class SeriesLollipopDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataDragDrop {
  /**
