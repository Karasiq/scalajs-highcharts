...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dataLabels-filter</code>
  */
class SeriesLinearregressioninterceptDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptDataLabelsFilter {
