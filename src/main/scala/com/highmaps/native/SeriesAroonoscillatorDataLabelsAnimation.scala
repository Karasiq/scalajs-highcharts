...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dataLabels-animation</code>
  */
class SeriesAroonoscillatorDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorDataLabelsAnimation {
      this.defer = defer
    })
  }
}
