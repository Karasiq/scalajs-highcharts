...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-dataGrouping</code>
  */
class PlotOptionsDisparityindexDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexDataGrouping {
  /**
