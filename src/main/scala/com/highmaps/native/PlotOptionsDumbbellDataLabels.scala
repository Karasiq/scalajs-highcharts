...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dataLabels</code>
  */
class PlotOptionsDumbbellDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDataLabels {
  /**
