...
/**
  * @note JavaScript name: <code>plotOptions-bar-states-inactive</code>
  */
class PlotOptionsBarStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsBarStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarStatesInactive {
