...
/**
  * @note JavaScript name: <code>plotOptions-aroon-marker-states</code>
  */
class PlotOptionsAroonMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAroonMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
