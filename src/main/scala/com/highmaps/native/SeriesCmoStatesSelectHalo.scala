...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-states-select-halo</code>
  */
class SeriesCmoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesCmoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoStatesSelectHalo {
