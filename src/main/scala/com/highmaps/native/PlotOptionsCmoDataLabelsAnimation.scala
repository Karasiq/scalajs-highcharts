...
/**
  * @note JavaScript name: <code>plotOptions-cmo-dataLabels-animation</code>
  */
class PlotOptionsCmoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsCmoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
