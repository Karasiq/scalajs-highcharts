...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-states-inactive</code>
  */
class PlotOptionsPyramid3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPyramid3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dStatesInactive {
