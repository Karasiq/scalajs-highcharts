...
/**
  * @note JavaScript name: <code>plotOptions-klinger-states-select-halo</code>
  */
class PlotOptionsKlingerStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerStatesSelectHalo {
