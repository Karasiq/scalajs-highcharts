...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-accessibility</code>
  */
class SeriesMomentumAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMomentumAccessibilityPoint]] = js.undefined
}

object SeriesMomentumAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMomentumAccessibilityPoint]] = js.undefined): SeriesMomentumAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumAccessibility {
