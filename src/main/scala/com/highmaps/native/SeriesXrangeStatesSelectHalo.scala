...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-states-select-halo</code>
  */
class SeriesXrangeStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesXrangeStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeStatesSelectHalo {
