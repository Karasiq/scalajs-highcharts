...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-zones</code>
  */
class SeriesBulletZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBulletZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletZones {
