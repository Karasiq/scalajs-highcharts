...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-events</code>
  */
class SeriesAroonEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): SeriesAroonEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonEvents {
