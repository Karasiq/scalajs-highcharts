...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-states-select-halo</code>
  */
class SeriesTemaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTemaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaStatesSelectHalo {
