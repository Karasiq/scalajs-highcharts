...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-accessibility</code>
  */
class PlotOptionsVariablepieAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsVariablepieAccessibilityPoint]] = js.undefined
}

object PlotOptionsVariablepieAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsVariablepieAccessibilityPoint]] = js.undefined): PlotOptionsVariablepieAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariablepieAccessibility {
