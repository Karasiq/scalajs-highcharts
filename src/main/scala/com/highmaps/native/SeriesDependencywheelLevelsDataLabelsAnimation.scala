...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-dataLabels-animation</code>
  */
class SeriesDependencywheelLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDependencywheelLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
