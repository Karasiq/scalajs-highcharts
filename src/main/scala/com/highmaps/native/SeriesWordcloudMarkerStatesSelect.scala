...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-marker-states-select</code>
  */
class SeriesWordcloudMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesWordcloudMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudMarkerStatesSelect {
