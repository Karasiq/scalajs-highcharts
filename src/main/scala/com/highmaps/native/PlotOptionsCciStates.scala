...
class PlotOptionsCciStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsCciStatesSelect]] = js.undefined
}
...
object PlotOptionsCciStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsCciStatesSelect]] = js.undefined): PlotOptionsCciStates = {
