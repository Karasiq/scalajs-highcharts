...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-dataLabels-filter</code>
  */
class SeriesMfiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMfiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiDataLabelsFilter {
