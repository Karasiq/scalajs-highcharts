...
/**
  * @note JavaScript name: <code>plotOptions-mfi-dataSorting</code>
  */
class PlotOptionsMfiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMfiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiDataSorting {
