...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-marker</code>
  */
class PlotOptionsSupertrendMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendMarker {
  /**
