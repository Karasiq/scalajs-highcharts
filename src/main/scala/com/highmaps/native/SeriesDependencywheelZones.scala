...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-zones</code>
  */
class SeriesDependencywheelZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDependencywheelZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelZones {
