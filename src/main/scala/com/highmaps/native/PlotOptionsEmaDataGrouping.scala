...
/**
  * @note JavaScript name: <code>plotOptions-ema-dataGrouping</code>
  */
class PlotOptionsEmaDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaDataGrouping {
  /**
