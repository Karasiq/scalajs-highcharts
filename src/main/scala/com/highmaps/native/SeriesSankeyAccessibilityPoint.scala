...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-accessibility-point</code>
  */
class SeriesSankeyAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesSankeyAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyAccessibilityPoint {
