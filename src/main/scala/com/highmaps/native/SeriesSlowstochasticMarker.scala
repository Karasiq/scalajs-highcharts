...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-marker</code>
  */
class SeriesSlowstochasticMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticMarker {
  /**
