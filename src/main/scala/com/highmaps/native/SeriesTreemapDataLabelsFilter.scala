...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-dataLabels-filter</code>
  */
class SeriesTreemapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTreemapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataLabelsFilter {
