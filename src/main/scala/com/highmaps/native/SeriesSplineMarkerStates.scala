...
/**
  ...
  */
class SeriesSplineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSplineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
