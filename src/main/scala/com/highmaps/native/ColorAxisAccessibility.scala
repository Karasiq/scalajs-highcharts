...
/**
  * @note JavaScript name: <code>colorAxis-accessibility</code>
  */
class ColorAxisAccessibility extends com.highcharts.HighchartsGenericObject {
...
object ColorAxisAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, rangeDescription: js.UndefOr[String] = js.undefined): ColorAxisAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ColorAxisAccessibility {
