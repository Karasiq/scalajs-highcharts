...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-states-hover-halo</code>
  */
class SeriesPsarStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPsarStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarStatesHoverHalo {
