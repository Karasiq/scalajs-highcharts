...
/**
  * @note JavaScript name: <code>annotations-pitchfork-typeOptions-outerBackground</code>
  */
class AnnotationsPitchforkTypeOptionsOuterBackground extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsPitchforkTypeOptionsOuterBackground {
  /**
    ...
    */
  def apply(fill: js.UndefOr[String] = js.undefined, strokeWidth: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, ry: js.UndefOr[Double] = js.undefined, snap: js.UndefOr[Double] = js.undefined, src: js.UndefOr[String] = js.undefined, stroke: js.UndefOr[String] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): AnnotationsPitchforkTypeOptionsOuterBackground = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsPitchforkTypeOptionsOuterBackground {
      this.fill = fill
