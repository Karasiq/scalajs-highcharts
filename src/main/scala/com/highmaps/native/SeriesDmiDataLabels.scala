...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dataLabels</code>
  */
class SeriesDmiDataLabels extends com.highcharts.HighchartsGenericObject {
