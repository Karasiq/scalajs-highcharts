...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-dataLabels-filter</code>
  */
class PlotOptionsLinearregressionslopeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionslopeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeDataLabelsFilter {
