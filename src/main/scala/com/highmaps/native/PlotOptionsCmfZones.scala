...
/**
  * @note JavaScript name: <code>plotOptions-cmf-zones</code>
  */
class PlotOptionsCmfZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCmfZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfZones {
