...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dataLabels-filter</code>
  */
class SeriesCmoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCmoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoDataLabelsFilter {
