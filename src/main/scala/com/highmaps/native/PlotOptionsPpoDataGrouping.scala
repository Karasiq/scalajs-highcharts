...
/**
  * @note JavaScript name: <code>plotOptions-ppo-dataGrouping</code>
  */
class PlotOptionsPpoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoDataGrouping {
  /**
