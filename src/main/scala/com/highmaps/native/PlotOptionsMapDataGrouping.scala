...
/**
  * @note JavaScript name: <code>plotOptions-map-dataGrouping</code>
  */
class PlotOptionsMapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapDataGrouping {
  /**
