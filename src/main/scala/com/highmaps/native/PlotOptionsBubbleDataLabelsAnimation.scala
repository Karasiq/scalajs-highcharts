...
/**
  * @note JavaScript name: <code>plotOptions-bubble-dataLabels-animation</code>
  */
class PlotOptionsBubbleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
