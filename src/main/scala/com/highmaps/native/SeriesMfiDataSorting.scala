...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-dataSorting</code>
  */
class SeriesMfiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMfiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiDataSorting {
