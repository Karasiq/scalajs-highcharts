...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-marker-states</code>
  */
class SeriesDisparityindexMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDisparityindexMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
