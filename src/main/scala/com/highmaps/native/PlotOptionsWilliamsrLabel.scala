...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-label</code>
  */
class PlotOptionsWilliamsrLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrLabel {
  /**
