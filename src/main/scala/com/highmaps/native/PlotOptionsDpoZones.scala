...
/**
  * @note JavaScript name: <code>plotOptions-dpo-zones</code>
  */
class PlotOptionsDpoZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDpoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoZones {
