...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-marker</code>
  */
class PlotOptionsSlowstochasticMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticMarker {
  /**
