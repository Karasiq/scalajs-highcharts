...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-dataLabels</code>
  */
class SeriesAtrDataLabels extends com.highcharts.HighchartsGenericObject {
