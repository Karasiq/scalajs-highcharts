...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-point-events</code>
  */
class SeriesPyramid3dPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dPointEvents {
  /**
    ...
    */
  def apply(legendItemClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesPyramid3dPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dPointEvents {
