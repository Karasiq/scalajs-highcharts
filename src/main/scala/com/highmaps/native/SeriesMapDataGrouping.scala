...
/**
  * @note JavaScript name: <code>series&lt;map&gt;-dataGrouping</code>
  */
class SeriesMapDataGrouping extends com.highcharts.HighchartsGenericObject {
