...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-accessibility</code>
  */
class SeriesLinearregressionangleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLinearregressionangleAccessibilityPoint]] = js.undefined
}

object SeriesLinearregressionangleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLinearregressionangleAccessibilityPoint]] = js.undefined): SeriesLinearregressionangleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleAccessibility {
