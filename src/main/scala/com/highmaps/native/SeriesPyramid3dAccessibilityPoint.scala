...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-accessibility-point</code>
  */
class SeriesPyramid3dAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPyramid3dAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dAccessibilityPoint {
