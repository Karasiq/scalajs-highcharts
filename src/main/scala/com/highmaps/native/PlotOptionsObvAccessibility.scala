...
/**
  * @note JavaScript name: <code>plotOptions-obv-accessibility</code>
  */
class PlotOptionsObvAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsObvAccessibilityPoint]] = js.undefined
}

object PlotOptionsObvAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsObvAccessibilityPoint]] = js.undefined): PlotOptionsObvAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvAccessibility {
