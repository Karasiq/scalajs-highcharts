...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-label</code>
  */
class SeriesCylinderLabel extends com.highcharts.HighchartsGenericObject {
