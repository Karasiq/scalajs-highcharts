...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-dataGrouping</code>
  */
class PlotOptionsMappointDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointDataGrouping {
  /**
