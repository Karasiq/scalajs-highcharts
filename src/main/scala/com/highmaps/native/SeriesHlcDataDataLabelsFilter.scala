...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-data-dataLabels-filter</code>
  */
class SeriesHlcDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHlcDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataDataLabelsFilter {
