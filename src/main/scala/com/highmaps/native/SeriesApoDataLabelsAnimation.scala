...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-dataLabels-animation</code>
  */
class SeriesApoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesApoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
