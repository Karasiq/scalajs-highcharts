...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-states-inactive</code>
  */
class SeriesDependencywheelStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDependencywheelStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelStatesInactive {
