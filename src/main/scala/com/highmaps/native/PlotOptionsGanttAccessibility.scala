...
/**
  * @note JavaScript name: <code>plotOptions-gantt-accessibility</code>
  */
class PlotOptionsGanttAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsGanttAccessibilityPoint]] = js.undefined
}

object PlotOptionsGanttAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsGanttAccessibilityPoint]] = js.undefined): PlotOptionsGanttAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttAccessibility {
