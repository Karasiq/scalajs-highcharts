...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-states-inactive</code>
  */
class SeriesFlagsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesFlagsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsStatesInactive {
