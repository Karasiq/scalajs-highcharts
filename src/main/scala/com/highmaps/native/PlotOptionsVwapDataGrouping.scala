...
/**
  * @note JavaScript name: <code>plotOptions-vwap-dataGrouping</code>
  */
class PlotOptionsVwapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapDataGrouping {
  /**
