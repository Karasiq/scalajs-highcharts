...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-connectors</code>
  */
class PlotOptionsDependencywheelConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelConnectorsStartMarker]] = js.undefined
...
object PlotOptionsDependencywheelConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsDependencywheelConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelConnectors {
