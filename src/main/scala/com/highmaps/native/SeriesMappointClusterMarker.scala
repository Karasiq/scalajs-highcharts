...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-cluster-marker</code>
  */
class SeriesMappointClusterMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointClusterMarker {
  /**
    ...
    */
  def apply(lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesMappointClusterMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointClusterMarker {
