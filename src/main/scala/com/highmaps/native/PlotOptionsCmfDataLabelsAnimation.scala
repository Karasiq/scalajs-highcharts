...
/**
  * @note JavaScript name: <code>plotOptions-cmf-dataLabels-animation</code>
  */
class PlotOptionsCmfDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsCmfDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfDataLabelsAnimation {
      this.defer = defer
    })
  }
}
