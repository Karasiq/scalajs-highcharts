...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-accessibility</code>
  */
class SeriesEmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesEmaAccessibilityPoint]] = js.undefined
}

object SeriesEmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesEmaAccessibilityPoint]] = js.undefined): SeriesEmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaAccessibility {
