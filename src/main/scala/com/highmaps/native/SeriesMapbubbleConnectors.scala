...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-connectors</code>
  */
class SeriesMapbubbleConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectorsStartMarker]] = js.undefined
...
object SeriesMapbubbleConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesMapbubbleConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleConnectors {
