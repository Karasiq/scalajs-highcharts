...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-states-select-halo</code>
  */
class SeriesLinearregressioninterceptStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptStatesSelectHalo {
