...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-states-hover-halo</code>
  */
class SeriesHlcStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHlcStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcStatesHoverHalo {
