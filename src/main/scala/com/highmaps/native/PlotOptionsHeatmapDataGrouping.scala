...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-dataGrouping</code>
  */
class PlotOptionsHeatmapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapDataGrouping {
  /**
