...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-accessibility</code>
  */
class SeriesBarAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBarAccessibilityPoint]] = js.undefined
}

object SeriesBarAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBarAccessibilityPoint]] = js.undefined): SeriesBarAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarAccessibility {
