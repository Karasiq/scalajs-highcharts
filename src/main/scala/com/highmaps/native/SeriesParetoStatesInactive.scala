...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-inactive</code>
  */
class SeriesParetoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesParetoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesInactive {
