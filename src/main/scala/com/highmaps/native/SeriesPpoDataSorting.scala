...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-dataSorting</code>
  */
class SeriesPpoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPpoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoDataSorting {
