...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-zones</code>
  */
class SeriesNatrZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesNatrZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrZones {
