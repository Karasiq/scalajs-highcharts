...
/**
  * @note JavaScript name: <code>plotOptions-momentum-dataLabels</code>
  */
class PlotOptionsMomentumDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumDataLabels {
  /**
