...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-states-hover-halo</code>
  */
class SeriesZigzagStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesZigzagStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagStatesHoverHalo {
