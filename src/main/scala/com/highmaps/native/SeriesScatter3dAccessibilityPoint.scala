...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-accessibility-point</code>
  */
class SeriesScatter3dAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesScatter3dAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dAccessibilityPoint {
