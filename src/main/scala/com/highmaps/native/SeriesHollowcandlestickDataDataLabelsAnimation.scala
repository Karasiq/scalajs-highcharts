...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-data-dataLabels-animation</code>
  */
class SeriesHollowcandlestickDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
