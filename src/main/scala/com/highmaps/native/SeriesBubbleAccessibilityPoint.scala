...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-accessibility-point</code>
  */
class SeriesBubbleAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesBubbleAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleAccessibilityPoint {
