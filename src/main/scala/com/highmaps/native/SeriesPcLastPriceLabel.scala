...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-lastPrice-label</code>
  */
class SeriesPcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
