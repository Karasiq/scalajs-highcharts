...
/**
  * @note JavaScript name: <code>plotOptions-sma-states-hover-halo</code>
  */
class PlotOptionsSmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSmaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaStatesHoverHalo {
