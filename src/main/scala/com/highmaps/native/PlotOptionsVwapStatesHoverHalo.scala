...
/**
  * @note JavaScript name: <code>plotOptions-vwap-states-hover-halo</code>
  */
class PlotOptionsVwapStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsVwapStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapStatesHoverHalo {
