...
/**
  * @note JavaScript name: <code>plotOptions-histogram-states-inactive</code>
  */
class PlotOptionsHistogramStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsHistogramStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramStatesInactive {
