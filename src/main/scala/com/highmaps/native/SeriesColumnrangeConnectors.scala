...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-connectors</code>
  */
class SeriesColumnrangeConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesColumnrangeConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesColumnrangeConnectorsStartMarker]] = js.undefined
...
object SeriesColumnrangeConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesColumnrangeConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesColumnrangeConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesColumnrangeConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeConnectors {
