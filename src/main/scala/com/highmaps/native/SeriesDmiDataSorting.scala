...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dataSorting</code>
  */
class SeriesDmiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesDmiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiDataSorting {
