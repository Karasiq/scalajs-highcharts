...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-connectors</code>
  */
class SeriesLinearregressioninterceptConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptConnectorsStartMarker]] = js.undefined
...
object SeriesLinearregressioninterceptConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesLinearregressioninterceptConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptConnectors {
