...
/**
  * @note JavaScript name: <code>plotOptions-mfi-zones</code>
  */
class PlotOptionsMfiZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMfiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiZones {
