...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-marker-states</code>
  */
class SeriesKeltnerchannelsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesKeltnerchannelsMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
