...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-marker-states-select</code>
  */
class SeriesAreasplinerangeMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeMarkerStatesSelect {
