...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-states-inactive</code>
  */
class SeriesZigzagStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesZigzagStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagStatesInactive {
