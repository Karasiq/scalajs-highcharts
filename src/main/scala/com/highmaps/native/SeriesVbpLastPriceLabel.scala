...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-lastPrice-label</code>
  */
class SeriesVbpLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpLastPriceLabel {
  /**
