...
/**
  * @note JavaScript name: <code>plotOptions-item-dataLabels-animation</code>
  */
class PlotOptionsItemDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsItemDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemDataLabelsAnimation {
      this.defer = defer
    })
  }
}
