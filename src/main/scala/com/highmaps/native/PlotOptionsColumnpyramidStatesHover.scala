...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-states-hover</code>
  */
class PlotOptionsColumnpyramidStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsColumnpyramidStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidStatesHover {
