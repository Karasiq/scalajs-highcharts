...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-lastPrice-label</code>
  */
class SeriesStochasticLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticLastPriceLabel {
  /**
