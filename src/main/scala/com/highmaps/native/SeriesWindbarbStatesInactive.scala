...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-states-inactive</code>
  */
class SeriesWindbarbStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesWindbarbStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbStatesInactive {
