...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-states-select-halo</code>
  */
class SeriesRsiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesRsiStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiStatesSelectHalo {
