...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-accessibility</code>
  */
class SeriesBulletAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBulletAccessibilityPoint]] = js.undefined
}

object SeriesBulletAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBulletAccessibilityPoint]] = js.undefined): SeriesBulletAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletAccessibility {
