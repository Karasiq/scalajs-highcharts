...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-states-inactive</code>
  */
class SeriesAreasplineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAreasplineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineStatesInactive {
