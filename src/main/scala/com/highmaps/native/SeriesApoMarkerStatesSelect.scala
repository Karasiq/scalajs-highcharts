...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-marker-states-select</code>
  */
class SeriesApoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesApoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoMarkerStatesSelect {
