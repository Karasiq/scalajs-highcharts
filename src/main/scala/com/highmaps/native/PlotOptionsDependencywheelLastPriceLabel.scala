...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-lastPrice-label</code>
  */
class PlotOptionsDependencywheelLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelLastPriceLabel {
  /**
