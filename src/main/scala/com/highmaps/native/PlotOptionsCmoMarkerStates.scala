...
/**
  * @note JavaScript name: <code>plotOptions-cmo-marker-states</code>
  */
class PlotOptionsCmoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsCmoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
