...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-dataLabels</code>
  */
class PlotOptionsDependencywheelDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelDataLabels {
  /**
