...
/**
  * @note JavaScript name: <code>plotOptions-pie-states-select-marker</code>
  */
class PlotOptionsPieStatesSelectMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieStatesSelectMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsPieStatesSelectMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieStatesSelectMarker {
