...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dataLabels-animation</code>
  */
class SeriesCylinderDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCylinderDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataLabelsAnimation {
      this.defer = defer
    })
  }
}
