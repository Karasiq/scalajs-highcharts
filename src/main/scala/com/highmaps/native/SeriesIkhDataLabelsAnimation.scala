...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-dataLabels-animation</code>
  */
class SeriesIkhDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesIkhDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhDataLabelsAnimation {
      this.defer = defer
    })
  }
}
