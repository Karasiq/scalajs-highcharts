...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-states-select-halo</code>
  */
class SeriesStreamgraphStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesStreamgraphStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphStatesSelectHalo {
