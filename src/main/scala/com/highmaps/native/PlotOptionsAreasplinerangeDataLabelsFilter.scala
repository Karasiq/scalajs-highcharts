...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-dataLabels-filter</code>
  */
class PlotOptionsAreasplinerangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplinerangeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAreasplinerangeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplinerangeDataLabelsFilter {
