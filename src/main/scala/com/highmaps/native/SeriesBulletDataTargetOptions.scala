...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-data-targetOptions</code>
  */
class SeriesBulletDataTargetOptions extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataTargetOptions {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double | String] = js.undefined): SeriesBulletDataTargetOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletDataTargetOptions {
