...
/**
  * @note JavaScript name: <code>plotOptions-pc-dataLabels</code>
  */
class PlotOptionsPcDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcDataLabels {
  /**
