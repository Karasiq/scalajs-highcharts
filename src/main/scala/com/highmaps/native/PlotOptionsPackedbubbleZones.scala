...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-zones</code>
  */
class PlotOptionsPackedbubbleZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleZones {
