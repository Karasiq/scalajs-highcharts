...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-accessibility</code>
  */
class SeriesHollowcandlestickAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesHollowcandlestickAccessibilityPoint]] = js.undefined
}

object SeriesHollowcandlestickAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesHollowcandlestickAccessibilityPoint]] = js.undefined): SeriesHollowcandlestickAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickAccessibility {
