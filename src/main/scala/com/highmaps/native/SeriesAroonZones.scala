...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-zones</code>
  */
class SeriesAroonZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAroonZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonZones {
