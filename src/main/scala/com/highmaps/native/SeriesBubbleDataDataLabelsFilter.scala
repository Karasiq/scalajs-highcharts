...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-dataLabels-filter</code>
  */
class SeriesBubbleDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBubbleDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataDataLabelsFilter {
