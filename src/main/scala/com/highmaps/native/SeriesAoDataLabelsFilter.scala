...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-dataLabels-filter</code>
  */
class SeriesAoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoDataLabelsFilter {
