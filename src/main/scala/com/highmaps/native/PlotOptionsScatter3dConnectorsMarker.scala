...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-connectors-marker</code>
  */
class PlotOptionsScatter3dConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dConnectorsMarker {
      this.align = align
      this.color = color
