...
class SeriesCmfStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesCmfStatesSelect]] = js.undefined
}
...
object SeriesCmfStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesCmfStatesSelect]] = js.undefined): SeriesCmfStates = {
