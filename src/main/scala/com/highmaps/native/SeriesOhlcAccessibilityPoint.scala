...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-accessibility-point</code>
  */
class SeriesOhlcAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesOhlcAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcAccessibilityPoint {
