...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-dataLabels-animation</code>
  */
class SeriesNetworkgraphDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphDataLabelsAnimation {
      this.defer = defer
    })
  }
}
