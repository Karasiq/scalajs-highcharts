...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-states-select-halo</code>
  */
class SeriesAroonStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAroonStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonStatesSelectHalo {
