...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-events</code>
  */
class SeriesNatrEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): SeriesNatrEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrEvents {
