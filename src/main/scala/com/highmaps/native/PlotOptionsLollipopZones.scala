...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-zones</code>
  */
class PlotOptionsLollipopZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopZones {
