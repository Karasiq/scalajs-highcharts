...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-data-dataLabels</code>
  */
class SeriesSunburstDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataDataLabels {
  /**
