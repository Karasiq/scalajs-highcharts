...
/**
  * @note JavaScript name: <code>plotOptions-variwide-lastPrice-label</code>
  */
class PlotOptionsVariwideLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideLastPriceLabel {
  /**
