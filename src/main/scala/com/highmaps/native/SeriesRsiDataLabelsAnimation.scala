...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-dataLabels-animation</code>
  */
class SeriesRsiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesRsiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
