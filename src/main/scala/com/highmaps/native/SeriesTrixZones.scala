...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-zones</code>
  */
class SeriesTrixZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTrixZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixZones {
