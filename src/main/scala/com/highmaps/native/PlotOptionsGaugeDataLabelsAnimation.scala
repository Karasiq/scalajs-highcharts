...
/**
  * @note JavaScript name: <code>plotOptions-gauge-dataLabels-animation</code>
  */
class PlotOptionsGaugeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGaugeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsGaugeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGaugeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
