...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-accessibility</code>
  */
class SeriesWindbarbAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesWindbarbAccessibilityPoint]] = js.undefined
}

object SeriesWindbarbAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesWindbarbAccessibilityPoint]] = js.undefined): SeriesWindbarbAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbAccessibility {
