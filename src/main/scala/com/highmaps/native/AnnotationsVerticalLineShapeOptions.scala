...
/**
  * @note JavaScript name: <code>annotations-verticalLine-shapeOptions</code>
  */
class AnnotationsVerticalLineShapeOptions extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsVerticalLineShapeOptions {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, fill: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, r: js.UndefOr[Double] = js.undefined, ry: js.UndefOr[Double] = js.undefined, snap: js.UndefOr[Double] = js.undefined, src: js.UndefOr[String] = js.undefined, stroke: js.UndefOr[String] = js.undefined, strokeWidth: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String] = "rect", width: js.UndefOr[Double] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): AnnotationsVerticalLineShapeOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsVerticalLineShapeOptions {
