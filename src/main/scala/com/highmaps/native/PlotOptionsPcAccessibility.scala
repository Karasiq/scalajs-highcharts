...
/**
  * @note JavaScript name: <code>plotOptions-pc-accessibility</code>
  */
class PlotOptionsPcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPcAccessibilityPoint]] = js.undefined
}

object PlotOptionsPcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPcAccessibilityPoint]] = js.undefined): PlotOptionsPcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcAccessibility {
