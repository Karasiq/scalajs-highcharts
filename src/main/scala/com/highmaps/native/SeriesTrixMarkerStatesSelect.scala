...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-marker-states-select</code>
  */
class SeriesTrixMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesTrixMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixMarkerStatesSelect {
