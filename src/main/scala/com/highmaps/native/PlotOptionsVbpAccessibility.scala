...
/**
  * @note JavaScript name: <code>plotOptions-vbp-accessibility</code>
  */
class PlotOptionsVbpAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsVbpAccessibilityPoint]] = js.undefined
}

object PlotOptionsVbpAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsVbpAccessibilityPoint]] = js.undefined): PlotOptionsVbpAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpAccessibility {
