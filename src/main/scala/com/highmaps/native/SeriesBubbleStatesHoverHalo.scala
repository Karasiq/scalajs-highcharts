...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-states-hover-halo</code>
  */
class SeriesBubbleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBubbleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleStatesHoverHalo {
      this.size = size
