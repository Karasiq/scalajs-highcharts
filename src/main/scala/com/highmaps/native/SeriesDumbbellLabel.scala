...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-label</code>
  */
class SeriesDumbbellLabel extends com.highcharts.HighchartsGenericObject {
