...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-accessibility</code>
  */
class SeriesXrangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesXrangeAccessibilityPoint]] = js.undefined
}

object SeriesXrangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesXrangeAccessibilityPoint]] = js.undefined): SeriesXrangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeAccessibility {
