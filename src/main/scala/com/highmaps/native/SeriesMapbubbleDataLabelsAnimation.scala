...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-dataLabels-animation</code>
  */
class SeriesMapbubbleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMapbubbleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
