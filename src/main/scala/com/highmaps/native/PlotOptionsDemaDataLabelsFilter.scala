...
/**
  * @note JavaScript name: <code>plotOptions-dema-dataLabels-filter</code>
  */
class PlotOptionsDemaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDemaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaDataLabelsFilter {
