...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dataLabels-filter</code>
  */
class SeriesTemaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTemaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaDataLabelsFilter {
