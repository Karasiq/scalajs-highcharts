...
/**
  * @note JavaScript name: <code>plotOptions-histogram-accessibility</code>
  */
class PlotOptionsHistogramAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsHistogramAccessibilityPoint]] = js.undefined
}

object PlotOptionsHistogramAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsHistogramAccessibilityPoint]] = js.undefined): PlotOptionsHistogramAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramAccessibility {
