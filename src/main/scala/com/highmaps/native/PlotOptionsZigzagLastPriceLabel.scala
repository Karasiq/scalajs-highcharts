...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-lastPrice-label</code>
  */
class PlotOptionsZigzagLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagLastPriceLabel {
  /**
