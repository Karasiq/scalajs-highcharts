...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-accessibility</code>
  */
class SeriesIkhAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesIkhAccessibilityPoint]] = js.undefined
}

object SeriesIkhAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesIkhAccessibilityPoint]] = js.undefined): SeriesIkhAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhAccessibility {
