...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-events</code>
  */
class SeriesHollowcandlestickEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): SeriesHollowcandlestickEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickEvents {
