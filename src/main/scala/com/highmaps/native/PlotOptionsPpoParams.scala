...
/**
  * @note JavaScript name: <code>plotOptions-ppo-params</code>
  */
class PlotOptionsPpoParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoParams {
  /**
    ...
    */
  def apply(periods: js.UndefOr[js.Array[Double]] = js.undefined, index: js.UndefOr[Double] = js.undefined): PlotOptionsPpoParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoParams {
