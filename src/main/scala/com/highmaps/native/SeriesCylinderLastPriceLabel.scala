...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-lastPrice-label</code>
  */
class SeriesCylinderLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderLastPriceLabel {
  /**
