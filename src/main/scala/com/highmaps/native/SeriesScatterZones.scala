...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-zones</code>
  */
class SeriesScatterZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesScatterZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterZones {
