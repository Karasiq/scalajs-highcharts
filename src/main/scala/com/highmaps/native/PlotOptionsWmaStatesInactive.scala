...
/**
  * @note JavaScript name: <code>plotOptions-wma-states-inactive</code>
  */
class PlotOptionsWmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsWmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaStatesInactive {
