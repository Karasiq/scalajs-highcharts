...
class PlotOptionsScatter3dStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsScatter3dStatesSelect]] = js.undefined
}
...
object PlotOptionsScatter3dStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsScatter3dStatesSelect]] = js.undefined): PlotOptionsScatter3dStates = {
