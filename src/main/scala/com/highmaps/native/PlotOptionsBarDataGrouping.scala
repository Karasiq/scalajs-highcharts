...
/**
  * @note JavaScript name: <code>plotOptions-bar-dataGrouping</code>
  */
class PlotOptionsBarDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarDataGrouping {
  /**
