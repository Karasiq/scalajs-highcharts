...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-data-dataLabels-filter</code>
  */
class SeriesPyramidDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPyramidDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidDataDataLabelsFilter {
