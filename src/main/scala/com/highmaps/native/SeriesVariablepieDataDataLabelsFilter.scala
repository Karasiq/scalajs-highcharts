...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-data-dataLabels-filter</code>
  */
class SeriesVariablepieDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVariablepieDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieDataDataLabelsFilter {
