...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dataGrouping</code>
  */
class SeriesFunnel3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataGrouping {
  /**
