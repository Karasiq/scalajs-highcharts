...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-accessibility-point</code>
  */
class SeriesHeikinashiAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesHeikinashiAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiAccessibilityPoint {
