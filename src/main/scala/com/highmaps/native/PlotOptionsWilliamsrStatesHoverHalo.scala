...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-states-hover-halo</code>
  */
class PlotOptionsWilliamsrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrStatesHoverHalo {
