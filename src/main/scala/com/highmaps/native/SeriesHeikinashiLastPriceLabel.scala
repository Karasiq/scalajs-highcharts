...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-lastPrice-label</code>
  */
class SeriesHeikinashiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiLastPriceLabel {
  /**
