...
/**
  * @note JavaScript name: <code>plotOptions-pyramid-dataLabels-animation</code>
  */
class PlotOptionsPyramidDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramidDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPyramidDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramidDataLabelsAnimation {
      this.defer = defer
    })
  }
}
