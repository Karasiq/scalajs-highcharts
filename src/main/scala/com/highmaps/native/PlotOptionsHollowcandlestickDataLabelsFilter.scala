...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dataLabels-filter</code>
  */
class PlotOptionsHollowcandlestickDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHollowcandlestickDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickDataLabelsFilter {
