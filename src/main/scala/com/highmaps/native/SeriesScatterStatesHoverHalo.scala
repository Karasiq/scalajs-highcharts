...
/**
  ...
  */
class SeriesScatterStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesScatterStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterStatesHoverHalo {
