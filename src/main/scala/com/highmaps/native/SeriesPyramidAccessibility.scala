...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-accessibility</code>
  */
class SeriesPyramidAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPyramidAccessibilityPoint]] = js.undefined
}

object SeriesPyramidAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPyramidAccessibilityPoint]] = js.undefined): SeriesPyramidAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidAccessibility {
