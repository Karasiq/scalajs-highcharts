...
/**
  * @note JavaScript name: <code>plotOptions-funnel-dataLabels-animation</code>
  */
class PlotOptionsFunnelDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsFunnelDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelDataLabelsAnimation {
      this.defer = defer
    })
  }
}
