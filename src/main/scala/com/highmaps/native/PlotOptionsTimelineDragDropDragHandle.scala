...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dragDrop-dragHandle</code>
  */
class PlotOptionsTimelineDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineDragDropDragHandle {
