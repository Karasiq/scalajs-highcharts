...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-dataLabels-animation</code>
  */
class SeriesItemDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesItemDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
