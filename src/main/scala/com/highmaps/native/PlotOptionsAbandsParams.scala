...
/**
  * @note JavaScript name: <code>plotOptions-abands-params</code>
  */
class PlotOptionsAbandsParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsParams {
      this.index = index
      this.period = period
    })
  }
