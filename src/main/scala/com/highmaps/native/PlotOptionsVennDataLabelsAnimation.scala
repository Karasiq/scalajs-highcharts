...
/**
  * @note JavaScript name: <code>plotOptions-venn-dataLabels-animation</code>
  */
class PlotOptionsVennDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVennDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVennDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennDataLabelsAnimation {
      this.defer = defer
    })
  }
}
