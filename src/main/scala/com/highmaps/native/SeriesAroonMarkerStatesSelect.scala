...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-marker-states-select</code>
  */
class SeriesAroonMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAroonMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonMarkerStatesSelect {
