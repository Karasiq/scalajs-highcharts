...
/**
  * @note JavaScript name: <code>plotOptions-psar-states-inactive</code>
  */
class PlotOptionsPsarStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPsarStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarStatesInactive {
