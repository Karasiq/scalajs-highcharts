...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-point-events</code>
  */
class PlotOptionsDisparityindexPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsDisparityindexPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexPointEvents {
      this.click = click
      this.drag = drag
