...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-accessibility-point</code>
  */
class SeriesCmoAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesCmoAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoAccessibilityPoint {
