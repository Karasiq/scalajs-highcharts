...
/**
  * @note JavaScript name: <code>annotations-verticalLine-typeOptions-label</code>
  */
class AnnotationsVerticalLineTypeOptionsLabel extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsVerticalLineTypeOptionsLabel {
  /**
    ...
    */
  def apply(allowOverlap: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, offset: js.UndefOr[Double] = js.undefined, overflow: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, text: js.UndefOr[String] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, align: js.UndefOr[String] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, padding: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): AnnotationsVerticalLineTypeOptionsLabel = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsVerticalLineTypeOptionsLabel {
