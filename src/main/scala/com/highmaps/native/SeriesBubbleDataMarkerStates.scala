...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-marker-states</code>
  */
class SeriesBubbleDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesBubbleDataMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
