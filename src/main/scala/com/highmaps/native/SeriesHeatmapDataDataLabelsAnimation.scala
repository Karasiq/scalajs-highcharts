...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-dataLabels-animation</code>
  */
class SeriesHeatmapDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHeatmapDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
