...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-dataLabels-animation</code>
  */
class PlotOptionsSunburstDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSunburstDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstDataLabelsAnimation {
      this.defer = defer
    })
  }
}
