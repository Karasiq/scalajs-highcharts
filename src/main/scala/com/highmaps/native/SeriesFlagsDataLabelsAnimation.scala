...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-dataLabels-animation</code>
  */
class SeriesFlagsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesFlagsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
