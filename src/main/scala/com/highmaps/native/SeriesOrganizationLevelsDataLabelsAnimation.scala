...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-dataLabels-animation</code>
  */
class SeriesOrganizationLevelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesOrganizationLevelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
