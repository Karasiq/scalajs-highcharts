...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-dataLabels-filter</code>
  */
class SeriesMacdDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMacdDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdDataLabelsFilter {
