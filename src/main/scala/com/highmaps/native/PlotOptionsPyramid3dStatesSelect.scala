...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-states-select</code>
  */
class PlotOptionsPyramid3dStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsPyramid3dStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dStatesSelect {
