...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-marker-states-select</code>
  */
class SeriesNetworkgraphMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphMarkerStatesSelect {
