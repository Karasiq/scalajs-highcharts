...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-marker-states-select</code>
  */
class SeriesKlingerMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesKlingerMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerMarkerStatesSelect {
