...
/**
  * @note JavaScript name: <code>plotOptions-wordcloud-lastPrice-label</code>
  */
class PlotOptionsWordcloudLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWordcloudLastPriceLabel {
  /**
