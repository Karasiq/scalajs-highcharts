...
/**
  * @note JavaScript name: <code>plotOptions-bullet-dataLabels-animation</code>
  */
class PlotOptionsBulletDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsBulletDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletDataLabelsAnimation {
      this.defer = defer
    })
  }
}
