...
/**
  * @note JavaScript name: <code>plotOptions-klinger-lastPrice-label</code>
  */
class PlotOptionsKlingerLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerLastPriceLabel {
  /**
