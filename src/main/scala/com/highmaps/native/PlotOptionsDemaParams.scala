...
/**
  * @note JavaScript name: <code>plotOptions-dema-params</code>
  */
class PlotOptionsDemaParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsDemaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaParams {
      this.index = index
      this.period = period
    })
  }
