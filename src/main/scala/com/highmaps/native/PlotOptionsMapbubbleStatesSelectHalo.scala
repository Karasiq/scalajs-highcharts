...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-states-select-halo</code>
  */
class PlotOptionsMapbubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsMapbubbleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleStatesSelectHalo {
