...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data-dataLabels-filter</code>
  */
class SeriesPolygonDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPolygonDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataDataLabelsFilter {
