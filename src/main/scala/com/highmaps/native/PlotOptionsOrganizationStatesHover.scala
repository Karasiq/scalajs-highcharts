...
/**
  * @note JavaScript name: <code>plotOptions-organization-states-hover</code>
  */
class PlotOptionsOrganizationStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationStatesHover {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsOrganizationStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationStatesHover {
