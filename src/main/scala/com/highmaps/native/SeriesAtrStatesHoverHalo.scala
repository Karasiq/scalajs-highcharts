...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-states-hover-halo</code>
  */
class SeriesAtrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAtrStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrStatesHoverHalo {
