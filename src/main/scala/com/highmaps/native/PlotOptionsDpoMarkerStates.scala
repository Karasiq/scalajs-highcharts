...
/**
  * @note JavaScript name: <code>plotOptions-dpo-marker-states</code>
  */
class PlotOptionsDpoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsDpoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
