...
/**
  * @note JavaScript name: <code>plotOptions-ema-marker-states-select</code>
  */
class PlotOptionsEmaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): PlotOptionsEmaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaMarkerStatesSelect {
