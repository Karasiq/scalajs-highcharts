...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-accessibility</code>
  */
class SeriesChaikinAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesChaikinAccessibilityPoint]] = js.undefined
}

object SeriesChaikinAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesChaikinAccessibilityPoint]] = js.undefined): SeriesChaikinAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinAccessibility {
