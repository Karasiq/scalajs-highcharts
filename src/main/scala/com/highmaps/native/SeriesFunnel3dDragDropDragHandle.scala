...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dragDrop-dragHandle</code>
  */
class SeriesFunnel3dDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDragDropDragHandle {
