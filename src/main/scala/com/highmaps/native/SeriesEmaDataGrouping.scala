...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-dataGrouping</code>
  */
class SeriesEmaDataGrouping extends com.highcharts.HighchartsGenericObject {
