...
/**
  * @note JavaScript name: <code>navigator-xAxis-plotLines-events</code>
  */
class NavigatorXAxisPlotLinesEvents extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisPlotLinesEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): NavigatorXAxisPlotLinesEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisPlotLinesEvents {
      this.click = click
