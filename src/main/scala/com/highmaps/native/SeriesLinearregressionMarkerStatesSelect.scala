...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-marker-states-select</code>
  */
class SeriesLinearregressionMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesLinearregressionMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionMarkerStatesSelect {
