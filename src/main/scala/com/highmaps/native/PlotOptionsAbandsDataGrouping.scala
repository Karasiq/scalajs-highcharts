...
/**
  * @note JavaScript name: <code>plotOptions-abands-dataGrouping</code>
  */
class PlotOptionsAbandsDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsDataGrouping {
  /**
