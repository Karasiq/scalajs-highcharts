...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-connectors</code>
  */
class PlotOptionsMapbubbleConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleConnectorsStartMarker]] = js.undefined
...
object PlotOptionsMapbubbleConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsMapbubbleConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleConnectors {
