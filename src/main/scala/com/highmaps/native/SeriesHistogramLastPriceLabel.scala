...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-lastPrice-label</code>
  */
class SeriesHistogramLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramLastPriceLabel {
  /**
