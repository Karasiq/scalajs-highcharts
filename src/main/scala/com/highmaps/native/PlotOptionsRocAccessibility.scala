...
/**
  * @note JavaScript name: <code>plotOptions-roc-accessibility</code>
  */
class PlotOptionsRocAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsRocAccessibilityPoint]] = js.undefined
}

object PlotOptionsRocAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsRocAccessibilityPoint]] = js.undefined): PlotOptionsRocAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocAccessibility {
