...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dataLabels-animation</code>
  */
class SeriesDisparityindexDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDisparityindexDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexDataLabelsAnimation {
      this.defer = defer
    })
  }
}
