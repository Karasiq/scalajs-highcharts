...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-marker-states-select</code>
  */
class SeriesBellcurveMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesBellcurveMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveMarkerStatesSelect {
