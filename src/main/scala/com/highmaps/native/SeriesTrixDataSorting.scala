...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dataSorting</code>
  */
class SeriesTrixDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesTrixDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixDataSorting {
