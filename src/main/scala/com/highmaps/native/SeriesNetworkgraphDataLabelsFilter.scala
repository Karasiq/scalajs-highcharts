...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-dataLabels-filter</code>
  */
class SeriesNetworkgraphDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphDataLabelsFilter {
