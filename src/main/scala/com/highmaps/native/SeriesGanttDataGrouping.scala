...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dataGrouping</code>
  */
class SeriesGanttDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataGrouping {
  /**
