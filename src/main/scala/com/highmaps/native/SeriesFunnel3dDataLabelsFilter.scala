...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dataLabels-filter</code>
  */
class SeriesFunnel3dDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataLabelsFilter {
