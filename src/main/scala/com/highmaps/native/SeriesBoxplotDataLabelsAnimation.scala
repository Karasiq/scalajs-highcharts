...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-dataLabels-animation</code>
  */
class SeriesBoxplotDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBoxplotDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataLabelsAnimation {
      this.defer = defer
    })
  }
}
