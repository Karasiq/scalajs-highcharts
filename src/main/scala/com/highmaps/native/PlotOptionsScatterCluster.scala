...
/**
  * @note JavaScript name: <code>plotOptions-scatter-cluster</code>
  */
class PlotOptionsScatterCluster extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterCluster {
  /**
