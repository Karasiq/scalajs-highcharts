...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-point-events</code>
  */
class PlotOptionsChaikinPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsChaikinPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinPointEvents {
      this.click = click
      this.drag = drag
