...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-lastPrice-label</code>
  */
class PlotOptionsTilemapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapLastPriceLabel {
  /**
