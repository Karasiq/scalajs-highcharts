...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-dataLabels-animation</code>
  */
class SeriesPolygonDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPolygonDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataLabelsAnimation {
      this.defer = defer
    })
  }
}
