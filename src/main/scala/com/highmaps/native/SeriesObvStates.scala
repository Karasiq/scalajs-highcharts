...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-states</code>
  */
class SeriesObvStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesObvStatesSelect]] = js.undefined
}

object SeriesObvStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesObvStatesSelect]] = js.undefined): SeriesObvStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvStates {
      this.hover = hover
