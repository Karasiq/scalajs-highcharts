...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-states-inactive</code>
  */
class SeriesBarStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBarStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarStatesInactive {
