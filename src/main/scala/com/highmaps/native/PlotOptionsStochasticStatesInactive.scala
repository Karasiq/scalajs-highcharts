...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-states-inactive</code>
  */
class PlotOptionsStochasticStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsStochasticStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticStatesInactive {
