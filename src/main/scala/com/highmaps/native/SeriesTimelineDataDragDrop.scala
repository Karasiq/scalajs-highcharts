...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-dragDrop</code>
  */
class SeriesTimelineDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataDragDrop {
  /**
