...
/**
  * @note JavaScript name: <code>plotOptions-natr-marker-states</code>
  */
class PlotOptionsNatrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsNatrMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
