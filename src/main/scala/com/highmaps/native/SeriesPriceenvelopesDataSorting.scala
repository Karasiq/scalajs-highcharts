...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-dataSorting</code>
  */
class SeriesPriceenvelopesDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPriceenvelopesDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesDataSorting {
