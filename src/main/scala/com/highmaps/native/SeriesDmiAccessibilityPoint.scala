...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-accessibility-point</code>
  */
class SeriesDmiAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesDmiAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiAccessibilityPoint {
