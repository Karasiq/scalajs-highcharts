...
/**
  * @note JavaScript name: <code>plotOptions-tema-dataGrouping</code>
  */
class PlotOptionsTemaDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaDataGrouping {
  /**
