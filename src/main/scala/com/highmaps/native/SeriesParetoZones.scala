...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-zones</code>
  */
class SeriesParetoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesParetoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoZones {
