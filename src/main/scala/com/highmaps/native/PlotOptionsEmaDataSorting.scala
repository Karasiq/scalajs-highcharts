...
/**
  * @note JavaScript name: <code>plotOptions-ema-dataSorting</code>
  */
class PlotOptionsEmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsEmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaDataSorting {
