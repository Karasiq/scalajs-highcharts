...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-data-dataLabels-animation</code>
  */
class SeriesSunburstDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSunburstDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
