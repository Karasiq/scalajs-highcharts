...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-data-dataLabels-filter</code>
  */
class SeriesOhlcDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOhlcDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcDataDataLabelsFilter {
