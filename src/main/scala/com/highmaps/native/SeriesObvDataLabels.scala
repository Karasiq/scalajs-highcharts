...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-dataLabels</code>
  */
class SeriesObvDataLabels extends com.highcharts.HighchartsGenericObject {
