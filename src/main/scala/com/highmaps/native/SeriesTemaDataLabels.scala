...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dataLabels</code>
  */
class SeriesTemaDataLabels extends com.highcharts.HighchartsGenericObject {
