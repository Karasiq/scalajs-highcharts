...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-states-select-halo</code>
  */
class PlotOptionsHeatmapStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapStatesSelectHalo {
