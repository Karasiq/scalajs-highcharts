...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-accessibility</code>
  */
class PlotOptionsCylinderAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsCylinderAccessibilityPoint]] = js.undefined
}

object PlotOptionsCylinderAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCylinderAccessibilityPoint]] = js.undefined): PlotOptionsCylinderAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderAccessibility {
