...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-states</code>
  */
class PlotOptionsHollowcandlestickStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsHollowcandlestickStatesSelect]] = js.undefined
...
object PlotOptionsHollowcandlestickStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsHollowcandlestickStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsHollowcandlestickStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickStates {
      this.hover = hover
      this.select = select
