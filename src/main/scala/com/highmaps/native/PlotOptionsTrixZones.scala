...
/**
  * @note JavaScript name: <code>plotOptions-trix-zones</code>
  */
class PlotOptionsTrixZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTrixZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixZones {
