...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-states-inactive</code>
  */
class SeriesCciStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesCciStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciStatesInactive {
