...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-states-inactive</code>
  */
class SeriesAroonoscillatorStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorStatesInactive {
