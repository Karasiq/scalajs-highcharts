...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-dataGrouping</code>
  */
class SeriesBarDataGrouping extends com.highcharts.HighchartsGenericObject {
