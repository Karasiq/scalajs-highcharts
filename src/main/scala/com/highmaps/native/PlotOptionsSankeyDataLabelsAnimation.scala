...
/**
  * @note JavaScript name: <code>plotOptions-sankey-dataLabels-animation</code>
  */
class PlotOptionsSankeyDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyDataLabelsAnimation {
      this.defer = defer
    })
  }
}
