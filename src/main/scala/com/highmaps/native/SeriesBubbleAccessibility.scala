...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-accessibility</code>
  */
class SeriesBubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBubbleAccessibilityPoint]] = js.undefined
}

object SeriesBubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBubbleAccessibilityPoint]] = js.undefined): SeriesBubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleAccessibility {
