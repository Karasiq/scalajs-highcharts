...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-states-select-halo</code>
  */
class SeriesVariablepieStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesVariablepieStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieStatesSelectHalo {
