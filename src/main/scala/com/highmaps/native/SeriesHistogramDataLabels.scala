...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-dataLabels</code>
  */
class SeriesHistogramDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramDataLabels {
  /**
