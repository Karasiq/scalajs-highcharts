...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-marker-states-select</code>
  */
class SeriesSupertrendMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesSupertrendMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendMarkerStatesSelect {
