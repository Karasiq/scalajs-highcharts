...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-dataSorting</code>
  */
class SeriesOhlcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesOhlcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcDataSorting {
