...
/**
  * @note JavaScript name: <code>plotOptions-roc-zones</code>
  */
class PlotOptionsRocZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsRocZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocZones {
