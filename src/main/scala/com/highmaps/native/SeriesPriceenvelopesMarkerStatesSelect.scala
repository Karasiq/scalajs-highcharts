...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-marker-states-select</code>
  */
class SeriesPriceenvelopesMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesPriceenvelopesMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesMarkerStatesSelect {
