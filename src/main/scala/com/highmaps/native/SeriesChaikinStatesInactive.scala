...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-states-inactive</code>
  */
class SeriesChaikinStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesChaikinStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinStatesInactive {
