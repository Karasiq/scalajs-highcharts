...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-marker-states-select</code>
  */
class SeriesVbpMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesVbpMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpMarkerStatesSelect {
