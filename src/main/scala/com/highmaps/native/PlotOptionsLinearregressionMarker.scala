...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-marker</code>
  */
class PlotOptionsLinearregressionMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionMarker {
  /**
