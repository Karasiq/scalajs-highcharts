...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-levels-dataLabels-filter</code>
  */
class PlotOptionsSunburstLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSunburstLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstLevelsDataLabelsFilter {
