...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-dataLabels</code>
  */
class PlotOptionsLinearregressionDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionDataLabels {
  /**
