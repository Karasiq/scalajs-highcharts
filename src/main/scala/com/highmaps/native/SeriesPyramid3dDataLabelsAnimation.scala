...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-dataLabels-animation</code>
  */
class SeriesPyramid3dDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPyramid3dDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataLabelsAnimation {
      this.defer = defer
    })
  }
}
