...
/**
  * @note JavaScript name: <code>plotOptions-macd-states-inactive</code>
  */
class PlotOptionsMacdStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMacdStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdStatesInactive {
