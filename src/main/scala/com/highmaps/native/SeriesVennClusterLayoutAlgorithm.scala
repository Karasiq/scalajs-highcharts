...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-cluster-layoutAlgorithm</code>
  */
class SeriesVennClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): SeriesVennClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennClusterLayoutAlgorithm {
