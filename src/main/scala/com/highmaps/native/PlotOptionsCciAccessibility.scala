...
/**
  * @note JavaScript name: <code>plotOptions-cci-accessibility</code>
  */
class PlotOptionsCciAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsCciAccessibilityPoint]] = js.undefined
}

object PlotOptionsCciAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsCciAccessibilityPoint]] = js.undefined): PlotOptionsCciAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciAccessibility {
