...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-dataGrouping</code>
  */
class SeriesNetworkgraphDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataGrouping {
  /**
