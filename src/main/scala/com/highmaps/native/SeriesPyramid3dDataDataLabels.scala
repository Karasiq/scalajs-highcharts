...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-dataLabels</code>
  */
class SeriesPyramid3dDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataDataLabels {
  /**
