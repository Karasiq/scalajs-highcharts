...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-dataLabels</code>
  */
class PlotOptionsLinearregressioninterceptDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptDataLabels {
  /**
