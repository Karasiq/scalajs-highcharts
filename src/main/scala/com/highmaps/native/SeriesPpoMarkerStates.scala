...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-marker-states</code>
  */
class SeriesPpoMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPpoMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
