...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-dataSorting</code>
  */
class SeriesAoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoDataSorting {
