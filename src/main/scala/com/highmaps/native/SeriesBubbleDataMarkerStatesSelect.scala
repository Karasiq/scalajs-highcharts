...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-marker-states-select</code>
  */
class SeriesBubbleDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesBubbleDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataMarkerStatesSelect {
