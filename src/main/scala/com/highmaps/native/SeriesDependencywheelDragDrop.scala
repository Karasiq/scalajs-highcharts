...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-dragDrop</code>
  */
class SeriesDependencywheelDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDragDrop {
  /**
