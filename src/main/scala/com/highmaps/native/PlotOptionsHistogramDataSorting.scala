...
/**
  * @note JavaScript name: <code>plotOptions-histogram-dataSorting</code>
  */
class PlotOptionsHistogramDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsHistogramDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHistogramDataSorting {
