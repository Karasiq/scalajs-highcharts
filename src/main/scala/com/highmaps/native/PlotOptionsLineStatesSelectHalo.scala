...
/**
  * @note JavaScript name: <code>plotOptions-line-states-select-halo</code>
  */
class PlotOptionsLineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineStatesSelectHalo {
