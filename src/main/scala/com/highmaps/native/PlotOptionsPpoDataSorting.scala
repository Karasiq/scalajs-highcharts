...
/**
  * @note JavaScript name: <code>plotOptions-ppo-dataSorting</code>
  */
class PlotOptionsPpoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPpoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoDataSorting {
