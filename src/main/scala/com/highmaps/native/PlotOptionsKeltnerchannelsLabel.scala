...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-label</code>
  */
class PlotOptionsKeltnerchannelsLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsLabel {
  /**
