...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-states-select-halo</code>
  */
class SeriesBbStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBbStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbStatesSelectHalo {
