...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-data-accessibility</code>
  */
class SeriesVectorDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVectorDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataAccessibility {
