...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-marker-states</code>
  */
class SeriesCciMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesCciMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
