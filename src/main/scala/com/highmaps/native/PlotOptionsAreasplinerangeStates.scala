...
class PlotOptionsAreasplinerangeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 2.3.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeStatesSelect]] = js.undefined
}
...
object PlotOptionsAreasplinerangeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAreasplinerangeStatesSelect]] = js.undefined): PlotOptionsAreasplinerangeStates = {
