...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-dataGrouping</code>
  */
class SeriesApoDataGrouping extends com.highcharts.HighchartsGenericObject {
