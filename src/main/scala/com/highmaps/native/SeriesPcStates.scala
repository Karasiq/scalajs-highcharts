...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-states</code>
  */
class SeriesPcStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesPcStatesSelect]] = js.undefined
}

object SeriesPcStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesPcStatesSelect]] = js.undefined): SeriesPcStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcStates {
      this.hover = hover
