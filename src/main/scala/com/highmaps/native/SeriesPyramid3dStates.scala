...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states</code>
  */
class SeriesPyramid3dStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesPyramid3dStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStates {
      this.hover = hover
      this.select = select
