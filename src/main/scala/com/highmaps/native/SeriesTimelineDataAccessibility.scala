...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-accessibility</code>
  */
class SeriesTimelineDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesTimelineDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataAccessibility {
