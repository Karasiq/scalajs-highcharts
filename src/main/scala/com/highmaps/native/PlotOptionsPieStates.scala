...
class PlotOptionsPieStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsPieStatesSelect]] = js.undefined
}
...
object PlotOptionsPieStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsPieStatesSelect]] = js.undefined): PlotOptionsPieStates = {
