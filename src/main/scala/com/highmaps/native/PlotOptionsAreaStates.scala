...
class PlotOptionsAreaStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAreaStatesSelect]] = js.undefined
}
...
object PlotOptionsAreaStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAreaStatesSelect]] = js.undefined): PlotOptionsAreaStates = {
