...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-dataLabels-filter</code>
  */
class PlotOptionsStreamgraphDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsStreamgraphDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphDataLabelsFilter {
