...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dragDrop</code>
  */
class SeriesSlowstochasticDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDragDrop {
  /**
