...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-dataLabels-animation</code>
  */
class SeriesWmaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWmaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
