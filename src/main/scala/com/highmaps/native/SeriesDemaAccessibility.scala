...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-accessibility</code>
  */
class SeriesDemaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDemaAccessibilityPoint]] = js.undefined
}

object SeriesDemaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDemaAccessibilityPoint]] = js.undefined): SeriesDemaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaAccessibility {
