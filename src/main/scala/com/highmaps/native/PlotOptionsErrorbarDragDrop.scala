...
class PlotOptionsErrorbarDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    * <p>Allow Q1 value to be dragged individually.</p>
    * @since 6.2.0
    */
  var draggableQ1: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow Q3 value to be dragged individually.</p>
    * @since 6.2.0
    */
...
object PlotOptionsErrorbarDragDrop {
  /**
    ...
    * @param draggableQ1 <p>Allow Q1 value to be dragged individually.</p>
    * @param draggableQ3 <p>Allow Q3 value to be dragged individually.</p>
    ...
    */
  def apply(draggableHigh: js.UndefOr[Boolean] = js.undefined, draggableLow: js.UndefOr[Boolean] = js.undefined, draggableQ1: js.UndefOr[Boolean] = js.undefined, draggableQ3: js.UndefOr[Boolean] = js.undefined, dragHandle: js.UndefOr[js.Any] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsErrorbarDragDrop = {
