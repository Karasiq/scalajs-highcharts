...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-events</code>
  */
class PlotOptionsLinearregressioninterceptEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressioninterceptEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptEvents {
