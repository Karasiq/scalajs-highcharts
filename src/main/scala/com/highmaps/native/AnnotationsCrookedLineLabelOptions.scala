...
/**
  * @note JavaScript name: <code>annotations-crookedLine-labelOptions</code>
  */
class AnnotationsCrookedLineLabelOptions extends com.highcharts.HighchartsGenericObject {
