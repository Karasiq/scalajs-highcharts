...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-marker</code>
  */
class SeriesAbandsMarker extends com.highcharts.HighchartsGenericObject {
