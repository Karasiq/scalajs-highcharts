...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-hover-halo</code>
  */
class SeriesOhlcStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesOhlcStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesHoverHalo {
