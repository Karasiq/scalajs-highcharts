...
class PlotOptionsBubbleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsBubbleStatesSelect]] = js.undefined
}
...
object PlotOptionsBubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsBubbleStatesSelect]] = js.undefined): PlotOptionsBubbleStates = {
