...
/**
  * @note JavaScript name: <code>plotOptions-histogram-dataLabels</code>
  */
class PlotOptionsHistogramDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHistogramDataLabels {
  /**
