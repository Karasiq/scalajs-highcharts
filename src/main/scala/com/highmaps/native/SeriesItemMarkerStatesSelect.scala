...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-marker-states-select</code>
  */
class SeriesItemMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesItemMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemMarkerStatesSelect {
