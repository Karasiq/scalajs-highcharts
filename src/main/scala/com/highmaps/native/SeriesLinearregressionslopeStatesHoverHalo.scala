...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-states-hover-halo</code>
  */
class SeriesLinearregressionslopeStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressionslopeStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeStatesHoverHalo {
