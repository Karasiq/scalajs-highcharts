...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-accessibility</code>
  */
class PlotOptionsLinearregressionAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionAccessibilityPoint]] = js.undefined
}

object PlotOptionsLinearregressionAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionAccessibilityPoint]] = js.undefined): PlotOptionsLinearregressionAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionAccessibility {
