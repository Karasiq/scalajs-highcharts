...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-states</code>
  */
class SeriesSankeyLevelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesSankeyLevelsStatesSelect]] = js.undefined
...
object SeriesSankeyLevelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesSankeyLevelsStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesSankeyLevelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsStates {
      this.hover = hover
