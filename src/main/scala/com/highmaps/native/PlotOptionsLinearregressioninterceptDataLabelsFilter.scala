...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-dataLabels-filter</code>
  */
class PlotOptionsLinearregressioninterceptDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressioninterceptDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptDataLabelsFilter {
