...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dataLabels-filter</code>
  */
class PlotOptionsDumbbellDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellDataLabelsFilter {
