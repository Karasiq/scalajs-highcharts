...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dataLabels-animation</code>
  */
class SeriesChaikinDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesChaikinDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinDataLabelsAnimation {
      this.defer = defer
    })
  }
}
