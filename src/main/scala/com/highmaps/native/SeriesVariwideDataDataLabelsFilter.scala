...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-data-dataLabels-filter</code>
  */
class SeriesVariwideDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVariwideDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataDataLabelsFilter {
