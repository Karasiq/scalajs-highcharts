...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-levels-dataLabels</code>
  */
class PlotOptionsSunburstLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstLevelsDataLabels {
  /**
