...
/**
  * @note JavaScript name: <code>plotOptions-dpo-states</code>
  */
class PlotOptionsDpoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDpoStatesSelect]] = js.undefined
}

object PlotOptionsDpoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDpoStatesSelect]] = js.undefined): PlotOptionsDpoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoStates {
      this.hover = hover
