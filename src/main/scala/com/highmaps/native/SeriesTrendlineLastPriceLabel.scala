...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-lastPrice-label</code>
  */
class SeriesTrendlineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineLastPriceLabel {
  /**
