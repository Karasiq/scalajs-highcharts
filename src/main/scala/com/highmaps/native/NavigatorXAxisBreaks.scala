...
/**
  * @note JavaScript name: <code>navigator-xAxis-breaks</code>
  */
class NavigatorXAxisBreaks extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisBreaks {
  /**
    ...
    */
  def apply(breakSize: js.UndefOr[Double] = js.undefined, from: js.UndefOr[Double] = js.undefined, repeat: js.UndefOr[Double] = js.undefined, to: js.UndefOr[Double] = js.undefined): NavigatorXAxisBreaks = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisBreaks {
