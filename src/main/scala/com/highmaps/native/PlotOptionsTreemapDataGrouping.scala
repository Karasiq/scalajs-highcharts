...
/**
  * @note JavaScript name: <code>plotOptions-treemap-dataGrouping</code>
  */
class PlotOptionsTreemapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapDataGrouping {
  /**
