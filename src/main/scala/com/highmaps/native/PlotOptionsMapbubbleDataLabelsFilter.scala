...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-dataLabels-filter</code>
  */
class PlotOptionsMapbubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMapbubbleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleDataLabelsFilter {
