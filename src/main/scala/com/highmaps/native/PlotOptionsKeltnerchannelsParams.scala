...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-params</code>
  */
class PlotOptionsKeltnerchannelsParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsKeltnerchannelsParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsParams {
      this.index = index
      this.period = period
    })
  }
