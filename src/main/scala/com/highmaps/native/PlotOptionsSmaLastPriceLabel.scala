...
/**
  * @note JavaScript name: <code>plotOptions-sma-lastPrice-label</code>
  */
class PlotOptionsSmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaLastPriceLabel {
  /**
