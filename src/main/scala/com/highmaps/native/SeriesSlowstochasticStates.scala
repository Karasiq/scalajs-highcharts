...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-states</code>
  */
class SeriesSlowstochasticStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 8.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesSlowstochasticStatesSelect]] = js.undefined
}

object SeriesSlowstochasticStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesSlowstochasticStatesSelect]] = js.undefined): SeriesSlowstochasticStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticStates {
      this.hover = hover
