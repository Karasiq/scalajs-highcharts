...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-states-inactive</code>
  */
class SeriesHollowcandlestickStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickStatesInactive {
