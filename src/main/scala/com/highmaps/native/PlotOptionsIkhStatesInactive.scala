...
/**
  * @note JavaScript name: <code>plotOptions-ikh-states-inactive</code>
  */
class PlotOptionsIkhStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsIkhStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhStatesInactive {
