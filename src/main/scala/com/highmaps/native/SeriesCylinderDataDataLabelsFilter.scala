...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data-dataLabels-filter</code>
  */
class SeriesCylinderDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCylinderDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataDataLabelsFilter {
