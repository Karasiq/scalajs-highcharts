...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-lastPrice-label</code>
  */
class SeriesAoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
