...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-dataLabels-animation</code>
  */
class SeriesColumnrangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnrangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
