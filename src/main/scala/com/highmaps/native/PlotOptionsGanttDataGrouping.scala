...
/**
  * @note JavaScript name: <code>plotOptions-gantt-dataGrouping</code>
  */
class PlotOptionsGanttDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGanttDataGrouping {
  /**
