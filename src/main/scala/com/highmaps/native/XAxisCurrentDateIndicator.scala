...
/**
  * @note JavaScript name: <code>xAxis-currentDateIndicator</code>
  */
class XAxisCurrentDateIndicator extends com.highcharts.HighchartsGenericObject {
...
object XAxisCurrentDateIndicator {
  /**
    ...
    */
  def apply(label: js.UndefOr[js.Any] = js.undefined, acrossPanes: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): XAxisCurrentDateIndicator = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisCurrentDateIndicator {
      this.label = label
