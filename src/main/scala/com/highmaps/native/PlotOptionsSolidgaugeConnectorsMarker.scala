...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-connectors-marker</code>
  */
class PlotOptionsSolidgaugeConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSolidgaugeConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsSolidgaugeConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugeConnectorsMarker {
      this.align = align
      this.color = color
