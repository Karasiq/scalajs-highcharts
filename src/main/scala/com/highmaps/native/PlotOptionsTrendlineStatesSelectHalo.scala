...
/**
  * @note JavaScript name: <code>plotOptions-trendline-states-select-halo</code>
  */
class PlotOptionsTrendlineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTrendlineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineStatesSelectHalo {
