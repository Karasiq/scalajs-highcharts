...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-states-inactive</code>
  */
class SeriesXrangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesXrangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeStatesInactive {
