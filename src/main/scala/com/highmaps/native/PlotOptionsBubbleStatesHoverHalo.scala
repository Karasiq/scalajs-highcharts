...
/**
  * @note JavaScript name: <code>plotOptions-bubble-states-hover-halo</code>
  */
class PlotOptionsBubbleStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleStatesHoverHalo {
      this.size = size
