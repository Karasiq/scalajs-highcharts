...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-data-dragDrop</code>
  */
class SeriesNetworkgraphDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataDragDrop {
  /**
