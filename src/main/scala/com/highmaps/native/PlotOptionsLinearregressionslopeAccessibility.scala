...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-accessibility</code>
  */
class PlotOptionsLinearregressionslopeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionslopeAccessibilityPoint]] = js.undefined
}

object PlotOptionsLinearregressionslopeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionslopeAccessibilityPoint]] = js.undefined): PlotOptionsLinearregressionslopeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionslopeAccessibility {
