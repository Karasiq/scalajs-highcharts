...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dataLabels-animation</code>
  */
class PlotOptionsTimelineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
