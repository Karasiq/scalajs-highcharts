...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dragDrop</code>
  */
class PlotOptionsLollipopDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDragDrop {
  /**
