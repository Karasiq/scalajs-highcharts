...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-states-inactive</code>
  */
class SeriesVariwideStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesVariwideStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesInactive {
