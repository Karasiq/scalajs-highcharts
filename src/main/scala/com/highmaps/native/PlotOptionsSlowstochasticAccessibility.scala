...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-accessibility</code>
  */
class PlotOptionsSlowstochasticAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSlowstochasticAccessibilityPoint]] = js.undefined
}

object PlotOptionsSlowstochasticAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSlowstochasticAccessibilityPoint]] = js.undefined): PlotOptionsSlowstochasticAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticAccessibility {
