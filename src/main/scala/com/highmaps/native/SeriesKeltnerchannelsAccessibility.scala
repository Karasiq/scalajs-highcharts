...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-accessibility</code>
  */
class SeriesKeltnerchannelsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsAccessibilityPoint]] = js.undefined
}

object SeriesKeltnerchannelsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsAccessibilityPoint]] = js.undefined): SeriesKeltnerchannelsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsAccessibility {
