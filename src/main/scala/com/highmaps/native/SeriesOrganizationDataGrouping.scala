...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-dataGrouping</code>
  */
class SeriesOrganizationDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataGrouping {
  /**
