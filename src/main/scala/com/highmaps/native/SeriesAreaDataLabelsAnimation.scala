...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-dataLabels-animation</code>
  */
class SeriesAreaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
