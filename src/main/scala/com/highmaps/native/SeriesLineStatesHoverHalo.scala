...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-states-hover-halo</code>
  */
class SeriesLineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineStatesHoverHalo {
