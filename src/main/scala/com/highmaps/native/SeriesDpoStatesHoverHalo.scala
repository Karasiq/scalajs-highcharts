...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-states-hover-halo</code>
  */
class SeriesDpoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDpoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoStatesHoverHalo {
