...
/**
  * @note JavaScript name: <code>plotOptions-psar-dataLabels-animation</code>
  */
class PlotOptionsPsarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPsarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
