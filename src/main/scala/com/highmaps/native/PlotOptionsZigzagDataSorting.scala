...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-dataSorting</code>
  */
class PlotOptionsZigzagDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsZigzagDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsZigzagDataSorting {
