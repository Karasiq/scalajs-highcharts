...
/**
  * @note JavaScript name: <code>plotOptions-natr-zones</code>
  */
class PlotOptionsNatrZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsNatrZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrZones {
