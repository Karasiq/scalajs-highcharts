...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-accessibility-point</code>
  */
class SeriesVariwideAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVariwideAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideAccessibilityPoint {
