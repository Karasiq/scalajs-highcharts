...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-states-inactive</code>
  */
class SeriesHeatmapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesHeatmapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapStatesInactive {
