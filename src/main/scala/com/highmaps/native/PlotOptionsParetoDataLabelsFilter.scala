...
/**
  * @note JavaScript name: <code>plotOptions-pareto-dataLabels-filter</code>
  */
class PlotOptionsParetoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsParetoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoDataLabelsFilter {
