...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-accessibility</code>
  */
class PlotOptionsOhlcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsOhlcAccessibilityPoint]] = js.undefined
}

object PlotOptionsOhlcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsOhlcAccessibilityPoint]] = js.undefined): PlotOptionsOhlcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcAccessibility {
