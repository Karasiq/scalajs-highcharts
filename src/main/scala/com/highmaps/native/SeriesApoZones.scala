...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-zones</code>
  */
class SeriesApoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesApoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoZones {
