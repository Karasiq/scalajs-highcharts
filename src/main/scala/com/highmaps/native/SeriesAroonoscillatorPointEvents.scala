...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-point-events</code>
  */
class SeriesAroonoscillatorPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesAroonoscillatorPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorPointEvents {
      this.click = click
      this.drag = drag
