...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-zones</code>
  */
class PlotOptionsSupertrendZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendZones {
