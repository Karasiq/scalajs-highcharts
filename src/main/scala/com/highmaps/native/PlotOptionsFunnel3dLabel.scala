...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-label</code>
  */
class PlotOptionsFunnel3dLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dLabel {
  /**
