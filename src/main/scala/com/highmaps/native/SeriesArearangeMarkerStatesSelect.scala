...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-marker-states-select</code>
  */
class SeriesArearangeMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesArearangeMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeMarkerStatesSelect {
