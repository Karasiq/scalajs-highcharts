...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-events</code>
  */
class PlotOptionsPyramid3dEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsPyramid3dEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dEvents {
