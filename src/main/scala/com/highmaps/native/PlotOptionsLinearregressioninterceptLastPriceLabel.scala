...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-lastPrice-label</code>
  */
class PlotOptionsLinearregressioninterceptLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptLastPriceLabel {
  /**
