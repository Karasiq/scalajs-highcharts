...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-dataLabels-filter</code>
  */
class SeriesItemDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesItemDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataDataLabelsFilter {
