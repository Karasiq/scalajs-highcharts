...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-data-dataLabels-animation</code>
  */
class SeriesVennDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVennDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
