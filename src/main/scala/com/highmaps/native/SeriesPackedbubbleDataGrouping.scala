...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-dataGrouping</code>
  */
class SeriesPackedbubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataGrouping {
  /**
