...
/**
  * @note JavaScript name: <code>plotOptions-pie-accessibility</code>
  */
class PlotOptionsPieAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPieAccessibilityPoint]] = js.undefined
}

object PlotOptionsPieAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPieAccessibilityPoint]] = js.undefined): PlotOptionsPieAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieAccessibility {
