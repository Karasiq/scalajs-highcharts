...
/**
  * @note JavaScript name: <code>plotOptions-rsi-dataSorting</code>
  */
class PlotOptionsRsiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsRsiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiDataSorting {
