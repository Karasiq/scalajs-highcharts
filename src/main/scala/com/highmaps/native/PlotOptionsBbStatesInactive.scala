...
/**
  * @note JavaScript name: <code>plotOptions-bb-states-inactive</code>
  */
class PlotOptionsBbStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsBbStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbStatesInactive {
