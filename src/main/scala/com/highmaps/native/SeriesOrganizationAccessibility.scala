...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-accessibility</code>
  */
class SeriesOrganizationAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesOrganizationAccessibilityPoint]] = js.undefined
}

object SeriesOrganizationAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesOrganizationAccessibilityPoint]] = js.undefined): SeriesOrganizationAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationAccessibility {
