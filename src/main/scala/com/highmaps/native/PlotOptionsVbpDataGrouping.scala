...
/**
  * @note JavaScript name: <code>plotOptions-vbp-dataGrouping</code>
  */
class PlotOptionsVbpDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpDataGrouping {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, anchor: js.UndefOr[String] = js.undefined, approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): PlotOptionsVbpDataGrouping = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpDataGrouping {
