...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-dataSorting</code>
  */
class PlotOptionsCandlestickDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsCandlestickDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickDataSorting {
