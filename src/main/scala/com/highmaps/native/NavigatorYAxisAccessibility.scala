...
/**
  * @note JavaScript name: <code>navigator-yAxis-accessibility</code>
  */
class NavigatorYAxisAccessibility extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, rangeDescription: js.UndefOr[String] = js.undefined): NavigatorYAxisAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisAccessibility {
