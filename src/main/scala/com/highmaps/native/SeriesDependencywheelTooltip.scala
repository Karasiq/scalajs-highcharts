...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-tooltip</code>
  */
class SeriesDependencywheelTooltip extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelTooltip {
  /**
    ...
    */
  def apply(followPointer: js.UndefOr[Boolean] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, nodeFormatter: js.UndefOr[js.Any] = js.undefined, pointFormat: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined, clusterFormat: js.UndefOr[js.Any] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, nullFormat: js.UndefOr[String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, pointFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[js.UndefOr[Double]] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined): SeriesDependencywheelTooltip = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelTooltip {
