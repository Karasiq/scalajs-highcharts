...
/**
  * @note JavaScript name: <code>plotOptions-dpo-dataSorting</code>
  */
class PlotOptionsDpoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsDpoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoDataSorting {
