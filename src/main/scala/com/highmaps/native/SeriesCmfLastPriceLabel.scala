...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-lastPrice-label</code>
  */
class SeriesCmfLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfLastPriceLabel {
  /**
