...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-states-inactive</code>
  */
class SeriesWilliamsrStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesWilliamsrStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrStatesInactive {
