...
/**
  * @note JavaScript name: <code>plotOptions-column-accessibility</code>
  */
class PlotOptionsColumnAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsColumnAccessibilityPoint]] = js.undefined
}

object PlotOptionsColumnAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsColumnAccessibilityPoint]] = js.undefined): PlotOptionsColumnAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnAccessibility {
