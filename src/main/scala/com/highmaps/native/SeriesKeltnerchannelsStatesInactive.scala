...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-states-inactive</code>
  */
class SeriesKeltnerchannelsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsStatesInactive {
