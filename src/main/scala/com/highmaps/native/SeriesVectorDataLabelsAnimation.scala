...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-dataLabels-animation</code>
  */
class SeriesVectorDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVectorDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataLabelsAnimation {
      this.defer = defer
    })
  }
}
