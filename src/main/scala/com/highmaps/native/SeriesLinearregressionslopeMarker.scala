...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-marker</code>
  */
class SeriesLinearregressionslopeMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeMarker {
  /**
