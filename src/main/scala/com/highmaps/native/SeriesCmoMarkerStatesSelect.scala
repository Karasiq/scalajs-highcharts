...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-marker-states-select</code>
  */
class SeriesCmoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesCmoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoMarkerStatesSelect {
