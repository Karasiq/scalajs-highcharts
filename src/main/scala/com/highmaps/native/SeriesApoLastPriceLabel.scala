...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-lastPrice-label</code>
  */
class SeriesApoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoLastPriceLabel {
  /**
