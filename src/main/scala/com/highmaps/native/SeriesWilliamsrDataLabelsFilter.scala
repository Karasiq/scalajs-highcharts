...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dataLabels-filter</code>
  */
class SeriesWilliamsrDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWilliamsrDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrDataLabelsFilter {
