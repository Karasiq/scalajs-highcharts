...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-dataLabels-filter</code>
  */
class PlotOptionsStochasticDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsStochasticDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticDataLabelsFilter {
