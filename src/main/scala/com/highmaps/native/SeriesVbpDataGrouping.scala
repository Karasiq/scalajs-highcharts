...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-dataGrouping</code>
  */
class SeriesVbpDataGrouping extends com.highcharts.HighchartsGenericObject {
