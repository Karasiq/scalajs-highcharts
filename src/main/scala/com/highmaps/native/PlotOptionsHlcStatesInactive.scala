...
/**
  * @note JavaScript name: <code>plotOptions-hlc-states-inactive</code>
  */
class PlotOptionsHlcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsHlcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcStatesInactive {
