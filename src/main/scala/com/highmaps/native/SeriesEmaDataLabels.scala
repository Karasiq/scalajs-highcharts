...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-dataLabels</code>
  */
class SeriesEmaDataLabels extends com.highcharts.HighchartsGenericObject {
