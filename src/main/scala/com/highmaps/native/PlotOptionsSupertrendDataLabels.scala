...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-dataLabels</code>
  */
class PlotOptionsSupertrendDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendDataLabels {
  /**
