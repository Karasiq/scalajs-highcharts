...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-data-dataLabels</code>
  */
class SeriesHlcDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataDataLabels {
  /**
