...
/**
  * @note JavaScript name: <code>plotOptions-ikh-accessibility</code>
  */
class PlotOptionsIkhAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsIkhAccessibilityPoint]] = js.undefined
}

object PlotOptionsIkhAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsIkhAccessibilityPoint]] = js.undefined): PlotOptionsIkhAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhAccessibility {
