...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-accessibility</code>
  */
class PlotOptionsMapbubbleAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleAccessibilityPoint]] = js.undefined
}

object PlotOptionsMapbubbleAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMapbubbleAccessibilityPoint]] = js.undefined): PlotOptionsMapbubbleAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleAccessibility {
