...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-data-dataLabels-filter</code>
  */
class SeriesScatter3dDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesScatter3dDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dDataDataLabelsFilter {
