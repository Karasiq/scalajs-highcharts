...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-point-events</code>
  */
class SeriesWilliamsrPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesWilliamsrPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrPointEvents {
      this.click = click
      this.drag = drag
