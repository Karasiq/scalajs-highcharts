...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-dataSorting</code>
  */
class SeriesBoxplotDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesBoxplotDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataSorting {
