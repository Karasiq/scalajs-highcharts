...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-marker-states-select</code>
  */
class SeriesDemaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDemaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaMarkerStatesSelect {
