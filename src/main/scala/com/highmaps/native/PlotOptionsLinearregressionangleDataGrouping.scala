...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-dataGrouping</code>
  */
class PlotOptionsLinearregressionangleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleDataGrouping {
  /**
