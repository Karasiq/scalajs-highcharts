...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-nodes-dataLabels</code>
  */
class SeriesSankeyNodesDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyNodesDataLabels {
  /**
