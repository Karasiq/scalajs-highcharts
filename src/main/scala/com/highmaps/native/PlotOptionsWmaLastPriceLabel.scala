...
/**
  * @note JavaScript name: <code>plotOptions-wma-lastPrice-label</code>
  */
class PlotOptionsWmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaLastPriceLabel {
  /**
