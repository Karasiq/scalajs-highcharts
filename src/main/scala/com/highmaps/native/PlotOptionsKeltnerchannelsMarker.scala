...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-marker</code>
  */
class PlotOptionsKeltnerchannelsMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsMarker {
  /**
