...
/**
  * @note JavaScript name: <code>plotOptions-ema-dataLabels-animation</code>
  */
class PlotOptionsEmaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsEmaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
