...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-lastPrice-label</code>
  */
class SeriesMappointLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointLastPriceLabel {
  /**
