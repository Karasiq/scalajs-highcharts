...
/**
  * @note JavaScript name: <code>plotOptions-mapline-accessibility</code>
  */
class PlotOptionsMaplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMaplineAccessibilityPoint]] = js.undefined
}

object PlotOptionsMaplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMaplineAccessibilityPoint]] = js.undefined): PlotOptionsMaplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineAccessibility {
