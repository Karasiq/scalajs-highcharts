...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-states</code>
  */
class PlotOptionsLinearregressionStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionStatesSelect]] = js.undefined
}

object PlotOptionsLinearregressionStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressionStatesSelect]] = js.undefined): PlotOptionsLinearregressionStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionStates {
      this.hover = hover
