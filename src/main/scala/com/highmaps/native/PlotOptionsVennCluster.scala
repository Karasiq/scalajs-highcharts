...
/**
  * @note JavaScript name: <code>plotOptions-venn-cluster</code>
  */
class PlotOptionsVennCluster extends com.highcharts.HighchartsGenericObject {
