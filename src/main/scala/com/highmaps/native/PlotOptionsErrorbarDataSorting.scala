...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dataSorting</code>
  */
class PlotOptionsErrorbarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsErrorbarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarDataSorting {
