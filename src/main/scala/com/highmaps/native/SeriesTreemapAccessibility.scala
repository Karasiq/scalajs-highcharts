...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-accessibility</code>
  */
class SeriesTreemapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTreemapAccessibilityPoint]] = js.undefined
}

object SeriesTreemapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTreemapAccessibilityPoint]] = js.undefined): SeriesTreemapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapAccessibility {
