...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-lastPrice-label</code>
  */
class SeriesDpoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoLastPriceLabel {
  /**
