...
/**
  * @note JavaScript name: <code>plotOptions-area-dataSorting</code>
  */
class PlotOptionsAreaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAreaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaDataSorting {
