...
/**
  * @note JavaScript name: <code>navigation-annotationsOptions-labels</code>
  */
class NavigationAnnotationsOptionsLabels extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>This option defines the point to which the label will be
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/annotations/mock-points/">Attach annotation to a mock point with different ways</a>
    * @since 6.0.0
    */
...
object NavigationAnnotationsOptionsLabels {
  /**
    * @param point <p>This option defines the point to which the label will be. connected. It can be either the point which exists in the. series - it is referenced by the point&#39;s id - or a new point. with defined x, y properties and optionally axes.</p>
    ...
    */
  def apply(point: js.UndefOr[String | js.Object | js.Function] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, align: js.UndefOr[String] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, distance: js.UndefOr[Double] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, text: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): NavigationAnnotationsOptionsLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigationAnnotationsOptionsLabels {
      this.point = point
