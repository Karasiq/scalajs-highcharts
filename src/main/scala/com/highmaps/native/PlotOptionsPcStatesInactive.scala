...
/**
  * @note JavaScript name: <code>plotOptions-pc-states-inactive</code>
  */
class PlotOptionsPcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcStatesInactive {
