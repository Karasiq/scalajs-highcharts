...
/**
  * @note JavaScript name: <code>plotOptions-rsi-lastPrice-label</code>
  */
class PlotOptionsRsiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiLastPriceLabel {
  /**
