...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-states-inactive</code>
  */
class SeriesPpoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPpoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoStatesInactive {
