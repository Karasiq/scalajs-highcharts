...
object ColorAxisGrid {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined, columns: js.UndefOr[js.Array[js.Any]] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): ColorAxisGrid = {
