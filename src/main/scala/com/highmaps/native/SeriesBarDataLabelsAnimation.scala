...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-dataLabels-animation</code>
  */
class SeriesBarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
