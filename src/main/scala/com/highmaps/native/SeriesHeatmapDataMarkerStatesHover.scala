...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-data-marker-states-hover</code>
  */
class SeriesHeatmapDataMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataMarkerStatesHover {
  /**
    ...
    */
  def apply(height: js.UndefOr[js.UndefOr[Double]] = js.undefined, heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, lineWidthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesHeatmapDataMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataMarkerStatesHover {
      this.height = height
