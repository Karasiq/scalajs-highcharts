...
/**
  * @note JavaScript name: <code>navigator-xAxis-currentDateIndicator</code>
  */
class NavigatorXAxisCurrentDateIndicator extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisCurrentDateIndicator {
  /**
    ...
    */
  def apply(label: js.UndefOr[js.Any] = js.undefined, acrossPanes: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): NavigatorXAxisCurrentDateIndicator = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisCurrentDateIndicator {
      this.label = label
