...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-data-dataLabels-animation</code>
  */
class SeriesTilemapDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTilemapDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
