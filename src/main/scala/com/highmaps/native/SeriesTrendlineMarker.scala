...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-marker</code>
  */
class SeriesTrendlineMarker extends com.highcharts.HighchartsGenericObject {
