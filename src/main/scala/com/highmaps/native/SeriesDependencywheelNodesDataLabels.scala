...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-nodes-dataLabels</code>
  */
class SeriesDependencywheelNodesDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelNodesDataLabels {
  /**
