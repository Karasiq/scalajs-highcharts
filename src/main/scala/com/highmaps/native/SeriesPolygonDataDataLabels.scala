...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data-dataLabels</code>
  */
class SeriesPolygonDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataDataLabels {
  /**
