...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-dataLabels</code>
  */
class SeriesBellcurveDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveDataLabels {
  /**
