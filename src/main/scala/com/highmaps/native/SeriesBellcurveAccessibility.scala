...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-accessibility</code>
  */
class SeriesBellcurveAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesBellcurveAccessibilityPoint]] = js.undefined
}

object SeriesBellcurveAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesBellcurveAccessibilityPoint]] = js.undefined): SeriesBellcurveAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveAccessibility {
