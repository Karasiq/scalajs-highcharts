...
/**
  * @note JavaScript name: <code>plotOptions-map-states-inactive</code>
  */
class PlotOptionsMapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapStatesInactive {
