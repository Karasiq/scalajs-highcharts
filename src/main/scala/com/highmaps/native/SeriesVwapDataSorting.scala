...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-dataSorting</code>
  */
class SeriesVwapDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesVwapDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapDataSorting {
