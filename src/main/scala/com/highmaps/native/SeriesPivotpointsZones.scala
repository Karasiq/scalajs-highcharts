...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-zones</code>
  */
class SeriesPivotpointsZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPivotpointsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsZones {
