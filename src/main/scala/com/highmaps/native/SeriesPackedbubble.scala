...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;</code>
  */
class SeriesPackedbubble extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>packedbubble</code> series type,
    * points can be given in the following ways:</p>
    * <ol>
    * <li> An array of <code>values</code>.</li>
    * </ol>
    * <pre><code class="language-js">   data: [5, 1, 20]
    * </code></pre>
    * <ol start="2">
    * <li> An array of objects with named values. The objects are point
    * configuration objects as seen below. If the total number of data points
    * exceeds the series&#39; <a href="#series.packedbubble.turboThreshold">turboThreshold</a>,
    ...
    *    }]
    * </code></pre>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    */
  var data: js.UndefOr[js.Array[CleanJsObject[SeriesPackedbubbleData] | js.Array[js.Any]]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "packedbubble"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">Style mode example</a>
  ...
  /**
    * <p>Flag to determine if nodes are draggable or not. Available for
    * graph with useSimulation set to true only.</p>
    * @since 7.1.0
    */
  var draggable: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Options for layout algorithm when simulation is enabled. Inside there
    * are options to change the speed, padding, initial bubbles positions
    * and more.</p>
    * @since 7.1.0
    */
  var layoutAlgorithm: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithm]] = js.undefined

  /**
    * <p>Maximum bubble size. Bubbles will automatically size between the
    * <code>minSize</code> and <code>maxSize</code> to reflect the value of each bubble.
    * Can be either pixels (when no unit is given), or a percentage of
    * the smallest one of the plot width and height, divided by the square
    * root of total number of points.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bubble-size/">Bubble size</a>
    * @since 7.0.0
    */
  ...
  /**
    * <p>Series options for parent nodes.</p>
    * @since 8.1.1
    */
  var parentNode: js.Any = js.undefined
  ...
  /**
    * <p>An option is giving a possibility to choose between using simulation
    * for calculating bubble positions. These reflects in both animation
    * and final position of bubbles. Simulation is also adding options to
    * the series graph based on used layout. In case of big data sets, with
    * any performance issues, it is possible to disable animation and pack
    * bubble in a simple circular way.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series-packedbubble/spiral/">useSimulation set to false</a>
    * @since 7.1.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/color-zones-zoneaxis-x/">Zones on the X-Axis</a>
  ...
  /**
    ...
    * doesn&#39;t work well with heavy data series.</p>
    * @since 6.1.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/coloraxis/changed-default-color-key/">Changed default color key</a>
  ...
  /**
    ...
    * by the <a href="#plotOptions.bubble.zThreshold">zThreshold</a> option, and negative
    * bubbles can be visualized by setting
    * <a href="#plotOptions.bubble.negativeColor">negativeColor</a>.</p>
  ...
  /**
    * <p>When a point&#39;s Z value is below the
    * <a href="#plotOptions.bubble.zThreshold">zThreshold</a>
    * setting, this color is used.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bubble-negative/">Negative bubbles</a>
    * @since 3.0.0
    */
  ...
  /**
    * <p>When <a href="#plotOptions.bubble.displayNegative">displayNegative</a> is <code>false</code>,
    * bubbles with lower Z values are skipped. When <code>displayNegative</code>
    * is <code>true</code> and a <a href="#plotOptions.bubble.negativeColor">negativeColor</a>
    * is given, points with lower Z is colored.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/bubble-negative/">Negative bubbles</a>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesPackedbubbleConnectors]] = js.undefined
...
object SeriesPackedbubble {
  /**
    * @param data <p>An array of data points for the series. For the <code>packedbubble</code> series type,. points can be given in the following ways:</p>. <ol>. <li> An array of <code>values</code>.</li>. </ol>. <pre><code class="language-js">   data: [5, 1, 20]. </code></pre>. <ol start="2">. <li> An array of objects with named values. The objects are point. configuration objects as seen below. If the total number of data points. exceeds the series&#39; <a href="#series.packedbubble.turboThreshold">turboThreshold</a>,. this option is not available.</li>. </ol>. <pre><code class="language-js">   data: [{.        value: 1,.        name: &quot;Point2&quot;,.        color: &quot;#00FF00&quot;.    }, {.        value: 5,.        name: &quot;Point1&quot;,.        color: &quot;#FF00FF&quot;.    }]. </code></pre>
    ...
    * @param draggable <p>Flag to determine if nodes are draggable or not. Available for. graph with useSimulation set to true only.</p>
    * @param layoutAlgorithm <p>Options for layout algorithm when simulation is enabled. Inside there. are options to change the speed, padding, initial bubbles positions. and more.</p>
    * @param maxSize <p>Maximum bubble size. Bubbles will automatically size between the. <code>minSize</code> and <code>maxSize</code> to reflect the value of each bubble.. Can be either pixels (when no unit is given), or a percentage of. the smallest one of the plot width and height, divided by the square. root of total number of points.</p>
    * @param minSize <p>Minimum bubble size. Bubbles will automatically size between the. <code>minSize</code> and <code>maxSize</code> to reflect the value of each bubble.. Can be either pixels (when no unit is given), or a percentage of. the smallest one of the plot width and height, divided by the square. root of total number of points.</p>
    * @param parentNode <p>Series options for parent nodes.</p>
    ...
    * @param useSimulation <p>An option is giving a possibility to choose between using simulation. for calculating bubble positions. These reflects in both animation. and final position of bubbles. Simulation is also adding options to. the series graph based on used layout. In case of big data sets, with. any performance issues, it is possible to disable animation and pack. bubble in a simple circular way.</p>
    ...
    * @param displayNegative <p>Whether to display negative sized bubbles. The threshold is given. by the <a href="#plotOptions.bubble.zThreshold">zThreshold</a> option, and negative. bubbles can be visualized by setting. <a href="#plotOptions.bubble.negativeColor">negativeColor</a>.</p>
    * @param negativeColor <p>When a point&#39;s Z value is below the. <a href="#plotOptions.bubble.zThreshold">zThreshold</a>. setting, this color is used.</p>
    ...
    * @param zThreshold <p>When <a href="#plotOptions.bubble.displayNegative">displayNegative</a> is <code>false</code>,. bubbles with lower Z values are skipped. When <code>displayNegative</code>. is <code>true</code> and a <a href="#plotOptions.bubble.negativeColor">negativeColor</a>. is given, points with lower Z is colored.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesPackedbubbleData] | js.Array[js.Any]]] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "packedbubble", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, draggable: js.UndefOr[Boolean] = js.undefined, layoutAlgorithm: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithm]] = js.undefined, maxSize: js.UndefOr[Double | String] = js.undefined, minSize: js.UndefOr[Double | String] = js.undefined, parentNode: js.UndefOr[js.Any] = js.undefined, sizeBy: js.UndefOr[String] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, useSimulation: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, displayNegative: js.UndefOr[Boolean] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, zThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesPackedbubbleConnectors]] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, step: js.UndefOr[String] = js.undefined): SeriesPackedbubble = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubble {
      this.data = data
      this.marker = marker
      this.id = id
      this.index = index
