...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-states-hover-halo</code>
  */
class PlotOptionsStochasticStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsStochasticStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticStatesHoverHalo {
