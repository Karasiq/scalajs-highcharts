...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-states</code>
  */
class SeriesVennStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesVennStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennStates {
      this.hover = hover
      this.select = select
