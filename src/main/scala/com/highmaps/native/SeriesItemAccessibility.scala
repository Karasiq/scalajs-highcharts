...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-accessibility</code>
  */
class SeriesItemAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesItemAccessibilityPoint]] = js.undefined
}

object SeriesItemAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesItemAccessibilityPoint]] = js.undefined): SeriesItemAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemAccessibility {
