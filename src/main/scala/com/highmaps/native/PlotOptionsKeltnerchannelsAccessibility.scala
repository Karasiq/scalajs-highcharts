...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-accessibility</code>
  */
class PlotOptionsKeltnerchannelsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsKeltnerchannelsAccessibilityPoint]] = js.undefined
}

object PlotOptionsKeltnerchannelsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsKeltnerchannelsAccessibilityPoint]] = js.undefined): PlotOptionsKeltnerchannelsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsAccessibility {
