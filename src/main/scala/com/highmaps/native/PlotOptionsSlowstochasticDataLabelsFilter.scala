...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-dataLabels-filter</code>
  */
class PlotOptionsSlowstochasticDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSlowstochasticDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticDataLabelsFilter {
