...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-states</code>
  */
class PlotOptionsLinearregressioninterceptStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressioninterceptStatesSelect]] = js.undefined
}

object PlotOptionsLinearregressioninterceptStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsLinearregressioninterceptStatesSelect]] = js.undefined): PlotOptionsLinearregressioninterceptStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptStates {
      this.hover = hover
