...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dataLabels-animation</code>
  */
class SeriesSlowstochasticDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticDataLabelsAnimation {
      this.defer = defer
    })
  }
}
