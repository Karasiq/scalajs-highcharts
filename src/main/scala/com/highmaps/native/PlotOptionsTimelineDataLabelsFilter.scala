...
/**
  * @note JavaScript name: <code>plotOptions-timeline-dataLabels-filter</code>
  */
class PlotOptionsTimelineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineDataLabelsFilter {
