...
/**
  ...
  */
class SeriesAreasplineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAreasplineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
