...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-zones</code>
  */
class SeriesSmaZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSmaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaZones {
