...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-marker-states-select</code>
  */
class SeriesDependencywheelMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDependencywheelMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelMarkerStatesSelect {
