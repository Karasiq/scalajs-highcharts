...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-dataLabels-animation</code>
  */
class SeriesAreasplinerangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
