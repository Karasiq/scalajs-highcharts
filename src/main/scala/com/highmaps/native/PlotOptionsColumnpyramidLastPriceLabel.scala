...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-lastPrice-label</code>
  */
class PlotOptionsColumnpyramidLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidLastPriceLabel {
  /**
