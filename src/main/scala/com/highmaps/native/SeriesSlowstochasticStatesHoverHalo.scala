...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-states-hover-halo</code>
  */
class SeriesSlowstochasticStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticStatesHoverHalo {
