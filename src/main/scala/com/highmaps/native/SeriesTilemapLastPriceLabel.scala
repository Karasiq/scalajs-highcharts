...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-lastPrice-label</code>
  */
class SeriesTilemapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapLastPriceLabel {
  /**
