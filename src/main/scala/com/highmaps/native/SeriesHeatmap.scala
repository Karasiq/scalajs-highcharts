...
/**
  ...
  */
class SeriesHeatmap extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>heatmap</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li> An array of arrays with 3 or 2 values. In this case, the values
    ...
    * and <code>pointInterval</code> given in the series options.</li>
    * </ol>
    ...
    * points exceeds the series&#39; <a href="#series.heatmap.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "heatmap"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesHeatmapConnectors]] = js.undefined
...
object SeriesHeatmap {
  /**
    * @param data <p>An array of data points for the series. For the <code>heatmap</code> series. type, points can be given in the following ways:</p>. <ol>. <li> An array of arrays with 3 or 2 values. In this case, the values. correspond to <code>x,y,value</code>. If the first value is a string, it is. applied as the name of the point, and the <code>x</code> value is inferred.. The <code>x</code> value can also be omitted, in which case the inner arrays. should be of length 2. Then the <code>x</code> value is automatically calculated,. either starting at 0 and incremented by 1, or from <code>pointStart</code>. and <code>pointInterval</code> given in the series options.</li>. </ol>. <pre><code class="language-js">   data: [.        [0, 9, 7],.        [1, 10, 4],.        [2, 6, 3].    ]. </code></pre>. <ol start="2">. <li> An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.heatmap.turboThreshold">turboThreshold</a>,. this option is not available.</li>. </ol>. <pre><code class="language-js">   data: [{.        x: 1,.        y: 3,.        value: 10,.        name: &quot;Point2&quot;,.        color: &quot;#00FF00&quot;.    }, {.        x: 1,.        y: 7,.        value: 10,.        name: &quot;Point1&quot;,.        color: &quot;#FF00FF&quot;.    }]. </code></pre>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "heatmap", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, colsize: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, nullColor: js.UndefOr[String | js.Object] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, rowsize: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, boostBlending: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, className: js.UndefOr[String] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesHeatmapConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, dataSorting: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined): SeriesHeatmap = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmap {
      this.data = data
      this.marker = marker
      this.id = id
      this.index = index
