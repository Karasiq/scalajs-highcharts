...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesTimelineDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesTimelineDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataDragDropDragHandle {
