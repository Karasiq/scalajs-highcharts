...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dataLabels-animation</code>
  */
class PlotOptionsErrorbarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsErrorbarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
