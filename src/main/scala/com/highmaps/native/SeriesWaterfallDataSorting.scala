...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-dataSorting</code>
  */
class SeriesWaterfallDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesWaterfallDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallDataSorting {
