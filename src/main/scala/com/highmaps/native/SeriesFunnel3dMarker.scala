...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-marker</code>
  */
class SeriesFunnel3dMarker extends com.highcharts.HighchartsGenericObject {
