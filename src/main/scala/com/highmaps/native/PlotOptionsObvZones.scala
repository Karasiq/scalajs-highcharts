...
/**
  * @note JavaScript name: <code>plotOptions-obv-zones</code>
  */
class PlotOptionsObvZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsObvZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvZones {
