...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-dataLabels</code>
  */
class SeriesOrganizationDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataLabels {
  /**
