...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-dataSorting</code>
  */
class SeriesPolygonDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPolygonDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataSorting {
