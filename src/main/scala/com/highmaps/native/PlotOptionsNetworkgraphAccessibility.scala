...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-accessibility</code>
  */
class PlotOptionsNetworkgraphAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphAccessibilityPoint]] = js.undefined
}

object PlotOptionsNetworkgraphAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphAccessibilityPoint]] = js.undefined): PlotOptionsNetworkgraphAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphAccessibility {
