...
/**
  * @note JavaScript name: <code>plotOptions-atr-dataLabels</code>
  */
class PlotOptionsAtrDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrDataLabels {
  /**
