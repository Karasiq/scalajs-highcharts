...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-states-select-halo</code>
  */
class PlotOptionsDumbbellStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellStatesSelectHalo {
