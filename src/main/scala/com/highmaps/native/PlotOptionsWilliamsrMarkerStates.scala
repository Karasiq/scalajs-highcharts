...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-marker-states</code>
  */
class PlotOptionsWilliamsrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsWilliamsrMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
