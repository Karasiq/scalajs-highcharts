...
/**
  * @note JavaScript name: <code>plotOptions-bb-accessibility</code>
  */
class PlotOptionsBbAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBbAccessibilityPoint]] = js.undefined
}

object PlotOptionsBbAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBbAccessibilityPoint]] = js.undefined): PlotOptionsBbAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbAccessibility {
