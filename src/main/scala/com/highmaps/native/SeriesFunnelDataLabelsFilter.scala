...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-dataLabels-filter</code>
  */
class SeriesFunnelDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFunnelDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDataLabelsFilter {
