...
/**
  * @note JavaScript name: <code>plotOptions-series-dataSorting</code>
  */
class PlotOptionsSeriesDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsSeriesDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesDataSorting {
