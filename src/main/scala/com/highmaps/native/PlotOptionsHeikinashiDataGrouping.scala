...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dataGrouping</code>
  */
class PlotOptionsHeikinashiDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDataGrouping {
  /**
    ...
    */
  def apply(groupAll: js.UndefOr[Boolean] = js.undefined, approximation: js.UndefOr[String | js.Function] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, anchor: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): PlotOptionsHeikinashiDataGrouping = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiDataGrouping {
