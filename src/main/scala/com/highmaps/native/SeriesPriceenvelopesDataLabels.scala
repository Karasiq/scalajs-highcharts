...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-dataLabels</code>
  */
class SeriesPriceenvelopesDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesDataLabels {
  /**
