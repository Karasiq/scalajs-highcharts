...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-accessibility-point</code>
  */
class SeriesGaugeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesGaugeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeAccessibilityPoint {
