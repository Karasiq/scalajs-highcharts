...
/**
  * @note JavaScript name: <code>plotOptions-ao-states-inactive</code>
  */
class PlotOptionsAoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsAoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoStatesInactive {
