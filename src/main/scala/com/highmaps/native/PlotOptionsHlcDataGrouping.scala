...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dataGrouping</code>
  */
class PlotOptionsHlcDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcDataGrouping {
  /**
