...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-dataGrouping</code>
  */
class PlotOptionsSupertrendDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendDataGrouping {
  /**
