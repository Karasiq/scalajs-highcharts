...
/**
  * @note JavaScript name: <code>plotOptions-treemap-dataLabels-filter</code>
  */
class PlotOptionsTreemapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapDataLabelsFilter {
