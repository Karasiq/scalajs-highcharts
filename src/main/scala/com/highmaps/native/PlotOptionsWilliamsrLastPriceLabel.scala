...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-lastPrice-label</code>
  */
class PlotOptionsWilliamsrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrLastPriceLabel {
  /**
