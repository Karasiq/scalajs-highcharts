...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data-dataLabels-animation</code>
  */
class SeriesAreasplineDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAreasplineDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
