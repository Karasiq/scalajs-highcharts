...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-label</code>
  */
class SeriesKlingerLabel extends com.highcharts.HighchartsGenericObject {
