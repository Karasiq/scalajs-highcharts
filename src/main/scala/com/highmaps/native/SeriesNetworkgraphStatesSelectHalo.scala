...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-states-select-halo</code>
  */
class SeriesNetworkgraphStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphStatesSelectHalo {
