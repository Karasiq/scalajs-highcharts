...
/**
  * @note JavaScript name: <code>plotOptions-sma-zones</code>
  */
class PlotOptionsSmaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSmaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaZones {
