...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data-accessibility</code>
  */
class SeriesLollipopDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesLollipopDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopDataAccessibility {
