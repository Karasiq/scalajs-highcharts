...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-states-hover-halo</code>
  */
class SeriesSupertrendStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSupertrendStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendStatesHoverHalo {
