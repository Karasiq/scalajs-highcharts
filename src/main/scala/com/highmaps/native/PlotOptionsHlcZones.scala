...
/**
  * @note JavaScript name: <code>plotOptions-hlc-zones</code>
  */
class PlotOptionsHlcZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHlcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcZones {
