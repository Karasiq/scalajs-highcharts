...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-dragDrop-dragHandle</code>
  */
class SeriesPcDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesPcDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcDragDropDragHandle {
