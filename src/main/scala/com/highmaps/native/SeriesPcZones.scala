...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-zones</code>
  */
class SeriesPcZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcZones {
