...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-accessibility</code>
  */
class SeriesMacdAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMacdAccessibilityPoint]] = js.undefined
}

object SeriesMacdAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMacdAccessibilityPoint]] = js.undefined): SeriesMacdAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdAccessibility {
