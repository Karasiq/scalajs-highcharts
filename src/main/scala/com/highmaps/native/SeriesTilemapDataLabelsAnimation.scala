...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-dataLabels-animation</code>
  */
class SeriesTilemapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTilemapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
