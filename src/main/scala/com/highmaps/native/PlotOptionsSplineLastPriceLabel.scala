...
/**
  * @note JavaScript name: <code>plotOptions-spline-lastPrice-label</code>
  */
class PlotOptionsSplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineLastPriceLabel {
  /**
