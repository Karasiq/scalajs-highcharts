...
/**
  * @note JavaScript name: <code>plotOptions-dema-dataSorting</code>
  */
class PlotOptionsDemaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsDemaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaDataSorting {
