...
/**
  ...
  */
class PlotOptionsColumnStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsColumnStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnStatesHover {
