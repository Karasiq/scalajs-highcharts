...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-dataLabels-animation</code>
  */
class SeriesPyramid3dDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPyramid3dDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
