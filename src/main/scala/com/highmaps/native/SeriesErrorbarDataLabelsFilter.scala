...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-dataLabels-filter</code>
  */
class SeriesErrorbarDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesErrorbarDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarDataLabelsFilter {
