...
/**
  * @note JavaScript name: <code>plotOptions-dmi-accessibility</code>
  */
class PlotOptionsDmiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsDmiAccessibilityPoint]] = js.undefined
}

object PlotOptionsDmiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsDmiAccessibilityPoint]] = js.undefined): PlotOptionsDmiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiAccessibility {
