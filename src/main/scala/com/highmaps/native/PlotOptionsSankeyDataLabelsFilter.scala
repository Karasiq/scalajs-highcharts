...
/**
  * @note JavaScript name: <code>plotOptions-sankey-dataLabels-filter</code>
  */
class PlotOptionsSankeyDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyDataLabelsFilter {
