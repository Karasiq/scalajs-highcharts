...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dataGrouping</code>
  */
class SeriesAbandsDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsDataGrouping {
  /**
