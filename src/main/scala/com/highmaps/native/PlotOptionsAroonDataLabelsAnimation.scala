...
/**
  * @note JavaScript name: <code>plotOptions-aroon-dataLabels-animation</code>
  */
class PlotOptionsAroonDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAroonDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonDataLabelsAnimation {
      this.defer = defer
    })
  }
}
