...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-states</code>
  */
class SeriesDisparityindexStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesDisparityindexStatesSelect]] = js.undefined
}

object SeriesDisparityindexStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDisparityindexStatesSelect]] = js.undefined): SeriesDisparityindexStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexStates {
      this.hover = hover
