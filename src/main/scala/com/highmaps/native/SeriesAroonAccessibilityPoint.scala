...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-accessibility-point</code>
  */
class SeriesAroonAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAroonAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonAccessibilityPoint {
