...
/**
  * @note JavaScript name: <code>plotOptions-cmo-states-hover-halo</code>
  */
class PlotOptionsCmoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsCmoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoStatesHoverHalo {
