...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-dataLabels-filter</code>
  */
class SeriesVbpDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVbpDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpDataLabelsFilter {
