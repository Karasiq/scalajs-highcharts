...
/**
  * @note JavaScript name: <code>plotOptions-trix-states-inactive</code>
  */
class PlotOptionsTrixStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsTrixStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixStatesInactive {
