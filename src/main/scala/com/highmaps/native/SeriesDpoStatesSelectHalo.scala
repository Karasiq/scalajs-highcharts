...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-states-select-halo</code>
  */
class SeriesDpoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDpoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoStatesSelectHalo {
