...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-dataSorting</code>
  */
class SeriesLollipopDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLollipopDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopDataSorting {
