...
/**
  * @note JavaScript name: <code>plotOptions-variwide-dataSorting</code>
  */
class PlotOptionsVariwideDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsVariwideDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideDataSorting {
