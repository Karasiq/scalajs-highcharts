...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-accessibility-point</code>
  */
class SeriesTrixAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTrixAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixAccessibilityPoint {
