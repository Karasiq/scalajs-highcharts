...
/**
  * @note JavaScript name: <code>plotOptions-dema-lastPrice-label</code>
  */
class PlotOptionsDemaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaLastPriceLabel {
  /**
