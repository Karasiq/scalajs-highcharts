...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-states-select-halo</code>
  */
class PlotOptionsSupertrendStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendStatesSelectHalo {
