...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-layoutAlgorithm-parentNodeOptions</code>
  */
class SeriesPackedbubbleLayoutAlgorithmParentNodeOptions extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithmParentNodeOptionsMarker]] = js.undefined
...
object SeriesPackedbubbleLayoutAlgorithmParentNodeOptions {
  /**
    ...
    */
  def apply(gravitationalConstant: js.UndefOr[Double] = js.undefined, initialPositionRadius: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithmParentNodeOptionsMarker]] = js.undefined, maxIterations: js.UndefOr[Double] = js.undefined, maxSpeed: js.UndefOr[Double] = js.undefined, seriesInteraction: js.UndefOr[Boolean] = js.undefined, friction: js.UndefOr[Double] = js.undefined, initialPositions: js.UndefOr[String | js.Function] = js.undefined, integration: js.UndefOr[String] = js.undefined, linkLength: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String] = "reingold-fruchterman"): SeriesPackedbubbleLayoutAlgorithmParentNodeOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleLayoutAlgorithmParentNodeOptions {
