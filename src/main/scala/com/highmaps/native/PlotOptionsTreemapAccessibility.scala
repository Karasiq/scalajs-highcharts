...
/**
  * @note JavaScript name: <code>plotOptions-treemap-accessibility</code>
  */
class PlotOptionsTreemapAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTreemapAccessibilityPoint]] = js.undefined
}

object PlotOptionsTreemapAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTreemapAccessibilityPoint]] = js.undefined): PlotOptionsTreemapAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapAccessibility {
