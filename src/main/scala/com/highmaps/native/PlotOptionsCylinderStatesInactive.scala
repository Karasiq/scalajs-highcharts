...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-states-inactive</code>
  */
class PlotOptionsCylinderStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsCylinderStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderStatesInactive {
