...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-params</code>
  */
class PlotOptionsLinearregressioninterceptParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressioninterceptParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptParams {
