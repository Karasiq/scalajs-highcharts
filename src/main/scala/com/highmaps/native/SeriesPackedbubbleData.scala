...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-data</code>
  */
class SeriesPackedbubbleData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesPackedbubbleDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesPackedbubbleDataEvents]] = js.undefined
...
object SeriesPackedbubbleData {
  /**
    ...
    */
  def apply(dataLabels: js.UndefOr[js.Object | js.Array[js.Object]] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesPackedbubbleDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesPackedbubbleDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined): SeriesPackedbubbleData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleData {
