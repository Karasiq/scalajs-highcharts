...
/**
  * @note JavaScript name: <code>plotOptions-vector-states-select-halo</code>
  */
class PlotOptionsVectorStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsVectorStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorStatesSelectHalo {
