...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-zones</code>
  */
class PlotOptionsErrorbarZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsErrorbarZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarZones {
