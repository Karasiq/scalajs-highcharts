...
class PlotOptionsTreemapLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 4.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[PlotOptionsTreemapLevelsDataLabels]] = js.undefined
...
object PlotOptionsTreemapLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderDashStyle: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorVariation: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsTreemapLevelsDataLabels]] = js.undefined, layoutAlgorithm: js.UndefOr[String] = js.undefined, layoutStartingDirection: js.UndefOr[String] = js.undefined, level: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapLevels = {
