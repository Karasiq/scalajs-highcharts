...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-dragDrop</code>
  */
class SeriesFunnel3dDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataDragDrop {
  /**
