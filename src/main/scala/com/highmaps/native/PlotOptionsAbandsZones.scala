...
/**
  * @note JavaScript name: <code>plotOptions-abands-zones</code>
  */
class PlotOptionsAbandsZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsZones {
