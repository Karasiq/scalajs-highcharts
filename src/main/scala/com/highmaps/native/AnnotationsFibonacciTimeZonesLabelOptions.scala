...
/**
  * @note JavaScript name: <code>annotations-fibonacciTimeZones-labelOptions</code>
  */
class AnnotationsFibonacciTimeZonesLabelOptions extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsFibonacciTimeZonesLabelOptions {
  /**
