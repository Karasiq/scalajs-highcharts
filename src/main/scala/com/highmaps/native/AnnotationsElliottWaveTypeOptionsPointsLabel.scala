...
/**
  * @note JavaScript name: <code>annotations-elliottWave-typeOptions-points-label</code>
  */
class AnnotationsElliottWaveTypeOptionsPointsLabel extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsElliottWaveTypeOptionsPointsLabel {
  /**
