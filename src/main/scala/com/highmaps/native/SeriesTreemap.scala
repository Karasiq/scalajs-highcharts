...
class SeriesTreemap extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * <a href="#series.treemap.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "treemap"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    ...
    * <a href="#plotOptions.treemap.allowTraversingTree">allowTraversingTree</a>.</p>
  ...
  /**
    ...
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/treemap-allowtraversingtree/">Enabled</a>
    * @since 7.0.3
    */
  ...
  /**
    * <p>The border radius for each treemap item.</p>
    */
  ...
  /**
    ...
    * @since 2.0.0
    */
  var colorByPoint: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/coloraxis/changed-default-color-key/">Changed default color key</a>
  ...
  /**
    ...
    * of the global <a href="#colors">colors</a> when
    * <a href="#plotOptions.treemap.colorByPoint">colorByPoint</a> is true.</p>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/series-datalabels">Style mode example</a>
  ...
  /**
    * <p>Options for the button appearing when drilling down in a treemap.
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/treemap-interactbyleaf-true-and-allowtraversingtree/">InteractByLeaf and allowTraversingTree is true</a>
    * @since 4.1.2
    */
  ...
  /**
    ...
    * and dimensions of the points.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/treemap-layoutalgorithm-strip/">Strip</a>
  ...
  /**
    * <p>Defines which direction the layout algorithm will start drawing.</p>
    * @since 4.1.0
    */
  var layoutStartingDirection: js.UndefOr[String] = js.undefined

  /**
    * <p>Used together with the levels and allowTraversingTree options. When
    * set to false the first level visible to be level one, which is
    * dynamic when traversing the tree. Otherwise the level will be the
    * same as the tree structure.</p>
    * @since 4.1.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/treemap-with-levels/">Different layoutAlgorithm</a>
  ...
  /**
    ...
    */
  var traverseUpButton: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-connectnulls-true/">True</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesTreemapConnectors]] = js.undefined
...
object SeriesTreemap {
  /**
    ...
    * @param allowDrillToNode <p>When enabled the user can click on a point which is a parent and. zoom in on its children. Deprecated and replaced by. <a href="#plotOptions.treemap.allowTraversingTree">allowTraversingTree</a>.</p>
    ...
    * @param borderRadius <p>The border radius for each treemap item.</p>
    ...
    * @param drillUpButton <p>Options for the button appearing when drilling down in a treemap.. Deprecated and replaced by. <a href="#plotOptions.treemap.traverseUpButton">traverseUpButton</a>.</p>
    ...
    * @param interactByLeaf <p>This option decides if the user can interact with the parent nodes. or just the leaf nodes. When this option is undefined, it will be. true by default. However when allowTraversingTree is true, then it. will be false by default.</p>
    * @param layoutAlgorithm <p>This option decides which algorithm is used for setting position. and dimensions of the points.</p>
    * @param layoutStartingDirection <p>Defines which direction the layout algorithm will start drawing.</p>
    * @param levelIsConstant <p>Used together with the levels and allowTraversingTree options. When. set to false the first level visible to be level one, which is. dynamic when traversing the tree. Otherwise the level will be the. same as the tree structure.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[Double | Null | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "treemap", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, allowDrillToNode: js.UndefOr[Boolean] = js.undefined, allowTraversingTree: js.UndefOr[Boolean] = js.undefined, alternateStartingDirection: js.UndefOr[Boolean] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, colorByPoint: js.UndefOr[js.Any] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, drillUpButton: js.UndefOr[js.Any] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, ignoreHiddenPoint: js.UndefOr[Boolean] = js.undefined, interactByLeaf: js.UndefOr[Boolean] = js.undefined, layoutAlgorithm: js.UndefOr[String] = js.undefined, layoutStartingDirection: js.UndefOr[String] = js.undefined, levelIsConstant: js.UndefOr[Boolean] = js.undefined, levels: js.UndefOr[js.Array[js.Any]] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, sortIndex: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, traverseUpButton: js.UndefOr[js.Any] = js.undefined, cluster: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, boostBlending: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesTreemapConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined): SeriesTreemap = {
