...
/**
  * @note JavaScript name: <code>plotOptions-pc-dataLabels-filter</code>
  */
class PlotOptionsPcDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPcDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcDataLabelsFilter {
