...
/**
  * @note JavaScript name: <code>plotOptions-abands-states-hover-halo</code>
  */
class PlotOptionsAbandsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsStatesHoverHalo {
