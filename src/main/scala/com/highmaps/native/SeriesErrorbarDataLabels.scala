...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-dataLabels</code>
  */
class SeriesErrorbarDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataLabels {
  /**
