...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data-dataLabels</code>
  */
class SeriesLollipopDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataDataLabels {
  /**
