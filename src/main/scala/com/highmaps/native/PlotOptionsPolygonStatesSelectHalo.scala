...
/**
  * @note JavaScript name: <code>plotOptions-polygon-states-select-halo</code>
  */
class PlotOptionsPolygonStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonStatesSelectHalo {
