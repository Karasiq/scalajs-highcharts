...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-dataLabels-animation</code>
  */
class PlotOptionsSlowstochasticDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSlowstochasticDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticDataLabelsAnimation {
      this.defer = defer
    })
  }
}
