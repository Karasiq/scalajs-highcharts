...
/**
  * @note JavaScript name: <code>plotOptions-klinger-dataLabels-filter</code>
  */
class PlotOptionsKlingerDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerDataLabelsFilter {
