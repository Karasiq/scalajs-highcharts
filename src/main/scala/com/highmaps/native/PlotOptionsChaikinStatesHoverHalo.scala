...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-states-hover-halo</code>
  */
class PlotOptionsChaikinStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinStatesHoverHalo {
