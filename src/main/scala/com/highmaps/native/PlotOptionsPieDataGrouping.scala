...
/**
  * @note JavaScript name: <code>plotOptions-pie-dataGrouping</code>
  */
class PlotOptionsPieDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieDataGrouping {
  /**
