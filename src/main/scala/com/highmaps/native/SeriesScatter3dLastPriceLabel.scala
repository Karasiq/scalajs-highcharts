...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-lastPrice-label</code>
  */
class SeriesScatter3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dLastPriceLabel {
  /**
