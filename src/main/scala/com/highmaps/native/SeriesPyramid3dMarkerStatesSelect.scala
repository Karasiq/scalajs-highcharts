...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-marker-states-select</code>
  */
class SeriesPyramid3dMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesPyramid3dMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dMarkerStatesSelect {
