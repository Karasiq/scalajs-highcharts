...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-dataSorting</code>
  */
class SeriesSplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesSplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataSorting {
