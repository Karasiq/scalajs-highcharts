...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-dataLabels</code>
  */
class SeriesWindbarbDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataDataLabels {
  /**
