...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;</code>
  */
class SeriesHollowcandlestick extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>hollowcandlestick</code> series
    ...
    * <a href="#series.hollowcandlestick.turboThreshold">turboThreshold</a>, this option is not
    * available.</p>
    * <pre><code class="language-js">data: [{
    *     x: 1,
    *     open: 9,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "hollowcandlestick"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>The fill color of the candlestick when the current
    * close is lower than the previous one.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hollow-candlestick-color/">Custom colors</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/hollow-candlestick/">Colors in styled mode</a>
    */
  ...
  /**
    * <p>The color of the line/border of the hollow candlestick when
    * the current close is lower than the previous one.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hollow-candlestick-color/">Custom colors</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/hollow-candlestick/">Colors in styled mode</a>
    */
  ...
  /**
    * <p>The fill color of the candlestick when the current
    * close is higher than the previous one.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hollow-candlestick-color/">Custom colors</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/hollow-candlestick/">Colors in styled mode</a>
    */
  var upColor: js.Any = js.undefined

  /**
    * <p>The color of the line/border of the hollow candlestick when
    * the current close is higher than the previous one.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hollow-candlestick-color/">Custom colors</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/hollow-candlestick/">Colors in styled mode</a>
    * @since 1.3.6
    */
  var upLineColor: js.Any = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesHollowcandlestickConnectors]] = js.undefined
...
object SeriesHollowcandlestick {
  /**
    ...
    * @param color <p>The fill color of the candlestick when the current. close is lower than the previous one.</p>
    ...
    * @param lineColor <p>The color of the line/border of the hollow candlestick when. the current close is lower than the previous one.</p>
    * @param upColor <p>The fill color of the candlestick when the current. close is higher than the previous one.</p>
    * @param upLineColor <p>The color of the line/border of the hollow candlestick when. the current close is higher than the previous one.</p>
