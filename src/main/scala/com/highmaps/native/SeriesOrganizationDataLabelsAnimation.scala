...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-dataLabels-animation</code>
  */
class SeriesOrganizationDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesOrganizationDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationDataLabelsAnimation {
      this.defer = defer
    })
  }
}
