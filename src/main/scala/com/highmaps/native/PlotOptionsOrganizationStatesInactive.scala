...
/**
  * @note JavaScript name: <code>plotOptions-organization-states-inactive</code>
  */
class PlotOptionsOrganizationStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationStatesInactive {
