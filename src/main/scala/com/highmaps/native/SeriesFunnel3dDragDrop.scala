...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dragDrop</code>
  */
class SeriesFunnel3dDragDrop extends com.highcharts.HighchartsGenericObject {
