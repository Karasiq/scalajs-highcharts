...
/**
  * @note JavaScript name: <code>plotOptions-trendline-label</code>
  */
class PlotOptionsTrendlineLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineLabel {
  /**
