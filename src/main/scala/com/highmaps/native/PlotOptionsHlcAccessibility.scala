...
/**
  * @note JavaScript name: <code>plotOptions-hlc-accessibility</code>
  */
class PlotOptionsHlcAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsHlcAccessibilityPoint]] = js.undefined
}

object PlotOptionsHlcAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsHlcAccessibilityPoint]] = js.undefined): PlotOptionsHlcAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcAccessibility {
