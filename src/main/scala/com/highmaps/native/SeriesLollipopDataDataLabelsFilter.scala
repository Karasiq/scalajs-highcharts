...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data-dataLabels-filter</code>
  */
class SeriesLollipopDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLollipopDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopDataDataLabelsFilter {
