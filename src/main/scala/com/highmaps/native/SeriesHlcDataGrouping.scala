...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dataGrouping</code>
  */
class SeriesHlcDataGrouping extends com.highcharts.HighchartsGenericObject {
