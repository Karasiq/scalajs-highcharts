...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-marker-states</code>
  */
class SeriesSlowstochasticMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSlowstochasticMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
