...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-dataGrouping</code>
  */
class PlotOptionsStreamgraphDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphDataGrouping {
  /**
