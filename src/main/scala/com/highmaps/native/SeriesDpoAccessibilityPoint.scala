...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-accessibility-point</code>
  */
class SeriesDpoAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesDpoAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoAccessibilityPoint {
