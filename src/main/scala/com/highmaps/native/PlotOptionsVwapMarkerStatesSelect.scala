...
/**
  * @note JavaScript name: <code>plotOptions-vwap-marker-states-select</code>
  */
class PlotOptionsVwapMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): PlotOptionsVwapMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapMarkerStatesSelect {
