...
/**
  * @note JavaScript name: <code>plotOptions-aroon-states-hover-halo</code>
  */
class PlotOptionsAroonStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAroonStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonStatesHoverHalo {
