...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-states</code>
  */
class SeriesPpoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesPpoStatesSelect]] = js.undefined
}

object SeriesPpoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesPpoStatesSelect]] = js.undefined): SeriesPpoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoStates {
      this.hover = hover
