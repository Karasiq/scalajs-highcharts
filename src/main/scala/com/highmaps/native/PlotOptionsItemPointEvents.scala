...
/**
  * @note JavaScript name: <code>plotOptions-item-point-events</code>
  */
class PlotOptionsItemPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemPointEvents {
  /**
    ...
    */
  def apply(legendItemClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsItemPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemPointEvents {
