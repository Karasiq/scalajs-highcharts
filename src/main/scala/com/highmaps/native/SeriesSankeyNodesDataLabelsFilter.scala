...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-nodes-dataLabels-filter</code>
  */
class SeriesSankeyNodesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyNodesDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSankeyNodesDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyNodesDataLabelsFilter {
