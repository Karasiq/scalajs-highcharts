...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-accessibility-point</code>
  */
class SeriesWaterfallAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesWaterfallAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallAccessibilityPoint {
