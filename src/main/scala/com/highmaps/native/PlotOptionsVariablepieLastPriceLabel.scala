...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-lastPrice-label</code>
  */
class PlotOptionsVariablepieLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariablepieLastPriceLabel {
  /**
