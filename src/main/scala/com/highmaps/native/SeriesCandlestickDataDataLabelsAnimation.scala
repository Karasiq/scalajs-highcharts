...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-data-dataLabels-animation</code>
  */
class SeriesCandlestickDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCandlestickDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
