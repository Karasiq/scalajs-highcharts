...
/**
  * @note JavaScript name: <code>plotOptions-ppo-states</code>
  */
class PlotOptionsPpoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsPpoStatesSelect]] = js.undefined
}

object PlotOptionsPpoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsPpoStatesSelect]] = js.undefined): PlotOptionsPpoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoStates {
      this.hover = hover
