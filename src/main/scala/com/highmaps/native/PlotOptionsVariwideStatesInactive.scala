...
/**
  * @note JavaScript name: <code>plotOptions-variwide-states-inactive</code>
  */
class PlotOptionsVariwideStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsVariwideStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideStatesInactive {
