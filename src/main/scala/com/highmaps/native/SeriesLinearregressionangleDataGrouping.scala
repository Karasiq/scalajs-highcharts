...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-dataGrouping</code>
  */
class SeriesLinearregressionangleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleDataGrouping {
  /**
