...
/**
  * @note JavaScript name: <code>plotOptions-bubble-dataLabels-filter</code>
  */
class PlotOptionsBubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleDataLabelsFilter {
