...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-dragDrop-dragHandle</code>
  */
class SeriesPyramid3dDataDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesPyramid3dDataDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataDragDropDragHandle {
