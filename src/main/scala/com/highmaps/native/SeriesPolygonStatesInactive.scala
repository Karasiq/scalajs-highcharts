...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-states-inactive</code>
  */
class SeriesPolygonStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPolygonStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonStatesInactive {
