...
/**
  * @note JavaScript name: <code>plotOptions-tema-marker</code>
  */
class PlotOptionsTemaMarker extends com.highcharts.HighchartsGenericObject {
