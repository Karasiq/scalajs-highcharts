...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-dataGrouping</code>
  */
class SeriesObvDataGrouping extends com.highcharts.HighchartsGenericObject {
