...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;</code>
  */
class SeriesScatter3d extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>scatter3d</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li> An array of arrays with 3 values. In this case, the values correspond
    * to <code>x,y,z</code>. If the first value is a string, it is applied as the name
    * of the point, and the <code>x</code> value is inferred.</li>
    * </ol>
    ...
    * <a href="#series.scatter3d.turboThreshold">turboThreshold</a>, this option is not
    * available.</li>
    * </ol>
    * <pre><code class="language-js">   data: [{
    *        x: 1,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    */
  var data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "scatter3d"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-connectnulls-true/">True</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesScatter3dConnectors]] = js.undefined
...
object SeriesScatter3d {
  /**
    * @param data <p>An array of data points for the series. For the <code>scatter3d</code> series. type, points can be given in the following ways:</p>. <ol>. <li> An array of arrays with 3 values. In this case, the values correspond. to <code>x,y,z</code>. If the first value is a string, it is applied as the name. of the point, and the <code>x</code> value is inferred.</li>. </ol>. <pre><code class="language-js">   data: [.        [0, 0, 1],.        [1, 8, 7],.        [2, 9, 2].    ]. </code></pre>. <ol start="3">. <li> An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39;. <a href="#series.scatter3d.turboThreshold">turboThreshold</a>, this option is not. available.</li>. </ol>. <pre><code class="language-js">   data: [{.        x: 1,.        y: 2,.        z: 24,.        name: &quot;Point2&quot;,.        color: &quot;#00FF00&quot;.    }, {.        x: 1,.        y: 4,.        z: 12,.        name: &quot;Point1&quot;,.        color: &quot;#FF00FF&quot;.    }]. </code></pre>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Array[Double] | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[Double | String] = js.undefined, `type`: js.UndefOr[String] = "scatter3d", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, jitter: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesScatter3dConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[js.Any | js.Array[js.Any]] = js.undefined, dataSorting: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined): SeriesScatter3d = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3d {
      this.data = data
      this.id = id
      this.index = index
