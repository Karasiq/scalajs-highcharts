...
/**
  * @note JavaScript name: <code>plotOptions-cmo-lastPrice-label</code>
  */
class PlotOptionsCmoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoLastPriceLabel {
  /**
