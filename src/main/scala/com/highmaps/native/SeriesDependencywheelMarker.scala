...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-marker</code>
  */
class SeriesDependencywheelMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelMarker {
  /**
