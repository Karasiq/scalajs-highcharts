...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-accessibility</code>
  */
class SeriesNetworkgraphAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesNetworkgraphAccessibilityPoint]] = js.undefined
}

object SeriesNetworkgraphAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesNetworkgraphAccessibilityPoint]] = js.undefined): SeriesNetworkgraphAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphAccessibility {
