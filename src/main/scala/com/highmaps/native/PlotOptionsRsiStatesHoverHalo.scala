...
/**
  * @note JavaScript name: <code>plotOptions-rsi-states-hover-halo</code>
  */
class PlotOptionsRsiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsRsiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiStatesHoverHalo {
