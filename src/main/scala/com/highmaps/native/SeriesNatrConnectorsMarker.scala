...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-connectors-marker</code>
  */
class SeriesNatrConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesNatrConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrConnectorsMarker {
      this.align = align
      this.color = color
