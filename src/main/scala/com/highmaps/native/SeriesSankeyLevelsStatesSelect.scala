...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-states-select</code>
  */
class SeriesSankeyLevelsStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSankeyLevelsStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsStatesSelect {
