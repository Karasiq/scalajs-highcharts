...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dataSorting</code>
  */
class PlotOptionsHollowcandlestickDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsHollowcandlestickDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickDataSorting {
