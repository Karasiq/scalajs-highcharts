...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-label</code>
  */
class PlotOptionsDependencywheelLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelLabel {
  /**
