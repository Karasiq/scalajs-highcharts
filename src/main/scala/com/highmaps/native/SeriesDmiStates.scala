...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-states</code>
  */
class SeriesDmiStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesDmiStatesSelect]] = js.undefined
}

object SeriesDmiStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDmiStatesSelect]] = js.undefined): SeriesDmiStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiStates {
      this.hover = hover
