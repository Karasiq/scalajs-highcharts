...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-dataLabels</code>
  */
class PlotOptionsChaikinDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinDataLabels {
  /**
