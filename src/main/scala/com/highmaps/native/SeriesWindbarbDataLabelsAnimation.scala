...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-dataLabels-animation</code>
  */
class SeriesWindbarbDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWindbarbDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataLabelsAnimation {
      this.defer = defer
    })
  }
}
