...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-dataLabels</code>
  */
class SeriesLollipopDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataLabels {
  /**
