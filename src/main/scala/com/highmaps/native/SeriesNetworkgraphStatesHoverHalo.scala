...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-states-hover-halo</code>
  */
class SeriesNetworkgraphStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphStatesHoverHalo {
