...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-accessibility-point</code>
  */
class SeriesSunburstAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesSunburstAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstAccessibilityPoint {
