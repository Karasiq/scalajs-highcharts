...
/**
  * @note JavaScript name: <code>plotOptions-apo-dataSorting</code>
  */
class PlotOptionsApoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsApoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoDataSorting {
