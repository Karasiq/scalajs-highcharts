...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-dataGrouping</code>
  */
class PlotOptionsLinearregressionDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionDataGrouping {
  /**
