...
/**
  * @note JavaScript name: <code>plotOptions-dmi-dataLabels-animation</code>
  */
class PlotOptionsDmiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDmiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
