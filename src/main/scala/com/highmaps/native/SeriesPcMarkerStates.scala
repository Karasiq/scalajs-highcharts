...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-marker-states</code>
  */
class SeriesPcMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPcMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
