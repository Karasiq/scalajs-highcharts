...
/**
  * @note JavaScript name: <code>plotOptions-aroon-lastPrice-label</code>
  */
class PlotOptionsAroonLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonLastPriceLabel {
  /**
