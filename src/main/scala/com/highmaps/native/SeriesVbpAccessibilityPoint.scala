...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-accessibility-point</code>
  */
class SeriesVbpAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVbpAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpAccessibilityPoint {
