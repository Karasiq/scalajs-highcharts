...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-dataGrouping</code>
  */
class SeriesTimelineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataGrouping {
  /**
