...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-zones</code>
  */
class SeriesMacdZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMacdZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdZones {
