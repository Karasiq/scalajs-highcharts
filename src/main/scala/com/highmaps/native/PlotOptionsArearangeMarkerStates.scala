...
/**
  * @note JavaScript name: <code>plotOptions-arearange-marker-states</code>
  */
class PlotOptionsArearangeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsArearangeMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
