...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-dataLabels-animation</code>
  */
class SeriesStreamgraphDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesStreamgraphDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataLabelsAnimation {
      this.defer = defer
    })
  }
}
