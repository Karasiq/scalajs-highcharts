...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-accessibility</code>
  */
class SeriesLinearregressioninterceptAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptAccessibilityPoint]] = js.undefined
}

object SeriesLinearregressioninterceptAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLinearregressioninterceptAccessibilityPoint]] = js.undefined): SeriesLinearregressioninterceptAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptAccessibility {
