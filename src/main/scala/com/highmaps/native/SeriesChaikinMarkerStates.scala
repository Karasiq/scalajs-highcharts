...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-marker-states</code>
  */
class SeriesChaikinMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesChaikinMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
