...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-accessibility</code>
  */
class PlotOptionsAreasplineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAreasplineAccessibilityPoint]] = js.undefined
}

object PlotOptionsAreasplineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAreasplineAccessibilityPoint]] = js.undefined): PlotOptionsAreasplineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineAccessibility {
