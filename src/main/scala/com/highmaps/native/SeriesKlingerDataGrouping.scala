...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dataGrouping</code>
  */
class SeriesKlingerDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerDataGrouping {
  /**
