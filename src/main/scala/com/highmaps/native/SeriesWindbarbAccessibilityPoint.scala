...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-accessibility-point</code>
  */
class SeriesWindbarbAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesWindbarbAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbAccessibilityPoint {
