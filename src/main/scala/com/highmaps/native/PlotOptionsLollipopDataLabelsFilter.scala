...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dataLabels-filter</code>
  */
class PlotOptionsLollipopDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopDataLabelsFilter {
