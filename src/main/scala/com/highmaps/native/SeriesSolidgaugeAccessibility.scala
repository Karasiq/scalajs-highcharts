...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-accessibility</code>
  */
class SeriesSolidgaugeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSolidgaugeAccessibilityPoint]] = js.undefined
}

object SeriesSolidgaugeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSolidgaugeAccessibilityPoint]] = js.undefined): SeriesSolidgaugeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeAccessibility {
