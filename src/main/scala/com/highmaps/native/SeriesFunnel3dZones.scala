...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-zones</code>
  */
class SeriesFunnel3dZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFunnel3dZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dZones {
