...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-data-accessibility</code>
  */
class SeriesSplineDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSplineDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataAccessibility {
