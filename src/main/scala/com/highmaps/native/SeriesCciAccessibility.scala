...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-accessibility</code>
  */
class SeriesCciAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesCciAccessibilityPoint]] = js.undefined
}

object SeriesCciAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesCciAccessibilityPoint]] = js.undefined): SeriesCciAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciAccessibility {
