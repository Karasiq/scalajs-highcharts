...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-data-dataLabels-filter</code>
  */
class SeriesPyramid3dDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPyramid3dDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataDataLabelsFilter {
