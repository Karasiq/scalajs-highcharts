...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-zones</code>
  */
class SeriesErrorbarZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesErrorbarZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarZones {
