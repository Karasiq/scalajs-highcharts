...
/**
  * @note JavaScript name: <code>plotOptions-rsi-marker-states</code>
  */
class PlotOptionsRsiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsRsiMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
