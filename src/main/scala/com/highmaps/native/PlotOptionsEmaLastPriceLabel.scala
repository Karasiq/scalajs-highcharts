...
/**
  * @note JavaScript name: <code>plotOptions-ema-lastPrice-label</code>
  */
class PlotOptionsEmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaLastPriceLabel {
  /**
