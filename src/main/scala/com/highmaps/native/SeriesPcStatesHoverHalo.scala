...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-states-hover-halo</code>
  */
class SeriesPcStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPcStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcStatesHoverHalo {
