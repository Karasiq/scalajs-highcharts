...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-data-accessibility</code>
  */
class SeriesErrorbarDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesErrorbarDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarDataAccessibility {
