...
/**
  * @note JavaScript name: <code>plotOptions-item-states-hover-halo</code>
  */
class PlotOptionsItemStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsItemStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemStatesHoverHalo {
