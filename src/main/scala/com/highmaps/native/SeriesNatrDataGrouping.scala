...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dataGrouping</code>
  */
class SeriesNatrDataGrouping extends com.highcharts.HighchartsGenericObject {
