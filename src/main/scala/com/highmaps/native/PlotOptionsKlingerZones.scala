...
/**
  * @note JavaScript name: <code>plotOptions-klinger-zones</code>
  */
class PlotOptionsKlingerZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerZones {
