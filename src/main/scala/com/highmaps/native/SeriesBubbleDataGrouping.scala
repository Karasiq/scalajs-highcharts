...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-dataGrouping</code>
  */
class SeriesBubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataGrouping {
  /**
