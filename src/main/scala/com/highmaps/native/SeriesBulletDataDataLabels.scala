...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-data-dataLabels</code>
  */
class SeriesBulletDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataDataLabels {
  /**
