...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-accessibility-point</code>
  */
class SeriesItemAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesItemAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemAccessibilityPoint {
