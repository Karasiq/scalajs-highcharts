...
/**
  * @note JavaScript name: <code>plotOptions-cmf-states-inactive</code>
  */
class PlotOptionsCmfStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsCmfStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfStatesInactive {
