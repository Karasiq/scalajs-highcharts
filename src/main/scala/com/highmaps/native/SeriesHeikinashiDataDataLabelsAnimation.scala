...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-dataLabels-animation</code>
  */
class SeriesHeikinashiDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHeikinashiDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
