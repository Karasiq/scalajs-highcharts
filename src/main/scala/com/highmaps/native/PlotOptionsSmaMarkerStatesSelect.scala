...
/**
  * @note JavaScript name: <code>plotOptions-sma-marker-states-select</code>
  */
class PlotOptionsSmaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): PlotOptionsSmaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaMarkerStatesSelect {
