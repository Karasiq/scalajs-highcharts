...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-states-hover-halo</code>
  */
class SeriesApoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesApoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoStatesHoverHalo {
