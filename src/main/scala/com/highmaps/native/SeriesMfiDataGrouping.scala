...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-dataGrouping</code>
  */
class SeriesMfiDataGrouping extends com.highcharts.HighchartsGenericObject {
