...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-lastPrice-label</code>
  */
class SeriesGanttLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttLastPriceLabel {
  /**
