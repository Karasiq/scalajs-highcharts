...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-dataLabels-filter</code>
  */
class PlotOptionsNetworkgraphDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphDataLabelsFilter {
