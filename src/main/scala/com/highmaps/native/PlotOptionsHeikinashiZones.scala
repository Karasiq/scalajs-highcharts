...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-zones</code>
  */
class PlotOptionsHeikinashiZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHeikinashiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiZones {
