...
object PlotOptionsMacdParams {
  /**
    ...
    */
  def apply(longPeriod: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined, shortPeriod: js.UndefOr[Double] = js.undefined, signalPeriod: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined): PlotOptionsMacdParams = {
