...
/**
  * @note JavaScript name: <code>chart-parallelAxes-crosshair</code>
  */
class ChartParallelAxesCrosshair extends com.highcharts.HighchartsGenericObject {
...
object ChartParallelAxesCrosshair {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[js.Any] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, snap: js.UndefOr[Boolean] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): ChartParallelAxesCrosshair = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ChartParallelAxesCrosshair {
