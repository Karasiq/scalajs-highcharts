...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-accessibility-point</code>
  */
class SeriesAdAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAdAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdAccessibilityPoint {
