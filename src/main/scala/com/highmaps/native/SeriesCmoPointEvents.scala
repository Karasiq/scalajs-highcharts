...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-point-events</code>
  */
class SeriesCmoPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesCmoPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoPointEvents {
      this.click = click
      this.drag = drag
