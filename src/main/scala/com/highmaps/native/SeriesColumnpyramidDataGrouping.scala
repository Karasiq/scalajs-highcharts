...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dataGrouping</code>
  */
class SeriesColumnpyramidDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataGrouping {
  /**
