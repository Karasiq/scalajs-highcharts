...
/**
  * @note JavaScript name: <code>plotOptions-series-dataLabels-animation</code>
  */
class PlotOptionsSeriesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
