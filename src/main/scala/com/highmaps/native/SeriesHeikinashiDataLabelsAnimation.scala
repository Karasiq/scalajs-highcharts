...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dataLabels-animation</code>
  */
class SeriesHeikinashiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHeikinashiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
