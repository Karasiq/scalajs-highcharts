...
/**
  * @note JavaScript name: <code>plotOptions-macd-dataSorting</code>
  */
class PlotOptionsMacdDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMacdDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdDataSorting {
