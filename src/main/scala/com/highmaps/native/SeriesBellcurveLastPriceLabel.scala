...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-lastPrice-label</code>
  */
class SeriesBellcurveLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveLastPriceLabel {
  /**
