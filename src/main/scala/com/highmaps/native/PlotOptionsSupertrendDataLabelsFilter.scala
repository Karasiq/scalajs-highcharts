...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-dataLabels-filter</code>
  */
class PlotOptionsSupertrendDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendDataLabelsFilter {
