...
/**
  * @note JavaScript name: <code>plotOptions-sankey-levels-dataLabels-filter</code>
  */
class PlotOptionsSankeyLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyLevelsDataLabelsFilter {
