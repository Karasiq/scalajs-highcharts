...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dataSorting</code>
  */
class PlotOptionsHeikinashiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsHeikinashiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiDataSorting {
