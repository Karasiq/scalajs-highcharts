...
/**
  ...
  */
class SeriesErrorbar extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>errorbar</code> series
    ...
    * to <code>x,low,high</code>. If the first value is a string, it is applied as the name
    * of the point, and the <code>x</code> value is inferred. The <code>x</code> value can also be
    ...
    * <a href="#series.errorbar.turboThreshold">turboThreshold</a>, this option is not
    * available.</p>
    * <pre><code class="language-js">data: [{
    *     x: 1,
    *     low: 0,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "errorbar"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>The main color of the bars. This can be overridden by
    * <a href="#plotOptions.errorbar.stemColor">stemColor</a> and
    * <a href="#plotOptions.errorbar.whiskerColor">whiskerColor</a> individually.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/column-grouping-false/">Grouping disabled</a>
  ...
  /**
    * <p>The parent series of the error bar. The default value links it to
    * the previous series. Otherwise, use the id of the parent series.</p>
  ...
  /**
    * <p>The line width of the whiskers, the horizontal lines marking
    * low and high values. When <code>null</code>, the general
    * <a href="#plotOptions.errorbar.lineWidth">lineWidth</a> applies.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
  ...
  /**
    * <p>The color of the median line. If <code>undefined</code>, the general series
    * color applies.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
    * @since 3.0.0
    */
  var medianColor: js.UndefOr[String | js.Object] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/boxplot/">Box plot in styled mode</a>
    * @since 3.0.0
    */
  var medianWidth: js.UndefOr[Double | Null] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
  ...
  /**
    ...
    * the whiskers. If <code>undefined</code>, the width is inherited from the
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/error-bar-styling/">Error bar styling</a>
  ...
  /**
    ...
    * values. When <code>undefined</code>, the general series color is used.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/boxplot/">Box plot in styled mode</a>
    * @since 3.0.0
    */
  var whiskerColor: js.UndefOr[String | js.Object] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesErrorbarConnectors]] = js.undefined
...
object SeriesErrorbar {
  /**
    ...
    * @param color <p>The main color of the bars. This can be overridden by. <a href="#plotOptions.errorbar.stemColor">stemColor</a> and. <a href="#plotOptions.errorbar.whiskerColor">whiskerColor</a> individually.</p>
    ...
    * @param linkedTo <p>The parent series of the error bar. The default value links it to. the previous series. Otherwise, use the id of the parent series.</p>
    ...
    * @param whiskerWidth <p>The line width of the whiskers, the horizontal lines marking. low and high values. When <code>null</code>, the general. <a href="#plotOptions.errorbar.lineWidth">lineWidth</a> applies.</p>
    ...
    * @param medianColor <p>The color of the median line. If <code>undefined</code>, the general series. color applies.</p>. <p>In styled mode, the median stroke width can be set with the. <code>.highcharts-boxplot-median</code> class.</p>
    ...
    * @param stemWidth <p>The width of the stem, the vertical line extending from the box to. the whiskers. If <code>undefined</code>, the width is inherited from the. <a href="#plotOptions.boxplot.lineWidth">lineWidth</a> option.</p>. <p>In styled mode, the stem stroke width can be set with the. <code>.highcharts-boxplot-stem</code> class.</p>
    ...
    * @param whiskerColor <p>The color of the whiskers, the horizontal lines marking low and high. values. When <code>undefined</code>, the general series color is used.</p>. <p>In styled mode, the whisker stroke can be set with the. <code>.highcharts-boxplot-whisker</code> class .</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Array[js.Array[js.Any]] | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "errorbar", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, whiskerWidth: js.UndefOr[Double] = js.undefined, boxDashStyle: js.UndefOr[String] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, medianColor: js.UndefOr[String | js.Object] = js.undefined, medianDashStyle: js.UndefOr[String] = js.undefined, medianWidth: js.UndefOr[Double | Null] = js.undefined, stemDashStyle: js.UndefOr[String] = js.undefined, stemWidth: js.UndefOr[Double] = js.undefined, threshold: js.UndefOr[js.Any] = js.undefined, whiskerColor: js.UndefOr[String | js.Object] = js.undefined, whiskerDashStyle: js.UndefOr[String] = js.undefined, whiskerLength: js.UndefOr[Double | String] = js.undefined, centerInCategory: js.UndefOr[Boolean] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesErrorbarConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataSorting: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, step: js.UndefOr[String] = js.undefined): SeriesErrorbar = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbar {
      this.data = data
      this.id = id
      this.index = index
