...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-states-hover-halo</code>
  */
class SeriesPieStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPieStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieStatesHoverHalo {
