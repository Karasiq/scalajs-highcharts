...
/**
  * @note JavaScript name: <code>plotOptions-abands-accessibility</code>
  */
class PlotOptionsAbandsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAbandsAccessibilityPoint]] = js.undefined
}

object PlotOptionsAbandsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAbandsAccessibilityPoint]] = js.undefined): PlotOptionsAbandsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsAccessibility {
