...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-accessibility</code>
  */
class SeriesMappointAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesMappointAccessibilityPoint]] = js.undefined
}

object SeriesMappointAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesMappointAccessibilityPoint]] = js.undefined): SeriesMappointAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointAccessibility {
