...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-states-inactive</code>
  */
class SeriesTimelineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTimelineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineStatesInactive {
