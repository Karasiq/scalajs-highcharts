...
/**
  * @note JavaScript name: <code>plotOptions-ad-marker-states</code>
  */
class PlotOptionsAdMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAdMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
