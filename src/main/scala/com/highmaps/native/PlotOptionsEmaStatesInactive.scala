...
/**
  * @note JavaScript name: <code>plotOptions-ema-states-inactive</code>
  */
class PlotOptionsEmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsEmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaStatesInactive {
