...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-states-select-halo</code>
  */
class SeriesChaikinStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesChaikinStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinStatesSelectHalo {
