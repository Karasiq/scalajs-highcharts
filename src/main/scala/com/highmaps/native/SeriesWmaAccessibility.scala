...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-accessibility</code>
  */
class SeriesWmaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesWmaAccessibilityPoint]] = js.undefined
}

object SeriesWmaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesWmaAccessibilityPoint]] = js.undefined): SeriesWmaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaAccessibility {
