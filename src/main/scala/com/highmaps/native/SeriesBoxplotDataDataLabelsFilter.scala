...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-data-dataLabels-filter</code>
  */
class SeriesBoxplotDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBoxplotDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataDataLabelsFilter {
