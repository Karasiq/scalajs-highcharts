...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dataSorting</code>
  */
class SeriesGanttDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesGanttDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataSorting {
