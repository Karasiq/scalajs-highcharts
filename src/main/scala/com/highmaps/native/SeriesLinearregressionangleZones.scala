...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-zones</code>
  */
class SeriesLinearregressionangleZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleZones {
