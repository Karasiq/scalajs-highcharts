...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-marker-states-select</code>
  */
class SeriesDmiMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesDmiMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiMarkerStatesSelect {
