...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-dataLabels-animation</code>
  */
class SeriesVariablepieDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVariablepieDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieDataLabelsAnimation {
      this.defer = defer
    })
  }
}
