...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dragDrop</code>
  */
class SeriesTrixDragDrop extends com.highcharts.HighchartsGenericObject {
