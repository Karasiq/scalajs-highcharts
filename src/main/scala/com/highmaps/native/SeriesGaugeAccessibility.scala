...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-accessibility</code>
  */
class SeriesGaugeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesGaugeAccessibilityPoint]] = js.undefined
}

object SeriesGaugeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesGaugeAccessibilityPoint]] = js.undefined): SeriesGaugeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeAccessibility {
