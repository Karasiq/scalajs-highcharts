...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-dataLabels-animation</code>
  */
class SeriesPriceenvelopesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPriceenvelopesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPriceenvelopesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
