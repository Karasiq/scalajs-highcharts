...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-dataLabels-filter</code>
  */
class SeriesPsarDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPsarDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarDataLabelsFilter {
