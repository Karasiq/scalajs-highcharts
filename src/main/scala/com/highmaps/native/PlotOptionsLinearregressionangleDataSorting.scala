...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-dataSorting</code>
  */
class PlotOptionsLinearregressionangleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLinearregressionangleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleDataSorting {
