...
/**
  * @note JavaScript name: <code>navigator-series-dataLabels-filter</code>
  */
class NavigatorSeriesDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object NavigatorSeriesDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): NavigatorSeriesDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorSeriesDataLabelsFilter {
