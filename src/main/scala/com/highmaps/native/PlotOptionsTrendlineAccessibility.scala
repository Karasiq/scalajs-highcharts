...
/**
  * @note JavaScript name: <code>plotOptions-trendline-accessibility</code>
  */
class PlotOptionsTrendlineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTrendlineAccessibilityPoint]] = js.undefined
}

object PlotOptionsTrendlineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTrendlineAccessibilityPoint]] = js.undefined): PlotOptionsTrendlineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineAccessibility {
