...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-dataLabels-filter</code>
  */
class SeriesOrganizationDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesOrganizationDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationDataLabelsFilter {
