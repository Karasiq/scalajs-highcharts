...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dataLabels-filter</code>
  */
class SeriesColumnpyramidDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataLabelsFilter {
