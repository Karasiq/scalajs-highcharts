...
/**
  * @note JavaScript name: <code>plotOptions-column-lastPrice-label</code>
  */
class PlotOptionsColumnLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnLastPriceLabel {
  /**
