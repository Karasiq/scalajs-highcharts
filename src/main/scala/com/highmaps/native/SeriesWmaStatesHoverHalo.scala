...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-states-hover-halo</code>
  */
class SeriesWmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesWmaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaStatesHoverHalo {
