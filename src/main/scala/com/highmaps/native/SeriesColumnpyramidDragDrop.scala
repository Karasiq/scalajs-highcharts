...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dragDrop</code>
  */
class SeriesColumnpyramidDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDragDrop {
  /**
