...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-data-accessibility</code>
  */
class SeriesOrganizationDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesOrganizationDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationDataAccessibility {
