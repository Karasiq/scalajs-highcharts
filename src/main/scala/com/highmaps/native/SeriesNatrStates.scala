...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-states</code>
  */
class SeriesNatrStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesNatrStatesSelect]] = js.undefined
}

object SeriesNatrStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesNatrStatesSelect]] = js.undefined): SeriesNatrStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrStates {
      this.hover = hover
