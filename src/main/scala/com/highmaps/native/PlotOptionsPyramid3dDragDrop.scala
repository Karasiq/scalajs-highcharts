...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-dragDrop</code>
  */
class PlotOptionsPyramid3dDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dDragDrop {
  /**
