...
/**
  * @note JavaScript name: <code>plotOptions-hlc-lastPrice-label</code>
  */
class PlotOptionsHlcLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcLastPriceLabel {
  /**
