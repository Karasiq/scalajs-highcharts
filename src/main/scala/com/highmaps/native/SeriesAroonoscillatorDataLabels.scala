...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dataLabels</code>
  */
class SeriesAroonoscillatorDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDataLabels {
  /**
