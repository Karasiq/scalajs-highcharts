...
/**
  * @note JavaScript name: <code>plotOptions-obv-dataLabels-animation</code>
  */
class PlotOptionsObvDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsObvDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsObvDataLabelsAnimation {
      this.defer = defer
    })
  }
}
