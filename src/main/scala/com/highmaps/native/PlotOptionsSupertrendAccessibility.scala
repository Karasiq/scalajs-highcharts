...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-accessibility</code>
  */
class PlotOptionsSupertrendAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSupertrendAccessibilityPoint]] = js.undefined
}

object PlotOptionsSupertrendAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSupertrendAccessibilityPoint]] = js.undefined): PlotOptionsSupertrendAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendAccessibility {
