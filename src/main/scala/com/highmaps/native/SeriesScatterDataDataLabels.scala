...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-data-dataLabels</code>
  */
class SeriesScatterDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataDataLabels {
  /**
