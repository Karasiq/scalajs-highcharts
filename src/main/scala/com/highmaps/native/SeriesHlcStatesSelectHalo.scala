...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-states-select-halo</code>
  */
class SeriesHlcStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHlcStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcStatesSelectHalo {
