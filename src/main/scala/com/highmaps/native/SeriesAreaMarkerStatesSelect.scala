...
/**
  ...
  */
class SeriesAreaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaMarkerStatesSelect {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAreaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaMarkerStatesSelect {
