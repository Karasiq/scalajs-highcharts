...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-states-inactive</code>
  */
class SeriesTrendlineStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTrendlineStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineStatesInactive {
