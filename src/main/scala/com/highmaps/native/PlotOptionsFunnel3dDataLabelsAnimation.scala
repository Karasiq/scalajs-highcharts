...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-dataLabels-animation</code>
  */
class PlotOptionsFunnel3dDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsFunnel3dDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dDataLabelsAnimation {
      this.defer = defer
    })
  }
}
