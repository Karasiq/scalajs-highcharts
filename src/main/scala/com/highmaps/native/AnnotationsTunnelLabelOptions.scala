...
/**
  * @note JavaScript name: <code>annotations-tunnel-labelOptions</code>
  */
class AnnotationsTunnelLabelOptions extends com.highcharts.HighchartsGenericObject {
