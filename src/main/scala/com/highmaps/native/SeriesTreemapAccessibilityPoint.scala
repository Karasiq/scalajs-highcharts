...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-accessibility-point</code>
  */
class SeriesTreemapAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTreemapAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapAccessibilityPoint {
