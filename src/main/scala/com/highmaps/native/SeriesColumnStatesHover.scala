...
/**
  ...
  */
class SeriesColumnStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesColumnStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnStatesHover {
