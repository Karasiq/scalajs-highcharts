...
/**
  * @note JavaScript name: <code>plotOptions-dpo-dataGrouping</code>
  */
class PlotOptionsDpoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoDataGrouping {
  /**
