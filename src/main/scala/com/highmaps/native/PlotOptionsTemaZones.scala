...
/**
  * @note JavaScript name: <code>plotOptions-tema-zones</code>
  */
class PlotOptionsTemaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTemaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaZones {
