...
/**
  * @note JavaScript name: <code>plotOptions-variablepie-dataLabels-animation</code>
  */
class PlotOptionsVariablepieDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariablepieDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVariablepieDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariablepieDataLabelsAnimation {
      this.defer = defer
    })
  }
}
