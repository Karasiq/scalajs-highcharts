...
/**
  * @note JavaScript name: <code>plotOptions-organization-dataGrouping</code>
  */
class PlotOptionsOrganizationDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationDataGrouping {
  /**
