...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-states</code>
  */
class SeriesApoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesApoStatesSelect]] = js.undefined
}

object SeriesApoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesApoStatesSelect]] = js.undefined): SeriesApoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoStates {
      this.hover = hover
