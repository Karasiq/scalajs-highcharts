...
/**
  * @note JavaScript name: <code>plotOptions-psar-states-select-halo</code>
  */
class PlotOptionsPsarStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPsarStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarStatesSelectHalo {
