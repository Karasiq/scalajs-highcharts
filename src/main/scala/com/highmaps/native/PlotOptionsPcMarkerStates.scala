...
/**
  * @note JavaScript name: <code>plotOptions-pc-marker-states</code>
  */
class PlotOptionsPcMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPcMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
