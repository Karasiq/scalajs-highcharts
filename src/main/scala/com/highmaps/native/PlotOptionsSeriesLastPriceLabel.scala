...
/**
  * @note JavaScript name: <code>plotOptions-series-lastPrice-label</code>
  */
class PlotOptionsSeriesLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesLastPriceLabel {
  /**
