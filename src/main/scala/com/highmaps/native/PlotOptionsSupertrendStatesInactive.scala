...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-states-inactive</code>
  */
class PlotOptionsSupertrendStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSupertrendStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSupertrendStatesInactive {
