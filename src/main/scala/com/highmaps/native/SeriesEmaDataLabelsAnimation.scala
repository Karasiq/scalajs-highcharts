...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-dataLabels-animation</code>
  */
class SeriesEmaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesEmaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
