...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-states</code>
  */
class SeriesCmoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesCmoStatesSelect]] = js.undefined
}

object SeriesCmoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesCmoStatesSelect]] = js.undefined): SeriesCmoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoStates {
      this.hover = hover
