...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-states-select-halo</code>
  */
class SeriesBubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBubbleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleStatesSelectHalo {
