...
/**
  * @note JavaScript name: <code>plotOptions-apo-dataLabels</code>
  */
class PlotOptionsApoDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoDataLabels {
  /**
