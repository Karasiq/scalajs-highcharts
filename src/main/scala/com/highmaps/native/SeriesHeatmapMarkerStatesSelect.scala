...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-marker-states-select</code>
  */
class SeriesHeatmapMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapMarkerStatesSelect {
  /**
    ...
    */
  def apply(heightPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, widthPlus: js.UndefOr[js.UndefOr[Double]] = js.undefined, height: js.UndefOr[js.UndefOr[Double]] = js.undefined, width: js.UndefOr[js.UndefOr[Double]] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesHeatmapMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapMarkerStatesSelect {
