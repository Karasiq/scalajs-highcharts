...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-dataLabels-animation</code>
  */
class PlotOptionsPackedbubbleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
