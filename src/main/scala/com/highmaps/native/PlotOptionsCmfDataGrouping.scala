...
/**
  * @note JavaScript name: <code>plotOptions-cmf-dataGrouping</code>
  */
class PlotOptionsCmfDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfDataGrouping {
  /**
