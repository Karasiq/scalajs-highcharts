...
/**
  * @note JavaScript name: <code>plotOptions-atr-dataLabels-animation</code>
  */
class PlotOptionsAtrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAtrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
