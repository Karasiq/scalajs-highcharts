...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-levels-states</code>
  */
class PlotOptionsDependencywheelLevelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsStatesSelect]] = js.undefined
...
object PlotOptionsDependencywheelLevelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsDependencywheelLevelsStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsDependencywheelLevelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelLevelsStates {
      this.hover = hover
