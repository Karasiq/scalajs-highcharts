...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-label</code>
  */
class SeriesPyramid3dLabel extends com.highcharts.HighchartsGenericObject {
