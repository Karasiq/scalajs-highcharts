...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dataLabels-filter</code>
  */
class PlotOptionsColumnpyramidDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsColumnpyramidDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidDataLabelsFilter {
