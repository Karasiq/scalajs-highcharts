...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-data-dataLabels</code>
  */
class SeriesAreasplinerangeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataDataLabels {
  /**
