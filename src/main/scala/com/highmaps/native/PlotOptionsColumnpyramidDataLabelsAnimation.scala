...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dataLabels-animation</code>
  */
class PlotOptionsColumnpyramidDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsColumnpyramidDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidDataLabelsAnimation {
      this.defer = defer
    })
  }
}
