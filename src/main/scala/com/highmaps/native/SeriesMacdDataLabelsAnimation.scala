...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-dataLabels-animation</code>
  */
class SeriesMacdDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMacdDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdDataLabelsAnimation {
      this.defer = defer
    })
  }
}
