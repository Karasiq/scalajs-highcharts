...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-data-dataLabels-filter</code>
  */
class SeriesColumnpyramidDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataDataLabelsFilter {
