...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-label</code>
  */
class SeriesLinearregressionLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionLabel {
  /**
