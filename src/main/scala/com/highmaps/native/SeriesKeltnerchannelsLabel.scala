...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-label</code>
  */
class SeriesKeltnerchannelsLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsLabel {
  /**
