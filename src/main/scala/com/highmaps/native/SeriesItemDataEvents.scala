...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-events</code>
  */
class SeriesItemDataEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesItemDataEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataEvents {
      this.click = click
      this.drag = drag
