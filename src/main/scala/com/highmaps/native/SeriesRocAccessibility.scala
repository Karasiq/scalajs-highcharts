...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-accessibility</code>
  */
class SeriesRocAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesRocAccessibilityPoint]] = js.undefined
}

object SeriesRocAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesRocAccessibilityPoint]] = js.undefined): SeriesRocAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocAccessibility {
