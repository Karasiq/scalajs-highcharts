...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-dataSorting</code>
  */
class PlotOptionsMappointDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMappointDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointDataSorting {
