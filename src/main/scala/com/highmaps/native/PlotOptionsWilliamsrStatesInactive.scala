...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-states-inactive</code>
  */
class PlotOptionsWilliamsrStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrStatesInactive {
