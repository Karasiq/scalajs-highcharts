...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-marker-states</code>
  */
class PlotOptionsKeltnerchannelsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsKeltnerchannelsMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
