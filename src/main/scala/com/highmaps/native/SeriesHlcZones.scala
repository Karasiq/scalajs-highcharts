...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-zones</code>
  */
class SeriesHlcZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHlcZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcZones {
