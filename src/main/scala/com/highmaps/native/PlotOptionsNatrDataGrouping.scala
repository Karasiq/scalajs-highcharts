...
/**
  * @note JavaScript name: <code>plotOptions-natr-dataGrouping</code>
  */
class PlotOptionsNatrDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrDataGrouping {
  /**
