...
/**
  * @note JavaScript name: <code>plotOptions-column-zones</code>
  */
class PlotOptionsColumnZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsColumnZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnZones {
