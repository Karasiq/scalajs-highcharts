...
/**
  * @note JavaScript name: <code>plotOptions-cci-dataSorting</code>
  */
class PlotOptionsCciDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsCciDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciDataSorting {
