...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-lastPrice-label</code>
  */
class PlotOptionsHollowcandlestickLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHollowcandlestickLastPriceLabel {
  /**
