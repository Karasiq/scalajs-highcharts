...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-marker-states</code>
  */
class SeriesKlingerMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesKlingerMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
