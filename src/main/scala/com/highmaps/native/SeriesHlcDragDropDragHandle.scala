...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-dragDrop-dragHandle</code>
  */
class SeriesHlcDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesHlcDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDragDropDragHandle {
