...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-data</code>
  */
class SeriesCylinderData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesCylinderDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesCylinderDataDragDrop]] = js.undefined
  ...
  /**
    ...
    * @since 7.0.0
    */
  var events: js.UndefOr[CleanJsObject[SeriesCylinderDataEvents]] = js.undefined
...
object SeriesCylinderData {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesCylinderDataDataLabels]] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesCylinderDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesCylinderDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined): SeriesCylinderData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderData {
