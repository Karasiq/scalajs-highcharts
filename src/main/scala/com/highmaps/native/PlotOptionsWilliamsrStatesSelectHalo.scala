...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-states-select-halo</code>
  */
class PlotOptionsWilliamsrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrStatesSelectHalo {
