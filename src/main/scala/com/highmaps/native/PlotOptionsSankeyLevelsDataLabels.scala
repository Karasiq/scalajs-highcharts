...
/**
  * @note JavaScript name: <code>plotOptions-sankey-levels-dataLabels</code>
  */
class PlotOptionsSankeyLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyLevelsDataLabels {
  /**
