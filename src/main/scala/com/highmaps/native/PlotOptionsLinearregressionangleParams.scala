...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-params</code>
  */
class PlotOptionsLinearregressionangleParams extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionangleParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionangleParams {
