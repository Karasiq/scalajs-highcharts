...
/**
  * @note JavaScript name: <code>plotOptions-timeline-label</code>
  */
class PlotOptionsTimelineLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineLabel {
  /**
