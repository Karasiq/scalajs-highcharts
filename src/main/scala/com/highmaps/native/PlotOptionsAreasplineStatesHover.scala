...
/**
  ...
  */
class PlotOptionsAreasplineStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[PlotOptionsAreasplineStatesHoverMarker]] = js.undefined
}
...
object PlotOptionsAreasplineStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsAreasplineStatesHoverMarker]] = js.undefined): PlotOptionsAreasplineStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineStatesHover {
