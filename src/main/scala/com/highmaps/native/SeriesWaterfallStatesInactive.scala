...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-states-inactive</code>
  */
class SeriesWaterfallStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesWaterfallStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesInactive {
