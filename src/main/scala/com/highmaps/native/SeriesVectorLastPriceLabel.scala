...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-lastPrice-label</code>
  */
class SeriesVectorLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorLastPriceLabel {
  /**
