...
class PlotOptionsScatterStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsScatterStatesSelect]] = js.undefined
}
...
object PlotOptionsScatterStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsScatterStatesSelect]] = js.undefined): PlotOptionsScatterStates = {
