...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-label</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudLabel {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, connectorAllowed: js.UndefOr[Boolean] = js.undefined, connectorNeighbourDistance: js.UndefOr[Double] = js.undefined, minFontSize: js.UndefOr[Double] = js.undefined, maxFontSize: js.UndefOr[Double] = js.undefined, onArea: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Any] = js.undefined, boxesToAvoid: js.UndefOr[js.Array[js.Object]] = js.undefined): SeriesWordcloudLabel = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudLabel {
