...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-point-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMapbubblePointEvents extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-point-events-click/" target="_blank">Click marker to display values</a>,
			<a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-point-events-click-url/" target="_blank">go to URL</a>.
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/3.1.1/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-allowpointselect/" target="_blank">Report select and unselect</a>
    */
...
object PlotOptionsMapbubblePointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, remove: js.UndefOr[js.Function] = js.undefined, select: js.UndefOr[js.Function] = js.undefined, unselect: js.UndefOr[js.Function] = js.undefined, update: js.UndefOr[js.Function] = js.undefined): PlotOptionsMapbubblePointEvents = {
    ...
    new PlotOptionsMapbubblePointEvents {
