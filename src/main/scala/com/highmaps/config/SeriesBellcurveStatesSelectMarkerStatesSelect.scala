...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBellcurveStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBellcurveStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveStatesSelectMarkerStatesSelect {
