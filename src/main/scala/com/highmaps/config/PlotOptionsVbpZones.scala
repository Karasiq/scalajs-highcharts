...
/**
  * @note JavaScript name: <code>plotOptions-vbp-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVbpZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVbpZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVbpZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVbpZones {
