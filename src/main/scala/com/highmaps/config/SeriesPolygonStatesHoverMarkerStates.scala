...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPolygonStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonStatesHoverMarkerStates {
