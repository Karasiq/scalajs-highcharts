...
object PlotOptionsSeriesStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[CleanJsObject[PlotOptionsSeriesStatesNormal]] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsSeriesStatesSelect]] = js.undefined): PlotOptionsSeriesStates = {
