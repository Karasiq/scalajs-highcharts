...
class PlotOptionsMaplineStatesNormal extends js.Object {
...
object PlotOptionsMaplineStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsMaplineStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    new PlotOptionsMaplineStatesNormal {
