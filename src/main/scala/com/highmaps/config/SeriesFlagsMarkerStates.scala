...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFlagsMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesFlagsMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsMarkerStates {
