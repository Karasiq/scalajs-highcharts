...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesWordcloudStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudStatesSelectMarkerStatesSelect {
