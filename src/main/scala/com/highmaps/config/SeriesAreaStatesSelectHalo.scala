...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesAreaStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaStatesSelectHalo {
