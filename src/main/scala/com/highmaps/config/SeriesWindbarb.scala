...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarb extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>windbarb</code> series type,
    * points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of arrays with 3 values. In this case, the values correspond
    * to <code>x,value,direction</code>. If the first value is a string, it is applied as
    * the name of the point, and the <code>x</code> value is inferred.</p>
    ...
    * points exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    */
  val data: js.UndefOr[js.Array[CleanJsObject[SeriesWindbarbData] | js.Array[js.Any] | Double]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  val `type`: js.UndefOr[String] = "windbarb"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>The line width of the wind barb symbols.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-linewidth-specific/">On one single series</a>
  ...
  /**
    * <p>The id of another series in the chart that the wind barbs are projected
    * on. When <code>null</code>, the wind symbols are drawn on the X axis, but offset
    * up or down by the <code>yOffset</code> setting.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/windbarb-onseries">Projected on area series</a>
    */
  val onSeries: js.UndefOr[String | Null] = js.undefined
  ...
  /**
    * <p>Pixel length of the stems.</p>
    */
  val vectorLength: js.UndefOr[Double] = js.undefined

  /**
    * <p>Vertical offset from the cartesian position, in pixels. The default value
    * makes sure the symbols don&#39;t overlap the X axis when <code>onSeries</code> is
    * <code>null</code>, and that they don&#39;t overlap the linked series when <code>onSeries</code> is
    * given.</p>
    */
  val yOffset: js.UndefOr[Double] = js.undefined

  /**
    * <p>Horizontal offset from the cartesian position, in pixels. When the chart
    * is inverted, this option allows translation like
    * <a href="#plotOptions.windbarb.yOffset">yOffset</a> in non inverted charts.</p>
    * @since 6.1.0
    */
  val xOffset: js.UndefOr[Double] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesWindbarbPathfinder]] = js.undefined
...
object SeriesWindbarb {
  /**
    * @param data <p>An array of data points for the series. For the <code>windbarb</code> series type,. points can be given in the following ways:</p>. <ol>. <li><p>An array of arrays with 3 values. In this case, the values correspond. to <code>x,value,direction</code>. If the first value is a string, it is applied as. the name of the point, and the <code>x</code> value is inferred.</p>. <pre><code class="language-js">data: [.     [Date.UTC(2017, 0, 1, 0), 3.3, 90],.     [Date.UTC(2017, 0, 1, 1), 12.1, 180],.     [Date.UTC(2017, 0, 1, 2), 11.1, 270]. ]</code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.area.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">data: [{.     x: Date.UTC(2017, 0, 1, 0),.     value: 12.1,.     direction: 90. }, {.     x: Date.UTC(2017, 0, 1, 1),.     value: 11.1,.     direction: 270. }]</code></pre>. </li>. </ol>
    ...
    * @param lineWidth <p>The line width of the wind barb symbols.</p>
    * @param onSeries <p>The id of another series in the chart that the wind barbs are projected. on. When <code>null</code>, the wind symbols are drawn on the X axis, but offset. up or down by the <code>yOffset</code> setting.</p>
    ...
    * @param vectorLength <p>Pixel length of the stems.</p>
    * @param yOffset <p>Vertical offset from the cartesian position, in pixels. The default value. makes sure the symbols don&#39;t overlap the X axis when <code>onSeries</code> is. <code>null</code>, and that they don&#39;t overlap the linked series when <code>onSeries</code> is. given.</p>
    * @param xOffset <p>Horizontal offset from the cartesian position, in pixels. When the chart. is inverted, this option allows translation like. <a href="#plotOptions.windbarb.yOffset">yOffset</a> in non inverted charts.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesWindbarbData] | js.Array[js.Any] | Double]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[String | js.Any] = js.undefined, `type`: js.UndefOr[String] = "windbarb", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, onSeries: js.UndefOr[String | Null] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, vectorLength: js.UndefOr[Double] = js.undefined, yOffset: js.UndefOr[Double] = js.undefined, xOffset: js.UndefOr[Double] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String | js.Object] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesWindbarbPathfinder]] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[String] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined): SeriesWindbarb = {
    val dataOuter: js.UndefOr[js.Array[CleanJsObject[SeriesWindbarbData] | js.Array[js.Any] | Double]] = data
    ...
    val onSeriesOuter: js.UndefOr[String | Null] = onSeries
    val statesOuter: js.Any = states
    val tooltipOuter: js.Any = tooltip
    val vectorLengthOuter: js.UndefOr[Double] = vectorLength
    val yOffsetOuter: js.UndefOr[Double] = yOffset
    val xOffsetOuter: js.UndefOr[Double] = xOffset
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesWindbarbPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarb {
      override val data: js.UndefOr[js.Array[CleanJsObject[SeriesWindbarbData] | js.Array[js.Any] | Double]] = dataOuter
      ...
      override val onSeries: js.UndefOr[String | Null] = onSeriesOuter
      override val states: js.Any = statesOuter
      override val tooltip: js.Any = tooltipOuter
      override val vectorLength: js.UndefOr[Double] = vectorLengthOuter
      override val yOffset: js.UndefOr[Double] = yOffsetOuter
      override val xOffset: js.UndefOr[Double] = xOffsetOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesWindbarbPathfinder]] = pathfinderOuter
