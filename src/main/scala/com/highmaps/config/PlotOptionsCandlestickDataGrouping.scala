...
class PlotOptionsCandlestickDataGrouping extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  val approximation: js.UndefOr[String] = js.undefined
...
object PlotOptionsCandlestickDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined): PlotOptionsCandlestickDataGrouping = {
    val approximationOuter: js.UndefOr[String] = approximation
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickDataGrouping {
      override val approximation: js.UndefOr[String] = approximationOuter
