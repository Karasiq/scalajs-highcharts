...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVariablepieDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesVariablepieDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieDragDropGuideBoxDefault {
