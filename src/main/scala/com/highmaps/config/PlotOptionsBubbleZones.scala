...
/**
  * @note JavaScript name: <code>plotOptions-bubble-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBubbleZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBubbleZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleZones {
