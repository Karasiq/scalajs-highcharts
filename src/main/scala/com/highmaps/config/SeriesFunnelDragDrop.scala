...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[SeriesFunnelDragDropDragHandle]] = js.undefined
...
object SeriesFunnelDragDrop {
  ...
  def apply(dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[SeriesFunnelDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): SeriesFunnelDragDrop = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[SeriesFunnelDragDropDragHandle]] = dragHandleOuter
