...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMaplineStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesSelectMarkerStatesSelect {
