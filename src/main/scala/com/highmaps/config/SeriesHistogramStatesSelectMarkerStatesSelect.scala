...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogramStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHistogramStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesSelectMarkerStatesSelect {
