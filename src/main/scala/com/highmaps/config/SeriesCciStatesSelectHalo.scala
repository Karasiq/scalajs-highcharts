...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCciStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCciStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesCciStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCciStatesSelectHalo {
