...
/**
  * @note JavaScript name: <code>plotOptions-gantt-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsGanttDragDrop extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Allow start value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableStart: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow end value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableEnd: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow x value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableX1: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow x2 value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableX2: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsGanttDragDropDragHandle]] = js.undefined
...
object PlotOptionsGanttDragDrop {
  /**
    * @param draggableStart <p>Allow start value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    * @param draggableEnd <p>Allow end value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    * @param draggableX1 <p>Allow x value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    * @param draggableX2 <p>Allow x2 value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    ...
    */
  def apply(draggableStart: js.UndefOr[Boolean] = js.undefined, draggableEnd: js.UndefOr[Boolean] = js.undefined, draggableX1: js.UndefOr[Boolean] = js.undefined, draggableX2: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsGanttDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsGanttDragDrop = {
    val draggableStartOuter: js.UndefOr[Boolean] = draggableStart
    val draggableEndOuter: js.UndefOr[Boolean] = draggableEnd
    val draggableX1Outer: js.UndefOr[Boolean] = draggableX1
    val draggableX2Outer: js.UndefOr[Boolean] = draggableX2
    val dragSensitivityOuter: js.UndefOr[Double] = dragSensitivity
    val guideBoxOuter: js.UndefOr[js.Object] = guideBox
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsGanttDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGanttDragDrop {
      override val draggableStart: js.UndefOr[Boolean] = draggableStartOuter
      override val draggableEnd: js.UndefOr[Boolean] = draggableEndOuter
      override val draggableX1: js.UndefOr[Boolean] = draggableX1Outer
      override val draggableX2: js.UndefOr[Boolean] = draggableX2Outer
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsGanttDragDropDragHandle]] = dragHandleOuter
