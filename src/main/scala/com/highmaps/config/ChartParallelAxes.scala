...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/xaxis/linewidth/">A 2px line on X axis</a>
  ...
  /**
    ...
    * <a href="#xAxis.categories">xAxis.categories</a>. All options for
    * <code>xAxis.labels</code> applies to parallel coordinates titles.
    * For example, to style categories, use
    * <a href="#xAxis.labels.style">xAxis.labels.style</a>.</p>
    * @since 6.0.0
    */
...
object ChartParallelAxes {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, title: js.UndefOr[js.Any] = js.undefined, labels: js.UndefOr[js.Any] = js.undefined, offset: js.UndefOr[Double] = js.undefined, minLength: js.UndefOr[Double | String] = js.undefined, maxLength: js.UndefOr[String | Double] = js.undefined, resize: js.UndefOr[js.Any] = js.undefined, tooltipValueFormat: js.UndefOr[String] = js.undefined, staticScale: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String] = "linear", endOnTick: js.UndefOr[Boolean] = js.undefined, maxPadding: js.UndefOr[Double] = js.undefined, minPadding: js.UndefOr[Double] = js.undefined, tickPixelInterval: js.UndefOr[Double] = js.undefined, showLastLabel: js.UndefOr[Boolean] = js.undefined, startOnTick: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double | String] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, reversedStacks: js.UndefOr[Boolean] = js.undefined, tickWidth: js.UndefOr[Double] = js.undefined, opposite: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, max: js.UndefOr[Double] = js.undefined, min: js.UndefOr[Double] = js.undefined, softMax: js.UndefOr[Double] = js.undefined, softMin: js.UndefOr[Double] = js.undefined, top: js.UndefOr[Double | String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Any] = js.undefined, minorTickLength: js.UndefOr[Double] = js.undefined, minorTickPosition: js.UndefOr[String] = js.undefined, startOfWeek: js.UndefOr[Double] = js.undefined, tickLength: js.UndefOr[Double] = js.undefined, tickmarkPlacement: js.UndefOr[String] = js.undefined, tickPosition: js.UndefOr[String] = js.undefined, minorTickColor: js.UndefOr[String | js.Object] = js.undefined, tickColor: js.UndefOr[String | js.Object] = js.undefined, alignTicks: js.UndefOr[Boolean] = js.undefined, allowDecimals: js.UndefOr[Boolean] = js.undefined, categories: js.UndefOr[js.Array[String]] = js.undefined, ceiling: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, crosshair: js.UndefOr[Boolean | js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, floor: js.UndefOr[Double] = js.undefined, gridZIndex: js.UndefOr[Double] = js.undefined, linkedTo: js.UndefOr[Double] = js.undefined, minorTickInterval: js.UndefOr[Double | String | Null] = js.undefined, minorTicks: js.UndefOr[Boolean] = js.undefined, minorTickWidth: js.UndefOr[Double] = js.undefined, minRange: js.UndefOr[Double] = js.undefined, minTickInterval: js.UndefOr[Double] = js.undefined, pane: js.UndefOr[Double] = js.undefined, range: js.UndefOr[Double] = js.undefined, showEmpty: js.UndefOr[Boolean] = js.undefined, showFirstLabel: js.UndefOr[Boolean] = js.undefined, tickAmount: js.UndefOr[Double] = js.undefined, tickInterval: js.UndefOr[Double] = js.undefined, tickPositioner: js.UndefOr[js.Function] = js.undefined, tickPositions: js.UndefOr[js.Array[Double]] = js.undefined, uniqueNames: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[String | js.Array[Double]]]] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, maxRange: js.UndefOr[Double] = js.undefined, grid: js.UndefOr[js.Object] = js.undefined): ChartParallelAxes = {
