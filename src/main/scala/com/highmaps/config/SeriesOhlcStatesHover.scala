...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesHoverMarker]] = js.undefined
...
object SeriesOhlcStatesHover {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined): SeriesOhlcStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesOhlcStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesHoverMarker]] = markerOuter
