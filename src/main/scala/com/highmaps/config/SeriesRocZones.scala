...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesRocZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesRocZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocZones {
