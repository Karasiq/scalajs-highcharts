...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMaplineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesMaplineStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMaplineStatesHoverHalo {
