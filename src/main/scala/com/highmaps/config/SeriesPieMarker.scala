...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-marker</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieMarker {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesPieMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieMarker {
