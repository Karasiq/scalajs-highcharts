...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHeatmapStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesHeatmapStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapStatesHoverMarkerStates {
