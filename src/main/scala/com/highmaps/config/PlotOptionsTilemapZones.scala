...
/**
  * @note JavaScript name: <code>plotOptions-tilemap-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTilemapZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTilemapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTilemapZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTilemapZones {
