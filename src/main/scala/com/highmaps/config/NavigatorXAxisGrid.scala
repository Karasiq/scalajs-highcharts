...
/**
  * @note JavaScript name: <code>navigator-xAxis-grid</code>
  */
@js.annotation.ScalaJSDefined
class NavigatorXAxisGrid extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): NavigatorXAxisGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisGrid {
