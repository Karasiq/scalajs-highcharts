...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-params</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWmaParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesWmaParams = {
    val indexOuter: js.UndefOr[Double] = index
    val periodOuter: js.UndefOr[Double] = period
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaParams {
