...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCandlestickEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsCandlestickEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickEvents {
