...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPyramidStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesHoverMarkerStates {
