...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-dataLabels</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataLabels {
  ...
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, backgroundColor: js.UndefOr[String] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, nodeFormat: js.UndefOr[String] = js.undefined, nodeFormatter: js.UndefOr[js.Function] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, verticalAlign: js.UndefOr[String | Null] = js.undefined, y: js.UndefOr[Double | Null] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, x: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, shape: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): SeriesSankeyDataLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataLabels {
