...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWaterfallMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallMarkerStates {
