...
/**
  * @note JavaScript name: <code>plotOptions-bar-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBarZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsBarZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarZones {
