...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarbStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesSelectMarker]] = js.undefined
...
object SeriesWindbarbStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesWindbarbStatesSelect = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesWindbarbStatesSelectMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbStatesSelect {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesWindbarbStatesSelectMarker]] = markerOuter
