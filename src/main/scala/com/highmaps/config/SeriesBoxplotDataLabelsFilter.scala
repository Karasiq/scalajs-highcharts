...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBoxplotDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesBoxplotDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataLabelsFilter {
