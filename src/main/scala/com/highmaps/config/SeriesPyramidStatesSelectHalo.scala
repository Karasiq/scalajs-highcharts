...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesPyramidStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesSelectHalo {
