...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesStreamgraphData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesStreamgraphDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesStreamgraphDataEvents]] = js.undefined

  val marker: js.UndefOr[CleanJsObject[SeriesStreamgraphDataMarker]] = js.undefined
}

object SeriesStreamgraphData {
  /**
    ...
    */
  def apply(dragDrop: js.UndefOr[CleanJsObject[SeriesStreamgraphDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesStreamgraphDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesStreamgraphDataMarker]] = js.undefined): SeriesStreamgraphData = {
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesStreamgraphDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesStreamgraphDataEvents]] = events
    val markerOuter: js.UndefOr[CleanJsObject[SeriesStreamgraphDataMarker]] = marker
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphData {
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesStreamgraphDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesStreamgraphDataEvents]] = eventsOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesStreamgraphDataMarker]] = markerOuter
    })
  }
}
