...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemapStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTilemapStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapStatesHoverMarkerStates {
