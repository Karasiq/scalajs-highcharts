...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesArearangeDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataLabelsFilter {
