...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesArearangeStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesArearangeStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeStatesSelectMarkerStates {
