...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSunburstStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsSunburstStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstStatesSelectHalo {
