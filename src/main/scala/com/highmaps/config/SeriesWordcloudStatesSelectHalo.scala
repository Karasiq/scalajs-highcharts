...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWordcloudStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesWordcloudStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudStatesSelectHalo {
