...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHeatmapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesHeatmapDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataLabelsFilter {
