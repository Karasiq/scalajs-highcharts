...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPieStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieStatesHoverMarkerStates {
