...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesMappointZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointZones {
