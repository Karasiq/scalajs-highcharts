...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-params</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumParams {
  /**
    ...
    */
  def apply(period: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined): SeriesMomentumParams = {
    val periodOuter: js.UndefOr[Double] = period
    val indexOuter: js.UndefOr[Double] = index
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumParams {
