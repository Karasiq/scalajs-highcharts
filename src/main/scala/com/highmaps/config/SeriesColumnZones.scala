...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesColumnZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnZones {
