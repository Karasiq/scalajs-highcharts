...
object SeriesBulletDataTargetOptions {
  /**
    ...
    */
  def apply(width: js.UndefOr[Double | String] = js.undefined, height: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined): SeriesBulletDataTargetOptions = {
