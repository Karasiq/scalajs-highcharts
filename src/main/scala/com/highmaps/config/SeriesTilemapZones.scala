...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemapZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTilemapZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapZones {
