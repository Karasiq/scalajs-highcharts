...
/**
  * @note JavaScript name: <code>plotOptions-bullet-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBulletDragDrop extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>Allow target value to be dragged individually. Requires
    * <code>draggable-points</code> module.</p>
    * @since 6.2.0
    */
  val draggableTarget: js.UndefOr[Boolean] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBulletDragDropDragHandle]] = js.undefined
...
object PlotOptionsBulletDragDrop {
  /**
    * @param draggableTarget <p>Allow target value to be dragged individually. Requires. <code>draggable-points</code> module.</p>
    ...
    */
  def apply(draggableTarget: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBulletDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsBulletDragDrop = {
    val draggableTargetOuter: js.UndefOr[Boolean] = draggableTarget
    val dragSensitivityOuter: js.UndefOr[Double] = dragSensitivity
    val guideBoxOuter: js.UndefOr[js.Object] = guideBox
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsBulletDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletDragDrop {
      override val draggableTarget: js.UndefOr[Boolean] = draggableTargetOuter
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBulletDragDropDragHandle]] = dragHandleOuter
