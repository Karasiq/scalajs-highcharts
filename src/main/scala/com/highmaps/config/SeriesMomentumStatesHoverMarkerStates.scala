...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMomentumStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumStatesHoverMarkerStates {
