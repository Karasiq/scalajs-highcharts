...
/**
  * @note JavaScript name: <code>plotOptions-column-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsColumnStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnStatesNormal {
