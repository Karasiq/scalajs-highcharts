...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarbDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesWindbarbDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataLabelsFilter {
