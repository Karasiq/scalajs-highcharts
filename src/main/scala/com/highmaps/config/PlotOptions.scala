...
class PlotOptions extends js.Object {
  ...
  /**
    ...
    * @example <ul>
<li><a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/heatmap/" target="_blank">Basic heatmap</a></li>
<li><a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/heatmap-canvas/" target="_blank">Extended heatmap rendered on canvas for greater performance</a></li>
</ul>
    */
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/" target="_blank">Map lines and points</a>
    */
  ...
  /**
    ...
    * @example  <a href="http://jsfiddle.net/gh/get/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/" target="_blank">Lines and points in maps</a>
    */
