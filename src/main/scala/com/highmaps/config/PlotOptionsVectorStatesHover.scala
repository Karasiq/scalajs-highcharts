...
/**
  * @note JavaScript name: <code>plotOptions-vector-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVectorStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 6.0.0
    */
  val marker: js.UndefOr[CleanJsObject[PlotOptionsVectorStatesHoverMarker]] = js.undefined
...
object PlotOptionsVectorStatesHover {
  /**
    * @param lineWidthPlus <p>Additonal line width for the vector errors when they are hovered.</p>
    ...
    */
  def apply(lineWidthPlus: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, marker: js.UndefOr[CleanJsObject[PlotOptionsVectorStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined): PlotOptionsVectorStatesHover = {
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val markerOuter: js.UndefOr[CleanJsObject[PlotOptionsVectorStatesHoverMarker]] = marker
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorStatesHover {
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val animation: js.UndefOr[Boolean | js.Object] = animationOuter
      override val marker: js.UndefOr[CleanJsObject[PlotOptionsVectorStatesHoverMarker]] = markerOuter
