...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesScatter3dStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesHoverHalo {
