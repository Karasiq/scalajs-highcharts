...
/**
  * @note JavaScript name: <code>plotOptions-scatter-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatterStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsScatterStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterStatesSelectHalo {
