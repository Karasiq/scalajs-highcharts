...
object MapNavigationButtonOptions {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, alignTo: js.UndefOr[String] = js.undefined, height: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, theme: js.UndefOr[js.Object] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined, x: js.UndefOr[Double] = js.undefined): MapNavigationButtonOptions = {
