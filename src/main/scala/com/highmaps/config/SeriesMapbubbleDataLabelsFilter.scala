...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMapbubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesMapbubbleDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleDataLabelsFilter {
