...
class SeriesBubbleData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesBubbleDataDragDrop]] = js.undefined
...
object SeriesBubbleData {
  /**
    ...
    */
  def apply(z: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesBubbleDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesBubbleDataEvents]] = js.undefined): SeriesBubbleData = {
    val zOuter: js.UndefOr[Double] = z
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesBubbleDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesBubbleDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleData {
      override val z: js.UndefOr[Double] = zOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesBubbleDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesBubbleDataEvents]] = eventsOuter
    })
  }
}
