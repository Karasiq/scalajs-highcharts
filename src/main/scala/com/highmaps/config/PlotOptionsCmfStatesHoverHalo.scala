...
/**
  * @note JavaScript name: <code>plotOptions-cmf-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsCmfStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsCmfStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmfStatesHoverHalo {
