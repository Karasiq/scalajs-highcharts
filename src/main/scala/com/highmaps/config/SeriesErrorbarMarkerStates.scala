...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesErrorbarMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesErrorbarMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarMarkerStates {
