...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSunburstStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsSunburstStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstStatesNormal {
