...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogramStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesHistogramStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramStatesHoverHalo {
