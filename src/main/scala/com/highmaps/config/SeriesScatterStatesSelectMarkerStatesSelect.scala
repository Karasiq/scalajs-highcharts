...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesScatterStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterStatesSelectMarkerStatesSelect {
