...
class SeriesWaterfall extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>waterfall</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of numerical values. In this case, the numerical values
    * will be interpreted as <code>y</code> options. The <code>x</code> values will be automatically
    * calculated, either starting at 0 and incremented by 1, or from <code>pointStart</code>
    * and <code>pointInterval</code> given in the series options. If the axis has
    * categories, these will be used. Example:</p>
    * <pre><code class="language-js">data: [0, 5, 3, 5]</code></pre>
    * </li>
    * <li><p>An array of arrays with 2 values. In this case, the values correspond
    * to <code>x,y</code>. If the first value is a string, it is applied as the name
    * of the point, and the <code>x</code> value is inferred.</p>
    ...
    * <a href="#series.waterfall.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series/data-array-of-objects/">Config objects</a>
    */
  val data: js.UndefOr[js.Array[CleanJsObject[SeriesWaterfallData] | js.Array[js.Any] | Double]] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  val `type`: js.UndefOr[String] = "waterfall"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-datalabels-multiple">Multiple data labels on a bar series</a>
  ...
  /**
    * <p>The width of the line connecting waterfall columns.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-linewidth-specific/">On one single series</a>
  ...
  /**
    ...
    * <p>In styled mode, the stroke can be set with the <code>.highcharts-graph</code> class.</p>
    * @since 3.0
    */
  val lineColor: js.UndefOr[String | js.Object] = js.undefined

  /**
    * <p>A name for the dash style to use for the line connecting the columns
    * of the waterfall series. Possible values:</p>
    * <ul>
    * <li>Solid</li>
    * <li>ShortDash</li>
    * <li>ShortDot</li>
    ...
    * </ul>
    * <p>In styled mode, the stroke dash-array can be set with the
    * <code>.highcharts-graph</code> class.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-dashstyle/">Dotted borders on a map</a>
  ...
  /**
    * <p>The color used specifically for positive point columns. When not
    * specified, the general series color is used.</p>
    * <p>In styled mode, the waterfall colors can be set with the
    * <code>.highcharts-point-negative</code>, <code>.highcharts-sum</code> and
    * <code>.highcharts-intermediate-sum</code> classes.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/waterfall/">Waterfall</a>
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesWaterfallPathfinder]] = js.undefined
...
object SeriesWaterfall {
  /**
    * @param data <p>An array of data points for the series. For the <code>waterfall</code> series. type, points can be given in the following ways:</p>. <ol>. <li><p>An array of numerical values. In this case, the numerical values. will be interpreted as <code>y</code> options. The <code>x</code> values will be automatically. calculated, either starting at 0 and incremented by 1, or from <code>pointStart</code>. and <code>pointInterval</code> given in the series options. If the axis has. categories, these will be used. Example:</p>. <pre><code class="language-js">data: [0, 5, 3, 5]</code></pre>. </li>. <li><p>An array of arrays with 2 values. In this case, the values correspond. to <code>x,y</code>. If the first value is a string, it is applied as the name. of the point, and the <code>x</code> value is inferred.</p>. <pre><code class="language-js">data: [.     [0, 7],.     [1, 8],.     [2, 3]. ]</code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39;. <a href="#series.waterfall.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">data: [{.     x: 1,.     y: 8,.     name: &quot;Point2&quot;,.     color: &quot;#00FF00&quot;. }, {.     x: 1,.     y: 8,.     name: &quot;Point1&quot;,.     color: &quot;#FF00FF&quot;. }]</code></pre>. </li>. </ol>
    ...
    * @param lineWidth <p>The width of the line connecting waterfall columns.</p>
    * @param lineColor <p>The color of the line that connects columns in a waterfall series.</p>. <p>In styled mode, the stroke can be set with the <code>.highcharts-graph</code> class.</p>
    * @param dashStyle <p>A name for the dash style to use for the line connecting the columns. of the waterfall series. Possible values:</p>. <ul>. <li>Solid</li>. <li>ShortDash</li>. <li>ShortDot</li>. <li>ShortDashDot</li>. <li>ShortDashDotDot</li>. <li>Dot</li>. <li>Dash</li>. <li>LongDash</li>. <li>DashDot</li>. <li>LongDashDot</li>. <li>LongDashDotDot</li>. </ul>. <p>In styled mode, the stroke dash-array can be set with the. <code>.highcharts-graph</code> class.</p>
    * @param borderColor <p>The color of the border of each waterfall column.</p>. <p>In styled mode, the border stroke can be set with the. <code>.highcharts-point</code> class.</p>
    * @param states <p>A wrapper object for all the series options in specific states.</p>
    * @param upColor <p>The color used specifically for positive point columns. When not. specified, the general series color is used.</p>. <p>In styled mode, the waterfall colors can be set with the. <code>.highcharts-point-negative</code>, <code>.highcharts-sum</code> and. <code>.highcharts-intermediate-sum</code> classes.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesWaterfallData] | js.Array[js.Any] | Double]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[String | js.Any] = js.undefined, `type`: js.UndefOr[String] = "waterfall", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, upColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, threshold: js.UndefOr[Double] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String | js.Object] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesWaterfallPathfinder]] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined): SeriesWaterfall = {
    val dataOuter: js.UndefOr[js.Array[CleanJsObject[SeriesWaterfallData] | js.Array[js.Any] | Double]] = data
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesWaterfallPathfinder]] = pathfinder
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfall {
      override val data: js.UndefOr[js.Array[CleanJsObject[SeriesWaterfallData] | js.Array[js.Any] | Double]] = dataOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesWaterfallPathfinder]] = pathfinderOuter
