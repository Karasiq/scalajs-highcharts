...
/**
  * @note JavaScript name: <code>plotOptions-ad-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAdStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsAdStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdStatesNormal {
