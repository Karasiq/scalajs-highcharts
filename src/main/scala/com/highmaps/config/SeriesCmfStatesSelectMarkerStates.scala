...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCmfStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesCmfStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfStatesSelectMarkerStates {
