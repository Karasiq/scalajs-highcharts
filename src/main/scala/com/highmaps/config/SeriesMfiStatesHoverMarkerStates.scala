...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMfiStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMfiStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiStatesHoverMarkerStates {
