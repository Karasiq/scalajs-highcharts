...
class SeriesPieData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesPieDataDragDrop]] = js.undefined
...
object SeriesPieData {
  /**
    ...
    */
  def apply(legendIndex: js.UndefOr[Double] = js.undefined, sliced: js.UndefOr[Boolean] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesPieDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesPieDataEvents]] = js.undefined): SeriesPieData = {
    val legendIndexOuter: js.UndefOr[Double] = legendIndex
    val slicedOuter: js.UndefOr[Boolean] = sliced
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesPieDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesPieDataDragDrop]] = dragDropOuter
