...
object PlotOptionsParetoTooltip {
  /**
    ...
    */
  def apply(dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, footerFormat: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, headerFormat: js.UndefOr[String] = js.undefined, pointFormat: js.UndefOr[String] = js.undefined, followPointer: js.UndefOr[Boolean] = js.undefined, followTouchMove: js.UndefOr[Boolean] = js.undefined, hideDelay: js.UndefOr[Double] = js.undefined, outside: js.UndefOr[Boolean] = js.undefined, pointFormatter: js.UndefOr[js.Function] = js.undefined, split: js.UndefOr[Boolean] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined, xDateFormat: js.UndefOr[String] = js.undefined, changeDecimals: js.UndefOr[Double] = js.undefined): PlotOptionsParetoTooltip = {
