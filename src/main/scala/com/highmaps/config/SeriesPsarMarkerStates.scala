...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPsarMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPsarMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarMarkerStates {
