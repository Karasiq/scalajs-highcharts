...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesParetoStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesSelectMarkerStatesSelect {
