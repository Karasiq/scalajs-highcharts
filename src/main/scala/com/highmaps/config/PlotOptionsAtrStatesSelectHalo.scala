...
/**
  * @note JavaScript name: <code>plotOptions-atr-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAtrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsAtrStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrStatesSelectHalo {
