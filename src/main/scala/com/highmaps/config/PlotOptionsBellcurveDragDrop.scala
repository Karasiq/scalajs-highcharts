...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBellcurveDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBellcurveDragDropDragHandle]] = js.undefined
...
object PlotOptionsBellcurveDragDrop {
  /**
    ...
    */
  def apply(dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBellcurveDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsBellcurveDragDrop = {
    val dragSensitivityOuter: js.UndefOr[Double] = dragSensitivity
    val guideBoxOuter: js.UndefOr[js.Object] = guideBox
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsBellcurveDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsBellcurveDragDropDragHandle]] = dragHandleOuter
