...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBarDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesBarDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataLabelsFilter {
