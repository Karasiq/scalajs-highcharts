...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-pathfinder-marker</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsSolidgaugePathfinderMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSolidgaugePathfinderMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, align: js.UndefOr[String] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined): PlotOptionsSolidgaugePathfinderMarker = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugePathfinderMarker {
