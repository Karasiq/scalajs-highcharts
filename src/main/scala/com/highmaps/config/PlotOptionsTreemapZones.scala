...
/**
  * @note JavaScript name: <code>plotOptions-treemap-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsTreemapZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTreemapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTreemapZones {
