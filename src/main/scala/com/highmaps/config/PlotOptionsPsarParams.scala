...
object PlotOptionsPsarParams {
  /**
    ...
    */
  def apply(initialAccelerationFactor: js.UndefOr[Double] = js.undefined, maxAccelerationFactor: js.UndefOr[Double] = js.undefined, increment: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, decimals: js.UndefOr[Double] = js.undefined): PlotOptionsPsarParams = {
