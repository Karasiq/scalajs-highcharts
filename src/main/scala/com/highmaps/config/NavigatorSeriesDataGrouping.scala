...
/**
  * @note JavaScript name: <code>navigator-series-dataGrouping</code>
  */
@js.annotation.ScalaJSDefined
class NavigatorSeriesDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object NavigatorSeriesDataGrouping {
  /**
    ...
    */
  def apply(approximation: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Any]] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined): NavigatorSeriesDataGrouping = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorSeriesDataGrouping {
