...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatter3dStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesScatter3dStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesSelectMarkerStatesSelect {
