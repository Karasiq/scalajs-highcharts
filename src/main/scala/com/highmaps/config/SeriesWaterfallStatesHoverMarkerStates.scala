...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWaterfallStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallStatesHoverMarkerStates {
