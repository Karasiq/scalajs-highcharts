...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-data-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterDataDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesScatterDataDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataDragDropGuideBoxDefault {
