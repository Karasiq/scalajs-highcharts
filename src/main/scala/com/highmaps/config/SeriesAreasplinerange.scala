...
class SeriesAreasplinerange extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>areasplinerange</code>
    * series type, points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of arrays with 3 or 2 values. In this case, the values
    * correspond to <code>x,low,high</code>. If the first value is a string, it is
    * applied as the name of the point, and the <code>x</code> value is inferred.
    * The <code>x</code> value can also be omitted, in which case the inner arrays
    * should be of length 2. Then the <code>x</code> value is automatically calculated,
    ...
    * points exceeds the series&#39; <a href="#series.areasplinerange.turboThreshold">turboThreshold</a>, this option is not available.</p>
    * <pre><code class="language-js">data: [{
    *     x: 1,
    *     low: 5,
    *     high: 0,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  val `type`: js.UndefOr[String] = "areasplinerange"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/dragdrop/drag-xrange">Draggable X range series</a>
  ...
  /**
    * <p>Pixel width of the arearange graph line.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesAreasplinerangePathfinder]] = js.undefined
...
object SeriesAreasplinerange {
  /**
    ...
    * @param lineWidth <p>Pixel width of the arearange graph line.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesAreasplinerangeData] | js.Array[js.Any]]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "areasplinerange", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, threshold: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, trackByArea: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesAreasplinerangeDataLabels]] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, fillOpacity: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, negativeFillColor: js.UndefOr[String | js.Object] = js.undefined, linecap: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[js.Any] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesAreasplinerangePathfinder]] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined): SeriesAreasplinerange = {
    val dataOuter: js.UndefOr[js.Array[CleanJsObject[SeriesAreasplinerangeData] | js.Array[js.Any]]] = data
    ...
    val dataLabelsOuter: js.UndefOr[CleanJsObject[SeriesAreasplinerangeDataLabels]] = dataLabels
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesAreasplinerangePathfinder]] = pathfinder
    val stackingOuter: js.UndefOr[String] = stacking
    val stepOuter: js.UndefOr[String] = step
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerange {
      override val data: js.UndefOr[js.Array[CleanJsObject[SeriesAreasplinerangeData] | js.Array[js.Any]]] = dataOuter
      ...
      override val dataLabels: js.UndefOr[CleanJsObject[SeriesAreasplinerangeDataLabels]] = dataLabelsOuter
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesAreasplinerangePathfinder]] = pathfinderOuter
