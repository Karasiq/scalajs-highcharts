...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStochasticStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsStochasticStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticStatesNormal {
