...
class YAxisStackLabels extends com.highcharts.HighchartsGenericObject {
...
object YAxisStackLabels {
  /**
    ...
    */
  def apply(allowOverlap: js.UndefOr[Boolean] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, align: js.UndefOr[String] = js.undefined, format: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, textAlign: js.UndefOr[String] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): YAxisStackLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new YAxisStackLabels {
