...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-pathfinder</code>
  */
@js.annotation.ScalaJSDefined
class SeriesGanttPathfinder extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttPathfinder {
  /**
    ...
    */
  def apply(`type`: js.UndefOr[String] = "simpleConnect", animation: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[js.Any] = js.undefined, endMarker: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, algorithmMargin: js.UndefOr[Double] = js.undefined): SeriesGanttPathfinder = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttPathfinder {
