...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAreaStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAreaStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaStatesHoverMarkerStates {
