...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMappointStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsMappointStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesSelectMarkerStates {
