...
/**
  * @note JavaScript name: <code>plotOptions-macd-macdLine-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMacdMacdLineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdMacdLineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMacdMacdLineZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdMacdLineZones {
