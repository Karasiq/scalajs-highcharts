...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesSankeyStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyStatesHoverMarkerStates {
