...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesSelectMarker]] = js.undefined
...
object SeriesOhlcStatesSelect {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesOhlcStatesSelect = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesOhlcStatesSelectMarker]] = marker
    val haloOuter: js.Any = halo
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesSelect {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesOhlcStatesSelectMarker]] = markerOuter
