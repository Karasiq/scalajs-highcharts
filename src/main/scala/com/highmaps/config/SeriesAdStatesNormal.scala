...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesAdStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesAdStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdStatesNormal {
