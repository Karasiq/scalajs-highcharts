...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesErrorbarStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesErrorbarStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarStatesHoverMarkerStates {
