...
/**
  * @note JavaScript name: <code>plotOptions-ikh-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsIkhMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsIkhMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsIkhMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsIkhMarkerStates {
