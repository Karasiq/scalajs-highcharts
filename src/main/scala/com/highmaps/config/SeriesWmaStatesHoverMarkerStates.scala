...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWmaStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWmaStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaStatesHoverMarkerStates {
