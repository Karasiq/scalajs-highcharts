...
/**
  * @note JavaScript name: <code>chart-options3d-frame-front</code>
  */
@js.annotation.ScalaJSDefined
class ChartOptions3dFrameFront extends com.highcharts.HighchartsGenericObject {
...
object ChartOptions3dFrameFront {
  /**
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, size: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean | String] = js.undefined): ChartOptions3dFrameFront = {
    val colorOuter: js.UndefOr[String | js.Object] = color
    val sizeOuter: js.UndefOr[Double] = size
    val visibleOuter: js.UndefOr[Boolean | String] = visible
    com.highcharts.HighchartsGenericObject.toCleanObject(new ChartOptions3dFrameFront {
