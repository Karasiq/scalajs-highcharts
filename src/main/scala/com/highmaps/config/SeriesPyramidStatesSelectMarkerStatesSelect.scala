...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPyramidStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPyramidStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidStatesSelectMarkerStatesSelect {
