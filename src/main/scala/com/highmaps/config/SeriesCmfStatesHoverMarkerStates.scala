...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCmfStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesCmfStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfStatesHoverMarkerStates {
