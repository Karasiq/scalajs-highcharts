...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesCandlestickMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickMarkerStatesSelect {
