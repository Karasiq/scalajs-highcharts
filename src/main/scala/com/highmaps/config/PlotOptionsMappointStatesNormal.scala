...
/**
  * @note JavaScript name: <code>plotOptions-mappoint-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMappointStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMappointStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsMappointStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMappointStatesNormal {
