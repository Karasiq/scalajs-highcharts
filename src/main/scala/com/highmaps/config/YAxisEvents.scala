...
object YAxisEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Function] = js.undefined, afterSetExtremes: js.UndefOr[js.Function] = js.undefined, pointBreak: js.UndefOr[js.Function] = js.undefined, pointInBreak: js.UndefOr[js.Function] = js.undefined, setExtremes: js.UndefOr[js.Function] = js.undefined): YAxisEvents = {
