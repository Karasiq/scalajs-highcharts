...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPivotpointsStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsStatesSelectMarkerStates {
