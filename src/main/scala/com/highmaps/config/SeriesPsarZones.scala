...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPsarZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPsarZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPsarZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPsarZones {
