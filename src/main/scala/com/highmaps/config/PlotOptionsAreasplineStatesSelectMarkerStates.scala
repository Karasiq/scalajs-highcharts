...
/**
  * @note JavaScript name: <code>plotOptions-areaspline-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAreasplineStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplineStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAreasplineStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplineStatesSelectMarkerStates {
