...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMappointMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesMappointMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointMarkerStatesSelect {
