...
/**
  * @note JavaScript name: <code>plotOptions-mapline-states-hover-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMaplineStatesHoverMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineStatesHoverMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsMaplineStatesHoverMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineStatesHoverMarkerStatesSelect {
