...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatter3dDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dDragDropGuideBoxDefault {
