...
/**
  * @note JavaScript name: <code>plotOptions-bubble-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsBubbleEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsBubbleEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleEvents {
