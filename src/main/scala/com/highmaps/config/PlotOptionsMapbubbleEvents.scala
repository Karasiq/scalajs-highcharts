...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMapbubbleEvents extends js.Object {
  ...
  /**
    ...
    * @example <a href="http://jsfiddle.net/gh/get/jquery/1.7.2/highslide-software/highcharts.com/tree/master/samples/maps/plotoptions/series-events-click/" target="_blank">Display click info in subtitle</a>
    */
...
object PlotOptionsMapbubbleEvents {
  /**
    ...
    */
  def apply(checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsMapbubbleEvents = {
    ...
    new PlotOptionsMapbubbleEvents {
