...
class SeriesSplineData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesSplineDataDragDrop]] = js.undefined
...
object SeriesSplineData {
  /**
    ...
    */
  def apply(dragDrop: js.UndefOr[CleanJsObject[SeriesSplineDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesSplineDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesSplineDataMarker]] = js.undefined): SeriesSplineData = {
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesSplineDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineData {
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesSplineDataDragDrop]] = dragDropOuter
