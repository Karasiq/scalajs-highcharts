...
/**
  * @note JavaScript name: <code>plotOptions-scatter-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsScatterStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsScatterStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterStatesNormal {
