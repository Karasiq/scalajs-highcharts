...
object PlotOptionsHeatmapStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[PlotOptionsHeatmapStatesNormal]] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsHeatmapStatesSelect]] = js.undefined): PlotOptionsHeatmapStates = {
