...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesEmaZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesEmaZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaZones {
