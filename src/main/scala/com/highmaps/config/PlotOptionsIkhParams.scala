...
object PlotOptionsIkhParams {
  /**
    ...
    */
  def apply(period: js.UndefOr[Double] = js.undefined, periodTenkan: js.UndefOr[Double] = js.undefined, periodSenkouSpanB: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined): PlotOptionsIkhParams = {
