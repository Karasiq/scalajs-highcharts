...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesScatterStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesScatterStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterStatesHoverMarkerStates {
