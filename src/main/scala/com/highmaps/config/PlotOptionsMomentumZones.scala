...
/**
  * @note JavaScript name: <code>plotOptions-momentum-zones</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMomentumZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMomentumZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumZones {
