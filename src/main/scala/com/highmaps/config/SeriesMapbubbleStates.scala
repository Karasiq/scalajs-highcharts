...
object SeriesMapbubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[CleanJsObject[SeriesMapbubbleStatesNormal]] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesMapbubbleStatesSelect]] = js.undefined): SeriesMapbubbleStates = {
