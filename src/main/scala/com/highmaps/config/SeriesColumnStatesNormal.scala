...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesColumnStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnStatesNormal {
