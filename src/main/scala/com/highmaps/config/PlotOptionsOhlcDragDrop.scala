...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-dragDrop</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsOhlcDragDrop extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsOhlcDragDropDragHandle]] = js.undefined
...
object PlotOptionsOhlcDragDrop {
  /**
    ...
    */
  def apply(draggableLow: js.UndefOr[Boolean] = js.undefined, draggableHigh: js.UndefOr[Boolean] = js.undefined, draggableOpen: js.UndefOr[Boolean] = js.undefined, draggableClose: js.UndefOr[Boolean] = js.undefined, dragSensitivity: js.UndefOr[Double] = js.undefined, guideBox: js.UndefOr[js.Object] = js.undefined, dragHandle: js.UndefOr[CleanJsObject[PlotOptionsOhlcDragDropDragHandle]] = js.undefined, dragMinX: js.UndefOr[Double] = js.undefined, dragMaxX: js.UndefOr[Double] = js.undefined, dragMinY: js.UndefOr[Double] = js.undefined, dragMaxY: js.UndefOr[Double] = js.undefined, dragPrecisionX: js.UndefOr[Double] = js.undefined, dragPrecisionY: js.UndefOr[Double] = js.undefined, draggableX: js.UndefOr[Boolean] = js.undefined, draggableY: js.UndefOr[Boolean] = js.undefined, groupBy: js.UndefOr[String] = js.undefined, liveRedraw: js.UndefOr[Boolean] = js.undefined): PlotOptionsOhlcDragDrop = {
    ...
    val dragHandleOuter: js.UndefOr[CleanJsObject[PlotOptionsOhlcDragDropDragHandle]] = dragHandle
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcDragDrop {
      ...
      override val dragHandle: js.UndefOr[CleanJsObject[PlotOptionsOhlcDragDropDragHandle]] = dragHandleOuter
