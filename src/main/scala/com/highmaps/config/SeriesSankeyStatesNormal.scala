...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSankeyStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesSankeyStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyStatesNormal {
