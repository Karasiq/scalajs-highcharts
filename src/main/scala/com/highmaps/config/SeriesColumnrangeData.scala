...
class SeriesColumnrangeData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesColumnrangeDataDragDrop]] = js.undefined
...
object SeriesColumnrangeData {
  /**
    ...
    */
  def apply(high: js.UndefOr[Double] = js.undefined, low: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesColumnrangeDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesColumnrangeDataEvents]] = js.undefined): SeriesColumnrangeData = {
    val highOuter: js.UndefOr[Double] = high
    val lowOuter: js.UndefOr[Double] = low
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesColumnrangeDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesColumnrangeDataDragDrop]] = dragDropOuter
