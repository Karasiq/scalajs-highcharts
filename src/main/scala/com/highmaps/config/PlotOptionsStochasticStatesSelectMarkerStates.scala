...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-states-select-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStochasticStatesSelectMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticStatesSelectMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsStochasticStatesSelectMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticStatesSelectMarkerStates {
