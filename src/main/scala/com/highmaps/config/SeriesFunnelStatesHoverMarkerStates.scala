...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFunnelStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesFunnelStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelStatesHoverMarkerStates {
