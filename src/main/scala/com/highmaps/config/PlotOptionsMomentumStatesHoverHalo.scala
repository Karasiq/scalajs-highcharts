...
/**
  * @note JavaScript name: <code>plotOptions-momentum-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsMomentumStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): PlotOptionsMomentumStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumStatesHoverHalo {
