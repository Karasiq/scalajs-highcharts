...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesBubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesBubbleDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataLabelsFilter {
