...
/**
  * @note JavaScript name: <code>plotOptions-ema-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsEmaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsEmaMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaMarkerStates {
