...
/**
  * @note JavaScript name: <code>plotOptions-vwap-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVwapMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsVwapMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapMarkerStates {
