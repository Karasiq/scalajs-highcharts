...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTilemapData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The color of the point. In tilemaps the point color is rarely set
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesTilemapDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesTilemapDataEvents]] = js.undefined
}

object SeriesTilemapData {
  /**
    * @param color <p>The color of the point. In tilemaps the point color is rarely set. explicitly, as we use the color to denote the <code>value</code>. Options for. this are set in the <a href="#colorAxis">colorAxis</a> configuration.</p>
    * @param x <p>The x coordinate of the point.</p>. <p>Note that for some <a href="#plotOptions.tilemap.tileShape">tileShapes</a> the grid. coordinates are offset.</p>
    * @param y <p>The y coordinate of the point.</p>. <p>Note that for some <a href="#plotOptions.tilemap.tileShape">tileShapes</a> the grid. coordinates are offset.</p>
    ...
    */
  def apply(color: js.UndefOr[String | js.Object] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, value: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesTilemapDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesTilemapDataEvents]] = js.undefined): SeriesTilemapData = {
    val colorOuter: js.UndefOr[String | js.Object] = color
    val xOuter: js.UndefOr[Double] = x
    val yOuter: js.UndefOr[Double] = y
    val valueOuter: js.UndefOr[Double] = value
    val pointPaddingOuter: js.UndefOr[Double] = pointPadding
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesTilemapDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesTilemapDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapData {
      ...
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesTilemapDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesTilemapDataEvents]] = eventsOuter
    })
  }
}
