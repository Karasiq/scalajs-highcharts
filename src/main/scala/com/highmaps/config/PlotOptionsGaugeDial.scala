...
class PlotOptionsGaugeDial extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGaugeDial {
  /**
    ...
    */
  def apply(baseLength: js.UndefOr[String] = js.undefined, baseWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[String] = js.undefined, rearLength: js.UndefOr[String] = js.undefined, topWidth: js.UndefOr[Double] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsGaugeDial = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsGaugeDial {
