...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWindbarbDataMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesWindbarbDataMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataMarkerStates {
