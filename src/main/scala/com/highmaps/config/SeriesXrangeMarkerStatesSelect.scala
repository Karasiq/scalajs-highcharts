...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesXrangeMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesXrangeMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeMarkerStatesSelect {
