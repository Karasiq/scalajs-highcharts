...
class SeriesVariwideStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesVariwideStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideStatesNormal {
