...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesPieStatesSelectMarker]] = js.undefined
...
object SeriesPieStatesSelect {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPieStatesSelectMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): SeriesPieStatesSelect = {
    val animationOuter: js.UndefOr[Boolean | js.Object] = animation
    val lineWidthPlusOuter: js.UndefOr[Double] = lineWidthPlus
    val markerOuter: js.UndefOr[CleanJsObject[SeriesPieStatesSelectMarker]] = marker
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieStatesSelect {
      override val animation: js.UndefOr[Boolean | js.Object] = animationOuter
      override val lineWidthPlus: js.UndefOr[Double] = lineWidthPlusOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesPieStatesSelectMarker]] = markerOuter
