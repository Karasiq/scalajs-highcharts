...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesCandlestickMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickMarkerStates {
