...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVectorStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesVectorStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesSelectHalo {
