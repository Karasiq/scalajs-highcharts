...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesFlagsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesFlagsDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsDataLabelsFilter {
