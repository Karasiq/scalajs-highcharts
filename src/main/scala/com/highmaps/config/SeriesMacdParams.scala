...
object SeriesMacdParams {
  /**
    ...
    */
  def apply(shortPeriod: js.UndefOr[Double] = js.undefined, longPeriod: js.UndefOr[Double] = js.undefined, signalPeriod: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined, index: js.UndefOr[Double] = js.undefined): SeriesMacdParams = {
