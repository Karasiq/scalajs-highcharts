...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCandlestickStatesHover extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The pixel width of the line/border around the candlestick.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesHoverMarker]] = js.undefined
...
object SeriesCandlestickStatesHover {
  /**
    * @param lineWidth <p>The pixel width of the line/border around the candlestick.</p>
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesHoverMarker]] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined): SeriesCandlestickStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesCandlestickStatesHoverMarker]] = marker
    val haloOuter: js.Any = halo
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesCandlestickStatesHoverMarker]] = markerOuter
