...
/**
  * @note JavaScript name: <code>plotOptions-variwide-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVariwideStatesHover extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined): PlotOptionsVariwideStatesHover = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideStatesHover {
