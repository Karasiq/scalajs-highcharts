...
/**
  * @note JavaScript name: <code>plotOptions-vector-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsVectorStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): PlotOptionsVectorStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorStatesNormal {
