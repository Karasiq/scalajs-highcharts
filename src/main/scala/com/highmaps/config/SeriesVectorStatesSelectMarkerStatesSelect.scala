...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVectorStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVectorStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesSelectMarkerStatesSelect {
