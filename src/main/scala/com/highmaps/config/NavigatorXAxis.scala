...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/xaxis/crosshair-both/">Crosshair on both axes</a>
    * @since 4.1
    */
  val crosshair: js.UndefOr[Boolean] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/gantt/current-date-indicator/object-config">Current date indicator with custom options</a>
    */
  val currentDateIndicator: js.UndefOr[CleanJsObject[NavigatorXAxisCurrentDateIndicator]] = js.undefined
...
object NavigatorXAxis {
  /**
    ...
    */
  def apply(overscroll: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, tickLength: js.UndefOr[Double] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, gridLineColor: js.UndefOr[String] = js.undefined, gridLineWidth: js.UndefOr[Double] = js.undefined, tickPixelInterval: js.UndefOr[Double] = js.undefined, labels: js.UndefOr[js.Any] = js.undefined, crosshair: js.UndefOr[Boolean] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Any] = js.undefined, endOnTick: js.UndefOr[Boolean] = js.undefined, maxPadding: js.UndefOr[Double] = js.undefined, minorTickLength: js.UndefOr[Double] = js.undefined, minorTickPosition: js.UndefOr[String] = js.undefined, minPadding: js.UndefOr[Double] = js.undefined, startOfWeek: js.UndefOr[Double] = js.undefined, startOnTick: js.UndefOr[Boolean] = js.undefined, tickmarkPlacement: js.UndefOr[String] = js.undefined, tickPosition: js.UndefOr[String] = js.undefined, title: js.UndefOr[js.Any] = js.undefined, `type`: js.UndefOr[String] = "linear", minorGridLineColor: js.UndefOr[String | js.Object] = js.undefined, minorGridLineWidth: js.UndefOr[Double] = js.undefined, minorTickColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, tickColor: js.UndefOr[String | js.Object] = js.undefined, alignTicks: js.UndefOr[Boolean] = js.undefined, allowDecimals: js.UndefOr[Boolean] = js.undefined, alternateGridColor: js.UndefOr[String | js.Object] = js.undefined, breaks: js.UndefOr[js.Array[js.Any]] = js.undefined, categories: js.UndefOr[js.Array[String]] = js.undefined, ceiling: js.UndefOr[Double] = js.undefined, description: js.UndefOr[String] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, floor: js.UndefOr[Double] = js.undefined, gridLineDashStyle: js.UndefOr[String] = js.undefined, gridZIndex: js.UndefOr[Double] = js.undefined, id: js.UndefOr[String] = js.undefined, max: js.UndefOr[Double] = js.undefined, min: js.UndefOr[Double] = js.undefined, minorGridLineDashStyle: js.UndefOr[String] = js.undefined, minorTickInterval: js.UndefOr[Double | String | Null] = js.undefined, minorTicks: js.UndefOr[Boolean] = js.undefined, minorTickWidth: js.UndefOr[Double] = js.undefined, minTickInterval: js.UndefOr[Double] = js.undefined, offset: js.UndefOr[Double] = js.undefined, ordinal: js.UndefOr[Boolean] = js.undefined, pane: js.UndefOr[Double] = js.undefined, reversed: js.UndefOr[Boolean] = js.undefined, reversedStacks: js.UndefOr[Boolean] = js.undefined, showFirstLabel: js.UndefOr[Boolean] = js.undefined, showLastLabel: js.UndefOr[Boolean] = js.undefined, softMax: js.UndefOr[Double] = js.undefined, softMin: js.UndefOr[Double] = js.undefined, tickAmount: js.UndefOr[Double] = js.undefined, tickInterval: js.UndefOr[Double] = js.undefined, tickPositioner: js.UndefOr[js.Function] = js.undefined, tickPositions: js.UndefOr[js.Array[Double]] = js.undefined, tickWidth: js.UndefOr[Double] = js.undefined, uniqueNames: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[String | js.Array[Double]]]] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, plotBands: js.UndefOr[js.Array[js.Any]] = js.undefined, plotLines: js.UndefOr[js.Array[js.Any]] = js.undefined, currentDateIndicator: js.UndefOr[CleanJsObject[NavigatorXAxisCurrentDateIndicator]] = js.undefined, grid: js.UndefOr[js.Object] = js.undefined): NavigatorXAxis = {
    val overscrollOuter: js.UndefOr[Double] = overscroll
    val classNameOuter: js.UndefOr[String] = className
    val tickLengthOuter: js.UndefOr[Double] = tickLength
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    val gridLineColorOuter: js.UndefOr[String] = gridLineColor
    ...
    val crosshairOuter: js.UndefOr[Boolean] = crosshair
    ...
    val currentDateIndicatorOuter: js.UndefOr[CleanJsObject[NavigatorXAxisCurrentDateIndicator]] = currentDateIndicator
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxis {
      ...
      override val gridLineColor: js.UndefOr[String] = gridLineColorOuter
      ...
      override val crosshair: js.UndefOr[Boolean] = crosshairOuter
      ...
      override val currentDateIndicator: js.UndefOr[CleanJsObject[NavigatorXAxisCurrentDateIndicator]] = currentDateIndicatorOuter
