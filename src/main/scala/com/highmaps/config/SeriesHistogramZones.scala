...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-zones</code>
  */
@js.annotation.ScalaJSDefined
class SeriesHistogramZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHistogramZones = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramZones {
