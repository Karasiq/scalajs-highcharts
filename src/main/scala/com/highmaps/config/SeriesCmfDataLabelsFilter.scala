...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesCmfDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesCmfDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfDataLabelsFilter {
