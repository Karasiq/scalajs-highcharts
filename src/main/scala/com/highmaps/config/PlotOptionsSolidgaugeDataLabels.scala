...
class PlotOptionsSolidgaugeDataLabels extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/color-axis/">Data labels enabled</a>
  ...
  /**
    * <p>The y position offset of the label relative to the center of the
    * gauge.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/series-datalabels-box/">Data labels box options</a>
  ...
  /**
    * <p>The Z index of the data labels. A value of 2 display them behind
    * the dial.</p>
    * @since 2.1.5
    */
...
object PlotOptionsSolidgaugeDataLabels {
  /**
    ...
    * @param y <p>The y position offset of the label relative to the center of the. gauge.</p>
    * @param borderRadius <p>The border radius in pixels for the gauge&#39;s data label.</p>
    ...
    * @param verticalAlign <p>The vertical alignment of the data label.</p>
    * @param zIndex <p>The Z index of the data labels. A value of 2 display them behind. the dial.</p>
    * @param borderWidth <p>The border width in pixels for the gauge data label.</p>
    * @param borderColor <p>The border color for the data label.</p>
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean] = js.undefined, y: js.UndefOr[Double] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, align: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, x: js.UndefOr[Double] = js.undefined, padding: js.UndefOr[Double] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, format: js.UndefOr[String] = js.undefined, shape: js.UndefOr[String] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, shadow: js.UndefOr[Boolean | js.Any] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, overflow: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined): PlotOptionsSolidgaugeDataLabels = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSolidgaugeDataLabels {
