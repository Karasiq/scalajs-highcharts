...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesColumnrangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesColumnrangeDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeDataLabelsFilter {
