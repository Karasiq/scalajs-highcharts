...
object HighmapsConfig {
  /**
    ...
    * @param colors <p>An array containing the default colors for the chart's series. When all colors are used, new colors are pulled from the start again. Defaults to:. <pre>colors: ['#7cb5ec', '#434348', '#90ed7d', '#f7a35c', '#8085e9', .    '#f15c80', '#e4d354', '#8085e8', '#8d4653', '#91e8e1']</pre>. </p>
    ...
    */
  def apply(series: js.UndefOr[js.Array[CleanJsObject[SeriesHeatmap | SeriesMap | SeriesMapbubble | SeriesMapline | SeriesMappoint]]] = js.undefined, chart: js.UndefOr[CleanJsObject[Chart]] = js.undefined, colorAxis: js.UndefOr[CleanJsObject[ColorAxis]] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, credits: js.UndefOr[CleanJsObject[Credits]] = js.undefined, drilldown: js.UndefOr[CleanJsObject[Drilldown]] = js.undefined, exporting: js.UndefOr[CleanJsObject[Exporting]] = js.undefined, global: js.UndefOr[CleanJsObject[Global]] = js.undefined, labels: js.UndefOr[CleanJsObject[Labels]] = js.undefined, lang: js.UndefOr[CleanJsObject[Lang]] = js.undefined, legend: js.UndefOr[CleanJsObject[Legend]] = js.undefined, loading: js.UndefOr[CleanJsObject[Loading]] = js.undefined, mapNavigation: js.UndefOr[CleanJsObject[MapNavigation]] = js.undefined, navigation: js.UndefOr[CleanJsObject[Navigation]] = js.undefined, plotOptions: js.UndefOr[CleanJsObject[PlotOptions]] = js.undefined, subtitle: js.UndefOr[CleanJsObject[Subtitle]] = js.undefined, title: js.UndefOr[CleanJsObject[Title]] = js.undefined, tooltip: js.UndefOr[CleanJsObject[Tooltip]] = js.undefined, xAxis: js.UndefOr[CleanJsObject[XAxis]] = js.undefined, yAxis: js.UndefOr[CleanJsObject[YAxis]] = js.undefined): HighmapsConfig = {
