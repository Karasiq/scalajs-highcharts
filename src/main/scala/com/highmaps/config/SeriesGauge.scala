...
class SeriesGauge extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>gauge</code> series type,
    ...
    * points exceeds the series&#39; <a href="#series.gauge.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  val `type`: js.UndefOr[String] = "gauge"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>Data labels for the gauge. For gauges, the data labels are enabled
    * by default and shown in a bordered box below the point.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-datalabels-multiple">Multiple data labels on a bar series</a>
  ...
  /**
    ...
    * <p>In styled mode, the dial is styled with the
    * <code>.highcharts-gauge-series .highcharts-dial</code> rule.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/gauge/">Styled mode</a>
    * @since 2.3.0
    */
  ...
  /**
    ...
    * <p>In styled mode, the pivot is styled with the
    * <code>.highcharts-gauge-series .highcharts-pivot</code> rule.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/gauge/">Styled mode</a>
    * @since 2.3.0
    */
  ...
  /**
    * <p>When this option is <code>true</code>, the dial will wrap around the axes. For
    * instance, in a full-range gauge going from 0 to 360, a value of 400
    * will point to 40. When <code>wrap</code> is <code>false</code>, the dial stops at 360.</p>
    * @since 3.0
    */
  val wrap: js.UndefOr[Boolean] = js.undefined

  /**
    * <p>Allow the dial to overshoot the end of the perimeter axis by this
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/series/joinby-null/">Simple data joined by null</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  val pathfinder: js.UndefOr[CleanJsObject[SeriesGaugePathfinder]] = js.undefined
}

object SeriesGauge {
  /**
    * @param data <p>An array of data points for the series. For the <code>gauge</code> series type,. points can be given in the following ways:</p>. <ol>. <li><p>An array of numerical values. In this case, the numerical values. will be interpreted as <code>y</code> options. Example:</p>. <pre><code class="language-js">data: [0, 5, 3, 5]</code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of data. points exceeds the series&#39; <a href="#series.gauge.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <p><code>`</code>js. data: [{. y: 6,. name: &quot;Point2&quot;,. color: &quot;#00FF00&quot;. }, {. y: 8,. name: &quot;Point1&quot;,. color: &quot;#FF00FF&quot;. }]</pre></p>. </li>. </ol>. <p>The typical gauge only contains a single data value.</p>
    ...
    * @param dial <p>Options for the dial or arrow pointer of the gauge.</p>. <p>In styled mode, the dial is styled with the. <code>.highcharts-gauge-series .highcharts-dial</code> rule.</p>
    * @param pivot <p>Options for the pivot or the center point of the gauge.</p>. <p>In styled mode, the pivot is styled with the. <code>.highcharts-gauge-series .highcharts-pivot</code> rule.</p>
    ...
    * @param wrap <p>When this option is <code>true</code>, the dial will wrap around the axes. For. instance, in a full-range gauge going from 0 to 360, a value of 400. will point to 40. When <code>wrap</code> is <code>false</code>, the dial stops at 360.</p>
    * @param overshoot <p>Allow the dial to overshoot the end of the perimeter axis by this. many degrees. Say if the gauge axis goes from 0 to 60, a value of. 100, or 1000, will show 5 degrees beyond the end of the axis when this. option is set to 5.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[CleanJsObject[SeriesGaugeData] | Double]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, `type`: js.UndefOr[String] = "gauge", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Object]] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesGaugeDataLabels]] = js.undefined, dial: js.UndefOr[CleanJsObject[SeriesGaugeDial]] = js.undefined, pivot: js.UndefOr[CleanJsObject[SeriesGaugePivot]] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, wrap: js.UndefOr[Boolean] = js.undefined, overshoot: js.UndefOr[Double] = js.undefined, linecap: js.UndefOr[String] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Object] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, cursor: js.UndefOr[String] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, exposeElementToA11y: js.UndefOr[Boolean] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[js.Any] = js.undefined, colorAxis: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, pathfinder: js.UndefOr[CleanJsObject[SeriesGaugePathfinder]] = js.undefined): SeriesGauge = {
    ...
    val pathfinderOuter: js.UndefOr[CleanJsObject[SeriesGaugePathfinder]] = pathfinder
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGauge {
      ...
      override val pathfinder: js.UndefOr[CleanJsObject[SeriesGaugePathfinder]] = pathfinderOuter
    })
  }
}
