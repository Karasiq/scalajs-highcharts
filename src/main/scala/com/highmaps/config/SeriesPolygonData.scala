...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPolygonData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesPolygonDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesPolygonDataEvents]] = js.undefined

  val marker: js.UndefOr[CleanJsObject[SeriesPolygonDataMarker]] = js.undefined
}
...
object SeriesPolygonData {
  /**
    ...
    */
  def apply(dragDrop: js.UndefOr[CleanJsObject[SeriesPolygonDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesPolygonDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPolygonDataMarker]] = js.undefined): SeriesPolygonData = {
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesPolygonDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesPolygonDataEvents]] = events
    val markerOuter: js.UndefOr[CleanJsObject[SeriesPolygonDataMarker]] = marker
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonData {
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesPolygonDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesPolygonDataEvents]] = eventsOuter
      override val marker: js.UndefOr[CleanJsObject[SeriesPolygonDataMarker]] = markerOuter
    })
  }
}
