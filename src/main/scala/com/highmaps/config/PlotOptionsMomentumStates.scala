...
class PlotOptionsMomentumStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  val normal: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesNormal]] = js.undefined
  ...
  /**
    ...
    * @since 6.0.0
    */
  val select: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesSelect]] = js.undefined
}
...
object PlotOptionsMomentumStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesNormal]] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesSelect]] = js.undefined): PlotOptionsMomentumStates = {
    val normalOuter: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesNormal]] = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesSelect]] = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumStates {
      override val normal: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesNormal]] = normalOuter
      override val hover: js.Any = hoverOuter
      override val select: js.UndefOr[CleanJsObject[PlotOptionsMomentumStatesSelect]] = selectOuter
    })
  }
}
