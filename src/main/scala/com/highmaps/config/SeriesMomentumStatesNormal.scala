...
/**
  * @note JavaScript name: <code>series&lt;momentum&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesMomentumStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesMomentumStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesMomentumStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMomentumStatesNormal {
