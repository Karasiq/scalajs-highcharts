...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-states-hover-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class SeriesOhlcStatesHoverMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcStatesHoverMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesOhlcStatesHoverMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcStatesHoverMarkerStates {
