...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-data</code>
  */
@js.annotation.ScalaJSDefined
class SeriesWaterfallData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>When this property is true, the points acts as a summary column for
    * the values added or substracted since the last intermediate sum,
    * or since the start of the series. The <code>y</code> value is ignored.</p>
  ...
  /**
    * <p>When this property is true, the point display the total sum across
    * the entire series. The <code>y</code> value is ignored.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/demo/waterfall/">Waterfall</a>
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesWaterfallDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  val events: js.UndefOr[CleanJsObject[SeriesWaterfallDataEvents]] = js.undefined
}

object SeriesWaterfallData {
  /**
    * @param isIntermediateSum <p>When this property is true, the points acts as a summary column for. the values added or substracted since the last intermediate sum,. or since the start of the series. The <code>y</code> value is ignored.</p>
    * @param isSum <p>When this property is true, the point display the total sum across. the entire series. The <code>y</code> value is ignored.</p>
    ...
    */
  def apply(isIntermediateSum: js.UndefOr[Boolean] = js.undefined, isSum: js.UndefOr[Boolean] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesWaterfallDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesWaterfallDataEvents]] = js.undefined): SeriesWaterfallData = {
    val isIntermediateSumOuter: js.UndefOr[Boolean] = isIntermediateSum
    val isSumOuter: js.UndefOr[Boolean] = isSum
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesWaterfallDataDragDrop]] = dragDrop
    ...
    val eventsOuter: js.UndefOr[CleanJsObject[SeriesWaterfallDataEvents]] = events
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWaterfallData {
      override val isIntermediateSum: js.UndefOr[Boolean] = isIntermediateSumOuter
      override val isSum: js.UndefOr[Boolean] = isSumOuter
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesWaterfallDataDragDrop]] = dragDropOuter
      ...
      override val events: js.UndefOr[CleanJsObject[SeriesWaterfallDataEvents]] = eventsOuter
    })
  }
}
