...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPivotpointsMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPivotpointsMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsMarkerStatesSelect {
