...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-dragDrop-dragHandle</code>
  */
@js.annotation.ScalaJSDefined
class SeriesPieDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDragDropDragHandle {
  /**
    ...
    */
  def apply(pathFormatter: js.UndefOr[js.Function] = js.undefined, cursor: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesPieDragDropDragHandle = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieDragDropDragHandle {
