...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-dataLabels-filter</code>
  */
@js.annotation.ScalaJSDefined
class SeriesParetoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoDataLabelsFilter {
  /**
    ...
    */
  def apply(property: js.UndefOr[String] = js.undefined, operator: js.UndefOr[String] = js.undefined, value: js.UndefOr[js.Any] = js.undefined): SeriesParetoDataLabelsFilter = {
    val propertyOuter: js.UndefOr[String] = property
    val operatorOuter: js.UndefOr[String] = operator
    val valueOuter: js.Any = value
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoDataLabelsFilter {
