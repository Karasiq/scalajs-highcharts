...
/**
  * @note JavaScript name: <code>plotOptions-atr-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsAtrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAtrMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrMarkerStates {
