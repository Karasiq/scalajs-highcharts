...
/**
  * @note JavaScript name: <code>navigator-yAxis-events</code>
  */
@js.annotation.ScalaJSDefined
class NavigatorYAxisEvents extends com.highcharts.HighchartsGenericObject {
...
object NavigatorYAxisEvents {
  /**
    ...
    */
  def apply(afterBreaks: js.UndefOr[js.Function] = js.undefined, afterSetExtremes: js.UndefOr[js.Function] = js.undefined, pointBreak: js.UndefOr[js.Function] = js.undefined, pointInBreak: js.UndefOr[js.Function] = js.undefined, setExtremes: js.UndefOr[js.Function] = js.undefined): NavigatorYAxisEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorYAxisEvents {
