...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-dragDrop-guideBox-default</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStochasticDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsStochasticDragDropGuideBoxDefault = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticDragDropGuideBoxDefault {
