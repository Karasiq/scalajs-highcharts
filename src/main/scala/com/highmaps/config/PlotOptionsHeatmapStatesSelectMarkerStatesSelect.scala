...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-states-select-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsHeatmapStatesSelectMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapStatesSelectMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsHeatmapStatesSelectMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapStatesSelectMarkerStatesSelect {
