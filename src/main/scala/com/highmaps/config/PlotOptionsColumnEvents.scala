...
/**
  * @note JavaScript name: <code>plotOptions-column-events</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsColumnEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Function] = js.undefined, checkboxClick: js.UndefOr[js.Function] = js.undefined, click: js.UndefOr[js.Function] = js.undefined, hide: js.UndefOr[js.Function] = js.undefined, legendItemClick: js.UndefOr[js.Function] = js.undefined, mouseOut: js.UndefOr[js.Function] = js.undefined, mouseOver: js.UndefOr[js.Function] = js.undefined, show: js.UndefOr[js.Function] = js.undefined): PlotOptionsColumnEvents = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnEvents {
