...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-marker-states-select</code>
  */
@js.annotation.ScalaJSDefined
class SeriesTreemapMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapMarkerStatesSelect {
  /**
    ...
    */
  def apply(fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesTreemapMarkerStatesSelect = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapMarkerStatesSelect {
