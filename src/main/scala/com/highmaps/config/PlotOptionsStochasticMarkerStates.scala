...
/**
  * @note JavaScript name: <code>plotOptions-stochastic-marker-states</code>
  */
@js.annotation.ScalaJSDefined
class PlotOptionsStochasticMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStochasticMarkerStates {
  /**
    ...
    */
  def apply(normal: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsStochasticMarkerStates = {
    val normalOuter: js.Any = normal
    val hoverOuter: js.Any = hover
    val selectOuter: js.Any = select
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStochasticMarkerStates {
