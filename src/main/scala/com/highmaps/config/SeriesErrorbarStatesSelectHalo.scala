...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-states-select-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesErrorbarStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarStatesSelectHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesErrorbarStatesSelectHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarStatesSelectHalo {
