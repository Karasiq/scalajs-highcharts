...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-states-normal</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVbpStatesNormal extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpStatesNormal {
  /**
    ...
    */
  def apply(animation: js.UndefOr[js.Object | Boolean] = js.undefined): SeriesVbpStatesNormal = {
    val animationOuter: js.UndefOr[js.Object | Boolean] = animation
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpStatesNormal {
