...
/**
  * @note JavaScript name: <code>chart-parallelAxes-grid</code>
  */
@js.annotation.ScalaJSDefined
class ChartParallelAxesGrid extends com.highcharts.HighchartsGenericObject {
...
object ChartParallelAxesGrid {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, columns: js.UndefOr[js.Array[js.Object]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, cellHeight: js.UndefOr[Double] = js.undefined): ChartParallelAxesGrid = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new ChartParallelAxesGrid {
