...
class SeriesLineData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  val dragDrop: js.UndefOr[CleanJsObject[SeriesLineDataDragDrop]] = js.undefined
...
object SeriesLineData {
  /**
    ...
    */
  def apply(dragDrop: js.UndefOr[CleanJsObject[SeriesLineDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesLineDataEvents]] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesLineDataMarker]] = js.undefined): SeriesLineData = {
    val dragDropOuter: js.UndefOr[CleanJsObject[SeriesLineDataDragDrop]] = dragDrop
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineData {
      override val dragDrop: js.UndefOr[CleanJsObject[SeriesLineDataDragDrop]] = dragDropOuter
