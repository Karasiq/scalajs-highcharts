...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-states-hover-halo</code>
  */
@js.annotation.ScalaJSDefined
class SeriesVectorStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined): SeriesVectorStatesHoverHalo = {
    ...
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorStatesHoverHalo {
