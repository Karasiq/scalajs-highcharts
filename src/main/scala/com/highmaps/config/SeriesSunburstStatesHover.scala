...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-states-hover</code>
  */
@js.annotation.ScalaJSDefined
class SeriesSunburstStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  val marker: js.UndefOr[CleanJsObject[SeriesSunburstStatesHoverMarker]] = js.undefined
...
object SeriesSunburstStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, halo: js.UndefOr[js.Any] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesSunburstStatesHoverMarker]] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined): SeriesSunburstStatesHover = {
    ...
    val markerOuter: js.UndefOr[CleanJsObject[SeriesSunburstStatesHoverMarker]] = marker
    val lineWidthOuter: js.UndefOr[Double] = lineWidth
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstStatesHover {
      ...
      override val marker: js.UndefOr[CleanJsObject[SeriesSunburstStatesHoverMarker]] = markerOuter
