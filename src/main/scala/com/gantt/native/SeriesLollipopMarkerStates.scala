...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-marker-states</code>
  */
class SeriesLollipopMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLollipopMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
