...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-states</code>
  */
class SeriesAroonoscillatorStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesAroonoscillatorStatesSelect]] = js.undefined
}

object SeriesAroonoscillatorStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAroonoscillatorStatesSelect]] = js.undefined): SeriesAroonoscillatorStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorStates {
      this.hover = hover
