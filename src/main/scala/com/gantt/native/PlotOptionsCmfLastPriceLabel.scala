...
/**
  * @note JavaScript name: <code>plotOptions-cmf-lastPrice-label</code>
  */
class PlotOptionsCmfLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmfLastPriceLabel {
  /**
