...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dataLabels-animation</code>
  */
class SeriesKeltnerchannelsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
