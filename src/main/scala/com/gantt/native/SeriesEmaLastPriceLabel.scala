...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-lastPrice-label</code>
  */
class SeriesEmaLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaLastPriceLabel {
  /**
