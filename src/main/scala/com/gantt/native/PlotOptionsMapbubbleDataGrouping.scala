...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-dataGrouping</code>
  */
class PlotOptionsMapbubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleDataGrouping {
  /**
