...
/**
  * @note JavaScript name: <code>plotOptions-abands-label</code>
  */
class PlotOptionsAbandsLabel extends com.highcharts.HighchartsGenericObject {
