...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-dataGrouping</code>
  */
class SeriesErrorbarDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataGrouping {
  /**
