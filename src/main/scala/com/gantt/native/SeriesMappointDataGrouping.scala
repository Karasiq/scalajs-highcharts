...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-dataGrouping</code>
  */
class SeriesMappointDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointDataGrouping {
  /**
