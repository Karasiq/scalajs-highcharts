...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-states-inactive</code>
  */
class SeriesTilemapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTilemapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTilemapStatesInactive {
