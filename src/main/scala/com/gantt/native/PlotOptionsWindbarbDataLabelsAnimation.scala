...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-dataLabels-animation</code>
  */
class PlotOptionsWindbarbDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsWindbarbDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbDataLabelsAnimation {
      this.defer = defer
    })
  }
}
