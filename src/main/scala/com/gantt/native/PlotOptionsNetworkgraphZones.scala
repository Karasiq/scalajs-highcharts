...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-zones</code>
  */
class PlotOptionsNetworkgraphZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsNetworkgraphZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphZones {
