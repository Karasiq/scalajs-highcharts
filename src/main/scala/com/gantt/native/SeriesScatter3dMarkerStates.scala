...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-marker-states</code>
  */
class SeriesScatter3dMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesScatter3dMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
