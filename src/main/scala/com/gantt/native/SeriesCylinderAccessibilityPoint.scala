...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-accessibility-point</code>
  */
class SeriesCylinderAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesCylinderAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderAccessibilityPoint {
