...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-dataLabels-animation</code>
  */
class SeriesAtrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAtrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
