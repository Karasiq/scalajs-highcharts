...
/**
  * @note JavaScript name: <code>chart-parallelAxes-labels</code>
  */
class ChartParallelAxesLabels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * <p>Angular gauges and solid gauges defaults to <code>&quot;center&quot;</code>.
    * Solid gauges with two labels have additional option <code>&quot;auto&quot;</code>
    * for automatic horizontal and vertical alignment.</p>
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/series-solidgauge/labels-auto-aligned/">Solid gauge labels auto aligned</a>
    * @since 6.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/xaxis/labels-reservespace-true/">Left-aligned labels on a vertical category axis</a>
  ...
  /**
    ...
    * of the <a href="#yAxis.labels.distance">distance</a> option.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/xaxis/labels-x/">Y axis labels placed on grid lines</a>
    * @since 6.0.0
    */
  ...
  /**
    * <p>Angular gauges and solid gauges only.
    * The label&#39;s pixel distance from the perimeter of the plot area.</p>
    * <p>Since v7.1.2: If it&#39;s a percentage string, it is interpreted the
    * same as <a href="#plotOptions.gauge.radius">series.radius</a>, so label can be
    * aligned under the gauge&#39;s shape.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/yaxis/labels-distance/">Labels centered under the arc</a>
    * @since 6.0.0
    */
  ...
  /**
    ...
    * @since 6.0.0
    */
  var symbol: js.Any = js.undefined
...
object ChartParallelAxesLabels {
  /**
    * @param align <p>What part of the string the given position is anchored to. Can. be one of <code>&quot;left&quot;</code>, <code>&quot;center&quot;</code> or <code>&quot;right&quot;</code>. The exact position. also depends on the <code>labels.x</code> setting.</p>. <p>Angular gauges and solid gauges defaults to <code>&quot;center&quot;</code>.. Solid gauges with two labels have additional option <code>&quot;auto&quot;</code>. for automatic horizontal and vertical alignment.</p>
    ...
    * @param x <p>The x position offset of all labels relative to the tick. positions on the axis. Defaults to -15 for left axis, 15 for. right axis.</p>
    * @param y <p>The y position offset of all labels relative to the tick. positions on the axis. For polar and radial axis consider the use. of the <a href="#yAxis.labels.distance">distance</a> option.</p>
    * @param distance <p>Angular gauges and solid gauges only.. The label&#39;s pixel distance from the perimeter of the plot area.</p>. <p>Since v7.1.2: If it&#39;s a percentage string, it is interpreted the. same as <a href="#plotOptions.gauge.radius">series.radius</a>, so label can be. aligned under the gauge&#39;s shape.</p>
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, reserveSpace: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, distance: js.UndefOr[Double | String] = js.undefined, levels: js.UndefOr[js.Array[js.Any]] = js.undefined, symbol: js.UndefOr[js.Any] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, autoRotation: js.UndefOr[js.Array[Double]] = js.undefined, autoRotationLimit: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, indentation: js.UndefOr[Double] = js.undefined, maxStaggerLines: js.UndefOr[Double] = js.undefined, overflow: js.UndefOr[String] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position3d: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, skew3d: js.UndefOr[Boolean] = js.undefined, staggerLines: js.UndefOr[Double] = js.undefined, step: js.UndefOr[Double] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): ChartParallelAxesLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ChartParallelAxesLabels {
      this.align = align
