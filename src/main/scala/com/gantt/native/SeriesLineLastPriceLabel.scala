...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-lastPrice-label</code>
  */
class SeriesLineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineLastPriceLabel {
  /**
