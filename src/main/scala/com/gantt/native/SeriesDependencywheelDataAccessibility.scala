...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-data-accessibility</code>
  */
class SeriesDependencywheelDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesDependencywheelDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelDataAccessibility {
