...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-dataSorting</code>
  */
class PlotOptionsWindbarbDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsWindbarbDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbDataSorting {
