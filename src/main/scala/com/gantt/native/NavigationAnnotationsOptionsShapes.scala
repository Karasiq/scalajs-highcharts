...
/**
  * @note JavaScript name: <code>navigation-annotationsOptions-shapes</code>
  */
class NavigationAnnotationsOptionsShapes extends com.highcharts.HighchartsGenericObject {
...
object NavigationAnnotationsOptionsShapes {
  /**
