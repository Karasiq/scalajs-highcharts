...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-dataGrouping</code>
  */
class SeriesTilemapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataGrouping {
  /**
