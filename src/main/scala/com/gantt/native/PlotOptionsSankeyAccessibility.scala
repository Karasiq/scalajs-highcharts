...
/**
  * @note JavaScript name: <code>plotOptions-sankey-accessibility</code>
  */
class PlotOptionsSankeyAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSankeyAccessibilityPoint]] = js.undefined
}

object PlotOptionsSankeyAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSankeyAccessibilityPoint]] = js.undefined): PlotOptionsSankeyAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyAccessibility {
