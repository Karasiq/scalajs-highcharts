...
/**
  * @note JavaScript name: <code>plotOptions-flags-dataLabels-filter</code>
  */
class PlotOptionsFlagsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsFlagsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsDataLabelsFilter {
