...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-label</code>
  */
class SeriesTrendlineLabel extends com.highcharts.HighchartsGenericObject {
