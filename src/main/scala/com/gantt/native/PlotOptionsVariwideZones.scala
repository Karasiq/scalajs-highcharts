...
/**
  * @note JavaScript name: <code>plotOptions-variwide-zones</code>
  */
class PlotOptionsVariwideZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVariwideZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsVariwideZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVariwideZones {
