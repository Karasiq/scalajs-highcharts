...
/**
  * @note JavaScript name: <code>plotOptions-cci-states-inactive</code>
  */
class PlotOptionsCciStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsCciStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciStatesInactive {
