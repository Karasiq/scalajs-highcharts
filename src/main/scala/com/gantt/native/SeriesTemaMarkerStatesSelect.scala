...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-marker-states-select</code>
  */
class SeriesTemaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesTemaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaMarkerStatesSelect {
