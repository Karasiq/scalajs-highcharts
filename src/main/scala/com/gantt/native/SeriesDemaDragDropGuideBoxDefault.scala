...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dragDrop-guideBox-default</code>
  */
class SeriesDemaDragDropGuideBoxDefault extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaDragDropGuideBoxDefault {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesDemaDragDropGuideBoxDefault = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaDragDropGuideBoxDefault {
