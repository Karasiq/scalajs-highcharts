...
/**
  * @note JavaScript name: <code>plotOptions-mfi-states-inactive</code>
  */
class PlotOptionsMfiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsMfiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiStatesInactive {
