...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dataSorting</code>
  */
class SeriesChaikinDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesChaikinDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinDataSorting {
