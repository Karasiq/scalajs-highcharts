...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-dataSorting</code>
  */
class SeriesSmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesSmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaDataSorting {
