...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-dataLabels-filter</code>
  */
class SeriesRocDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesRocDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocDataLabelsFilter {
