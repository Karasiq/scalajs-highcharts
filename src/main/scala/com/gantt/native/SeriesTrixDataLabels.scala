...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dataLabels</code>
  */
class SeriesTrixDataLabels extends com.highcharts.HighchartsGenericObject {
