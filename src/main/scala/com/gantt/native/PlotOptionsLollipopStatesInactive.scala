...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-states-inactive</code>
  */
class PlotOptionsLollipopStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopStatesInactive {
