...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dataGrouping</code>
  */
class SeriesLinearregressioninterceptDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDataGrouping {
  /**
