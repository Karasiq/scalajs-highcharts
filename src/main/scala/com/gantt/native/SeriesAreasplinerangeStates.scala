...
class SeriesAreasplinerangeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesAreasplinerangeStatesSelect]] = js.undefined
}
...
object SeriesAreasplinerangeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAreasplinerangeStatesSelect]] = js.undefined): SeriesAreasplinerangeStates = {
