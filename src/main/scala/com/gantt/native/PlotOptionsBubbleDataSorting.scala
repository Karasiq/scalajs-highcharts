...
/**
  * @note JavaScript name: <code>plotOptions-bubble-dataSorting</code>
  */
class PlotOptionsBubbleDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBubbleDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsBubbleDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBubbleDataSorting {
