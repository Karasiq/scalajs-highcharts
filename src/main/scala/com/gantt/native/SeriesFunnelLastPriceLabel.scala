...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-lastPrice-label</code>
  */
class SeriesFunnelLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelLastPriceLabel {
  /**
