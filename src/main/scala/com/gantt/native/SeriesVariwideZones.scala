...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-zones</code>
  */
class SeriesVariwideZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVariwideZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideZones {
