...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-lastPrice-label</code>
  */
class SeriesAreasplineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineLastPriceLabel {
  /**
