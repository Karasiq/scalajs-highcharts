...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-accessibility-point</code>
  */
class SeriesBulletAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesBulletAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletAccessibilityPoint {
