...
/**
  * @note JavaScript name: <code>plotOptions-series-states-select-marker</code>
  */
class PlotOptionsSeriesStatesSelectMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSeriesStatesSelectMarker {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, enabledThreshold: js.UndefOr[Double] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsSeriesStatesSelectMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesStatesSelectMarker {
