...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-dataLabels-animation</code>
  */
class SeriesDependencywheelDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDependencywheelDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelDataLabelsAnimation {
      this.defer = defer
    })
  }
}
