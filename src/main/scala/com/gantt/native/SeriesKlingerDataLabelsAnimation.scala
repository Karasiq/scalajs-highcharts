...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dataLabels-animation</code>
  */
class SeriesKlingerDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesKlingerDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerDataLabelsAnimation {
      this.defer = defer
    })
  }
}
