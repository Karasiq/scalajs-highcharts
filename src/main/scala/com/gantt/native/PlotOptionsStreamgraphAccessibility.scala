...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-accessibility</code>
  */
class PlotOptionsStreamgraphAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsStreamgraphAccessibilityPoint]] = js.undefined
}

object PlotOptionsStreamgraphAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsStreamgraphAccessibilityPoint]] = js.undefined): PlotOptionsStreamgraphAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsStreamgraphAccessibility {
