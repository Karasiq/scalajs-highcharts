...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-states-select-halo</code>
  */
class PlotOptionsSlowstochasticStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSlowstochasticStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSlowstochasticStatesSelectHalo {
