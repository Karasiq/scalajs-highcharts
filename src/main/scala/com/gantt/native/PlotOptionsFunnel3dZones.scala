...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-zones</code>
  */
class PlotOptionsFunnel3dZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsFunnel3dZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dZones {
