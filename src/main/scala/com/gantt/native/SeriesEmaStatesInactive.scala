...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-states-inactive</code>
  */
class SeriesEmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesEmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaStatesInactive {
