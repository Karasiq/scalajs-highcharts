...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-data-dataLabels-filter</code>
  */
class SeriesArearangeDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesArearangeDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataDataLabelsFilter {
