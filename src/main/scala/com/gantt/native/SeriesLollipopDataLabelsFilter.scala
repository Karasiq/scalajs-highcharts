...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-dataLabels-filter</code>
  */
class SeriesLollipopDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLollipopDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopDataLabelsFilter {
