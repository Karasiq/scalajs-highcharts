...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-states-select-halo</code>
  */
class SeriesDumbbellStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDumbbellStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellStatesSelectHalo {
