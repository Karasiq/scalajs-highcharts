...
/**
  * @note JavaScript name: <code>plotOptions-vector-accessibility</code>
  */
class PlotOptionsVectorAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsVectorAccessibilityPoint]] = js.undefined
}

object PlotOptionsVectorAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsVectorAccessibilityPoint]] = js.undefined): PlotOptionsVectorAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorAccessibility {
