...
/**
  * @note JavaScript name: <code>plotOptions-obv-dataLabels</code>
  */
class PlotOptionsObvDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsObvDataLabels {
  /**
