...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-states-inactive</code>
  */
class SeriesVbpStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesVbpStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpStatesInactive {
