...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dragDrop</code>
  */
class SeriesChaikinDragDrop extends com.highcharts.HighchartsGenericObject {
