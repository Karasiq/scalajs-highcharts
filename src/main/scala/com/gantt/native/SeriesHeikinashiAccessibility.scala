...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-accessibility</code>
  */
class SeriesHeikinashiAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesHeikinashiAccessibilityPoint]] = js.undefined
}

object SeriesHeikinashiAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesHeikinashiAccessibilityPoint]] = js.undefined): SeriesHeikinashiAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiAccessibility {
