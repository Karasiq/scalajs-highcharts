...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-marker-states</code>
  */
class SeriesLinearregressionangleMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLinearregressionangleMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
