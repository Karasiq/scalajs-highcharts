...
/**
  * @note JavaScript name: <code>plotOptions-cmo-states</code>
  */
class PlotOptionsCmoStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsCmoStatesSelect]] = js.undefined
}

object PlotOptionsCmoStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsCmoStatesSelect]] = js.undefined): PlotOptionsCmoStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoStates {
      this.hover = hover
