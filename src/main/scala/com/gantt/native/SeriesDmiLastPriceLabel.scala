...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-lastPrice-label</code>
  */
class SeriesDmiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiLastPriceLabel {
  /**
