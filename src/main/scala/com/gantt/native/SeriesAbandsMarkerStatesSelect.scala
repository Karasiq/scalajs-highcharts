...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-marker-states-select</code>
  */
class SeriesAbandsMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesAbandsMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsMarkerStatesSelect {
