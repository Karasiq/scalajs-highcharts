...
/**
  * @note JavaScript name: <code>plotOptions-line-zones</code>
  */
class PlotOptionsLineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineZones {
