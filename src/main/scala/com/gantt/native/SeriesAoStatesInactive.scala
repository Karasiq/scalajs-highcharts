...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-states-inactive</code>
  */
class SeriesAoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoStatesInactive {
