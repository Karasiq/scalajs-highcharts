...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-data-marker-states-select</code>
  */
class SeriesVectorDataMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesVectorDataMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataMarkerStatesSelect {
