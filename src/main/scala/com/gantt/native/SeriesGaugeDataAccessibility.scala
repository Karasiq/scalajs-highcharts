...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-data-accessibility</code>
  */
class SeriesGaugeDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesGaugeDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataAccessibility {
