...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-data-dataLabels</code>
  */
class SeriesNetworkgraphDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataDataLabels {
  /**
