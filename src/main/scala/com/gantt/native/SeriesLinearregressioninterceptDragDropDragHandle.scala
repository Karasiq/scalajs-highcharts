...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-dragDrop-dragHandle</code>
  */
class SeriesLinearregressioninterceptDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptDragDropDragHandle {
