...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-dataLabels-animation</code>
  */
class SeriesVwapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesVwapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
