...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-lastPrice-label</code>
  */
class PlotOptionsLinearregressionslopeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeLastPriceLabel {
  /**
