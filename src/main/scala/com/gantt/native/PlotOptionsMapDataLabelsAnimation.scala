...
/**
  * @note JavaScript name: <code>plotOptions-map-dataLabels-animation</code>
  */
class PlotOptionsMapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
