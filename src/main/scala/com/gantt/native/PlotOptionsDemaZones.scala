...
/**
  * @note JavaScript name: <code>plotOptions-dema-zones</code>
  */
class PlotOptionsDemaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDemaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaZones {
