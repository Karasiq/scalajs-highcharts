...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-params</code>
  */
class SeriesLinearregressioninterceptParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptParams {
