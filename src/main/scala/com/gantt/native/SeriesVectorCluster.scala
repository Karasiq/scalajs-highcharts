...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-cluster</code>
  */
class SeriesVectorCluster extends com.highcharts.HighchartsGenericObject {
