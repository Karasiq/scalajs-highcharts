...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-zones</code>
  */
class SeriesFlagsZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFlagsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFlagsZones {
