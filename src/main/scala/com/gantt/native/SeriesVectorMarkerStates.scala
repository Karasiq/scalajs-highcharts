...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-marker-states</code>
  */
class SeriesVectorMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVectorMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
