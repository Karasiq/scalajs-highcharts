...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-accessibility-point</code>
  */
class SeriesAreaAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesAreaAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaAccessibilityPoint {
