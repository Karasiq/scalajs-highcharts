...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-states-select-halo</code>
  */
class PlotOptionsPackedbubbleStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPackedbubbleStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleStatesSelectHalo {
