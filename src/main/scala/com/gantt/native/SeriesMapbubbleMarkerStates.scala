...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-marker-states</code>
  */
class SeriesMapbubbleMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesMapbubbleMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubbleMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
