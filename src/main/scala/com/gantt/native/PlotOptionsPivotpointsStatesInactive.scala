...
/**
  * @note JavaScript name: <code>plotOptions-pivotpoints-states-inactive</code>
  */
class PlotOptionsPivotpointsStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPivotpointsStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsPivotpointsStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPivotpointsStatesInactive {
