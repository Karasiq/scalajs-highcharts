...
/**
  * @note JavaScript name: <code>plotOptions-line-dataLabels-animation</code>
  */
class PlotOptionsLineDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsLineDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineDataLabelsAnimation {
      this.defer = defer
    })
  }
}
