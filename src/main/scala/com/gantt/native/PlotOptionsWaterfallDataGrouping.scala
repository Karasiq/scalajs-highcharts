...
/**
  * @note JavaScript name: <code>plotOptions-waterfall-dataGrouping</code>
  */
class PlotOptionsWaterfallDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWaterfallDataGrouping {
  /**
