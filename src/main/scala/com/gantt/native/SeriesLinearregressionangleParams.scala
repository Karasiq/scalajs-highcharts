...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-params</code>
  */
class SeriesLinearregressionangleParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleParams {
  /**
    ...
    */
  def apply(xAxisUnit: js.UndefOr[Null | Double] = js.undefined, index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleParams {
