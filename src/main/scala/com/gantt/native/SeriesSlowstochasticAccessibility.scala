...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-accessibility</code>
  */
class SeriesSlowstochasticAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesSlowstochasticAccessibilityPoint]] = js.undefined
}

object SeriesSlowstochasticAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesSlowstochasticAccessibilityPoint]] = js.undefined): SeriesSlowstochasticAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticAccessibility {
