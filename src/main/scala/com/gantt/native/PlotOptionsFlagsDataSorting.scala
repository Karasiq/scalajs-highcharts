...
/**
  * @note JavaScript name: <code>plotOptions-flags-dataSorting</code>
  */
class PlotOptionsFlagsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFlagsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsFlagsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFlagsDataSorting {
