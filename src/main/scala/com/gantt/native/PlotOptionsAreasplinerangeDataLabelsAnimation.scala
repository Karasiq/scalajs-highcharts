...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-dataLabels-animation</code>
  */
class PlotOptionsAreasplinerangeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplinerangeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAreasplinerangeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplinerangeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
