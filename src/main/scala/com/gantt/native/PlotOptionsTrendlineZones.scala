...
/**
  * @note JavaScript name: <code>plotOptions-trendline-zones</code>
  */
class PlotOptionsTrendlineZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrendlineZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsTrendlineZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrendlineZones {
