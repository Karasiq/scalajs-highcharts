...
/**
  * @note JavaScript name: <code>plotOptions-abands-dataSorting</code>
  */
class PlotOptionsAbandsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAbandsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsDataSorting {
