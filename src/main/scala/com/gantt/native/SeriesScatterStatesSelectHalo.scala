...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-states-select-halo</code>
  */
class SeriesScatterStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesScatterStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterStatesSelectHalo {
