...
/**
  * @note JavaScript name: <code>plotOptions-cmo-dataSorting</code>
  */
class PlotOptionsCmoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsCmoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCmoDataSorting {
