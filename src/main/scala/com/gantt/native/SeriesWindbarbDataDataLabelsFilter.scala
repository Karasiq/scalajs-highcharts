...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-data-dataLabels-filter</code>
  */
class SeriesWindbarbDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWindbarbDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataDataLabelsFilter {
