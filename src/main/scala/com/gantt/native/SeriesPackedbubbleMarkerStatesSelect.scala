...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-marker-states-select</code>
  */
class SeriesPackedbubbleMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleMarkerStatesSelect {
