...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-dataLabels-filter</code>
  */
class PlotOptionsChaikinDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinDataLabelsFilter {
