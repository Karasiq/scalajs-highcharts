...
/**
  * @note JavaScript name: <code>navigator-xAxis-plotBands-events</code>
  */
class NavigatorXAxisPlotBandsEvents extends com.highcharts.HighchartsGenericObject {
...
object NavigatorXAxisPlotBandsEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): NavigatorXAxisPlotBandsEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorXAxisPlotBandsEvents {
      this.click = click
