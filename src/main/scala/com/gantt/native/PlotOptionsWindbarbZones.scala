...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-zones</code>
  */
class PlotOptionsWindbarbZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWindbarbZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbZones {
