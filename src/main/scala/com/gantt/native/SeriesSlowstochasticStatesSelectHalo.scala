...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-states-select-halo</code>
  */
class SeriesSlowstochasticStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticStatesSelectHalo {
