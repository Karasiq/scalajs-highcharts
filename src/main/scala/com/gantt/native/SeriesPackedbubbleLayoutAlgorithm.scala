...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-layoutAlgorithm</code>
  */
class SeriesPackedbubbleLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var parentNodeOptions: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithmParentNodeOptions]] = js.undefined
...
object SeriesPackedbubbleLayoutAlgorithm {
  /**
    ...
    */
  def apply(bubblePadding: js.UndefOr[Double] = js.undefined, dragBetweenSeries: js.UndefOr[Boolean] = js.undefined, enableSimulation: js.UndefOr[Boolean] = js.undefined, friction: js.UndefOr[Double] = js.undefined, gravitationalConstant: js.UndefOr[Double] = js.undefined, initialPositionRadius: js.UndefOr[Double] = js.undefined, initialPositions: js.UndefOr[String | js.Function] = js.undefined, maxIterations: js.UndefOr[Double] = js.undefined, maxSpeed: js.UndefOr[Double] = js.undefined, parentNodeLimit: js.UndefOr[Boolean] = js.undefined, parentNodeOptions: js.UndefOr[CleanJsObject[SeriesPackedbubbleLayoutAlgorithmParentNodeOptions]] = js.undefined, seriesInteraction: js.UndefOr[Boolean] = js.undefined, splitSeries: js.UndefOr[String] = js.undefined, integration: js.UndefOr[String] = js.undefined, linkLength: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String] = "reingold-fruchterman"): SeriesPackedbubbleLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleLayoutAlgorithm {
