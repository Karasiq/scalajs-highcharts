...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-states-hover-halo</code>
  */
class SeriesLollipopStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLollipopStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopStatesHoverHalo {
