...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-lastPrice-label</code>
  */
class SeriesBoxplotLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotLastPriceLabel {
  /**
