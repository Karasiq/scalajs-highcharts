...
/**
  * @note JavaScript name: <code>plotOptions-momentum-dataLabels-animation</code>
  */
class PlotOptionsMomentumDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMomentumDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumDataLabelsAnimation {
      this.defer = defer
    })
  }
}
