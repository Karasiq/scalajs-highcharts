...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-data-accessibility</code>
  */
class SeriesHollowcandlestickDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesHollowcandlestickDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataAccessibility {
