...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-states-inactive</code>
  */
class SeriesOrganizationStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesOrganizationStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationStatesInactive {
