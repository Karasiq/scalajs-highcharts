...
/**
  * @note JavaScript name: <code>navigator-series-dataLabels-animation</code>
  */
class NavigatorSeriesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object NavigatorSeriesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): NavigatorSeriesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new NavigatorSeriesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
