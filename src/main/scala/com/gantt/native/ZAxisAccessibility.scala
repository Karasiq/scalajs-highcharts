...
/**
  * @note JavaScript name: <code>zAxis-accessibility</code>
  */
class ZAxisAccessibility extends com.highcharts.HighchartsGenericObject {
...
object ZAxisAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, rangeDescription: js.UndefOr[String] = js.undefined): ZAxisAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ZAxisAccessibility {
