...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-accessibility</code>
  */
class SeriesColumnrangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesColumnrangeAccessibilityPoint]] = js.undefined
}

object SeriesColumnrangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesColumnrangeAccessibilityPoint]] = js.undefined): SeriesColumnrangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnrangeAccessibility {
