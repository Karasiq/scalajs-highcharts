...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-states-select-halo</code>
  */
class SeriesHollowcandlestickStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesHollowcandlestickStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickStatesSelectHalo {
