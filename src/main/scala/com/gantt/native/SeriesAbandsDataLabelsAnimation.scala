...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-dataLabels-animation</code>
  */
class SeriesAbandsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesAbandsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
