...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-lastPrice-label</code>
  */
class SeriesPivotpointsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsLastPriceLabel {
  /**
