...
/**
  * @note JavaScript name: <code>plotOptions-aroon-dataLabels-filter</code>
  */
class PlotOptionsAroonDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAroonDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonDataLabelsFilter {
