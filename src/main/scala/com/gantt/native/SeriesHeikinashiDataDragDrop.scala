...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-dragDrop</code>
  */
class SeriesHeikinashiDataDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataDragDrop {
  /**
