...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-states</code>
  */
class SeriesOrganizationStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesOrganizationStatesSelect]] = js.undefined
...
object SeriesOrganizationStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesOrganizationStatesSelect]] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesOrganizationStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationStates {
      this.hover = hover
