...
/**
  * @note JavaScript name: <code>plotOptions-ema-states-select-halo</code>
  */
class PlotOptionsEmaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsEmaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsEmaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsEmaStatesSelectHalo {
