...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-dataGrouping</code>
  */
class SeriesAoDataGrouping extends com.highcharts.HighchartsGenericObject {
