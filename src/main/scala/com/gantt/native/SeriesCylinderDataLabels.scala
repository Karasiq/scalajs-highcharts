...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dataLabels</code>
  */
class SeriesCylinderDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataLabels {
  /**
