...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-dataLabels-filter</code>
  */
class SeriesSplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSplineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataLabelsFilter {
