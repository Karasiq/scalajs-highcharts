...
/**
  * @note JavaScript name: <code>plotOptions-polygon-dataLabels-animation</code>
  */
class PlotOptionsPolygonDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPolygonDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPolygonDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonDataLabelsAnimation {
      this.defer = defer
    })
  }
}
