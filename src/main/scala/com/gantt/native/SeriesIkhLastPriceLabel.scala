...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-lastPrice-label</code>
  */
class SeriesIkhLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhLastPriceLabel {
  /**
