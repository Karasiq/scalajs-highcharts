...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-dataSorting</code>
  */
class SeriesStochasticDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesStochasticDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticDataSorting {
