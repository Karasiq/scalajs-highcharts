...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-data-dataLabels-filter</code>
  */
class SeriesCandlestickDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCandlestickDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataDataLabelsFilter {
