...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-zones</code>
  */
class SeriesPyramidZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPyramidZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidZones {
