...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-data-dataLabels</code>
  */
class SeriesGaugeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataDataLabels {
  /**
