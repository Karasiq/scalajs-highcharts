...
class SeriesAreasplineStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesAreasplineStatesSelect]] = js.undefined
}
...
object SeriesAreasplineStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesAreasplineStatesSelect]] = js.undefined): SeriesAreasplineStates = {
