...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-accessibility</code>
  */
class SeriesFunnelAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesFunnelAccessibilityPoint]] = js.undefined
}

object SeriesFunnelAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesFunnelAccessibilityPoint]] = js.undefined): SeriesFunnelAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelAccessibility {
