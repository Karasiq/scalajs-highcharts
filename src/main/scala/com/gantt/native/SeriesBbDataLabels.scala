...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-dataLabels</code>
  */
class SeriesBbDataLabels extends com.highcharts.HighchartsGenericObject {
