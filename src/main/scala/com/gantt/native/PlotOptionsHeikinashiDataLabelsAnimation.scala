...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-dataLabels-animation</code>
  */
class PlotOptionsHeikinashiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsHeikinashiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
