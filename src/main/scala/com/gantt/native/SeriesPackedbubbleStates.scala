...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states</code>
  */
class SeriesPackedbubbleStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesSelect]] = js.undefined
}

object SeriesPackedbubbleStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesPackedbubbleStatesSelect]] = js.undefined): SeriesPackedbubbleStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStates {
      this.hover = hover
