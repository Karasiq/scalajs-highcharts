...
/**
  * @note JavaScript name: <code>plotOptions-item-dataLabels-filter</code>
  */
class PlotOptionsItemDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsItemDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemDataLabelsFilter {
