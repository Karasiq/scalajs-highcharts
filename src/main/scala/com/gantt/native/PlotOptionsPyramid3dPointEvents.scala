...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-point-events</code>
  */
class PlotOptionsPyramid3dPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsPyramid3dPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dPointEvents {
      this.click = click
      this.drag = drag
