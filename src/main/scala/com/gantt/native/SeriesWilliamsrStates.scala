...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-states</code>
  */
class SeriesWilliamsrStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesWilliamsrStatesSelect]] = js.undefined
}

object SeriesWilliamsrStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesWilliamsrStatesSelect]] = js.undefined): SeriesWilliamsrStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrStates {
      this.hover = hover
