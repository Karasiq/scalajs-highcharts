...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-params</code>
  */
class SeriesTrixParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesTrixParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixParams {
      this.index = index
      this.period = period
    })
  }
