...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-lastPrice-label</code>
  */
class SeriesAbandsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsLastPriceLabel {
  /**
