...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-accessibility-point</code>
  */
class SeriesHollowcandlestickAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesHollowcandlestickAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickAccessibilityPoint {
