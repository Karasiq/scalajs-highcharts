...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-dataGrouping</code>
  */
class PlotOptionsScatter3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dDataGrouping {
  /**
