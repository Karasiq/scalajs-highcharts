...
/**
  ...
  */
class SeriesHeatmapZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHeatmapZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapZones {
