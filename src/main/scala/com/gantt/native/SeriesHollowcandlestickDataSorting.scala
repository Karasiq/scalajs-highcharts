...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-dataSorting</code>
  */
class SeriesHollowcandlestickDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesHollowcandlestickDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickDataSorting {
