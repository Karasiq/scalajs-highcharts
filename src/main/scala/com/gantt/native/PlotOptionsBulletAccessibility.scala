...
/**
  * @note JavaScript name: <code>plotOptions-bullet-accessibility</code>
  */
class PlotOptionsBulletAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsBulletAccessibilityPoint]] = js.undefined
}

object PlotOptionsBulletAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsBulletAccessibilityPoint]] = js.undefined): PlotOptionsBulletAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletAccessibility {
