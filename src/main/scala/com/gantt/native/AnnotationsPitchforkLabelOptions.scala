...
/**
  * @note JavaScript name: <code>annotations-pitchfork-labelOptions</code>
  */
class AnnotationsPitchforkLabelOptions extends com.highcharts.HighchartsGenericObject {
