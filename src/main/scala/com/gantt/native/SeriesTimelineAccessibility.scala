...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-accessibility</code>
  */
class SeriesTimelineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTimelineAccessibilityPoint]] = js.undefined
}

object SeriesTimelineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTimelineAccessibilityPoint]] = js.undefined): SeriesTimelineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineAccessibility {
