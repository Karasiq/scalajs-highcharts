...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dataLabels-filter</code>
  */
class SeriesItemDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesItemDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataLabelsFilter {
