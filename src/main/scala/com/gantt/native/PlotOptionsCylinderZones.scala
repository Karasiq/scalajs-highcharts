...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-zones</code>
  */
class PlotOptionsCylinderZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCylinderZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCylinderZones {
