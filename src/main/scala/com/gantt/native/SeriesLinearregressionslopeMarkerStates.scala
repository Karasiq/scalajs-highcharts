...
/**
  * @note JavaScript name: <code>series&lt;linearregressionslope&gt;-marker-states</code>
  */
class SeriesLinearregressionslopeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionslopeMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesLinearregressionslopeMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionslopeMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
