...
/**
  * @note JavaScript name: <code>plotOptions-klinger-dataGrouping</code>
  */
class PlotOptionsKlingerDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerDataGrouping {
  /**
