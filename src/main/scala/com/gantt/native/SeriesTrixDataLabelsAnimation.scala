...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-dataLabels-animation</code>
  */
class SeriesTrixDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTrixDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixDataLabelsAnimation {
      this.defer = defer
    })
  }
}
