...
/**
  ...
  */
class SeriesHeatmapStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesHeatmapStatesSelect]] = js.undefined
}
...
object SeriesHeatmapStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesHeatmapStatesSelect]] = js.undefined): SeriesHeatmapStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapStates {
      this.hover = hover
