...
/**
  ...
  */
class XAxisCrosshair extends com.highcharts.HighchartsGenericObject {
...
object XAxisCrosshair {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[js.Any] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, snap: js.UndefOr[Boolean] = js.undefined, width: js.UndefOr[Double] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): XAxisCrosshair = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisCrosshair {
