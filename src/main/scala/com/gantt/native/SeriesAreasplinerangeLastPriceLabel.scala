...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-lastPrice-label</code>
  */
class SeriesAreasplinerangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeLastPriceLabel {
  /**
