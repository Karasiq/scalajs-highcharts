...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-dataGrouping</code>
  */
class SeriesFunnelDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataGrouping {
  /**
