...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-states-inactive</code>
  */
class SeriesPcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcStatesInactive {
