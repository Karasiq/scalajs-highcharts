...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-dataLabels-filter</code>
  */
class SeriesPivotpointsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPivotpointsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsDataLabelsFilter {
