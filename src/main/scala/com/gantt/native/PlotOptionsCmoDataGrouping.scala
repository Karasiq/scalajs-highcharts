...
/**
  * @note JavaScript name: <code>plotOptions-cmo-dataGrouping</code>
  */
class PlotOptionsCmoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCmoDataGrouping {
  /**
