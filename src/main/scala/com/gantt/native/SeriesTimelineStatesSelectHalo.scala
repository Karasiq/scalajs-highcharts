...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-states-select-halo</code>
  */
class SeriesTimelineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTimelineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineStatesSelectHalo {
