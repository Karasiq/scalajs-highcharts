...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-states-inactive</code>
  */
class SeriesErrorbarStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesErrorbarStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarStatesInactive {
