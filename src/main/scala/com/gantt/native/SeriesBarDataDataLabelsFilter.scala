...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-data-dataLabels-filter</code>
  */
class SeriesBarDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBarDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataDataLabelsFilter {
