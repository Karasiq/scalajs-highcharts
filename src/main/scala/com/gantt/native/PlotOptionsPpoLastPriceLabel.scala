...
/**
  * @note JavaScript name: <code>plotOptions-ppo-lastPrice-label</code>
  */
class PlotOptionsPpoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoLastPriceLabel {
  /**
