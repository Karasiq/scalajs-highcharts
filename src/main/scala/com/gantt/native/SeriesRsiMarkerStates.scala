...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-marker-states</code>
  */
class SeriesRsiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesRsiMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
