...
/**
  * @note JavaScript name: <code>plotOptions-map-dataSorting</code>
  */
class PlotOptionsMapDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMapDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapDataSorting {
