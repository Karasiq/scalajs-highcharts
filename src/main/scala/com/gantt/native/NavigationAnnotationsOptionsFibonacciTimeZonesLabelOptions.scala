...
/**
  * @note JavaScript name: <code>navigation-annotationsOptions-fibonacciTimeZones-labelOptions</code>
  */
class NavigationAnnotationsOptionsFibonacciTimeZonesLabelOptions extends com.highcharts.HighchartsGenericObject {
...
object NavigationAnnotationsOptionsFibonacciTimeZonesLabelOptions {
  /**
