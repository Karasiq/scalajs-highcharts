...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-dataLabels</code>
  */
class SeriesPackedbubbleDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataLabels {
  /**
