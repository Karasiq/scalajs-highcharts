...
/**
  * @note JavaScript name: <code>series&lt;bar&gt;-data-dataLabels-animation</code>
  */
class SeriesBarDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBarDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBarDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBarDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
