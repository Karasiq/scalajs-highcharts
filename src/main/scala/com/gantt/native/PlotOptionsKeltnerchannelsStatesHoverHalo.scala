...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-states-hover-halo</code>
  */
class PlotOptionsKeltnerchannelsStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsKeltnerchannelsStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsStatesHoverHalo {
