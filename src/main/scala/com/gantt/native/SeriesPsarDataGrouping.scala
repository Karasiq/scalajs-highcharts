...
/**
  * @note JavaScript name: <code>series&lt;psar&gt;-dataGrouping</code>
  */
class SeriesPsarDataGrouping extends com.highcharts.HighchartsGenericObject {
