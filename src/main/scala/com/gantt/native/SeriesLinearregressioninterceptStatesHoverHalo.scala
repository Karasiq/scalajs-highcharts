...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-states-hover-halo</code>
  */
class SeriesLinearregressioninterceptStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressioninterceptStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressioninterceptStatesHoverHalo {
