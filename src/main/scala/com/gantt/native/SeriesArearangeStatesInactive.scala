...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-states-inactive</code>
  */
class SeriesArearangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesArearangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeStatesInactive {
