...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dataGrouping</code>
  */
class SeriesHeikinashiDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataGrouping {
  /**
