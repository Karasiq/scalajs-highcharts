...
/**
  * @note JavaScript name: <code>series&lt;columnrange&gt;-data-dataLabels</code>
  */
class SeriesColumnrangeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnrangeDataDataLabels {
  /**
