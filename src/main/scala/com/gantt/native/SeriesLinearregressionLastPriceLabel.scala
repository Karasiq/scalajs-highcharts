...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-lastPrice-label</code>
  */
class SeriesLinearregressionLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionLastPriceLabel {
  /**
