...
class SeriesRocStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesRocStatesSelect]] = js.undefined
}
...
object SeriesRocStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesRocStatesSelect]] = js.undefined): SeriesRocStates = {
