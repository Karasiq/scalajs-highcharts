...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-dataLabels-animation</code>
  */
class PlotOptionsWilliamsrDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrDataLabelsAnimation {
      this.defer = defer
    })
  }
}
