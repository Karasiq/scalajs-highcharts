...
/**
  * @note JavaScript name: <code>series&lt;ikh&gt;-accessibility-point</code>
  */
class SeriesIkhAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesIkhAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesIkhAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesIkhAccessibilityPoint {
