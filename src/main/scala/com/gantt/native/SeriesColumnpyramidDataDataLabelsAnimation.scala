...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-data-dataLabels-animation</code>
  */
class SeriesColumnpyramidDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
