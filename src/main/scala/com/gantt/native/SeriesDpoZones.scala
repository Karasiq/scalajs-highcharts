...
/**
  * @note JavaScript name: <code>series&lt;dpo&gt;-zones</code>
  */
class SeriesDpoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesDpoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDpoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDpoZones {
