...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-data-accessibility</code>
  */
class SeriesVariwideDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVariwideDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideDataAccessibility {
