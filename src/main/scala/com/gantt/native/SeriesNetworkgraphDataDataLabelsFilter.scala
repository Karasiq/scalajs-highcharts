...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-data-dataLabels-filter</code>
  */
class SeriesNetworkgraphDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesNetworkgraphDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphDataDataLabelsFilter {
