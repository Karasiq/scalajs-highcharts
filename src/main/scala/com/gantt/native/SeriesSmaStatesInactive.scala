...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-states-inactive</code>
  */
class SeriesSmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesSmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaStatesInactive {
