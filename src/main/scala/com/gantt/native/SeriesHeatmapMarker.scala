...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-marker</code>
  */
class SeriesHeatmapMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapMarker {
  /**
    ...
    */
  def apply(states: js.UndefOr[js.Any] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesHeatmapMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapMarker {
      this.states = states
