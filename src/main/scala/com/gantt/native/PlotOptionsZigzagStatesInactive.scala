...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-states-inactive</code>
  */
class PlotOptionsZigzagStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsZigzagStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsZigzagStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsZigzagStatesInactive {
