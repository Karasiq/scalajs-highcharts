...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-data-accessibility</code>
  */
class SeriesPieDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesPieDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieDataAccessibility {
