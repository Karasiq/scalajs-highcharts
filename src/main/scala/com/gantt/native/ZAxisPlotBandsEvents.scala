...
/**
  * @note JavaScript name: <code>zAxis-plotBands-events</code>
  */
class ZAxisPlotBandsEvents extends com.highcharts.HighchartsGenericObject {
...
object ZAxisPlotBandsEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): ZAxisPlotBandsEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new ZAxisPlotBandsEvents {
      this.click = click
