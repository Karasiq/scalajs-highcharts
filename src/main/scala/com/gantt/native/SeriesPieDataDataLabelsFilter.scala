...
/**
  * @note JavaScript name: <code>series&lt;pie&gt;-data-dataLabels-filter</code>
  */
class SeriesPieDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPieDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPieDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPieDataDataLabelsFilter {
