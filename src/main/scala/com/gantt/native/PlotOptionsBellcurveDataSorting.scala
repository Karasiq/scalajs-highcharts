...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-dataSorting</code>
  */
class PlotOptionsBellcurveDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsBellcurveDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveDataSorting {
