...
/**
  * @note JavaScript name: <code>xAxis-plotBands-events</code>
  */
class XAxisPlotBandsEvents extends com.highcharts.HighchartsGenericObject {
...
object XAxisPlotBandsEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, mousemove: js.UndefOr[js.Any] = js.undefined, mouseout: js.UndefOr[js.Any] = js.undefined, mouseover: js.UndefOr[js.Any] = js.undefined): XAxisPlotBandsEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new XAxisPlotBandsEvents {
      this.click = click
