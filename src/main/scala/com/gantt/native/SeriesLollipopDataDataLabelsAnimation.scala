...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-data-dataLabels-animation</code>
  */
class SeriesLollipopDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesLollipopDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
