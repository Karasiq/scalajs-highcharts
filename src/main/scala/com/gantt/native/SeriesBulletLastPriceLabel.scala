...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-lastPrice-label</code>
  */
class SeriesBulletLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletLastPriceLabel {
  /**
