...
/**
  * @note JavaScript name: <code>plotOptions-zigzag-accessibility</code>
  */
class PlotOptionsZigzagAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsZigzagAccessibilityPoint]] = js.undefined
}

object PlotOptionsZigzagAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsZigzagAccessibilityPoint]] = js.undefined): PlotOptionsZigzagAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsZigzagAccessibility {
