...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-point-events</code>
  */
class SeriesDumbbellPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesDumbbellPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellPointEvents {
      this.click = click
      this.drag = drag
