...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-lastPrice-label</code>
  */
class SeriesPyramidLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidLastPriceLabel {
  /**
