...
/**
  * @note JavaScript name: <code>plotOptions-ao-dataGrouping</code>
  */
class PlotOptionsAoDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoDataGrouping {
  /**
