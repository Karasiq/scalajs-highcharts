...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-dragDrop</code>
  */
class SeriesAroonDragDrop extends com.highcharts.HighchartsGenericObject {
