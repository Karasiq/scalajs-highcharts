...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-data-dataLabels-animation</code>
  */
class SeriesSankeyDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSankeyDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
