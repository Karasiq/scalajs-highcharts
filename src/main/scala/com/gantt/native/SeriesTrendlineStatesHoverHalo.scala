...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-states-hover-halo</code>
  */
class SeriesTrendlineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTrendlineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineStatesHoverHalo {
