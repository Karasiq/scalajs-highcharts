...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-marker-states</code>
  */
class PlotOptionsPackedbubbleMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsPackedbubbleMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPackedbubbleMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
