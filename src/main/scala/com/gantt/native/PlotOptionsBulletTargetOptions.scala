...
/**
  * @note JavaScript name: <code>plotOptions-bullet-targetOptions</code>
  */
class PlotOptionsBulletTargetOptions extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletTargetOptions {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, height: js.UndefOr[Double] = js.undefined, width: js.UndefOr[Double | String] = js.undefined): PlotOptionsBulletTargetOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletTargetOptions {
