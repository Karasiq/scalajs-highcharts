...
/**
  * @note JavaScript name: <code>plotOptions-arearange-lastPrice-label</code>
  */
class PlotOptionsArearangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeLastPriceLabel {
  /**
