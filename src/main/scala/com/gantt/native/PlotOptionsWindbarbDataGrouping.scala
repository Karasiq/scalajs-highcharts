...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-dataGrouping</code>
  */
class PlotOptionsWindbarbDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbDataGrouping {
  /**
