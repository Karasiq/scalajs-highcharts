...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-states-select</code>
  */
class SeriesFunnel3dStatesSelect extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 7.1.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesFunnel3dStatesSelectMarker]] = js.undefined
}

object SeriesFunnel3dStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesFunnel3dStatesSelectMarker]] = js.undefined): SeriesFunnel3dStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dStatesSelect {
