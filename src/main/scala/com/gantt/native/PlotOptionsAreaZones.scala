...
/**
  * @note JavaScript name: <code>plotOptions-area-zones</code>
  */
class PlotOptionsAreaZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAreaZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaZones {
