...
/**
  * @note JavaScript name: <code>plotOptions-ao-dataSorting</code>
  */
class PlotOptionsAoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoDataSorting {
