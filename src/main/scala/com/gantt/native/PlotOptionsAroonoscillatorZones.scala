...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-zones</code>
  */
class PlotOptionsAroonoscillatorZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAroonoscillatorZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorZones {
