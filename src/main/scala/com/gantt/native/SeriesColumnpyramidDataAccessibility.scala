...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-data-accessibility</code>
  */
class SeriesColumnpyramidDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesColumnpyramidDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataAccessibility {
