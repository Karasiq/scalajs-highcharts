...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-data-dataLabels-animation</code>
  */
class SeriesWordcloudDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesWordcloudDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
