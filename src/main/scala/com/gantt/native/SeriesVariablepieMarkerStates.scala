...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-marker-states</code>
  */
class SeriesVariablepieMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVariablepieMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
