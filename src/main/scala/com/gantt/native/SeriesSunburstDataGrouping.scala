...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-dataGrouping</code>
  */
class SeriesSunburstDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataGrouping {
  /**
