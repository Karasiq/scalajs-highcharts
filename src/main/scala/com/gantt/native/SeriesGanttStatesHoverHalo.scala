...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-states-hover-halo</code>
  */
class SeriesGanttStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesGanttStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttStatesHoverHalo {
