...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-lastPrice-label</code>
  */
class SeriesTimelineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineLastPriceLabel {
  /**
