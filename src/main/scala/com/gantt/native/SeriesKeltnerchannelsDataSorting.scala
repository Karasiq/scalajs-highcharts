...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dataSorting</code>
  */
class SeriesKeltnerchannelsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesKeltnerchannelsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsDataSorting {
