...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-lastPrice-label</code>
  */
class SeriesErrorbarLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarLastPriceLabel {
  /**
