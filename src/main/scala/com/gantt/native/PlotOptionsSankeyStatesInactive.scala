...
/**
  * @note JavaScript name: <code>plotOptions-sankey-states-inactive</code>
  */
class PlotOptionsSankeyStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSankeyStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyStatesInactive {
