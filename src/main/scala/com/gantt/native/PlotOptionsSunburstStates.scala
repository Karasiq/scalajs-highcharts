...
class PlotOptionsSunburstStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsSunburstStatesSelect]] = js.undefined
}
...
object PlotOptionsSunburstStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsSunburstStatesSelect]] = js.undefined): PlotOptionsSunburstStates = {
