...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-accessibility</code>
  */
class PlotOptionsSunburstAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSunburstAccessibilityPoint]] = js.undefined
}

object PlotOptionsSunburstAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSunburstAccessibilityPoint]] = js.undefined): PlotOptionsSunburstAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstAccessibility {
