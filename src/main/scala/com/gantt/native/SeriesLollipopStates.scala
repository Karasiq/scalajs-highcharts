...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-states</code>
  */
class SeriesLollipopStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesLollipopStatesSelect]] = js.undefined
}

object SeriesLollipopStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesLollipopStatesSelect]] = js.undefined): SeriesLollipopStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLollipopStates {
      this.hover = hover
