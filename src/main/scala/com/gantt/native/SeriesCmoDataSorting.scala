...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dataSorting</code>
  */
class SeriesCmoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesCmoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoDataSorting {
