...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-data-dataLabels-filter</code>
  */
class SeriesSunburstDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSunburstDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSunburstDataDataLabelsFilter {
