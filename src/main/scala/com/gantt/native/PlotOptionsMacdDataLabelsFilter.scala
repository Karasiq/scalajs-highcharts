...
/**
  * @note JavaScript name: <code>plotOptions-macd-dataLabels-filter</code>
  */
class PlotOptionsMacdDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMacdDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdDataLabelsFilter {
