...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-lastPrice-label</code>
  */
class SeriesSupertrendLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendLastPriceLabel {
  /**
