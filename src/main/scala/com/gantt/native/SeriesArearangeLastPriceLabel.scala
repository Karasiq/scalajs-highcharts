...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-lastPrice-label</code>
  */
class SeriesArearangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeLastPriceLabel {
  /**
