...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-marker-states-select</code>
  */
class SeriesSmaMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesSmaMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaMarkerStatesSelect {
