...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-states-inactive</code>
  */
class SeriesNatrStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesNatrStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrStatesInactive {
