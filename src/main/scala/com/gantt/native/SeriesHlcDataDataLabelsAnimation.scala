...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-data-dataLabels-animation</code>
  */
class SeriesHlcDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHlcDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
