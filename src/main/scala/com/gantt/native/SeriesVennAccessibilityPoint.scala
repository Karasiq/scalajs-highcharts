...
/**
  * @note JavaScript name: <code>series&lt;venn&gt;-accessibility-point</code>
  */
class SeriesVennAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVennAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVennAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVennAccessibilityPoint {
