...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-marker-states</code>
  */
class PlotOptionsChaikinMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsChaikinMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
