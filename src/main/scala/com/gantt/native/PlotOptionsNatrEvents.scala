...
/**
  * @note JavaScript name: <code>plotOptions-natr-events</code>
  */
class PlotOptionsNatrEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsNatrEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrEvents {
