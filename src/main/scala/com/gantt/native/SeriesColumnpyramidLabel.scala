...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-label</code>
  */
class SeriesColumnpyramidLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidLabel {
  /**
