...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dataGrouping</code>
  */
class SeriesDmiDataGrouping extends com.highcharts.HighchartsGenericObject {
