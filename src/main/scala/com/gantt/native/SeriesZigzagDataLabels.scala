...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-dataLabels</code>
  */
class SeriesZigzagDataLabels extends com.highcharts.HighchartsGenericObject {
