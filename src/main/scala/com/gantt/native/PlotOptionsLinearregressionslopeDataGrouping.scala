...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionslope-dataGrouping</code>
  */
class PlotOptionsLinearregressionslopeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionslopeDataGrouping {
  /**
