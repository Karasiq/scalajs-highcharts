...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-marker-states</code>
  */
class PlotOptionsNetworkgraphMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNetworkgraphMarkerStates {
  /**
    ...
    */
  def apply(inactive: js.UndefOr[js.Any] = js.undefined, hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsNetworkgraphMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphMarkerStates {
