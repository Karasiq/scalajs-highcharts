...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dragDrop</code>
  */
class SeriesDisparityindexDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDragDrop {
  /**
