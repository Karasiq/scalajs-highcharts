...
/**
  * @note JavaScript name: <code>plotOptions-column-dataLabels-animation</code>
  */
class PlotOptionsColumnDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsColumnDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnDataLabelsAnimation {
      this.defer = defer
    })
  }
}
