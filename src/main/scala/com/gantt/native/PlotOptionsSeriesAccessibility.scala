...
/**
  * @note JavaScript name: <code>plotOptions-series-accessibility</code>
  */
class PlotOptionsSeriesAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsSeriesAccessibilityPoint]] = js.undefined
}

object PlotOptionsSeriesAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsSeriesAccessibilityPoint]] = js.undefined): PlotOptionsSeriesAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSeriesAccessibility {
