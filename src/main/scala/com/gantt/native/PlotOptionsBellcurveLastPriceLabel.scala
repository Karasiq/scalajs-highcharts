...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-lastPrice-label</code>
  */
class PlotOptionsBellcurveLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveLastPriceLabel {
  /**
