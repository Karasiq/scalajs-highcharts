...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dataSorting</code>
  */
class SeriesNatrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesNatrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrDataSorting {
