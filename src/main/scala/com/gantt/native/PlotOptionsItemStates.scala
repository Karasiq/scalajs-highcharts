...
/**
  * @note JavaScript name: <code>plotOptions-item-states</code>
  */
class PlotOptionsItemStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsItemStatesSelect]] = js.undefined
}

object PlotOptionsItemStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsItemStatesSelect]] = js.undefined): PlotOptionsItemStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemStates {
      this.hover = hover
