...
/**
  * @note JavaScript name: <code>plotOptions-dpo-dataLabels-filter</code>
  */
class PlotOptionsDpoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDpoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoDataLabelsFilter {
