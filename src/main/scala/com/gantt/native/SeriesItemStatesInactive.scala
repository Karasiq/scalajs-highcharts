...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-states-inactive</code>
  */
class SeriesItemStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesItemStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemStatesInactive {
