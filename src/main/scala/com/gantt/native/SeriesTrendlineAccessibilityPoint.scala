...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-accessibility-point</code>
  */
class SeriesTrendlineAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesTrendlineAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineAccessibilityPoint {
