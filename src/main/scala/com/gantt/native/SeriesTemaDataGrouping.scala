...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dataGrouping</code>
  */
class SeriesTemaDataGrouping extends com.highcharts.HighchartsGenericObject {
