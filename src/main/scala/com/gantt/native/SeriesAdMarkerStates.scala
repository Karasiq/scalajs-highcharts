...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-marker-states</code>
  */
class SeriesAdMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesAdMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesAdMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAdMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
