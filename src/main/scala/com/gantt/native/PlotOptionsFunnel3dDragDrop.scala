...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-dragDrop</code>
  */
class PlotOptionsFunnel3dDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dDragDrop {
  /**
