...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-accessibility-point</code>
  */
class SeriesFunnelAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesFunnelAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelAccessibilityPoint {
