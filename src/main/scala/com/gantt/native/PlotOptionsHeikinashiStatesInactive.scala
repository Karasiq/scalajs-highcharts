...
/**
  * @note JavaScript name: <code>plotOptions-heikinashi-states-inactive</code>
  */
class PlotOptionsHeikinashiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeikinashiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsHeikinashiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeikinashiStatesInactive {
