...
/**
  * @note JavaScript name: <code>plotOptions-pc-dataSorting</code>
  */
class PlotOptionsPcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPcDataSorting {
