...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-data-dataLabels-animation</code>
  */
class SeriesSolidgaugeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSolidgaugeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
