...
/**
  * @note JavaScript name: <code>plotOptions-cci-accessibility-point</code>
  */
class PlotOptionsCciAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCciAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): PlotOptionsCciAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCciAccessibilityPoint {
