...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-dataLabels-animation</code>
  */
class SeriesColumnpyramidDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidDataLabelsAnimation {
      this.defer = defer
    })
  }
}
