...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-dataLabels</code>
  */
class SeriesCciDataLabels extends com.highcharts.HighchartsGenericObject {
