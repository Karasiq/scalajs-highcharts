...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-states-select-halo</code>
  */
class SeriesDmiStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDmiStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiStatesSelectHalo {
