...
/**
  * @note JavaScript name: <code>plotOptions-arearange-zones</code>
  */
class PlotOptionsArearangeZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsArearangeZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeZones {
