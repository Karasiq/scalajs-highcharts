...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-states-inactive</code>
  */
class PlotOptionsSunburstStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsSunburstStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstStatesInactive {
