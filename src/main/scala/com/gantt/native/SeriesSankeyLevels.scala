...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels</code>
  */
class SeriesSankeyLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesSankeyLevelsDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var states: js.UndefOr[CleanJsObject[SeriesSankeyLevelsStates]] = js.undefined
}

object SeriesSankeyLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesSankeyLevelsDataLabels]] = js.undefined, level: js.UndefOr[Double] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[SeriesSankeyLevelsStates]] = js.undefined): SeriesSankeyLevels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevels {
