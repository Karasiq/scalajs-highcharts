...
/**
  * @note JavaScript name: <code>series&lt;funnel&gt;-data-dataLabels-animation</code>
  */
class SeriesFunnelDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnelDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesFunnelDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnelDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
