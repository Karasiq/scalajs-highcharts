...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-dataLabels-animation</code>
  */
class SeriesBellcurveDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBellcurveDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveDataLabelsAnimation {
      this.defer = defer
    })
  }
}
