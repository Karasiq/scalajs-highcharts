...
/**
  * @note JavaScript name: <code>plotOptions-vector-dataLabels</code>
  */
class PlotOptionsVectorDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorDataLabels {
  /**
