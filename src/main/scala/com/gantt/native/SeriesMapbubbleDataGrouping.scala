...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-dataGrouping</code>
  */
class SeriesMapbubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleDataGrouping {
  /**
