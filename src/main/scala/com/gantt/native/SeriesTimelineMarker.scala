...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-marker</code>
  */
class SeriesTimelineMarker extends com.highcharts.HighchartsGenericObject {
