...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-dataLabels-animation</code>
  */
class SeriesPpoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesPpoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
