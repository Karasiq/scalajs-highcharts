...
/**
  * @note JavaScript name: <code>series&lt;cci&gt;-dataGrouping</code>
  */
class SeriesCciDataGrouping extends com.highcharts.HighchartsGenericObject {
