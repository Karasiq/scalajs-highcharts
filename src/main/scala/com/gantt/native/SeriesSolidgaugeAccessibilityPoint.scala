...
/**
  * @note JavaScript name: <code>series&lt;solidgauge&gt;-accessibility-point</code>
  */
class SeriesSolidgaugeAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesSolidgaugeAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesSolidgaugeAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSolidgaugeAccessibilityPoint {
