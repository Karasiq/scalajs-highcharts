...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-states-hover-halo</code>
  */
class SeriesDependencywheelStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDependencywheelStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelStatesHoverHalo {
