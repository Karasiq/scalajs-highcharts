...
/**
  * @note JavaScript name: <code>plotOptions-sankey-levels</code>
  */
class PlotOptionsSankeyLevels extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.1.0
    */
  var dataLabels: js.UndefOr[CleanJsObject[PlotOptionsSankeyLevelsDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 7.1.0
    */
  var states: js.UndefOr[CleanJsObject[PlotOptionsSankeyLevelsStates]] = js.undefined
}

object PlotOptionsSankeyLevels {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[PlotOptionsSankeyLevelsDataLabels]] = js.undefined, level: js.UndefOr[Double] = js.undefined, linkOpacity: js.UndefOr[Double] = js.undefined, states: js.UndefOr[CleanJsObject[PlotOptionsSankeyLevelsStates]] = js.undefined): PlotOptionsSankeyLevels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSankeyLevels {
