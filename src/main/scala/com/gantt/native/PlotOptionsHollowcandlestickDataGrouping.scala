...
/**
  * @note JavaScript name: <code>plotOptions-hollowcandlestick-dataGrouping</code>
  */
class PlotOptionsHollowcandlestickDataGrouping extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * two pixels wide. Defaults to <code>5</code>.</p>
...
object PlotOptionsHollowcandlestickDataGrouping {
  /**
    ...
    */
  def apply(groupAll: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, approximation: js.UndefOr[String | js.Function] = js.undefined, anchor: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): PlotOptionsHollowcandlestickDataGrouping = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHollowcandlestickDataGrouping {
