...
/**
  * @note JavaScript name: <code>plotOptions-trix-marker</code>
  */
class PlotOptionsTrixMarker extends com.highcharts.HighchartsGenericObject {
