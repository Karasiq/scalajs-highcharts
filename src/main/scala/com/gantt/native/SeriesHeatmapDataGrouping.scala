...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-dataGrouping</code>
  */
class SeriesHeatmapDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataGrouping {
  /**
