...
/**
  * @note JavaScript name: <code>plotOptions-networkgraph-connectors</code>
  */
class PlotOptionsNetworkgraphConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphConnectorsStartMarker]] = js.undefined
...
object PlotOptionsNetworkgraphConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[PlotOptionsNetworkgraphConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): PlotOptionsNetworkgraphConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNetworkgraphConnectors {
