...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-zones</code>
  */
class PlotOptionsDumbbellZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellZones {
