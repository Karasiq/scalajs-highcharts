...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-states-hover</code>
  */
class SeriesPyramid3dStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    * @since 7.1.0
    */
  var marker: js.UndefOr[CleanJsObject[SeriesPyramid3dStatesHoverMarker]] = js.undefined
}

object SeriesPyramid3dStatesHover {
  /**
    ...
    */
  def apply(brightness: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesPyramid3dStatesHoverMarker]] = js.undefined): SeriesPyramid3dStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dStatesHover {
