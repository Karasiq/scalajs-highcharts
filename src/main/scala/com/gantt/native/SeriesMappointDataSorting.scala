...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-dataSorting</code>
  */
class SeriesMappointDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesMappointDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointDataSorting {
