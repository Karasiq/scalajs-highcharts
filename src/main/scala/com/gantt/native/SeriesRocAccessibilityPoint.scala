...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-accessibility-point</code>
  */
class SeriesRocAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesRocAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocAccessibilityPoint {
