...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-dragDrop-dragHandle</code>
  */
class PlotOptionsFunnel3dDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): PlotOptionsFunnel3dDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dDragDropDragHandle {
