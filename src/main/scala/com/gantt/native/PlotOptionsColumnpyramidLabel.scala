...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-label</code>
  */
class PlotOptionsColumnpyramidLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidLabel {
  /**
