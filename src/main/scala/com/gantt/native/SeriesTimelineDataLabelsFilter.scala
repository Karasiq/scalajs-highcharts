...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-dataLabels-filter</code>
  */
class SeriesTimelineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTimelineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataLabelsFilter {
