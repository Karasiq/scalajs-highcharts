...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-dataLabels-filter</code>
  */
class SeriesTimelineDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTimelineDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineDataDataLabelsFilter {
