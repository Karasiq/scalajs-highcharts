...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-data-dataLabels-animation</code>
  */
class SeriesArearangeDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesArearangeDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
