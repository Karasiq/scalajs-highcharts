...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-dataLabels-filter</code>
  */
class PlotOptionsDependencywheelDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDependencywheelDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelDataLabelsFilter {
