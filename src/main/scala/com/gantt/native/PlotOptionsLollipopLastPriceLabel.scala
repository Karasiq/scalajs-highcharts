...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-lastPrice-label</code>
  */
class PlotOptionsLollipopLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopLastPriceLabel {
  /**
