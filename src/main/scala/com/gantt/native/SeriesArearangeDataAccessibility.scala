...
/**
  * @note JavaScript name: <code>series&lt;arearange&gt;-data-accessibility</code>
  */
class SeriesArearangeDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesArearangeDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesArearangeDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesArearangeDataAccessibility {
