...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-marker</code>
  */
class SeriesLollipopMarker extends com.highcharts.HighchartsGenericObject {
