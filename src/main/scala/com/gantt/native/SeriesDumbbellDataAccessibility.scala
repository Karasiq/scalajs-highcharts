...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-accessibility</code>
  */
class SeriesDumbbellDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesDumbbellDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataAccessibility {
