...
/**
  * @note JavaScript name: <code>series&lt;roc&gt;-states-inactive</code>
  */
class SeriesRocStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesRocStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesRocStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRocStatesInactive {
