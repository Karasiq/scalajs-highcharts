...
/**
  * @note JavaScript name: <code>plotOptions-venn-accessibility</code>
  */
class PlotOptionsVennAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsVennAccessibilityPoint]] = js.undefined
}

object PlotOptionsVennAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsVennAccessibilityPoint]] = js.undefined): PlotOptionsVennAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVennAccessibility {
