...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-marker-states</code>
  */
class SeriesTrixMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTrixMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
