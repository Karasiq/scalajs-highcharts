...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-states-inactive</code>
  */
class SeriesScatter3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesScatter3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatter3dStatesInactive {
