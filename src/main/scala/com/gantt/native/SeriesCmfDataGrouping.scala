...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-dataGrouping</code>
  */
class SeriesCmfDataGrouping extends com.highcharts.HighchartsGenericObject {
