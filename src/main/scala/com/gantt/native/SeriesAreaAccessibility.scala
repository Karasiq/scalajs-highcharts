...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-accessibility</code>
  */
class SeriesAreaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesAreaAccessibilityPoint]] = js.undefined
}

object SeriesAreaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesAreaAccessibilityPoint]] = js.undefined): SeriesAreaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaAccessibility {
