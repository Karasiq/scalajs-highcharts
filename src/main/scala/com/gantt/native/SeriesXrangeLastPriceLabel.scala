...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-lastPrice-label</code>
  */
class SeriesXrangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeLastPriceLabel {
  /**
