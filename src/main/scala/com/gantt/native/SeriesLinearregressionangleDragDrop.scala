...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-dragDrop</code>
  */
class SeriesLinearregressionangleDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleDragDrop {
  /**
