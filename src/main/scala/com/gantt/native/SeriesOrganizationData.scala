...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-data</code>
  */
class SeriesOrganizationData extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesOrganizationDataEvents]] = js.undefined
...
object SeriesOrganizationData {
  /**
    ...
    */
  def apply(dataLabels: js.UndefOr[js.Object | js.Array[js.Object]] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, from: js.UndefOr[String] = js.undefined, outgoing: js.UndefOr[Boolean] = js.undefined, to: js.UndefOr[String] = js.undefined, weight: js.UndefOr[Double | Null] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, description: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesOrganizationDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, name: js.UndefOr[String] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined): SeriesOrganizationData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationData {
