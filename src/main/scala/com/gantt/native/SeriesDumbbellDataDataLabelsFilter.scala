...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-data-dataLabels-filter</code>
  */
class SeriesDumbbellDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDumbbellDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellDataDataLabelsFilter {
