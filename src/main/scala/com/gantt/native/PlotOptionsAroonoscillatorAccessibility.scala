...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-accessibility</code>
  */
class PlotOptionsAroonoscillatorAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAroonoscillatorAccessibilityPoint]] = js.undefined
}

object PlotOptionsAroonoscillatorAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAroonoscillatorAccessibilityPoint]] = js.undefined): PlotOptionsAroonoscillatorAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorAccessibility {
