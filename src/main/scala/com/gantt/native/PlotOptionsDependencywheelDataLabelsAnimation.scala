...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-dataLabels-animation</code>
  */
class PlotOptionsDependencywheelDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDependencywheelDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelDataLabelsAnimation {
      this.defer = defer
    })
  }
}
