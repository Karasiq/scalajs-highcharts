...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-lastPrice-label</code>
  */
class SeriesPackedbubbleLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleLastPriceLabel {
  /**
