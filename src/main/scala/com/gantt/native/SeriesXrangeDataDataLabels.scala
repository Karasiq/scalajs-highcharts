...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-data-dataLabels</code>
  */
class SeriesXrangeDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataDataLabels {
  /**
