...
/**
  * @note JavaScript name: <code>plotOptions-xrange-lastPrice-label</code>
  */
class PlotOptionsXrangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeLastPriceLabel {
  /**
