...
/**
  * @note JavaScript name: <code>plotOptions-atr-dataGrouping</code>
  */
class PlotOptionsAtrDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAtrDataGrouping {
  /**
