...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-data-dragDrop</code>
  */
class SeriesHlcDataDragDrop extends com.highcharts.HighchartsGenericObject {
