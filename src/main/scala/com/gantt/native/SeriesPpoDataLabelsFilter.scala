...
/**
  * @note JavaScript name: <code>series&lt;ppo&gt;-dataLabels-filter</code>
  */
class SeriesPpoDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPpoDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPpoDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPpoDataLabelsFilter {
