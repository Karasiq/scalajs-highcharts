...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-states-select-halo</code>
  */
class SeriesOrganizationStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesOrganizationStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationStatesSelectHalo {
