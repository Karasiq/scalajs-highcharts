...
/**
  * @note JavaScript name: <code>plotOptions-klinger-point-events</code>
  */
class PlotOptionsKlingerPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsKlingerPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerPointEvents {
      this.click = click
      this.drag = drag
