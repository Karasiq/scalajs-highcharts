...
/**
  * @note JavaScript name: <code>plotOptions-packedbubble-dataGrouping</code>
  */
class PlotOptionsPackedbubbleDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPackedbubbleDataGrouping {
  /**
