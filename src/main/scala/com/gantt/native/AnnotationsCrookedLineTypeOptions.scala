...
/**
  * @note JavaScript name: <code>annotations-crookedLine-typeOptions</code>
  */
class AnnotationsCrookedLineTypeOptions extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsCrookedLineTypeOptions {
  /**
    ...
    */
  def apply(line: js.UndefOr[js.Any] = js.undefined, points: js.UndefOr[js.Array[js.Any]] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): AnnotationsCrookedLineTypeOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsCrookedLineTypeOptions {
      this.line = line
      this.points = points
      this.xAxis = xAxis
      this.yAxis = yAxis
