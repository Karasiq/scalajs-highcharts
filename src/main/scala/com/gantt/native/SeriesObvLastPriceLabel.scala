...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-lastPrice-label</code>
  */
class SeriesObvLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvLastPriceLabel {
  /**
