...
object PlotOptionsTreemapDrillUpButtonPosition {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined): PlotOptionsTreemapDrillUpButtonPosition = {
