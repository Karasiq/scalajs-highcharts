...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-levels-dataLabels-filter</code>
  */
class PlotOptionsDependencywheelLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDependencywheelLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelLevelsDataLabelsFilter {
