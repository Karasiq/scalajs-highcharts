...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-dataSorting</code>
  */
class PlotOptionsColumnrangeDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsColumnrangeDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnrangeDataSorting {
