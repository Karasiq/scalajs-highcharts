...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dataLabels-animation</code>
  */
class PlotOptionsDumbbellDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsDumbbellDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellDataLabelsAnimation {
      this.defer = defer
    })
  }
}
