...
class SeriesSunburstStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesSunburstStatesSelect]] = js.undefined
}
...
object SeriesSunburstStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesSunburstStatesSelect]] = js.undefined): SeriesSunburstStates = {
