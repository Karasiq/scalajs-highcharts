...
/**
  * @note JavaScript name: <code>plotOptions-mapbubble-dataLabels-animation</code>
  */
class PlotOptionsMapbubbleDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMapbubbleDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsMapbubbleDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMapbubbleDataLabelsAnimation {
      this.defer = defer
    })
  }
}
