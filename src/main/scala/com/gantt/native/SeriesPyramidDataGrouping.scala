...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-dataGrouping</code>
  */
class SeriesPyramidDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidDataGrouping {
  /**
