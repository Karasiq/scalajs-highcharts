...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-dataLabels-animation</code>
  */
class SeriesGanttDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesGanttDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesGanttDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataLabelsAnimation {
      this.defer = defer
    })
  }
}
