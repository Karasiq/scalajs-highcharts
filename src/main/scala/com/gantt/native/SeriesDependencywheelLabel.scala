...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-label</code>
  */
class SeriesDependencywheelLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLabel {
  /**
