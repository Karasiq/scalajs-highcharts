...
/**
  * @note JavaScript name: <code>plotOptions-wma-dataGrouping</code>
  */
class PlotOptionsWmaDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaDataGrouping {
  /**
