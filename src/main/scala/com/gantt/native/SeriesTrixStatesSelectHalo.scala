...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-states-select-halo</code>
  */
class SeriesTrixStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTrixStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrixStatesSelectHalo {
