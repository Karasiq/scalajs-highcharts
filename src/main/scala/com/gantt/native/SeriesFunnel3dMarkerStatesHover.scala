...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-marker-states-hover</code>
  */
class SeriesFunnel3dMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesFunnel3dMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dMarkerStatesHover {
