...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-data-dataLabels-animation</code>
  */
class SeriesStreamgraphDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesStreamgraphDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
