...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-dataSorting</code>
  */
class SeriesAreaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesAreaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaDataSorting {
