...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-accessibility-point</code>
  */
class SeriesColumnAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesColumnAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnAccessibilityPoint {
