...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-dataLabels-animation</code>
  */
class SeriesScatterDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesScatterDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataLabelsAnimation {
      this.defer = defer
    })
  }
}
