...
/**
  * @note JavaScript name: <code>series&lt;wordcloud&gt;-data-dataLabels-filter</code>
  */
class SeriesWordcloudDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesWordcloudDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesWordcloudDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWordcloudDataDataLabelsFilter {
