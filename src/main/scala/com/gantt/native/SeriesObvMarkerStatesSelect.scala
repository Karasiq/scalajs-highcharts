...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-marker-states-select</code>
  */
class SeriesObvMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesObvMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvMarkerStatesSelect {
