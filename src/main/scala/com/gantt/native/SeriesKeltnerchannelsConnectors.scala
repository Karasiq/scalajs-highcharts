...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-connectors</code>
  */
class SeriesKeltnerchannelsConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsConnectorsStartMarker]] = js.undefined
...
object SeriesKeltnerchannelsConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesKeltnerchannelsConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsConnectors {
