...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-data-accessibility</code>
  */
class SeriesAreaDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesAreaDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaDataAccessibility {
