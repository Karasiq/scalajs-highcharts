...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-states-select-halo</code>
  */
class SeriesSplineStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSplineStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineStatesSelectHalo {
