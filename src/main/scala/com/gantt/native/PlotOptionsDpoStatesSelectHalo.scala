...
/**
  * @note JavaScript name: <code>plotOptions-dpo-states-select-halo</code>
  */
class PlotOptionsDpoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDpoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoStatesSelectHalo {
