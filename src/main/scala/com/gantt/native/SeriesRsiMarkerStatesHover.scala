...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-marker-states-hover</code>
  */
class SeriesRsiMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesRsiMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiMarkerStatesHover {
