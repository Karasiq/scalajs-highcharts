...
/**
  * @note JavaScript name: <code>plotOptions-bar-dataLabels-animation</code>
  */
class PlotOptionsBarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsBarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
