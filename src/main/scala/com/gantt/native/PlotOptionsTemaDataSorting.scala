...
/**
  * @note JavaScript name: <code>plotOptions-tema-dataSorting</code>
  */
class PlotOptionsTemaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsTemaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaDataSorting {
