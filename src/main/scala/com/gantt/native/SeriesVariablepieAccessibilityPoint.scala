...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-accessibility-point</code>
  */
class SeriesVariablepieAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVariablepieAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieAccessibilityPoint {
