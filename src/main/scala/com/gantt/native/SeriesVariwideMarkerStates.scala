...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-marker-states</code>
  */
class SeriesVariwideMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesVariwideMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
