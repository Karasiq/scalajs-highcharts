...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dataGrouping</code>
  */
class SeriesKeltnerchannelsDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDataGrouping {
  /**
