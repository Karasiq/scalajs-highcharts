...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-marker-states-select</code>
  */
class SeriesHlcMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesHlcMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcMarkerStatesSelect {
