...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-states-inactive</code>
  */
class SeriesDmiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDmiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiStatesInactive {
