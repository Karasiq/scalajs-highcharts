...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-dataSorting</code>
  */
class SeriesVbpDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesVbpDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesVbpDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpDataSorting {
