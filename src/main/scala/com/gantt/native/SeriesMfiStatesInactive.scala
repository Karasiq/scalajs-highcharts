...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-states-inactive</code>
  */
class SeriesMfiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMfiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMfiStatesInactive {
