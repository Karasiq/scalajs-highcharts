...
/**
  * @note JavaScript name: <code>plotOptions-aroon-states</code>
  */
class PlotOptionsAroonStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsAroonStatesSelect]] = js.undefined
}

object PlotOptionsAroonStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsAroonStatesSelect]] = js.undefined): PlotOptionsAroonStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonStates {
      this.hover = hover
