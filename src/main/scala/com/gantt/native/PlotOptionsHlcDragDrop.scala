...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dragDrop</code>
  */
class PlotOptionsHlcDragDrop extends com.highcharts.HighchartsGenericObject {
