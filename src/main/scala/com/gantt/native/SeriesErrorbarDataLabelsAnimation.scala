...
/**
  * @note JavaScript name: <code>series&lt;errorbar&gt;-dataLabels-animation</code>
  */
class SeriesErrorbarDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesErrorbarDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesErrorbarDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesErrorbarDataLabelsAnimation {
      this.defer = defer
    })
  }
}
