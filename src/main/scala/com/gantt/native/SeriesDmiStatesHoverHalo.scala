...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-states-hover-halo</code>
  */
class SeriesDmiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDmiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiStatesHoverHalo {
