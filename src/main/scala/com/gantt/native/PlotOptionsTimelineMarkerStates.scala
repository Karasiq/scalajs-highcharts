...
/**
  * @note JavaScript name: <code>plotOptions-timeline-marker-states</code>
  */
class PlotOptionsTimelineMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsTimelineMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
