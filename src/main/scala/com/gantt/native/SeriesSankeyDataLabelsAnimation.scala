...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-dataLabels-animation</code>
  */
class SeriesSankeyDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSankeyDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyDataLabelsAnimation {
      this.defer = defer
    })
  }
}
