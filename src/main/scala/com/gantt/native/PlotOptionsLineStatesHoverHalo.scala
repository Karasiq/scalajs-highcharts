...
/**
  * @note JavaScript name: <code>plotOptions-line-states-hover-halo</code>
  */
class PlotOptionsLineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineStatesHoverHalo {
