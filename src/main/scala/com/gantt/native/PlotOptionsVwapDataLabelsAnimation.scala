...
/**
  * @note JavaScript name: <code>plotOptions-vwap-dataLabels-animation</code>
  */
class PlotOptionsVwapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsVwapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVwapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
