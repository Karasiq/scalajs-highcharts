...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-dataLabels-filter</code>
  */
class SeriesAreasplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreasplineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineDataLabelsFilter {
