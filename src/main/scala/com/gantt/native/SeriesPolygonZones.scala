...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-zones</code>
  */
class SeriesPolygonZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPolygonZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonZones {
