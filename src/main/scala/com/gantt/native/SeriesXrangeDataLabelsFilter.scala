...
/**
  * @note JavaScript name: <code>series&lt;xrange&gt;-dataLabels-filter</code>
  */
class SeriesXrangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesXrangeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesXrangeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesXrangeDataLabelsFilter {
