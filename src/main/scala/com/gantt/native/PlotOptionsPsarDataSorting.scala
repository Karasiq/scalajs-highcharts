...
/**
  * @note JavaScript name: <code>plotOptions-psar-dataSorting</code>
  */
class PlotOptionsPsarDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPsarDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPsarDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarDataSorting {
