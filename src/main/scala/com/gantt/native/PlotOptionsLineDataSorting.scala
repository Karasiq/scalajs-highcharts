...
/**
  * @note JavaScript name: <code>plotOptions-line-dataSorting</code>
  */
class PlotOptionsLineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineDataSorting {
