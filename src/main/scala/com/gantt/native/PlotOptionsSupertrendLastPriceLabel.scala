...
/**
  * @note JavaScript name: <code>plotOptions-supertrend-lastPrice-label</code>
  */
class PlotOptionsSupertrendLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSupertrendLastPriceLabel {
  /**
