...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-states</code>
  */
class SeriesHollowcandlestickStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesHollowcandlestickStatesSelect]] = js.undefined
...
object SeriesHollowcandlestickStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesHollowcandlestickStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): SeriesHollowcandlestickStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHollowcandlestickStates {
      this.hover = hover
      this.select = select
