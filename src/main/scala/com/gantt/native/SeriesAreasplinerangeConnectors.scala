...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-connectors</code>
  */
class SeriesAreasplinerangeConnectors extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesAreasplinerangeConnectorsEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesAreasplinerangeConnectorsStartMarker]] = js.undefined
...
object SeriesAreasplinerangeConnectors {
  /**
    ...
    */
  def apply(dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesAreasplinerangeConnectorsEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesAreasplinerangeConnectorsStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesAreasplinerangeConnectors = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeConnectors {
