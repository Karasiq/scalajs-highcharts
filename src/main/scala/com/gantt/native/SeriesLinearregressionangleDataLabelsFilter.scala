...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-dataLabels-filter</code>
  */
class SeriesLinearregressionangleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLinearregressionangleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionangleDataLabelsFilter {
