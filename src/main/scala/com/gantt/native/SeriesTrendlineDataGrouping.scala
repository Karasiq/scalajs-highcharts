...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dataGrouping</code>
  */
class SeriesTrendlineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDataGrouping {
  /**
