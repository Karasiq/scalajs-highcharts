...
/**
  * @note JavaScript name: <code>annotations-fibonacciTimeZones-typeOptions</code>
  */
class AnnotationsFibonacciTimeZonesTypeOptions extends com.highcharts.HighchartsGenericObject {
...
object AnnotationsFibonacciTimeZonesTypeOptions {
  /**
    ...
    */
  def apply(line: js.UndefOr[js.Any] = js.undefined, points: js.UndefOr[js.Array[js.Any]] = js.undefined, xAxis: js.UndefOr[Double] = js.undefined, yAxis: js.UndefOr[Double] = js.undefined): AnnotationsFibonacciTimeZonesTypeOptions = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new AnnotationsFibonacciTimeZonesTypeOptions {
      this.line = line
      this.points = points
      this.xAxis = xAxis
      this.yAxis = yAxis
