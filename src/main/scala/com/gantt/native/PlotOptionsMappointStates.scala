...
class PlotOptionsMappointStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsMappointStatesSelect]] = js.undefined
}
...
object PlotOptionsMappointStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsMappointStatesSelect]] = js.undefined): PlotOptionsMappointStates = {
