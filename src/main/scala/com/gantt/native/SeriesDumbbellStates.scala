...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-states</code>
  */
class SeriesDumbbellStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesDumbbellStatesSelect]] = js.undefined
}

object SeriesDumbbellStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDumbbellStatesSelect]] = js.undefined): SeriesDumbbellStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellStates {
      this.hover = hover
