...
/**
  * @note JavaScript name: <code>plotOptions-pie-dataLabels-animation</code>
  */
class PlotOptionsPieDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPieDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsPieDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPieDataLabelsAnimation {
      this.defer = defer
    })
  }
}
