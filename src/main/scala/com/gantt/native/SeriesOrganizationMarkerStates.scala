...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-marker-states</code>
  */
class SeriesOrganizationMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesOrganizationMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
