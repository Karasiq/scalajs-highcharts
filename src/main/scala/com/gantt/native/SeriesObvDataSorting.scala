...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-dataSorting</code>
  */
class SeriesObvDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesObvDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvDataSorting {
