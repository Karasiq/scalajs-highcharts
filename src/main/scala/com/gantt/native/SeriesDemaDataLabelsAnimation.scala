...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-dataLabels-animation</code>
  */
class SeriesDemaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDemaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
