...
/**
  * @note JavaScript name: <code>plotOptions-sma-dataLabels</code>
  */
class PlotOptionsSmaDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaDataLabels {
  /**
