...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-dataSorting</code>
  */
class SeriesPcDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPcDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcDataSorting {
