...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-states-hover-halo</code>
  */
class SeriesTemaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTemaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaStatesHoverHalo {
