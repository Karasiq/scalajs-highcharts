...
/**
  * @note JavaScript name: <code>series&lt;sunburst&gt;-levels-dataLabels</code>
  */
class SeriesSunburstLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesSunburstLevelsDataLabels {
  /**
