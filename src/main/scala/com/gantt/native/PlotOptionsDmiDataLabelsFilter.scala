...
/**
  * @note JavaScript name: <code>plotOptions-dmi-dataLabels-filter</code>
  */
class PlotOptionsDmiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsDmiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiDataLabelsFilter {
