...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-states-hover</code>
  */
class SeriesHeikinashiStatesHover extends com.highcharts.HighchartsGenericObject {
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-states-hover-linewidthplus/">5 pixels wider</a>
  ...
  /**
    ...
    */
  var marker: js.UndefOr[CleanJsObject[SeriesHeikinashiStatesHoverMarker]] = js.undefined
}

object SeriesHeikinashiStatesHover {
  /**
    ...
    */
  def apply(lineWidth: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, halo: js.UndefOr[Null | js.Any] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[CleanJsObject[SeriesHeikinashiStatesHoverMarker]] = js.undefined): SeriesHeikinashiStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiStatesHover {
