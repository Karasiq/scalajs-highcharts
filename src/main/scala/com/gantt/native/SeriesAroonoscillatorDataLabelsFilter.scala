...
/**
  * @note JavaScript name: <code>series&lt;aroonoscillator&gt;-dataLabels-filter</code>
  */
class SeriesAroonoscillatorDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonoscillatorDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAroonoscillatorDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonoscillatorDataLabelsFilter {
