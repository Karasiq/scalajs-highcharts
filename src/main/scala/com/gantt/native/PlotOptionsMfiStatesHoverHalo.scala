...
/**
  * @note JavaScript name: <code>plotOptions-mfi-states-hover-halo</code>
  */
class PlotOptionsMfiStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMfiStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsMfiStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMfiStatesHoverHalo {
