...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-marker-states</code>
  */
class SeriesObvMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesObvMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
