...
/**
  * @note JavaScript name: <code>plotOptions-scatter-cluster-layoutAlgorithm</code>
  */
class PlotOptionsScatterClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatterClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): PlotOptionsScatterClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatterClusterLayoutAlgorithm {
