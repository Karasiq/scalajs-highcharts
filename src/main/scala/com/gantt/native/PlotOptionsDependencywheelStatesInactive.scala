...
/**
  * @note JavaScript name: <code>plotOptions-dependencywheel-states-inactive</code>
  */
class PlotOptionsDependencywheelStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDependencywheelStatesInactive {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsDependencywheelStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDependencywheelStatesInactive {
