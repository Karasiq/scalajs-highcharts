...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-states-inactive</code>
  */
class SeriesColumnpyramidStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesColumnpyramidStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidStatesInactive {
