...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-accessibility</code>
  */
class SeriesDumbbellAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesDumbbellAccessibilityPoint]] = js.undefined
}

object SeriesDumbbellAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesDumbbellAccessibilityPoint]] = js.undefined): SeriesDumbbellAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellAccessibility {
