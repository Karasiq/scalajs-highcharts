...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-states-inactive</code>
  */
class SeriesPackedbubbleStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleStatesInactive {
