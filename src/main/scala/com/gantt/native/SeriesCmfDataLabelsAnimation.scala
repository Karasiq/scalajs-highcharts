...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-dataLabels-animation</code>
  */
class SeriesCmfDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCmfDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfDataLabelsAnimation {
      this.defer = defer
    })
  }
}
