...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-states-select</code>
  */
class PlotOptionsFunnel3dStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsFunnel3dStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dStatesSelect {
