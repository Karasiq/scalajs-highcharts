...
/**
  * @note JavaScript name: <code>series&lt;aroon&gt;-states-inactive</code>
  */
class SeriesAroonStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAroonStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAroonStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAroonStatesInactive {
