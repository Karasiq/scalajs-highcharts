...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dragDrop</code>
  */
class SeriesTrendlineDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDragDrop {
  /**
