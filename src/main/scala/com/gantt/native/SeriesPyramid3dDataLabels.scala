...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-dataLabels</code>
  */
class SeriesPyramid3dDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dDataLabels {
  /**
    ...
    */
  def apply(connectorWidth: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, alignTo: js.UndefOr[String] = js.undefined, connectorColor: js.UndefOr[String | js.Object] = js.undefined, connectorPadding: js.UndefOr[Double] = js.undefined, connectorShape: js.UndefOr[String | js.Function] = js.undefined, crookDistance: js.UndefOr[String] = js.undefined, distance: js.UndefOr[Double | String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, format: js.UndefOr[String] = js.undefined, formatter: js.UndefOr[js.Any] = js.undefined, softConnector: js.UndefOr[Boolean] = js.undefined, style: js.UndefOr[js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, backgroundColor: js.UndefOr[String | js.Object] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderRadius: js.UndefOr[Double] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, crop: js.UndefOr[Boolean] = js.undefined, defer: js.UndefOr[Boolean | Double] = js.undefined, filter: js.UndefOr[js.Any] = js.undefined, nullFormat: js.UndefOr[Boolean | String] = js.undefined, nullFormatter: js.UndefOr[js.Any] = js.undefined, overflow: js.UndefOr[js.Any] = js.undefined, padding: js.UndefOr[Double] = js.undefined, position: js.UndefOr[String] = js.undefined, rotation: js.UndefOr[Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, shape: js.UndefOr[String] = js.undefined, textPath: js.UndefOr[js.Any] = js.undefined, useHTML: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined, y: js.UndefOr[Double] = js.undefined, z: js.UndefOr[Double] = js.undefined, align: js.UndefOr[String | Null] = js.undefined, allowOverlap: js.UndefOr[Boolean] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined): SeriesPyramid3dDataLabels = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dDataLabels {
