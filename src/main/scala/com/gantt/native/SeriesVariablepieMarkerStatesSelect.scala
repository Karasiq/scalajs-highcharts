...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-marker-states-select</code>
  */
class SeriesVariablepieMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesVariablepieMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieMarkerStatesSelect {
