...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data</code>
  */
class SeriesTimelineData extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The description of event. This description will be shown in tooltip.</p>
    * @since 5.0.0
    */
  var description: js.UndefOr[String] = js.undefined

  /**
    * <p>The label of event.</p>
    */
  ...
  /**
    ...
    */
  var dataLabels: js.UndefOr[CleanJsObject[SeriesTimelineDataDataLabels]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var dragDrop: js.UndefOr[CleanJsObject[SeriesTimelineDataDragDrop]] = js.undefined
  ...
  /**
    ...
    */
  var events: js.UndefOr[CleanJsObject[SeriesTimelineDataEvents]] = js.undefined
...
object SeriesTimelineData {
  /**
    * @param description <p>The description of event. This description will be shown in tooltip.</p>
    * @param label <p>The label of event.</p>
    * @param name <p>The name of event.</p>
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, label: js.UndefOr[String] = js.undefined, name: js.UndefOr[String] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dataLabels: js.UndefOr[CleanJsObject[SeriesTimelineDataDataLabels]] = js.undefined, dragDrop: js.UndefOr[CleanJsObject[SeriesTimelineDataDragDrop]] = js.undefined, drilldown: js.UndefOr[String] = js.undefined, events: js.UndefOr[CleanJsObject[SeriesTimelineDataEvents]] = js.undefined, id: js.UndefOr[String] = js.undefined, labelrank: js.UndefOr[Double] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, x: js.UndefOr[Double] = js.undefined): SeriesTimelineData = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineData {
