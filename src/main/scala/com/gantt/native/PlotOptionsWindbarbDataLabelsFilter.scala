...
/**
  * @note JavaScript name: <code>plotOptions-windbarb-dataLabels-filter</code>
  */
class PlotOptionsWindbarbDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWindbarbDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWindbarbDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWindbarbDataLabelsFilter {
