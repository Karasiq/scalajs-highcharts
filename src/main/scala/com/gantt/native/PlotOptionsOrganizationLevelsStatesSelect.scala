...
/**
  * @note JavaScript name: <code>plotOptions-organization-levels-states-select</code>
  */
class PlotOptionsOrganizationLevelsStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLevelsStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsOrganizationLevelsStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationLevelsStatesSelect {
