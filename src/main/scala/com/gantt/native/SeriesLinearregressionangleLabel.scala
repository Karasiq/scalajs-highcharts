...
/**
  * @note JavaScript name: <code>series&lt;linearregressionangle&gt;-label</code>
  */
class SeriesLinearregressionangleLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionangleLabel {
  /**
