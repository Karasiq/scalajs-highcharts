...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionangle-label</code>
  */
class PlotOptionsLinearregressionangleLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionangleLabel {
  /**
