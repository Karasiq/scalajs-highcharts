...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-marker-states</code>
  */
class SeriesNatrMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesNatrMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
