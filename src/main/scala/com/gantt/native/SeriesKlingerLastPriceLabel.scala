...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-lastPrice-label</code>
  */
class SeriesKlingerLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerLastPriceLabel {
  /**
