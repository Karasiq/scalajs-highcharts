...
/**
  * @note JavaScript name: <code>plotOptions-dpo-states-inactive</code>
  */
class PlotOptionsDpoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDpoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsDpoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDpoStatesInactive {
