...
/**
  * @note JavaScript name: <code>series&lt;dmi&gt;-dataLabels-animation</code>
  */
class SeriesDmiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesDmiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesDmiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDmiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
