...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-params</code>
  */
class SeriesDemaParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesDemaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaParams {
      this.index = index
      this.period = period
    })
  }
