...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-dataSorting</code>
  */
class PlotOptionsLinearregressionDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsLinearregressionDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionDataSorting {
