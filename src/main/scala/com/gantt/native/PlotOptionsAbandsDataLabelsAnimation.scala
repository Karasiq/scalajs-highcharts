...
/**
  * @note JavaScript name: <code>plotOptions-abands-dataLabels-animation</code>
  */
class PlotOptionsAbandsDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsDataLabelsAnimation {
      this.defer = defer
    })
  }
}
