...
/**
  * @note JavaScript name: <code>plotOptions-bullet-states-inactive</code>
  */
class PlotOptionsBulletStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBulletStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsBulletStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBulletStatesInactive {
