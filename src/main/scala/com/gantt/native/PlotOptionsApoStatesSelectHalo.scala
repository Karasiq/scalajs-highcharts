...
/**
  * @note JavaScript name: <code>plotOptions-apo-states-select-halo</code>
  */
class PlotOptionsApoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsApoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsApoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsApoStatesSelectHalo {
