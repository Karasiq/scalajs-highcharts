...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-dataLabels</code>
  */
class PlotOptionsCylinderDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderDataLabels {
  /**
