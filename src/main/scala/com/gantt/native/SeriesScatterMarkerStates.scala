...
/**
  ...
  */
class SeriesScatterMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesScatterMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
