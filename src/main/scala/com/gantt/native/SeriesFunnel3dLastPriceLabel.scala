...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-lastPrice-label</code>
  */
class SeriesFunnel3dLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dLastPriceLabel {
  /**
