...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-dataLabels</code>
  */
class SeriesRsiDataLabels extends com.highcharts.HighchartsGenericObject {
