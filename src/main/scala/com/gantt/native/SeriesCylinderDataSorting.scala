...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-dataSorting</code>
  */
class SeriesCylinderDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesCylinderDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderDataSorting {
