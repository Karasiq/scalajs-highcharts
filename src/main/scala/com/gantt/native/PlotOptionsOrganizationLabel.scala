...
/**
  * @note JavaScript name: <code>plotOptions-organization-label</code>
  */
class PlotOptionsOrganizationLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationLabel {
  /**
