...
/**
  * @note JavaScript name: <code>plotOptions-cylinder-dataGrouping</code>
  */
class PlotOptionsCylinderDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCylinderDataGrouping {
  /**
