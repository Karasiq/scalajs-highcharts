...
/**
  * @note JavaScript name: <code>plotOptions-candlestick-dataLabels-filter</code>
  */
class PlotOptionsCandlestickDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsCandlestickDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsCandlestickDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsCandlestickDataLabelsFilter {
