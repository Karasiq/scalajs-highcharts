...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-dataLabels-animation</code>
  */
class SeriesStochasticDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesStochasticDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticDataLabelsAnimation {
      this.defer = defer
    })
  }
}
