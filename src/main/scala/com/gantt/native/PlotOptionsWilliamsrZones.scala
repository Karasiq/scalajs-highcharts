...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-zones</code>
  */
class PlotOptionsWilliamsrZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrZones {
