...
/**
  * @note JavaScript name: <code>series&lt;pyramid&gt;-accessibility-point</code>
  */
class SeriesPyramidAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramidAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPyramidAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramidAccessibilityPoint {
