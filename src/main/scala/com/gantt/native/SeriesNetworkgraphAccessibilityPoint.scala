...
/**
  * @note JavaScript name: <code>series&lt;networkgraph&gt;-accessibility-point</code>
  */
class SeriesNetworkgraphAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesNetworkgraphAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesNetworkgraphAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNetworkgraphAccessibilityPoint {
