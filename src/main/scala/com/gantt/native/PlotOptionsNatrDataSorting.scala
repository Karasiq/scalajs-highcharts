...
/**
  * @note JavaScript name: <code>plotOptions-natr-dataSorting</code>
  */
class PlotOptionsNatrDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsNatrDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrDataSorting {
