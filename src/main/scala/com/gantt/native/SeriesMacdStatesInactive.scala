...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-states-inactive</code>
  */
class SeriesMacdStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesMacdStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMacdStatesInactive {
