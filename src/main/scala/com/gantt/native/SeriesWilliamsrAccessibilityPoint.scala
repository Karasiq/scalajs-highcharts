...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-accessibility-point</code>
  */
class SeriesWilliamsrAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesWilliamsrAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWilliamsrAccessibilityPoint {
