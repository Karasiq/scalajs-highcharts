...
/**
  * @note JavaScript name: <code>plotOptions-rsi-dataLabels-animation</code>
  */
class PlotOptionsRsiDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsRsiDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiDataLabelsAnimation {
      this.defer = defer
    })
  }
}
