...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-states-hover-halo</code>
  */
class PlotOptionsScatter3dStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dStatesHoverHalo {
