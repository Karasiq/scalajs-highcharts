...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-dataLabels</code>
  */
class SeriesCmfDataLabels extends com.highcharts.HighchartsGenericObject {
