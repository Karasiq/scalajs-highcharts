...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-dataSorting</code>
  */
class PlotOptionsKeltnerchannelsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsKeltnerchannelsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsDataSorting {
