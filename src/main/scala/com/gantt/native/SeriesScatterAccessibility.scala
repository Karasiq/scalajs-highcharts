...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-accessibility</code>
  */
class SeriesScatterAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesScatterAccessibilityPoint]] = js.undefined
}

object SeriesScatterAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesScatterAccessibilityPoint]] = js.undefined): SeriesScatterAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterAccessibility {
