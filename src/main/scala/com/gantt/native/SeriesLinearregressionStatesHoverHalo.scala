...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-states-hover-halo</code>
  */
class SeriesLinearregressionStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesLinearregressionStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLinearregressionStatesHoverHalo {
