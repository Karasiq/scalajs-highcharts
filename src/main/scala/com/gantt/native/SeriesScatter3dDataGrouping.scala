...
/**
  * @note JavaScript name: <code>series&lt;scatter3d&gt;-dataGrouping</code>
  */
class SeriesScatter3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatter3dDataGrouping {
  /**
