...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-accessibility</code>
  */
class SeriesPivotpointsAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPivotpointsAccessibilityPoint]] = js.undefined
}

object SeriesPivotpointsAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPivotpointsAccessibilityPoint]] = js.undefined): SeriesPivotpointsAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsAccessibility {
