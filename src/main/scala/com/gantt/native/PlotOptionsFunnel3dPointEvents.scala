...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-point-events</code>
  */
class PlotOptionsFunnel3dPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsFunnel3dPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dPointEvents {
      this.click = click
      this.drag = drag
