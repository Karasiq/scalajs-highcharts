...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-states-select-halo</code>
  */
class SeriesCandlestickStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesCandlestickStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickStatesSelectHalo {
