...
/**
  * @note JavaScript name: <code>plotOptions-bb-dataSorting</code>
  */
class PlotOptionsBbDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBbDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsBbDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBbDataSorting {
