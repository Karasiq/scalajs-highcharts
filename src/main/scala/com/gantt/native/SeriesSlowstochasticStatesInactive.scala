...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-states-inactive</code>
  */
class SeriesSlowstochasticStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticStatesInactive {
