...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-dataLabels</code>
  */
class SeriesItemDataLabels extends com.highcharts.HighchartsGenericObject {
