...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dragDrop-dragHandle</code>
  */
class SeriesNatrDragDropDragHandle extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrDragDropDragHandle {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, cursor: js.UndefOr[String] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, pathFormatter: js.UndefOr[js.Function] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined): SeriesNatrDragDropDragHandle = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesNatrDragDropDragHandle {
