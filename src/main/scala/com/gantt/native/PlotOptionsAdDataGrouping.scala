...
/**
  * @note JavaScript name: <code>plotOptions-ad-dataGrouping</code>
  */
class PlotOptionsAdDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdDataGrouping {
  /**
