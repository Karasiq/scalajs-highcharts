...
object PlotOptionsBubbleMarker {
  /**
    ...
    */
  def apply(fillOpacity: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, symbol: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined): PlotOptionsBubbleMarker = {
