...
/**
  * @note JavaScript name: <code>plotOptions-psar-accessibility</code>
  */
class PlotOptionsPsarAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPsarAccessibilityPoint]] = js.undefined
}

object PlotOptionsPsarAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPsarAccessibilityPoint]] = js.undefined): PlotOptionsPsarAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPsarAccessibility {
