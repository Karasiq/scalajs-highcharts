...
/**
  * @note JavaScript name: <code>series&lt;trix&gt;-lastPrice-label</code>
  */
class SeriesTrixLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrixLastPriceLabel {
  /**
