...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dragDrop</code>
  */
class SeriesSupertrendDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDragDrop {
  /**
