...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-dataLabels</code>
  */
class SeriesMfiDataLabels extends com.highcharts.HighchartsGenericObject {
