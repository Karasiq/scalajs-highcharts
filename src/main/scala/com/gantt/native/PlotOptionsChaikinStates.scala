...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-states</code>
  */
class PlotOptionsChaikinStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsChaikinStatesSelect]] = js.undefined
}

object PlotOptionsChaikinStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsChaikinStatesSelect]] = js.undefined): PlotOptionsChaikinStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinStates {
      this.hover = hover
