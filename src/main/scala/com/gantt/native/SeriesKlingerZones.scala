...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-zones</code>
  */
class SeriesKlingerZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesKlingerZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerZones {
