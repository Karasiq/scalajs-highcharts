...
object NavigatorSeriesDataGrouping {
  /**
    ...
    */
  def apply(anchor: js.UndefOr[String] = js.undefined, approximation: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): NavigatorSeriesDataGrouping = {
