...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-dataLabels-filter</code>
  */
class SeriesPolygonDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPolygonDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPolygonDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonDataLabelsFilter {
