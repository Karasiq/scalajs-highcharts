...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-states-hover-halo</code>
  */
class SeriesDumbbellStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesDumbbellStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellStatesHoverHalo {
