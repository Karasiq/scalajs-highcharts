...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-dataLabels</code>
  */
class SeriesParetoDataLabels extends com.highcharts.HighchartsGenericObject {
