...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-accessibility</code>
  */
class SeriesTrendlineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTrendlineAccessibilityPoint]] = js.undefined
}

object SeriesTrendlineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTrendlineAccessibilityPoint]] = js.undefined): SeriesTrendlineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTrendlineAccessibility {
