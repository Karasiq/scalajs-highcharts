...
/**
  * @note JavaScript name: <code>series&lt;hlc&gt;-states-inactive</code>
  */
class SeriesHlcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesHlcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesHlcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHlcStatesInactive {
