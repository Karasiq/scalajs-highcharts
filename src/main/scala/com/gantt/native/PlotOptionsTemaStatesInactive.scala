...
/**
  * @note JavaScript name: <code>plotOptions-tema-states-inactive</code>
  */
class PlotOptionsTemaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsTemaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaStatesInactive {
