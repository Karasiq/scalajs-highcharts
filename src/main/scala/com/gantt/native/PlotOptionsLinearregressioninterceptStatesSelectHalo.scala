...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-states-select-halo</code>
  */
class PlotOptionsLinearregressioninterceptStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressioninterceptStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptStatesSelectHalo {
