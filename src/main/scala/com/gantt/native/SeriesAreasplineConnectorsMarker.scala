...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-connectors-marker</code>
  */
class SeriesAreasplineConnectorsMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineConnectorsMarker {
  /**
    ...
    */
  def apply(align: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, height: js.UndefOr[Double] = js.undefined, inside: js.UndefOr[Boolean] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, verticalAlign: js.UndefOr[String] = js.undefined, width: js.UndefOr[Double] = js.undefined): SeriesAreasplineConnectorsMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplineConnectorsMarker {
      this.align = align
      this.color = color
