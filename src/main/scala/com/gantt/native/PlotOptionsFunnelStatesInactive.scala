...
/**
  * @note JavaScript name: <code>plotOptions-funnel-states-inactive</code>
  */
class PlotOptionsFunnelStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnelStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsFunnelStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelStatesInactive {
