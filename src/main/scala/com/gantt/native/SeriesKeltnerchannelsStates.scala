...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-states</code>
  */
class SeriesKeltnerchannelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsStatesSelect]] = js.undefined
}

object SeriesKeltnerchannelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesKeltnerchannelsStatesSelect]] = js.undefined): SeriesKeltnerchannelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsStates {
      this.hover = hover
