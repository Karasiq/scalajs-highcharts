...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dataGrouping</code>
  */
class SeriesLinearregressionDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDataGrouping {
  /**
