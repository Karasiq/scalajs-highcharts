...
/**
  * @note JavaScript name: <code>plotOptions-hlc-states</code>
  */
class PlotOptionsHlcStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsHlcStatesSelect]] = js.undefined
...
object PlotOptionsHlcStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsHlcStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsHlcStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcStates {
      this.hover = hover
      this.select = select
