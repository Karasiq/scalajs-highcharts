...
/**
  * @note JavaScript name: <code>series&lt;streamgraph&gt;-accessibility-point</code>
  */
class SeriesStreamgraphAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesStreamgraphAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesStreamgraphAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStreamgraphAccessibilityPoint {
