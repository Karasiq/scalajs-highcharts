...
/**
  * @note JavaScript name: <code>plotOptions-column-states-inactive</code>
  */
class PlotOptionsColumnStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsColumnStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnStatesInactive {
