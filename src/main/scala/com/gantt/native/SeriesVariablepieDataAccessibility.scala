...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-data-accessibility</code>
  */
class SeriesVariablepieDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesVariablepieDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariablepieDataAccessibility {
