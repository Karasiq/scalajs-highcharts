...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-dataGrouping</code>
  */
class SeriesSlowstochasticDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticDataGrouping {
  /**
