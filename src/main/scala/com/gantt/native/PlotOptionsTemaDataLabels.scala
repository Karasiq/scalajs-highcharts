...
/**
  * @note JavaScript name: <code>plotOptions-tema-dataLabels</code>
  */
class PlotOptionsTemaDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaDataLabels {
  /**
