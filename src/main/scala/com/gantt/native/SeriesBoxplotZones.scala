...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-zones</code>
  */
class SeriesBoxplotZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesBoxplotZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotZones {
