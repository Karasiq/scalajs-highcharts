...
/**
  * @note JavaScript name: <code>plotOptions-dmi-marker-states</code>
  */
class PlotOptionsDmiMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDmiMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsDmiMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDmiMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
