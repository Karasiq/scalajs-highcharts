...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-lastPrice-label</code>
  */
class SeriesDumbbellLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellLastPriceLabel {
  /**
