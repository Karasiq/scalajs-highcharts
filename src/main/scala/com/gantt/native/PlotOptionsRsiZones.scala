...
/**
  * @note JavaScript name: <code>plotOptions-rsi-zones</code>
  */
class PlotOptionsRsiZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsRsiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiZones {
