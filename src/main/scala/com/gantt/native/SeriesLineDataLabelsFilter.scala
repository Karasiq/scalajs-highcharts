...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-dataLabels-filter</code>
  */
class SeriesLineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesLineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataLabelsFilter {
