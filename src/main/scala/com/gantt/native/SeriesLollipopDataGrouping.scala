...
/**
  * @note JavaScript name: <code>series&lt;lollipop&gt;-dataGrouping</code>
  */
class SeriesLollipopDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesLollipopDataGrouping {
  /**
