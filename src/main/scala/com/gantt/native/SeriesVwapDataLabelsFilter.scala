...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-dataLabels-filter</code>
  */
class SeriesVwapDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVwapDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVwapDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVwapDataLabelsFilter {
