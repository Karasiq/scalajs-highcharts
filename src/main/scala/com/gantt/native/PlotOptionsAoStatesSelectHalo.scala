...
/**
  * @note JavaScript name: <code>plotOptions-ao-states-select-halo</code>
  */
class PlotOptionsAoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoStatesSelectHalo {
