...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-states-hover-halo</code>
  */
class PlotOptionsDisparityindexStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsDisparityindexStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDisparityindexStatesHoverHalo {
