...
/**
  * @note JavaScript name: <code>plotOptions-sankey-lastPrice-label</code>
  */
class PlotOptionsSankeyLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSankeyLastPriceLabel {
  /**
