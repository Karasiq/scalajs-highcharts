...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-dataSorting</code>
  */
class PlotOptionsColumnpyramidDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsColumnpyramidDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidDataSorting {
