...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-dataLabels-animation</code>
  */
class SeriesTemaDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesTemaDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaDataLabelsAnimation {
      this.defer = defer
    })
  }
}
