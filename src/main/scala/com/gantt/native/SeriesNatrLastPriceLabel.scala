...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-lastPrice-label</code>
  */
class SeriesNatrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesNatrLastPriceLabel {
  /**
