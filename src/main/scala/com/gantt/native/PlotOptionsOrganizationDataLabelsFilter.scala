...
/**
  * @note JavaScript name: <code>plotOptions-organization-dataLabels-filter</code>
  */
class PlotOptionsOrganizationDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsOrganizationDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationDataLabelsFilter {
