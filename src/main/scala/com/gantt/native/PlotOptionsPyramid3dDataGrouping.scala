...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-dataGrouping</code>
  */
class PlotOptionsPyramid3dDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dDataGrouping {
  /**
