...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-dataSorting</code>
  */
class SeriesHistogramDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesHistogramDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramDataSorting {
