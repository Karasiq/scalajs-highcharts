...
/**
  * @note JavaScript name: <code>series&lt;macd&gt;-lastPrice-label</code>
  */
class SeriesMacdLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMacdLastPriceLabel {
  /**
