...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-accessibility</code>
  */
class SeriesVariwideAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVariwideAccessibilityPoint]] = js.undefined
}

object SeriesVariwideAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVariwideAccessibilityPoint]] = js.undefined): SeriesVariwideAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVariwideAccessibility {
