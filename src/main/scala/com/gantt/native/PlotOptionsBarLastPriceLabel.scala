...
/**
  * @note JavaScript name: <code>plotOptions-bar-lastPrice-label</code>
  */
class PlotOptionsBarLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBarLastPriceLabel {
  /**
