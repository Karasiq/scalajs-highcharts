...
/**
  * @note JavaScript name: <code>plotOptions-scatter3d-states-inactive</code>
  */
class PlotOptionsScatter3dStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsScatter3dStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsScatter3dStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsScatter3dStatesInactive {
