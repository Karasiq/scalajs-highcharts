...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-states-hover-halo</code>
  */
class SeriesChaikinStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesChaikinStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinStatesHoverHalo {
