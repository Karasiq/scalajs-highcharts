...
/**
  * @note JavaScript name: <code>plotOptions-columnrange-lastPrice-label</code>
  */
class PlotOptionsColumnrangeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnrangeLastPriceLabel {
  /**
