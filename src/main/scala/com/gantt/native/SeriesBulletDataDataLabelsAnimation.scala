...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-data-dataLabels-animation</code>
  */
class SeriesBulletDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBulletDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBulletDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBulletDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
