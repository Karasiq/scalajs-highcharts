...
/**
  * @note JavaScript name: <code>plotOptions-arearange-dataLabels-filter</code>
  */
class PlotOptionsArearangeDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsArearangeDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsArearangeDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeDataLabelsFilter {
