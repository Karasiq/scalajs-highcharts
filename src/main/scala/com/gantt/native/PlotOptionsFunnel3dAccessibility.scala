...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-accessibility</code>
  */
class PlotOptionsFunnel3dAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsFunnel3dAccessibilityPoint]] = js.undefined
}

object PlotOptionsFunnel3dAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsFunnel3dAccessibilityPoint]] = js.undefined): PlotOptionsFunnel3dAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dAccessibility {
