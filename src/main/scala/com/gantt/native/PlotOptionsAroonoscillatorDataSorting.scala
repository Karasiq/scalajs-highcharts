...
/**
  * @note JavaScript name: <code>plotOptions-aroonoscillator-dataSorting</code>
  */
class PlotOptionsAroonoscillatorDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAroonoscillatorDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsAroonoscillatorDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAroonoscillatorDataSorting {
