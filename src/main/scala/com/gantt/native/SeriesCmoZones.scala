...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-zones</code>
  */
class SeriesCmoZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCmoZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoZones {
