...
/**
  * @note JavaScript name: <code>plotOptions-polygon-accessibility</code>
  */
class PlotOptionsPolygonAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsPolygonAccessibilityPoint]] = js.undefined
}

object PlotOptionsPolygonAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsPolygonAccessibilityPoint]] = js.undefined): PlotOptionsPolygonAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPolygonAccessibility {
