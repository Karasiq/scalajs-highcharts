...
/**
  * @note JavaScript name: <code>plotOptions-klinger-states-hover-halo</code>
  */
class PlotOptionsKlingerStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsKlingerStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKlingerStatesHoverHalo {
