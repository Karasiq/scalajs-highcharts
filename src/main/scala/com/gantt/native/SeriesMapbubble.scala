...
/**
  ...
  */
class SeriesMapbubble extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>mapbubble</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of numerical values. In this case, the numerical values
    * will be interpreted as <code>z</code> options. Example:</p>
    ...
    * <a href="#series.mapbubble.turboThreshold">turboThreshold</a>,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "mapbubble"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    * <p>The main color of the series. This color affects both the fill
    * and the stroke of the bubble. For enhanced control, use <code>marker</code>
    * options.</p>
  ...
  /**
    * <p>Whether to display negative sized bubbles. The threshold is
    * given by the <a href="#plotOptions.mapbubble.zThreshold">zThreshold</a>
  ...
  /**
    ...
    * <a href="#plotOptions.mapbubble.zThreshold">zThreshold</a> setting, this
    * color is used.</p>
  ...
  /**
    * <p>Whether the bubble&#39;s value should be represented by the area or
    * the width of the bubble. The default, <code>area</code>, corresponds best to
    * the human perception of the size of each bubble.</p>
  ...
  /**
    * <p>When this is true, the absolute value of z determines the size
    * of the bubble. This means that with the default <code>zThreshold</code> of
    * 0, a bubble of value -1 will have the same size as a bubble of
    * value 1, while a bubble of value 0 will have a smaller size
    * according to <code>minSize</code>.</p>
  ...
  /**
    * <p>The minimum for the Z value range. Defaults to the highest Z
    * value in the data.</p>
  ...
  /**
    * <p>When <a href="#plotOptions.mapbubble.displayNegative">displayNegative</a>
    * is <code>false</code>, bubbles with lower Z values are skipped. When
    * <code>displayNegative</code> is <code>true</code> and a
    * <a href="#plotOptions.mapbubble.negativeColor">negativeColor</a> is given,
    * points with lower Z is colored.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/plotoptions/mapbubble-negativecolor/">Negative color below a threshold</a>
    * @since 3.0.0
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-connectnulls-true/">True</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectors]] = js.undefined
...
object SeriesMapbubble {
  /**
    * @param data <p>An array of data points for the series. For the <code>mapbubble</code> series. type, points can be given in the following ways:</p>. <ol>. <li><p>An array of numerical values. In this case, the numerical values. will be interpreted as <code>z</code> options. Example:</p>. <pre><code class="language-js">data: [0, 5, 3, 5]. </code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of. data points exceeds the series&#39;. <a href="#series.mapbubble.turboThreshold">turboThreshold</a>,. this option is not available.</p>. <pre><code class="language-js">    data: [{.         z: 9,.         name: &quot;Point2&quot;,.         color: &quot;#00FF00&quot;.     }, {.         z: 10,.         name: &quot;Point1&quot;,.         color: &quot;#FF00FF&quot;.     }]. </code></pre>. </li>. </ol>
    ...
    */
  def apply(data: js.UndefOr[js.Array[Double | Null | js.Any]] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[Double | String] = js.undefined, `type`: js.UndefOr[String] = "mapbubble", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, displayNegative: js.UndefOr[Boolean] = js.undefined, maxSize: js.UndefOr[Double | String] = js.undefined, minSize: js.UndefOr[Double | String] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, sizeBy: js.UndefOr[js.Any] = js.undefined, sizeByAbsoluteValue: js.UndefOr[Boolean] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, zMax: js.UndefOr[Double] = js.undefined, zMin: js.UndefOr[Double] = js.undefined, zThreshold: js.UndefOr[Double] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, jitter: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, boostBlending: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesMapbubbleConnectors]] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, dataSorting: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointRange: js.UndefOr[Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined): SeriesMapbubble = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapbubble {
      this.data = data
      this.marker = marker
      this.id = id
      this.index = index
