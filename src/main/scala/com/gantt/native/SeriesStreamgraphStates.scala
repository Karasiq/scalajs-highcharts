...
class SeriesStreamgraphStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesStreamgraphStatesSelect]] = js.undefined
}
...
object SeriesStreamgraphStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesStreamgraphStatesSelect]] = js.undefined): SeriesStreamgraphStates = {
