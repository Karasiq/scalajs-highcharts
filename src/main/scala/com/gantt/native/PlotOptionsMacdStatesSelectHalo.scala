...
/**
  * @note JavaScript name: <code>plotOptions-macd-states-select-halo</code>
  */
class PlotOptionsMacdStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMacdStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsMacdStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMacdStatesSelectHalo {
