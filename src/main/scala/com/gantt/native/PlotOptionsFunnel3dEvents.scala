...
/**
  * @note JavaScript name: <code>plotOptions-funnel3d-events</code>
  */
class PlotOptionsFunnel3dEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsFunnel3dEvents {
  /**
    ...
    */
  def apply(afterAnimate: js.UndefOr[js.Any] = js.undefined, checkboxClick: js.UndefOr[js.Any] = js.undefined, click: js.UndefOr[js.Any] = js.undefined, hide: js.UndefOr[js.Any] = js.undefined, legendItemClick: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, show: js.UndefOr[js.Any] = js.undefined): PlotOptionsFunnel3dEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnel3dEvents {
