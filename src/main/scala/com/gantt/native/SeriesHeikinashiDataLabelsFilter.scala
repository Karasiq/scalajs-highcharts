...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dataLabels-filter</code>
  */
class SeriesHeikinashiDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHeikinashiDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataLabelsFilter {
