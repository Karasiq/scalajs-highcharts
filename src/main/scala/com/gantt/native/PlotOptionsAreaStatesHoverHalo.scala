...
/**
  * @note JavaScript name: <code>plotOptions-area-states-hover-halo</code>
  */
class PlotOptionsAreaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAreaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreaStatesHoverHalo {
