...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-dataGrouping</code>
  */
class SeriesSmaDataGrouping extends com.highcharts.HighchartsGenericObject {
