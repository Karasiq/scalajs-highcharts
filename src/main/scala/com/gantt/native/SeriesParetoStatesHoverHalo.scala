...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-states-hover-halo</code>
  */
class SeriesParetoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesParetoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoStatesHoverHalo {
