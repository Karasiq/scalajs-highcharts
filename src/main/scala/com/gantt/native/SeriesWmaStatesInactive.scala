...
/**
  * @note JavaScript name: <code>series&lt;wma&gt;-states-inactive</code>
  */
class SeriesWmaStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesWmaStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesWmaStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWmaStatesInactive {
