...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-data-dataLabels-filter</code>
  */
class SeriesFunnel3dDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataDataLabelsFilter {
