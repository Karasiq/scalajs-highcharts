...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-states-select</code>
  */
class SeriesColumnpyramidStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesColumnpyramidStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidStatesSelect {
