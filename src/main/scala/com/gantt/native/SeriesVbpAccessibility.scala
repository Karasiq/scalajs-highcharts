...
/**
  * @note JavaScript name: <code>series&lt;vbp&gt;-accessibility</code>
  */
class SeriesVbpAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesVbpAccessibilityPoint]] = js.undefined
}

object SeriesVbpAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesVbpAccessibilityPoint]] = js.undefined): SeriesVbpAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVbpAccessibility {
