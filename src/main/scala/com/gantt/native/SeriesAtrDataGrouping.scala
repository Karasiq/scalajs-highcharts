...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-dataGrouping</code>
  */
class SeriesAtrDataGrouping extends com.highcharts.HighchartsGenericObject {
