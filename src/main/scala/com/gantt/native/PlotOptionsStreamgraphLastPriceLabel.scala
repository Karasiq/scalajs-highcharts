...
/**
  * @note JavaScript name: <code>plotOptions-streamgraph-lastPrice-label</code>
  */
class PlotOptionsStreamgraphLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsStreamgraphLastPriceLabel {
  /**
