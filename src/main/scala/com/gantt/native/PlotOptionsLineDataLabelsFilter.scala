...
/**
  * @note JavaScript name: <code>plotOptions-line-dataLabels-filter</code>
  */
class PlotOptionsLineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsLineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLineDataLabelsFilter {
