...
/**
  * @note JavaScript name: <code>series&lt;tilemap&gt;-data-dataLabels</code>
  */
class SeriesTilemapDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTilemapDataDataLabels {
  /**
