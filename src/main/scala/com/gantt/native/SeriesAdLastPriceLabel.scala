...
/**
  * @note JavaScript name: <code>series&lt;ad&gt;-lastPrice-label</code>
  */
class SeriesAdLastPriceLabel extends com.highcharts.HighchartsGenericObject {
