...
/**
  * @note JavaScript name: <code>plotOptions-ao-dataLabels-animation</code>
  */
class PlotOptionsAoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsAoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
