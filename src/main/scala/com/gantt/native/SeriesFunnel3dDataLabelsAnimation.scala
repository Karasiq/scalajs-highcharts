...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-dataLabels-animation</code>
  */
class SeriesFunnel3dDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesFunnel3dDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesFunnel3dDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesFunnel3dDataLabelsAnimation {
      this.defer = defer
    })
  }
}
