...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-dataLabels-animation</code>
  */
class SeriesMappointDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesMappointDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointDataLabelsAnimation {
      this.defer = defer
    })
  }
}
