...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-accessibility</code>
  */
class SeriesApoAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesApoAccessibilityPoint]] = js.undefined
}

object SeriesApoAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesApoAccessibilityPoint]] = js.undefined): SeriesApoAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoAccessibility {
