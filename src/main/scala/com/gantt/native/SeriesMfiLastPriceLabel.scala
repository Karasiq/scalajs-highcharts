...
/**
  * @note JavaScript name: <code>series&lt;mfi&gt;-lastPrice-label</code>
  */
class SeriesMfiLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesMfiLastPriceLabel {
  /**
