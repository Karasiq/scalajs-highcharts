...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dragDrop</code>
  */
class PlotOptionsDumbbellDragDrop extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDragDrop {
  /**
