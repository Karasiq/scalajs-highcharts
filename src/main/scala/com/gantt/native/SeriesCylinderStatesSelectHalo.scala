...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-states-select-halo</code>
  */
class SeriesCylinderStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesCylinderStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderStatesSelectHalo {
