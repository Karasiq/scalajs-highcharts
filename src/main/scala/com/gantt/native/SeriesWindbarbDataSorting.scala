...
/**
  * @note JavaScript name: <code>series&lt;windbarb&gt;-dataSorting</code>
  */
class SeriesWindbarbDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesWindbarbDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesWindbarbDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesWindbarbDataSorting {
