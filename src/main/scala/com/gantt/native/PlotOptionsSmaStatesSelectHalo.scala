...
/**
  * @note JavaScript name: <code>plotOptions-sma-states-select-halo</code>
  */
class PlotOptionsSmaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSmaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaStatesSelectHalo {
