...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-states-hover</code>
  */
class SeriesColumnpyramidStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidStatesHover {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesColumnpyramidStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesColumnpyramidStatesHover {
