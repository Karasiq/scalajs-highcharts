...
/**
  * @note JavaScript name: <code>plotOptions-sma-dataSorting</code>
  */
class PlotOptionsSmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsSmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSmaDataSorting {
