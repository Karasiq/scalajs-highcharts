...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-accessibility-point</code>
  */
class SeriesDisparityindexAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesDisparityindexAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexAccessibilityPoint {
