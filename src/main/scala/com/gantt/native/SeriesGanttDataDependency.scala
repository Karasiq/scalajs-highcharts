...
/**
  * @note JavaScript name: <code>series&lt;gantt&gt;-data-dependency</code>
  */
class SeriesGanttDataDependency extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>The ID of the point to connect to.</p>
    * @since 6.2.0
    */
  ...
  /**
    ...
    * @since 6.2.0
    */
  var endMarker: js.UndefOr[CleanJsObject[SeriesGanttDataDependencyEndMarker]] = js.undefined
  ...
  /**
    ...
    * @since 6.2.0
    */
  var startMarker: js.UndefOr[CleanJsObject[SeriesGanttDataDependencyStartMarker]] = js.undefined
...
object SeriesGanttDataDependency {
  /**
    * @param to <p>The ID of the point to connect to.</p>
    ...
    */
  def apply(to: js.UndefOr[String] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, endMarker: js.UndefOr[CleanJsObject[SeriesGanttDataDependencyEndMarker]] = js.undefined, lineColor: js.UndefOr[String] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, marker: js.UndefOr[js.Any] = js.undefined, startMarker: js.UndefOr[CleanJsObject[SeriesGanttDataDependencyStartMarker]] = js.undefined, `type`: js.UndefOr[js.Any] = js.undefined): SeriesGanttDataDependency = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGanttDataDependency {
      this.to = to
