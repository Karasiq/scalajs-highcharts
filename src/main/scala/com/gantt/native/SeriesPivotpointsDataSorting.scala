...
/**
  * @note JavaScript name: <code>series&lt;pivotpoints&gt;-dataSorting</code>
  */
class SeriesPivotpointsDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesPivotpointsDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesPivotpointsDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPivotpointsDataSorting {
