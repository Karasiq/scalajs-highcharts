...
/**
  * @note JavaScript name: <code>plotOptions-vwap-lastPrice-label</code>
  */
class PlotOptionsVwapLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVwapLastPriceLabel {
  /**
