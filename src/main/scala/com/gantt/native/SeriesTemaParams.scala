...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-params</code>
  */
class SeriesTemaParams extends com.highcharts.HighchartsGenericObject {
...
object SeriesTemaParams {
  /**
    ...
    */
  def apply(index: js.UndefOr[Double] = js.undefined, period: js.UndefOr[Double] = js.undefined): SeriesTemaParams = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaParams {
      this.index = index
      this.period = period
    })
  }
