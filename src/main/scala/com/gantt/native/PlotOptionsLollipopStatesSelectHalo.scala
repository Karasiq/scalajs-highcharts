...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-states-select-halo</code>
  */
class PlotOptionsLollipopStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLollipopStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLollipopStatesSelectHalo {
