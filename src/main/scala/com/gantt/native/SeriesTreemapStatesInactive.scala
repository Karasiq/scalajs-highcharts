...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-states-inactive</code>
  */
class SeriesTreemapStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesTreemapStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapStatesInactive {
