...
/**
  * @note JavaScript name: <code>plotOptions-momentum-dataSorting</code>
  */
class PlotOptionsMomentumDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMomentumDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsMomentumDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumDataSorting {
