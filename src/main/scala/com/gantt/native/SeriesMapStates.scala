...
/**
  ...
  */
class SeriesMapStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    */
  var select: js.UndefOr[CleanJsObject[SeriesMapStatesSelect]] = js.undefined
}
...
object SeriesMapStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesMapStatesSelect]] = js.undefined): SeriesMapStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMapStates {
      this.hover = hover
