...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-dataGrouping</code>
  */
class PlotOptionsWilliamsrDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrDataGrouping {
  /**
