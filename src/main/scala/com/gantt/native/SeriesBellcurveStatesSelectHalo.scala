...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-states-select-halo</code>
  */
class SeriesBellcurveStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesBellcurveStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBellcurveStatesSelectHalo {
