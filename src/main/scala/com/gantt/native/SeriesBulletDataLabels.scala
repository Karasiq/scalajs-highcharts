...
/**
  * @note JavaScript name: <code>series&lt;bullet&gt;-dataLabels</code>
  */
class SeriesBulletDataLabels extends com.highcharts.HighchartsGenericObject {
