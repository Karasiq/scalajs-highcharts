...
/**
  * @note JavaScript name: <code>series&lt;heatmap&gt;-dataLabels-animation</code>
  */
class SeriesHeatmapDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeatmapDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesHeatmapDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeatmapDataLabelsAnimation {
      this.defer = defer
    })
  }
}
