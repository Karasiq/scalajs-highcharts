...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-dataLabels</code>
  */
class SeriesKlingerDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesKlingerDataLabels {
  /**
