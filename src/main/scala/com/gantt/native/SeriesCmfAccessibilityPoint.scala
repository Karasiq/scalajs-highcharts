...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-accessibility-point</code>
  */
class SeriesCmfAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesCmfAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfAccessibilityPoint {
