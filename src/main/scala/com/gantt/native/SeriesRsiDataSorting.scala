...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-dataSorting</code>
  */
class SeriesRsiDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesRsiDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiDataSorting {
