...
/**
  * @note JavaScript name: <code>series&lt;rsi&gt;-zones</code>
  */
class SeriesRsiZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesRsiZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesRsiZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesRsiZones {
