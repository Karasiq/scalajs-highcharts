...
/**
  * @note JavaScript name: <code>series&lt;cmo&gt;-dataLabels-animation</code>
  */
class SeriesCmoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesCmoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
