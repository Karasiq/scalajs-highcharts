...
/**
  * @note JavaScript name: <code>plotOptions-priceenvelopes-dataSorting</code>
  */
class PlotOptionsPriceenvelopesDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPriceenvelopesDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsPriceenvelopesDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPriceenvelopesDataSorting {
