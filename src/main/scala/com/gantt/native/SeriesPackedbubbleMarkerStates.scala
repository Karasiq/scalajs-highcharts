...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-marker-states</code>
  */
class SeriesPackedbubbleMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesPackedbubbleMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
