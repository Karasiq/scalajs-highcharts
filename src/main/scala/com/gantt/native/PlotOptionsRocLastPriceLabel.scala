...
/**
  * @note JavaScript name: <code>plotOptions-roc-lastPrice-label</code>
  */
class PlotOptionsRocLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocLastPriceLabel {
  /**
