...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-dataLabels-filter</code>
  */
class PlotOptionsKeltnerchannelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKeltnerchannelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsKeltnerchannelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsDataLabelsFilter {
