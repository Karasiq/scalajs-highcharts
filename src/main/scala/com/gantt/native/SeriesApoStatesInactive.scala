...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-states-inactive</code>
  */
class SeriesApoStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesApoStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoStatesInactive {
