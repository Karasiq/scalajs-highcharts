...
/**
  * @note JavaScript name: <code>series&lt;bellcurve&gt;-dataGrouping</code>
  */
class SeriesBellcurveDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesBellcurveDataGrouping {
  /**
