...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-dataLabels-filter</code>
  */
class SeriesScatterDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesScatterDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterDataLabelsFilter {
