...
/**
  * @note JavaScript name: <code>plotOptions-williamsr-dataLabels-filter</code>
  */
class PlotOptionsWilliamsrDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWilliamsrDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsWilliamsrDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWilliamsrDataLabelsFilter {
