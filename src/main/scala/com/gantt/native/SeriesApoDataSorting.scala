...
/**
  * @note JavaScript name: <code>series&lt;apo&gt;-dataSorting</code>
  */
class SeriesApoDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesApoDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesApoDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesApoDataSorting {
