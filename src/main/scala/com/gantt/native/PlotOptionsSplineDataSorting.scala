...
/**
  * @note JavaScript name: <code>plotOptions-spline-dataSorting</code>
  */
class PlotOptionsSplineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSplineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsSplineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSplineDataSorting {
