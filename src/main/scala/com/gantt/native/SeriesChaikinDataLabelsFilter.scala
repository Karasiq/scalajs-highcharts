...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dataLabels-filter</code>
  */
class SeriesChaikinDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesChaikinDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinDataLabelsFilter {
