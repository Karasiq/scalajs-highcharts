...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-accessibility-point</code>
  */
class SeriesScatterAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesScatterAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterAccessibilityPoint {
