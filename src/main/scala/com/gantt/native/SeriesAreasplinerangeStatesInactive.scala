...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-states-inactive</code>
  */
class SeriesAreasplinerangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeStatesInactive {
