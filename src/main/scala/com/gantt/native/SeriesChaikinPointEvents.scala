...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-point-events</code>
  */
class SeriesChaikinPointEvents extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): SeriesChaikinPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesChaikinPointEvents {
      this.click = click
      this.drag = drag
