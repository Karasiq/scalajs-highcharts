...
/**
  * @note JavaScript name: <code>plotOptions-timeline-marker</code>
  */
class PlotOptionsTimelineMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTimelineMarker {
  /**
    ...
    */
  def apply(enabledThreshold: js.UndefOr[Double] = js.undefined, height: js.UndefOr[Double] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, symbol: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, width: js.UndefOr[Double] = js.undefined): PlotOptionsTimelineMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTimelineMarker {
