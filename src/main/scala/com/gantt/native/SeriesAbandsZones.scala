...
/**
  * @note JavaScript name: <code>series&lt;abands&gt;-zones</code>
  */
class SeriesAbandsZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesAbandsZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAbandsZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAbandsZones {
