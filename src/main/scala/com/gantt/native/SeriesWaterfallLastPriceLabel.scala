...
/**
  * @note JavaScript name: <code>series&lt;waterfall&gt;-lastPrice-label</code>
  */
class SeriesWaterfallLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesWaterfallLastPriceLabel {
  /**
