...
class PlotOptionsColumnrangeStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 2.3.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsColumnrangeStatesSelect]] = js.undefined
...
object PlotOptionsColumnrangeStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsColumnrangeStatesSelect]] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnrangeStates = {
