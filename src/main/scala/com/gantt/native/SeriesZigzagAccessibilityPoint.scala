...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-accessibility-point</code>
  */
class SeriesZigzagAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesZigzagAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesZigzagAccessibilityPoint {
