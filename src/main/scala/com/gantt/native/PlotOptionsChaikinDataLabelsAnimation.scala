...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-dataLabels-animation</code>
  */
class PlotOptionsChaikinDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinDataLabelsAnimation {
      this.defer = defer
    })
  }
}
