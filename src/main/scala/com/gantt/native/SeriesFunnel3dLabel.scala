...
/**
  * @note JavaScript name: <code>series&lt;funnel3d&gt;-label</code>
  */
class SeriesFunnel3dLabel extends com.highcharts.HighchartsGenericObject {
