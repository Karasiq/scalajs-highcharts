...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-dataSorting</code>
  */
class SeriesSupertrendDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesSupertrendDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendDataSorting {
