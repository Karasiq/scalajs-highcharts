...
/**
  * @note JavaScript name: <code>series&lt;histogram&gt;-marker-states</code>
  */
class SeriesHistogramMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesHistogramMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesHistogramMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHistogramMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
