...
/**
  * @note JavaScript name: <code>series&lt;williamsr&gt;-dataGrouping</code>
  */
class SeriesWilliamsrDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesWilliamsrDataGrouping {
  /**
