...
/**
  * @note JavaScript name: <code>plotOptions-heatmap-zones</code>
  */
class PlotOptionsHeatmapZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHeatmapZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsHeatmapZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHeatmapZones {
