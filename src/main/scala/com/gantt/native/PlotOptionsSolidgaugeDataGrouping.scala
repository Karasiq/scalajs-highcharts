...
/**
  * @note JavaScript name: <code>plotOptions-solidgauge-dataGrouping</code>
  */
class PlotOptionsSolidgaugeDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSolidgaugeDataGrouping {
  /**
