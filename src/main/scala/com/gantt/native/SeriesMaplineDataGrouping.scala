...
/**
  * @note JavaScript name: <code>series&lt;mapline&gt;-dataGrouping</code>
  */
class SeriesMaplineDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesMaplineDataGrouping {
  /**
