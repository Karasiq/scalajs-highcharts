...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-data-dataLabels</code>
  */
class SeriesVariablepieDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataDataLabels {
  /**
