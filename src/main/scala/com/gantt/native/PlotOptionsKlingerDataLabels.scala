...
/**
  * @note JavaScript name: <code>plotOptions-klinger-dataLabels</code>
  */
class PlotOptionsKlingerDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsKlingerDataLabels {
  /**
