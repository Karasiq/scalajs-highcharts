...
/**
  * @note JavaScript name: <code>plotOptions-columnpyramid-point-events</code>
  */
class PlotOptionsColumnpyramidPointEvents extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsColumnpyramidPointEvents {
  /**
    ...
    */
  def apply(click: js.UndefOr[js.Any] = js.undefined, drag: js.UndefOr[js.Any] = js.undefined, dragStart: js.UndefOr[js.Any] = js.undefined, drop: js.UndefOr[js.Any] = js.undefined, mouseOut: js.UndefOr[js.Any] = js.undefined, mouseOver: js.UndefOr[js.Any] = js.undefined, remove: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined, unselect: js.UndefOr[js.Any] = js.undefined, update: js.UndefOr[js.Any] = js.undefined): PlotOptionsColumnpyramidPointEvents = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsColumnpyramidPointEvents {
      this.click = click
      this.drag = drag
