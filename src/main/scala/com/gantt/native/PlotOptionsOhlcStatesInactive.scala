...
/**
  * @note JavaScript name: <code>plotOptions-ohlc-states-inactive</code>
  */
class PlotOptionsOhlcStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOhlcStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsOhlcStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOhlcStatesInactive {
