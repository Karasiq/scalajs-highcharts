...
/**
  * @note JavaScript name: <code>series&lt;stochastic&gt;-accessibility-point</code>
  */
class SeriesStochasticAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesStochasticAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesStochasticAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesStochasticAccessibilityPoint {
