...
/**
  * @note JavaScript name: <code>plotOptions-xrange-accessibility</code>
  */
class PlotOptionsXrangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsXrangeAccessibilityPoint]] = js.undefined
}

object PlotOptionsXrangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsXrangeAccessibilityPoint]] = js.undefined): PlotOptionsXrangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeAccessibility {
