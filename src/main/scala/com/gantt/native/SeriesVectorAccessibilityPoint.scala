...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-accessibility-point</code>
  */
class SeriesVectorAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesVectorAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorAccessibilityPoint {
