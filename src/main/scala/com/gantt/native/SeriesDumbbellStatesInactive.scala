...
/**
  * @note JavaScript name: <code>series&lt;dumbbell&gt;-states-inactive</code>
  */
class SeriesDumbbellStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesDumbbellStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesDumbbellStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDumbbellStatesInactive {
