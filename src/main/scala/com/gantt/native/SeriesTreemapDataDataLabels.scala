...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-data-dataLabels</code>
  */
class SeriesTreemapDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataDataLabels {
  /**
