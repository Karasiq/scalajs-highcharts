...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-data-accessibility</code>
  */
class SeriesItemDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesItemDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemDataAccessibility {
