...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-zones</code>
  */
class PlotOptionsChaikinZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsChaikinZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsChaikinZones {
