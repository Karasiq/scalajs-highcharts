...
/**
  * @note JavaScript name: <code>series&lt;areaspline&gt;-data-dataLabels</code>
  */
class SeriesAreasplineDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplineDataDataLabels {
  /**
