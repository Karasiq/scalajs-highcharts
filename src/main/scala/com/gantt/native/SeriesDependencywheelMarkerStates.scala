...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-marker-states</code>
  */
class SeriesDependencywheelMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDependencywheelMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
