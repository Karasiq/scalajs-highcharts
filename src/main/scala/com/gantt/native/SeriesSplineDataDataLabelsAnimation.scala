...
/**
  * @note JavaScript name: <code>series&lt;spline&gt;-data-dataLabels-animation</code>
  */
class SeriesSplineDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesSplineDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesSplineDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSplineDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
