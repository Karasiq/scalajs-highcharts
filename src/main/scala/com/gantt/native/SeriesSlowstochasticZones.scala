...
/**
  * @note JavaScript name: <code>series&lt;slowstochastic&gt;-zones</code>
  */
class SeriesSlowstochasticZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesSlowstochasticZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSlowstochasticZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSlowstochasticZones {
