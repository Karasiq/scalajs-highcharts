...
/**
  * @note JavaScript name: <code>series&lt;klinger&gt;-accessibility</code>
  */
class SeriesKlingerAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesKlingerAccessibilityPoint]] = js.undefined
}

object SeriesKlingerAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesKlingerAccessibilityPoint]] = js.undefined): SeriesKlingerAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKlingerAccessibility {
