...
/**
  * @note JavaScript name: <code>plotOptions-line-lastPrice-label</code>
  */
class PlotOptionsLineLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLineLastPriceLabel {
  /**
