...
/**
  * @note JavaScript name: <code>plotOptions-rsi-dataGrouping</code>
  */
class PlotOptionsRsiDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiDataGrouping {
  /**
