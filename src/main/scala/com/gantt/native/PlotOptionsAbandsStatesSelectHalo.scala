...
/**
  * @note JavaScript name: <code>plotOptions-abands-states-select-halo</code>
  */
class PlotOptionsAbandsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsStatesSelectHalo {
