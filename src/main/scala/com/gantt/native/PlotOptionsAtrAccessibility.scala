...
/**
  * @note JavaScript name: <code>plotOptions-atr-accessibility</code>
  */
class PlotOptionsAtrAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsAtrAccessibilityPoint]] = js.undefined
}

object PlotOptionsAtrAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsAtrAccessibilityPoint]] = js.undefined): PlotOptionsAtrAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAtrAccessibility {
