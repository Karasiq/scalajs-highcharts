...
/**
  * @note JavaScript name: <code>series&lt;zigzag&gt;-lastPrice-label</code>
  */
class SeriesZigzagLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesZigzagLastPriceLabel {
  /**
