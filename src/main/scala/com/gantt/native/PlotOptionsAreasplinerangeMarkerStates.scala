...
/**
  * @note JavaScript name: <code>plotOptions-areasplinerange-marker-states</code>
  */
class PlotOptionsAreasplinerangeMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAreasplinerangeMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsAreasplinerangeMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAreasplinerangeMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
