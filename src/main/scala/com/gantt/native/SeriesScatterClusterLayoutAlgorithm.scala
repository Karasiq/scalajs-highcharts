...
/**
  * @note JavaScript name: <code>series&lt;scatter&gt;-cluster-layoutAlgorithm</code>
  */
class SeriesScatterClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object SeriesScatterClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): SeriesScatterClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesScatterClusterLayoutAlgorithm {
