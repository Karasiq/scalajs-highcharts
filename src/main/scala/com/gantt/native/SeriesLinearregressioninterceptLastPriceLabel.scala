...
/**
  * @note JavaScript name: <code>series&lt;linearregressionintercept&gt;-lastPrice-label</code>
  */
class SeriesLinearregressioninterceptLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressioninterceptLastPriceLabel {
  /**
