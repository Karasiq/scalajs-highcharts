...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-states</code>
  */
class SeriesDemaStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[SeriesDemaStatesSelect]] = js.undefined
}

object SeriesDemaStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[SeriesDemaStatesSelect]] = js.undefined): SeriesDemaStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaStates {
      this.hover = hover
