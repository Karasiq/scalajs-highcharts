...
/**
  * @note JavaScript name: <code>plotOptions-boxplot-lastPrice-label</code>
  */
class PlotOptionsBoxplotLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBoxplotLastPriceLabel {
  /**
