...
/**
  * @note JavaScript name: <code>plotOptions-ad-zones</code>
  */
class PlotOptionsAdZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAdZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAdZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAdZones {
