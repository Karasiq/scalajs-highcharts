...
/**
  * @note JavaScript name: <code>plotOptions-trix-states-hover-halo</code>
  */
class PlotOptionsTrixStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTrixStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTrixStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixStatesHoverHalo {
