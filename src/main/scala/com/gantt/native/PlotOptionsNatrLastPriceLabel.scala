...
/**
  * @note JavaScript name: <code>plotOptions-natr-lastPrice-label</code>
  */
class PlotOptionsNatrLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrLastPriceLabel {
  /**
