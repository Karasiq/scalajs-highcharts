...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dataGrouping</code>
  */
class PlotOptionsLollipopDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDataGrouping {
  /**
