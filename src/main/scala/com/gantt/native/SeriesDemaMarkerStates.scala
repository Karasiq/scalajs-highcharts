...
/**
  * @note JavaScript name: <code>series&lt;dema&gt;-marker-states</code>
  */
class SeriesDemaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesDemaMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesDemaMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDemaMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
