...
/**
  * @note JavaScript name: <code>plotOptions-bellcurve-states-hover-halo</code>
  */
class PlotOptionsBellcurveStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsBellcurveStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsBellcurveStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsBellcurveStatesHoverHalo {
