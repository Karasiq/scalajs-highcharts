...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-data-dataLabels</code>
  */
class SeriesTimelineDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineDataDataLabels {
  /**
