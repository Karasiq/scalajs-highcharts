...
/**
  * @note JavaScript name: <code>series&lt;mapbubble&gt;-dataLabels</code>
  */
class SeriesMapbubbleDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesMapbubbleDataLabels {
  /**
