...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-label</code>
  */
class SeriesHeikinashiLabel extends com.highcharts.HighchartsGenericObject {
