...
/**
  * @note JavaScript name: <code>series&lt;item&gt;-zones</code>
  */
class SeriesItemZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesItemZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesItemZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesItemZones {
