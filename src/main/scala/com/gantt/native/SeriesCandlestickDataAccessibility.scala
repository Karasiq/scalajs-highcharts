...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-data-accessibility</code>
  */
class SeriesCandlestickDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesCandlestickDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCandlestickDataAccessibility {
