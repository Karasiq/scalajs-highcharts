...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-lastPrice-label</code>
  */
class SeriesChaikinLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinLastPriceLabel {
  /**
