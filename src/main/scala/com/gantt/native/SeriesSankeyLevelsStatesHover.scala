...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-levels-states-hover</code>
  */
class SeriesSankeyLevelsStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyLevelsStatesHover {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesSankeyLevelsStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyLevelsStatesHover {
