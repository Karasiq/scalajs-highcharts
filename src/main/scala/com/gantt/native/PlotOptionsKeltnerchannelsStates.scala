...
/**
  * @note JavaScript name: <code>plotOptions-keltnerchannels-states</code>
  */
class PlotOptionsKeltnerchannelsStates extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 7.0.0
    */
  var select: js.UndefOr[CleanJsObject[PlotOptionsKeltnerchannelsStatesSelect]] = js.undefined
}

object PlotOptionsKeltnerchannelsStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, inactive: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[CleanJsObject[PlotOptionsKeltnerchannelsStatesSelect]] = js.undefined): PlotOptionsKeltnerchannelsStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsKeltnerchannelsStates {
      this.hover = hover
