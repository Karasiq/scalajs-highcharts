...
/**
  * @note JavaScript name: <code>series&lt;mappoint&gt;-states-hover-halo</code>
  */
class SeriesMappointStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesMappointStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesMappointStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesMappointStatesHoverHalo {
