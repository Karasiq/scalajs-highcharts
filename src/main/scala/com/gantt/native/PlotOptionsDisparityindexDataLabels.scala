...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-dataLabels</code>
  */
class PlotOptionsDisparityindexDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexDataLabels {
  /**
