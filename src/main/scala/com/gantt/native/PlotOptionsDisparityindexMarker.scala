...
/**
  * @note JavaScript name: <code>plotOptions-disparityindex-marker</code>
  */
class PlotOptionsDisparityindexMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDisparityindexMarker {
  /**
