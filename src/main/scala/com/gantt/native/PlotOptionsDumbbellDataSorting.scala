...
/**
  * @note JavaScript name: <code>plotOptions-dumbbell-dataSorting</code>
  */
class PlotOptionsDumbbellDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDumbbellDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsDumbbellDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDumbbellDataSorting {
