...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-marker-states</code>
  */
class PlotOptionsLinearregressionMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsLinearregressionMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
