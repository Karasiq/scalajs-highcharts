...
/**
  * @note JavaScript name: <code>series&lt;cylinder&gt;-states-hover-halo</code>
  */
class SeriesCylinderStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesCylinderStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesCylinderStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCylinderStatesHoverHalo {
