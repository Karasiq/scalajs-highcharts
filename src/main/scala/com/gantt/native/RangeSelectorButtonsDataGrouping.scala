...
/**
  * @note JavaScript name: <code>rangeSelector-buttons-dataGrouping</code>
  */
class RangeSelectorButtonsDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object RangeSelectorButtonsDataGrouping {
  /**
