...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-accessibility</code>
  */
class SeriesLineAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesLineAccessibilityPoint]] = js.undefined
}

object SeriesLineAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesLineAccessibilityPoint]] = js.undefined): SeriesLineAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineAccessibility {
