...
/**
  * @note JavaScript name: <code>plotOptions-linearregression-states-hover-halo</code>
  */
class PlotOptionsLinearregressionStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressionStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsLinearregressionStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressionStatesHoverHalo {
