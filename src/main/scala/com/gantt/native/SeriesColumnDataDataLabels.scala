...
/**
  * @note JavaScript name: <code>series&lt;column&gt;-data-dataLabels</code>
  */
class SeriesColumnDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnDataDataLabels {
  /**
