...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-marker</code>
  */
class PlotOptionsChaikinMarker extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinMarker {
  /**
