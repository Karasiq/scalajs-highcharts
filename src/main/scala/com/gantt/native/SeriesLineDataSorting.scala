...
/**
  * @note JavaScript name: <code>series&lt;line&gt;-dataSorting</code>
  */
class SeriesLineDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesLineDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesLineDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesLineDataSorting {
