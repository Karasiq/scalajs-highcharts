...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-marker-states-select</code>
  */
class SeriesOrganizationMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesOrganizationMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationMarkerStatesSelect {
