...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-marker-states</code>
  */
class SeriesTreemapMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): SeriesTreemapMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
