...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-marker</code>
  */
class SeriesPackedbubbleMarker extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleMarker {
  /**
    ...
    */
  def apply(fillOpacity: js.UndefOr[Double] = js.undefined, lineColor: js.UndefOr[js.Any] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, symbol: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined): SeriesPackedbubbleMarker = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleMarker {
