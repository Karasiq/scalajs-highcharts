...
/**
  * @note JavaScript name: <code>plotOptions-pareto-lastPrice-label</code>
  */
class PlotOptionsParetoLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoLastPriceLabel {
  /**
