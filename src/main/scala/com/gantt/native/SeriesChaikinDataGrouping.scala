...
/**
  * @note JavaScript name: <code>series&lt;chaikin&gt;-dataGrouping</code>
  */
class SeriesChaikinDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesChaikinDataGrouping {
  /**
