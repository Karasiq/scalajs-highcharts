...
/**
  * @note JavaScript name: <code>series&lt;natr&gt;-dragDrop</code>
  */
class SeriesNatrDragDrop extends com.highcharts.HighchartsGenericObject {
