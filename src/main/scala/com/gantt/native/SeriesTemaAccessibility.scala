...
/**
  * @note JavaScript name: <code>series&lt;tema&gt;-accessibility</code>
  */
class SeriesTemaAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesTemaAccessibilityPoint]] = js.undefined
}

object SeriesTemaAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesTemaAccessibilityPoint]] = js.undefined): SeriesTemaAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTemaAccessibility {
