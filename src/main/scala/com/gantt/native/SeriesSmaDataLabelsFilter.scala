...
/**
  * @note JavaScript name: <code>series&lt;sma&gt;-dataLabels-filter</code>
  */
class SeriesSmaDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesSmaDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesSmaDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSmaDataLabelsFilter {
