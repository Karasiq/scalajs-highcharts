...
/**
  * @note JavaScript name: <code>plotOptions-pareto-dataLabels-animation</code>
  */
class PlotOptionsParetoDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsParetoDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsParetoDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsParetoDataLabelsAnimation {
      this.defer = defer
    })
  }
}
