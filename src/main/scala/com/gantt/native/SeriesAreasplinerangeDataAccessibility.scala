...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-data-accessibility</code>
  */
class SeriesAreasplinerangeDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesAreasplinerangeDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeDataAccessibility {
