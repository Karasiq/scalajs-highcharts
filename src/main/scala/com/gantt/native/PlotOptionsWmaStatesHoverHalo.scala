...
/**
  * @note JavaScript name: <code>plotOptions-wma-states-hover-halo</code>
  */
class PlotOptionsWmaStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsWmaStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsWmaStatesHoverHalo {
