...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-label</code>
  */
class SeriesOrganizationLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLabel {
  /**
