...
/**
  * @note JavaScript name: <code>series&lt;candlestick&gt;-data-dataLabels</code>
  */
class SeriesCandlestickDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesCandlestickDataDataLabels {
  /**
