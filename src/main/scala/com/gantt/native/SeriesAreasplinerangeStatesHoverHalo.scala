...
/**
  * @note JavaScript name: <code>series&lt;areasplinerange&gt;-states-hover-halo</code>
  */
class SeriesAreasplinerangeStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreasplinerangeStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAreasplinerangeStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreasplinerangeStatesHoverHalo {
