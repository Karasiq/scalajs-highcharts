...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-dataLabels</code>
  */
class SeriesVwapDataLabels extends com.highcharts.HighchartsGenericObject {
