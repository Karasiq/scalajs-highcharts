...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-zones</code>
  */
class SeriesPackedbubbleZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleZones {
