...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;</code>
  */
class SeriesHeikinashi extends com.highcharts.HighchartsGenericObject {

  /**
    * <p>An array of data points for the series. For the <code>heikinashi</code> series
    * type, points can be given in the following ways:</p>
    * <ol>
    * <li><p>An array of arrays with 5 or 4 values. In this case, the values correspond
    * to <code>x,open,high,low,close</code>. If the first value is a string, it is applied
    ...
    * <a href="#series.heikinashi.turboThreshold">turboThreshold</a>, this option is not
    * available.</p>
    * <pre><code class="language-js">data: [{
    *     x: 1,
    *     open: 9,
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/maps/demo/mapline-mappoint/">Multiple types in the same map</a>
    */
  var `type`: js.UndefOr[String] = "heikinashi"
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-zindex/">With a z index, the series with the highest z index is on top</a>
  ...
  /**
    ...
    * <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/candlestick-linecolor/">Candlestick line colors</a>
    */
  ...
  /**
    ...
    * <p>In styled mode, the line stroke width can be set with the
    * <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hlc-linewidth/">A greater line width</a>
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/plotoptions/series-stickytracking-false/">False</a>
  ...
  /**
    ...
    * <p>In styled mode, the up color can be set with the
    * <code>.highcharts-candlestick-series .highcharts-point-up</code> rule.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/candlestick-color/">Custom colors</a>
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/css/candlestick/">Colors in styled mode</a>
    */
  var upColor: js.UndefOr[String | js.Object] = js.undefined

  /**
    * <p>The specific line color for up candle sticks. The default is to
    * inherit the general <code>lineColor</code> setting.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/candlestick-linecolor/">Candlestick line colors</a>
    * @since 1.3.6
    */
  var upLineColor: js.UndefOr[String | js.Object] = js.undefined
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/highcharts/coloraxis/changed-default-color-key/">Changed default color key</a>
  ...
  /**
    * <p>Determines which one of  <code>high</code>, <code>low</code>, <code>close</code> values should
    * be represented as <code>point.y</code>, which is later used to set dataLabel
    * position and <a href="#plotOptions.series.compare">compare</a>.</p>
    * @example <a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/hlc-pointvalkey/">Possible values</a>
    */
...
<a href="https://jsfiddle.net/gh/library/pure/highcharts/highcharts/tree/master/samples/stock/plotoptions/series-compare-value/">Value</a>
  ...
  /**
    ...
    * @since 6.2.0
    */
  var connectors: js.UndefOr[CleanJsObject[SeriesHeikinashiConnectors]] = js.undefined
...
object SeriesHeikinashi {
  /**
    * @param data <p>An array of data points for the series. For the <code>heikinashi</code> series. type, points can be given in the following ways:</p>. <ol>. <li><p>An array of arrays with 5 or 4 values. In this case, the values correspond. to <code>x,open,high,low,close</code>. If the first value is a string, it is applied. as the name of the point, and the <code>x</code> value is inferred. The <code>x</code> value can. also be omitted, in which case the inner arrays should be of length 4.. Then the <code>x</code> value is automatically calculated, either starting at 0 and. incremented by 1, or from <code>pointStart</code> and <code>pointInterval</code> given in the. series options.</p>. <pre><code class="language-js">data: [.     [0, 7, 2, 0, 4],.     [1, 1, 4, 2, 8],.     [2, 3, 3, 9, 3]. ]. </code></pre>. </li>. <li><p>An array of objects with named values. The following snippet shows only a. few settings, see the complete options set below. If the total number of. data points exceeds the series&#39;. <a href="#series.heikinashi.turboThreshold">turboThreshold</a>, this option is not. available.</p>. <pre><code class="language-js">data: [{.     x: 1,.     open: 9,.     high: 2,.     low: 4,.     close: 6,.     name: &quot;Point2&quot;,.     color: &quot;#00FF00&quot;. }, {.     x: 1,.     open: 1,.     high: 4,.     low: 7,.     close: 7,.     name: &quot;Point1&quot;,.     color: &quot;#FF00FF&quot;. }]. </code></pre>. </li>. </ol>
    ...
    * @param lineColor <p>The color of the line/border of the candlestick.</p>. <p>In styled mode, the line stroke can be set with the. <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
    * @param lineWidth <p>The pixel width of the candlestick line/border. Defaults to <code>1</code>.</p>. <p>In styled mode, the line stroke width can be set with the. <code>.highcharts-candlestick-series .highcahrts-point</code> rule.</p>
    ...
    * @param upColor <p>The fill color of the candlestick when values are rising.</p>. <p>In styled mode, the up color can be set with the. <code>.highcharts-candlestick-series .highcharts-point-up</code> rule.</p>
    * @param upLineColor <p>The specific line color for up candle sticks. The default is to. inherit the general <code>lineColor</code> setting.</p>
    ...
    * @param pointValKey <p>Determines which one of  <code>high</code>, <code>low</code>, <code>close</code> values should. be represented as <code>point.y</code>, which is later used to set dataLabel. position and <a href="#plotOptions.series.compare">compare</a>.</p>
    ...
    */
  def apply(data: js.UndefOr[js.Array[js.Array[js.Array[js.Any]] | js.Any]] = js.undefined, id: js.UndefOr[String] = js.undefined, index: js.UndefOr[Double] = js.undefined, legendIndex: js.UndefOr[Double] = js.undefined, mapData: js.UndefOr[js.Array[js.Any] | js.Any] = js.undefined, name: js.UndefOr[String] = js.undefined, stack: js.UndefOr[Double | String] = js.undefined, `type`: js.UndefOr[String] = "heikinashi", xAxis: js.UndefOr[Double | String] = js.undefined, yAxis: js.UndefOr[Double | String] = js.undefined, zIndex: js.UndefOr[Double] = js.undefined, dataGrouping: js.UndefOr[js.Any] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, stickyTracking: js.UndefOr[Boolean] = js.undefined, threshold: js.UndefOr[Double | Null] = js.undefined, upColor: js.UndefOr[String | js.Object] = js.undefined, upLineColor: js.UndefOr[String | js.Object] = js.undefined, dragDrop: js.UndefOr[js.Any] = js.undefined, colorKey: js.UndefOr[String] = js.undefined, pointValKey: js.UndefOr[String] = js.undefined, states: js.UndefOr[js.Any] = js.undefined, tooltip: js.UndefOr[js.Any] = js.undefined, centerInCategory: js.UndefOr[Boolean] = js.undefined, colorByPoint: js.UndefOr[Boolean] = js.undefined, colors: js.UndefOr[js.Array[String | js.Object]] = js.undefined, cropThreshold: js.UndefOr[Double] = js.undefined, dataLabels: js.UndefOr[js.Any] = js.undefined, depth: js.UndefOr[Double] = js.undefined, edgeColor: js.UndefOr[String] = js.undefined, edgeWidth: js.UndefOr[Double] = js.undefined, groupPadding: js.UndefOr[Double] = js.undefined, groupZPadding: js.UndefOr[Double] = js.undefined, grouping: js.UndefOr[Boolean] = js.undefined, maxPointWidth: js.UndefOr[Double] = js.undefined, minPointLength: js.UndefOr[Double] = js.undefined, pointPadding: js.UndefOr[Double] = js.undefined, pointRange: js.UndefOr[Double | Null] = js.undefined, pointWidth: js.UndefOr[Double] = js.undefined, accessibility: js.UndefOr[js.Any] = js.undefined, allAreas: js.UndefOr[Boolean] = js.undefined, allowPointSelect: js.UndefOr[Boolean] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, animationLimit: js.UndefOr[Double] = js.undefined, boostBlending: js.UndefOr[String] = js.undefined, boostThreshold: js.UndefOr[Double] = js.undefined, className: js.UndefOr[String] = js.undefined, clip: js.UndefOr[Boolean] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, colorAxis: js.UndefOr[Double | String | Boolean] = js.undefined, colorIndex: js.UndefOr[Double] = js.undefined, compare: js.UndefOr[String] = js.undefined, compareBase: js.UndefOr[Double] = js.undefined, compareStart: js.UndefOr[Boolean] = js.undefined, connectors: js.UndefOr[CleanJsObject[SeriesHeikinashiConnectors]] = js.undefined, cumulative: js.UndefOr[Boolean] = js.undefined, cursor: js.UndefOr[String] = js.undefined, custom: js.UndefOr[js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, dataSorting: js.UndefOr[js.Any] = js.undefined, description: js.UndefOr[String] = js.undefined, enableMouseTracking: js.UndefOr[Boolean] = js.undefined, events: js.UndefOr[js.Any] = js.undefined, findNearestPointBy: js.UndefOr[String] = js.undefined, getExtremesFromAll: js.UndefOr[Boolean] = js.undefined, includeInDataExport: js.UndefOr[Boolean] = js.undefined, joinBy: js.UndefOr[String | js.Array[String]] = js.undefined, keys: js.UndefOr[js.Array[String]] = js.undefined, label: js.UndefOr[js.Any] = js.undefined, lastPrice: js.UndefOr[js.Any] = js.undefined, lastVisiblePrice: js.UndefOr[js.Any] = js.undefined, linkedTo: js.UndefOr[String] = js.undefined, navigatorOptions: js.UndefOr[js.Any] = js.undefined, negativeColor: js.UndefOr[String | js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, point: js.UndefOr[js.Any] = js.undefined, pointDescriptionFormatter: js.UndefOr[js.Function] = js.undefined, pointInterval: js.UndefOr[Double] = js.undefined, pointIntervalUnit: js.UndefOr[String] = js.undefined, pointPlacement: js.UndefOr[String | Double] = js.undefined, pointStart: js.UndefOr[Double] = js.undefined, relativeXValue: js.UndefOr[Boolean] = js.undefined, selected: js.UndefOr[Boolean] = js.undefined, shadow: js.UndefOr[Boolean | js.Object] = js.undefined, showCheckbox: js.UndefOr[Boolean] = js.undefined, showInLegend: js.UndefOr[Boolean] = js.undefined, showInNavigator: js.UndefOr[Boolean] = js.undefined, skipKeyboardNavigation: js.UndefOr[Boolean] = js.undefined, softThreshold: js.UndefOr[Boolean] = js.undefined, turboThreshold: js.UndefOr[Double] = js.undefined, visible: js.UndefOr[Boolean] = js.undefined, zoneAxis: js.UndefOr[String] = js.undefined, zones: js.UndefOr[js.Array[js.Any]] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, connectEnds: js.UndefOr[Boolean] = js.undefined, connectNulls: js.UndefOr[Boolean] = js.undefined, crisp: js.UndefOr[Boolean] = js.undefined, gapSize: js.UndefOr[Double] = js.undefined, gapUnit: js.UndefOr[String] = js.undefined, linecap: js.UndefOr[js.Any] = js.undefined, stacking: js.UndefOr[String] = js.undefined, step: js.UndefOr[String] = js.undefined): SeriesHeikinashi = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashi {
      this.data = data
      this.id = id
      this.index = index
