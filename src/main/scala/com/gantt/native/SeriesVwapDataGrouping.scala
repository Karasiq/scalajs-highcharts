...
/**
  * @note JavaScript name: <code>series&lt;vwap&gt;-dataGrouping</code>
  */
class SeriesVwapDataGrouping extends com.highcharts.HighchartsGenericObject {
