...
/**
  * @note JavaScript name: <code>series&lt;bb&gt;-states-inactive</code>
  */
class SeriesBbStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesBbStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesBbStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBbStatesInactive {
