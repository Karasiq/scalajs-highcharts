...
/**
  * @note JavaScript name: <code>series&lt;gauge&gt;-dataLabels-animation</code>
  */
class SeriesGaugeDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesGaugeDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesGaugeDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesGaugeDataLabelsAnimation {
      this.defer = defer
    })
  }
}
