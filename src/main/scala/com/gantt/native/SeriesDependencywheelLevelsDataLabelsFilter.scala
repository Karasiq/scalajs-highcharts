...
/**
  * @note JavaScript name: <code>series&lt;dependencywheel&gt;-levels-dataLabels-filter</code>
  */
class SeriesDependencywheelLevelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesDependencywheelLevelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesDependencywheelLevelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDependencywheelLevelsDataLabelsFilter {
