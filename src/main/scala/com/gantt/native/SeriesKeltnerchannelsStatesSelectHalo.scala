...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-states-select-halo</code>
  */
class SeriesKeltnerchannelsStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsStatesSelectHalo {
