...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-dataLabels</code>
  */
class SeriesHeikinashiDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataLabels {
  /**
