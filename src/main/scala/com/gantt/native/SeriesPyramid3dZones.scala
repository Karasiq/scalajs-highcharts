...
/**
  * @note JavaScript name: <code>series&lt;pyramid3d&gt;-zones</code>
  */
class SeriesPyramid3dZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesPyramid3dZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPyramid3dZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPyramid3dZones {
