...
/**
  * @note JavaScript name: <code>series&lt;bubble&gt;-data-dataLabels-animation</code>
  */
class SeriesBubbleDataDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesBubbleDataDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesBubbleDataDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBubbleDataDataLabelsAnimation {
      this.defer = defer
    })
  }
}
