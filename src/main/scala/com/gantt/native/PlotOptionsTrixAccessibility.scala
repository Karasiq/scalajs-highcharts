...
/**
  * @note JavaScript name: <code>plotOptions-trix-accessibility</code>
  */
class PlotOptionsTrixAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsTrixAccessibilityPoint]] = js.undefined
}

object PlotOptionsTrixAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsTrixAccessibilityPoint]] = js.undefined): PlotOptionsTrixAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTrixAccessibility {
