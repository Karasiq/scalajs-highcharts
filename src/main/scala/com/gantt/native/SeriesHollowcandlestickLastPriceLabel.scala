...
/**
  * @note JavaScript name: <code>series&lt;hollowcandlestick&gt;-lastPrice-label</code>
  */
class SeriesHollowcandlestickLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesHollowcandlestickLastPriceLabel {
  /**
