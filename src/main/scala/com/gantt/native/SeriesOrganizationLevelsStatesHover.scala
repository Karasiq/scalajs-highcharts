...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-states-hover</code>
  */
class SeriesOrganizationLevelsStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsStatesHover {
  /**
    ...
    */
  def apply(linkOpacity: js.UndefOr[Double] = js.undefined, borderColor: js.UndefOr[String | js.Object] = js.undefined, brightness: js.UndefOr[Double] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[Boolean | js.Object] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesOrganizationLevelsStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationLevelsStatesHover {
