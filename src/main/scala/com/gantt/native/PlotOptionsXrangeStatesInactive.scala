...
/**
  * @note JavaScript name: <code>plotOptions-xrange-states-inactive</code>
  */
class PlotOptionsXrangeStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsXrangeStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsXrangeStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsXrangeStatesInactive {
