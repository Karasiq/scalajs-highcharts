...
/**
  * @note JavaScript name: <code>plotOptions-natr-states-hover-halo</code>
  */
class PlotOptionsNatrStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsNatrStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsNatrStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsNatrStatesHoverHalo {
