...
/**
  * @note JavaScript name: <code>series&lt;ohlc&gt;-data-accessibility</code>
  */
class SeriesOhlcDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesOhlcDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesOhlcDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOhlcDataAccessibility {
