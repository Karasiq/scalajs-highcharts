...
/**
  * @note JavaScript name: <code>plotOptions-slowstochastic-label</code>
  */
class PlotOptionsSlowstochasticLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSlowstochasticLabel {
  /**
