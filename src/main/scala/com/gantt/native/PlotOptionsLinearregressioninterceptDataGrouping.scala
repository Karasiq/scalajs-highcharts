...
/**
  * @note JavaScript name: <code>plotOptions-linearregressionintercept-dataGrouping</code>
  */
class PlotOptionsLinearregressioninterceptDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLinearregressioninterceptDataGrouping {
  /**
    ...
    */
  def apply(anchor: js.UndefOr[String] = js.undefined, approximation: js.UndefOr[String | js.Function] = js.undefined, dateTimeLabelFormats: js.UndefOr[js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, firstAnchor: js.UndefOr[String] = js.undefined, forced: js.UndefOr[Boolean] = js.undefined, groupAll: js.UndefOr[Boolean] = js.undefined, groupPixelWidth: js.UndefOr[Double] = js.undefined, lastAnchor: js.UndefOr[String] = js.undefined, smoothed: js.UndefOr[Boolean] = js.undefined, units: js.UndefOr[js.Array[js.Array[js.Array[js.Any]]]] = js.undefined): PlotOptionsLinearregressioninterceptDataGrouping = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsLinearregressioninterceptDataGrouping {
      this.anchor = anchor
