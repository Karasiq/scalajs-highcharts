...
/**
  * @note JavaScript name: <code>series&lt;pareto&gt;-marker-states-select</code>
  */
class SeriesParetoMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object SeriesParetoMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): SeriesParetoMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesParetoMarkerStatesSelect {
