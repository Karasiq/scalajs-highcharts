...
/**
  * @note JavaScript name: <code>series&lt;ao&gt;-states-hover-halo</code>
  */
class SeriesAoStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAoStatesHoverHalo {
  /**
    ...
    */
  def apply(size: js.UndefOr[Double] = js.undefined, attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesAoStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAoStatesHoverHalo {
      this.size = size
