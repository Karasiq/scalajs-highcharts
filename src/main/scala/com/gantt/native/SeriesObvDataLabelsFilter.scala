...
/**
  * @note JavaScript name: <code>series&lt;obv&gt;-dataLabels-filter</code>
  */
class SeriesObvDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesObvDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesObvDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesObvDataLabelsFilter {
