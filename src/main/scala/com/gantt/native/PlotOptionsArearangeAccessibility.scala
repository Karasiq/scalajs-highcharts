...
/**
  * @note JavaScript name: <code>plotOptions-arearange-accessibility</code>
  */
class PlotOptionsArearangeAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsArearangeAccessibilityPoint]] = js.undefined
}

object PlotOptionsArearangeAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsArearangeAccessibilityPoint]] = js.undefined): PlotOptionsArearangeAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsArearangeAccessibility {
