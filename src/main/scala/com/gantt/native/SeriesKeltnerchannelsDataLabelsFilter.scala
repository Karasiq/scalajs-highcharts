...
/**
  * @note JavaScript name: <code>series&lt;keltnerchannels&gt;-dataLabels-filter</code>
  */
class SeriesKeltnerchannelsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesKeltnerchannelsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesKeltnerchannelsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesKeltnerchannelsDataLabelsFilter {
