...
/**
  * @note JavaScript name: <code>plotOptions-hlc-dataLabels-animation</code>
  */
class PlotOptionsHlcDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsHlcDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): PlotOptionsHlcDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsHlcDataLabelsAnimation {
      this.defer = defer
    })
  }
}
