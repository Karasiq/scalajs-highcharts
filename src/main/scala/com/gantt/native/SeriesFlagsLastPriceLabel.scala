...
/**
  * @note JavaScript name: <code>series&lt;flags&gt;-lastPrice-label</code>
  */
class SeriesFlagsLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesFlagsLastPriceLabel {
  /**
