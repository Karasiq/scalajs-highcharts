...
/**
  * @note JavaScript name: <code>plotOptions-organization-states-select</code>
  */
class PlotOptionsOrganizationStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsOrganizationStatesSelect {
  /**
    ...
    */
  def apply(borderColor: js.UndefOr[String | js.Object] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, animation: js.UndefOr[js.Any] = js.undefined, borderWidth: js.UndefOr[Double] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): PlotOptionsOrganizationStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsOrganizationStatesSelect {
