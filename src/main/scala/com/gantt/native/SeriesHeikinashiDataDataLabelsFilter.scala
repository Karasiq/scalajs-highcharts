...
/**
  * @note JavaScript name: <code>series&lt;heikinashi&gt;-data-dataLabels-filter</code>
  */
class SeriesHeikinashiDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesHeikinashiDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesHeikinashiDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesHeikinashiDataDataLabelsFilter {
