...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-dataLabels-filter</code>
  */
class PlotOptionsErrorbarDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsErrorbarDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsErrorbarDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarDataLabelsFilter {
