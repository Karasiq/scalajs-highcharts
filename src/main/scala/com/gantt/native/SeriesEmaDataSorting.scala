...
/**
  * @note JavaScript name: <code>series&lt;ema&gt;-dataSorting</code>
  */
class SeriesEmaDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesEmaDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesEmaDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesEmaDataSorting {
