...
/**
  * @note JavaScript name: <code>series&lt;timeline&gt;-states-hover-halo</code>
  */
class SeriesTimelineStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesTimelineStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesTimelineStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTimelineStatesHoverHalo {
