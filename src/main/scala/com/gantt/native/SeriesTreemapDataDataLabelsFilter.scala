...
/**
  * @note JavaScript name: <code>series&lt;treemap&gt;-data-dataLabels-filter</code>
  */
class SeriesTreemapDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesTreemapDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesTreemapDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesTreemapDataDataLabelsFilter {
