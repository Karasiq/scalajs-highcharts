...
/**
  * @note JavaScript name: <code>plotOptions-item-marker-states-select</code>
  */
class PlotOptionsItemMarkerStatesSelect extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsItemMarkerStatesSelect {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined): PlotOptionsItemMarkerStatesSelect = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsItemMarkerStatesSelect {
