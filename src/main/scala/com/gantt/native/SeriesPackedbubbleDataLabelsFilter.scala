...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-dataLabels-filter</code>
  */
class SeriesPackedbubbleDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesPackedbubbleDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPackedbubbleDataLabelsFilter {
