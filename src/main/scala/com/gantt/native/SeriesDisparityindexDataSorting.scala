...
/**
  * @note JavaScript name: <code>series&lt;disparityindex&gt;-dataSorting</code>
  */
class SeriesDisparityindexDataSorting extends com.highcharts.HighchartsGenericObject {
...
object SeriesDisparityindexDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): SeriesDisparityindexDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesDisparityindexDataSorting {
