...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-levels-dataLabels</code>
  */
class SeriesOrganizationLevelsDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationLevelsDataLabels {
  /**
