...
/**
  * @note JavaScript name: <code>series&lt;supertrend&gt;-states-select-halo</code>
  */
class SeriesSupertrendStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesSupertrendStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesSupertrendStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSupertrendStatesSelectHalo {
