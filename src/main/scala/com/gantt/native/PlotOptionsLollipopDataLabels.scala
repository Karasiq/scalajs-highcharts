...
/**
  * @note JavaScript name: <code>plotOptions-lollipop-dataLabels</code>
  */
class PlotOptionsLollipopDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsLollipopDataLabels {
  /**
