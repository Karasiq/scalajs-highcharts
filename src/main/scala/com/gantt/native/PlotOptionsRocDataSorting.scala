...
/**
  * @note JavaScript name: <code>plotOptions-roc-dataSorting</code>
  */
class PlotOptionsRocDataSorting extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRocDataSorting {
  /**
    ...
    */
  def apply(enabled: js.UndefOr[Boolean] = js.undefined, matchByName: js.UndefOr[Boolean] = js.undefined, sortKey: js.UndefOr[String] = js.undefined): PlotOptionsRocDataSorting = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRocDataSorting {
