...
/**
  * @note JavaScript name: <code>plotOptions-momentum-accessibility</code>
  */
class PlotOptionsMomentumAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsMomentumAccessibilityPoint]] = js.undefined
}

object PlotOptionsMomentumAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsMomentumAccessibilityPoint]] = js.undefined): PlotOptionsMomentumAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMomentumAccessibility {
