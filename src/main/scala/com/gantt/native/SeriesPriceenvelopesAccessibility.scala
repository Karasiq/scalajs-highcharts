...
/**
  * @note JavaScript name: <code>series&lt;priceenvelopes&gt;-accessibility</code>
  */
class SeriesPriceenvelopesAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPriceenvelopesAccessibilityPoint]] = js.undefined
}

object SeriesPriceenvelopesAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPriceenvelopesAccessibilityPoint]] = js.undefined): SeriesPriceenvelopesAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPriceenvelopesAccessibility {
