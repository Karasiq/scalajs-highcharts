...
/**
  * @note JavaScript name: <code>series&lt;atr&gt;-states-select-halo</code>
  */
class SeriesAtrStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesAtrStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesAtrStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAtrStatesSelectHalo {
