...
/**
  * @note JavaScript name: <code>series&lt;vector&gt;-data-dataLabels-filter</code>
  */
class SeriesVectorDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesVectorDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesVectorDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesVectorDataDataLabelsFilter {
