...
/**
  * @note JavaScript name: <code>series&lt;sankey&gt;-marker-states-hover</code>
  */
class SeriesSankeyMarkerStatesHover extends com.highcharts.HighchartsGenericObject {
...
object SeriesSankeyMarkerStatesHover {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, lineColor: js.UndefOr[String | js.Object] = js.undefined, lineWidth: js.UndefOr[Double] = js.undefined, lineWidthPlus: js.UndefOr[Double] = js.undefined, radius: js.UndefOr[Double] = js.undefined, radiusPlus: js.UndefOr[Double] = js.undefined): SeriesSankeyMarkerStatesHover = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesSankeyMarkerStatesHover {
