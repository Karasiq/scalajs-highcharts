...
/**
  * @note JavaScript name: <code>series&lt;boxplot&gt;-data-accessibility</code>
  */
class SeriesBoxplotDataAccessibility extends com.highcharts.HighchartsGenericObject {
...
object SeriesBoxplotDataAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined): SeriesBoxplotDataAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesBoxplotDataAccessibility {
