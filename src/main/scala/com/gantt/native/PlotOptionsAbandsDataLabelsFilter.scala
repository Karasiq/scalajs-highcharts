...
/**
  * @note JavaScript name: <code>plotOptions-abands-dataLabels-filter</code>
  */
class PlotOptionsAbandsDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsAbandsDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsAbandsDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsAbandsDataLabelsFilter {
