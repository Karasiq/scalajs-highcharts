...
/**
  * @note JavaScript name: <code>plotOptions-vector-cluster-layoutAlgorithm</code>
  */
class PlotOptionsVectorClusterLayoutAlgorithm extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsVectorClusterLayoutAlgorithm {
  /**
    ...
    */
  def apply(distance: js.UndefOr[Double | String] = js.undefined, gridSize: js.UndefOr[Double | String] = js.undefined, iterations: js.UndefOr[Double] = js.undefined, kmeansThreshold: js.UndefOr[Double] = js.undefined, `type`: js.UndefOr[String | js.Function] = js.undefined): PlotOptionsVectorClusterLayoutAlgorithm = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsVectorClusterLayoutAlgorithm {
