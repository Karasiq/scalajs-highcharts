...
/**
  * @note JavaScript name: <code>plotOptions-chaikin-dataGrouping</code>
  */
class PlotOptionsChaikinDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsChaikinDataGrouping {
  /**
