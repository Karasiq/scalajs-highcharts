...
/**
  * @note JavaScript name: <code>series&lt;variablepie&gt;-dataGrouping</code>
  */
class SeriesVariablepieDataGrouping extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariablepieDataGrouping {
  /**
