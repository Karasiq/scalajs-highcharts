...
/**
  * @note JavaScript name: <code>plotOptions-errorbar-accessibility</code>
  */
class PlotOptionsErrorbarAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsErrorbarAccessibilityPoint]] = js.undefined
}

object PlotOptionsErrorbarAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsErrorbarAccessibilityPoint]] = js.undefined): PlotOptionsErrorbarAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsErrorbarAccessibility {
