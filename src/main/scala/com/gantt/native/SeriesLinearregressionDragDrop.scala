...
/**
  * @note JavaScript name: <code>series&lt;linearregression&gt;-dragDrop</code>
  */
class SeriesLinearregressionDragDrop extends com.highcharts.HighchartsGenericObject {
...
object SeriesLinearregressionDragDrop {
  /**
