...
/**
  * @note JavaScript name: <code>plotOptions-sunburst-states-hover-halo</code>
  */
class PlotOptionsSunburstStatesHoverHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsSunburstStatesHoverHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsSunburstStatesHoverHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsSunburstStatesHoverHalo {
