...
/**
  * @note JavaScript name: <code>plotOptions-pyramid3d-zones</code>
  */
class PlotOptionsPyramid3dZones extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPyramid3dZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsPyramid3dZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPyramid3dZones {
