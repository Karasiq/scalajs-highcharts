...
/**
  * @note JavaScript name: <code>series&lt;polygon&gt;-accessibility</code>
  */
class SeriesPolygonAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[SeriesPolygonAccessibilityPoint]] = js.undefined
}

object SeriesPolygonAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[SeriesPolygonAccessibilityPoint]] = js.undefined): SeriesPolygonAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPolygonAccessibility {
