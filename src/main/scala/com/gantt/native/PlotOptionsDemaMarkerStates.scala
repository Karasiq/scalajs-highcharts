...
/**
  * @note JavaScript name: <code>plotOptions-dema-marker-states</code>
  */
class PlotOptionsDemaMarkerStates extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsDemaMarkerStates {
  /**
    ...
    */
  def apply(hover: js.UndefOr[js.Any] = js.undefined, normal: js.UndefOr[js.Any] = js.undefined, select: js.UndefOr[js.Any] = js.undefined): PlotOptionsDemaMarkerStates = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsDemaMarkerStates {
      this.hover = hover
      this.normal = normal
      this.select = select
    })
