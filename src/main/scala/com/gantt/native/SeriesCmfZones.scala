...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-zones</code>
  */
class SeriesCmfZones extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfZones {
  /**
    ...
    */
  def apply(className: js.UndefOr[String] = js.undefined, color: js.UndefOr[String | js.Object] = js.undefined, dashStyle: js.UndefOr[String] = js.undefined, fillColor: js.UndefOr[String | js.Object] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesCmfZones = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfZones {
