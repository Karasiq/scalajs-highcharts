...
/**
  * @note JavaScript name: <code>plotOptions-ppo-states-select-halo</code>
  */
class PlotOptionsPpoStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsPpoStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsPpoStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsPpoStatesSelectHalo {
