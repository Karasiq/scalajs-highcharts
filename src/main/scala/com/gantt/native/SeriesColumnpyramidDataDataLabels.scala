...
/**
  * @note JavaScript name: <code>series&lt;columnpyramid&gt;-data-dataLabels</code>
  */
class SeriesColumnpyramidDataDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesColumnpyramidDataDataLabels {
  /**
