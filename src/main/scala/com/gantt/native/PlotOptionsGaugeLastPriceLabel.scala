...
/**
  * @note JavaScript name: <code>plotOptions-gauge-lastPrice-label</code>
  */
class PlotOptionsGaugeLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsGaugeLastPriceLabel {
  /**
