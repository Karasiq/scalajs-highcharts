...
/**
  * @note JavaScript name: <code>series&lt;variwide&gt;-lastPrice-label</code>
  */
class SeriesVariwideLastPriceLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesVariwideLastPriceLabel {
  /**
