...
/**
  * @note JavaScript name: <code>plotOptions-tema-states-select-halo</code>
  */
class PlotOptionsTemaStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsTemaStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): PlotOptionsTemaStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsTemaStatesSelectHalo {
