...
/**
  * @note JavaScript name: <code>series&lt;organization&gt;-nodes-dataLabels-animation</code>
  */
class SeriesOrganizationNodesDataLabelsAnimation extends com.highcharts.HighchartsGenericObject {
...
object SeriesOrganizationNodesDataLabelsAnimation {
  /**
    ...
    */
  def apply(defer: js.UndefOr[Double] = js.undefined): SeriesOrganizationNodesDataLabelsAnimation = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesOrganizationNodesDataLabelsAnimation {
      this.defer = defer
    })
  }
}
