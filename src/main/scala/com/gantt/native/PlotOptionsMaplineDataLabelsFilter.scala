...
/**
  * @note JavaScript name: <code>plotOptions-mapline-dataLabels-filter</code>
  */
class PlotOptionsMaplineDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsMaplineDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): PlotOptionsMaplineDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsMaplineDataLabelsFilter {
