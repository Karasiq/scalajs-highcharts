...
/**
  * @note JavaScript name: <code>plotOptions-funnel-accessibility</code>
  */
class PlotOptionsFunnelAccessibility extends com.highcharts.HighchartsGenericObject {
  ...
  /**
    ...
    * @since 9.3.0
    */
  var point: js.UndefOr[CleanJsObject[PlotOptionsFunnelAccessibilityPoint]] = js.undefined
}

object PlotOptionsFunnelAccessibility {
  /**
    ...
    */
  def apply(description: js.UndefOr[String] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, exposeAsGroupOnly: js.UndefOr[Boolean] = js.undefined, keyboardNavigation: js.UndefOr[js.Any] = js.undefined, point: js.UndefOr[CleanJsObject[PlotOptionsFunnelAccessibilityPoint]] = js.undefined): PlotOptionsFunnelAccessibility = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsFunnelAccessibility {
