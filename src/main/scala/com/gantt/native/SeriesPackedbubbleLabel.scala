...
/**
  * @note JavaScript name: <code>series&lt;packedbubble&gt;-label</code>
  */
class SeriesPackedbubbleLabel extends com.highcharts.HighchartsGenericObject {
...
object SeriesPackedbubbleLabel {
  /**
