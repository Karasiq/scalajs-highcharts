...
/**
  * @note JavaScript name: <code>series&lt;area&gt;-data-dataLabels-filter</code>
  */
class SeriesAreaDataDataLabelsFilter extends com.highcharts.HighchartsGenericObject {
...
object SeriesAreaDataDataLabelsFilter {
  /**
    ...
    */
  def apply(operator: js.UndefOr[String] = js.undefined, property: js.UndefOr[String] = js.undefined, value: js.UndefOr[Double] = js.undefined): SeriesAreaDataDataLabelsFilter = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesAreaDataDataLabelsFilter {
