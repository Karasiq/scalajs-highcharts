...
/**
  * @note JavaScript name: <code>series&lt;trendline&gt;-dataLabels</code>
  */
class SeriesTrendlineDataLabels extends com.highcharts.HighchartsGenericObject {
...
object SeriesTrendlineDataLabels {
  /**
