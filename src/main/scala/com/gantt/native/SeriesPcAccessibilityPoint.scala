...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-accessibility-point</code>
  */
class SeriesPcAccessibilityPoint extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcAccessibilityPoint {
  /**
    ...
    */
  def apply(descriptionFormatter: js.UndefOr[js.Any] = js.undefined, dateFormat: js.UndefOr[String] = js.undefined, dateFormatter: js.UndefOr[js.Any] = js.undefined, valueDecimals: js.UndefOr[Double] = js.undefined, valueDescriptionFormat: js.UndefOr[String] = js.undefined, valuePrefix: js.UndefOr[String] = js.undefined, valueSuffix: js.UndefOr[String] = js.undefined): SeriesPcAccessibilityPoint = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcAccessibilityPoint {
