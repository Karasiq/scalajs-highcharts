...
/**
  * @note JavaScript name: <code>series&lt;cmf&gt;-states-inactive</code>
  */
class SeriesCmfStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object SeriesCmfStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): SeriesCmfStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesCmfStatesInactive {
