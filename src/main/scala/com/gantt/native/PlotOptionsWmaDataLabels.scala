...
/**
  * @note JavaScript name: <code>plotOptions-wma-dataLabels</code>
  */
class PlotOptionsWmaDataLabels extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsWmaDataLabels {
  /**
