...
/**
  * @note JavaScript name: <code>series&lt;pc&gt;-states-select-halo</code>
  */
class SeriesPcStatesSelectHalo extends com.highcharts.HighchartsGenericObject {
...
object SeriesPcStatesSelectHalo {
  /**
    ...
    */
  def apply(attributes: js.UndefOr[js.Object] = js.undefined, opacity: js.UndefOr[Double] = js.undefined, size: js.UndefOr[Double] = js.undefined): SeriesPcStatesSelectHalo = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new SeriesPcStatesSelectHalo {
