...
/**
  * @note JavaScript name: <code>plotOptions-rsi-states-inactive</code>
  */
class PlotOptionsRsiStatesInactive extends com.highcharts.HighchartsGenericObject {
...
object PlotOptionsRsiStatesInactive {
  /**
    ...
    */
  def apply(animation: js.UndefOr[Boolean | js.Object] = js.undefined, enabled: js.UndefOr[Boolean] = js.undefined, opacity: js.UndefOr[Double] = js.undefined): PlotOptionsRsiStatesInactive = {
    com.highcharts.HighchartsGenericObject.toCleanObject(new PlotOptionsRsiStatesInactive {
